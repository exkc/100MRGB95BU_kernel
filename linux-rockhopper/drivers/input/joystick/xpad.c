...
static const struct xpad_device {
	...
	{ 0x045e, 0x02fd, "Microsoft X-Box One S pad (Bluetooth)", 0, XTYPE_XBOXONE },
	...
	{ 0x1038, 0x1434, "SteelSeries Stratus Plus Controller", 0, XTYPE_XBOX360 },
...
static void xpad_set_up_abs(struct input_dev *input_dev, signed short abs)
{
	...
	case ABS_RY:	/* the two sticks */
		/*
		 * 1.To address the thumbstick navigation issues in webOS home with Logitech
		 *   F310 and F710 controllers, this code has been implemented by giving flat
		 *   value of 130. This adjustment enhances the functionality of the thumbstick
		 *   in the webOS home environment.
		 * 2.Additionally, the Logitech F310 and F710 gamepads have a high deadzone
		 *   that prevents thumbstick movements from being registered. It has also been
		 *   observed that these controllers occasionally experience a slight delay when
		 *   the thumbstick is released to the center, which is a fundamental problem
		 * with the controllers themselves.
                 */
		if (xpad->udev->descriptor.idVendor == 0x046d)
			input_set_abs_params(input_dev, abs, -32768, 32767, 16, 130);
		else
