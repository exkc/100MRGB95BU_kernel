...
extern	int		REG_WriteI2CL(UINT32 idx, UINT8 slave, UINT8 reg, UINT8* data, UINT8 len);
extern	int		REG_ReadI2CL(UINT32 idx, UINT8 slave, UINT8 reg, UINT8* data, UINT8 len);
