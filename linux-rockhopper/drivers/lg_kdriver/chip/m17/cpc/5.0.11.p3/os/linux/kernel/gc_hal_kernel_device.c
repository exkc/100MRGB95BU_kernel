    ...
    )
{
    ...
    ret = request_irq(
        ...
        Device->irqLines[gcvCORE_MAJOR], isrRoutine3D0, NULL,
#else
    ...
    ret = request_irq(
#if LINUX_VERSION_CODE >= KERNEL_VERSION(4,4,0)
        Device->irqLines[gcvCORE_OCL], isrRoutine3D1, NULL,
#else
    ...
    ret = request_irq(
#if LINUX_VERSION_CODE >= KERNEL_VERSION(4,4,0)
        Device->irqLines[gcvCORE_MAJOR], isrRoutine, NULL,
#else
    ...
    )
{
    ...
    ret = request_irq(
#if LINUX_VERSION_CODE >= KERNEL_VERSION(4,4,0)
        Device->irqLines[gcvCORE_2D], isrRoutine2D, NULL,
#else
    ...
    )
{
    ...
    ret = request_irq(
#if LINUX_VERSION_CODE >= KERNEL_VERSION(4,4,0)
        Device->irqLines[gcvCORE_VG], isrRoutineVG, NULL,
#else
