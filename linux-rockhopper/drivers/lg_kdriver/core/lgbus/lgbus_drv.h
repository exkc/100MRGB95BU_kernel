...
#define LGBUS_LOG_LEVEL_NOTI			LX_LOGM_LEVEL_NOTI
...
#define LGBUS_LOG_LEVEL_DDR_M			(LX_LOGM_LEVEL_TRACE + 2)
...
#define	LGBUS_NOTI(format, args...)				DBG_PRINT(g_lgbus_debug_fd, LGBUS_LOG_LEVEL_NOTI, format, ##args)
#define	LGBUS_DDRM_PRINT(format, args...)		DBG_PRINT(g_lgbus_debug_fd, LGBUS_LOG_LEVEL_DDR_M, format, ##args)

#define	LGBUS_HW0_DEBUG(format, args...)	DBG_PRINT(g_lgbus_debug_fd, 10 /* bit[10] */, format, ##args)
...
extern	bool     LGBUS_ignore_notify(char *name, bool wr);
