...
#ifndef	_PE_HW_M19_H_
#define	_PE_HW_M19_H_
...
#undef PE_HW_M19_PROTECT_OVERLAP_SETTINGS
/* for pe hw bringup */
#define PE_HW_M19_BRINGUP
/* for pe hw use f/w src apl */
#define PE_HW_M19_USE_FW_SRC_APL

/*----------------------------------------------------------------------------
	Macro Definitions
----------------------------------------------------------------------------*/
#define PE_HW_M19_CHK_MULTI_PATH_OUT(_x)		\
	((_x)>=LX_PE_OUT_TB && (_x)<=LX_PE_OUT_DUAL_FULL)

#define PE_HW_M19_CHK_MULTI_PATH_FMT(_x)		\
	((_x)==LX_PE_FMT_UHD)

#define PE_HW_M19_CHK_UHD_FMT_N_3D_CASE(_x)		\
