...
#ifndef  _IPC_DEF_M19_H_
#define  _IPC_DEF_M19_H_

/*----------------------------------------------------------------------------------------
 *   Control Constants
 *---------------------------------------------------------------------------------------*/
#define BE_IPC_FROM_CPU_M19A0_BASE
#define BE_IPC_FROM_MCU_M19A0_BASE
...
typedef struct
{
	...
	UINT32	uFrameRate; // 0 : 60Hz, 1 : 120Hz, 2 : 30Hz
	UINT32 	rsvd[2];
} BE_IPC_DISP_MODE_T;
