 ...
 *
 */
#ifndef __OSD_REG_O18_H__
#define __OSD_REG_O18_H__
...
/*-----------------------------------------------------------------------------
	0x027c osd0_scaler_status_ctrl ''
------------------------------------------------------------------------------*/
typedef struct {
	UINT32
...
} OSDX_SCALER_STATUS_CTRL;

/*-----------------------------------------------------------------------------
	0x0400 osd4_ctrl_main ''
------------------------------------------------------------------------------*/
typedef struct {
	UINT32
	osd_en                          : 1,	//     0
...
/*-----------------------------------------------------------------------------
	GROUP OBJECT : OSDX_SEP_OSD_MIXER
------------------------------------------------------------------------------*/
typedef struct
{
...
typedef struct
{
	CTRL_BOSD1_MIXER_DISP_SIZE      	ctrl_bosd_mixer_disp_size      ;	// 0x0180 : ''
	CTRL_BOSD1_MIXER_OUTPUT         	ctrl_bosd_mixer_output         ;	// 0x0184 : ''
	CTRL_BOSD1_MIXER_AWB            	ctrl_bosd_mixer_awb            ;	// 0x0188 : ''
	UINT32                          	                 __rsvd_03[   4];	// 0x018c ~ 0x0198
	CTRL_BOSD1_MIXER_HOLE           	ctrl_bosd_mixer_hole           ;	// 0x019c : ''
	CTRL_BOSD1_MIXER_MUX0           	ctrl_bosd_mixer_mux0           ;	// 0x01a0 : ''
	CTRL_BOSD1_MIXER_MUX1           	ctrl_bosd_mixer_mux1           ;	// 0x01a4 : ''
	CTRL_BOSD1_MIXER_MUX2           	ctrl_bosd_mixer_mux2           ;	// 0x01a8 : ''
	CTRL_BOSD1_MIXER_MUX3           	ctrl_bosd_mixer_mux3           ;	// 0x01ac : ''
	CTRL_BOSD1_MIXER_MUX4           	ctrl_bosd_mixer_mux4           ;	// 0x01b0 : ''
	CTRL_BOSD1_MIXER_MUX5           	ctrl_bosd_mixer_mux5           ;	// 0x01b4 : ''
	CTRL_BOSD1_MIXER_MUX6           	ctrl_bosd_mixer_mux6           ;	// 0x01b8 : ''
	CTRL_BOSD1_MIXER_MUX7           	ctrl_bosd_mixer_mux7           ;	// 0x01bc : ''
	CTRL_BOSD1_MIXER_MUX8           	ctrl_bosd_mixer_mux8           ;	// 0x01c0 : ''
	CTRL_BOSD1_MIXER_MUX9           	ctrl_bosd_mixer_mux9           ;	// 0x01c4 : ''
	CTRL_BOSD1_MIXER_MUXA           	ctrl_bosd_mixer_muxa           ;	// 0x01c8 : ''
	CTRL_BOSD1_MIXER_MUXB           	ctrl_bosd_mixer_muxb           ;	// 0x01cc : ''
	CTRL_BOSD1_MIXER_MUXC           	ctrl_bosd_mixer_muxc           ;	// 0x01d0 : ''
	CTRL_BOSD1_MIXER_MUXD           	ctrl_bosd_mixer_muxd           ;	// 0x01d4 : ''
	CTRL_BOSD1_MIXER_MUXE           	ctrl_bosd_mixer_muxe           ;	// 0x01d8 : ''
	CTRL_BOSD1_MIXER_MUXF           	ctrl_bosd_mixer_muxf           ;	// 0x01dc : ''
}
OSDX_BLEND_OSD_MIXER;

/*-----------------------------------------------------------------------------
	GROUP OBJECT : OSDX_CTRL
------------------------------------------------------------------------------*/
typedef struct
{
	...
	OSDX_BITMAP_CTRL0               	osd_bitmap_ctrl0               ;	// 0x0258 : ''		(IMAGE only, NOT cursor)
	OSDX_BITMAP_CTRL1               	osd_bitmap_ctrl1               ;	// 0x025c : ''		(IMAGE only, NOT cursor)
	OSDX_VSP_BOSD_CTRL_0            	osd_vsp_bosd_ctrl_0            ;	// 0x0260 : ''		(IMAGE only, NOT cursor)
	OSDX_VSP_BOSD_CTRL_1            	osd_vsp_bosd_ctrl_1            ;	// 0x0264 : ''		(IMAGE only, NOT cursor)
	OSDX_VSP_SOSD_CTRL_0            	osd_vsp_sosd_ctrl_0            ;	// 0x0268 : ''		(IMAGE only, NOT cursor)
	OSDX_VSP_SOSD_CTRL_1            	osd_vsp_sosd_ctrl_1            ;	// 0x026c : ''		(IMAGE only, NOT cursor)
	UINT32                          	                 __rsvd_05[   3];	// 0x0270 ~ 0x0278	(IMAGE only, NOT cursor)
	OSDX_SCALER_STATUS_CTRL         	osd_scaler_status_ctrl         ;	// 0x027c : ''		(IMAGE only, NOT cursor)
}
OSDX_CTRL;
...
typedef struct
{
	...
	/* S.OSD */
	OSDX_SEP_OSD_MIXER					osdx_sep_osd_mixer[1];				// 0x0080 ~ 0x00dc
	UINT32                          	                 __rsvd_02[  33];	// 0x00e0 ~ 0x0160

	/* TODO: COMMON (SEP_CTRL is removed & CROP_CTRL is newly implemented ? */
	OSD_CDC_CROP_CTRL_0             	osd_cdc_crop_ctrl_0             ;	// 0x0164 : ''
	OSD_CDC_CROP_CTRL_1             	osd_cdc_crop_ctrl_1             ;	// 0x0168 : ''
	OSD_CDC_CROP_CTRL_2             	osd_cdc_crop_ctrl_2             ;	// 0x016c : ''
	OSD_CROP_CTRL_0                 	osd_crop_ctrl_0                 ;	// 0x0170 : ''
	OSD_CROP_CTRL_1                 	osd_crop_ctrl_1                 ;	// 0x0174 : ''
	OSD_CROP_CTRL_2                 	osd_crop_ctrl_2                 ;	// 0x0178 : ''
	OSD_CROP_CTRL_3                 	osd_crop_ctrl_3                 ;	// 0x017c : ''

	/* B.OSD mixer */
	OSDX_BLEND_OSD_MIXER				osdx_blend_osd_mixer[1];			// 0x0180~0x01dc
	UINT32                          	                 __rsvd_04[   8];	// 0x01e0 ~ 0x01fc

	OSDX_CTRL							osdx_ctrl[8];						// 0x0200 - OSD0(IMAGE), 0x400 - OSD4/CSR0(CURSOR),

#define OSDX_O18_Off(_g,_r)             ((UINT32)&(g_osd_o18_reg_shadow->_g._r) - (UINT32)(g_osd_o18_reg_shadow))

#define OSDX_O18_RdFL(_g,_r)            ((g_osd_o18_reg_shadow->_g._r)=(g_osd_o18_reg->_g._r))
#define OSDX_O18_WrFL(_g,_r)            ((g_osd_o18_reg->_g._r)=(g_osd_o18_reg_shadow->_g._r))

#define OSDX_O18_Rd(_g,_r)              *((UINT32*)(&(g_osd_o18_reg_shadow->_g._r)))
#define OSDX_O18_Wr(_g,_r,_v)           ((OSDX_O18_Rd(_g,_r))=((UINT32)(_v)))

#define OSDX_O18_Rd00(_g,_r,_f)         (g_osd_o18_reg_shadow->_g._r._f)
#define OSDX_O18_Rd01(_g,_r,_f01,_v01)  do {                                                \
                                            (_v01) = (g_osd_o18_reg_shadow->_g._r._f01);    \
                                        } while(0)
#define OSDX_O18_Wr01(_g,_r,_f01,_v01)  do {                                                \
                                            (g_osd_o18_reg_shadow->_g._r._f01) = (_v01);    \
                                        } while(0)
#define OSDX_O18_Wr02(_g,_r,_f01,_v01,_f02,_v02)    do {                                    \
                                            (g_osd_o18_reg_shadow->_g._r._f01) = (_v01);    \
                                            (g_osd_o18_reg_shadow->_g._r._f02) = (_v02);    \
                                        } while(0)
}
OSD_O18_REG_T;
/* 129 regs, 129 types */
...
/* from 'O18_PQE_OSD_reg_man.csv' 20170603 15:57:09 KST by getregs v2.9 */

/*
 * @{
 * Naming for register pointer.
 * g_osd_o18_reg : real register of OSD.
 * g_osd_o18_reg_shadow     : shadow register.
 *
 * @def OSD_O18_RdFL: Read  FLushing : Shadow <- Real.
 * @def OSD_O18_WrFL: Write FLushing : Shadow -> Real.
 * @def OSD_O18_Rd  : Read  whole register(UINT32) from Shadow register.
 * @def OSD_O18_Wr  : Write whole register(UINT32) from Shadow register.
 * @def OSD_O18_Rd01 ~ OSD_O18_Rdnn: Read  given '01~nn' fields from Shadow register.
 * @def OSD_O18_Wr01 ~ OSD_O18_Wrnn: Write given '01~nn' fields to   Shadow register.
 * */
#define OSD_O18_RdFL(_r)			((g_osd_o18_reg_shadow->_r)=(g_osd_o18_reg->_r))
#define OSD_O18_WrFL(_r)			((g_osd_o18_reg->_r)=(g_osd_o18_reg_shadow->_r))

#define OSD_O18_Rd(_r)				*((UINT32*)(&(g_osd_o18_reg_shadow->_r)))
#define OSD_O18_Wr(_r,_v)			((OSD_O18_Rd(_r))=((UINT32)(_v)))

#define OSD_O18_Rd00(_r,_f)         (g_osd_o18_reg_shadow->_r._f)


#define OSD_O18_Rd01(_r,_f01,_v01)													\
								do { 											\
									(_v01) = (g_osd_o18_reg_shadow->_r._f01);				\
								} while(0)

#define OSD_O18_Rd02(_r,_f01,_v01,_f02,_v02)										\
								do { 											\
									(_v01) = (g_osd_o18_reg_shadow->_r._f01);				\
									(_v02) = (g_osd_o18_reg_shadow->_r._f02);				\
								} while(0)

#define OSD_O18_Rd03(_r,_f01,_v01,_f02,_v02,_f03,_v03)								\
								do { 											\
									(_v01) = (g_osd_o18_reg_shadow->_r._f01);				\
									(_v02) = (g_osd_o18_reg_shadow->_r._f02);				\
									(_v03) = (g_osd_o18_reg_shadow->_r._f03);				\
								} while(0)

#define OSD_O18_Rd04(_r,_f01,_v01,_f02,_v02,_f03,_v03,_f04,_v04)					\
								do { 											\
									(_v01) = (g_osd_o18_reg_shadow->_r._f01);				\
									(_v02) = (g_osd_o18_reg_shadow->_r._f02);				\
									(_v03) = (g_osd_o18_reg_shadow->_r._f03);				\
									(_v04) = (g_osd_o18_reg_shadow->_r._f04);				\
								} while(0)

#define OSD_O18_Wr01(_r,_f01,_v01)													\
								do { 											\
									(g_osd_o18_reg_shadow->_r._f01) = (_v01);				\
								} while(0)

#define OSD_O18_Wr02(_r,_f01,_v01,_f02,_v02)										\
								do { 											\
									(g_osd_o18_reg_shadow->_r._f01) = (_v01);				\
									(g_osd_o18_reg_shadow->_r._f02) = (_v02);				\
								} while(0)

#define OSD_O18_Wr03(_r,_f01,_v01,_f02,_v02,_f03,_v03)								\
								do { 											\
									(g_osd_o18_reg_shadow->_r._f01) = (_v01);				\
									(g_osd_o18_reg_shadow->_r._f02) = (_v02);				\
									(g_osd_o18_reg_shadow->_r._f03) = (_v03);				\
								} while(0)

#define OSD_O18_Wr04(_r,_f01,_v01,_f02,_v02,_f03,_v03,_f04,_v04)					\
								do { 											\
									(g_osd_o18_reg_shadow->_r._f01) = (_v01);				\
									(g_osd_o18_reg_shadow->_r._f02) = (_v02);				\
									(g_osd_o18_reg_shadow->_r._f03) = (_v03);				\
									(g_osd_o18_reg_shadow->_r._f04) = (_v04);				\
								} while(0)

/** @} *//* end of macro documentation */

extern volatile OSD_O18_REG_T*	g_osd_o18_reg;
extern OSD_O18_REG_T*			g_osd_o18_reg_shadow;
...
/* from 'O18_PQE_OSD_reg_man.csv'  대한민국 표준시 by getregs v2.8 */
