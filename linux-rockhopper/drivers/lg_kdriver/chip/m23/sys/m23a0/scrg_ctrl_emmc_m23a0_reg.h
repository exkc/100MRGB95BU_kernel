#ifndef _SCRG_CTRL_EMMC_M23A0_REG_H_
#define _SCRG_CTRL_EMMC_M23A0_REG_H_
...
/*-----------------------------------------------------------------------------------------
    0xC475_0000    crg_emmc00 ''
-----------------------------------------------------------------------------------------*/
typedef struct {
    UINT32
    test_reserved             : 32;    //  31: 0
}SCRG_CTRL_EMMC_CRG_EMMC00_M23A0_T;

/*-----------------------------------------------------------------------------------------
    0xC475_0004    crg_emmc01 ''
-----------------------------------------------------------------------------------------*/
typedef struct {
    UINT32
    test_reserved_ro          : 32;    //  31: 0
}SCRG_CTRL_EMMC_CRG_EMMC01_M23A0_T;

/*-----------------------------------------------------------------------------------------
    0xC475_0008    crg_emmc02 ''
-----------------------------------------------------------------------------------------*/
typedef struct {
    UINT32
    ...
    reg_emmc_tx_inv_clk_gate_en: 1,    //      3
                              : 28;    //   31:4 reserved
}SCRG_CTRL_EMMC_CRG_EMMC02_M23A0_T;

/*-----------------------------------------------------------------------------------------
    0xC475_000C    crg_emmc03 ''
-----------------------------------------------------------------------------------------*/
typedef struct {
    UINT32
    ...
    reg_soft_rst_x_emmc_0_axi_n: 1,    //      6
                              : 25;    //   31:7 reserved
}SCRG_CTRL_EMMC_CRG_EMMC03_M23A0_T;

/*-----------------------------------------------------------------------------------------
    scrg_ctrl_emmc Register LIst
-----------------------------------------------------------------------------------------*/
typedef struct {
    SCRG_CTRL_EMMC_CRG_EMMC00_M23A0_T    crg_emmc00;            // 0xC475_0000
    SCRG_CTRL_EMMC_CRG_EMMC01_M23A0_T    crg_emmc01;            // 0xC475_0004
    SCRG_CTRL_EMMC_CRG_EMMC02_M23A0_T    crg_emmc02;            // 0xC475_0008
    SCRG_CTRL_EMMC_CRG_EMMC03_M23A0_T    crg_emmc03;            // 0xC475_000C
}SCRG_CTRL_EMMC_REG_M23A0_T;
/* 4 regs */
...
#define SCRG_CTRL_EMMC_CRG_EMMC00_M23A0_T_OFF               (BASEADDRESS+0x0000)
#define SCRG_CTRL_EMMC_CRG_EMMC01_M23A0_T_OFF               (BASEADDRESS+0x0004)
#define SCRG_CTRL_EMMC_CRG_EMMC02_M23A0_T_OFF               (BASEADDRESS+0x0008)
#define SCRG_CTRL_EMMC_CRG_EMMC03_M23A0_T_OFF               (BASEADDRESS+0x000C)
