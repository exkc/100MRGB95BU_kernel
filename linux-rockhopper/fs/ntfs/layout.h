...
typedef struct {
	...
	le32 sub_authority[];		/* At least one sub_authority. */
...
typedef struct {
	...
	u8 ea_name[];		/* Name of the EA.  Note this is ASCII, not
...
typedef enum {
	INTX_SYMBOLIC_LINK =
		cpu_to_le64(0x014B4E4C78746E49ULL), /* "IntxLNK\1" */
	INTX_CHARACTER_DEVICE =
		cpu_to_le64(0x0052484378746E49ULL), /* "IntxCHR\0" */
	INTX_BLOCK_DEVICE =
		cpu_to_le64(0x004B4C4278746E49ULL), /* "IntxBLK\0" */
} INTX_FILE_TYPE;

typedef struct {
	INTX_FILE_TYPE magic;          /* Intx file magic. */
	union {
