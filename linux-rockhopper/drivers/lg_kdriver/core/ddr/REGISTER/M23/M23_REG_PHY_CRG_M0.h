...
//Header File for PHY_CRG_M0 in \M23\M23_DRAM_M0_Register_Manual.xls
...
typedef struct {
	REG_PHY_CRG_M0_PHY_CLK_EN_T                              phy_clk_en;	//0xC4F4F000
	REG_PHY_CRG_M0_PHY_RST_EN_T                              phy_rst_en;	//0xC4F4F004
	REG_PHY_CRG_M0_PAD_CAL_CLK_DIV_T                    pad_cal_clk_div;	//0xC4F4F008
	REG_PHY_CRG_M0_PHY_CLK_SRC_SEL_T                    phy_clk_src_sel;	//0xC4F4F00C
	REG_PHY_CRG_M0_PLL_PDB_CTRL_T                          pll_pdb_ctrl;	//0xC4F4F010
	REG_PHY_CRG_M0_DMODE_CTRL_T                              dmode_ctrl;	//0xC4F4F014
	REG_PHY_CRG_M0_IBIAS_BGRBUF_T                          ibias_bgrbuf;	//0xC4F4F018
	REG_PHY_CRG_M0_RX_PDB_T                                      rx_pdb;	//0xC4F4F01C
	UINT32                                                    reserved0;	//0xC4F4F020
	UINT32                                                    reserved1;	//0xC4F4F024
	UINT32                                                    reserved2;	//0xC4F4F028
	UINT32                                                    reserved3;	//0xC4F4F02C
	UINT32                                                    reserved4;	//0xC4F4F030
	UINT32                                                    reserved5;	//0xC4F4F034
	UINT32                                                    reserved6;	//0xC4F4F038
	UINT32                                                    reserved7;	//0xC4F4F03C
	UINT32                                                    reserved8;	//0xC4F4F040
	UINT32                                                    reserved9;	//0xC4F4F044
	UINT32                                                   reserved10;	//0xC4F4F048
	UINT32                                                   reserved11;	//0xC4F4F04C
	REG_PHY_CRG_M0_APHY_CTRL_PWRUP_RSTB_0_T      aphy_ctrl_pwrup_rstb_0;	//0xC4F4F050
	REG_PHY_CRG_M0_APHY_CTRL_PWRUP_RSTB_1_T      aphy_ctrl_pwrup_rstb_1;	//0xC4F4F054
	REG_PHY_CRG_M0_APHY_CTRL_PWRUP_RSTB_2_T      aphy_ctrl_pwrup_rstb_2;	//0xC4F4F058
	REG_PHY_CRG_M0_APHY_CTRL_PWRUP_RSTB_3_T      aphy_ctrl_pwrup_rstb_3;	//0xC4F4F05C
	REG_PHY_CRG_M0_APHY_CTRL_PWRUP_RSTB_4_T      aphy_ctrl_pwrup_rstb_4;	//0xC4F4F060
	REG_PHY_CRG_M0_APHY_CTRL_PWRUP_RSTB_5_T      aphy_ctrl_pwrup_rstb_5;	//0xC4F4F064
	REG_PHY_CRG_M0_APHY_CTRL_PWRUP_RSTB_6_T      aphy_ctrl_pwrup_rstb_6;	//0xC4F4F068
	REG_PHY_CRG_M0_APHY_CTRL_PWRUP_RSTB_7_T      aphy_ctrl_pwrup_rstb_7;	//0xC4F4F06C
	REG_PHY_CRG_M0_APHY_CTRL_PWRUP_RSTB_8_T      aphy_ctrl_pwrup_rstb_8;	//0xC4F4F070
	REG_PHY_CRG_M0_APHY_CTRL_PWRUP_RSTB_9_T      aphy_ctrl_pwrup_rstb_9;	//0xC4F4F074
	REG_PHY_CRG_M0_APHY_CTRL_SW_RSTB_DQS_T        aphy_ctrl_sw_rstb_dqs;	//0xC4F4F078
	REG_PHY_CRG_M0_APHY_CTRL_SW_RSTB_CK_T          aphy_ctrl_sw_rstb_ck;	//0xC4F4F07C
	REG_PHY_CRG_M0_APHY_PAD_CKE_DDR4_T                aphy_pad_cke_ddr4;	//0xC4F4F080
	REG_PHY_CRG_M0_APHY_PAD_ODT_DDR4_T                aphy_pad_odt_ddr4;	//0xC4F4F084
	REG_PHY_CRG_M0_APHY_PAD_CKE_ODT_LPD4_T        aphy_pad_cke_odt_lpd4;	//0xC4F4F088
	UINT32                                                   reserved12;	//0xC4F4F08C
	UINT32                                                   reserved13;	//0xC4F4F090
	UINT32                                                   reserved14;	//0xC4F4F094
	UINT32                                                   reserved15;	//0xC4F4F098
	UINT32                                                   reserved16;	//0xC4F4F09C
	UINT32                                                   reserved17;	//0xC4F4F0A0
	UINT32                                                   reserved18;	//0xC4F4F0A4
	UINT32                                                   reserved19;	//0xC4F4F0A8
	UINT32                                                   reserved20;	//0xC4F4F0AC
	UINT32                                                   reserved21;	//0xC4F4F0B0
	UINT32                                                   reserved22;	//0xC4F4F0B4
	UINT32                                                   reserved23;	//0xC4F4F0B8
	UINT32                                                   reserved24;	//0xC4F4F0BC
	UINT32                                                   reserved25;	//0xC4F4F0C0
	UINT32                                                   reserved26;	//0xC4F4F0C4
	UINT32                                                   reserved27;	//0xC4F4F0C8
	UINT32                                                   reserved28;	//0xC4F4F0CC
	UINT32                                                   reserved29;	//0xC4F4F0D0
	UINT32                                                   reserved30;	//0xC4F4F0D4
	UINT32                                                   reserved31;	//0xC4F4F0D8
	UINT32                                                   reserved32;	//0xC4F4F0DC
	UINT32                                                   reserved33;	//0xC4F4F0E0
	UINT32                                                   reserved34;	//0xC4F4F0E4
	UINT32                                                   reserved35;	//0xC4F4F0E8
	UINT32                                                   reserved36;	//0xC4F4F0EC
	UINT32                                                   reserved37;	//0xC4F4F0F0
	UINT32                                                   reserved38;	//0xC4F4F0F4
	UINT32                                                   reserved39;	//0xC4F4F0F8
	UINT32                                                   reserved40;	//0xC4F4F0FC
	REG_PHY_CRG_M0_PLL_CTRL_STATUS_T                    pll_ctrl_status;	//0xC4F4F100
	REG_PHY_CRG_M0_DFS_CTRL_STATUS_T                    dfs_ctrl_status;	//0xC4F4F104
	REG_PHY_CRG_M0_LP_CTRL_STATUS_T                      lp_ctrl_status;	//0xC4F4F108
	REG_PHY_CRG_M0_RTE_STATUS_T                              rte_status;	//0xC4F4F10C
	REG_PHY_CRG_M0_CAL_STATUS_T                              cal_status;	//0xC4F4F110
	REG_PHY_CRG_M0_RTE_CAL_STATUS_T                      rte_cal_status;	//0xC4F4F114
	REG_PHY_CRG_M0_SPARE_T                                        spare;	//0xC4F4F118
}REG_PHY_CRG_M0_T;
