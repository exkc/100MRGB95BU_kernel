...
#ifdef CONFIG_EKP
	map_segment(init_pg_dir, &pgdp, va_offset, __ekp_rodata_start,
		    __ekp_rodata_end, data_prot, false, root_level);
...
#ifdef CONFIG_EKP
	/* Clear EKP rodata */
	memset(__ekp_rodata_start, 0,
	       (u64)__ekp_rodata_end - (u64)__ekp_rodata_start);
#endif
