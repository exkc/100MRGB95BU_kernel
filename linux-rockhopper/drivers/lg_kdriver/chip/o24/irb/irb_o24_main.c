...
/*----------------------------------------------------------------------------------------
  global Functions
  ---------------------------------------------------------------------------------------*/
static int o24_irbs_enable = 1;
static int o24_irb_inited = 0;

module_param(o24_irbs_enable, int, S_IRUGO);
MODULE_PARM_DESC(o24_irbs_enable, "o24 irbs disable");


static irbs_o24_func_t* irb_o24_func = NULL;
int o24_irb_ioctl_main (unsigned int cmd, unsigned long arg);
...
static int o24_irb_ioctl (unsigned int cmd, unsigned long arg)
{
    int ret = 0;
    ...
    ret = o24_irb_ioctl_main(cmd, arg);

    return ret;
}

static int o24_irb_suspend(void)
{

    return 0;
}

static int o24_irb_resume(void)
{
...
static irbs_driver_t o24_irbs_driver =
{
    .init = o24_irb_init,
    .ioctl = o24_irb_ioctl,
    .suspend = o24_irb_suspend,
    .resume = o24_irb_resume,
};

irbs_driver_t* get_o24_irb_driver(void)
{
    return &o24_irbs_driver;
}
