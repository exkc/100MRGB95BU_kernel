 ...
 *
 * CONFIG_LX_CHIP_EMUL
 * -- if none-zero value defined, kdriver will be configured based on this revision
 * CONFIG_LX_<chip>_CHIP_FIRMWARE
 * -- if none-zero value defined, kdriver will include built-in firmware data
 ----------------------------------------------------------------------------------------*/
#define CONFIG_LX_CHIP_EMUL     0x0 /* 0x0 = AUTO, 0x18A0 = M16A0 */
#define CONFIG_LX_O26_CHIP_FIRMWARE 1
 ...
 *  to save device memory.
 ----------------------------------------------------------------------------------------*/
#define CONFIG_LX_BOOT_LOGO         0   /* OFF */
