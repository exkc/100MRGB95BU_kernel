#ifndef _PE_CHPI_HDR_REG_O26F22A0_H_
#define _PE_CHPI_HDR_REG_O26F22A0_H_
#ifndef UINT32
...
}PE_O26F22_HDR_YGAIN_LUT_CTRL_05_T;
...
}PE_O26F22_HDR_YGAIN_LUT_IA_CTRL_T;
...
}PE_O26F22_HDR_YGAIN_LUT_IA_DATA_T;
...
}PE_O26F22_HDR_LGAIN_LUT_CTRL_00_T;
...
}PE_O26F22_HDR_LGAIN_LUT_CTRL_01_T;
...
}PE_O26F22_HDR_LGAIN_LUT_CTRL_02_T;
...
}PE_O26F22_HDR_LGAIN_LUT_CTRL_03_T;
...
}PE_O26F22_HDR_LGAIN_LUT_CTRL_04_T;
...
}PE_O26F22_HDR_LGAIN_LUT_CTRL_05_T;
...
}PE_O26F22_HDR_LGAIN_LUT_CTRL_06_T;
...
}PE_O26F22_HDR_LGAIN_LUT_CTRL_07_T;
...
}PE_O26F22_HDR_SGAIN_LUT_CTRL_00_T;
...
}PE_O26F22_HDR_SGAIN_LUT_CTRL_01_T;
...
}PE_O26F22_HDR_SGAIN_LUT_CTRL_02_T;
...
}PE_O26F22_HDR_SGAIN_LUT_CTRL_03_T;
...
}PE_O26F22_HDR_SGAIN_LUT_CTRL_04_T;
...
}PE_O26F22_HDR_SGAIN_LUT_CTRL_05_T;
...
}PE_O26F22_HDR_SGAIN_LUT_CTRL_06_T;
...
}PE_O26F22_HDR_SGAIN_LUT_CTRL_07_T;
...
}PE_O26F22_HDR_PCC_CTRL_05_T;

typedef struct
{
	PE_O26F22_HDR_LLUT0_IA_CTRL_T                 hdr_llut0_ia_ctrl_x;	//0xF1000A20
	PE_O26F22_HDR_LLUT1_IA_CTRL_T                 hdr_llut1_ia_ctrl_x;	//0xF1000A50
	PE_O26F22_HDR_LLUT2_IA_CTRL_T                 hdr_llut2_ia_ctrl_x;	//0xF1000A80
	PE_O26F22_HDR_LLUT0_IA_DATA_T                 hdr_llut0_ia_data_x[32];	//0xF1000A24
	PE_O26F22_HDR_LLUT1_IA_DATA_T                 hdr_llut1_ia_data_x[32];	//0xF1000A54
	PE_O26F22_HDR_LLUT2_IA_DATA_T                 hdr_llut2_ia_data_x[32];	//0xF1000A84
	PE_O26F22_HDR_LLUT0_CTRL_05_T                 hdr_llut0_ctrl_05;	//0xF1000A14
	PE_O26F22_HDR_LLUT1_CTRL_05_T                 hdr_llut1_ctrl_05;	//0xF1000A44
	PE_O26F22_HDR_LLUT2_CTRL_05_T                 hdr_llut2_ctrl_05;	//0xF1000A74
	PE_O26F22_HDR_LLUT0_IA_CTRL_T                 hdr_llut0_ia_ctrl_y;	//0xF1000A20
	PE_O26F22_HDR_LLUT1_IA_CTRL_T                 hdr_llut1_ia_ctrl_y;	//0xF1000A50
	PE_O26F22_HDR_LLUT2_IA_CTRL_T                 hdr_llut2_ia_ctrl_y;	//0xF1000A80
	PE_O26F22_HDR_LLUT0_IA_DATA_T                 hdr_llut0_ia_data_y[32];	//0xF1000A24
	PE_O26F22_HDR_LLUT1_IA_DATA_T                 hdr_llut1_ia_data_y[32];	//0xF1000A54
	PE_O26F22_HDR_LLUT2_IA_DATA_T                 hdr_llut2_ia_data_y[32];	//0xF1000A84
	PE_O26F22_HDR_LLUT0_CTRL_06_T                 hdr_llut0_ctrl_06;	//0xF1000A18
	PE_O26F22_HDR_LLUT1_CTRL_06_T                 hdr_llut1_ctrl_06;	//0xF1000A48
	PE_O26F22_HDR_LLUT2_CTRL_06_T                 hdr_llut2_ctrl_06;	//0xF1000A78
	PE_O26F22_HDR_LLUT0_IA_CTRL_T                 hdr_llut0_ia_ctrl_e;	//0xF1000A20
	PE_O26F22_HDR_LLUT1_IA_CTRL_T                 hdr_llut1_ia_ctrl_e;	//0xF1000A50
	PE_O26F22_HDR_LLUT2_IA_CTRL_T                 hdr_llut2_ia_ctrl_e;	//0xF1000A80
}PE_CHPI_HDR_TM_O26F22_T;

typedef struct
{
	PE_O26F22_HDR_YGAIN_LUT_IA_CTRL_T             hdr_ygain_lut_ia_ctrl_s;	//0xF1000B38
	PE_O26F22_HDR_YGAIN_LUT_IA_DATA_T             hdr_ygain_lut_ia_data[32];	//0xF1000B3C
	PE_O26F22_HDR_YGAIN_LUT_IA_CTRL_T             hdr_ygain_lut_ia_ctrl_e;	//0xF1000B38
	PE_O26F22_HDR_YGAIN_LUT_CTRL_05_T             hdr_ygain_lut_ctrl_05;	//0xF1000B34
}PE_CHPI_HDR_YG_O26F22_T;

typedef struct
{
	PE_O26F22_HDR_HUE_SAT_CTRL_T                  hdr_hue_sat_ctrl;	//0xF10008D0
	PE_O26F22_HDR_LGAIN_LUT_CTRL_00_T             hdr_lgain_lut_ctrl_00;	//0xF1000B60
	PE_O26F22_HDR_LGAIN_LUT_CTRL_01_T             hdr_lgain_lut_ctrl_01;	//0xF1000B64
	PE_O26F22_HDR_LGAIN_LUT_CTRL_02_T             hdr_lgain_lut_ctrl_02;	//0xF1000B68
	PE_O26F22_HDR_LGAIN_LUT_CTRL_03_T             hdr_lgain_lut_ctrl_03;	//0xF1000B6C
	PE_O26F22_HDR_LGAIN_LUT_CTRL_04_T             hdr_lgain_lut_ctrl_04;	//0xF1000B70
	PE_O26F22_HDR_LGAIN_LUT_CTRL_05_T             hdr_lgain_lut_ctrl_05;	//0xF1000B74
	PE_O26F22_HDR_LGAIN_LUT_CTRL_06_T             hdr_lgain_lut_ctrl_06;	//0xF1000B78
	PE_O26F22_HDR_LGAIN_LUT_CTRL_07_T             hdr_lgain_lut_ctrl_07;	//0xF1000B7C
	PE_O26F22_HDR_SGAIN_LUT_CTRL_00_T             hdr_sgain_lut_ctrl_00;	//0xF1000B80
	PE_O26F22_HDR_SGAIN_LUT_CTRL_01_T             hdr_sgain_lut_ctrl_01;	//0xF1000B84
	PE_O26F22_HDR_SGAIN_LUT_CTRL_02_T             hdr_sgain_lut_ctrl_02;	//0xF1000B88
	PE_O26F22_HDR_SGAIN_LUT_CTRL_03_T             hdr_sgain_lut_ctrl_03;	//0xF1000B8C
	PE_O26F22_HDR_SGAIN_LUT_CTRL_04_T             hdr_sgain_lut_ctrl_04;	//0xF1000B90
	PE_O26F22_HDR_SGAIN_LUT_CTRL_05_T             hdr_sgain_lut_ctrl_05;	//0xF1000B94
	PE_O26F22_HDR_SGAIN_LUT_CTRL_06_T             hdr_sgain_lut_ctrl_06;	//0xF1000B98
	PE_O26F22_HDR_SGAIN_LUT_CTRL_07_T             hdr_sgain_lut_ctrl_07;	//0xF1000B9C
}PE_CHPI_HDR_HS_O26F22_T;

typedef struct
{
	PE_O26F22_HDR_PCC_CTRL_01_T                   hdr_pcc_ctrl_01;	//0xF10008A4
	PE_O26F22_HDR_PCC_CTRL_02_T                   hdr_pcc_ctrl_02;	//0xF10008A8
	PE_O26F22_HDR_PCC_CTRL_03_T                   hdr_pcc_ctrl_03;	//0xF10008AC
	PE_O26F22_HDR_PCC_CTRL_04_T                   hdr_pcc_ctrl_04;	//0xF10008B0
	PE_O26F22_HDR_PCC_CTRL_05_T                   hdr_pcc_ctrl_05;	//0xF10008B4
}PE_CHPI_HDR_PCC_O26F22_T;
