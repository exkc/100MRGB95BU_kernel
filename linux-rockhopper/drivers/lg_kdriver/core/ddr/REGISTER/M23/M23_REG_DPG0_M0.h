...
//Header File for DPG0_M0 in \M23\M23_DRAM_M0_Register_Manual.xls
...
typedef struct {
	REG_DPG0_M0_DPG_ENABLE_T                                 dpg_enable;	//0xC4F44100
	REG_DPG0_M0_DPG_INF_CTRL_T                             dpg_inf_ctrl;	//0xC4F44104
	REG_DPG0_M0_DPG_ID_INC_T                                 dpg_id_inc;	//0xC4F44108
	REG_DPG0_M0_DPG_SW_RESET_T                             dpg_sw_reset;	//0xC4F4410C
	REG_DPG0_M0_DPG_WR_PATTERN_T                         dpg_wr_pattern;	//0xC4F44110
	REG_DPG0_M0_CMD_DLY_CTRL_T                             cmd_dly_ctrl;	//0xC4F44114
	REG_DPG0_M0_RND_AXI_LENGTH_T                         rnd_axi_length;	//0xC4F44118
	REG_DPG0_M0_AXI_TR_STATUS_T                           axi_tr_status;	//0xC4F4411C
	REG_DPG0_M0_DPG_MO_STATUS_T                           dpg_mo_status;	//0xC4F44120
	REG_DPG0_M0_DPG_BCH_ERR_STATUS_T                 dpg_bch_err_status;	//0xC4F44124
	REG_DPG0_M0_DPG_RDATA_ERR_STATUS_T             dpg_rdata_err_status;	//0xC4F44128
	REG_DPG0_M0_DPG_RCH_ERR_STATUS_T                 dpg_rch_err_status;	//0xC4F4412C
	REG_DPG0_M0_IP_GATING_T                                   ip_gating;	//0xC4F44130
	REG_DPG0_M0_DPG_GATING_T                                 dpg_gating;	//0xC4F44134
	REG_DPG0_M0_FLUSH_EN_T                                     flush_en;	//0xC4F44138
	REG_DPG0_M0_FLUSH_DONE_T                                 flush_done;	//0xC4F4413C
	REG_DPG0_M0_GRP0_START_ADDR_T                       grp0_start_addr;	//0xC4F44140
	REG_DPG0_M0_GPR0_ADDR_INC_BND_T                   gpr0_addr_inc_bnd;	//0xC4F44144
	REG_DPG0_M0_GRP1_START_ADDR_T                       grp1_start_addr;	//0xC4F44148
	REG_DPG0_M0_GPR1_ADDR_INC_BND_T                   gpr1_addr_inc_bnd;	//0xC4F4414C
	REG_DPG0_M0_ADDR_INC_VAL_T                             addr_inc_val;	//0xC4F44150
	REG_DPG0_M0_ROW_BANK_ADDR_MODE_T                 row_bank_addr_mode;	//0xC4F44154
	UINT32                                                    reserved0;	//0xC4F44158
	REG_DPG0_M0_RDATA_ERR_ADDR_T                         rdata_err_addr;	//0xC4F4415C
	REG_DPG0_M0_RDATA_EXP_DATA_127_96_T           rdata_exp_data_127_96;	//0xC4F44160
	REG_DPG0_M0_RDATA_EXP_DATA_95_64_T             rdata_exp_data_95_64;	//0xC4F44164
	REG_DPG0_M0_RDATA_EXP_DATA_63_32_T             rdata_exp_data_63_32;	//0xC4F44168
	REG_DPG0_M0_RDATA_EXP_DATA_31_0_T               rdata_exp_data_31_0;	//0xC4F4416C
	REG_DPG0_M0_RDATA_IN_DATA_127_96_T             rdata_in_data_127_96;	//0xC4F44170
	REG_DPG0_M0_RDATA_IN_DATA_95_64_T               rdata_in_data_95_64;	//0xC4F44174
	REG_DPG0_M0_RDATA_IN_DATA_63_32_T               rdata_in_data_63_32;	//0xC4F44178
	REG_DPG0_M0_RDATA_IN_DATA_31_0_T                 rdata_in_data_31_0;	//0xC4F4417C
	REG_DPG0_M0_USER_CMD_REG0_T                           user_cmd_reg0;	//0xC4F44180
	REG_DPG0_M0_USER_CMD_REG1_T                           user_cmd_reg1;	//0xC4F44184
	UINT32                                                    reserved1;	//0xC4F44188
	UINT32                                                    reserved2;	//0xC4F4418C
	REG_DPG0_M0_START_MODE_T                                 start_mode;	//0xC4F44190
	UINT32                                                    reserved3;	//0xC4F44194
	REG_DPG0_M0_LP_CTRL_T                                       lp_ctrl;	//0xC4F44198
	UINT32                                                    reserved4;	//0xC4F4419C
	REG_DPG0_M0_DIRECT_MODE_T                               direct_mode;	//0xC4F441A0
	REG_DPG0_M0_FIXED_MODE0_T                               fixed_mode0;	//0xC4F441A4
	REG_DPG0_M0_FIXED_MODE1_T                               fixed_mode1;	//0xC4F441A8
}REG_DPG0_M0_T;
