 ...
 * @{
 */
#ifndef  DOLBY_REG_O18_INC
#define  DOLBY_REG_O18_INC
...
#define KB 1024
#define HDR_BASE_ADDRESS	gMemCfgHDR[1].frame_base//VIDEO_M16_FIRMWARE_MEM_BASE_HDR
...
#define DOLBY_HAL_O18_CTRL_ADDR 0xC9006000
#define DOLBY_HAL_O18_CTRL_SIZE 0x3C4
#define DOLBY_HAL_O18_HDMI_MD_ADDR 0xC9014200 //0xC9005400 //0xC9014200  //O18 HDMI MD Address from Mail
#define DOLBY_HAL_O18_HDMI_HDR_HW_MD_ADDR 0xC9005400
#define DOLBY_HAL_O18_HDMI_TOTMD_SIZE 0x200
#define DOLBY_HAL_O18_HDMI_MD_SIZE 0x6E
#define DOLBY_HAL_O18_LUTIP_ADDR 0xC9003C00
#define DOLBY_HAL_O18_LUTIP_SIZE 0x300
#define DOLBY_HAL_O18_MCUIPC_ADDR 0xC90262E0
#define DOLBY_HAL_O18_LUT_DDR_ADDR HDR_DOLBY_LUT_BASE //Note:need to get from MCU
#define DOLBY_HAL_O18_LUT_DDR_SIZE HDR_DOLBY_LUT_SIZE //Note:need to get from MCU
#define DOLBY_HAL_O18_IP_CONFIG_DDR_ADDR HDR_DOLBY_REGMAP_BASE //Note:need to get from MCU
#define DOLBY_HAL_O18_IP_CONFIG_DDR_SIZE HDR_DOLBY_REGMAP_SIZE //Note:need to get from MCU
#define DOLBY_HAL_O18_OTTMD_DDR_ADDR HDR_DOLBY_MD_BASE //Note:need to get from MCU
#define DOLBY_HAL_O18_OTTMD_DDR_SIZE HDR_DOLBY_MD_SIZE //Note:need to get from MCU
#define DOLBY_HAL_O18_FRAME_INDEX_BASE HDR_DOLBY_INDEX_BASE
#define DOLBY_HAL_O18_FRAME_INDEX_SIZE HDR_DOLBY_INDEX_SIZE

//Interrup address
#define DOLBY_HAL_O18_HDRINTR_ADDR 0xC9005000
#define DOLBY_HAL_O18_HDRINTR_SIZE 0xFC
#define DOLBY_HAL_O18_MCUINTR_ADDR 0xC9026010
#define DOLBY_HAL_O18_MCUINTR_SIZE 0x20
#define DOLBY_HAL_O18_PICSTARTINTR_ADDR 0xC9001104
#define DOLBY_HAL_O18_PICSTARTINTR_SIZE 0x4

//LUT RAM address
#define DOLBY_HAL_O18_RPU_ADDR 0x14000000
#define DOLBY_HAL_O18_RPU_SIZE 0xC2B0
#define DOLBY_HAL_O18_3DLUTRAM_ADDR DOLBY_HAL_O18_RPU_ADDR + 0x00030000
#define DOLBY_HAL_O18_3DLUTRAM_SIZE 0x1B9A0 //0x6660
#define DOLBY_HAL_O18_TCLUTRAM_ADDR DOLBY_HAL_O18_3DLUTRAM_ADDR + DOLBY_HAL_O18_3DLUTRAM_SIZE
#define DOLBY_HAL_O18_TCLUTRAM_SIZE 0x800

//Irq NUMBER not sure... so need to get from H/W team
#define DOLBY_HAL_O18_HDRINTRIRQ_NUMBER 161
#define DOLBY_HAL_O18_MCUIRQ_NUMBER 90
...
int DE_DHDR_IP_REG_O18_SetIrqStatus(DOLBY_DEVICE_DATA_T *i_PtrDolby,UINT32 *i_PtrIrqStatus,int i_unFlag);
int DE_DHDR_IP_REG_O18_GetHDMIMetaData(DOLBY_DEVICE_DATA_T *i_PtrDolby,LX_DOLBY_DM_MD_T *o_PtrMetaData);
