...
#ifndef	_PM_M19_COMMON_H_
#define	_PM_M19_COMMON_H_
...
#define M19A0_AVS_SET_DELAY 	30	/* sec */
...
#define M19_CPU_VOL_ND			940
#define M19_CPU_VOL_UD			800
...
typedef struct
{
	...
	unsigned int cpu_ts_f_aparam;
	unsigned int cpu_ts_f_bparam;
	unsigned int cpu_ts_n_aparam;
	unsigned int cpu_ts_n_bparam;
	unsigned int cpu_ts_s_aparam;
	unsigned int cpu_ts_s_bparam;
...
typedef struct
{
	...
	void  			(*run)(pms_m19_work_t m19work);
	void  			(*reset)(void);
...
typedef struct
{
	...
	void  			(*reinit)(void);
	int 			(*set_avs)(void);
	int 			(*get_cpu_avs_type)(pms_m19_avsinto_t *);
	int 			(*get_core_avs_type)(pms_m19_avsinto_t *);
