 ...
 */
int DE_IPC_M17_Init(UINT32 mcu_id,           \
   ...
   switch(mcu_id)
   {
	   case 0:
		   *pVideoBuffToMCU = (void *)ioremap( \
				   DTVSOC_IPC_FROM_CPU_M17_BASE,\
				   DTVSOC_IPC_FROM_CPU_SIZE);
		   *pVideoBuffFrMCU = (void *)ioremap(\
				   DTVSOC_IPC_FROM_MCU_M17_BASE,\
 ...
 * @return RET_OK(0) if success, none zero for otherwise
 */
int DE_IPC_M17_Free(UINT32 **pVideoBuffToMCU, UINT32 **pVideoBuffFrMCU)
{
#ifdef USE_QEMU_SYSTEM
