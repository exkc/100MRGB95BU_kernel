...
/*****************************************************************************
**
**  Name:ademod_m16_factory.h
**
**  Description:   ABB M16P factory settings.
**
**  Functions
**
**  References:
...
#ifndef _ADEMOD_M16P_FACTORY_H_
#define _ADEMOD_M16P_FACTORY_H_
...
/******************************************************************************
**
**  Name: DEMOD_M16P_Analog_Factory_Table_Get
**
...
**
******************************************************************************/
LX_ADEMOD_Result DEMOD_M16P_Analog_Factory_Table_Get(pLX_ADEMOD_Demod_Instance pContext, const LX_ADEMOD_FACTORY_SETTINGS **Table, UINT32 *Size);

#if defined( __cplusplus )
}
#endif

#endif //_ADEMOD_M16P_FACTORY_H_
