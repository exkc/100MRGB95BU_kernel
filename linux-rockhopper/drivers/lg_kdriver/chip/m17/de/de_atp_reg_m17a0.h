...
#ifndef _ATP_REG_M17A0_H_
#define _ATP_REG_M17A0_H_
...
} M17A0_A_TOP_STATUS_T;

typedef struct {
	M17A0_TTX_VER_CTRL0_T              	ttx_ver_ctrl0;                //0xc8006600L
	M17A0_TTX_VER_CTRL1_T              	ttx_ver_ctrl1;                //0xc8006604L
	M17A0_WSS_DATA_T                   	wss_data;                     //0xc8006608L
	M17A0_CGMS_DATA_T                  	cgms_data;                    //0xc800660cL
	M17A0_CVE_CONFIG_T                 	cve_config;                   //0xc8006610L
	M17A0_PHASE_INCR_T                 	phase_incr;                   //0xc8006614L
	M17A0_DENC_VBI_CTRL_T              	denc_vbi_ctrl;                //0xc8006618L
	M17A0_CC_DATA_T                    	cc_data;                      //0xc800661cL
	M17A0_MV_N0_3_T                    	mv_n0_3;                      //0xc8006620L
	M17A0_MV_N4_9_T                    	mv_n4_9;                      //0xc8006624L
	M17A0_MV_N10_11_T                  	mv_n10_11;                    //0xc8006628L
	M17A0_MV_N12_14_T                  	mv_n12_14;                    //0xc800662cL
	M17A0_MV_N15_20_T                  	mv_n15_20;                    //0xc8006630L
	M17A0_VPS_CTRL_T                   	vps_ctrl;                     //0xc8006634L
	M17A0_TTX_DATA_T                   	ttx_data;                     //0xc8006638L
	M17A0_TTX_LOAD_T                   	ttx_load;                     //0xc800663cL
	UINT32                             	reserved00[4];                //0xc8006640L~0xc800664cL
	M17A0_TTX_DDRU_T                   	ttx_ddru;                     //0xc8006650L
	UINT32                             	reserved01[11];               //0xc8006654L~0xc800667cL
	M17A0_ADDR_DBG_T                   	addr_dbg;                     //0xc8006680L
	M17A0_A_TOP_STATUS_T               	a_top_status;                 //0xc8006684L
} DE_ATP_REG_M17A0_T;
