...
#include "../../chip/m17/apr/apr_reg_m17.h"
#endif
#if 0
#include "../../chip/m16/apr/apr_reg_m16.h"
#endif
#if 0
...
#endif
#if 0
	if (!LX_COMP_CHIP(lx_chip_rev(), LX_CHIP_M16) ) {
		ret = APR_M16_Init();
	} else
#endif
#if 0
...
#ifdef USE_KDRV_CODES_FOR_M17
	if (!LX_COMP_CHIP(lx_chip_rev(), LX_CHIP_M17) ) {
		ret = APR_M17_InitHardware();
	} else
#endif
#if 0
	if (!LX_COMP_CHIP(lx_chip_rev(), LX_CHIP_M16) ) {
		ret = APR_M16_InitHardware();
	} else
#endif
#if 0
	if (!LX_COMP_CHIP(lx_chip_rev(), LX_CHIP_H15) ) {
...
#ifdef USE_KDRV_CODES_FOR_M17
	if (!LX_COMP_CHIP(lx_chip_rev(), LX_CHIP_M17) ) {
		ret = APR_M17_CollectBasicData(apr_cfg, apr_data);
	} else
#endif
#if 0
	if (!LX_COMP_CHIP(lx_chip_rev(), LX_CHIP_M16) ) {
		ret = APR_M16_CollectBasicData(apr_cfg, apr_data);
	} else
#endif
#if 0
	if (!LX_COMP_CHIP(lx_chip_rev(), LX_CHIP_H15) ) {
...
#ifdef USE_KDRV_CODES_FOR_M17
	if (!LX_COMP_CHIP(lx_chip_rev(), LX_CHIP_M17) ) {
		ret = APR_M17_GetOVInfo(apr_cfg, ov_src, ov_info);
	} else
#endif
#if 0
	if (!LX_COMP_CHIP(lx_chip_rev(), LX_CHIP_M16) ) {
		ret = APR_M16_GetOVInfo(apr_cfg, ov_src, ov_info);
	} else
#endif
#if 0
	if (!LX_COMP_CHIP(lx_chip_rev(), LX_CHIP_H15) ) {
...
#ifdef USE_KDRV_CODES_FOR_M17
	if (!LX_COMP_CHIP(lx_chip_rev(), LX_CHIP_M17) ) {
		ret = APR_M17_GetHistInfo(hist_info);
	} else
#endif
#if 0
	if (!LX_COMP_CHIP(lx_chip_rev(), LX_CHIP_M16) ) {
		ret = APR_M16_GetHistInfo(hist_info);
	} else
#endif
#if 0
	if (!LX_COMP_CHIP(lx_chip_rev(), LX_CHIP_H15) ) {
...
#ifdef USE_KDRV_CODES_FOR_M17
	if (!LX_COMP_CHIP(lx_chip_rev(), LX_CHIP_M17) ) {
		ret = APR_M17_GetUSecTimerVal(tv);
	} else
#endif
#if 0
	if (!LX_COMP_CHIP(lx_chip_rev(), LX_CHIP_M16) ) {
		ret = APR_M16_GetUSecTimerVal(tv);
	} else
#endif
#if 0
	if (!LX_COMP_CHIP(lx_chip_rev(), LX_CHIP_H15) ) {
...
#ifdef USE_KDRV_CODES_FOR_M17
	if (!LX_COMP_CHIP(lx_chip_rev(), LX_CHIP_M17) ) {
		ret = APR_M17_SetFd3Config(apr_cfg);
	} else
#endif
#if 0
	if (!LX_COMP_CHIP(lx_chip_rev(), LX_CHIP_M16) ) {
		ret = APR_M16_SetFd3Config(apr_cfg);
	} else
#endif
#if 0
	if (!LX_COMP_CHIP(lx_chip_rev(), LX_CHIP_H15) ) {
...
#ifdef USE_KDRV_CODES_FOR_M17
	if (!LX_COMP_CHIP(lx_chip_rev(), LX_CHIP_M17) ) {
		ret = APR_M17_CollectFd3Data(apr_data);
	} else
#endif
#if 0
	if (!LX_COMP_CHIP(lx_chip_rev(), LX_CHIP_M16) ) {
		ret = APR_M16_CollectFd3Data(apr_data);
	} else
#endif
#if 0
	if (!LX_COMP_CHIP(lx_chip_rev(), LX_CHIP_H15) ) {
...
#ifdef USE_KDRV_CODES_FOR_M17
	if (!LX_COMP_CHIP(lx_chip_rev(), LX_CHIP_M17) ) {
		ret = APR_M17_DetectBlackBar(apr_cfg, apr_data);
	} else
#endif
#if 0
	if (!LX_COMP_CHIP(lx_chip_rev(), LX_CHIP_M16) ) {
		ret = APR_M16_DetectBlackBar(apr_cfg, apr_data);
	} else
#endif
#if 0
	if (!LX_COMP_CHIP(lx_chip_rev(), LX_CHIP_H15) ) {
...
#ifdef USE_KDRV_CODES_FOR_M17
	if (!LX_COMP_CHIP(lx_chip_rev(), LX_CHIP_M17) ) {
		ret = APR_M17_SetFd3SubtConfig(apr_cfg, alt_seg);
	} else
#endif
#if 0
	if (!LX_COMP_CHIP(lx_chip_rev(), LX_CHIP_M16) ) {
		ret = APR_M16_SetFd3SubtConfig(apr_cfg, alt_seg);
	} else
#endif
#if 0
	if (!LX_COMP_CHIP(lx_chip_rev(), LX_CHIP_H15) ) {
...
#ifdef USE_KDRV_CODES_FOR_M17
	if (!LX_COMP_CHIP(lx_chip_rev(), LX_CHIP_M17) ) {
		ret = APR_M17_SetCurrentInfo(apr_cfg, apr_data);
	} else
#endif
#if 0
	if (!LX_COMP_CHIP(lx_chip_rev(), LX_CHIP_M16) ) {
		ret = APR_M16_SetCurrentInfo(apr_cfg, apr_data);
	} else
#endif
#if 0
	if (!LX_COMP_CHIP(lx_chip_rev(), LX_CHIP_H15) ) {
