...
**
**  Description:   ABB L18F Digital AGC block.
**
**  Functions
**  Implemented:    LX_ADEMOD_Result DEMOD_L18F_Analog_DigAGC_Factory_Set
**                  LX_ADEMOD_Result DEMOD_L18F_Analog_DigAGC_Line_Set
**                  LX_ADEMOD_Result DEMOD_L18F_Analog_DigAGC_Flags_Set
**                  LX_ADEMOD_Result DEMOD_L18F_Analog_DigAGC_Flags_Get
**                  LX_ADEMOD_Result DEMOD_L18F_Analog_DigAGC_Standard_Set
**                  LX_ADEMOD_Result DEMOD_L18F_Analog_DigAGC_Init
**                  LX_ADEMOD_Result DEMOD_L18F_Analog_DigAGC_Start
**
**  References:
**
**  Exports:        LX_ADEMOD_Result DEMOD_L18F_Analog_DigAGC_Factory_Set
**                  LX_ADEMOD_Result DEMOD_L18F_Analog_DigAGC_Line_Set
**                  LX_ADEMOD_Result DEMOD_L18F_Analog_DigAGC_Flags_Set
**                  LX_ADEMOD_Result DEMOD_L18F_Analog_DigAGC_Flags_Get
**                  LX_ADEMOD_Result DEMOD_L18F_Analog_DigAGC_Standard_Set
...
**
*****************************************************************************/
#ifndef _ADEMOD_L18F_AGC_DIG_H_
#define _ADEMOD_L18F_AGC_DIG_H_
...
typedef struct LX_ADEMOD_DigAgc_tag {
	Handle_t		hDevice;   //jeongpil.yun for L18F
	UINT32			flags;
	UINT32			update;
	UINT32			factory;
	INT64			max_gain_rf;
