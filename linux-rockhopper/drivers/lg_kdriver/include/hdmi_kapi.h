...
@def HDMI_IOR_GET_HDR_INFO
Get HDMI DRM Information
*/
...
#define HDMI_IOR_GET_HDR_INFO				_IOR(HDMI_IOC_MAGIC,	75, LX_HDMI_RX_DRM_PACKET_T)
#define HDMI_IOW_ENABLE_ALWAYSONEDID		_IOW(HDMI_IOC_MAGIC,	76, UINT32)
#define HDMI_IOC_MAXNR				77
...
#define LX_HDMI_EARC_SIZE_OF_CAPS		256
#define LX_HDMI_AUDIO_SIZE_OF_CHANNEL 8
#define LX_HDMI_AUDIO_SIZE_OF_CHANNEL_STATUS 6
...
typedef enum
{
	...
	LX_HDMI_AVI_COLORSPACE_MAX		,		///< Max
...
typedef  enum
{
	...
	LX_HDMI_AUDIO_EAC3			= 14,		///< Enhanced AC3 Type.(EAC3 is added by TV Lab Request.(SCDCR-861, 2016.03.23))
	LX_HDMI_AUDIO_EAC3_ATMOS	= 15,		///< Enhanced AC3 ATMOS Type
	LX_HDMI_AUDIO_MAT			= 16,		///< MAT Type
	LX_HDMI_AUDIO_MAT_ATMOS		= 17,		///< MAT ATMOS Type
	LX_HDMI_AUDIO_TRUE_HD		= 18,		///< TRUE HD Type
	LX_HDMI_AUDIO_TRUE_HD_ATMOS = 19,		///< TRUE HD ATMOS Type

	LX_HDMI_AUDIO_AC3_IEC60958	= 200,		///< AC3 Type, IEC60958 Format(Internal Use)
	LX_HDMI_AUDIO_EAC3_IEC60958 = 201,		///< Enhanced AC3 Type, IEC60958 Format(Internal Use)
	LX_HDMI_AUDIO_DTS_HD		= 202,		///< DTS-HD Type(Internal Use)
	LX_HDMI_AUDIO_DTS_HD_HRA	= 203,		///< DTS-HD High Resolution Audio Type(Internal Use)

	/* Unknown */
	LX_HDMI_AUDIO_UNKNOWN_AC3			= 1003,		///< AC3 Type
	LX_HDMI_AUDIO_UNKNOWN_DTS			= 1004,		///< DTS Type
	LX_HDMI_AUDIO_UNKNOWN_AAC			= 1005,		///< AAC Type
	//LX_HDMI_AUDIO_UNKNOWN_DEFAULT		= 1006,		///< DEFAULT Type
	LX_HDMI_AUDIO_UNKNOWN_MPEG			= 1010, 		///< MPEG Type
	//LX_HDMI_AUDIO_UNKNOWN_DTS_HD_MA		= 1011,		///< DTS-HD MA Type
	//LX_HDMI_AUDIO_UNKNOWN_DTS_EXPRESS	= 1012,		///< DTS-Express Type
	//LX_HDMI_AUDIO_UNKNOWN_DTS_CD	 	= 1013,		///< DTS-CD Type
	LX_HDMI_AUDIO_UNKNOWN_EAC3			= 1014,		///< Enhanced AC3 Type.(EAC3 is added by TV Lab Request.(SCDCR-861, 2016.03.23))
	//LX_HDMI_AUDIO_UNKNOWN_EAC3_ATMOS	= 1015,		///< Enhanced AC3 ATMOS Type
	LX_HDMI_AUDIO_UNKNOWN_MAT			= 1016,		///< MAT Type
	//LX_HDMI_AUDIO_UNKNOWN_MAT_ATMOS		= 1017,		///< MAT ATMOS Type
	//LX_HDMI_AUDIO_UNKNOWN_TRUE_HD		= 1018,		///< TRUE HD Type
	//LX_HDMI_AUDIO_UNKNOWN_TRUE_HD_ATMOS = 1019,		///< TRUE HD ATMOS Type

	//LX_HDMI_AUDIO_UNKNOWN_AC3_IEC60958	= 1200,		///< AC3 Type, IEC60958 Format(Internal Use)
	//LX_HDMI_AUDIO_UNKNOWN_EAC3_IEC60958 = 1201,		///< Enhanced AC3 Type, IEC60958 Format(Internal Use)
	LX_HDMI_AUDIO_UNKNOWN_DTS_HD		= 1202,		///< DTS-HD Type(Internal Use)
	LX_HDMI_AUDIO_UNKNOWN_DTS_HD_HRA	= 1203,		///< DTS-HD High Resolution Audio Type(Internal Use)
...
/**
 * HDMI Audio Stream.
 * HDMI Audio Stream is defined.
 */
typedef  enum
{
	LX_HDMI_AUDIO_STREAM_NONE	= 0,		///< None
	LX_HDMI_AUDIO_STREAM_AUDS	= 1,		///< Audio Samples packet received
	LX_HDMI_AUDIO_STREAM_OBA	= 2,		///< One Bit Audio Sample packet received
	LX_HDMI_AUDIO_STREAM_DST	= 4,		///< DST Audio packet received
	LX_HDMI_AUDIO_STREAM_HBR	= 8,		///< High-Bit rate Audio Stream packet received
} LX_HDMI_AUDIO_STREAM_T;

/**
 * HDMI Audio Word length.
 * HDMI Audio Word length is defined.
 */
typedef  enum
{
	LX_HDMI_AUDIO_WORD_LENGTH_NONE	= 0,		///< None
	LX_HDMI_AUDIO_WORD_LENGTH_16	= 16,		///< 16 bit
	LX_HDMI_AUDIO_WORD_LENGTH_17	= 17,		///< 17 bit
	LX_HDMI_AUDIO_WORD_LENGTH_18	= 18,		///< 18 bit
	LX_HDMI_AUDIO_WORD_LENGTH_19	= 19,		///< 19 bit
	LX_HDMI_AUDIO_WORD_LENGTH_20	= 20,		///< 20 bit
	LX_HDMI_AUDIO_WORD_LENGTH_21	= 21,		///< 21 bit
	LX_HDMI_AUDIO_WORD_LENGTH_22	= 22,		///< 22 bit
	LX_HDMI_AUDIO_WORD_LENGTH_23	= 23,		///< 23 bit
	LX_HDMI_AUDIO_WORD_LENGTH_24	= 24		///< 24 bit
} LX_HDMI_AUDIO_WORD_LENGTH_T;
...
/**
 * HDMI eARC Status Info. Type.
 * HDMI eARC Status Information type is defined.
 */
typedef enum {
	LX_HDMI_EARC_STATUS__IDLE1		=	0,			///< IDLE1
	LX_HDMI_EARC_STATUS__IDLE2		=	1,			///< IDLE2
	LX_HDMI_EARC_STATUS__DISC1		=	2,			///< DISC1
	LX_HDMI_EARC_STATUS__DISC2		=	3,			///< DISC2
	LX_HDMI_EARC_STATUS__EARC 		=	4,			///< EARC
	LX_HDMI_EARC_STATUS__MAXIMUM	=	5
} LX_HDMI_EARC_STATUS_T;

/**
 * HDMI eARC Port Type.
 * HDMI eARC Port is defined.
 */
typedef enum {
    LX_HDMI_EARC_OUTPUT_PORT_NONE = 0,
    LX_HDMI_EARC_OUTPUT_PORT_1,
    LX_HDMI_EARC_OUTPUT_PORT_2,
    LX_HDMI_EARC_OUTPUT_PORT_3,
    LX_HDMI_EARC_OUTPUT_PORT_4,
    LX_HDMI_EARC_OUTPUT_PORT_ALL,
} LX_HDMI_EARC_OUTPUT_PORT_T;

/**
 * HDMI eARC Enable Type.
 * HDMI eARC Enable is defined.
 */
typedef enum {
    LX_HDMI_EARC_DISABLE = 0,
    LX_HDMI_EARC_ENABLE  = 1,
} LX_HDMI_EARC_ENABLE_T;
...
typedef  enum
{
	...
	LX_HDMI_COLOR_DEPTH_16,			///< Color depth 48 bits
	LX_HDMI_COLOR_DEPTH_MAXNUM
...
typedef struct {
	...
	UINT8	isDSC;					///< 0 : Off, 1: On
	UINT8	isQmsMode;				///< HDMI2.1 QMS
	UINT16	vFreqMin;				///< For VRR/FVA/FreeSync/Gsync case
	UINT16	vFreqMax;				///< For VRR/FVA/FreeSync/Gsync case
...
typedef struct
{
	...
	LX_HDMI_COLOR_DEPTH_T eColorDepth;		///< LX_HDMI_COLOR_DEPTH
...
typedef struct
{
  ...
  UINT32					countOfChannel; ///< The count of PCM channnel.
  LX_HDMI_AUDIO_STREAM_T	stream;			///< HDMI Audio Stream.
  LX_HDMI_AUDIO_WORD_LENGTH_T	wordLength;			///< HDMI Audio Word Length.
  UINT32					acr_n;
  UINT32					acr_cts;
  UINT32					pao_byte0;
  UINT32					pao_pc;
 ...
 * HDMI Auido and Video Info.
 * Get HDMI AUDIO AND VIDEO INFORMATION.
 * @see HDMI_IOR_GET_AUDIO_INFO_TYPE
 */
typedef struct
{
	UINT32		byte0;		///< byte0 param.
	UINT32		byte0_cnt;		
	UINT32		pc;			///< Pc param.
	UINT32		pc_cnt;		
} LX_HDMI_AUDIO_INFO_TYPE_T;

/**
 * hdmi ioctl parameter.
 * HDMI Auido and Video Info.
 * Get HDMI AUDIO AND VIDEO INFORMATION.
 * @see HDMI_IOR_GET_AUDIO_INFO_ACR
 */
typedef struct
{
  UINT32	n_param;
  UINT32	cts_param;
} LX_HDMI_AUDIO_INFO_ACR_T;

/**
 * hdmi ioctl parameter.
 * HDMI Auido and Video Info.
 * Get HDMI AUDIO AND VIDEO INFORMATION.
 * @see HDMI_IOR_GET_AUDIO_INFO_CHANNEL_STATUS
 */
typedef struct
{
  UINT32	subpacket[LX_HDMI_AUDIO_SIZE_OF_CHANNEL][LX_HDMI_AUDIO_SIZE_OF_CHANNEL_STATUS];
} LX_HDMI_AUDIO_INFO_CHANNEL_STATUS_T;
...
/**
 * hdmi eARC ioctl parameter.
 * HDMI EARC CONTROL.
 * @see HDMI_IOW_SET_ARC
 */
typedef struct {
  LX_HDMI_EARC_OUTPUT_PORT_T	portNum;		///< eARC Output Port Number.
  LX_HDMI_EARC_ENABLE_T			bEARCEnable;	///< eARC  0 : Off, 1 : On				
} LX_HDMI_EARC_CTRL_T;
...
typedef struct {
  LX_HDMI_EARC_OUTPUT_PORT_T	portNum;	  		///< eARC Output Port Number.
  LX_HDMI_EARC_STATUS_T			earcStatus;			///< eARC Status
  UINT8							capability[LX_HDMI_EARC_SIZE_OF_CAPS];///< eARC Rx Capability Structure.
  UINT8							latency_req;		///< eARC Tx Latency
  UINT8							latency;  			///< eARC Rx Latency
} LX_HDMI_EARC_CONNECTION_INFO_T;
...
typedef struct HDMI_PHY_INFORM {
	...
	int		hdmi_mode[5];		// < hdmi/dvi mode
	int 	hdmi5v[5];		//	< HDMI 5V detection on each ports
	int 	hpd_out[5];		//	< HPD out status on each ports
	int 	hpd_pol[5];		//	< HPD polarity on eash ports
	int 	hpd_in[5];		//	< HPD in status on each ports
	int		phy_pdb[5];		//  < PHY PDB inform on each ports
	int		phy_enable[5];		//  < PHY Enable inform on each ports
	int		phy_rstn[5];		//  < PHY Reset inform on each ports
	int 	edid_rd_done[5];		//  < EDID RD Done inform on each ports
	int 	scdt[5];				//  < SDCT inform on each ports
	UINT32		hdcp_authed[5];		//  < HDCP Authentication Done inform on each ports
	UINT32		hdcp_enc_en[5];		//  < HDCP Authentication Start inform on each ports
	...
	UINT32	tmds_clock[5];				// Phy TMDS Clock
	...
	int		rstn_edid[5];				// sw reset status of edid on each port
	int		tcs_done[5];				// tcs_done status of each port
	int		tcs_min[5][4];				// tcs_done status of each port
	int		tcs_max[5][4];				// tcs_done status of each port
	int		tcs_result[5][4];				// tcs_done status of each port
	int		tcs_add[5];				// tcs_done status of each port
	int		tcs_error[5][4];
	int		tcs_sync_recover[5][4];
	unsigned int ecc_error_count[5];				// ecc error interrupt count
	unsigned int hdcp_error_count[5];				// hdcp error interrupt count
	unsigned int terc4_error_count[5];				// terc4 error interrupt count
	unsigned int loop_count[5];				// counting loop count
	unsigned int scdt_detect_count[5];				// scdt detect count
	unsigned int scdt_fall_count[5];				// scdt fall interrupt count
	int		mhl_pp_mode;				// MHL PP mode
	int		mhl_mode_enable;			// MHL Mode Enable Flag
	int		hpd_hdcp22_control[5];		// HPD out control by HDCP2.2
	UINT32		hdcp22_status[5];		// HDCP 2.2 status register
	int		tcs_restart_count[5];		// tcs restart count of each port
	int		phy_accessible[5];
	int		cd_sense_org;				// < MHL Original CD Sence Detection flag
	int		set_low_power_mode[5];		// set phy low power mode
	int		status_low_power_mode[5];		//  phy low power mode status
...
typedef struct LX_HDMI_DRIVER_STATUS {
	...
	UINT32 Driver_Func_Revision;
	UINT32 Driver_Intr_Revision;
	UINT32 Driver_Audio_Revision;
	...
	LX_HDMI_INFO_PACKET_T intr_VSIPacket[2];	//VSI packet updated by interrupt for Dolby HDR
...
typedef struct
{
	...
	UINT8	metaData[32];
} LX_HDMI_RX_DRM_PACKET_T;

/**
 * hdmi ioctl parameter.
 * HDMI HDR INFO Parameter.
 * Get HDMI HDR INFO.
 * @see HDMI_IOR_GET_HDR_INFO
 */
typedef struct {
	int		prt_num;				/// < port selection information(-1: use previous selected port)
	LX_HDMI_RX_DRM_PACKET_T  hdr_packet;		///< hdr packet
} LX_HDMI_HDR_INFO_T;
/*----------------------------------------------------------------------------------------
