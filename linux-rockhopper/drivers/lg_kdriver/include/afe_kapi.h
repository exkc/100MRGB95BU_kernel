...
#define	AFE_IOR_GET_EVENT					_IOW(AFE_IOC_MAGIC, 84, LX_AFE_EVENT_T)
#define AFE_IOW_ADC_SET_OTP_DATA			_IOW(AFE_IOC_MAGIC, 85, LX_AFE_ADC_OTP_CAL_VALUE_T)
#define AFE_IOR_ADC_GET_OTP_DATA			_IOR(AFE_IOC_MAGIC, 86, LX_AFE_ADC_OTP_CAL_VALUE_T)
#define AFE_IOR_GET_OPEN_COUNT					_IOR(AFE_IOC_MAGIC, 87, UINT32)
#define AFE_IOC_MAXNR		88
/** @} */
...
typedef struct {
	...
	UINT32	llpll_phase_shift;		/// LLPLL Phase shift value 
	UINT32	g_gain_value;		/// post gain value(green)
	UINT32	sync_level;			/// component sync level (100% or 108%)
...
typedef struct {
	...
	BOOLEAN bEnableCompParams;	///< Set Component Parameters to 1080P 60Hz for better accuracy
...
typedef struct
{
	...
	UINT8	cvbs_pdbm;				/// < Power Down for Main Bias
...
typedef enum
{
	...
	ADC_TEST_WORKAROUND_CONTROL,
	ADC_TEST_GET_REVISION,
	ADC_TEST_LLPLL_RESET,
	ADC_TEST_CALIBRATION,
	ADC_TEST_IRE_LEVEL,
	ADC_TEST_DEBUG,
...
typedef struct
{
	...
	UINT32	workaround_number;
	UINT32	workaround_on_off;
	UINT32	adc_hw_revision;
	UINT32	adc_module_revision;
	UINT32	adc_control_revision;
	UINT32	adc_ire_value;
	UINT32	adc_test_debug_1;
	UINT32	adc_test_debug_2;
	UINT32	adc_test_debug_3;
...
/**
 * This enum is for AFE Event Structure
 * @see AFE_IOR_GET_EVENT
 */
typedef enum {
	LX_AFE_EVENT_NONE = 0,
	LX_AFE_EVENT_OTP_CAL_READ_FROM_SE = 1,
	LX_AFE_EVENT_OTP_CAL_TEST = 2,
	LX_AFE_EVENT_OTP_CAL_WRITE_TO_SE = 3,
} LX_AFE_EVENT_T;
 ...
 */
typedef struct {
	UINT16	R_Gain_Comp;	///< Red Gain Value
	UINT16	G_Gain_Comp;	///< Green Gain Value
	UINT16	B_Gain_Comp;	///< Blue Gain Value
	UINT16 R_Offset_Comp;	///< Red offset value
	UINT16 G_Offset_Comp;	///< Green offset value
	UINT16 B_Offset_Comp;	///< Blue offset value
	UINT16	R_Gain_RGB;		///< Red Gain Value
	UINT16	G_Gain_RGB;		///< Green Gain Value
	UINT16	B_Gain_RGB;		///< Blue Gain Value
	UINT16 R_Offset_RGB;	///< Red offset value
	UINT16 G_Offset_RGB;	///< Green offset value
	UINT16 B_Offset_RGB;	///< Blue offset value
} LX_AFE_ADC_OTP_CAL_VALUE_T;
