...
/*----------------------------------------------------------------------------------------
	global Functions
---------------------------------------------------------------------------------------*/
static int e60_irbs_enable = 1;
static int e60_irb_inited = 0;

module_param(e60_irbs_enable, int, S_IRUGO);
MODULE_PARM_DESC(e60_irbs_enable, "e60 irbs disable");


static irbs_e60_func_t* irb_e60_func = NULL;
 ...
 */
int e60_irb_ioctl_main (unsigned int cmd, unsigned long arg)
{
...
static int e60_irb_ioctl (unsigned int cmd, unsigned long arg)
{
	int ret = 0;
	...
	ret = e60_irb_ioctl_main(cmd, arg);

    return ret;
}

static int e60_irb_suspend(void)
{

	return 0;
}

static int e60_irb_resume(void)
{
	irb_e60_func = get_e60_irb_func();
	irb_e60_func->reinit();
...
static irbs_driver_t e60_irbs_driver =
{
	.init = e60_irb_init,
	.ioctl = e60_irb_ioctl,
	.suspend = e60_irb_suspend,
	.resume = e60_irb_resume,
};

irbs_driver_t* get_e60_irb_driver(void)
{
	return &e60_irbs_driver;
}
