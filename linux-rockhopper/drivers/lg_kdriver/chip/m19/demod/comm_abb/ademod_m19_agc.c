...
**                  LX_ADEMOD_Result DEMOD_M19_Analog_AGC_Options_Set
**                  LX_ADEMOD_Result DEMOD_M19_Analog_AGC_Options_Get
...
*/
static LX_ADEMOD_Result DEMOD_M19_Analog_AGC_Flags_Set(pLX_ADEMOD_Agc pContext, UINT32 Flags, Handle_t hUser, BOOL Update);

static LX_ADEMOD_Result DEMOD_M19_Analog_AGC_Reset(pLX_ADEMOD_Agc pContext, BOOL on_off, Handle_t hUser);

static LX_ADEMOD_Result DEMOD_M19_Analog_RFAGC_RFGainThrsh_Set(pLX_ADEMOD_Agc pContext);

static LX_ADEMOD_Result DEMOD_M19_Analog_RFAGC_IFGainThrsh_Set(pLX_ADEMOD_Agc pContext);

static LX_ADEMOD_Result DEMOD_M19_Analog_AGC_RFGainPreset_Set(pLX_ADEMOD_Agc pContext);

static LX_ADEMOD_Result DEMOD_M19_Analog_AGC_IFGainPreset_Set(pLX_ADEMOD_Agc pContext);

static LX_ADEMOD_Result DEMOD_M19_Analog_RFAGC_RfIIR_Shifts_Set(pLX_ADEMOD_Agc pContext, UINT32 RfIIR_BW);

static LX_ADEMOD_Result DEMOD_M19_Analog_RFAGC_LPF(pLX_ADEMOD_Agc pContext, UINT32 LPF_BW);

static LX_ADEMOD_Result DEMOD_M19_Analog_RFAGC_LPFGain_Shift(pLX_ADEMOD_Agc pContext, UINT32 LPFGain);

static LX_ADEMOD_Result DEMOD_M19_Analog_RFAGC_LoopGain(pLX_ADEMOD_Agc pContext,
									   UINT32 resp_time_poserr_RF,
									   UINT32 resp_time_negerr_RF,
									   UINT32 resp_time_poserr_IF,
									   UINT32 resp_time_negerr_IF);

static LX_ADEMOD_Result DEMOD_M19_Analog_RFAGC_BackOff(pLX_ADEMOD_Agc pContext, int BackOff_dB);

static LX_ADEMOD_Result DEMOD_M19_Analog_RFAGC_Attack(pLX_ADEMOD_Agc pContext, UINT32 Attack);

static LX_ADEMOD_Result DEMOD_M19_Analog_RFAGC_FastDecay(pLX_ADEMOD_Agc pContext, UINT32 DecayTimeOut_us);

static LX_ADEMOD_Result DEMOD_M19_Analog_RFAGC_Decay(pLX_ADEMOD_Agc pContext, UINT32 Decay_us);

static LX_ADEMOD_Result DEMOD_M19_Analog_RFAGC_DecFactor(pLX_ADEMOD_Agc pContext, UINT32 Dec_fs);

//static LX_ADEMOD_Result DEMOD_M19_Analog_DigAGC_FastDecay(pLX_ADEMOD_Agc pContext, UINT32 DecayTimeOut_us);

//static LX_ADEMOD_Result DEMOD_M19_Analog_RFAGC_RFGainDAC_Start(pLX_ADEMOD_Agc pContext, Handle_t hUser);

//static LX_ADEMOD_Result DEMOD_M19_Analog_RFAGC_IFGainDAC_Start(pLX_ADEMOD_Agc pContext, Handle_t hUser);
...
/******************************************************************************
**
**  Name: DEMOD_M19_Analog_AGC_Factory_Set
**
...
**
******************************************************************************/
LX_ADEMOD_Result DEMOD_M19_Analog_AGC_Factory_Set(pLX_ADEMOD_Agc pContext)
{
...
/******************************************************************************
**
**  Name: DEMOD_M19_Analog_AGC_Options_Set
**
...
**
******************************************************************************/
LX_ADEMOD_Result DEMOD_M19_Analog_AGC_Options_Set(pLX_ADEMOD_Agc pContext, UINT32 options, Handle_t hUser, BOOL Update)
{
    LX_ADEMOD_Result status = retOK; /*  Status to be returned.  */
	UINT32 flags = 0;
	...
	// update AGC flags
	status = DEMOD_M19_Analog_AGC_Flags_Set(pContext, flags, hUser, Update);
...
/******************************************************************************
**
**  Name: DEMOD_M19_Analog_AGC_Options_Get
**
**  Description:    Sets AGC flags.
**
**  Parameters:     pContext     - Pointer to the AGC context,
...
**
******************************************************************************/
LX_ADEMOD_Result DEMOD_M19_Analog_AGC_Options_Get(pLX_ADEMOD_Agc pContext, UINT32 *pValue, Handle_t hUser)
{
    LX_ADEMOD_Result status = retOK; /*  Status to be returned.  */
...
/******************************************************************************
**
**  Name: DEMOD_M19_Analog_AGC_MixedMode_Set
**
...
**
******************************************************************************/
LX_ADEMOD_Result DEMOD_M19_Analog_AGC_MixedMode_Set(pLX_ADEMOD_Agc pContext, UINT32 Mode, Handle_t hUser, BOOL Update)
{
    LX_ADEMOD_Result status = retOK; /*  Status to be returned.  */
	UINT32 flags = 0;
...
/******************************************************************************
**
**  Name: DEMOD_M19_Analog_AGC_MixedMode_Get
**
...
**
******************************************************************************/
LX_ADEMOD_Result DEMOD_M19_Analog_AGC_MixedMode_Get(pLX_ADEMOD_Agc pContext, UINT32 *pMode, Handle_t hUsere)
{
    LX_ADEMOD_Result status = retOK; /*  Status to be returned.  */
...
/******************************************************************************
**
**  Name: DEMOD_M19_Analog_Agc_Mode_Set
**
...
**
******************************************************************************/
LX_ADEMOD_Result DEMOD_M19_Analog_Agc_Mode_Set(pLX_ADEMOD_Agc pContext, UINT32 InputMode)
{
    LX_ADEMOD_Result status = retOK; /*  Status to be returned.  */
...
/******************************************************************************
**
**  Name: DEMOD_M19_Analog_AGC_Standard_Set
**
...
******************************************************************************/
LX_ADEMOD_Result DEMOD_M19_Analog_AGC_Standard_Set(pLX_ADEMOD_Agc pContext, UINT32 VideoStandard)
{
    LX_ADEMOD_Result status = retOK; /*  Status to be returned.  */
...
/******************************************************************************
**
**  Name: DEMOD_M19_Analog_AGC_Gain_Set
**
...
**
******************************************************************************/
LX_ADEMOD_Result DEMOD_M19_Analog_AGC_Gain_Set(pLX_ADEMOD_Agc pContext, UINT32 *pValue, Handle_t hUser, BOOL Update)
{
    LX_ADEMOD_Result status = retOK; /*  Status to be returned.  */
...
/******************************************************************************
**
**  Name: DEMOD_M19_Analog_AGC_Gain_Get
**
...
**
******************************************************************************/
LX_ADEMOD_Result DEMOD_M19_Analog_AGC_Gain_Get(pLX_ADEMOD_Agc pContext, UINT32 *pValue, Handle_t hUser)
{
    LX_ADEMOD_Result status = retOK; /*  Status to be returned.  */
...
/******************************************************************************
**
**  Name: DEMOD_M19_Analog_AGC_GainThrsh_Set
**
...
**
******************************************************************************/
LX_ADEMOD_Result DEMOD_M19_Analog_AGC_GainThrsh_Set(pLX_ADEMOD_Agc pContext, UINT32 *pValue, Handle_t hUser, BOOL Update)
{
    LX_ADEMOD_Result status = retOK; /*  Status to be returned.  */
	...
	switch (pValue[0]) {
		...
		case LX_ADEMOD_AGC_MODE_RF:
			...
			if (pValue[1] == LX_ADEMOD_PRESET_OPTION_NONE) {
				...
				status = DEMOD_M19_Analog_RFAGC_RFGainThrsh_Set(pContext);
			}
			if (Update) {
		...
		case LX_ADEMOD_AGC_MODE_IF:
			...
			if (pValue[1] == LX_ADEMOD_PRESET_OPTION_NONE) {
				...
				status = DEMOD_M19_Analog_RFAGC_IFGainThrsh_Set(pContext);
			}
			if (Update) {
...
/******************************************************************************
**
**  Name: DEMOD_M19_Analog_AGC_GainThrsh_Get
**
...
**
******************************************************************************/
LX_ADEMOD_Result DEMOD_M19_Analog_AGC_GainThrsh_Get(pLX_ADEMOD_Agc pContext, UINT32 *pValue, Handle_t hUser)
{
    LX_ADEMOD_Result status = retOK; /*  Status to be returned.  */
...
/******************************************************************************
**
**  Name: DEMOD_M19_Analog_AGC_GainPreset_Set
**
...
**
******************************************************************************/
LX_ADEMOD_Result DEMOD_M19_Analog_AGC_GainPreset_Set(pLX_ADEMOD_Agc pContext, UINT32 *pValue, Handle_t hUser, BOOL Update)
{
    LX_ADEMOD_Result status = retOK; /*  Status to be returned.  */
	...
	switch (pValue[0]) {
		...
		case LX_ADEMOD_AGC_MODE_RF:
			...
			if (pValue[1] == LX_ADEMOD_PRESET_OPTION_NONE) {
				...
				status = DEMOD_M19_Analog_AGC_RFGainPreset_Set(pContext);
			}
			if (Update) {
		...
		case LX_ADEMOD_AGC_MODE_IF:
			...
			if (pValue[1] == LX_ADEMOD_PRESET_OPTION_NONE) {
				...
				status = DEMOD_M19_Analog_AGC_IFGainPreset_Set(pContext);
			}
			if (Update) {
...
/******************************************************************************
**
**  Name: DEMOD_M19_Analog_AGC_GainPreset_Get
**
...
**
******************************************************************************/
LX_ADEMOD_Result DEMOD_M19_Analog_AGC_GainPreset_Get(pLX_ADEMOD_Agc pContext, UINT32 *pValue, Handle_t hUser)
{
    LX_ADEMOD_Result status = retOK; /*  Status to be returned.  */
...
/******************************************************************************
**
**  Name: DEMOD_M19_Analog_AGC_RFIIR_Bndw_Set
**
...
**
******************************************************************************/
LX_ADEMOD_Result DEMOD_M19_Analog_AGC_RFIIR_Bndw_Set(pLX_ADEMOD_Agc pContext, UINT32 *pValue, Handle_t hUser, BOOL Update)
{
    LX_ADEMOD_Result status = retOK; /*  Status to be returned.  */
	...
	if (status == retOK) {
		status = DEMOD_M19_Analog_RFAGC_RfIIR_Shifts_Set(pContext, pContext->rf.rfiir_bw);
	}
...
/******************************************************************************
**
**  Name: DEMOD_M19_Analog_AGC_RFIIR_Bndw_Get
**
**  Description:    Sets AGC RF IIR bandwidth.
**
**  Parameters:     pContext     - Pointer to AGC context,
...
**
******************************************************************************/
LX_ADEMOD_Result DEMOD_M19_Analog_AGC_RFIIR_Bndw_Get(pLX_ADEMOD_Agc pContext, UINT32 *pValue, Handle_t hUser)
{
    LX_ADEMOD_Result status = retOK; /*  Status to be returned.  */
...
/******************************************************************************
**
**  Name: DEMOD_M19_Analog_AGC_LPD_Speed_Set
**
...
**
******************************************************************************/
LX_ADEMOD_Result DEMOD_M19_Analog_AGC_LPD_Speed_Set(pLX_ADEMOD_Agc pContext, UINT32 *pValue, Handle_t hUser, BOOL Update)
{
    LX_ADEMOD_Result status = retOK; /*  Status to be returned.  */
	UINT64 temp = 0;
	UINT64 temp1 = 0;
	...
	if (status == retOK) {
		status = DEMOD_M19_Analog_RFAGC_Attack(pContext, pContext->rf.leaky_pd_attack);
	}
...
/******************************************************************************
**
**  Name: DEMOD_M19_Analog_AGC_LPD_Decay_Set
**
...
**
******************************************************************************/
LX_ADEMOD_Result DEMOD_M19_Analog_AGC_LPD_Decay_Set(pLX_ADEMOD_Agc pContext, UINT32 *pValue, Handle_t hUser, BOOL Update)
{
    LX_ADEMOD_Result status = retOK; /*  Status to be returned.  */
	...
	if (status == retOK) {
		status = DEMOD_M19_Analog_RFAGC_Decay(pContext, pContext->rf.leaky_pd_decay);
	}
...
/******************************************************************************
**
**  Name: DEMOD_M19_Analog_AGC_LPD_FastDecay_Set
**
...
**
******************************************************************************/
LX_ADEMOD_Result DEMOD_M19_Analog_AGC_LPD_FastDecay_Set(pLX_ADEMOD_Agc pContext, UINT32 *pValue, Handle_t hUser, BOOL Update)
{
    LX_ADEMOD_Result status = retOK; /*  Status to be returned.  */
...
/******************************************************************************
**
**  Name: DEMOD_M19_Analog_AGC_LPD_DecayWindow_Set
**
...
**
******************************************************************************/
LX_ADEMOD_Result DEMOD_M19_Analog_AGC_LPD_DecayWindow_Set(pLX_ADEMOD_Agc pContext, UINT32 *pValue, Handle_t hUser, BOOL Update)
{
    LX_ADEMOD_Result status = retOK; /*  Status to be returned.  */
	...
	if (status == retOK) {
		status = DEMOD_M19_Analog_RFAGC_FastDecay(pContext, pContext->rf.leaky_pd_decaywin);
	}
...
/******************************************************************************
**
**  Name: DEMOD_M19_Analog_AGC_LPD_DecayThresh_Set
**
...
**
******************************************************************************/
LX_ADEMOD_Result DEMOD_M19_Analog_AGC_LPD_DecayThresh_Set(pLX_ADEMOD_Agc pContext, UINT32 *pValue, Handle_t hUser, BOOL Update)
{
    LX_ADEMOD_Result status = retOK; /*  Status to be returned.  */
...
/******************************************************************************
**
**  Name: DEMOD_M19_Analog_AGC_LPD_DecFactor_Set
**
...
**
******************************************************************************/
LX_ADEMOD_Result DEMOD_M19_Analog_AGC_LPD_DecFactor_Set(pLX_ADEMOD_Agc pContext, UINT32 *pValue, Handle_t hUser, BOOL Update)
{
    LX_ADEMOD_Result status = retOK; /*  Status to be returned.  */
	...
	if (status == retOK) {
		status = DEMOD_M19_Analog_RFAGC_DecFactor(pContext, pContext->rf.dec_fs);
	}
...
/******************************************************************************
**
**  Name: DEMOD_M19_Analog_AGC_InstabGainAdj_Set
**
...
**
******************************************************************************/
LX_ADEMOD_Result DEMOD_M19_Analog_AGC_InstabGainAdj_Set(pLX_ADEMOD_Agc pContext, UINT32 *pValue, Handle_t hUser, BOOL Update)
{
    LX_ADEMOD_Result status = retOK; /*  Status to be returned.  */
...
/******************************************************************************
**
**  Name: DEMOD_M19_Analog_AGC_RF_Bndw_Set
**
...
**
******************************************************************************/
LX_ADEMOD_Result DEMOD_M19_Analog_AGC_RF_Bndw_Set(pLX_ADEMOD_Agc pContext, UINT32 *pValue, Handle_t hUser, BOOL Update)
{
    LX_ADEMOD_Result status = retOK; /*  Status to be returned.  */
	...
	if (status == retOK) {
		status = DEMOD_M19_Analog_RFAGC_LPF(pContext, pContext->rf.lpf_bw);
	}
...
/******************************************************************************
**
**  Name: DEMOD_M19_Analog_AGC_RF_Speed_Set
**
...
**
******************************************************************************/
LX_ADEMOD_Result DEMOD_M19_Analog_AGC_RF_Speed_Set(pLX_ADEMOD_Agc pContext, UINT32 *pValue, Handle_t hUser, BOOL Update)
{
    LX_ADEMOD_Result status = retOK; /*  Status to be returned.  */
	...
	if (status == retOK) {
		...
		status = DEMOD_M19_Analog_RFAGC_LoopGain(pContext,
...
/******************************************************************************
**
**  Name: DEMOD_M19_Analog_AGC_RF_Speed_Get
**
...
**
******************************************************************************/
LX_ADEMOD_Result DEMOD_M19_Analog_AGC_RF_Speed_Get(pLX_ADEMOD_Agc pContext, UINT32 *pValue, Handle_t hUser)
{
    LX_ADEMOD_Result status = retOK; /*  Status to be returned.  */
...
/******************************************************************************
**
**  Name: DEMOD_M19_Analog_AGC_RF_Backoff_Set
**
...
**
******************************************************************************/
LX_ADEMOD_Result DEMOD_M19_Analog_AGC_RF_Backoff_Set(pLX_ADEMOD_Agc pContext, UINT32 *pValue, Handle_t hUser, BOOL Update)
{
    LX_ADEMOD_Result status = retOK; /*  Status to be returned.  */
	...
	if (status == retOK) {
		status = DEMOD_M19_Analog_RFAGC_BackOff(pContext, pContext->rf.backoff);
	}
...
/******************************************************************************
**
**  Name: DEMOD_M19_Analog_AGC_RF_Backoff_Get
**
**  Description:    Sets AGC RF backoff.
**
**  Parameters:     pContext     - Pointer to AGC context,
...
**
******************************************************************************/
LX_ADEMOD_Result DEMOD_M19_Analog_AGC_RF_Backoff_Get(pLX_ADEMOD_Agc pContext, UINT32 *pValue, Handle_t hUser)
{
    LX_ADEMOD_Result status = retOK; /*  Status to be returned.  */
...
/******************************************************************************
**
**  Name: DEMOD_M19_Analog_AGC_Dither_Set
**
**  Description:    Sets AGC preset gain mode / value.
**
**  Parameters:     pContext     - Pointer to AGC context,
...
**
******************************************************************************/
LX_ADEMOD_Result DEMOD_M19_Analog_AGC_Dither_Set(pLX_ADEMOD_Agc pContext, UINT32 *pValue, Handle_t hUser, BOOL Update)
{
    LX_ADEMOD_Result status = retOK; /*  Status to be returned.  */
...
/******************************************************************************
**
**  Name: DEMOD_M19_Analog_AGC_InstabThresh_Set
**
...
**
******************************************************************************/
LX_ADEMOD_Result DEMOD_M19_Analog_AGC_InstabThresh_Set(pLX_ADEMOD_Agc pContext, UINT32 *pValue, Handle_t hUser, BOOL Update)
{
    LX_ADEMOD_Result status = retOK; /*  Status to be returned.  */
...
/******************************************************************************
**
**  Name: DEMOD_M19_Analog_AGC_Parameters_Set
**
...
**
******************************************************************************/
LX_ADEMOD_Result DEMOD_M19_Analog_AGC_Parameters_Set(pLX_ADEMOD_Agc pContext, UINT32 *pValue, Handle_t hUser, BOOL Update)
{
    LX_ADEMOD_Result status = retOK; /*  Status to be returned.  */
...
//	pContext->audio.peak_adj		= pValue[21];
	...
	if (Update) {
		status  = DEMOD_M19_Analog_AGC_Reset(pContext, TRUE, hUser);
...
//		ADEMOD_WriteSub( hUser, AGCMAGREFERENCE_SC1,     pContext->audio.mag_ref, 2);
		status  = DEMOD_M19_Analog_AGC_Reset(pContext, FALSE, hUser);
...
/******************************************************************************
**
**  Name: DEMOD_M19_Analog_AGC_Parameters_Get
**
...
**
******************************************************************************/
LX_ADEMOD_Result DEMOD_M19_Analog_AGC_Parameters_Get(pLX_ADEMOD_Agc pContext, UINT32 *pValue, Handle_t hUser)
{
    LX_ADEMOD_Result status = retOK; /*  Status to be returned.  */
...
/******************************************************************************
**
**  Name: DEMOD_M19_Analog_AGC_Init
**
...
**
******************************************************************************/
LX_ADEMOD_Result DEMOD_M19_Analog_AGC_Init(pLX_ADEMOD_Agc pContext, Handle_t hUser)
{
    LX_ADEMOD_Result status = retOK; /*  Status to be returned.  */
...
/******************************************************************************
**
**  Name: DEMOD_M19_Analog_AGC_Start
**
...
**
******************************************************************************/
LX_ADEMOD_Result DEMOD_M19_Analog_AGC_Start(pLX_ADEMOD_Agc pContext, Handle_t hUser)
{
    LX_ADEMOD_Result status = retOK; /*  Status to be returned.  */
	UINT8 AgcCntr;
	UINT8 AgcCntr_SC1;
...
/******************************************************************************
**
**  Name: DEMOD_M19_Analog_AGC_Flags_Set
**
**  Description:    Sets AGC flags.
**
**  Parameters:     pContext     - Pointer to the AGC context,
...
/******************************************************************************
**
**  Name: DEMOD_M19_Analog_RFAGC_RFGainDAC_Start
**
...
/******************************************************************************
**
**  Name: DEMOD_M19_Analog_RFAGC_IFGainDAC_Start
**
...
/******************************************************************************
**
**  Name: DEMOD_M19_Analog_RFAGC_RFGainThrsh_Set
**
...
/******************************************************************************
**
**  Name: DEMOD_M19_Analog_RFAGC_IFGainThrsh_Set
**
...
/******************************************************************************
**
**  Name: DEMOD_M19_Analog_AGC_RFGainPreset_Set
**
...
/******************************************************************************
**
**  Name: DEMOD_M19_Analog_AGC_IFGainPreset_Set
**
...
/******************************************************************************
**
**  Name: DEMOD_M19_Analog_RFAGC_RfIIR_Shifts_Set
**
...
/******************************************************************************
**
**  Name: DEMOD_M19_Analog_RFAGC_LPF
**
...
/******************************************************************************
**
**  Name: DEMOD_M19_Analog_RFAGC_LPFGain_Shift
**
...
/******************************************************************************
**
**  Name: DEMOD_M19_Analog_RFAGC_LoopGain
**
									   ...
									   UINT32 resp_time_negerr_IF)
{
	...
	DEMOD_M19_Analog_RFAGC_LPFGain_Shift(pContext, (UINT32)LPFGain_poserr_RF);
	pContext->rf.lpf_gain_perr_rf = (UINT16)(pContext->rf.LPFGain_Shift2 * 32 + pContext->rf.LPFGain_Shift1);

	DEMOD_M19_Analog_RFAGC_LPFGain_Shift(pContext, (UINT32)LPFGain_negerr_RF);
	pContext->rf.lpf_gain_nerr_rf = (UINT16)(pContext->rf.LPFGain_Shift2 * 32 + pContext->rf.LPFGain_Shift1);

	DEMOD_M19_Analog_RFAGC_LPFGain_Shift(pContext, (UINT32)LPFGain_poserr_IF);
	pContext->rf.lpf_gain_perr_if = (UINT16)(pContext->rf.LPFGain_Shift2 * 32 + pContext->rf.LPFGain_Shift1);

	DEMOD_M19_Analog_RFAGC_LPFGain_Shift(pContext, (UINT32)LPFGain_negerr_IF);
...
/******************************************************************************
**
**  Name: DEMOD_M19_Analog_RFAGC_BackOff
**
...
/******************************************************************************
**
**  Name: DEMOD_M19_Analog_RFAGC_Attack
**
...
/******************************************************************************
**
**  Name: DEMOD_M19_Analog_RFAGC_FastDecay
**
...
/******************************************************************************
**
**  Name: DEMOD_M19_Analog_RFAGC_Decay
**
...
**
******************************************************************************/
LX_ADEMOD_Result DEMOD_M19_Analog_RFAGC_SampleRate_Set(pLX_ADEMOD_Agc pContext, UINT32 Value)
{
    LX_ADEMOD_Result status = retOK; /*  Status to be returned.  */
...
/******************************************************************************
**
**  Name: DEMOD_M19_Analog_RFAGC_DecFactor
**
...
/******************************************************************************
**
**  Name: DEMOD_M19_Analog_AGC_Reset
**
