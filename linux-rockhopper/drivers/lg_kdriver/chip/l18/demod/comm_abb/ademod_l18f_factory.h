...
#ifndef _ADEMOD_L18F_FACTORY_H_
#define _ADEMOD_L18F_FACTORY_H_
...
/******************************************************************************
**
**  Name: DEMOD_L18F_Analog_Factory_Table_Get
**
...
**
******************************************************************************/
LX_ADEMOD_Result DEMOD_L18F_Analog_Factory_Table_Get(pLX_ADEMOD_Demod_Instance pContext, const LX_ADEMOD_FACTORY_SETTINGS **Table, UINT32 *Size);

#if defined( __cplusplus )
}
#endif

#endif //_ADEMOD_L18F_FACTORY_H_
