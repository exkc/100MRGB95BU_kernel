...
#ifndef	_IRB_M23_COMMON_H_
#define	_IRB_M23_COMMON_H_
...
#define M23_IRB_BASE 0xf9600000



typedef struct m23_irb_unit
{
...
typedef struct m23_irb
{
  ...
  m23_irb_unit_t prot_data[31];
  m23_irb_unit_t rpt_data[2];
} m23_irb_t;
...
extern unsigned int  m23_get_micom_disable(void);
