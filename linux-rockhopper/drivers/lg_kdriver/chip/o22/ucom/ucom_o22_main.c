...
static void o22_ucom_init(void);
static void o22_ucom_chipreset(void);
...
/*----------------------------------------------------------------------------------------
	global Functions
---------------------------------------------------------------------------------------*/
static int o22_ucom_enable = 1;
static int o22_ucom_inited = 0;

module_param(o22_ucom_enable, int, S_IRUGO);
MODULE_PARM_DESC(o22_ucom_enable, "ucom enable");

static ucom_o22_func_t* ucom_o22_func = NULL;
extern void __iomem *o22_micom_eeprom_base;
...
========================================================================================*/
int o22_ucom_ioctl_main (unsigned int cmd, unsigned long arg, struct file *file);
struct file * o22_ucom_getfp(void);
...
static int o22_ucom_ioctl (unsigned int cmd, unsigned long arg, struct file *file)
{
	int ret = 0;

	if ((_IOC_TYPE(cmd) != UCOM_IOC_MAGIC) )
		return -EINVAL;
	if(o22_get_micom_disable() == 1)
	{
		KDRV_UCOM_DEBUG("skip micom[%d]\n",o22_get_micom_disable());
		return 0;
	}
	ret = o22_ucom_ioctl_main(cmd, arg, file);

    return ret;
}

static int o22_ucom_suspend(void)
{
...
static int o22_ucom_resume(void)
{
	unsigned int reg = 0;
...
static void o22_ucom_init(void)
{
	...
	if(o22_ucom_inited == 0)
	{
		KDRV_UCOM_LOCK_INIT();
		ucom_o22_func = get_o22_ucom_func();
		ucom_o22_func->init();
		o22_ucom_inited = 1;
	}
...
{
	ucom_o22_func = get_o22_ucom_func();
	ucom_o22_func->chipreset();
	return;
}
static ucom_driver_t o22_ucom_driver =
{
	.init = o22_ucom_init,
	.ioctl = o22_ucom_ioctl,
	.suspend = o22_ucom_suspend,
	.resume = o22_ucom_resume,
	.getfp = o22_ucom_getfp,
};

ucom_driver_t* get_o22_ucom_driver(void)
{
	return &o22_ucom_driver;
}
