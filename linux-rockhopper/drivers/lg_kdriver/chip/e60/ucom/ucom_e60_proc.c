...
/*----------------------------------------------------------------------------------------
	global Variables
----------------------------------------------------------------------------------------*/
//static ucom_e60_gov_t* ucom_e60_gov = NULL;
...
static ucom_e60_func_t * ucom_func;
...
static OS_PROC_DESC_TABLE_T	_g_ucom_e60_device_proc_table[] =
{
...
int	e60_read_proc(UINT32 procId, char* buffer )
{
	int	status=0,ret = 0 ;
...
int e60_write_proc( UINT32 procId, char* command )
{
	int ret = 0;
	switch( procId ) {
 ...
 * @see UCOM_Init
*/
void e60_ucom_proc_init (void)
{
	ucom_func	= get_e60_ucom_func();
	ucom_drv =  get_e60_ucom_driver();


	OS_PROC_CreateEntryEx ( UCOM_MODULE, _g_ucom_e60_device_proc_table,
										e60_read_proc,
										e60_write_proc );
 ...
 * @see UCOM_Cleanup
*/
void e60_ucom_proc_cleanup (void)
{
	OS_PROC_RemoveEntry( UCOM_MODULE );
}

static ucom_proc_t e60_proc_func =
{
	.init = e60_ucom_proc_init,
	.cleanup = e60_ucom_proc_cleanup,
};

ucom_proc_t* get_e60_ucom_proc(void)
{
