...
int DEMOD_O24_Get_UART(BOOLEAN *pStatus){
	return RET_OK;
}

int DEMOD_O24_Set_UART(int enable){
	return RET_OK;
}

int DEMOD_O24_Get_JTAG(BOOLEAN *pStatus){
	return RET_OK;
}

int DEMOD_O24_Set_JTAG(int enable){
	return RET_OK;
}

int DEMOD_O24_Get_Trace(char * pDbglog, int * pDbgidx){
	return RET_OK;
}

int DEMOD_O24_Set_Trace(int enable){
	return RET_OK;
}

int DEMOD_O24_MCU_Set_UART(int enable){
	return RET_OK;
}

int DEMOD_O24_MCU_Set_UART_Speed(int speed) {
	return RET_OK;
}

int DEMOD_O24_MCU_Set_UART_HEX(int enable){
	return RET_OK;
}
...
static UINT32 _dbb_reg_addr = O24_DBB_IP_BASE;
...
static int _demod_chip_write_proc (UINT32 procId, char* command)
{
	...
	switch(procId) 	{
		case PROC_ID_TEST: {
			...
			DEMOD_O24_IPC_Send(CMD_TYPE(CMD_MAJOR_TYPE_TEST, arg1), 0, NULL, 0);
		}
		break;
