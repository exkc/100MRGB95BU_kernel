...
#define GFX_WRITE_REG(reg,val)  \
    __raw_writel(val , (volatile void*)((ULONG)(g_gfx_reg_o22) + (ULONG)OFFSET(GFX_O22_REG_T,reg)))

#define GFX_READ_REG(reg)   \
    __raw_readl( (volatile void*)((ULONG)(g_gfx_reg_o22) + (ULONG)OFFSET(GFX_O22_REG_T,reg)))
