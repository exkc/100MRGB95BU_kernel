...
#ifndef __SLT_O18_H__
#define __SLT_O18_H__
...
#include "../sys/ctop_ctrl_reg_o18_a0.h"

#define SLT_VSD
//
#ifdef SLT_VSD
#define O18_SLT_REG_T		VSD_CRC_REG_O18_A0
#define O18_IRQ_SLT			(O18_IRQ_INTR_CRC0)
#define O18_SLT_BASE		(O18_CRC_VSD_BASE)
#else
#define O18_SLT_REG_T		DPE_CRC_REG_O18_A0
#define O18_IRQ_SLT			(O18_IRQ_INTR_CRC1)
#define O18_SLT_BASE		(O18_CRC_DPE_BASE)
#endif
...
static volatile O18_SLT_REG_T		*SLT_REG = NULL;
static volatile O18_SLT_REG_T		SLT_REG_Shadow[1];
