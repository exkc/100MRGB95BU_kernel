...
typedef struct {
	...
	int (*get_irq_num_ex)(UINT32 *irq_num, UINT32 num);
	...
	int (*clear_ipc_intr_status2)(UINT32 type);
	int (*clear_ipc_intr_status3)(UINT32 type);
	int (*clear_wdg_status)(UINT32 mcu_id, BOOLEAN turnOn);
	int (*cleanup_status)(UINT32 mcu_id);
	int (*wakeup_ipc)(UINT32 mcu_id, VIDEO_IPC_TYPE_T ipcType, BOOLEAN turnOn);
	int (*init_ipc)(UINT32 mcu_id, void **pBuffToMCU, void **pBuffFrMCU);
	int (*free_ipc)(void **pBuffToMCU, void **pBuffFrMCU);
	int (*init_interrupt)(UINT32 mcu_id, BOOLEAN intr_en);
	BOOLEAN (*check_irq4vsync)(UINT32 mcu_id);
	int (*get_mute_status)(UINT32 win_id, UINT32 *mute_status);
	int (*get_fw_status)(UINT32 win_id, void *status);
	int (*ctop_intr)(void);
} ipc_reg_cb_t;
...
int ipc_phys_hal_CTOPIntr(void);
