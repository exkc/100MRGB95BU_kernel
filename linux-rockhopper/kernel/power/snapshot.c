...
void __init hibernate_image_size_init(void)
{
	...
	/*
	 * Set preferred image size to 256MB.
	 * This is a lgsnap specific configuration that considers lz4
	 * compression. This can be tuned via /sys/power/image_size
	 */
...
int hibernate_preallocate_memory(void)
{
 ...
 out:
	stop = ktime_get();
	pr_info("Allocated %lu pages for snapshot. shrunk %lu pages\n", pages, memory_shrunk);
