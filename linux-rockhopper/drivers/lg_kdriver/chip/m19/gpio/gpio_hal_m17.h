...
#ifndef	_GPIO_DRV_HAL_M17_A0_H_
#define	_GPIO_DRV_HAL_M17_A0_H_
...
extern UINT32 		gpio_intr_num_m17[GPIO_IRQ_NUM_NR];
extern void _GPIO_ISR_GPIO_M17( unsigned int ui32IRQNum, unsigned int IntData );
