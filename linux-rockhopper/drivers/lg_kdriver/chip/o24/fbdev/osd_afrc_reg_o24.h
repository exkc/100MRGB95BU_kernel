...
#ifndef __OSD_AFRC_REG_O24_H__
#define __OSD_AFRC_REG_O24_H__
...
/* 33 regs, 33 types in Total*/

// *INDENT-ON*

#define OSD_AFRC_CTRL_RdFL(idx,_r)                  ((g_osd_afrc_o24_reg_shadow[idx]->_r)=(g_osd_afrc_o24_reg[idx]->_r))
#define OSD_AFRC_CTRL_WrFL(idx,_r)                  ((g_osd_afrc_o24_reg[idx]->_r)=(g_osd_afrc_o24_reg_shadow[idx]->_r))

#define OSD_AFRC_CTRL_Rd(idx,_r)                    *((UINT32*)(&(g_osd_afrc_o24_reg_shadow[idx]->_r)))
#define OSD_AFRC_CTRL_Wr(idx,_r,_v)                 ((OSD_AFRC_CTRL_Rd(idx,_r))=((UINT32)(_v)))

#define OSD_AFRC_CTRL_Rd01(idx,_r,_f01,_v01)                                            \
                                do {                                                    \
                                    (_v01) = (g_osd_afrc_o24_reg_shadow[idx]->_r._f01); \
                                } while(0)

#define OSD_AFRC_CTRL_Rd02(idx,_r,_f01,_v01,_f02,_v02)                                  \
                                do {                                                    \
                                    (_v01) = (g_osd_afrc_o24_reg_shadow[idx]->_r._f01); \
                                    (_v02) = (g_osd_afrc_o24_reg_shadow[idx]->_r._f02); \
                                } while(0)

#define OSD_AFRC_CTRL_Wr01(idx,_r,_f01,_v01)                                            \
                                do {                                                    \
                                    (g_osd_afrc_o24_reg_shadow[idx]->_r._f01) = (_v01); \
                                } while(0)

#define OSD_AFRC_CTRL_Wr02(idx,_r,_f01,_v01,_f02,_v02)                                  \
                                do {                                                    \
                                    (g_osd_afrc_o24_reg_shadow[idx]->_r._f01) = (_v01); \
                                    (g_osd_afrc_o24_reg_shadow[idx]->_r._f02) = (_v02); \
                                } while(0)

/** @} *//* end of macro documentation */

extern volatile OSD_AFRC_O24_REG_T*     g_osd_afrc_o24_reg[2];
extern OSD_AFRC_O24_REG_T*              g_osd_afrc_o24_reg_shadow[2];
...
/* from 'O24-A0_PQE_OSD_AFRC_reg_man.csv' 20230407 14:38:16 KST by getregs v2.9 */
