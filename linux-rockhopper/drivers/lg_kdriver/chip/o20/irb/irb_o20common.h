...
#ifndef	_IRB_O20_COMMON_H_
#define	_IRB_O20_COMMON_H_
...
#define O20_IRB_BASE 0xf9600000



typedef struct o20_irb_unit
{
...
typedef struct o20_irb
{
  ...
  o20_irb_unit_t prot_data[31];
  o20_irb_unit_t rpt_data[2];
} o20_irb_t;
...
extern unsigned int  get_ucom_disable_kdrv(void);
