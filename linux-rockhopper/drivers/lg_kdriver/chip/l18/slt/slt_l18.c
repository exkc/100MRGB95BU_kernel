...
#define L18_IRQ_SLT			(L18_IRQ_INTR_CRC0)
#define L18_SLT_BASE		(L18_CRC_DPE_BASE)
...
static int slt_open( void )
{
	...
	SLT_REG = (volatile L18_SLT_REG_T*)ioremap(L18_SLT_BASE, sizeof(L18_SLT_REG_T));
#if LINUX_VERSION_CODE >= KERNEL_VERSION(4,4,0)
	ret = request_irq(L18_IRQ_SLT, (irq_handler_t)slt_isr, NULL, "SLT", NULL);
#else
	ret = request_irq(L18_IRQ_SLT, (irq_handler_t)slt_isr, IRQF_DISABLED, "SLT", NULL);
#endif
	if( ret != RET_OK )
	{
