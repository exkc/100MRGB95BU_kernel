#ifndef __OSD_SHP_REG_O22__
#define __OSD_SHP_REG_O22__
...
#define SHP_CTRL_RdFL(idx,_r)			((g_osd_shp_o22_reg_shadow[idx]->_r)=(g_osd_shp_o22_reg[idx]->_r))
#define SHP_CTRL_WrFL(idx,_r)			((g_osd_shp_o22_reg[idx]->_r)=(g_osd_shp_o22_reg_shadow[idx]->_r))

#define SHP_CTRL_Rd(idx,_r)				*((UINT32*)(&(g_osd_shp_o22_reg_shadow[idx]->_r)))
#define SHP_CTRL_Wr(idx,_r,_v)			((SHP_CTRL_Rd(idx,_r))=((UINT32)(_v)))

#define SHP_CTRL_Rd01(idx,_r,_f01,_v01)													\
								do { 											\
									(_v01) = (g_osd_shp_o22_reg_shadow[idx]->_r._f01);				\
								} while(0)

#define SHP_CTRL_Rd02(idx,_r,_f01,_v01,_f02,_v02)										\
								do { 											\
									(_v01) = (g_osd_shp_o22_reg_shadow[idx]->_r._f01);				\
									(_v02) = (g_osd_shp_o22_reg_shadow[idx]->_r._f02);				\
								} while(0)


#define SHP_CTRL_Wr01(idx,_r,_f01,_v01)													\
								do { 											\
									(g_osd_shp_o22_reg_shadow[idx]->_r._f01) = (_v01);				\
								} while(0)

#define SHP_CTRL_Wr02(idx,_r,_f01,_v01,_f02,_v02)										\
								do { 											\
									(g_osd_shp_o22_reg_shadow[idx]->_r._f01) = (_v01);				\
									(g_osd_shp_o22_reg_shadow[idx]->_r._f02) = (_v02);				\
								} while(0)

/** @} *//* end of macro documentation */

extern volatile OSD_SHP_O22_REG_T*	g_osd_shp_o22_reg[2];
extern OSD_SHP_O22_REG_T*  			g_osd_shp_o22_reg_shadow[2];
...
/* from 'O22_PQE_OSD_SHP_reg_man.csv' 20170609 18:24:26 KST by getregs v2.9 */
