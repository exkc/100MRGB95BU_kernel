...
#ifndef	_PE_TSK_M17_H_
#define	_PE_TSK_M17_H_
...
typedef enum
{
	PE_TSK_M17_RUN_START = 0,	///< run start
	PE_TSK_M17_RUN_STOP_TASK,	///< run stop task
	PE_TSK_M17_RUN_STOP_HDLR,	///< run stop handler
	PE_TSK_M17_RUN_STOP_OVWR,	///< run stop overwrite
	PE_TSK_M17_RUN_STOP_ALGO,	///< run stop algorithm
	PE_TSK_M17_RUN_STOP_MODE,	///< run stop mode
	PE_TSK_M17_RUN_NUM			///< max num
}
PE_TSK_M17_OPR_RUN_MODE;
...
typedef enum
{
	PE_TSK_M17_DBG_OFF = 0,		///< off
	PE_TSK_M17_DBG_ON,			///< on
	PE_TSK_M17_DBG_TIME,		///< time check
	PE_TSK_M17_DBG_CNT,			///< count check
	PE_TSK_M17_DBG_BRK,			///< break check
	PE_TSK_M17_DBG_MAX			///< max num
}
PE_TSK_M17_OPR_DBG_MODE;
...
typedef enum
{
	PE_TSK_M17_TIME_TASK = 0,	///< task time
	PE_TSK_M17_TIME_HNDL,		///< handler time
	PE_TSK_M17_TIME_MAX			///< max num
}
PE_TSK_M17_TIME;

/**
 *	pe task m17 operation type
 */
typedef struct
{
...
/**
 *	pe task m17 handler operation type
 */
typedef struct
{
...
PE_TSK_M17_LRC_HST_CTRL_T;

/**
 *	pe task m17 cfg type
 */
typedef struct {
	PE_INF_M17_SETTINGS_T inf;			///< info
	PE_TSK_M17_OPR_T opr;				///< operation mode
	PE_TSK_M17_HDLR_OPR_T hdlr_opr;		///< handler operation mode
	PE_TSK_M17_LRC_HST_CTRL_T lrc;		///< lrcr ctrl
}
PE_TSK_M17_CFG_T;
