 ...
 * @{
 */
#ifndef __HDMI20_RX_PHY_E60A0_H__
#define __HDMI20_RX_PHY_E60A0_H__
...
#include "hdmi21_rx_phy_b0_e60a0.h"
#include "hdmi21_rx_phy_b1_e60a0.h"
#include "hdmi21_rx_phy_b2_e60a0.h"

/*----------------------------------------------------------------------------------------
 *   Macro Definitions
 *---------------------------------------------------------------------------------------*/
/* E60:B0 */
#define PHY_REG_E60A0_SHDW(_port)		(phyReg_e60a0[_port].shdw.E60)
#define PHY_REG_B1_E60A0_SHDW(_port)	(phyReg_B1_e60a0[_port].shdw.E60)
#define PHY_REG_B2_E60A0_SHDW(_port)	(phyReg_B2_e60a0[_port].shdw.E60)
...
/* E60:B0 */
#define PHY_REG_E60A0_RdFL(_port,_r)		{PHY_E60_REG_RdFL(E60A0,_port,_r);}
#define PHY_REG_E60A0_WrFL(_port,_r)		{PHY_E60_REG_WrFL(E60A0,_port,_r);}

#define PHY_REG_B1_E60A0_RdFL(_port,_r)		{PHY_E60_REG_B1_RdFL(E60A0,_port,_r);}
#define PHY_REG_B1_E60A0_WrFL(_port,_r)		{PHY_E60_REG_B1_WrFL(E60A0,_port,_r);}

#define PHY_REG_B2_E60A0_RdFL(_port,_r)		{PHY_E60_REG_B2_RdFL(E60A0,_port,_r);}
#define PHY_REG_B2_E60A0_WrFL(_port,_r)		{PHY_E60_REG_B2_WrFL(E60A0,_port,_r);}


#define PHY_REG_E60A0_Rd01(_port,_r,_f01,_v01)			{PHY_E60_REG_Rd01(E60A0,_port,_r,_f01,_v01);}
#define PHY_REG_E60A0_Rd02(_port,_r,_f01,_v01,_f02,_v02)	{PHY_E60_REG_Rd02(E60A0,_port,_r,_f01,_v01,_f02,_v02);}

#define PHY_REG_B1_E60A0_Rd01(_port,_r,_f01,_v01)			{PHY_E60_REG_B1_Rd01(E60A0,_port,_r,_f01,_v01);}
#define PHY_REG_B1_E60A0_Rd02(_port,_r,_f01,_v01,_f02,_v02)	{PHY_E60_REG_B1_Rd02(E60A0,_port,_r,_f01,_v01,_f02,_v02);}

#define PHY_REG_B2_E60A0_Rd01(_port,_r,_f01,_v01)			{PHY_E60_REG_B2_Rd01(E60A0,_port,_r,_f01,_v01);}
#define PHY_REG_B2_E60A0_Rd02(_port,_r,_f01,_v01,_f02,_v02)	{PHY_E60_REG_B2_Rd02(E60A0,_port,_r,_f01,_v01,_f02,_v02);}

#define PHY_REG_E60A0_Wr01(_port,_r,_f01,_v01)			{PHY_E60_REG_Wr01(E60A0,_port,_r,_f01,_v01);}
#define PHY_REG_E60A0_Wr02(_port,_r,_f01,_v01,_f02,_v02)	{PHY_E60_REG_Wr02(E60A0,_port,_r,_f01,_v01,_f02,_v02);}

#define PHY_REG_B1_E60A0_Wr01(_port,_r,_f01,_v01)			{PHY_E60_REG_B1_Wr01(E60A0,_port,_r,_f01,_v01);}
#define PHY_REG_B1_E60A0_Wr02(_port,_r,_f01,_v01,_f02,_v02)	{PHY_E60_REG_B1_Wr02(E60A0,_port,_r,_f01,_v01,_f02,_v02);}

#define PHY_REG_B2_E60A0_Wr01(_port,_r,_f01,_v01)			{PHY_E60_REG_B2_Wr01(E60A0,_port,_r,_f01,_v01);}
#define PHY_REG_B2_E60A0_Wr02(_port,_r,_f01,_v01,_f02,_v02)	{PHY_E60_REG_B2_Wr02(E60A0,_port,_r,_f01,_v01,_f02,_v02);}
...
typedef struct
{
	union {
		UINT32          *addr;
		HDMI21_PHY_REG_E60A0_T	*E60;
	} shdw;
} HDMI21_PHY_REG_CTRL_E60A0_T;

typedef struct
{
	union {
		UINT32          *addr;
		HDMI21_PHY_REG_B1_E60A0_T	*E60;
	} shdw;
} HDMI21_PHY_REG_CTRL_B1_E60A0_T;
...
typedef struct
{
	union {
		UINT32          *addr;
		HDMI21_PHY_REG_B2_E60A0_T	*E60;
	} shdw;
} HDMI21_PHY_REG_CTRL_B2_E60A0_T;
/*----------------------------------------------------------------------------------------
	External Variables
----------------------------------------------------------------------------------------*/
/* IOCTL */
