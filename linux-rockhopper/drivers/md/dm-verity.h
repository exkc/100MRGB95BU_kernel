...
enum dm_webos_error_type {
        DM_VERITY_SIGNATURE_FAILURE,
        DM_VERITY_BLOCK_CORRUPT,
};
extern void dm_webos_verity_error_handle(enum dm_webos_error_type error_type,
