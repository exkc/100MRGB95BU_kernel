...
#CHIP_NAME 	:= $(shell echo $(KDRV_PLATFORM_CFG) | cut -b -3 | tr '[:lower:]' '[:upper:]')
CHIP_NAME 	:= $(shell echo $(KDRV_PLATFORM_CFG) | cut -d'_' -f1 | tr '[:lower:]' '[:upper:]')

DDK_CFLAGS	:= -D$(CHIP_NAME)_KDRV_BUILD
