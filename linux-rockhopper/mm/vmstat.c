...
unsigned long get_nr_memmap_pages(void)
{
	return atomic_long_read(&nr_memmap_pages);
}

unsigned long get_nr_memmap_boot_pages(void)
{
	return atomic_long_read(&nr_memmap_boot_pages);
}
