...
/*****************************************************************************
**
**  Name: ademod_o18_demod.h
**
**  Description:    ABB O18 Demodulator software interface.
**
**  Functions
**  Implemented:    FmLg_Result  DEMOD_O18_Analog_Demod_Open
**                  FmLg_Result  DEMOD_O18_Analog_Demod_Close
**                  FmLg_Result  DEMOD_O18_Analog_Demodulate
**                  FmLg_Result  DEMOD_O18_Analog_Parameter_Set
**                  FmLg_Result  DEMOD_O18_Analog_Parameter_Get
**                  FmLg_Result  DEMOD_O18_Analog_AGC_Set
**                  FmLg_Result  DEMOD_O18_Analog_AGC_Get
**                  FmLg_Result  DEMOD_O18_Analog_ChanScan_Set
**                  FmLg_Result  DEMOD_O18_Analog_ChanScan_Get
**                  FmLg_Result  DEMOD_O18_Analog_SleepMode_Set
**                  FmLg_Result  DEMOD_O18_Analog_SleepMode_Get
**                  FmLg_Result  DEMOD_O18_Analog_HostI2C_Write
**                  FmLg_Result  DEMOD_O18_Analog_HostI2C_Read
**
**  References:
**
**  Exports:        FmLg_Result  DEMOD_O18_Analog_Demod_Open
**                  FmLg_Result  DEMOD_O18_Analog_Demod_Close
**                  FmLg_Result  DEMOD_O18_Analog_Demodulate
**                  FmLg_Result  DEMOD_O18_Analog_Parameter_Set
**                  FmLg_Result  DEMOD_O18_Analog_Parameter_Get
...
**
*****************************************************************************/
#ifndef _ADEMOD_O18_DEMOD_H_
#define _ADEMOD_O18_DEMOD_H_
...
*/
typedef struct LX_ADEMOD_O18_Instance_tag
{
...
#endif
	UINT32				flags;
}  LX_ADEMOD_O18_Instance, *pLX_ADEMOD_O18_Instance;
...
**
******************************************************************************/
LX_ADEMOD_Result DEMOD_O18_Analog_Demodulate( Handle_t hDevice,
							 UINT32 InputMode,
...
**
******************************************************************************/
LX_ADEMOD_Result DEMOD_O18_Analog_Parameter_Set( Handle_t hDevice,
							    UINT32 ParamID,
								UINT32* pParamValue,
								BOOL UpdateNow);
...
**
******************************************************************************/
LX_ADEMOD_Result DEMOD_O18_Analog_Parameter_Get( Handle_t hDevice,
						        UINT32 ParamID,
							    UINT32* pParamValue);
...
**
******************************************************************************/
LX_ADEMOD_Result DEMOD_O18_Analog_AGC_Set( Handle_t hDevice,
						  UINT32* pDescriptor,
						  BOOL UpdateNow);
...
**
******************************************************************************/
LX_ADEMOD_Result DEMOD_O18_Analog_AGC_Get( Handle_t hDevice,
						  UINT32* pDescriptor);
...
**
******************************************************************************/
LX_ADEMOD_Result DEMOD_O18_Analog_ChanScan_Set( Handle_t hDevice,
							   UINT32* pDescriptor,
							   BOOL UpdateNow);
...
**
******************************************************************************/
LX_ADEMOD_Result DEMOD_O18_Analog_ChanScan_Get( Handle_t hDevice,
							   UINT32* pDescriptor);
...
**
******************************************************************************/
LX_ADEMOD_Result DEMOD_O18_Analog_SleepMode_Set( Handle_t hDevice,
							    UINT32 Mode);
...
**
******************************************************************************/
LX_ADEMOD_Result DEMOD_O18_Analog_SleepMode_Get( Handle_t hDevice,
							    UINT32 *pMode);
