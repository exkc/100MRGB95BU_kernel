...
/** @file pe_vfilt_y_hw_param_o20.h
 *
...
----------------------------------------------------------------------------*/
#include "pe_reg.h"
#include "pe_vflt_y_l_sd_default_o20.h"
#include "pe_vflt_y_l_hd_i_default_o20.h"
#include "pe_vflt_y_l_hd_p_default_o20.h"
#include "pe_vflt_y_l_ud_else_default_o20.h"
#include "pe_vflt_y_l_ud_hdmi_420_default_o20.h"
#include "pe_vflt_y_l_hd_i_dtv_default_o20.h"
#include "pe_vflt_y_l_vr_360_default_o20.h"
#include "pe_vflt_y_l_sd_dtv_default_o20.h"
#ifdef	__cplusplus
extern "C"
{
#endif /* __cplusplus */
 ...
 */
 typedef struct {
	PE_O20_VFILTER_CTRL_00_T			vfilter_ctrl_00; 	//0xc8007180L
	PE_O20_VFILTER_CTRL_01_T			vfilter_ctrl_01; 	//0xc8007184L
	PE_O20_VFILTER_CTRL_02_T			vfilter_ctrl_02; 	//0xc8007188L
...
typedef struct {
	union {
		UINT32			*addr;
		PE_VFY_HW_PARAM_REG_O20_T *data;
	} reg_dflt;
