...
#define AUD_CAP_IOW_SET_OUT_SAMPLING_FREQ           _IOW(AUD_CAP_IOC_MAGIC,13, UINT32)
...
typedef enum {
    ...
    LX_AUD_CAPTURE_INPUT_PCMREN,                            ///< pcmrenderer module in decoder for multi channel.
    LX_AUD_CAPTURE_INPUT_BTSE,                              ///< Sound Engine module 01 for BT Surround Mode
    LX_AUD_CAPTURE_INPUT_MAX,
...
typedef struct {
    ...
    UINT32                      ui32LastAu;                 ///< the last AU
    LX_AUD_DATA_TYPE_T          dataType;                   ///< the audio data type(0:PCM, 1:ES, 2:METADATA)
