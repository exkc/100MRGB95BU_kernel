...
#ifndef	_PE_WIN_HW_M17C0_H_
#define	_PE_WIN_HW_M17C0_H_
...
typedef struct
{
	PE_WIN_HW_M17C0_CTRL_T win_inf;			///< window info
	PE_WIN_HW_M17C0_LRCR_CTRL_T lrcr_inf;		///< lrcr win info
	PE_WIN_HW_M17C0_TNR_CTRL_T tnr_inf;		///< tnr measure win info
}
PE_WIN_HW_M17C0_SETTINGS_T;
