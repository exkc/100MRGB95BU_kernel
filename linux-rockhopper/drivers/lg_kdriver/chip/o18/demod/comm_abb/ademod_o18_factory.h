...
/*****************************************************************************
**
**  Name:ademod_o18_factory.h
**
**  Description:   ABB O18 factory settings.
**
**  Functions
**
**  References:
...
#ifndef _ADEMOD_O18_FACTORY_H_
#define _ADEMOD_O18_FACTORY_H_
...
/******************************************************************************
**
**  Name: DEMOD_O18_Analog_Factory_Table_Get
**
...
**
******************************************************************************/
LX_ADEMOD_Result DEMOD_O18_Analog_Factory_Table_Get(pLX_ADEMOD_Demod_Instance pContext, const LX_ADEMOD_FACTORY_SETTINGS **Table, UINT32 *Size);

#if defined( __cplusplus )
}
#endif

#endif //_ADEMOD_O18_FACTORY_H_
