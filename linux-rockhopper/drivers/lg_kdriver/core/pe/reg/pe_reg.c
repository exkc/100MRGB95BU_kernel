...
int PE_REG_RegisterCbFunc(void)
{
	...
	do{
		...
		if (PE_KDRV_VER_O26)
		{
			_g_pe_reg_cb_fn.init_phy_to_virt	= PE_REG_O26_InitPhyToVirt;
			_g_pe_reg_cb_fn.free_phy_to_virt	= PE_REG_O26_FreePhyToVirt;
			_g_pe_reg_cb_fn.wr_alloc_reg		= PE_REG_O26_WrAllocatedAddr;
		}
		else
		#endif
		...
		if (PE_KDRV_VER_O24)
		{
			_g_pe_reg_cb_fn.init_phy_to_virt	= PE_REG_O24_InitPhyToVirt;
			_g_pe_reg_cb_fn.free_phy_to_virt	= PE_REG_O24_FreePhyToVirt;
			_g_pe_reg_cb_fn.wr_reg				= NULL;//not support PE_REG_WD, use SYS_IO_WriteRegArray
			_g_pe_reg_cb_fn.wr_alloc_reg		= PE_REG_O24_WrAllocatedAddr;
			_g_pe_reg_cb_fn.rd_reg				= NULL;//not support PE_REG_RD, use SYS_IO_ReadRegArray
		}
		else
		#endif
		...
		if (PE_KDRV_VER_M23)
		{
			_g_pe_reg_cb_fn.init_phy_to_virt	= PE_REG_M23_InitPhyToVirt;
			_g_pe_reg_cb_fn.free_phy_to_virt	= PE_REG_M23_FreePhyToVirt;
			_g_pe_reg_cb_fn.wr_reg				= NULL;//not support PE_REG_WD, use SYS_IO_WriteRegArray
			_g_pe_reg_cb_fn.wr_alloc_reg		= PE_REG_M23_WrAllocatedAddr;
			_g_pe_reg_cb_fn.rd_reg				= NULL;//not support PE_REG_RD, use SYS_IO_ReadRegArray
		}
		else
		#endif
		...
		if (PE_KDRV_VER_O22)
		{
			_g_pe_reg_cb_fn.init_phy_to_virt	= PE_REG_O22_InitPhyToVirt;
			_g_pe_reg_cb_fn.free_phy_to_virt	= PE_REG_O22_FreePhyToVirt;
			_g_pe_reg_cb_fn.wr_reg				= PE_REG_O22_WD;
			_g_pe_reg_cb_fn.wr_alloc_reg		= PE_REG_O22_WrAllocatedAddr;
			_g_pe_reg_cb_fn.rd_reg				= PE_REG_O22_RD;
		...
		if (PE_KDRV_VER_E60)
		{
			_g_pe_reg_cb_fn.init_phy_to_virt	= PE_REG_E60_InitPhyToVirt;
			_g_pe_reg_cb_fn.free_phy_to_virt	= PE_REG_E60_FreePhyToVirt;
			_g_pe_reg_cb_fn.wr_reg				= PE_REG_E60_WD;
			_g_pe_reg_cb_fn.wr_alloc_reg		= PE_REG_E60_WrAllocatedAddr;
			_g_pe_reg_cb_fn.rd_reg				= PE_REG_E60_RD;
			_g_pe_reg_cb_fn.set_trace_tbl		= NULL;
		}
		else
		#endif
		...
		if (PE_KDRV_VER_O20)
		{
			_g_pe_reg_cb_fn.init_phy_to_virt	= PE_REG_O20_InitPhyToVirt;
			_g_pe_reg_cb_fn.free_phy_to_virt	= PE_REG_O20_FreePhyToVirt;
			_g_pe_reg_cb_fn.wr_reg				= PE_REG_O20_WD;
			_g_pe_reg_cb_fn.wr_alloc_reg		= PE_REG_O20_WrAllocatedAddr;
			_g_pe_reg_cb_fn.rd_reg				= PE_REG_O20_RD;
			_g_pe_reg_cb_fn.set_trace_tbl		= NULL;
		}
		else
		#endif
		...
		if (PE_KDRV_VER_O18)
		{
			_g_pe_reg_cb_fn.init_phy_to_virt	= PE_REG_O18_InitPhyToVirt;
			_g_pe_reg_cb_fn.free_phy_to_virt	= PE_REG_O18_FreePhyToVirt;
			_g_pe_reg_cb_fn.wr_reg				= PE_REG_O18_WD;
			_g_pe_reg_cb_fn.wr_alloc_reg		= PE_REG_O18_WrAllocatedAddr;
			_g_pe_reg_cb_fn.rd_reg				= PE_REG_O18_RD;
			_g_pe_reg_cb_fn.set_trace_tbl		= PE_REG_O18_SetTraceTable;
		}
		else
		#endif
		...
		if (PE_KDRV_VER_M17)
		{
			_g_pe_reg_cb_fn.init_phy_to_virt	= PE_REG_M17_InitPhyToVirt;
			_g_pe_reg_cb_fn.free_phy_to_virt	= PE_REG_M17_FreePhyToVirt;
			_g_pe_reg_cb_fn.wr_reg				= PE_REG_M17_WD;
			_g_pe_reg_cb_fn.wr_alloc_reg		= PE_REG_M17_WrAllocatedAddr;
			_g_pe_reg_cb_fn.rd_reg				= PE_REG_M17_RD;
			_g_pe_reg_cb_fn.set_trace_tbl		= PE_REG_M17_SetTraceTable;
		}
		else
		#endif
		...
		if (PE_KDRV_VER_M19)
		{
			_g_pe_reg_cb_fn.init_phy_to_virt	= PE_REG_M19_InitPhyToVirt;
			_g_pe_reg_cb_fn.free_phy_to_virt	= PE_REG_M19_FreePhyToVirt;
			_g_pe_reg_cb_fn.wr_reg				= PE_REG_M19_WD;
			_g_pe_reg_cb_fn.wr_alloc_reg		= PE_REG_M19_WrAllocatedAddr;
			_g_pe_reg_cb_fn.rd_reg				= PE_REG_M19_RD;
			_g_pe_reg_cb_fn.set_trace_tbl		= PE_REG_M19_SetTraceTable;
		}
		else
		#endif
		{
