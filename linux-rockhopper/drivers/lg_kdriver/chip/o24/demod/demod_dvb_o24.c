...
int _DEMOD_O24_DVBC_CheckTuneMode (DEMOD_CTX_T *pDemodInfo)
{
	UINT8  new_tuneMode;
...
int _DEMOD_O24_DVBT_CheckTuneMode (DEMOD_CTX_T *pDemodInfo)
{
	UINT8  new_tuneMode;
...
int _DEMOD_O24_DVBT2_CheckTuneMode (DEMOD_CTX_T *pDemodInfo)
{
	UINT8  new_tuneMode;
...
int _DEMOD_O24_DVBC_SetDemod (DEMOD_CTX_T *pDemodInfo)
{
	...
	new_tuneMode 		= _DEMOD_O24_DVBC_CheckTuneMode(pDemodInfo);
	symbol_rate_Kbps 	= pDemodInfo->setCfgParam.dvbc.symbolRate;// KSym/s

	if(RET_OK != DEMOD_O24_Get_BW(pDemodInfo, &dvb_c_bandwidth_Khz))
	{
...
int _DEMOD_O24_DVBT_SetDemod (DEMOD_CTX_T *pDemodInfo)
{
	LX_DEMOD_L2_Context *	pFrontend;
	...
	new_tuneMode		= _DEMOD_O24_DVBT_CheckTuneMode(pDemodInfo);

	DEMOD_NOTI("Start\n");

	if(RET_OK != DEMOD_O24_Get_BW(pDemodInfo, &dvb_t_bandwidth_Khz))
	{
		DEMOD_ERROR("Fail, DEMOD_O24_Get_BW()\n");
		return RET_ERROR;
	}
...
int _DEMOD_O24_DVBT2_SetDemod (DEMOD_CTX_T *pDemodInfo)
{
	LX_DEMOD_L2_Context *	pFrontend;
	...
	new_tuneMode		= _DEMOD_O24_DVBT2_CheckTuneMode(pDemodInfo);

	DEMOD_NOTI("Start\n");

	if(RET_OK != DEMOD_O24_Get_BW(pDemodInfo, &dvbt2_bandwidth_Khz))
	{
		DEMOD_ERROR("Fail, DEMOD_O24_Get_BW()\n");
		return RET_ERROR;
	}
...
int _DEMOD_O24_DVB_CheckSignalState (DEMOD_CTX_T *pDemodInfo)
{
...
int DEMOD_O24_DVB_SW_Init (void)
{
	LX_DEMOD_L2_Context *	pFrontend;
	...
	{
		DEMOD_ERROR("Fail, DEMOD_O24_DVB_SW_Init\n");
		return RET_ERROR;
	}
...
************************************************************************************/
/**
 * DEMOD_O24_DVBC_AutoSymbolRateDet
...
*/
int DEMOD_O24_DVBC_AutoSymbolRateDet (LX_DEMOD_SYMRDET_MODE_T symrateMode, UINT16 SymbolRate )
{
	LX_DEMOD_L2_Context *	pFrontend;
...
************************************************************************************/
/**
 * DEMOD_O24_DVBC_IsSymbolRateAuto
 * Enable/Diable automatic symbol rate detection on DVB-C mode.
 *
 * @param  *bAuto - BOOLEAN.
 * @return if Succeeded - RET_OK else-RET_ERROR
 ...
 * @author 	Jeongpil.yun (jeongpil.yun@lge.com)
*/
int DEMOD_O24_DVBC_IsSymbolRateAuto (BOOLEAN *bAuto)
{
	LX_DEMOD_L2_Context *	pFrontend;
...
************************************************************************************/
/**
 * DEMOD_O24_DVBC_IsQammodeAutoDet
 ...
 * @author 	Jeongpil.yun (jeongpil.yun@lge.com)
*/
int DEMOD_O24_DVBC_IsQammodeAutoDet (BOOLEAN *bAutoQam)
{
	LX_DEMOD_L2_Context *	pFrontend;
...
************************************************************************************/
/**
 * DEMOD_O24_DVBC_Set_DefaultRegisterValue
 ...
 * @author 	Jeongpil.yun (jeongpil.yun@lge.com)
*/
int DEMOD_O24_DVBC_Set_DefaultRegisterValue (void)
{
...
************************************************************************************/
/**
 * DEMOD_O24_DVBC_Set_Config_auto
 * Control automatic setting of DVBC config.
 *
 ...
 * @author 	Jeongpil.yun (jeongpil.yun@lge.com)
*/
int DEMOD_O24_DVBC_Set_Config_auto (BOOLEAN bAutoDetect)
{
	return RET_OK;
}
 ...
 * @author 	Jeongpil.yun (jeongpil.yun@lge.com)
*/
int DEMOD_O24_DVBC_Set_QamMode (LX_DEMOD_RF_MODE_T constel)
{
	LX_DEMOD_L2_Context *	pFrontend;
...
************************************************************************************/
/**
 * DEMOD_O24_DVBC_Set_NeverLockWaitTime
 ...
 * @author 	Jeongpil.yun (jeongpil.yun@lge.com)
*/
int DEMOD_O24_DVBC_Set_NeverLockWaitTime (UINT32 waitMs)
{
	return RET_OK;
}
...
************************************************************************************/
/**
 * DEMOD_O24_DVBC_Get_SymbolRateDetect
 ...
 * @author 	Jeongpil.yun (jeongpil.yun@lge.com)
*/
int DEMOD_O24_DVBC_Get_SymbolRateDetect (UINT16 *pSymbolRate)
{
	LX_DEMOD_L2_Context *	pFrontend;
	LX_DEMOD_L2_SIG_STATUS 	signalStatus;
...
************************************************************************************/
/**
 * DEMOD_O24_DVBC_Get_SymbolRateStatus
 ...
 * @author 	Jeongpil.yun (jeongpil.yun@lge.com)
*/
int DEMOD_O24_DVBC_Get_SymbolRateStatus (LX_DEMOD_SYMBOLRATE_STATE_T *pSymbolRateDet)
{
	LX_DEMOD_L2_Context *	pFrontend;
	LX_DEMOD_L2_SIG_STATUS 	signalStatus;
...
************************************************************************************/
/**
 * DEMOD_O24_DVBC_Get_QamModeDetectStatus
 ...
 * @author 	Jeongpil.yun (jeongpil.yun@lge.com)
*/
int DEMOD_O24_DVBC_Get_QamModeDetectStatus (LX_DEMOD_QAMMODE_STATE_T *pQamModeDet)
{
	LX_DEMOD_L2_Context *	pFrontend;
	LX_DEMOD_L2_SIG_STATUS 	signalStatus;
...
************************************************************************************/
/**
 * DEMOD_O24_DVBC_Obtaining_Signal_Lock.
...
int DEMOD_O24_DVBC_Obtaining_Signal_Lock (DEMOD_CTX_T *pDemodInfo)
{
	LX_DEMOD_L2_Context *	pFrontend;
	LX_DEMOD_L2_SIG_STATUS 	signalStatus;
		...
		case LX_DEMOD_TUNE_START:
			{
				...
				if(RET_OK != _DEMOD_O24_DVBC_SetDemod(pDemodInfo))
				{
					DEMOD_PRINT("Fail, _DEMOD_O24_DVBC_SetDemod()\n");
					return RET_ERROR;
				}
...
//				UINT16 symbolRateDiff;
				...
				if(LX_DEMOD_LOCKED == lockState)
				{
					...
					if (RET_OK != _DEMOD_O24_DVB_CheckSignalState(pDemodInfo))
					{
						DEMOD_ERROR("Fail, _DEMOD_O24_DVB_CheckSignalState()\n");
						return RET_ERROR;
					}
				}
				else
...
int DEMOD_O24_DVBC_Monitoring_Signal_Lock (DEMOD_CTX_T *pDemodInfo)
{
 ...
 * @author 	Jeongpil.yun (jeongpil.yun@lge.com)
*/
int DEMOD_O24_DVBC_Get_DvbInfo (void)
{
	LX_DEMOD_L2_Context *	pFrontend;
	LX_DEMOD_L2_SIG_STATUS	signalStatus;
	...
	DEMOD_PRINT("IF AGC Gain = 0x%x\n", signalStatus.if_agc);
 	...
 	//NeverLock status
	if (RET_OK != DEMOD_O24_Get_NeverLockStatus(LX_DEMOD_DVBC, &lockState))
	{
		DEMOD_ERROR("Fail, DEMOD_O24_Get_NeverLockStatus()\n");
		return RET_ERROR;
	}
	...
	if (RET_OK != DEMOD_O24_Get_Lock( LX_DEMOD_TR_LOCK, &lockState))
	{
		DEMOD_ERROR("Fail, DEMOD_O24_Get_Lock()\n");
		return RET_ERROR;
	}
	...
	if (RET_OK != DEMOD_O24_DVBC_IsSymbolRateAuto(&isAutoSymbol))
	{
		DEMOD_ERROR("Fail, DEMOD_O24_DVBC_IsSymbolRateAuto()\n");
		return RET_ERROR;
	}
	...
	if (RET_OK != DEMOD_O24_DVBC_IsQammodeAutoDet(&isAutoQammode))
	{
		DEMOD_ERROR("Fail, DEMOD_O24_DVBC_IsQammodeAutoDet()\n");
		return RET_ERROR;
	}

	if(TRUE == isAutoQammode)
	{
		if (RET_OK != DEMOD_O24_DVBC_Get_QamModeDetectStatus(&qamModeDet))
		{
			DEMOD_ERROR("Fail, DEMOD_O24_DVBC_Get_QamModeDetectStatus()\n");
			return RET_ERROR;
		}
	...
	if (RET_OK !=  DEMOD_O24_Get_SpectrumStatus(&spectrumAuto, &lockState))
	{
		DEMOD_WARN("Fail, DEMOD_O24_Get_SpectrumStatus()\n");
...
/**
 * DEMOD_O24_DVBT_Set_DefaultRegisterValue
 * Set defualt register value on DVB-T.
 * This function is applied only to A0 version, not to A1 version.
 *
 * @param none
 ...
 * @author 	Jeongpil.yun (jeongpil.yun@lge.com)
*/
int DEMOD_O24_DVBT_Set_DefaultRegisterValue (LX_DEMOD_BWMODE_T band)
{
	_DVB_Full_Pkerr_Count 	= 0;
...
************************************************************************************/
/**
 * DEMOD_O24_DVBT_Set_Config_auto
 ...
 * @author 	Jeongpil.yun (jeongpil.yun@lge.com)
*/
int DEMOD_O24_DVBT_Set_Config_auto (BOOLEAN bAutoDetect)
{
...
************************************************************************************/
/**
 * DEMOD_O24_DVBT_Set_PartialConfig
 * Set hierachical signal path and bandwidth.
 * This function is used when LX_DEMOD_O24_DVBT_Set_Config_auto is enabled.
 *
 ...
 * @author 	Jeongpil.yun (jeongpil.yun@lge.com)
*/
int DEMOD_O24_DVBT_Set_PartialConfig (LX_DEMOD_DVBT_CONFIG_T *pDvbtConfigParam)
{
	LX_DEMOD_L2_Context *	pFrontend;
 ...
 * @author 	Jeongpil.yun (jeongpil.yun@lge.com)
*/
int DEMOD_O24_DVBT_Set_FullConfig (LX_DEMOD_DVBT_CONFIG_T *pDvbtConfigParam)
{
	return RET_OK;
}
...
************************************************************************************/
/**
 * DEMOD_O24_DVBT_Set_NeverLockWaitTime
 * Set neverlock waiting period.
 *
 * @param waitMs 	[IN] UINT32 - unit: ms
 * @return if Succeeded - RET_OK else-RET_ERROR
 ...
 * @author 	Jeongpil.yun (jeongpil.yun@lge.com)
*/
int DEMOD_O24_DVBT_Set_NeverLockWaitTime (UINT32 waitMs)
{
	return RET_OK;
}
...
************************************************************************************/
/**
 * DEMOD_O24_DVBT_Set_TafcWaitSymbol
 ...
 * @author 	Jeongpil.yun (jeongpil.yun@lge.com)
*/
int DEMOD_O24_DVBT_Set_TafcWaitSymbol (BOOLEAN bDelayed)
{
	return RET_OK;
}
 ...
 * @author 	Jeongpil.yun (jeongpil.yun@lge.com)
*/
int DEMOD_O24_DVBT_Set_CrGearshEn (BOOLEAN bEnable)
{
	return RET_OK;
}
...
************************************************************************************/
/**
 * DEMOD_O24_DVBT_Get_PreGhostDetection
 ...
 * @author 	Jeongpil.yun (jeongpil.yun@lge.com)
*/
int DEMOD_O24_DVBT_Get_PreGhostDetection (BOOLEAN *pIsExist)
{
	return RET_OK;
}
...
************************************************************************************/
/**
 * DEMOD_O24_DVBT_Get_DelaySpreadStatus
 ...
 * @author 	Jeongpil.yun (jeongpil.yun@lge.com)
*/
int DEMOD_O24_DVBT_Get_DelaySpreadStatus (UINT16 *pDelaySpread)
{
	return RET_OK;
}
...
************************************************************************************/
/**
 * DEMOD_O24_DVBT_Get_Hierach_HPSel
 ...
 * @author 	Jeongpil.yun (jeongpil.yun@lge.com)
*/
int DEMOD_O24_DVBT_Get_Hierach_HPSel (BOOLEAN *pBSetHp)
{
	LX_DEMOD_L2_Context *	pFrontend;
	LX_DEMOD_L2_SIG_STATUS	signalStatus;
 ...
 * @author 	Jeongpil.yun (jeongpil.yun@lge.com)
*/
int DEMOD_O24_DVBT_Get_FFTMode (LX_DEMOD_LOCK_STATE_T *pTxModeLock, LX_DEMOD_FFTMODE_T *pFftMode)
{
...
************************************************************************************/
/**
 * DEMOD_O24_DVBT_Get_GuradIntervalMode
 ...
 * @author 	Jeongpil.yun (jeongpil.yun@lge.com)
*/
int DEMOD_O24_DVBT_Get_GuradIntervalMode (LX_DEMOD_GIMODE_T *pGIMode)
{
	LX_DEMOD_L2_Context *	pFrontend;
	LX_DEMOD_L2_SIG_STATUS	signalStatus;
...
************************************************************************************/
/**
 * DEMOD_O24_DVBT_Get_HierachyMode
 * Get the information of hierachical mode on DVB-T.
 *
 * @param *pHierachMode[OUT] DEMOD_O24_DVB_TPS_HIERACHY_T - alpha = none, 1, 2 and 4.
 * @return if Succeeded - RET_OK else-RET_ERROR
 * @see
 * @author 	Jeongpil.yun (jeongpil.yun@lge.com)
*/
int DEMOD_O24_DVBT_Get_HierachyMode (LX_DEMOD_DVB_TPS_HIERACHY_T *pHierachMode)
{
	LX_DEMOD_L2_Context *	pFrontend;
	LX_DEMOD_L2_SIG_STATUS	signalStatus;
...
************************************************************************************/
/**
 * DEMOD_O24_DVBT_Get_LpCoderRate
 ...
 * @author 	Jeongpil.yun (jeongpil.yun@lge.com)
*/
int DEMOD_O24_DVBT_Get_LpCoderRate (LX_DEMOD_CODERATE_T *pLpCodeRate)
{
	LX_DEMOD_L2_Context *	pFrontend;
	LX_DEMOD_L2_SIG_STATUS	signalStatus;
...
************************************************************************************/
/**
 * DEMOD_O24_DVBT_Get_HpCoderRate
 ...
 * @author 	Jeongpil.yun (jeongpil.yun@lge.com)
*/
int DEMOD_O24_DVBT_Get_HpCoderRate (LX_DEMOD_CODERATE_T *pHpCodeRate)
{
	LX_DEMOD_L2_Context *	pFrontend;
	LX_DEMOD_L2_SIG_STATUS	signalStatus;
 ...
 * @author 	Jeongpil.yun (jeongpil.yun@lge.com)
*/
int DEMOD_O24_DVBT_Get_CellId (UINT8 *pCellIDLength, UINT16 *cell_id)
{
	LX_DEMOD_L2_Context *	pFrontend;
	LX_DEMOD_L2_SIG_STATUS	signalStatus;
 ...
 * @author 	Jeongpil.yun (jeongpil.yun@lge.com)
*/
int DEMOD_O24_DVBT_Get_TpsInfo (LX_DEMOD_DVBT_CONFIG_T *pTpsParams)
{
	LX_DEMOD_L2_Context * 	pFrontend;
	LX_DEMOD_L2_SIG_STATUS	signalStatus;
	...
	if(NULL == pTpsParams)
	{
		DEMOD_ERROR("ERROR DEMOD_O24_DVBT_CONFIG_T TpsParams is NULL\n");
		return RET_ERROR;
	}
	...
	// get QAM mode
	if (RET_OK != DEMOD_O24_Get_QAMMode(&qamMode ))
	{
		DEMOD_ERROR("Fail, DEMOD_O24_Get_QAMMode()\n");
		return RET_ERROR;
	}
 ...
 * @author 	Jeongpil.yun (jeongpil.yun@lge.com)
*/
int DEMOD_O24_DVBT_Get_TotalInfo (void)
{
	LX_DEMOD_L2_Context *	pFrontend;
	LX_DEMOD_L2_SIG_STATUS	signalStatus;
	...
	if (RET_OK != DEMOD_O24_Get_Lock(LX_DEMOD_AGC_LOCK, &agcLockStatus))
	{
		DEMOD_WARN("Fail, DEMOD_O24_Get_Lock()\n");
	...
	if (RET_OK != DEMOD_O24_Get_NeverLockStatus(LX_DEMOD_DVBT, &neverLockStatus))
	{
		DEMOD_WARN("Fail, DEMOD_O24_Get_NeverLockStatus()\n");
		neverLockStatus = LX_DEMOD_UNKOWN_STATE;
	}

	if (RET_OK !=  DEMOD_O24_Get_SpectrumStatus(&spectrumAuto, &spectrumInv))
	{
		DEMOD_WARN("Fail, DEMOD_O24_Get_SpectrumStatus()\n");
	...
	if (RET_OK != DEMOD_O24_DVBT_Get_TpsInfo( &tppsParams))
	{
		DEMOD_ERROR("Fail, DEMOD_O24_DVBT_Get_TpsInfo()\n");
		return RET_ERROR;
	}
 ...
 * @author 	Jeongpil.yun (jeongpil.yun@lge.com)
*/
int DEMOD_O24_DVBT_Get_IFO_LOCK (BOOLEAN *pIfoLock)
{
	*pIfoLock = FALSE;
...
************************************************************************************/
/**
 * DEMOD_O24_DVBT_EqualizereReset.
 ...
 * @author 	Jeongpil.yun (jeongpil.yun@lge.com)
*/
int DEMOD_O24_DVBT_EqualizereReset (void)
{
	return RET_OK;
}
...
************************************************************************************/
/**
 * DEMOD_O24_DVBT_Obtaining_Signal_Lock.
 * Set channel change parameters
 *
 * @param *pDemodInfo [IN] DEMOD_CTX_T
 * @return if Succeeded - RET_OK else-RET_ERROR
...
int DEMOD_O24_DVBT_Obtaining_Signal_Lock (DEMOD_CTX_T *pDemodInfo)
{
	static LX_DEMOD_FLAG_T 		scanProcessing = LX_DEMOD_FLAG_START;
	static LX_DEMOD_LOCK_STATE_T 	lockState = LX_DEMOD_UNLOCKED;
	static unsigned int 		sigStablestartTime = 0;
		...
		case LX_DEMOD_TUNE_START:
			{
				...
				if(RET_OK != _DEMOD_O24_DVBT_SetDemod(pDemodInfo))
				{
					DEMOD_ERROR("Fail, _DEMOD_O24_DVBT_SetDemod()\n");
					return RET_ERROR;
				}
		...
		case LX_DEMOD_SYNC_CHECKING :
			{
				...
				{
					DEMOD_ERROR("Fail, DEMOD_O24_Get_OperMode()\n");
					return RET_ERROR;
...
************************************************************************************/
/**
 * DEMOD_O24_DVBT_Monitoring_Signal_Lock.
 * Set channel change parameters
 *
 * @param *pDemodInfo [IN] DEMOD_CTX_T
 * @return if Succeeded - RET_OK else-RET_ERROR
...
int DEMOD_O24_DVBT_Monitoring_Signal_Lock (DEMOD_CTX_T *pDemodInfo)
{
	LX_DEMOD_LOCK_STATE_T			lockState;
	LX_DEMOD_OPER_MODE_T 			operMode;
...
************************************************************************************/
/**
 * DEMOD_O24_DVBT2_Set_Config_auto
 * Control automatic setting of DVB-T config.
 *
 * @param bAutoDetect 	[IN] BOOLEAN - automatic setting (TRUE) / manual setting(FALSE).
 * @return if Succeeded - RET_OK else-RET_ERROR
 ...
 * @author 	Jeongpil.yun (jeongpil.yun@lge.com)
*/
int DEMOD_O24_DVBT2_Set_Config_auto (BOOLEAN bAutoDetect)
{
	DEMOD_INFO("deprecated\n");
/*
	LX_DEMOD_L2_Context *	pFrontend;
...
************************************************************************************/
/**
 DEMOD_O24_DVBT2_Set_PartialConfig
 * Set all config parameters on DVB-T.
 * This function is used when LX_DEMOD_O24_DVBT_Set_Config_auto is disabled.
 *
 * @param *pDvbtConfigParam 	[IN] LX_DEMOD_DVBT_CONFIG_T - DVB-T config. structure
 ...
 * @author 	Jeongpil.yun (jeongpil.yun@lge.com)
*/
int DEMOD_O24_DVBT2_Set_PartialConfig (LX_DEMOD_DVBT2_CONFIG_T *pDvbt2ConfigParam)
{
	LX_DEMOD_L2_Context * 	pFrontend;
//	LX_DEMOD_L2_SIG_STATUS	signalStatus;
 ...
 * @author 	Jeongpil.yun (jeongpil.yun@lge.com)
*/
int DEMOD_O24_DVBT2_Get_FFTMode (LX_DEMOD_LOCK_STATE_T *pTxModeLock, LX_DEMOD_FFTMODE_T *pFftMode)
{
	LX_DEMOD_L2_Context *	pFrontend;
	LX_DEMOD_L2_SIG_STATUS	signalStatus;
...
************************************************************************************/
/**
 * DEMOD_O24_DVBT2_Get_GuradIntervalMode
 * Get the information of guard interval on DVB-T.
 *
 * @param *pGIMode 	[OUT] LX_DEMOD_GIMODE_T - 1/32, 1/16, 1/8 and 1/4.
 * @return if Succeeded - RET_OK else-RET_ERROR
 ...
 * @author 	Jeongpil.yun (jeongpil.yun@lge.com)
*/
int DEMOD_O24_DVBT2_Get_GuradIntervalMode (LX_DEMOD_GIMODE_T *pGIMode)
{
	LX_DEMOD_L2_Context *	pFrontend;
	LX_DEMOD_L2_SIG_STATUS	signalStatus;
 ...
 * @author 	Jeongpil.yun (jeongpil.yun@lge.com)
*/
int DEMOD_O24_DVBT2_Get_CoderRate (LX_DEMOD_CODERATE_T *pCodeRate)
{
	LX_DEMOD_L2_Context *	pFrontend;
	LX_DEMOD_L2_SIG_STATUS	signalStatus;
...
************************************************************************************/
/**
 * DEMOD_O24_DVBT2_Get_CurrentPLP_ID
 ...
 * @author 	Jeongpil.yun (jeongpil.yun@lge.com)
*/
int DEMOD_O24_DVBT2_Get_CurrentPLP_ID (UINT8 *pCurrPlpID)
{
	LX_DEMOD_L2_Context *	pFrontend;
	LX_DEMOD_L2_SIG_STATUS	signalStatus;
 ...
 * @author 	Jeongpil.yun (jeongpil.yun@lge.com)
*/
int DEMOD_O24_DVBT2_Get_PlpInfo (LX_DEMOD_DVBT2_CONFIG_T *pPlpParams)
{
	LX_DEMOD_L2_Context * 	pFrontend;
	LX_DEMOD_L2_SIG_STATUS	signalStatus;
	...
	if(NULL == pPlpParams)
	{
		DEMOD_ERROR("Fail, DEMOD_O24_DVBT_CONFIG_T TpsParams is NULL\n");
		return RET_ERROR;
	}
...
************************************************************************************/
/**
 * DEMOD_O24_DVBT2_Get_multiPLP_ID
 * Get TPS information on DVB-T
 *
 * @param *pTpsParams [OUT] LX_DEMOD_DVBT_CONFIG_T - TPS data structure.
 * @return if Succeeded - RET_OK else-RET_ERROR
 ...
 * @author 	Jeongpil.yun (jeongpil.yun@lge.com)
*/
int DEMOD_O24_DVBT2_Get_multiPLP_ID (LX_DEMOD_DVBT2_MULTI_PLP_INFO_T *pPlpParams)
{
	LX_DEMOD_L2_Context *	pFrontend;
 ...
 * @author 	Jeongpil.yun (jeongpil.yun@lge.com)
*/
int DEMOD_O24_DVBT2_Get_TotalInfo (void)
{
	LX_DEMOD_L2_Context *	pFrontend;
	LX_DEMOD_L2_SIG_STATUS	signalStatus;
	...
	if (RET_OK != DEMOD_O24_Get_NeverLockStatus(LX_DEMOD_DVBT2, &neverLockStatus))
	{
		DEMOD_WARN("Fail, DEMOD_O24_Get_NeverLockStatus()\n");
		neverLockStatus = LX_DEMOD_UNKOWN_STATE;
	}
	...
	if (RET_OK != DEMOD_O24_DVBT2_Get_PlpInfo( &plpParams))
	{
		DEMOD_ERROR("Fail, DEMOD_O24_DVBT2_Get_PlpInfo()\n");
		return RET_ERROR;
	}
	if (RET_OK != DEMOD_O24_DVBT2_Get_multiPLP_ID(&plpInfo))
	{
		DEMOD_ERROR("Fail, DEMOD_O24_DVBT2_Get_multiPLP_ID()\n");
		return RET_ERROR;
	}
...
************************************************************************************/
/**
 * DEMOD_O24_DVBT2_Obtaining_Signal_Lock.
 * Set channel change parameters
 *
 * @param *pDemodInfo [IN] DEMOD_CTX_T
 * @return if Succeeded - RET_OK else-RET_ERROR
...
int DEMOD_O24_DVBT2_Obtaining_Signal_Lock (DEMOD_CTX_T *pDemodInfo)
{
	...
	switch (pDemodInfo->controlState)
	{
		...
		case LX_DEMOD_TUNE_START:
			{
				if(RET_OK != _DEMOD_O24_DVBT2_SetDemod(pDemodInfo))
				{
					DEMOD_ERROR("Fail, _DEMOD_O24_DVBT2_SetDemod()\n");
					return RET_ERROR;
				}
		...
		case LX_DEMOD_SYNC_CHECKING :
			{
				...
				if(LX_DEMOD_DVBT == operMode)
				{
					...
					if(RET_OK != DEMOD_O24_DVBT_Set_PartialConfig(&(pDemodInfo->setCfgParam.dvbt)))
					{
						DEMOD_ERROR("Fail, DEMOD_O24_DVBT_Set_PartialConfig()\n");
						return RET_ERROR;
					}
				...
				if(RET_OK != DEMOD_O24_Get_Lock(LX_DEMOD_L1_DONE, &lockState))
				{
					DEMOD_ERROR("Fail, DEMOD_O24_DVBT_Set_PartialConfig()\n");
					return RET_ERROR;
				}
	   	...
	   	case LX_DEMOD_SIGNAL_STABLE:
			{
				...
				if(RET_OK != DEMOD_O24_Get_Lock(LX_DEMOD_FEC_DEC_EN, &lockState))
				{
					DEMOD_ERROR("Fail, DEMOD_O24_Get_Lock()\n");
					return RET_ERROR;
				}
...
************************************************************************************/
/**
 * DEMOD_O24_DVBT2_Monitoring_Signal_Lock.
 * Set channel change parameters
 *
 * @param *pDemodInfo [IN] DEMOD_CTX_T
 * @return if Succeeded - RET_OK else-RET_ERROR
...
int DEMOD_O24_DVBT2_Monitoring_Signal_Lock (DEMOD_CTX_T *pDemodInfo)
{
