...
#include "be_def.h"
#include "be_cfg.h"
#include "ipc_def_o22.h"
#include "ipc_drv.h"
#include "be_fwl_hw_o22.h"
...
----------------------------------------------------------------------------------------*/
extern BOOLEAN _BE_WCG_O22_IsHwComplete(void);
extern void _BE_WCG_O22_InitModeInfo(void);
...
/*----------------------------------------------------------------------------------------
	global Variables
----------------------------------------------------------------------------------------*/
BE_FWL_HAL_FW_T gHeader_Firmware_O22A0[BE_FW_DWLD_TYPE_MAXNUM] =
	{
#if CONFIG_LX_O22_CHIP_FIRMWARE
...
BE_FWL_HAL_FW_T *BE_FWL_HW_O22_GetFwHeaderInfo(UINT8 ucIndex)
{
	...
	return &gHeader_Firmware_O22A0[ucIndex];
}
