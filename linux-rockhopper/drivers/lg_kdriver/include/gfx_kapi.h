...
typedef enum
{
    ...
    LX_GFX_PIXEL_FORMAT_ARGB8888_AFBC           = 0xafbc,   /**< Compressed, A8 R8 G8 B8 (AFBC) */
    LX_GFX_PIXEL_FORMAT_ARGB8888_FBDC           = 0xfbdc,   /**< Compressed, A8 R8 G8 B8 (LG FBDC) */
}
...
#endif
    UINT32                     palette_num;    /**< total number of palette entry */
    union
    {
...
typedef struct
{
    ...
    UINT64  virt_addr;                          /**< virtual address returned by mmap */
...
#define LX_GFX_MUX_FACTOR_ONE_MINUS_CONST_COLOR     0xd
    ...
    struct
    {
         ...
         *      refer to gfx_kadp.c
         */
#define LX_GFX_SCALER_MODE_NONE         0x00
#define LX_GFX_SCALER_MODE_BILINEAR     0x01    /* default : wr sel */

#define LX_GFX_SCALER_SELECT_WR         0x00
#define LX_GFX_SCALER_SELECT_R0         0x10
#define LX_GFX_SCALER_SELECT_R1         0x20
#define LX_GFX_SCALER_SELECT_R2         0x30
...
typedef struct
{
    ...
    UINT32                  surface_mem_base;       /**< base address of surface memory */
