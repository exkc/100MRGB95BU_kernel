...
#ifndef __TOP_CTRL_OSD_REG_M17_H__
#define __TOP_CTRL_OSD_REG_M17_H__
...
typedef struct {
	...
	osd0_afbc_en                    : 1,	//    20
	                                : 2,	// 21:22 reserved
	reg_dly_sync_sel                : 1,	//    23
	osd1_afbc_en                    : 1,	//    24
	reg_dly_sync_delay              : 2,	// 25:26
	                                : 1,	//    27 reserved
	detour_en                       : 1,	//    28
...
typedef struct {
	...
	cco_dpe_o_ha_sel                : 3,	//  9:11
	                                : 4,	// 12:15 reserved
	ctrl_bosd_src_vs                : 1,	//    16
	ctrl_bosd_src_hs                : 1,	//    17
	ctrl_bosd_src_de                : 1,	//    18
...
typedef struct {
	UINT32
	auto_delay_ha                   :16,	//  0:15
	auto_delay_va                   :16;	// 16:31
...
typedef struct {
	UINT32
	auto_delay_hs                   :16,	//  0:15
	auto_delay_vs                   :16;	// 16:31
...
/*-----------------------------------------------------------------------------
	0x00e8 dbg_timer_blk ''
------------------------------------------------------------------------------*/
typedef struct {
	UINT32
	info_timer_blk                  :24,	//  0:23
	ctrl_timer_blk                  : 8;	// 24:31
} DBG_TIMER_BLK;
...
typedef struct {
	...
	UINT32                          	                 __rsvd_03[   2];	// 0x0058 ~ 0x005c
	...
	UINT32                          	                 __rsvd_05[   1];	// 0x00e0
	DBG_TIMER_RUN                   	dbg_timer_run                   ;	// 0x00e4 : ''
	DBG_TIMER_BLK                   	dbg_timer_blk                   ;	// 0x00e8 : ''
...
/* 56 regs, 56 types in Total*/

/* from 'M17-A0_PQE_TopCTRL_reg_man.csv' 20160318 19:46:56 KST by getregs v2.9 */

/*
 * @{
 * Naming for register pointer.
 * g_osd_top_m17_reg : real register of CCO_CTRL.
 * g_osd_top_m17_reg_shadow     : shadow register.
 *
 * @def OSD_TOP_M17_RdFL: Read  FLushing : Shadow <- Real.
 * @def OSD_TOP_M17_WrFL: Write FLushing : Shadow -> Real.
 * @def OSD_TOP_M17_Rd  : Read  whole register(UINT32) from Shadow register.
 * @def OSD_TOP_M17_Wr  : Write whole register(UINT32) from Shadow register.
 * @def OSD_TOP_M17_Rd01 ~ OSD_TOP_M17_Rdnn: Read  given '01~nn' fields from Shadow register.
 * @def OSD_TOP_M17_Wr01 ~ OSD_TOP_M17_Wrnn: Write given '01~nn' fields to   Shadow register.
 * */
#define OSD_TOP_M17_RdFL(_r)			((g_osd_top_m17_reg_shadow->_r)=(g_osd_top_m17_reg->_r))
#define OSD_TOP_M17_WrFL(_r)			((g_osd_top_m17_reg->_r)=(g_osd_top_m17_reg_shadow->_r))

#define OSD_TOP_M17_Rd(_r)				*((UINT32*)(&(g_osd_top_m17_reg_shadow->_r)))
#define OSD_TOP_M17_Wr(_r,_v)			((OSD_TOP_M17_Rd(_r))=((UINT32)(_v)))

#define OSD_TOP_M17_Rd01(_r,_f01,_v01)													\
								do { 											\
									(_v01) = (g_osd_top_m17_reg_shadow->_r._f01);				\
								} while(0)

#define OSD_TOP_M17_Rd02(_r,_f01,_v01,_f02,_v02)										\
								do { 											\
									(_v01) = (g_osd_top_m17_reg_shadow->_r._f01);				\
									(_v02) = (g_osd_top_m17_reg_shadow->_r._f02);				\
								} while(0)

#define OSD_TOP_M17_Rd03(_r,_f01,_v01,_f02,_v02,_f03,_v03)								\
								do { 											\
									(_v01) = (g_osd_top_m17_reg_shadow->_r._f01);				\
									(_v02) = (g_osd_top_m17_reg_shadow->_r._f02);				\
									(_v03) = (g_osd_top_m17_reg_shadow->_r._f03);				\
								} while(0)

#define OSD_TOP_M17_Rd04(_r,_f01,_v01,_f02,_v02,_f03,_v03,_f04,_v04)					\
								do { 											\
									(_v01) = (g_osd_top_m17_reg_shadow->_r._f01);				\
									(_v02) = (g_osd_top_m17_reg_shadow->_r._f02);				\
									(_v03) = (g_osd_top_m17_reg_shadow->_r._f03);				\
									(_v04) = (g_osd_top_m17_reg_shadow->_r._f04);				\
								} while(0)

#define OSD_TOP_M17_Rd05(_r,_f01,_v01,_f02,_v02,_f03,_v03,_f04,_v04,					\
					_f05,_v05)													\
								do { 											\
									(_v01) = (g_osd_top_m17_reg_shadow->_r._f01);				\
									(_v02) = (g_osd_top_m17_reg_shadow->_r._f02);				\
									(_v03) = (g_osd_top_m17_reg_shadow->_r._f03);				\
									(_v04) = (g_osd_top_m17_reg_shadow->_r._f04);				\
									(_v05) = (g_osd_top_m17_reg_shadow->_r._f05);				\
								} while(0)

#define OSD_TOP_M17_Rd06(_r,_f01,_v01,_f02,_v02,_f03,_v03,_f04,_v04,					\
					_f05,_v05,_f06,_v06)										\
								do { 											\
									(_v01) = (g_osd_top_m17_reg_shadow->_r._f01);				\
									(_v02) = (g_osd_top_m17_reg_shadow->_r._f02);				\
									...
									(_v04) = (g_osd_top_m17_reg_shadow->_r._f04);				\
									(_v05) = (g_osd_top_m17_reg_shadow->_r._f05);				\
									(_v06) = (g_osd_top_m17_reg_shadow->_r._f06);				\
								} while(0)

#define OSD_TOP_M17_Rd07(_r,_f01,_v01,_f02,_v02,_f03,_v03,_f04,_v04,					\
					_f05,_v05,_f06,_v06,_f07,_v07)								\
								do { 											\
									...
									(_v05) = (g_osd_top_m17_reg_shadow->_r._f05);				\
									(_v06) = (g_osd_top_m17_reg_shadow->_r._f06);				\
									(_v07) = (g_osd_top_m17_reg_shadow->_r._f07);				\
								} while(0)

#define OSD_TOP_M17_Rd08(_r,_f01,_v01,_f02,_v02,_f03,_v03,_f04,_v04,					\
					_f05,_v05,_f06,_v06,_f07,_v07,_f08,_v08)					\
								do { 											\
									...
									(_v06) = (g_osd_top_m17_reg_shadow->_r._f06);				\
									(_v07) = (g_osd_top_m17_reg_shadow->_r._f07);				\
									(_v08) = (g_osd_top_m17_reg_shadow->_r._f08);				\
								} while(0)

#define OSD_TOP_M17_Wr01(_r,_f01,_v01)													\
								do { 											\
									(g_osd_top_m17_reg_shadow->_r._f01) = (_v01);				\
								} while(0)

#define OSD_TOP_M17_Wr02(_r,_f01,_v01,_f02,_v02)										\
								do { 											\
									(g_osd_top_m17_reg_shadow->_r._f01) = (_v01);				\
									(g_osd_top_m17_reg_shadow->_r._f02) = (_v02);				\
								} while(0)

#define OSD_TOP_M17_Wr03(_r,_f01,_v01,_f02,_v02,_f03,_v03)								\
								do { 											\
									(g_osd_top_m17_reg_shadow->_r._f01) = (_v01);				\
									(g_osd_top_m17_reg_shadow->_r._f02) = (_v02);				\
									(g_osd_top_m17_reg_shadow->_r._f03) = (_v03);				\
								} while(0)

#define OSD_TOP_M17_Wr04(_r,_f01,_v01,_f02,_v02,_f03,_v03,_f04,_v04)					\
								do { 											\
									(g_osd_top_m17_reg_shadow->_r._f01) = (_v01);				\
									(g_osd_top_m17_reg_shadow->_r._f02) = (_v02);				\
									(g_osd_top_m17_reg_shadow->_r._f03) = (_v03);				\
									(g_osd_top_m17_reg_shadow->_r._f04) = (_v04);				\
								} while(0)

#define OSD_TOP_M17_Wr05(_r,_f01,_v01,_f02,_v02,_f03,_v03,_f04,_v04,					\
					_f05,_v05)													\
								do { 											\
									(g_osd_top_m17_reg_shadow->_r._f01) = (_v01);				\
									(g_osd_top_m17_reg_shadow->_r._f02) = (_v02);				\
									(g_osd_top_m17_reg_shadow->_r._f03) = (_v03);				\
									(g_osd_top_m17_reg_shadow->_r._f04) = (_v04);				\
									(g_osd_top_m17_reg_shadow->_r._f05) = (_v05);				\
								} while(0)

#define OSD_TOP_M17_Wr06(_r,_f01,_v01,_f02,_v02,_f03,_v03,_f04,_v04,					\
					_f05,_v05,_f06,_v06)										\
								do { 											\
									(g_osd_top_m17_reg_shadow->_r._f01) = (_v01);				\
									(g_osd_top_m17_reg_shadow->_r._f02) = (_v02);				\
									...
									(g_osd_top_m17_reg_shadow->_r._f04) = (_v04);				\
									(g_osd_top_m17_reg_shadow->_r._f05) = (_v05);				\
									(g_osd_top_m17_reg_shadow->_r._f06) = (_v06);				\
								} while(0)

#define OSD_TOP_M17_Wr07(_r,_f01,_v01,_f02,_v02,_f03,_v03,_f04,_v04,					\
					_f05,_v05,_f06,_v06,_f07,_v07)								\
								do { 											\
									(g_osd_top_m17_reg_shadow->_r._f01) = (_v01);				\
									(g_osd_top_m17_reg_shadow->_r._f02) = (_v02);				\
									...
									(g_osd_top_m17_reg_shadow->_r._f05) = (_v05);				\
									(g_osd_top_m17_reg_shadow->_r._f06) = (_v06);				\
									(g_osd_top_m17_reg_shadow->_r._f07) = (_v07);				\
								} while(0)

#define OSD_TOP_M17_Wr08(_r,_f01,_v01,_f02,_v02,_f03,_v03,_f04,_v04,					\
					_f05,_v05,_f06,_v06,_f07,_v07,_f08,_v08)					\
								do { 											\
									(g_osd_top_m17_reg_shadow->_r._f01) = (_v01);				\
									(g_osd_top_m17_reg_shadow->_r._f02) = (_v02);				\
									...
									(g_osd_top_m17_reg_shadow->_r._f06) = (_v06);				\
									(g_osd_top_m17_reg_shadow->_r._f07) = (_v07);				\
									(g_osd_top_m17_reg_shadow->_r._f08) = (_v08);				\
								} while(0)


/** @} *//* end of macro documentation */

extern volatile OSD_TOP_M17_REG_T*	g_osd_top_m17_reg;
extern OSD_TOP_M17_REG_T*			g_osd_top_m17_reg_shadow;
...
/* from 'M17_PQE_TopCTRL_reg_man.csv'  대한민국 표준시 by getregs v2.8 */
