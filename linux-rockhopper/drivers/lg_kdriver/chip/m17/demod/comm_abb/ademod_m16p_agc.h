...
**
*****************************************************************************/
#ifndef _ADEMOD_M16P_AGC_H_
#define _ADEMOD_M16P_AGC_H_
...
{
	int			clipper;
	int			instab_min;  //jeongpil.yun M16P
	int			instab_max;
	int			instab_thresh;
	UINT32		DAC_Dither;
	UINT32		Dither_LFSR;
...
**
******************************************************************************/
LX_ADEMOD_Result DEMOD_M16P_Analog_AGC_Gain_Set(pLX_ADEMOD_Agc pContext, UINT32 *pGain, Handle_t hUser, BOOL Update);
...
**
******************************************************************************/
LX_ADEMOD_Result DEMOD_M16P_Analog_AGC_Gain_Get(pLX_ADEMOD_Agc pContext, UINT32 *pGain, Handle_t hUser);
