...
#include "be_def.h"
#include "be_cfg.h"
#include "ipc_def_e60.h"
#include "ipc_drv.h"
#include "be_fwl_hw_e60.h"
...
----------------------------------------------------------------------------------------*/
extern BOOLEAN _BE_WCG_E60_IsHwComplete(void);
extern void _BE_WCG_E60_InitModeInfo(void);
...
/*----------------------------------------------------------------------------------------
	global Variables
----------------------------------------------------------------------------------------*/
BE_FWL_HAL_FW_T gHeader_Firmware_E60A0[BE_FW_DWLD_TYPE_MAXNUM] =
	{
#if CONFIG_LX_E60_CHIP_FIRMWARE
...
========================================================================================*/
BE_FWL_HAL_FW_T *BE_FWL_HW_E60_GetFwHeaderInfo(UINT8 ucIndex)
{
	...
	return &gHeader_Firmware_E60A0[ucIndex];
}
 ...
 */
UINT32 BE_FWL_HW_E60_FW_Download(UINT8 ucIndex, UINT8 *pucBuff, UINT32 ulSize, BOOLEAN bIsMcuFw)
{
	int ret = RET_OK;
 ...
 */
BOOLEAN BE_FWL_HW_E60_MCUisAlive(void)
{
 ...
 */
UINT32 BE_FWL_HW_E60_GetFwMemBaseSize(UINT8 ucIndex)
{
	int ret = RET_OK;
...
int BE_FWL_HW_E60_WcgFwInit(UINT32 u32FwBaseAddr)
{
	int ret = RET_OK;
...
int BE_FWL_HW_E60_LedFwInit(UINT32 u32FwBaseAddr)
{
	int ret = RET_OK;
...
int BE_FWL_HW_E60_ProcHandler(int proc_id, void* m, void* data)
{
