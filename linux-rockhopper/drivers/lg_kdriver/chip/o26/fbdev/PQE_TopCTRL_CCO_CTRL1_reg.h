#ifndef __PQE_TOP_CCO_CTRL1_REG_H__
#define __PQE_TOP_CCO_CTRL1_REG_H__
...
typedef struct {
    CCO1_PIC_INIT1                            pic_init                        ;    // 0x0000 : ''
    CCO1_PIC_START1                           pic_start                       ;    // 0x0004 : ''
    CCO1_CTRL_AUTO_INIT                      ctrl_auto_init                  ;    // 0x0008 : ''
    CCO1_CTRL_INTR_PULSE                     ctrl_intr_pulse                 ;    // 0x000c : ''
    CCO1_INTR_REG                            intr_reg                        ;    // 0x0010 : ''
    CCO1_INTR_MASK                           intr_mask                       ;    // 0x0014 : ''
    CCO1_INTR_MUX                            intr_mux                        ;    // 0x0018 : ''
    CCO1_INTR_EN                             intr_en                         ;    // 0x001c : ''
    CCO1_CTRL_INFO                           ctrl_info                       ;    // 0x0020 : ''
    CCO1_CTRL_CC_DATA_DLY                    ctrl_cc_data_dly                ;    // 0x0024 : ''
    CCO1_CTRL_OSD_CHANGE                     ctrl_osd_change                 ;    // 0x0028 : ''
    CCO1_CTRL_OSD_PIP_MERGE                  ctrl_osd_pip_merge              ;    // 0x002c : ''
    CCO1_CTRL_DATA_DLY                       ctrl_data_dly                   ;    // 0x0030 : ''
    CCO1_CTRL_OSD_120_SYNC_DLY0              ctrl_osd_120_sync_dly0          ;    // 0x0034 : ''
    CCO1_CTRL_OSD_120_SYNC_DLY1              ctrl_osd_120_sync_dly1          ;    // 0x0038 : ''
    CCO1_CTRL_OSD_120_SYNC_DLY2              ctrl_osd_120_sync_dly2          ;    // 0x003c : ''
    CCO1_CTRL_OSD_120_SYNC_DLY3              ctrl_osd_120_sync_dly3          ;    // 0x0040 : ''
    CCO1_CTRL_OSD_120_SYNC_DLY4              ctrl_osd_120_sync_dly4          ;    // 0x0044 : ''
    CCO1_CTRL_OSD_120_SYNC_DLY5              ctrl_osd_120_sync_dly5          ;    // 0x0048 : ''
    CCO1_CTRL_OSD_120_SYNC_DLY6              ctrl_osd_120_sync_dly6          ;    // 0x004c : ''
    CCO1_CTRL_OSD_120_SYNC_DLY7              ctrl_osd_120_sync_dly7          ;    // 0x0050 : ''
    CCO1_CTRL_OSD_120_SYNC_DLY8              ctrl_osd_120_sync_dly8          ;    // 0x0054 : ''
    CCO1_CTRL_OSD_120_SYNC_DLY9              ctrl_osd_120_sync_dly9          ;    // 0x0058 : ''
    CCO1_CTRL_OSD_120_SYNC_DLYA              ctrl_osd_120_sync_dlya          ;    // 0x005c : ''
    CCO1_CTRL_CCO_PPD_CTRL0                  ctrl_cco_ppd_ctrl0              ;    // 0x0060 : ''
    CCO1_CTRL_CCO_PPD_CTRL1                  ctrl_cco_ppd_ctrl1              ;    // 0x0064 : ''
    CCO1_CTRL_BOSD_PULSE                     ctrl_bosd_pulse                 ;    // 0x0068 : ''
    CCO1_CTRL_SOSD_PULSE                     ctrl_sosd_pulse                 ;    // 0x006c : ''
    CCO1_CTRL_BOSD_INIT_2ND                  ctrl_bosd_init_2nd              ;    // 0x0070 : ''
    CCO1_CTRL_SOSD_INIT_2ND                  ctrl_sosd_init_2nd              ;    // 0x0074 : ''
    UINT32                                                    __rsvd_00[   2];    // 0x0078 ~ 0x007c
    CCO1_CTRL_L3D_DMA_SIZE                   ctrl_l3d_dma_size               ;    // 0x0080 : ''
    CCO1_CTRL_L3D_DMA_CTRL                   ctrl_l3d_dma_ctrl               ;    // 0x0084 : ''
    CCO1_CTRL_RO_L3D_VCNT                    ctrl_ro_l3d_vcnt                ;    // 0x0088 : ''
    CCO1_CTRL_VR360_ON                       ctrl_vr360_on                   ;    // 0x008c : ''
    CCO1_CTRL_CG_ON                          ctrl_cg_on                      ;    // 0x0090 : ''
    CCO1_CTRL_CG_ON_SYNC                     ctrl_cg_on_sync                 ;    // 0x0094 : ''
    CCO1_CTRL_VR360_VID_DATA0                ctrl_vr360_vid_data0            ;    // 0x0098 : ''
    CCO1_CTRL_VR360_VID_DATA1                ctrl_vr360_vid_data1            ;    // 0x009c : ''
    CCO1_CTRL_VX1_CONTROL_PACKET0            ctrl_vx1_control_packet0        ;    // 0x00a0 : ''
    CCO1_CTRL_VX1_CONTROL_PACKET1            ctrl_vx1_control_packet1        ;    // 0x00a4 : ''
    CCO1_CTRL_VX1_CONTROL_PACKET2            ctrl_vx1_control_packet2        ;    // 0x00a8 : ''
    CCO1_CTRL_VX1_CONTROL_PACKET3            ctrl_vx1_control_packet3        ;    // 0x00ac : ''
    CCO1_CTRL_VX1_CONTROL_PACKET4            ctrl_vx1_control_packet4        ;    // 0x00b0 : ''
    CCO1_CTRL_VX1_CONTROL_PACKET5            ctrl_vx1_control_packet5        ;    // 0x00b4 : ''
    CCO1_CTRL_VX1_CONTROL_PACKET6            ctrl_vx1_control_packet6        ;    // 0x00b8 : ''
    CCO1_AXI_USER_CCO                        axi_user_cco                    ;    // 0x00bc : ''
    CCO1_PIC_INIT_G0_TIMER                   pic_init_g0_timer               ;    // 0x00c0 : ''
    CCO1_PIC_INIT_G1_TIMER                   pic_init_g1_timer               ;    // 0x00c4 : ''
    CCO1_PIC_INIT_G2_TIMER                   pic_init_g2_timer               ;    // 0x00c8 : ''
    CCO1_PIC_INIT_G3_TIMER                   pic_init_g3_timer               ;    // 0x00cc : ''
    CCO1_PIC_INIT_G4_TIMER                   pic_init_g4_timer               ;    // 0x00d0 : ''
    CCO1_PIC_INIT_G5_TIMER                   pic_init_g5_timer               ;    // 0x00d4 : ''
    CCO1_PIC_INIT_G6_TIMER                   pic_init_g6_timer               ;    // 0x00d8 : ''
    CCO1_PIC_INIT_G7_TIMER                   pic_init_g7_timer               ;    // 0x00dc : ''
    UINT32                                                    __rsvd_01[   1];    // 0x00e0
    CCO1_DBG_TIMER_RUN                       dbg_timer_run                   ;    // 0x00e4 : ''
    CCO1_GX_PIC_START_END_PROC               gx_pic_start_end_proc           ;    // 0x00e8 : ''
    CCO1_CTRL_MONITOR                        ctrl_monitor                    ;    // 0x00ec : ''
    CCO1_CTRL_PIC_END                        ctrl_pic_end                    ;    // 0x00f0 : ''
    CCO1_INFO_PIC_END                        info_pic_end                    ;    // 0x00f4 : ''
    CCO1_CTRL_GPIO                           ctrl_gpio                       ;    // 0x00f8 : ''
    CCO1_CTRL_GMAU                           ctrl_gmau                       ;    // 0x00fc : ''
} CCO_CTRL1_O26_REG_T;
/* 61 regs, 61 types */
...
#define CCO_CTRL1_RdFL(_r)           ((g_cco_ctrl1_o26_reg_shadow->_r)=(g_cco_ctrl1_o26_reg->_r))
#define CCO_CTRL1_WrFL(_r)           ((g_cco_ctrl1_o26_reg->_r)=(g_cco_ctrl1_o26_reg_shadow->_r))

#define CCO_CTRL1_Rd(_r)             *((UINT32*)(&(g_cco_ctrl1_o26_reg_shadow->_r)))
#define CCO_CTRL1_Wr(_r,_v)          ((CCO_CTRL1_Rd(_r))=((UINT32)(_v)))

#define CCO_CTRL1_Rd01(_r,_f01,_v01)                                                 \
                                do {                                                    \
                                    (_v01) = (g_cco_ctrl1_o26_reg_shadow->_r._f01);  \
                                } while(0)

#define CCO_CTRL1_Rd02(_r,_f01,_v01,_f02,_v02)                                       \
                                do {                                                    \
                                    (_v01) = (g_cco_ctrl1_o26_reg_shadow->_r._f01);  \
                                    (_v02) = (g_cco_ctrl1_o26_reg_shadow->_r._f02);  \
                                } while(0)

#define CCO_CTRL1_Wr01(_r,_f01,_v01)                                                 \
                                do {                                                    \
                                    (g_cco_ctrl1_o26_reg_shadow->_r._f01) = (_v01);  \
                                } while(0)

#define CCO_CTRL1_Wr02(_r,_f01,_v01,_f02,_v02)                                       \
                                do {                                                    \
                                    (g_cco_ctrl1_o26_reg_shadow->_r._f01) = (_v01);  \
                                    (g_cco_ctrl1_o26_reg_shadow->_r._f02) = (_v02);  \
                                } while(0)

extern volatile CCO_CTRL1_O26_REG_T* g_cco_ctrl1_o26_reg;
extern CCO_CTRL1_O26_REG_T*          g_cco_ctrl1_o26_reg_shadow;
...
/* from 'O26-A0_PQE_TopCTRL_reg_man_CCO_CTRL11.csv' 20241210 18:02:35 KST by getregs v2.9 */
