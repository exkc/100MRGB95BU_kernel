...
const PE_REG_PARAM_T sre_2k_res_hd_dtv_default_o18[] =
{
    ...
    {0x912C, 0x60500000},      // SHP_FD_CTRL_07         
    ...
    {0x9168, 0x00006000},      // SHP_MP_CTRL_02         
    ...
    {0x9190, 0x18182020},      // SHP_MP_CTRL_0C         
