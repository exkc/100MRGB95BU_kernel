...
#ifndef	_IRB_O26_COMMON_H_
#define	_IRB_O26_COMMON_H_
...
extern OS_SEM_T			o26_irb_mutex;

#define O26_KDRV_IRB_LOCK_INIT()		OS_InitMutex(&o26_irb_mutex, OS_SEM_ATTR_DEFAULT)
#define O26_KDRV_IRB_LOCK()                      \
    do{                                             \
        if(OS_LockMutex(&o26_irb_mutex) < 0)             \
        {                                           \
...
#define O26_KDRV_IRB_UNLOCK()                    \
    do{                                             \
        OS_UnlockMutex(&o26_irb_mutex);                  \
    }while(0)

#define O26_IRB_BASE 0xf9600000



    typedef struct o26_irb_unit
    {
	...
	o26_irb_unit_t prot_data[31];
	o26_irb_unit_t rpt_data[2];
    } o26_irb_t;
