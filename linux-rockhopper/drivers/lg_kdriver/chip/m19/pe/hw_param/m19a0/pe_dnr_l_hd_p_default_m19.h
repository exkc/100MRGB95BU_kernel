...
const PE_REG_PARAM_T dnr_l_hd_p_default_m19[] =
{	
    {0x3594, 0x00400221},       // DNR_MAX_CTRL
    ...
    {0x36A8, 0x10101010},       // DC_BNR_CTRL_7
    ...
    {0x37A8, 0x70002010},       // REG_MNR_CTRL_6
    {0x37AC, 0x01020408},       // REG_MNR_CTRL_7
    {0x37B0, 0xFFC0A080},       // REG_MNR_CTRL_8
    {0x37B4, 0x05284060},       // REG_MNR_CTRL_9
    {0x37B8, 0xFF6080FF},       // REG_MNR_CTRL_10
    ...
    {0x37E0, 0x53200005},       // REG_DECON_CTRL_18
    {0x37E4, 0x20160805},       // REG_DECON_CTRL_19
    {0x37E8, 0x002080C0},       // REG_DECON_CTRL_20
    ...
    {0x3810, 0xC4050000},       // REG_DECON_CTRL_30
