...
#ifndef	_IRB_E60_COMMON_H_
#define	_IRB_E60_COMMON_H_
...
#define E60_IRB_BASE 0xf9600000



typedef struct e60_irb_unit
{
...
typedef struct e60_irb
{
  ...
  e60_irb_unit_t prot_data[31];
  e60_irb_unit_t rpt_data[2];
} e60_irb_t;
...
extern unsigned int  get_micom_disable(void);
