...
const PE_REG_PARAM_T sre_2k_res_sd_dtv_default_o18[] =
{
    {0x9100, 0x00000000},      // SHP_DP_CTRL_00
    {0x9110, 0x036A025B},      // SHP_FD_CTRL_00
    {0x9114, 0x0E000404},      // SHP_FD_CTRL_01
    {0x9118, 0x10081414},      // SHP_FD_CTRL_02
    {0x911C, 0x80FF5800},      // SHP_FD_CTRL_03
    {0x9120, 0x80800000},      // SHP_FD_CTRL_04
    {0x9124, 0x40FF1000},      // SHP_FD_CTRL_05
    {0x9128, 0xC0602020},      // SHP_FD_CTRL_06
    {0x912C, 0xA0180810},      // SHP_FD_CTRL_07
    {0x9130, 0x80800840},      // SHP_FD_CTRL_08
    ...
    {0x914C, 0x00000000},      // SHP_FD_CTRL_0F
    {0x9150, 0x0000086E},      // SHP_FD_CTRL_10
    {0x9154, 0x40300802},      // SHP_FD_CTRL_11
    {0x9158, 0x2E3E0A00},      // SHP_FD_CTRL_12
    {0x9160, 0x00000000},      // SHP_MP_CTRL_00
    {0x9164, 0x20102020},      // SHP_MP_CTRL_01
    {0x9168, 0x00003000},      // SHP_MP_CTRL_02
    {0x916C, 0x48600010},      // SHP_MP_CTRL_03
    {0x9170, 0x00000000},      // SHP_MP_CTRL_04
    {0x9174, 0x00040201},      // SHP_MP_CTRL_05
    {0x9178, 0x00804040},      // SHP_MP_CTRL_06
    {0x917C, 0xC0906030},      // SHP_MP_CTRL_07
    {0x9180, 0x30C06020},      // SHP_MP_CTRL_08
    {0x9184, 0x20C09060},      // SHP_MP_CTRL_09
    {0x9188, 0x0000C060},      // SHP_MP_CTRL_0A
    {0x918C, 0x00000007},      // SHP_MP_CTRL_0B
    {0x9190, 0x10100408},      // SHP_MP_CTRL_0C
    {0x9194, 0x0000F001},      // SHP_APL_CTRL_00
    {0x91A0, 0xFFA02010},      // SHP_LC_CTRL_00
    {0x91A4, 0x08003020},      // SHP_LC_CTRL_01
    {0x91A8, 0xFF600800},      // SHP_LC_CTRL_02
    {0x91AC, 0x08081017},      // SHP_LC_CTRL_03
    {0x91B0, 0x08080410},      // SHP_LC_CTRL_04
    {0x91C0, 0x00060001},      // SHP_DER_CTRL_00
    {0x91C4, 0x85060601},      // SHP_DER_CTRL_01
    {0x91C8, 0x00101000},      // SHP_DER_CTRL_02
    {0x91CC, 0x00065008},      // SHP_DER_CTRL_03
    {0x91D0, 0x00000008},      // SHP_DER_CTRL_04
    {0x91D4, 0x00000000},      // SHP_DER_CTRL_05
    {0x91D8, 0x20041000},      // SHP_DER_CTRL_06
    {0x91DC, 0x90E04008},      // SHP_DER_CTRL_07
    {0x91E0, 0x00000000},      // SHP_SP_CTRL_00
    {0x91E4, 0x00101010},      // SHP_SP_CTRL_01
    {0x91E8, 0x00002000},      // SHP_SP_CTRL_02
    {0x91EC, 0x62100000},      // SHP_SP_CTRL_03
    {0x91F0, 0x00401000},      // SHP_SP_CTRL_04
    {0x91F4, 0x00020201},      // SHP_SP_CTRL_05
    {0x91F8, 0x00803020},      // SHP_SP_CTRL_06
    {0x91FC, 0xC0906030},      // SHP_SP_CTRL_07
    {0x9200, 0x30C06020},      // SHP_SP_CTRL_08
    {0x9204, 0x20C09060},      // SHP_SP_CTRL_09
    {0x9208, 0x0000C060},      // SHP_SP_CTRL_0A
    {0x920C, 0x00000007},      // SHP_SP_CTRL_0B
    {0x9210, 0x10100410},      // SHP_SP_CTRL_0C
    {0x9220, 0x0000087D},      // SHP_PTI_CTRL_00
    {0x9224, 0x00004069},      // SHP_PTI_CTRL_01
    {0x9228, 0x00000007},      // SHP_PTI_CTRL_02
    {0x922C, 0x10100408},      // SHP_PTI_CTRL_03
    {0x9230, 0x1000403D},      // SHP_STI_CTRL_00
    {0x9240, 0x40000010},      // SHP_TGEN_CTRL_00
    ...
    {0x9270, 0x10100000},      // SHP_TGEN_CTRL_0B
    {0x9274, 0x00000100},      // SHP_SNR_CTRL_00
    {0x9280, 0x00000000},      // SHP_DCTP_CTRL_00
    ...
    {0x92EC, 0x404008E0},      // SHP_DCTP_CTRL_1B
    {0x92F0, 0xC0FF90C0},      // SHP_DCTP_CTRL_1C
    {0x92F4, 0x00000040},      // SHP_DCTP_CTRL_1D
    {0x92F8, 0x00000007},      // SHP_DCTP_CTRL_1E
    {0x92FC, 0x10100410},      // SHP_DCTP_CTRL_1F
    {0x9300, 0x00000000},      // SHP_NNTG_CTRL_00
    ...
    {0x933C, 0x03400100},      // SHP_NNTG_CTRL_0A
    {0x9340, 0x0A000630},      // SHP_NNTG_CTRL_0B
    {0x9344, 0x209010FF},      // SHP_NNTG_CTRL_0C
    {0x9348, 0xC0008040},      // SHP_NNTG_CTRL_0D
    {0x934C, 0xC01018A0},      // SHP_NNTG_CTRL_0E
    {0x9350, 0x00000005},      // SHP_NNTG_CTRL_0F
    {0x9354, 0x18180000},      // SHP_NNTG_CTRL_10
    {0x9360, 0x00000080},      // SHP_DP_SUM_CTRL_00
    {0x9400, 0x80100039},      // SHP_DJ_CTRL_00
    {0x9404, 0x00800000},      // SHP_DJ_CTRL_01
    {0x9408, 0x00000810},      // SHP_DJ_CTRL_02
    ...
    {0x9474, 0x00FF0614},      // SHP_DJ_CTRL_1D
    {0x9478, 0x00FF0412},      // SHP_DJ_CTRL_1E
    {0x947C, 0x00FF0610},      // SHP_DJ_CTRL_1F
    {0x9480, 0x00011400},      // SHP_DJ_CTRL_20
    {0x9490, 0x00000000},      // SHP_DIR_BLUR_CTRL_00
    {0x9494, 0x00200008},      // SHP_DIR_BLUR_CTRL_01
};
