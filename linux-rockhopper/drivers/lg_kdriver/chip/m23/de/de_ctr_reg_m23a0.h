...
#ifndef _DE_CTR_REG_M23A0_H_
#define _DE_CTR_REG_M23A0_H_

typedef union {
	UINT32 udata32;
	struct {						//0xCC6D0010 RW 0x0000_0000
	...
	UINT32 intr_g7_pic_end                  :1;	//(15,RW,0x00) //[FRAME_END] MVI_RN
...
}M23A0_IMX_CTRL_INTR_REG_T;

typedef union {
	UINT32 udata32;
	struct {						//0xCC620050 RW 0x0000_0000
	UINT32 intr_i0_intr_pulse               :1;	//(0,RW,0x00) //[SRC_PULSE] s0_src_pulse
	UINT32 intr_i1_intr_pulse               :1;	//(1,RW,0x00) //[SRC_PULSE] s2_src_pulse
	UINT32 intr_i2_intr_pulse               :1;	//(2,RW,0x00) //[SRC_PULSE] s4_src_pulse
	UINT32 intr_i3_intr_pulse               :1;	//(3,RW,0x00) //[SRC_PULSE] s6_src_pulse
