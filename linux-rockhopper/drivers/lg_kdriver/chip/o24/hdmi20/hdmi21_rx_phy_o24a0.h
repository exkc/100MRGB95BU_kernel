...
#ifndef __HDMI20_RX_PHY_O24A0_H__
#define __HDMI20_RX_PHY_O24A0_H__
...
#include "hdmi21_rx_phy_b0_o24a0.h"
#include "hdmi21_rx_phy_b1_o24a0.h"
#include "hdmi21_rx_phy_b2_o24a0.h"
...
/* O24:B0 */
#define PHY_REG_O24A0_SHDW(_port)		(phyReg_o24a0[_port].shdw.O24)
#define PHY_REG_B1_O24A0_SHDW(_port)	(phyReg_B1_o24a0[_port].shdw.O24)
#define PHY_REG_B2_O24A0_SHDW(_port)	(phyReg_B2_o24a0[_port].shdw.O24)
...
#define PHY_O24_REG_RdFL(_chip, _port, _r)						\
	do{ 														\
...
#define PHY_O24_REG_B1_RdFL(_chip, _port, _r)					\
	do{ 														\
...
#define PHY_O24_REG_B2_RdFL(_chip, _port, _r)					\
	do{ 														\
...
#define PHY_O24_REG_WrFL(_chip,_port, _r)						\
	do{ 														\
...
#define PHY_O24_REG_B1_WrFL(_chip,_port, _r)						\
	do{ 															\
...
#define PHY_O24_REG_B2_WrFL(_chip,_port, _r)						\
	do{ 															\
...
#define PHY_O24_REG_Rd01(_chip,_port,_r,_f01,_v01) \
	_REG_Rd01(PHY_REG_##_chip##_SHDW(_port),_r,_f01,_v01)

#define PHY_O24_REG_Rd02(_chip,_port,_r,_f01,_v01,_f02,_v02) \
	_REG_Rd02(PHY_REG_##_chip##_SHDW(_port),_r,_f01,_v01,_f02,_v02)

#define PHY_O24_REG_B1_Rd01(_chip,_port,_r,_f01,_v01) \
	_REG_Rd01(PHY_REG_B1_##_chip##_SHDW(_port),_r,_f01,_v01)

#define PHY_O24_REG_B1_Rd02(_chip,_port,_r,_f01,_v01,_f02,_v02) \
	_REG_Rd02(PHY_REG_B1_##_chip##_SHDW(_port),_r,_f01,_v01,_f02,_v02)

#define PHY_O24_REG_B2_Rd01(_chip,_port,_r,_f01,_v01) \
	_REG_Rd01(PHY_REG_B2_##_chip##_SHDW(_port),_r,_f01,_v01)

#define PHY_O24_REG_B2_Rd02(_chip,_port,_r,_f01,_v01,_f02,_v02) \
	_REG_Rd02(PHY_REG_B2_##_chip##_SHDW(_port),_r,_f01,_v01,_f02,_v02)


#define PHY_O24_REG_Wr01(_chip,_port,_r,_f01,_v01) \
	_REG_Wr01(PHY_REG_##_chip##_SHDW(_port),_r,_f01,_v01)

#define PHY_O24_REG_Wr02(_chip,_port,_r,_f01,_v01,_f02,_v02) \
	_REG_Wr02(PHY_REG_##_chip##_SHDW(_port),_r,_f01,_v01,_f02,_v02)

#define PHY_O24_REG_B1_Wr01(_chip,_port,_r,_f01,_v01) \
	_REG_Wr01(PHY_REG_B1_##_chip##_SHDW(_port),_r,_f01,_v01)

#define PHY_O24_REG_B1_Wr02(_chip,_port,_r,_f01,_v01,_f02,_v02) \
	_REG_Wr02(PHY_REG_B1_##_chip##_SHDW(_port),_r,_f01,_v01,_f02,_v02)

#define PHY_O24_REG_B2_Wr01(_chip,_port,_r,_f01,_v01) \
	_REG_Wr01(PHY_REG_B2_##_chip##_SHDW(_port),_r,_f01,_v01)

#define PHY_O24_REG_B2_Wr02(_chip,_port,_r,_f01,_v01,_f02,_v02) \
	_REG_Wr02(PHY_REG_B2_##_chip##_SHDW(_port),_r,_f01,_v01,_f02,_v02)


/* O24:B0 */
#define PHY_REG_O24A0_RdFL(_port,_r)		{PHY_O24_REG_RdFL(O24A0,_port,_r);}
#define PHY_REG_O24A0_WrFL(_port,_r)		{PHY_O24_REG_WrFL(O24A0,_port,_r);}

#define PHY_REG_B1_O24A0_RdFL(_port,_r)		{PHY_O24_REG_B1_RdFL(O24A0,_port,_r);}
#define PHY_REG_B1_O24A0_WrFL(_port,_r)		{PHY_O24_REG_B1_WrFL(O24A0,_port,_r);}

#define PHY_REG_B2_O24A0_RdFL(_port,_r)		{PHY_O24_REG_B2_RdFL(O24A0,_port,_r);}
#define PHY_REG_B2_O24A0_WrFL(_port,_r)		{PHY_O24_REG_B2_WrFL(O24A0,_port,_r);}


#define PHY_REG_O24A0_Rd01(_port,_r,_f01,_v01)			{PHY_O24_REG_Rd01(O24A0,_port,_r,_f01,_v01);}
#define PHY_REG_O24A0_Rd02(_port,_r,_f01,_v01,_f02,_v02)	{PHY_O24_REG_Rd02(O24A0,_port,_r,_f01,_v01,_f02,_v02);}

#define PHY_REG_B1_O24A0_Rd01(_port,_r,_f01,_v01)			{PHY_O24_REG_B1_Rd01(O24A0,_port,_r,_f01,_v01);}
#define PHY_REG_B1_O24A0_Rd02(_port,_r,_f01,_v01,_f02,_v02)	{PHY_O24_REG_B1_Rd02(O24A0,_port,_r,_f01,_v01,_f02,_v02);}

#define PHY_REG_B2_O24A0_Rd01(_port,_r,_f01,_v01)			{PHY_O24_REG_B2_Rd01(O24A0,_port,_r,_f01,_v01);}
#define PHY_REG_B2_O24A0_Rd02(_port,_r,_f01,_v01,_f02,_v02)	{PHY_O24_REG_B2_Rd02(O24A0,_port,_r,_f01,_v01,_f02,_v02);}

#define PHY_REG_O24A0_Wr01(_port,_r,_f01,_v01)			{PHY_O24_REG_Wr01(O24A0,_port,_r,_f01,_v01);}
#define PHY_REG_O24A0_Wr02(_port,_r,_f01,_v01,_f02,_v02)	{PHY_O24_REG_Wr02(O24A0,_port,_r,_f01,_v01,_f02,_v02);}

#define PHY_REG_B1_O24A0_Wr01(_port,_r,_f01,_v01)			{PHY_O24_REG_B1_Wr01(O24A0,_port,_r,_f01,_v01);}
#define PHY_REG_B1_O24A0_Wr02(_port,_r,_f01,_v01,_f02,_v02)	{PHY_O24_REG_B1_Wr02(O24A0,_port,_r,_f01,_v01,_f02,_v02);}

#define PHY_REG_B2_O24A0_Wr01(_port,_r,_f01,_v01)			{PHY_O24_REG_B2_Wr01(O24A0,_port,_r,_f01,_v01);}
#define PHY_REG_B2_O24A0_Wr02(_port,_r,_f01,_v01,_f02,_v02)	{PHY_O24_REG_B2_Wr02(O24A0,_port,_r,_f01,_v01,_f02,_v02);}
...
typedef struct
{
	union {
		UINT32          *addr;
		HDMI21_PHY_REG_O24A0_T	*O24;
	} shdw;
} HDMI21_PHY_REG_CTRL_O24A0_T;

typedef struct
{
	union {
		UINT32          *addr;
		HDMI21_PHY_REG_B1_O24A0_T	*O24;
	} shdw;
} HDMI21_PHY_REG_CTRL_B1_O24A0_T;
...
typedef struct
{
	union {
		UINT32          *addr;
		HDMI21_PHY_REG_B2_O24A0_T	*O24;
	} shdw;
} HDMI21_PHY_REG_CTRL_B2_O24A0_T;
...
/* 2020/06/09 : O24A0 Chip Bug SWWA */
