...
extern int debugpin;
extern int debugpindir;
extern int debugpinval;
...
extern wait_queue_head_t gGPIOIntrDurWaitQueue;

extern wait_queue_head_t* gGPIOPollWaitQueueT[GPIO_IRQ_NUM_NR + 1];
#ifdef	__cplusplus
}
#endif /* __cplusplus */
