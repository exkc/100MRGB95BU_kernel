...
#include "ademod_l18f_UserSettings.c"


LX_ADEMOD_Result DEMOD_L18F_Analog_Preset_Set(Handle_t hDevice, UINT32 smartTuneFilter, UINT32 Section)
{
			...
			if (smartTuneFilter & LX_ADEMOD_SmartTuneFilterAnalog) { // Analog mode
				...
				if(lx_chip_rev() <= LX_CHIP_REV( M16, A1)) // temp chungiii 2016_0425
				{
					switch (smartTuneFilter & LX_ADEMOD_SmartTuneFilterMode) // Video Standard
					{
						...
						#ifdef NTSC_M_USER
							ADEMOD_UserSettings = &ADEMOD_UserSettings_NTSC_M_L18F;
							Size = sizeof(ADEMOD_UserSettings_NTSC_M_L18F) / sizeof(LX_ADEMOD_PARAM);
						#endif
						break;
						case LX_ADEMOD_VIDEO_STANDARD_PAL_B:
						#ifdef PAL_B_USER
							ADEMOD_UserSettings = &ADEMOD_UserSettings_PAL_B_L18F;
							Size = sizeof(ADEMOD_UserSettings_PAL_B_L18F) / sizeof(LX_ADEMOD_PARAM);
						#endif
						break;
						case LX_ADEMOD_VIDEO_STANDARD_PAL_D:
						#ifdef PAL_D_USER
							ADEMOD_UserSettings = &ADEMOD_UserSettings_PAL_D_L18F;
							Size = sizeof(ADEMOD_UserSettings_PAL_D_L18F) / sizeof(LX_ADEMOD_PARAM);
						#endif
						break;
						case LX_ADEMOD_VIDEO_STANDARD_PAL_I:
						#ifdef PAL_I_USER
							ADEMOD_UserSettings = &ADEMOD_UserSettings_PAL_I_L18F;
							Size = sizeof(ADEMOD_UserSettings_PAL_I_L18F) / sizeof(LX_ADEMOD_PARAM);
						#endif
						break;
						case LX_ADEMOD_VIDEO_STANDARD_SECAM_L:
						#ifdef SECAM_L_USER
							ADEMOD_UserSettings = &ADEMOD_UserSettings_SECAM_L_L18F;
							Size = sizeof(ADEMOD_UserSettings_SECAM_L_L18F) / sizeof(LX_ADEMOD_PARAM);
						#endif
						break;
						case LX_ADEMOD_VIDEO_STANDARD_SECAM_L1:
						#ifdef SECAM_L1_USER
							ADEMOD_UserSettings = &ADEMOD_UserSettings_SECAM_L1_L18F;
							Size = sizeof(ADEMOD_UserSettings_SECAM_L1_L18F) / sizeof(LX_ADEMOD_PARAM);
						#endif
						break;
						case LX_ADEMOD_VIDEO_STANDARD_PAL_DK_NICAM:
						#ifdef PAL_DK_NICAM_USER
							ADEMOD_UserSettings = &ADEMOD_UserSettings_PAL_DK_NICAM_L18F;
							Size = sizeof(ADEMOD_UserSettings_PAL_DK_NICAM_L18F) / sizeof(LX_ADEMOD_PARAM);
						#endif
						break;
						default:
						break;
