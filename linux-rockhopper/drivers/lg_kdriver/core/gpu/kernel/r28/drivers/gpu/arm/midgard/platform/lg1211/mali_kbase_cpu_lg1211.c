...
#include "mali_kbase_cpu_lg1211.h"
...
*/
int kbase_get_lg1211_cpu_clock_speed(u32 *cpu_clock)
{
	int err = 0;
	u32 reg_val = 0;
	u32 osc2_value = 0;
 ...
 *
 * When platform_config build parameter is specified as lg1211, i.e.,
 * platform_config=lg1211, GPU frequency may vary dependent on the
