...
typedef enum {
	DDR_ADDR_START =	0x50000000,
		DDR_DATA_START =	0x50040000,
			DDR_A3_NOTI_TABLE_BASE =	0x50040000,
			DDR_A3_NOTI_TABLE_LAST =	0x5006FFFC,
		DDR_DATA_END =		0x5006FFFC,
		DDR_INFO_START =	0x50070000,
			/* ... */
			DDR_MCU_TO_DBG_BASE =		0x50072000,
			DDR_MCU_TO_DBG_LAST =		0x50072FFC,
			/* ... */
			DDR_TEST_INFO_BASE =		0x5007C000,
			DDR_DEBUG_INFO_BASE =		0x5007D000,
			DDR_ERROR_INFO_BASE =		0x5007E000,
			DDR_FAULT_INFO_BASE =		0x5007F000,
		DDR_INFO_END =		0x5007FFFC,
	DDR_ADDR_END =		0x5007FFFC,
} LX_DEMOD_L0_DDRMAP;
