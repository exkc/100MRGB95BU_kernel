...
/*****************************************************************************
**
**  Name: ademod_o18_agc_dig.h
**
**  Description:   ABB O18 Digital AGC block.
**
**  Functions
**  Implemented:    LX_ADEMOD_Result DEMOD_O18_Analog_DigAGC_Factory_Set
**                  LX_ADEMOD_Result DEMOD_O18_Analog_DigAGC_Line_Set
**                  LX_ADEMOD_Result DEMOD_O18_Analog_DigAGC_Flags_Set
**                  LX_ADEMOD_Result DEMOD_O18_Analog_DigAGC_Flags_Get
**                  LX_ADEMOD_Result DEMOD_O18_Analog_DigAGC_Standard_Set
**                  LX_ADEMOD_Result DEMOD_O18_Analog_DigAGC_Init
**                  LX_ADEMOD_Result DEMOD_O18_Analog_DigAGC_Start
**
**  References:
**
**  Exports:        LX_ADEMOD_Result DEMOD_O18_Analog_DigAGC_Factory_Set
**                  LX_ADEMOD_Result DEMOD_O18_Analog_DigAGC_Line_Set
**                  LX_ADEMOD_Result DEMOD_O18_Analog_DigAGC_Flags_Set
**                  LX_ADEMOD_Result DEMOD_O18_Analog_DigAGC_Flags_Get
**                  LX_ADEMOD_Result DEMOD_O18_Analog_DigAGC_Standard_Set
...
**
*****************************************************************************/
#ifndef _ADEMOD_O18_AGC_DIG_H_
#define _ADEMOD_O18_AGC_DIG_H_
...
typedef struct LX_ADEMOD_DigAgc_tag {
	Handle_t		hDevice;   //jeongpil.yun for O18
	UINT32			flags;
	UINT32			update;
	UINT32			factory;
	INT64			max_gain_rf;
