...
static LX_MEMCFG_DESC_T mem_desc[MEM_DESC_ID_MAX]	= {
	...
	DEFINE_MEM_DESC(DEMOD0	,MEMCFG_DESC_FLAG_NO_CMA),
	DEFINE_MEM_DESC(DEMOD1	,MEMCFG_DESC_FLAG_NO_CMA),
	DEFINE_MEM_DESC(DEMOD2	,MEMCFG_DESC_FLAG_NO_CMA),
...
#ifdef INCLUDE_KDRV_DEMOD
	LX_MEMCFG_ENTRY_EX(gMemCfgDEMOD, 		MEM_DESC(DEMOD0)),	/* DEMOD */
	LX_MEMCFG_ENTRY_EX(gMemCfgDEMOD_DVB_TDI,MEM_DESC(DEMOD0)),	/* DEMOD */
	LX_MEMCFG_ENTRY_EX(gMemCfgDEMOD_DVB_DJB,MEM_DESC(DEMOD0)),	/* DEMOD */
#endif
...
static void BASE_PLT_Setup_256MB(void)
{
    ...
    gMemCfgHdr[DDR_RGN_M0_DEV].base   = M0_256M_DEV_RGN_BASE;
    gMemCfgHdr[DDR_RGN_M0_DEV].size   = M0_256M_DEV_RGN_SZ;
    gMemCfgHdr[DDR_RGN_M1_DEV].base   = M0_STATIC_DEV_RGN_BASE;
    gMemCfgHdr[DDR_RGN_M1_DEV].size   = M0_STATIC_DEV_RGN_SZ;
...
static void BASE_PLT_DoPostMemoryLayout(void)
{
	...
	// raxis.lim (2017/05/12) -- surface can't hold any additonal alloc request :(
