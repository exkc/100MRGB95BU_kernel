...
#define REG_PCM_SUB0_DSPMODE                    sub0bc_ctrl
#define FLD_PCM_SUB0_DSPMODE                    pcm_sub0_dspmode
#define REG_PCM_SUB0_SWRESET                    sub0bc_ctrl
#define FLD_PCM_SUB0_SWRESET                    pcm_sub0_swreset
#define REG_PCM_SUB0_UNIT_INT_ENABLE            sub0bc_ctrl
#define FLD_PCM_SUB0_UNIT_INT_ENABLE            pcm_sub0_uniten
#define REG_PCM_SUB0_DATA_FORMAT                sub0bc_ctrl
#define FLD_PCM_SUB0_DATA_FORMAT                pcm_sub0_dataformat
#define REG_PCM_SUB0_START_ADDRESS              sub0bc_start_address
#define REG_PCM_SUB0_END_ADDRESS                sub0bc_end_address
#define REG_PCM_SUB0_WRITE_ADDRESS              sub0bc_write_address
#define REG_PCM_SUB0_READ_ADDRESS               sub0bc_read_address
#define REG_PCM_SUB0_ALMOST_LEVEL               sub0bc_almost_empty_level
#define REG_PCM_SUB0_UNIT_SIZE                  sub0bc_unit_interrupt_level
...
CONFIG_FUNC_DECLARATION (PCM_SUB0);
...
static struct bc_config bc_configs[] = {
    ...
    [BC_HEADPHONE]   = { "bc-hp",       CONFIG_FUNC_NAME (PCM_SUB0),     { 0x00,     8192,    256, 3 }, { .in = false } },
    ...
    [BC_HEADPHONE]   = { "bc-hp",       CONFIG_FUNC_NAME (PCM_SUB0),     { 0x00,     4096,    256, 3 }, { .in = false } },
    [BC_SPDIF]       = { "bc-spdif",    CONFIG_FUNC_NAME (SPDIF),       { 0x00,     4096,    256, 3 }, { .in = false } },
