...
static char * core_avstype[5] = { "XXX","SLOW","NORMAL","FAST", "FFAST", };
static char * core_volttype[5] = { "XXX","0.93","0.91","0.89", "0.87", };
static char * core_vidttype[5] = { "GPIO 31[0] 13[0]","GPIO 31[0] 13[0]","GPIO 30[0] 13[1]","GPIO 31[1] 13[0]","GPIO 31[1] 13[1]", };
...
char * core_volttype_c0[5] = { "XXX","0.91","0.89","0.87", "0.85", };
static char * core_vidttype_c0[5] = { "GPIO 31[0] 13[0]","GPIO 31[0] 13[0]","GPIO 30[0] 13[1]","GPIO 31[1] 13[0]","GPIO 31[1] 13[1]", };
 ...
 */
int m17_pm_ioctl_avs (unsigned int cmd, unsigned int arg)
{
	int ret = 0;
