ALSA ext external input Status
============
...
For checking alsa external input related driver's status, we require some items and format to
...
Key                  Example Values        Description                                               Remarks
==================== ===================== ========================================================= =======
HDMIConnected        1,0                   HDMI Cable is Connected or Not                            Get these data from HDMI module
AudioData            1,0                   Check HDMI data has audio data or not                     Get these data from HDMI module
Codec                UNKNOWN, PCM, AC3 ... What driver detected for audio codec base on HDMI Packet  Those values are based on alsa-ext-hdmi.h
SamplingRate         48                    Input source's sampling rate information.
N                    6144                  This value is for calculate sampling rate with CTS.
CTS                  25200                 Circle time stamp
==================== ===================== ========================================================= =======
