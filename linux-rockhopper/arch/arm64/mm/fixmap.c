...
#ifdef CONFIG_EKP
pte_t bm_pte[NR_BM_PTE_TABLES][PTRS_PER_PTE] __ekp_rodata;
pmd_t bm_pmd[PTRS_PER_PMD] __ekp_rodata __maybe_unused;
pud_t bm_pud[PTRS_PER_PUD] __ekp_rodata __maybe_unused;
#else /* !CONFIG_EKP */
