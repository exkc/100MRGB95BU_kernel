...
#ifndef _ATP_REG_O18A0_H_
#define _ATP_REG_O18A0_H_
...
} O18A0_A_TOP_STATUS_T;

typedef struct {
	O18A0_TTX_VER_CTRL0_T              	ttx_ver_ctrl0;                //0xc8006600L
	O18A0_TTX_VER_CTRL1_T              	ttx_ver_ctrl1;                //0xc8006604L
	O18A0_WSS_DATA_T                   	wss_data;                     //0xc8006608L
	O18A0_CGMS_DATA_T                  	cgms_data;                    //0xc800660cL
	O18A0_CVE_CONFIG_T                 	cve_config;                   //0xc8006610L
	O18A0_PHASE_INCR_T                 	phase_incr;                   //0xc8006614L
	O18A0_DENC_VBI_CTRL_T              	denc_vbi_ctrl;                //0xc8006618L
	O18A0_CC_DATA_T                    	cc_data;                      //0xc800661cL
	O18A0_MV_N0_3_T                    	mv_n0_3;                      //0xc8006620L
	O18A0_MV_N4_9_T                    	mv_n4_9;                      //0xc8006624L
	O18A0_MV_N10_11_T                  	mv_n10_11;                    //0xc8006628L
	O18A0_MV_N12_14_T                  	mv_n12_14;                    //0xc800662cL
	O18A0_MV_N15_20_T                  	mv_n15_20;                    //0xc8006630L
	O18A0_VPS_CTRL_T                   	vps_ctrl;                     //0xc8006634L
	O18A0_TTX_DATA_T                   	ttx_data;                     //0xc8006638L
	O18A0_TTX_LOAD_T                   	ttx_load;                     //0xc800663cL
	UINT32                             	reserved00[4];                //0xc8006640L~0xc800664cL
	O18A0_TTX_DDRU_T                   	ttx_ddru;                     //0xc8006650L
	UINT32                             	reserved01[11];               //0xc8006654L~0xc800667cL
	O18A0_ADDR_DBG_T                   	addr_dbg;                     //0xc8006680L
	O18A0_A_TOP_STATUS_T               	a_top_status;                 //0xc8006684L
} DE_ATP_REG_O18A0_T;
