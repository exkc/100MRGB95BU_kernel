#ifndef _PE_OSD_REG_M19A0_H_
#define _PE_OSD_REG_M19A0_H_
#ifndef UINT32
...
}PE_M19_SHP_OSD_PAT_GEN_CTRL_00_T;
/*-----------------------------------------------------------------------------
...
}PE_M19_SHP_OSD_HTI_WIN_CTRL_00_T;
/*-----------------------------------------------------------------------------
...
}PE_M19_SHP_OSD_HTI_WIN_CTRL_01_T;
/*-----------------------------------------------------------------------------
...
}PE_M19_SHP_OSD_HTI_WIN_CTRL_02_T;
/*-----------------------------------------------------------------------------
...
}PE_M19_SHP_OSD_HTI_WIN_CTRL_03_T;
/*-----------------------------------------------------------------------------
...
}PE_M19_SHP_OSD_HTI_WIN_CTRL_04_T;
/*-----------------------------------------------------------------------------
...
}PE_M19_SHP_OSD_DJ_WIN_CTRL_00_T;
/*-----------------------------------------------------------------------------
...
}PE_M19_SHP_OSD_DJ_WIN_CTRL_01_T;
/*-----------------------------------------------------------------------------
...
}PE_M19_SHP_OSD_DJ_WIN_CTRL_02_T;
/*-----------------------------------------------------------------------------
...
}PE_M19_SHP_OSD_DJ_WIN_CTRL_03_T;
/*-----------------------------------------------------------------------------
...
}PE_M19_SHP_OSD_DJ_WIN_CTRL_04_T;
/*-----------------------------------------------------------------------------
...
typedef struct
{
	UINT32
	reserved;	// 0:31
}PE_M19_SHP_OSD_FSW_CTRL_03_T;


typedef struct
{ 
	PE_M19_SHP_OSD_CORE_CTRL_00_T                         shp_core_ctrl_00;	//0x0000
	PE_M19_SHP_OSD_CORE_CTRL_01_T                         shp_core_ctrl_01;	//0x0004
	PE_M19_SHP_OSD_CORE_CTRL_02_T                         shp_core_ctrl_02;	//0x0008
	PE_M19_SHP_OSD_CORE_CTRL_03_T                         shp_core_ctrl_03;	//0x000C
	UINT32                                                reserved4[12];	//0x10-0x3c
	PE_M19_SHP_OSD_PAT_GEN_CTRL_00_T                      shp_pat_gen_ctrl_00;	//0x0040
	UINT32                                                reserved5[7];	//0x44-0x5c
	PE_M19_SHP_OSD_HTI_CTRL_00_T                          shp_hti_ctrl_00;	//0x0060
	PE_M19_SHP_OSD_HTI_CTRL_01_T                          shp_hti_ctrl_01;	//0x0064
	UINT32                                                reserved7[2];	//0x68-0x6c
	PE_M19_SHP_OSD_HTI_WIN_CTRL_00_T                      shp_hti_win_ctrl_00;	//0x0070
	PE_M19_SHP_OSD_HTI_WIN_CTRL_01_T                      shp_hti_win_ctrl_01;	//0x0074
	PE_M19_SHP_OSD_HTI_WIN_CTRL_02_T                      shp_hti_win_ctrl_02;	//0x0078
	PE_M19_SHP_OSD_HTI_WIN_CTRL_03_T                      shp_hti_win_ctrl_03;	//0x007C
	PE_M19_SHP_OSD_HTI_WIN_CTRL_04_T                      shp_hti_win_ctrl_04;	//0x0080
	UINT32                                                reserved12[3];	//0x84-0x8c
	PE_M19_SHP_OSD_VTI_CTRL_00_T                          shp_vti_ctrl_00;	//0x0090
	UINT32                                                reserved13[3];	//0x94-0x9c
	PE_M19_SHP_OSD_LTI_CTRL_00_T                          shp_lti_ctrl_00;	//0x00A0
	PE_M19_SHP_OSD_LTI_CTRL_01_T                          shp_lti_ctrl_01;	//0x00A4
	UINT32                                                reserved15[22];	//0xa8-0xfc
	PE_M19_SHP_OSD_DJ_CTRL_00_T                           shp_dj_ctrl_00;	//0x0100
	PE_M19_SHP_OSD_DJ_CTRL_01_T                           shp_dj_ctrl_01;	//0x0104
	PE_M19_SHP_OSD_DJ_CTRL_02_T                           shp_dj_ctrl_02;	//0x0108
	PE_M19_SHP_OSD_DJ_CTRL_03_T                           shp_dj_ctrl_03;	//0x010C
	UINT32                                                reserved19[4];	//0x110-0x11c
	PE_M19_SHP_OSD_DB_CTRL_00_T                           shp_db_ctrl_00;	//0x0120
	PE_M19_SHP_OSD_DB_CTRL_01_T                           shp_db_ctrl_01;	//0x0124
	UINT32                                                reserved21[6];	//0x128-0x13c
	PE_M19_SHP_OSD_DJ_WIN_CTRL_00_T                       shp_dj_win_ctrl_00;	//0x0140
	PE_M19_SHP_OSD_DJ_WIN_CTRL_01_T                       shp_dj_win_ctrl_01;	//0x0144
	PE_M19_SHP_OSD_DJ_WIN_CTRL_02_T                       shp_dj_win_ctrl_02;	//0x0148
	PE_M19_SHP_OSD_DJ_WIN_CTRL_03_T                       shp_dj_win_ctrl_03;	//0x014C
	PE_M19_SHP_OSD_DJ_WIN_CTRL_04_T                       shp_dj_win_ctrl_04;	//0x0150
	UINT32                                                reserved26[27];	//0x154-0x1bc
	PE_M19_SHP_OSD_CC_CTRL_00_T                           shp_cc_ctrl_00;	//0x01C0
	PE_M19_SHP_OSD_CC_CTRL_01_T                           shp_cc_ctrl_01;	//0x01C4
	UINT32                                                reserved28[14];	//0x1c8-0x1fc
	PE_M19_SHP_OSD_CORE_STAT_00_T                         shp_core_stat_00;	//0x0200
	PE_M19_SHP_OSD_CORE_STAT_01_T                         shp_core_stat_01;	//0x0204
	PE_M19_SHP_OSD_CORE_STAT_02_T                         shp_core_stat_02;	//0x0208
	PE_M19_SHP_OSD_CORE_STAT_03_T                         shp_core_stat_03;	//0x020C
	PE_M19_SHP_OSD_CORE_STAT_04_T                         shp_core_stat_04;	//0x0210
	PE_M19_SHP_OSD_CORE_STAT_05_T                         shp_core_stat_05;	//0x0214
	UINT32                                                reserved34[54];	//0x218-0x2ec
	PE_M19_SHP_OSD_FSW_CTRL_00_T                          shp_fsw_ctrl_00;	//0x02F0
	PE_M19_SHP_OSD_FSW_CTRL_01_T                          shp_fsw_ctrl_01;	//0x02F4
	PE_M19_SHP_OSD_FSW_CTRL_02_T                          shp_fsw_ctrl_02;	//0x02F8
	PE_M19_SHP_OSD_FSW_CTRL_03_T                          shp_fsw_ctrl_03;	//0x02FC
}PE_SHP_OSD_REG_M19_T;
#endif