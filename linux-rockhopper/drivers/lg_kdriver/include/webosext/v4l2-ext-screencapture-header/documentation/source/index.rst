LG V4L2 Screencapture Implementation Guide
=======================================
...
Module                      submitter
=========================== ==============================================
vt                          sungjoon.sim@lge.com, jjaem.kim@lge.com
=========================== ==============================================
...
======= ========== ========================== ================================== =======
1.2     2025-02-18 jjaem.kim@lge.com          Forked from the renderer header
...
* This is a guide document for implementing LG ALSA Broadcast driver.
...
.. warning::
  ...
  아래 1-7장 순서는 추가/제거/변경하지 않습니다. 각 장의 하위 내용은 변경 가능합니다.

  Chapter 1-7 must not be modified(add/remove/re-order).
...
.. toctree::
  ...
  V4L2 Screencapture Implementation Guide <screencapture>
  status-files
  api/index
  documentation
  release-notes
