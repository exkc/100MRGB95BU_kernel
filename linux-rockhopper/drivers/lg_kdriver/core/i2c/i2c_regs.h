...
#define I2C_CLOCK_FREQUENCY_M16		198000000	/* DDR Clock(792Mhz)/4 */
#define I2C_CLOCK_FREQUENCY_M16		198000000	/* DDR Clock(792Mhz)/4 */
#define I2C_CLOCK_FREQUENCY_M17		198000000	/* DDR Clock(792Mhz)/4 */
#define I2C_CLOCK_FREQUENCY_L18		200000000
#define I2C_CLOCK_FREQUENCY_O18		198000000
#define I2C_CLOCK_FREQUENCY_M19		198000000
#define I2C_CLOCK_FREQUENCY_O20		200000000
#define I2C_CLOCK_FREQUENCY_E60		200000000
#define I2C_CLOCK_FREQUENCY_O22		200000000
#define I2C_CLOCK_FREQUENCY_M23		200000000
#define I2C_CLOCK_FREQUENCY_O24		200000000
#define I2C_CLOCK_FREQUENCY_O26		200000000

#define I2C_REG_SIZE				0x30

#define I2CMMD(r) (void *)((uintptr_t)(r)+(uintptr_t)(0x000))
#define I2CMSSD(r) (void *)((uintptr_t)(r)+(uintptr_t)(0x004))
#define I2CMSSA(r) (void *)((uintptr_t)(r)+(uintptr_t)(0x008))
#define I2CMCTR0(r) (void *)((uintptr_t)(r)+(uintptr_t)(0x00c))
#define I2CMCTR1(r) (void *)((uintptr_t)(r)+(uintptr_t)(0x010))
#define I2CMMS(r) (void *)((uintptr_t)(r)+(uintptr_t)(0x014))
#define I2CMSSS(r) (void *)((uintptr_t)(r)+(uintptr_t)(0x018))
#define reserved(r) (void *)((uintptr_t)(r)+(uintptr_t)(0x01c))
#define I2CMPREH(r) (void *)((uintptr_t)(r)+(uintptr_t)(0x020))
#define I2CMPREL(r) (void *)((uintptr_t)(r)+(uintptr_t)(0x024))
