...
#ifndef	_GPIO_DRV_HAL_L18_A0_H_
#define	_GPIO_DRV_HAL_L18_A0_H_
...
extern UINT32 		gpio_intr_num_l18[GPIO_IRQ_NUM_NR];
extern void _GPIO_ISR_GPIO_L18( unsigned int ui32IRQNum, unsigned int IntData );
