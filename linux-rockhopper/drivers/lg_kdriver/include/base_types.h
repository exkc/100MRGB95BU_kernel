...
#define LX_CHIP_H15                     0x17    /* H15= LG1210 */
#define LX_CHIP_M16                     0x18    /* M16= LG1312 */
#define LX_CHIP_M17                     0x19    /* M17= LG1313 */
#define LX_CHIP_L18                     0x20    /* L18= LG1411 */
#define LX_CHIP_O18                     0x22    /* O18= LG1211 */
#define LX_CHIP_M19                     0x23    /* M19= LG1314 */
#define LX_CHIP_O20                     0x24    /* O20= LG1212 */
#define LX_CHIP_E60                     0x25    /* E60= LG1811 */
#define LX_CHIP_O22                     0x26    /* O22= LG1213 */
#define LX_CHIP_M23                     0x27    /* O22= LG1315 */
#define LX_CHIP_O24                     0x28    /* O24= LG1214 */
#define LX_CHIP_O26                     0x29    /* O26= LG1215 */
#define LX_CHIP_UNKNOWN                 0xff

#define LX_CHIP_L18F                    LX_CHIP_L18     /* L18F = L18 (obsolete) */
#define LX_CHIP_M16P                    LX_CHIP_M17     /* M16P = M17 (obsolete) */
...
/*----------------------------------------------------------------------------------------
 ...
 SoC SW/HW has many differences between FHD and UHD model.
 FHD/UHD information is very important information to implement BSP with runtime branch
 Use lx_chip_plt() to get FHD/UHD info and write your driver to support both model.

 And there are more extra information to help driver implementation.
 For example, DDR size, external FRC existance, display type, interface type with panel etc.
 Actually these information is not related to SoC feature, but device drivers can control
 HW functionalities well by referring these information.
 lx_board_opt() returns all identified board option list with BIT-ORed manner.
 Remember that board option is optional data.
 So if the current chip driver returns 0x0, it means that current chip driver doesn't need any board information.
 Ironically, try not to use the board option to make well made device driver.
----------------------------------------------------------------------------------------*/
#define LX_CHIP_PLT_FHD         0x00001000  /* FHD platform = 1920x1080@60Hz / 1920x1080@120Hz */
#define LX_CHIP_PLT_UHD         0x00002000  /* UHD platform = 2560x1080 / 3840x2160 / 5120x2160 */
#define LX_CHIP_PLT_QUHD        0x00004000  /* 8K  platform = 7680x4320 */
#define LX_CHIP_PLT_HD          0x00008000  /* HD  platform = 1366x768 */
#define LX_CHIP_PLT_2K          LX_CHIP_PLT_FHD
#define LX_CHIP_PLT_4K          LX_CHIP_PLT_UHD
#define LX_CHIP_PLT_8K          LX_CHIP_PLT_QUHD

#define LX_BOARD_OPT_EXT_FRC    0x00000001  /* external FRC chip (default) */
#define LX_BOARD_OPT_INT_FRC    0x00000002  /* internal FRC chip or no FRC */
#define LX_BOARD_OPT_NO_FRC     LX_BOARD_OPT_INT_FRC
#define LX_BOARD_OPT_NO_EXT_FRC LX_BOARD_OPT_INT_FRC

#define LX_BOARD_OPT_LCD        0x00000004  /* LCD/LED panel (default) */
#define LX_BOARD_OPT_OLED       0x00000008  /* OLED panel, otherwise LCD/LED or others */

/* 4 reserved */

#define LX_BOARD_OPT_4K_GRAPHIC 0x00000100  /* 4K graphic */
#define LX_BOARD_OPT_2K_GRAPHIC 0x00000200  /* 2K graphic (default) */
#define LX_BOARD_OPT_HD_GRAPHIC 0x00000400  /* HD graphic */

/* 1 reserved */

#define LX_BOARD_OPT_DDR_1_0GB  0x00001000  /* 1.0GB . do not use runtime branch based on DDR size */
#define LX_BOARD_OPT_DDR_1_5GB  0x00002000  /* 1.5GB . do not use runtime branch based on DDR size  */
#define LX_BOARD_OPT_DDR_2_0GB  0x00004000
#define LX_BOARD_OPT_DDR_2_5GB  0x00008000
#define LX_BOARD_OPT_DDR_3_0GB  0x00010000
#define LX_BOARD_OPT_DDR_3_5GB  0x00020000
#define LX_BOARD_OPT_DDR_MAX    0x00040000  /* max   . do not use runtime branch based on DDR size */
#define LX_BOARD_OPT_DDR_4_0GB  LX_BOARD_OPT_DDR_MAX
#define LX_BOARD_OPT_DDR_5_0GB  LX_BOARD_OPT_DDR_MAX
#define LX_BOARD_OPT_DDR_6_0GB  LX_BOARD_OPT_DDR_MAX
#define LX_BOARD_OPT_DDR_8_0GB  LX_BOARD_OPT_DDR_MAX

#define LX_BOARD_OPT_ADV        0x00080000  /* advanced featured model (default), obsoleted) */

#define LX_BOARD_OPT_DISP_60HZ  0x00100000  /* 60HZ  Display /w NO_FRC */
#define LX_BOARD_OPT_DISP_120HZ 0x00200000  /* 120Hz Display /w FRC (default) */

/* 2 reserved */

#define LX_BOARD_OPT_FPGA       0x00400000  /* FPGA board */
#define LX_BOARD_OPT_SYSTEM     0x00800000  /* SYSTEM board (default) */
#define LX_BOARD_OPT_SLT        0x01000000  /* SLT board */
#define LX_BOARD_OPT_SLT_MAP    0x02000000  /* SLT memory map */

/* 6 reserved */

#define LX_BOARD_OPT_USR0       0x40000000  /* user defined BOARD_OPT (temp test only) */
#define LX_BOARD_OPT_USR1       0x80000000  /* user defined BOARD_OPT (temp test only) */

// DO NOT refer the below optoin
#define LX_BOARD_OPT_STBBOX     0x00000000  /* no panel (obsoleted) */
#define LX_BOARD_OPT_STD        0x00000000  /* stanard  featured model (obsoleted) */
#define LX_BOARD_OPT_USR2       0x00000000  /* user defined BOARD_OPT (test only) */
#define LX_BOARD_OPT_USR3       0x00000000  /* user defined BOARD_OPT (test only) */
#define LX_BOARD_OPT_EPI        0x00000000  /* EPI interface, otherwise Vx1 or others */
...
#define LX_CALC_ALIGNED_VALUE(val,order)    ALIGN(val, (1<<order))
...
typedef struct
{
    ...
    UINT32      value __aligned(8); ///< register value
}
LX_REGISTER_T;
...
static inline LX_RECT_T LX_MAKE_RECT(SINT16 x, SINT16 y, UINT16 w, UINT16 h)
{
...
typedef struct
{
    union __aligned(8)
    {
        void*   addr;               ///< address of buffer ( physical or logical )
        UINT32  compat_addr;
        UINT64  sizer;
    };
...
typedef struct
{
    UINT32      phys_addr __aligned(8);///< physical address
    union __aligned(8)
    {
        void*   virt_addr;          ///< virtual address
        UINT32  compat_virt_addr;
        UINT64  sizer;
    };
    UINT32      length __aligned(8);    ///< length of buffer
}
...
typedef struct
{
    LX_MEM_BUF_T    mem_buf __aligned(8);       ///< memory buffer
    UINT32          curr_offset __aligned(8);   ///< current offset from mem_buf.addr
}
LX_MEM_STREAM_T;

/**
    @def USER_PTR
    If you have structure parameter passed to IOCTL and that structure has pointer value,
...
/*----------------------------------------------------------------------------------------
    Type Definitions (MemCfg)
----------------------------------------------------------------------------------------*/
#ifdef  __KERNEL__  /* kernel Space Only */
/**
...
#define LX_MEMCFG_FLAG_NONE     0x00000000
#define LX_MEMCFG_FLAG_ALIAS    0xFABC0000
/**
