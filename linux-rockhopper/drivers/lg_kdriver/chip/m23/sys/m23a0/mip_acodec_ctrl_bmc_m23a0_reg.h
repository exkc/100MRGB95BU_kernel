#ifndef _MIP_ACODEC_CTRL_BMC_M23A0_REG_H_
#define _MIP_ACODEC_CTRL_BMC_M23A0_REG_H_
...
}MIP_ACODEC_CTRL_BMC_MIP_ACODEC00_M23A0_T;
...
typedef struct {
    ...
    reg_aud_res               :  3;    //  31:29
}MIP_ACODEC_CTRL_BMC_MIP_ACODEC01_M23A0_T;
...
typedef struct {
    ...
    reg_reserve_in2           :  5,    //  24:20
                              :  7;    //  31:25 reserved
}MIP_ACODEC_CTRL_BMC_MIP_ACODEC02_M23A0_T;
...
typedef struct {
    ...
    reg_auad_pga_pdb          :  1,    //     24
                              :  7;    //  31:25 reserved
}MIP_ACODEC_CTRL_BMC_MIP_ACODEC03_M23A0_T;
...
typedef struct {
    ...
    reg_auad_ic_refp          :  2,    //  27:26
                              :  4;    //  31:28 reserved
}MIP_ACODEC_CTRL_BMC_MIP_ACODEC04_M23A0_T;
...
}MIP_ACODEC_CTRL_BMC_MIP_ACODEC05_M23A0_T;

/*-----------------------------------------------------------------------------------------
    mip_acodec_ctrl_bmc Register LIst
-----------------------------------------------------------------------------------------*/
typedef struct {
    MIP_ACODEC_CTRL_BMC_MIP_ACODEC00_M23A0_T    mip_acodec00;    // 0xC615_4000
    MIP_ACODEC_CTRL_BMC_MIP_ACODEC01_M23A0_T    mip_acodec01;    // 0xC615_4004
    MIP_ACODEC_CTRL_BMC_MIP_ACODEC02_M23A0_T    mip_acodec02;    // 0xC615_4008
    MIP_ACODEC_CTRL_BMC_MIP_ACODEC03_M23A0_T    mip_acodec03;    // 0xC615_400C
    MIP_ACODEC_CTRL_BMC_MIP_ACODEC04_M23A0_T    mip_acodec04;    // 0xC615_4010
    MIP_ACODEC_CTRL_BMC_MIP_ACODEC05_M23A0_T    mip_acodec05;    // 0xC615_4014
}MIP_ACODEC_CTRL_BMC_REG_M23A0_T;
/* 6 regs */
...
#define MIP_ACODEC_CTRL_BMC_MIP_ACODEC00_M23A0_T_OFF        (BASEADDRESS+0x0000)
#define MIP_ACODEC_CTRL_BMC_MIP_ACODEC01_M23A0_T_OFF        (BASEADDRESS+0x0004)
#define MIP_ACODEC_CTRL_BMC_MIP_ACODEC02_M23A0_T_OFF        (BASEADDRESS+0x0008)
#define MIP_ACODEC_CTRL_BMC_MIP_ACODEC03_M23A0_T_OFF        (BASEADDRESS+0x000C)
#define MIP_ACODEC_CTRL_BMC_MIP_ACODEC04_M23A0_T_OFF        (BASEADDRESS+0x0010)
#define MIP_ACODEC_CTRL_BMC_MIP_ACODEC05_M23A0_T_OFF        (BASEADDRESS+0x0014)
