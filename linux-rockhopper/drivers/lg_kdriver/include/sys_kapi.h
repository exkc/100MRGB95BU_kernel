...
#define SYS_IOW_WRITE_REG			_IOW(SYS_IOC_MAGIC, 6, LX_SYS_MEM_T )
#define SYS_IORW_READ_REG			_IOWR(SYS_IOC_MAGIC,7, LX_SYS_MEM_T )
#define SYS_IOW_WRITE_REG_ARRAY		_IOW(SYS_IOC_MAGIC, 8, LX_SYS_MEM_ARRAY_T )
#define SYS_IORW_READ_REG_ARRAY		_IOWR(SYS_IOC_MAGIC,9, LX_SYS_MEM_ARRAY_T )

#define SYS_IOW_SPREAD_SPRECTRUM	_IOW(SYS_IOC_MAGIC, 10, LX_SPREAD_SPECTRUM_T )

#define SYS_IORW_DIAGNOSIS			_IOWR(SYS_IOC_MAGIC,11, LX_DIAG_PARAM_T )
...
#if 1
	UINT64	data;		// support 64bit pointer type
#else
	union
	{
		void	*data;
