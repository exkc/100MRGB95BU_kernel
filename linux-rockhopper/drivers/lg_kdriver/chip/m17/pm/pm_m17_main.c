 ...
 */
int m17_pm_ioctl_main (unsigned int cmd, unsigned long arg)
{
...
static int m17_pm_ioctl (unsigned int cmd, unsigned long arg)
{
...
#if LINUX_VERSION_CODE >= KERNEL_VERSION(5,4,0)
	timer_setup(&m17_pm_timer, m17_pm_timer.function, 0);
#endif
...
#if LINUX_VERSION_CODE >= KERNEL_VERSION(5,4,0)
	timer_setup( &m17_avscheck_timer,m17_avscheck_timer.function, 0);
#endif
