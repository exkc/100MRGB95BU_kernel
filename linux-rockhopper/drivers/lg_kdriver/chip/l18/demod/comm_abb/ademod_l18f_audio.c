...
**
**  Description:    ABB L18F Audio Processing block.
**
**  Functions
**  Implemented:    LX_ADEMOD_Result DEMOD_L18F_Analog_AudioProc_Factory_Set
**                  LX_ADEMOD_Result DEMOD_L18F_Analog_AudioProc_InputFreq_Set
**                  LX_ADEMOD_Result DEMOD_L18F_Analog_AudioProc_InputFreq_Get
**                  LX_ADEMOD_Result DEMOD_L18F_Analog_AudioProc_Standard_Set
**                  LX_ADEMOD_Result DEMOD_L18F_Analog_AudioProc_Standard_Get
**                  LX_ADEMOD_Result DEMOD_L18F_Analog_AudioProc_Flags_Set
**                  LX_ADEMOD_Result DEMOD_L18F_Analog_AudioProc_Flags_Get
**                  LX_ADEMOD_Result DEMOD_L18F_Analog_AudioProc_Gain_Set
**                  LX_ADEMOD_Result DEMOD_L18F_Analog_AudioProc_Gain_Get
**                  LX_ADEMOD_Result DEMOD_L18F_Analog_AudioProc_RC_Gain_Set
**                  LX_ADEMOD_Result DEMOD_L18F_Analog_AudioProc_RC_Gain_Get
**                  LX_ADEMOD_Result DEMOD_L18F_Analog_AudioProc_Offset_Set
**                  LX_ADEMOD_Result DEMOD_L18F_Analog_AudioProc_Offset_Get
**                  LX_ADEMOD_Result DEMOD_L18F_Analog_AudioProc_RC_Offset_Set
**                  LX_ADEMOD_Result DEMOD_L18F_Analog_AudioProc_RC_Offset_Get
**
**  References:
**
**  Exports:        LX_ADEMOD_Result DEMOD_L18F_Analog_AudioProc_Factory_Set
**                  LX_ADEMOD_Result DEMOD_L18F_Analog_AudioProc_InputFreq_Set
**                  LX_ADEMOD_Result DEMOD_L18F_Analog_AudioProc_InputFreq_Get
**                  LX_ADEMOD_Result DEMOD_L18F_Analog_AudioProc_Standard_Set
**                  LX_ADEMOD_Result DEMOD_L18F_Analog_AudioProc_Standard_Get
...
static LX_ADEMOD_Result DEMOD_L18F_Analog_AudioProc_Reset(pLX_ADEMOD_AudioProc pContext, BOOL on_off, Handle_t hUser);

static LX_ADEMOD_Result DEMOD_L18F_Analog_AudioProc_ToneGen_Set(pLX_ADEMOD_AudioProc pContext, BOOL tone1_en, BOOL tone2_en, Handle_t hUser);

static LX_ADEMOD_Result DEMOD_L18F_Analog_AudioProc_DAC_Start(pLX_ADEMOD_AudioProc pContext, Handle_t hUser);
...
/******************************************************************************
**
**  Name: DEMOD_L18F_Analog_AudioProc_Factory_Set
**
...
**
******************************************************************************/
LX_ADEMOD_Result DEMOD_L18F_Analog_AudioProc_Factory_Set(pLX_ADEMOD_AudioProc pContext)
{
...
/******************************************************************************
**
**  Name: DEMOD_L18F_Analog_AudioProc_InputFreq_Set
**
...
**
******************************************************************************/
LX_ADEMOD_Result DEMOD_L18F_Analog_AudioProc_InputFreq_Set(pLX_ADEMOD_AudioProc pContext, UINT32 *pValue, Handle_t hUser)
{
    LX_ADEMOD_Result status = retOK; /*  Status to be returned.  */
...
/******************************************************************************
**
**  Name: DEMOD_L18F_Analog_AudioProc_InputFreq_Get
**
...
**
******************************************************************************/
LX_ADEMOD_Result DEMOD_L18F_Analog_AudioProc_InputFreq_Get(pLX_ADEMOD_AudioProc pContext, UINT32 *pValue, Handle_t hUser)
{
    LX_ADEMOD_Result status = retOK; /*  Status to be returned.  */
...
/******************************************************************************
**
**  Name: DEMOD_L18F_Analog_AudioProc_Mode_Set
**
...
**
******************************************************************************/
LX_ADEMOD_Result DEMOD_L18F_Analog_AudioProc_Mode_Set(pLX_ADEMOD_AudioProc pContext, UINT32 *pValue, Handle_t hUser, BOOL Update)
{
    LX_ADEMOD_Result status = retOK; /*  Status to be returned.  */
...
/******************************************************************************
**
**  Name: DEMOD_L18F_Analog_AudioProc_Mode_Get
**
...
**
******************************************************************************/
LX_ADEMOD_Result DEMOD_L18F_Analog_AudioProc_Mode_Get(pLX_ADEMOD_AudioProc pContext, UINT32 *pValue, Handle_t hUser)
{
    LX_ADEMOD_Result status = retOK; /*  Status to be returned.  */
...
/******************************************************************************
**
**  Name: DEMOD_L18F_Analog_AudioProc_Standard_Set
**
...
******************************************************************************/
LX_ADEMOD_Result DEMOD_L18F_Analog_AudioProc_Standard_Set(pLX_ADEMOD_AudioProc pContext, UINT32 VideoStandard, UINT32 AudioStandard)
{
    LX_ADEMOD_Result status = retOK; /*  Status to be returned.  */
...
/******************************************************************************
**
**  Name: DEMOD_L18F_Analog_AudioProc_Standard_Get
**
...
**
******************************************************************************/
LX_ADEMOD_Result DEMOD_L18F_Analog_AudioProc_Standard_Get(pLX_ADEMOD_AudioProc pContext, UINT32* pAudioStandard)
{
    LX_ADEMOD_Result status = retOK; /*  Status to be returned.  */
...
/******************************************************************************
**
**  Name: DEMOD_L18F_Analog_AudioProc_Flags_Set
**
...
**
******************************************************************************/
LX_ADEMOD_Result DEMOD_L18F_Analog_AudioProc_Flags_Set(pLX_ADEMOD_AudioProc pContext, UINT32 Flags)
{
    LX_ADEMOD_Result status = retOK; /*  Status to be returned.  */
	UINT32 mask = 0;
...
/******************************************************************************
**
**  Name: DEMOD_L18F_Analog_AudioProc_Flags_Get
**
...
**
******************************************************************************/
LX_ADEMOD_Result DEMOD_L18F_Analog_AudioProc_Flags_Get(pLX_ADEMOD_AudioProc pContext, UINT32* pFlags)
{
    LX_ADEMOD_Result status = retOK; /*  Status to be returned.  */
...
/******************************************************************************
**
**  Name: DEMOD_L18F_Analog_AudioProc_SampleRateDivider_Set
**
...
**
******************************************************************************/
LX_ADEMOD_Result DEMOD_L18F_Analog_AudioProc_SampleRateDivider_Set(pLX_ADEMOD_AudioProc pContext, UINT32 Value)
{
    LX_ADEMOD_Result status = retOK; /*  Status to be returned.  */
...
/******************************************************************************
**
**  Name: DEMOD_L18F_Analog_AudioProc_SampleRateDivider_Get
**
...
**
******************************************************************************/
LX_ADEMOD_Result DEMOD_L18F_Analog_AudioProc_SampleRateDivider_Get(pLX_ADEMOD_AudioProc pContext, UINT32 *pValue, Handle_t hUser)
{
    LX_ADEMOD_Result status = retOK; /*  Status to be returned.  */
...
/******************************************************************************
**
**  Name: DEMOD_L18F_Analog_AudioProc_Options_Set
**
...
**
******************************************************************************/
LX_ADEMOD_Result DEMOD_L18F_Analog_AudioProc_Options_Set(pLX_ADEMOD_AudioProc pContext, UINT32 *pValue, Handle_t hUser, BOOL Update)
{
    LX_ADEMOD_Result status = retOK; /*  Status to be returned.  */
...
/******************************************************************************
**
**  Name: DEMOD_L18F_Analog_AudioProc_Options_Get
**
...
**
******************************************************************************/
LX_ADEMOD_Result DEMOD_L18F_Analog_AudioProc_Options_Get(pLX_ADEMOD_AudioProc pContext, UINT32 *pValue, Handle_t hUser)
{
    LX_ADEMOD_Result status = retOK; /*  Status to be returned.  */
...
/******************************************************************************
**
**  Name: DEMOD_L18F_Analog_AudioProc_Mute_Set
**
...
**
******************************************************************************/
LX_ADEMOD_Result DEMOD_L18F_Analog_AudioProc_Mute_Set(pLX_ADEMOD_AudioProc pContext, UINT32 *pValue, Handle_t hUser, BOOL Update)
{
    LX_ADEMOD_Result status = retOK; /*  Status to be returned.  */
...
/******************************************************************************
**
**  Name: DEMOD_L18F_Analog_AudioProc_Mute_Get
**
...
**
******************************************************************************/
LX_ADEMOD_Result DEMOD_L18F_Analog_AudioProc_Mute_Get(pLX_ADEMOD_AudioProc pContext, UINT32 *pValue, Handle_t hUser)
{
    LX_ADEMOD_Result status = retOK; /*  Status to be returned.  */
...
/******************************************************************************
**
**  Name: DEMOD_L18F_Analog_AudioProc_MuteSpeed_Set
**
**  Description:    Sets audio mute.
**
**  Parameters:     pContext     - Pointer to the Audio Processor context,
...
**
******************************************************************************/
LX_ADEMOD_Result DEMOD_L18F_Analog_AudioProc_MuteSpeed_Set(pLX_ADEMOD_AudioProc pContext, UINT32 *pValue, Handle_t hUser, BOOL Update)
{
    LX_ADEMOD_Result status = retOK; /*  Status to be returned.  */
...
/******************************************************************************
**
**  Name: DEMOD_L18F_Analog_AudioProc_MuteSpeed_Get
**
...
**
******************************************************************************/
LX_ADEMOD_Result DEMOD_L18F_Analog_AudioProc_MuteSpeed_Get(pLX_ADEMOD_AudioProc pContext, UINT32 *pValue, Handle_t hUser)
{
    LX_ADEMOD_Result status = retOK; /*  Status to be returned.  */
...
/******************************************************************************
**
**  Name: DEMOD_L18F_Analog_AudioProc_Gain_Set
**
...
**
******************************************************************************/
LX_ADEMOD_Result DEMOD_L18F_Analog_AudioProc_Gain_Set(pLX_ADEMOD_AudioProc pContext, UINT32 *pValue, Handle_t hUser, BOOL Update)
{
    LX_ADEMOD_Result status = retOK; /*  Status to be returned.  */
...
/******************************************************************************
**
**  Name: DEMOD_L18F_Analog_AudioProc_Gain_Get
**
...
**
******************************************************************************/
LX_ADEMOD_Result DEMOD_L18F_Analog_AudioProc_Gain_Get(pLX_ADEMOD_AudioProc pContext, UINT32 *pValue, Handle_t hUser)
{
    LX_ADEMOD_Result status = retOK; /*  Status to be returned.  */
...
/******************************************************************************
**
**  Name: DEMOD_L18F_Analog_AudioProc_RC_Gain_Set
**
**  Description:    Sets audio gain thresholds.
**
**  Parameters:     pContext     - Pointer to the Audio Processor context,
...
**
******************************************************************************/
LX_ADEMOD_Result DEMOD_L18F_Analog_AudioProc_RC_Gain_Set(pLX_ADEMOD_AudioProc pContext, UINT32 *pValue, Handle_t hUser, BOOL Update)
{
    LX_ADEMOD_Result status = retOK; /*  Status to be returned.  */
...
/******************************************************************************
**
**  Name: DEMOD_L18F_Analog_AudioProc_RC_Gain_Get
**
**  Description:    Returns actual audio gain.
**
**  Parameters:     pContext     - Pointer to the Audio Processor context,
...
**
******************************************************************************/
LX_ADEMOD_Result DEMOD_L18F_Analog_AudioProc_RC_Gain_Get(pLX_ADEMOD_AudioProc pContext, UINT32 *pValue, Handle_t hUser)
{
    LX_ADEMOD_Result status = retOK; /*  Status to be returned.  */
...
/******************************************************************************
**
**  Name: DEMOD_L18F_Analog_AudioProc_Offset_Set
**
...
**
******************************************************************************/
LX_ADEMOD_Result DEMOD_L18F_Analog_AudioProc_Offset_Set(pLX_ADEMOD_AudioProc pContext, UINT32 *pValue, Handle_t hUser, BOOL Update)
{
    LX_ADEMOD_Result status = retOK; /*  Status to be returned.  */
...
/******************************************************************************
**
**  Name: DEMOD_L18F_Analog_AudioProc_Offset_Get
**
**  Description:    Returns actual audio gain.
**
**  Parameters:     pContext     - Pointer to the Audio Processor context,
...
**
******************************************************************************/
LX_ADEMOD_Result DEMOD_L18F_Analog_AudioProc_Offset_Get(pLX_ADEMOD_AudioProc pContext, UINT32 *pValue, Handle_t hUser)
{
    LX_ADEMOD_Result status = retOK; /*  Status to be returned.  */
...
/******************************************************************************
**
**  Name: DEMOD_L18F_Analog_AudioProc_RC_Offset_Set
**
...
**
******************************************************************************/
LX_ADEMOD_Result DEMOD_L18F_Analog_AudioProc_RC_Offset_Set(pLX_ADEMOD_AudioProc pContext, UINT32 *pValue, Handle_t hUser, BOOL Update)
{
    LX_ADEMOD_Result status = retOK; /*  Status to be returned.  */
...
/******************************************************************************
**
**  Name: DEMOD_L18F_Analog_AudioProc_RC_Offset_Get
**
...
**
******************************************************************************/
LX_ADEMOD_Result DEMOD_L18F_Analog_AudioProc_RC_Offset_Get(pLX_ADEMOD_AudioProc pContext, UINT32 *pValue, Handle_t hUser)
{
    LX_ADEMOD_Result status = retOK; /*  Status to be returned.  */
...
/******************************************************************************
**
**  Name: DEMOD_L18F_Analog_AudioProc_Clip_Set
**
...
**
******************************************************************************/
LX_ADEMOD_Result DEMOD_L18F_Analog_AudioProc_Clip_Set(pLX_ADEMOD_AudioProc pContext, UINT32 *pValue, Handle_t hUser, BOOL Update)
{
    LX_ADEMOD_Result status = retOK; /*  Status to be returned.  */
...
/******************************************************************************
**
**  Name: DEMOD_L18F_Analog_AudioProc_Clip_Get
**
...
**
******************************************************************************/
LX_ADEMOD_Result DEMOD_L18F_Analog_AudioProc_Clip_Get(pLX_ADEMOD_AudioProc pContext, UINT32 *pValue, Handle_t hUser)
{
    LX_ADEMOD_Result status = retOK; /*  Status to be returned.  */
...
/******************************************************************************
**
**  Name: DEMOD_L18F_Analog_AudioProc_RC_Clip_Set
**
**  Description:    Sets audio clipping thresholds.
**
**  Parameters:     pContext     - Pointer to the Audio Processor context,
...
**
******************************************************************************/
LX_ADEMOD_Result DEMOD_L18F_Analog_AudioProc_RC_Clip_Set(pLX_ADEMOD_AudioProc pContext, UINT32 *pValue, Handle_t hUser, BOOL Update)
{
    LX_ADEMOD_Result status = retOK; /*  Status to be returned.  */
...
/******************************************************************************
**
**  Name: DEMOD_L18F_Analog_AudioProc_RC_Clip_Get
**
**  Description:    Returns audio clipping thresholds.
**
**  Parameters:     pContext     - Pointer to the Audio Processor context,
...
**
******************************************************************************/
LX_ADEMOD_Result DEMOD_L18F_Analog_AudioProc_RC_Clip_Get(pLX_ADEMOD_AudioProc pContext, UINT32 *pValue, Handle_t hUser)
{
    LX_ADEMOD_Result status = retOK; /*  Status to be returned.  */
...
/******************************************************************************
**
**  Name: DEMOD_L18F_Analog_AudioProc_SifFreq_Set
**
...
**
******************************************************************************/
LX_ADEMOD_Result DEMOD_L18F_Analog_AudioProc_SifFreq_Set(pLX_ADEMOD_AudioProc pContext, UINT32 *pValue, Handle_t hUser, BOOL Update)
{
    LX_ADEMOD_Result status = retOK; /*  Status to be returned.  */
...
/******************************************************************************
**
**  Name: DEMOD_L18F_Analog_AudioProc_SifFreq_Get
**
...
**
******************************************************************************/
LX_ADEMOD_Result DEMOD_L18F_Analog_AudioProc_SifFreq_Get(pLX_ADEMOD_AudioProc pContext, UINT32 *pValue, Handle_t hUser)
{
    LX_ADEMOD_Result status = retOK; /*  Status to be returned.  */
...
/******************************************************************************
**
**  Name: DEMOD_L18F_Analog_AudioProc_MonoFreq_Set
**
...
**
******************************************************************************/
LX_ADEMOD_Result DEMOD_L18F_Analog_AudioProc_MonoFreq_Set(pLX_ADEMOD_AudioProc pContext, UINT32 *pValue, Handle_t hUser, BOOL Update)
{
    LX_ADEMOD_Result status = retOK; /*  Status to be returned.  */
...
/******************************************************************************
**
**  Name: DEMOD_L18F_Analog_AudioProc_MonoFreq_Get
**
...
**
******************************************************************************/
LX_ADEMOD_Result DEMOD_L18F_Analog_AudioProc_MonoFreq_Get(pLX_ADEMOD_AudioProc pContext, UINT32 *pValue, Handle_t hUser)
{
    LX_ADEMOD_Result status = retOK; /*  Status to be returned.  */
...
/******************************************************************************
**
**  Name: DEMOD_L18F_Analog_AudioProc_MonoGain_Set
**
...
**
******************************************************************************/
LX_ADEMOD_Result DEMOD_L18F_Analog_AudioProc_MonoGain_Set(pLX_ADEMOD_AudioProc pContext, UINT32 *pValue, Handle_t hUser, BOOL Update)
{
    LX_ADEMOD_Result status = retOK; /*  Status to be returned.  */
...
/******************************************************************************
**
**  Name: DEMOD_L18F_Analog_AudioProc_MonoGain_Get
**
...
**
******************************************************************************/
LX_ADEMOD_Result DEMOD_L18F_Analog_AudioProc_MonoGain_Get(pLX_ADEMOD_AudioProc pContext, UINT32 *pValue, Handle_t hUser)
{
    LX_ADEMOD_Result status = retOK; /*  Status to be returned.  */
...
/******************************************************************************
**
**  Name: DEMOD_L18F_Analog_AudioProc_Deviation_Set
**
...
**
******************************************************************************/
LX_ADEMOD_Result DEMOD_L18F_Analog_AudioProc_Deviation_Set(pLX_ADEMOD_AudioProc pContext, UINT32 *pValue, Handle_t hUser, BOOL Update)
{
    LX_ADEMOD_Result status = retOK; /*  Status to be returned.  */
...
/******************************************************************************
**
**  Name: DEMOD_L18F_Analog_AudioProc_Deviation_Get
**
...
**
******************************************************************************/
LX_ADEMOD_Result DEMOD_L18F_Analog_AudioProc_Deviation_Get(pLX_ADEMOD_AudioProc pContext, UINT32 *pValue, Handle_t hUser)
{
    LX_ADEMOD_Result status = retOK; /*  Status to be returned.  */
...
/******************************************************************************
**
**  Name: DEMOD_L18F_Analog_AudioProc_BBSampleRate_Set
**
...
**
******************************************************************************/
LX_ADEMOD_Result DEMOD_L18F_Analog_AudioProc_BBSampleRate_Set(pLX_ADEMOD_AudioProc pContext, UINT32 *pValue, Handle_t hUser, BOOL Update)
{
    LX_ADEMOD_Result status = retOK; /*  Status to be returned.  */
...
/******************************************************************************
**
**  Name: DEMOD_L18F_Analog_AudioProc_BBSampleRate_Get
**
**  Description:    Sets mono BBSampleRate.
**
**  Parameters:     pContext     - Pointer to the Audio Processor context,
...
**
******************************************************************************/
LX_ADEMOD_Result DEMOD_L18F_Analog_AudioProc_BBSampleRate_Get(pLX_ADEMOD_AudioProc pContext, UINT32 *pValue, Handle_t hUser)
{
    LX_ADEMOD_Result status = retOK; /*  Status to be returned.  */
...
/******************************************************************************
**
**  Name: DEMOD_L18F_Analog_AudioProc_Deemphasis_Set
**
...
**
******************************************************************************/
LX_ADEMOD_Result DEMOD_L18F_Analog_AudioProc_Deemphasis_Set(pLX_ADEMOD_AudioProc pContext, UINT32 *pValue, Handle_t hUser, BOOL Update)
{
    LX_ADEMOD_Result status = retOK; /*  Status to be returned.  */
...
/******************************************************************************
**
**  Name: DEMOD_L18F_Analog_AudioProc_Deemphasis_Get
**
...
**
******************************************************************************/
LX_ADEMOD_Result DEMOD_L18F_Analog_AudioProc_Deemphasis_Get(pLX_ADEMOD_AudioProc pContext, UINT32 *pValue, Handle_t hUser)
{
    LX_ADEMOD_Result status = retOK; /*  Status to be returned.  */
...
/******************************************************************************
**
**  Name: DEMOD_L18F_Analog_AudioProc_BasebandExtraGain_Set
**
...
**
******************************************************************************/
LX_ADEMOD_Result DEMOD_L18F_Analog_AudioProc_BasebandExtraGain_Set(pLX_ADEMOD_AudioProc pContext, UINT32 *pValue, Handle_t hUser, BOOL Update)
{
    LX_ADEMOD_Result status = retOK; /*  Status to be returned.  */
...
/******************************************************************************
**
**  Name: DEMOD_L18F_Analog_AudioProc_BasebandExtraGain_Get
**
...
**
******************************************************************************/
LX_ADEMOD_Result DEMOD_L18F_Analog_AudioProc_BasebandExtraGain_Get(pLX_ADEMOD_AudioProc pContext, UINT32 *pValue, Handle_t hUser)
{
    LX_ADEMOD_Result status = retOK; /*  Status to be returned.  */
...
/******************************************************************************
**
**  Name: DEMOD_L18F_Analog_AudioProc_AGCTarget_Set
**
...
**
******************************************************************************/
LX_ADEMOD_Result DEMOD_L18F_Analog_AudioProc_AGCTarget_Set(pLX_ADEMOD_AudioProc pContext, UINT32 *pValue, Handle_t hUser, BOOL Update)
{
    LX_ADEMOD_Result status = retOK; /*  Status to be returned.  */
...
/******************************************************************************
**
**  Name: DEMOD_L18F_Analog_AudioProc_AGCTarget_Get
**
...
**
******************************************************************************/
LX_ADEMOD_Result DEMOD_L18F_Analog_AudioProc_AGCTarget_Get(pLX_ADEMOD_AudioProc pContext, UINT32 *pValue, Handle_t hUser)
{
    LX_ADEMOD_Result status = retOK; /*  Status to be returned.  */
...
/******************************************************************************
**
**  Name: DEMOD_L18F_Analog_AudioProc_AGCGainThresh_Set
**
...
**
******************************************************************************/
LX_ADEMOD_Result DEMOD_L18F_Analog_AudioProc_AGCGainThresh_Set(pLX_ADEMOD_AudioProc pContext, UINT32 *pValue, Handle_t hUser, BOOL Update)
{
    LX_ADEMOD_Result status = retOK; /*  Status to be returned.  */
...
/******************************************************************************
**
**  Name: DEMOD_L18F_Analog_AudioProc_AGCGainThresh_Get
**
...
**
******************************************************************************/
LX_ADEMOD_Result DEMOD_L18F_Analog_AudioProc_AGCGainThresh_Get(pLX_ADEMOD_AudioProc pContext, UINT32 *pValue, Handle_t hUser)
{
    LX_ADEMOD_Result status = retOK; /*  Status to be returned.  */
...
/******************************************************************************
**
**  Name: DEMOD_L18F_Analog_AudioProc_AGCGainPreset_Set
**
...
**
******************************************************************************/
LX_ADEMOD_Result DEMOD_L18F_Analog_AudioProc_AGCGainPreset_Set(pLX_ADEMOD_AudioProc pContext, UINT32 *pValue, Handle_t hUser, BOOL Update)
{
    LX_ADEMOD_Result status = retOK; /*  Status to be returned.  */
...
/******************************************************************************
**
**  Name: DEMOD_L18F_Analog_AudioProc_AGCGainPreset_Get
**
...
**
******************************************************************************/
LX_ADEMOD_Result DEMOD_L18F_Analog_AudioProc_AGCGainPreset_Get(pLX_ADEMOD_AudioProc pContext, UINT32 *pValue, Handle_t hUser)
{
    LX_ADEMOD_Result status = retOK; /*  Status to be returned.  */
...
/******************************************************************************
**
**  Name: DEMOD_L18F_Analog_AudioProc_SifBw_Set
**
...
**
******************************************************************************/
LX_ADEMOD_Result DEMOD_L18F_Analog_AudioProc_SifBw_Set(pLX_ADEMOD_AudioProc pContext, UINT32 *pValue, Handle_t hUser, BOOL Update)
{
    LX_ADEMOD_Result status = retOK; /*  Status to be returned.  */
...
/******************************************************************************
**
**  Name: DEMOD_L18F_Analog_AudioProc_SifBw_Get
**
...
**
******************************************************************************/
LX_ADEMOD_Result DEMOD_L18F_Analog_AudioProc_SifBw_Get(pLX_ADEMOD_AudioProc pContext, UINT32 *pValue, Handle_t hUser)
{
    LX_ADEMOD_Result status = retOK; /*  Status to be returned.  */
...
/******************************************************************************
**
**  Name: DEMOD_L18F_Analog_AudioProc_Mix_Set
**
...
**
******************************************************************************/
LX_ADEMOD_Result DEMOD_L18F_Analog_AudioProc_Mix_Set(pLX_ADEMOD_AudioProc pContext, UINT32 *pValue, Handle_t hUser, BOOL Update)
{
    LX_ADEMOD_Result status = retOK; /*  Status to be returned.  */
...
/******************************************************************************
**
**  Name: DEMOD_L18F_Analog_AudioProc_Mix_Get
**
...
**
******************************************************************************/
LX_ADEMOD_Result DEMOD_L18F_Analog_AudioProc_Mix_Get(pLX_ADEMOD_AudioProc pContext, UINT32 *pValue, Handle_t hUser)
{
    LX_ADEMOD_Result status = retOK; /*  Status to be returned.  */
...
/******************************************************************************
**
**  Name: DEMOD_L18F_Analog_AudioProc_BuzzDelay_Set
**
...
**
******************************************************************************/
LX_ADEMOD_Result DEMOD_L18F_Analog_AudioProc_BuzzDelay_Set(pLX_ADEMOD_AudioProc pContext, UINT32 *pValue, Handle_t hUser, BOOL Update)
{
    LX_ADEMOD_Result status = retOK; /*  Status to be returned.  */
...
/******************************************************************************
**
**  Name: DEMOD_L18F_Analog_AudioProc_BuzzDelay_Get
**
...
**
******************************************************************************/
LX_ADEMOD_Result DEMOD_L18F_Analog_AudioProc_BuzzDelay_Get(pLX_ADEMOD_AudioProc pContext, UINT32 *pValue, Handle_t hUser)
{
    LX_ADEMOD_Result status = retOK; /*  Status to be returned.  */
...
/******************************************************************************
**
**  Name: DEMOD_L18F_Analog_AudioProc_Init
**
...
**
******************************************************************************/
LX_ADEMOD_Result DEMOD_L18F_Analog_AudioProc_Init(pLX_ADEMOD_AudioProc pContext, Handle_t hUser)
{
    LX_ADEMOD_Result status = retOK; /*  Status to be returned.  */
	...
	status = DEMOD_L18F_Analog_AudioProc_Reset(pContext, TRUE, hUser);
	...
	status = DEMOD_L18F_Analog_AudioProc_Reset(pContext, FALSE, hUser);
...
/******************************************************************************
**
**  Name: DEMOD_L18F_Analog_AudioProc_Start
**
...
**                  variables.
******************************************************************************/
LX_ADEMOD_Result DEMOD_L18F_Analog_AudioProc_Start(pLX_ADEMOD_AudioProc pContext, UINT32 *pVideo_freq, UINT32 flags, Handle_t hUser)
{
    LX_ADEMOD_Result status = retOK; /*  Status to be returned.  */
	UINT64 PC_IFFreq =0;
...
//		MuteVolumeOffTime = ( ( pContext->MuteOffSpeed * pContext->AdcDacFreq ) * (UINT64)(1 << 17) * 10 / 1000 / pContext->Fs_div /4 / pContext->FinalUp_TincInv / 64 + 5 ) / 10 ;
	...
	// Update Audio Registers
	//status = DEMOD_L18F_Analog_AudioProc_Reset(pContext, TRUE, hUser); // Bug #1382
	...
	//
	status = DEMOD_L18F_Analog_AudioProc_ToneGen_Set(pContext, TRUE, TRUE, hUser);

	//  Audio DAC
	status = DEMOD_L18F_Analog_AudioProc_DAC_Start(pContext, hUser);

	//
	// make sure Audio is powered up and out of reset
	//
	//status = DEMOD_L18F_Analog_AudioProc_Reset(pContext, FALSE, hUser); // Bug #1382
...
/******************************************************************************
**
**  Name: DEMOD_L18F_Analog_AudioProc_DAC_Start
**
...
/******************************************************************************
**
**  Name: DEMOD_L18F_Analog_AudioProc_Reset
**
...
/******************************************************************************
**
**  Name: DEMOD_L18F_Analog_AudioProc_ToneGen_Set
**
