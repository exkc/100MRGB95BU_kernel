...
#ifndef	_PM_M23_COMMON_H_
#define	_PM_M23_COMMON_H_
...
/* m23_gov_status.governor status  */
...
#define M23_DVFS_ENABLE
	//#define USE_KER_CPUFREQ
	/*defined: use kernel cpufreq ndefined: use kdrv cpuferq */


#define M23_CPU_FREQ_OD 1400
#define M23_CPU_FREQ_ND 1400
#define M23_CPU_FREQ_UD 1050
...
#define M23_SLT_HIGH_AVS_SET_DELAY 3 /* sec */
#define M23_SLT_LOW_AVS_SET_DELAY 1 /* sec */
#define M23_AVS_SET_DELAY 25 /* sec */

#define M23_GOV_START_DELAY 50

#define AVS_NOT_INITED 0

/* m23_load_dump related*/
...
#define M23_CPU_DFTFREQ	660 //Mhz
#define M23_CPU_NORMALFREQ	1400 //Mhz

#define M23_CORE_AVS_INVALID_MAX   6  /* invalid max */
...
#define M23_CPU_AVS_INVALID_MAX   5  /* invalid max */
...
#define M23_CPU_AVS_S_UV            981000
#define M23_CPU_AVS_N_UV            960000
#define M23_CPU_AVS_F_UV            941000
#define M23_CPU_AVS_FF_UV           920000

/* need to update jun.kong */
#define M23_CPU_AVS_FF_HTEMP_UV     920000

#define M23_CORE_AVS_S_UV           981000
#define M23_CORE_AVS_N_UV           960000
#define M23_CORE_AVS_F_UV           941000
#define M23_CORE_AVS_FF_UV          920000

/* need to update jun.kong */
#define M23_CORE_AVS_S_HTEMP_UV     981000
#define M23_CORE_AVS_N_HTEMP_UV     960000
#define M23_CORE_AVS_F_HTEMP_UV     941000
#define M23_CORE_AVS_FF_HTEMP_UV    920000

#define M23_AVS_STEP_DELAY          2000 /* ms */
#define M23_AVS_STEP_DELAY_SLT      500  /* ms */
...
typedef struct
{
	...
	void  		(*run)(pms_m23_work_t * m23work);
	void  		(*run_regul)(pms_m23_work_t  * m23work);
	void  		(*reset)(void);
...
typedef struct
{
	...
	int 			(*get_cpu_avs_type)(pms_m23_avsinto_t *);
	int 			(*get_core_avs_type)(pms_m23_avsinto_t *);
...
pms_m23_cg_t* get_m23_pm_cg(void);
...
int m23_set_clock_gating(unsigned int module, unsigned int sub, unsigned int state);
int m23_get_clock_gating(unsigned int module, unsigned int sub, unsigned int *state);
