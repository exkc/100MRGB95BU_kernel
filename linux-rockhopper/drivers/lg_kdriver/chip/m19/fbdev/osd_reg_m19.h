 ...
 *
 */
#ifndef __OSD_REG_M19_H__
#define __OSD_REG_M19_H__
...
/*-----------------------------------------------------------------------------
	GROUP OBJECT : OSDX_BLEND_OSD_MIXER
------------------------------------------------------------------------------*/
typedef struct
{
...
/*-----------------------------------------------------------------------------
	GROUP OBJECT : OSDX_CTRL_SCALER

	raxis.lim (2018/03/27) : OSD0 and OSD4 has the different struct !!
------------------------------------------------------------------------------*/
typedef struct {
	union
	{
		UINT32									//  OSD0 - graphic plane only
										: 2,	//  0: 1 reserved
		reg_osd_line_th_en              : 1,	//     2
		reg_osd_bilinear                : 1,	//     3
		reg_osd_odd_width_en            : 1,	//     4
...
typedef struct
{
	OSD0_CTRL_MAIN                  	osd_ctrl_main                  ;	// 0x0200 : ''
	OSD0_BASE_ADDR                  	osd_base_addr                  ;	// 0x0204 : ''
	OSD0_CTRL_SWAP                  	osd_ctrl_swap                  ;	// 0x0208 : ''
	OSD0_CTRL_PDEC                  	osd_ctrl_pdec                  ;	// 0x020c : ''
	OSDX_CTRL_SCALER                	osd_ctrl_scaler                ;	// 0x0210 : ''
	OSD0_INFO_SCALER                	osd_info_scaler                ;	// 0x0214 : ''
	OSD0_CTRL_PATH                  	osd_ctrl_path                  ;	// 0x0218 : ''
	OSD0_CTRL_CKEY_CTRL_0           	osd_ctrl_ckey_ctrl_0           ;	// 0x021c : ''
	OSD0_CTRL_HDR0                  	osd_ctrl_hdr0                  ;	// 0x0220 : ''
	OSD0_CTRL_HDR1                  	osd_ctrl_hdr1                  ;	// 0x0224 : ''
	OSD0_CTRL_HDR2                  	osd_ctrl_hdr2                  ;	// 0x0228 : ''
	OSD0_CTRL_HDR3                  	osd_ctrl_hdr3                  ;	// 0x022c : ''
	OSD0_CTRL_HDR4                  	osd_ctrl_hdr4                  ;	// 0x0230 : ''
	OSD0_CTRL_HDR5                  	osd_ctrl_hdr5                  ;	// 0x0234 : ''
	OSD0_CTRL_HDR6                  	osd_ctrl_hdr6                  ;	// 0x0238 : ''
	OSD0_CTRL_CKEY_CTRL_1           	osd_ctrl_ckey_ctrl_1           ;	// 0x023c : ''
	OSD0_CTRL_SYNC0                 	osd_ctrl_sync0                 ;	// 0x0240 : ''
	OSD0_CTRL_SYNC1                 	osd_ctrl_sync1                 ;	// 0x0244 : ''
	OSD0_CTRL_SYNC2                 	osd_ctrl_sync2                 ;	// 0x0248 : ''
	OSD0_CTRL_SYNC3                 	osd_ctrl_sync3                 ;	// 0x024c : ''
	OSD0_CTRL_SYNC4                 	osd_ctrl_sync4                 ;	// 0x0250 : ''
	OSD0_CTRL_SYNC5                 	osd_ctrl_sync5                 ;	// 0x0254 : ''

	OSD0_BITMAP_CTRL0               	osd_bitmap_ctrl0               ;	// 0x0258 : '' <-- OSD0 only, BLANK if CSR0
	OSD0_BITMAP_CTRL1               	osd_bitmap_ctrl1               ;	// 0x025c : '' <-- OSD0 only, BLANK if CSR0
	OSD0_VSP_BOSD_CTRL_0            	osd_vsp_bosd_ctrl_0            ;	// 0x0260 : '' <-- OSD0 only, BLANK if CSR0
	OSD0_VSP_BOSD_CTRL_1            	osd_vsp_bosd_ctrl_1            ;	// 0x0264 : '' <-- OSD0 only, BLANK if CSR0
	OSD0_VSP_SOSD_CTRL_0            	osd_vsp_sosd_ctrl_0            ;	// 0x0268 : '' <-- OSD0 only, BLANK if CSR0
	OSD0_VSP_SOSD_CTRL_1            	osd_vsp_sosd_ctrl_1            ;	// 0x026c : '' <-- OSD0 only, BLANK if CSR0
	UINT32                          	                 __rsvd_07[   3];	// 0x0270 ~ 0x0278
	OSD0_SCALER_STATUS_CTRL         	osd_scaler_status_ctrl         ;	// 0x027c : '' <-- OSD0 only, BLANK if CSR0
}
OSDX_CTRL;
...
typedef struct {
	...
	OSDX_BLEND_OSD_MIXER				osdx_blend0_osd_mixer[1];			// 0x0100~0x015c
	...
	OSDX_BLEND_OSD_MIXER				osdx_blend1_osd_mixer[1];			// 0x0180~0x01dc

	UINT32                          	                 __rsvd_06[   8];	// 0x01e0 ~ 0x01fc

	OSDX_CTRL							osdx_ctrl[8];						// 0x0200 - OSD0(IMAGE), 0x400 - OSD4/CSR0(CURSOR),

#define OSDX_M19_Off(_g,_r)             ((UINT32)&(g_osd_m19_reg_shadow->_g._r) - (UINT32)(g_osd_m19_reg_shadow))

#define OSDX_M19_RdFL(_g,_r)            ((g_osd_m19_reg_shadow->_g._r)=(g_osd_m19_reg->_g._r))
#define OSDX_M19_WrFL(_g,_r)            ((g_osd_m19_reg->_g._r)=(g_osd_m19_reg_shadow->_g._r))

#define OSDX_M19_Rd(_g,_r)              *((UINT32*)(&(g_osd_m19_reg_shadow->_g._r)))
#define OSDX_M19_Wr(_g,_r,_v)           ((OSDX_M19_Rd(_g,_r))=((UINT32)(_v)))

#define OSDX_M19_Rd00(_g,_r,_f)         (g_osd_m19_reg_shadow->_g._r._f)
#define OSDX_M19_Rd01(_g,_r,_f01,_v01)  do {                                                \
                                            (_v01) = (g_osd_m19_reg_shadow->_g._r._f01);    \
                                        } while(0)
#define OSDX_M19_Wr01(_g,_r,_f01,_v01)  do {                                                \
                                            (g_osd_m19_reg_shadow->_g._r._f01) = (_v01);    \
                                        } while(0)
#define OSDX_M19_Wr02(_g,_r,_f01,_v01,_f02,_v02)    do {                                    \
                                            (g_osd_m19_reg_shadow->_g._r._f01) = (_v01);    \
                                            (g_osd_m19_reg_shadow->_g._r._f02) = (_v02);    \
                                        } while(0)
}
OSD_M19_REG_T;
/* 150 regs, 150 types */

/* 150 regs, 150 types in Total*/

/* from 'M16P3-A0_PQE_OSD_reg_man_one_sheet.csv' 20180327 21:26:23 KST by getregs v2.9 */

/*
 * @{
 * Naming for register pointer.
 * g_osd_m19_reg : real register of OSD.
 * g_osd_m19_reg_shadow     : shadow register.
 *
 * @def OSD_M19_RdFL: Read  FLushing : Shadow <- Real.
 * @def OSD_M19_WrFL: Write FLushing : Shadow -> Real.
 * @def OSD_M19_Rd  : Read  whole register(UINT32) from Shadow register.
 * @def OSD_M19_Wr  : Write whole register(UINT32) from Shadow register.
 * @def OSD_M19_Rd01 ~ OSD_M19_Rdnn: Read  given '01~nn' fields from Shadow register.
 * @def OSD_M19_Wr01 ~ OSD_M19_Wrnn: Write given '01~nn' fields to   Shadow register.
 * */
#define OSD_M19_RdFL(_r)			((g_osd_m19_reg_shadow->_r)=(g_osd_m19_reg->_r))
#define OSD_M19_WrFL(_r)			((g_osd_m19_reg->_r)=(g_osd_m19_reg_shadow->_r))

#define OSD_M19_Rd(_r)				*((UINT32*)(&(g_osd_m19_reg_shadow->_r)))
#define OSD_M19_Wr(_r,_v)			((OSD_M19_Rd(_r))=((UINT32)(_v)))

#define OSD_M19_Rd00(_r,_f)         (g_osd_m19_reg_shadow->_r._f)


#define OSD_M19_Rd01(_r,_f01,_v01)													\
								do { 											\
									(_v01) = (g_osd_m19_reg_shadow->_r._f01);				\
								} while(0)

#define OSD_M19_Rd02(_r,_f01,_v01,_f02,_v02)										\
								do { 											\
									(_v01) = (g_osd_m19_reg_shadow->_r._f01);				\
									(_v02) = (g_osd_m19_reg_shadow->_r._f02);				\
								} while(0)

#define OSD_M19_Rd03(_r,_f01,_v01,_f02,_v02,_f03,_v03)								\
								do { 											\
									(_v01) = (g_osd_m19_reg_shadow->_r._f01);				\
									(_v02) = (g_osd_m19_reg_shadow->_r._f02);				\
									(_v03) = (g_osd_m19_reg_shadow->_r._f03);				\
								} while(0)

#define OSD_M19_Rd04(_r,_f01,_v01,_f02,_v02,_f03,_v03,_f04,_v04)					\
								do { 											\
									(_v01) = (g_osd_m19_reg_shadow->_r._f01);				\
									(_v02) = (g_osd_m19_reg_shadow->_r._f02);				\
									(_v03) = (g_osd_m19_reg_shadow->_r._f03);				\
									(_v04) = (g_osd_m19_reg_shadow->_r._f04);				\
								} while(0)

#define OSD_M19_Wr01(_r,_f01,_v01)													\
								do { 											\
									(g_osd_m19_reg_shadow->_r._f01) = (_v01);				\
								} while(0)

#define OSD_M19_Wr02(_r,_f01,_v01,_f02,_v02)										\
								do { 											\
									(g_osd_m19_reg_shadow->_r._f01) = (_v01);				\
									(g_osd_m19_reg_shadow->_r._f02) = (_v02);				\
								} while(0)

#define OSD_M19_Wr03(_r,_f01,_v01,_f02,_v02,_f03,_v03)								\
								do { 											\
									(g_osd_m19_reg_shadow->_r._f01) = (_v01);				\
									(g_osd_m19_reg_shadow->_r._f02) = (_v02);				\
									(g_osd_m19_reg_shadow->_r._f03) = (_v03);				\
								} while(0)

#define OSD_M19_Wr04(_r,_f01,_v01,_f02,_v02,_f03,_v03,_f04,_v04)					\
								do { 											\
									(g_osd_m19_reg_shadow->_r._f01) = (_v01);				\
									(g_osd_m19_reg_shadow->_r._f02) = (_v02);				\
									(g_osd_m19_reg_shadow->_r._f03) = (_v03);				\
									(g_osd_m19_reg_shadow->_r._f04) = (_v04);				\
								} while(0)

/** @} *//* end of macro documentation */

extern volatile OSD_M19_REG_T*	g_osd_m19_reg;
extern OSD_M19_REG_T*			g_osd_m19_reg_shadow;
...
/* from 'M19_PQE_OSD_reg_man.csv'  대한민국 표준시 by getregs v2.8 */
