...
const PE_REG_PARAM_T dnr_l_ud_default_m19[] =
{	
    {0x3594, 0x01780621},        // DNR_MAX_CTRL
    {0x3598, 0x00000004},        // DNR_DBAR_CTRL
    {0x35A0, 0x1800C0A1},        // MNR_CTRL_0
    ...
    {0x35BC, 0x1030C101},        // DC_BNR_CTRL_0
    {0x35C0, 0x25890102},        // DC_BNR_CTRL_1
    {0x35C4, 0x15000109},        // DC_BNR_CTRL_2
    ...
    {0x3604, 0x00100003},        // AC_BNR_CTRL_9
    ...
    {0x37A8, 0xD0002010},        // REG_MNR_CTRL_6
    {0x37AC, 0x01020408},        // REG_MNR_CTRL_7
    {0x37B0, 0xFFE0D0C0},        // REG_MNR_CTRL_8
    {0x37B4, 0x050A1428},        // REG_MNR_CTRL_9
    {0x37B8, 0xFFC0A080},        // REG_MNR_CTRL_10
    ...
    {0x37DC, 0x8C400000},        // REG_DECON_CTRL_17
    {0x37E0, 0x5B800005},        // REG_DECON_CTRL_18
    {0x37E4, 0x20160805},        // REG_DECON_CTRL_19
    {0x37E8, 0x002040C0},        // REG_DECON_CTRL_20
    {0x37EC, 0x01006820},        // REG_DECON_CTRL_21
    {0x37F0, 0x04040080},        // REG_DECON_CTRL_22
    ...
    {0x3804, 0x10040200},        // REG_DECON_CTRL_27
    {0x3808, 0x3FFFFFFF},        // REG_DECON_CTRL_28
    {0x380C, 0x00000000},        // REG_DECON_CTRL_29
    {0x3810, 0xC4160000},        // REG_DECON_CTRL_30
    {0x3814, 0xFF000000},        // REG_DECON_CTRL_31
    ...
    {0x3848, 0x2080A0C0},        // REG_DECON_CTRL_44
    {0x384C, 0xFF804000},        // REG_DECON_CTRL_45
    {0x3850, 0x7500009A},        // REG_DECON_CTRL_46
    {0x3854, 0x00780410},        // REG_DECON_CTRL_47
    {0x3858, 0x030C1A20},        // REG_DECON_CTRL_48
    {0x385C, 0xFF4B0201},        // REG_DECON_CTRL_49
    {0x3860, 0x1ABC4085},        // REG_DECON_CTRL_50
