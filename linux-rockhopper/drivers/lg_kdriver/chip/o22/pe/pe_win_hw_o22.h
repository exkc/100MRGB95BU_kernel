...
#ifndef	_PE_WIN_HW_O22_H_
#define	_PE_WIN_HW_O22_H_
...
typedef struct
{
	PE_WIN_HW_O22_CTRL_T win_inf;			///< window info
	PE_WIN_HW_O22_LRCR_CTRL_T lrcr_inf;		///< lrcr win info
	PE_WIN_HW_O22_TNR_CTRL_T tnr_inf;		///< tnr measure win info
	UINT32 is_external_chip;		///< 60Hz or 120Hz model, 0:60Hz, 1:120Hz
}
PE_WIN_HW_O22_SETTINGS_T;
