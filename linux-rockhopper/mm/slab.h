...
#define SLAB_CORE_FLAGS (SLAB_HWCACHE_ALIGN | SLAB_CACHE_DMA | \
			 SLAB_CACHE_DMA32 | SLAB_PANIC | SLAB_READONLY | \
...
#ifdef CONFIG_EKP
/* Read-only slab should be allocated after EKP is initialized. */
static __always_inline bool is_slab_readonly(unsigned long flags)
{
	return ekp_enabled() && (flags & SLAB_READONLY);
}
#else
static inline bool is_slab_readonly(unsigned long flags) { return false; }
#endif
