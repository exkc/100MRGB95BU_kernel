...
static int slt_open( void )
{
	...
	SLT_REG = (volatile O18_SLT_REG_T*)ioremap(O18_SLT_BASE, sizeof(O18_SLT_REG_T));
#if LINUX_VERSION_CODE >= KERNEL_VERSION(4,4,0)
	ret = request_irq(O18_IRQ_SLT, (irq_handler_t)slt_isr, NULL, "SLT", NULL);
#else
	ret = request_irq(O18_IRQ_SLT, (irq_handler_t)slt_isr, IRQF_DISABLED, "SLT", NULL);
#endif
	if( ret != RET_OK )
	{
