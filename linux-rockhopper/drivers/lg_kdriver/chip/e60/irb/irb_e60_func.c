...
void e60_irb_funcInit(void)
{

	KDRV_IRB_DEBUG("e60_irb init\n");
...
int e60_irb_tx(LX_IRB_PARAM_T * param)
{
	UINT32	micomcmd[5]	= {0,};
	UINT32 * pbuf = NULL;
	UINT32 * mbuf = NULL;
	...
	KDRV_IRB_DEBUG("e60_irb tx makenum[%x] pbuf[%x]\n",
		midx,pbuf[0]);
	if(mbuf)
		kfree(mbuf);
	return 0;
...
void e60_irb_funcReInit(void)
{

  KDRV_IRB_NOTI("e60_irb reinit\n");
}
void e60_irb_exit(void)
{
  KDRV_IRB_DEBUG("e60_irb end\n");
}


static irbs_e60_func_t e60_irb_func =
{
	.init = e60_irb_funcInit,
	.reinit = e60_irb_funcReInit,
	.tx = e60_irb_tx,
	.exit = e60_irb_exit,
};

irbs_e60_func_t* get_e60_irb_func(void)
{
	return &e60_irb_func;
}
