...
//Header File for DPG2_M0 in \M23\M23_DRAM_M0_Register_Manual.xls
...
typedef struct {
	REG_DPG2_M0_DPG_ENABLE_T                                 dpg_enable;	//0xC4F44500
	REG_DPG2_M0_DPG_INF_CTRL_T                             dpg_inf_ctrl;	//0xC4F44504
	REG_DPG2_M0_DPG_ID_INC_T                                 dpg_id_inc;	//0xC4F44508
	REG_DPG2_M0_DPG_SW_RESET_T                             dpg_sw_reset;	//0xC4F4450C
	REG_DPG2_M0_DPG_WR_PATTERN_T                         dpg_wr_pattern;	//0xC4F44510
	REG_DPG2_M0_CMD_DLY_CTRL_T                             cmd_dly_ctrl;	//0xC4F44514
	REG_DPG2_M0_RND_AXI_LENGTH_T                         rnd_axi_length;	//0xC4F44518
	REG_DPG2_M0_AXI_TR_STATUS_T                           axi_tr_status;	//0xC4F4451C
	REG_DPG2_M0_DPG_MO_STATUS_T                           dpg_mo_status;	//0xC4F44520
	REG_DPG2_M0_DPG_BCH_ERR_STATUS_T                 dpg_bch_err_status;	//0xC4F44524
	REG_DPG2_M0_DPG_RDATA_ERR_STATUS_T             dpg_rdata_err_status;	//0xC4F44528
	REG_DPG2_M0_DPG_RCH_ERR_STATUS_T                 dpg_rch_err_status;	//0xC4F4452C
	REG_DPG2_M0_IP_GATING_T                                   ip_gating;	//0xC4F44530
	REG_DPG2_M0_DPG_GATING_T                                 dpg_gating;	//0xC4F44534
	REG_DPG2_M0_FLUSH_EN_T                                     flush_en;	//0xC4F44538
	REG_DPG2_M0_FLUSH_DONE_T                                 flush_done;	//0xC4F4453C
	REG_DPG2_M0_GRP0_START_ADDR_T                       grp0_start_addr;	//0xC4F44540
	REG_DPG2_M0_GPR0_ADDR_INC_BND_T                   gpr0_addr_inc_bnd;	//0xC4F44544
	REG_DPG2_M0_GRP1_START_ADDR_T                       grp1_start_addr;	//0xC4F44548
	REG_DPG2_M0_GPR1_ADDR_INC_BND_T                   gpr1_addr_inc_bnd;	//0xC4F4454C
	REG_DPG2_M0_ADDR_INC_VAL_T                             addr_inc_val;	//0xC4F44550
	REG_DPG2_M0_ROW_BANK_ADDR_MODE_T                 row_bank_addr_mode;	//0xC4F44554
	UINT32                                                    reserved0;	//0xC4F44558
	REG_DPG2_M0_RDATA_ERR_ADDR_T                         rdata_err_addr;	//0xC4F4455C
	REG_DPG2_M0_RDATA_EXP_DATA_127_96_T           rdata_exp_data_127_96;	//0xC4F44560
	REG_DPG2_M0_RDATA_EXP_DATA_95_64_T             rdata_exp_data_95_64;	//0xC4F44564
	REG_DPG2_M0_RDATA_EXP_DATA_63_32_T             rdata_exp_data_63_32;	//0xC4F44568
	REG_DPG2_M0_RDATA_EXP_DATA_31_0_T               rdata_exp_data_31_0;	//0xC4F4456C
	REG_DPG2_M0_RDATA_IN_DATA_127_96_T             rdata_in_data_127_96;	//0xC4F44570
	REG_DPG2_M0_RDATA_IN_DATA_95_64_T               rdata_in_data_95_64;	//0xC4F44574
	REG_DPG2_M0_RDATA_IN_DATA_63_32_T               rdata_in_data_63_32;	//0xC4F44578
	REG_DPG2_M0_RDATA_IN_DATA_31_0_T                 rdata_in_data_31_0;	//0xC4F4457C
	REG_DPG2_M0_USER_CMD_REG0_T                           user_cmd_reg0;	//0xC4F44580
	REG_DPG2_M0_USER_CMD_REG1_T                           user_cmd_reg1;	//0xC4F44584
	UINT32                                                    reserved1;	//0xC4F44588
	UINT32                                                    reserved2;	//0xC4F4458C
	REG_DPG2_M0_START_MODE_T                                 start_mode;	//0xC4F44590
	UINT32                                                    reserved3;	//0xC4F44594
	REG_DPG2_M0_LP_CTRL_T                                       lp_ctrl;	//0xC4F44598
	UINT32                                                    reserved4;	//0xC4F4459C
	REG_DPG2_M0_DIRECT_MODE_T                               direct_mode;	//0xC4F445A0
	REG_DPG2_M0_FIXED_MODE0_T                               fixed_mode0;	//0xC4F445A4
	REG_DPG2_M0_FIXED_MODE1_T                               fixed_mode1;	//0xC4F445A8
}REG_DPG2_M0_T;
