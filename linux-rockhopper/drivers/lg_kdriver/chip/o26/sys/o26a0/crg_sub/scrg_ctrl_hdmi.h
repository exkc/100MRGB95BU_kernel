#ifndef _SCRG_CTRL_HDMI_REG_O26A0_H_
#define _SCRG_CTRL_HDMI_REG_O26A0_H_
...
/*-----------------------------------------------------------------------------------------
    0xC874_0000    crg_hdmi000 ''
-----------------------------------------------------------------------------------------*/
typedef struct {
    UINT32
    test_reserved             : 32;    //  31: 0
}SCRG_CTRL_HDMI_CRG_HDMI000_O26A0_T;

/*-----------------------------------------------------------------------------------------
    0xC874_0004    crg_hdmi001 ''
-----------------------------------------------------------------------------------------*/
typedef struct {
    UINT32
    test_reserved_ro          : 32;    //  31: 0
}SCRG_CTRL_HDMI_CRG_HDMI001_O26A0_T;

/*-----------------------------------------------------------------------------------------
    0xC874_0008    crg_hdmi002 ''
-----------------------------------------------------------------------------------------*/
typedef struct {
    UINT32
    reg_adaptx_f_hdmi_0__hdmirx_prt1_tmdsqp_clk_gate_en: 1,    //  0
    reg_adaptx_f_hdmi_1__hdmirx_prt2_tmdsqp_clk_gate_en: 1,    //  1
    reg_adaptx_f_hdmi_2__hdmirx_prt3_tmdsqp_clk_gate_en: 1,    //  2
    reg_adaptx_f_hdmi_3__hdmirx_prt4_tmdsqp_clk_gate_en: 1,    //  3
    reg_adaptx_f_hdmiipw_0__hdmirx_prt1_tmdsqp_clk_gate_en: 1,    //  4
    reg_adaptx_f_hdmiipw_1__hdmirx_prt2_tmdsqp_clk_gate_en: 1,    //  5
    reg_adaptx_f_hdmiipw_2__hdmirx_prt3_tmdsqp_clk_gate_en: 1,    //  6
    reg_adaptx_f_hdmiipw_3__hdmirx_prt4_tmdsqp_clk_gate_en: 1,    //  7
    reg_adaptx_x_hdmi_0__hdmirx_comm_esm_clk_gate_en: 1,    //  8
    reg_hdmirx_comm_esm_clk_gate_en: 1,    //  9
    reg_hdmirx_cr_para_clk_gate_en: 1,    //  10
    reg_hdmirx_prt1_aud_clk_gate_en: 1,    //  11
    reg_hdmirx_prt1_frl_clk_gate_en: 1,    //  12
    reg_hdmirx_prt1_link_clk_gate_en: 1,    //  13
    reg_hdmirx_prt1_tmdsqp_clk_gate_en: 1,    //  14
    reg_hdmirx_prt2_aud_clk_gate_en: 1,    //  15
    reg_hdmirx_prt2_earc_aud_clk_gate_en: 1,    //  16
    reg_hdmirx_prt2_earc_bp_clk_gate_en: 1,    //  17
    reg_hdmirx_prt2_frl_clk_gate_en: 1,    //  18
    reg_hdmirx_prt2_link_clk_gate_en: 1,    //  19
    reg_hdmirx_prt2_tmdsqp_clk_gate_en: 1,    //  20
    reg_hdmirx_prt3_aud_clk_gate_en: 1,    //  21
    reg_hdmirx_prt3_frl_clk_gate_en: 1,    //  22
    reg_hdmirx_prt3_link_clk_gate_en: 1,    //  23
    reg_hdmirx_prt3_tmdsqp_clk_gate_en: 1,    //  24
    reg_hdmirx_prt4_aud_clk_gate_en: 1,    //  25
    reg_hdmirx_prt4_frl_clk_gate_en: 1,    //  26
    reg_hdmirx_prt4_link_clk_gate_en: 1,    //  27
    reg_hdmirx_prt4_tmdsqp_clk_gate_en: 1,    //  28
    reg_hdmirx_ref_clk_gate_en:  1,    //     29
    reg_hdmirx_sapb_clk_gate_en: 1,    //     30
                              :  1;    //  31:31 reserved
}SCRG_CTRL_HDMI_CRG_HDMI002_O26A0_T;

/*-----------------------------------------------------------------------------------------
    0xC874_000C    crg_hdmi003 ''
-----------------------------------------------------------------------------------------*/
typedef struct {
    UINT32
...
}SCRG_CTRL_HDMI_CRG_HDMI003_O26A0_T;

/*-----------------------------------------------------------------------------------------
    0xC874_0010    crg_hdmi004 ''
-----------------------------------------------------------------------------------------*/
typedef struct {
    UINT32
    ...
    reg_soft_rst_x_hdmi_0_axi_n: 1;    //     31
}SCRG_CTRL_HDMI_CRG_HDMI004_O26A0_T;

/*-----------------------------------------------------------------------------------------
    0xC874_0014    crg_hdmi005 ''
-----------------------------------------------------------------------------------------*/
typedef struct {
    UINT32
    ...
    reg_hdmirx_prt4_aud_clk_sel: 3,    //  18:16
                              : 13;    //  31:19 reserved
}SCRG_CTRL_HDMI_CRG_HDMI005_O26A0_T;

/*-----------------------------------------------------------------------------------------
    scrg_ctrl_hdmi Register LIst
-----------------------------------------------------------------------------------------*/
typedef struct {
    SCRG_CTRL_HDMI_CRG_HDMI000_O26A0_T    crg_hdmi000;          // 0xC874_0000
    SCRG_CTRL_HDMI_CRG_HDMI001_O26A0_T    crg_hdmi001;          // 0xC874_0004
    SCRG_CTRL_HDMI_CRG_HDMI002_O26A0_T    crg_hdmi002;          // 0xC874_0008
    SCRG_CTRL_HDMI_CRG_HDMI003_O26A0_T    crg_hdmi003;          // 0xC874_000C
    SCRG_CTRL_HDMI_CRG_HDMI004_O26A0_T    crg_hdmi004;          // 0xC874_0010
    SCRG_CTRL_HDMI_CRG_HDMI005_O26A0_T    crg_hdmi005;          // 0xC874_0014
}SCRG_CTRL_HDMI_REG_O26A0_T;
/* 6 regs */
...
#define SCRG_CTRL_HDMI_CRG_HDMI000_O26A0_T_OFF              (BASEADDRESS+0x0000)
#define SCRG_CTRL_HDMI_CRG_HDMI001_O26A0_T_OFF              (BASEADDRESS+0x0004)
#define SCRG_CTRL_HDMI_CRG_HDMI002_O26A0_T_OFF              (BASEADDRESS+0x0008)
#define SCRG_CTRL_HDMI_CRG_HDMI003_O26A0_T_OFF              (BASEADDRESS+0x000C)
#define SCRG_CTRL_HDMI_CRG_HDMI004_O26A0_T_OFF              (BASEADDRESS+0x0010)
#define SCRG_CTRL_HDMI_CRG_HDMI005_O26A0_T_OFF              (BASEADDRESS+0x0014)
...
typedef union {
    UINT32 udata32;
    struct {
    UINT32 reg_adaptx_f_hdmi_0__hdmirx_prt1_tmdsqp_clk_gate_en: 1;    //  0
    UINT32 reg_adaptx_f_hdmi_1__hdmirx_prt2_tmdsqp_clk_gate_en: 1;    //  1
    UINT32 reg_adaptx_f_hdmi_2__hdmirx_prt3_tmdsqp_clk_gate_en: 1;    //  2
    UINT32 reg_adaptx_f_hdmi_3__hdmirx_prt4_tmdsqp_clk_gate_en: 1;    //  3
    UINT32 reg_adaptx_f_hdmiipw_0__hdmirx_prt1_tmdsqp_clk_gate_en: 1;    //  4
    UINT32 reg_adaptx_f_hdmiipw_1__hdmirx_prt2_tmdsqp_clk_gate_en: 1;    //  5
    UINT32 reg_adaptx_f_hdmiipw_2__hdmirx_prt3_tmdsqp_clk_gate_en: 1;    //  6
    UINT32 reg_adaptx_f_hdmiipw_3__hdmirx_prt4_tmdsqp_clk_gate_en: 1;    //  7
    UINT32 reg_adaptx_x_hdmi_0__hdmirx_comm_esm_clk_gate_en: 1;    //  8
    UINT32 reg_hdmirx_comm_esm_clk_gate_en: 1;    //  9
    UINT32 reg_hdmirx_cr_para_clk_gate_en: 1;    //  10
    UINT32 reg_hdmirx_prt1_aud_clk_gate_en: 1;    //  11
    UINT32 reg_hdmirx_prt1_frl_clk_gate_en: 1;    //  12
    UINT32 reg_hdmirx_prt1_link_clk_gate_en: 1;    //  13
    UINT32 reg_hdmirx_prt1_tmdsqp_clk_gate_en: 1;    //  14
    UINT32 reg_hdmirx_prt2_aud_clk_gate_en: 1;    //  15
    UINT32 reg_hdmirx_prt2_earc_aud_clk_gate_en: 1;    //  16
    UINT32 reg_hdmirx_prt2_earc_bp_clk_gate_en: 1;    //  17
    UINT32 reg_hdmirx_prt2_frl_clk_gate_en: 1;    //  18
    UINT32 reg_hdmirx_prt2_link_clk_gate_en: 1;    //  19
    UINT32 reg_hdmirx_prt2_tmdsqp_clk_gate_en: 1;    //  20
    UINT32 reg_hdmirx_prt3_aud_clk_gate_en: 1;    //  21
    UINT32 reg_hdmirx_prt3_frl_clk_gate_en: 1;    //  22
    UINT32 reg_hdmirx_prt3_link_clk_gate_en: 1;    //  23
    UINT32 reg_hdmirx_prt3_tmdsqp_clk_gate_en: 1;    //  24
    UINT32 reg_hdmirx_prt4_aud_clk_gate_en: 1;    //  25
    UINT32 reg_hdmirx_prt4_frl_clk_gate_en: 1;    //  26
    UINT32 reg_hdmirx_prt4_link_clk_gate_en: 1;    //  27
    UINT32 reg_hdmirx_prt4_tmdsqp_clk_gate_en: 1;    //  28
    UINT32 reg_hdmirx_ref_clk_gate_en: 1;    //  29
    UINT32 reg_hdmirx_sapb_clk_gate_en: 1;    //  30
...
typedef union {
    ...
    UINT32 reg_soft_rst_x_hdmi_0_axi_n: 1;    //  31
    };
}SCRG_CTRL_HDMI_CRG_HDMI004_O26A0_T;
...
#endif //_SCRG_CTRL_HDMI_REG_O26A0_H_
