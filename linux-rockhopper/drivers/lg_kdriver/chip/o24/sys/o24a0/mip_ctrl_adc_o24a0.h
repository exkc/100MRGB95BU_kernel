#ifndef _MIP_CTRL_ADC_REG_O24A0_H_
#define _MIP_CTRL_ADC_REG_O24A0_H_
...
}MIP_CTRL_ADC_MIP_ADC00_O24A0_T;
...
}MIP_CTRL_ADC_MIP_ADC01_O24A0_T;

/*-----------------------------------------------------------------------------------------
    0xCC9E_4008    mip_adc02 ''
-----------------------------------------------------------------------------------------*/
typedef struct {
    UINT32
                              :  1,    //      0 reserved
...
}MIP_CTRL_ADC_MIP_ADC02_O24A0_T;

/*-----------------------------------------------------------------------------------------
    0xCC9E_400C    mip_adc03 ''
-----------------------------------------------------------------------------------------*/
typedef struct {
    UINT32
                              :  1,    //      0 reserved
...
}MIP_CTRL_ADC_MIP_ADC03_O24A0_T;

/*-----------------------------------------------------------------------------------------
    0xCC9E_4010    mip_adc04 ''
-----------------------------------------------------------------------------------------*/
typedef struct {
    UINT32
    ...
    reg_admd_apll_dto_divsel  :  1,    //     12
                              : 19;    //  31:13 reserved
}MIP_CTRL_ADC_MIP_ADC04_O24A0_T;
...
typedef struct {
    ...
    reg_cvbsafe_cvbs_pdb      :  1,    //      5
                              : 26;    //   31:6 reserved
}MIP_CTRL_ADC_MIP_ADC05_O24A0_T;

/*-----------------------------------------------------------------------------------------
    0xCC9E_4018    mip_adc06 ''
-----------------------------------------------------------------------------------------*/
typedef struct {
    UINT32
    ...
    reg_cvbsafe_cvbs_dcsel    :  2,    //  29:28
                              :  2;    //  31:30 reserved
}MIP_CTRL_ADC_MIP_ADC06_O24A0_T;

/*-----------------------------------------------------------------------------------------
    0xCC9E_401C    mip_adc07 ''
-----------------------------------------------------------------------------------------*/
typedef struct {
    UINT32
    ...
    reg_cvbsafe_cvbs_ibuf     :  3,    //  30:28
                              :  1;    //  31:31 reserved
}MIP_CTRL_ADC_MIP_ADC07_O24A0_T;

/*-----------------------------------------------------------------------------------------
    mip_ctrl_adc Register LIst
-----------------------------------------------------------------------------------------*/
typedef struct {
    MIP_CTRL_ADC_MIP_ADC00_O24A0_T     mip_adc00  ;             // 0xCC9E_4000
    MIP_CTRL_ADC_MIP_ADC01_O24A0_T     mip_adc01  ;             // 0xCC9E_4004
    MIP_CTRL_ADC_MIP_ADC02_O24A0_T     mip_adc02  ;             // 0xCC9E_4008
    MIP_CTRL_ADC_MIP_ADC03_O24A0_T     mip_adc03  ;             // 0xCC9E_400C
    MIP_CTRL_ADC_MIP_ADC04_O24A0_T     mip_adc04  ;             // 0xCC9E_4010
    MIP_CTRL_ADC_MIP_ADC05_O24A0_T     mip_adc05  ;             // 0xCC9E_4014
    MIP_CTRL_ADC_MIP_ADC06_O24A0_T     mip_adc06  ;             // 0xCC9E_4018
    MIP_CTRL_ADC_MIP_ADC07_O24A0_T     mip_adc07  ;             // 0xCC9E_401C
}MIP_CTRL_ADC_REG_O24A0_T;
/* 8 regs */
...
#define MIP_CTRL_ADC_MIP_ADC00_O24A0_T_OFF                  (BASEADDRESS+0x0000)
#define MIP_CTRL_ADC_MIP_ADC01_O24A0_T_OFF                  (BASEADDRESS+0x0004)
#define MIP_CTRL_ADC_MIP_ADC02_O24A0_T_OFF                  (BASEADDRESS+0x0008)
#define MIP_CTRL_ADC_MIP_ADC03_O24A0_T_OFF                  (BASEADDRESS+0x000C)
#define MIP_CTRL_ADC_MIP_ADC04_O24A0_T_OFF                  (BASEADDRESS+0x0010)
#define MIP_CTRL_ADC_MIP_ADC05_O24A0_T_OFF                  (BASEADDRESS+0x0014)
#define MIP_CTRL_ADC_MIP_ADC06_O24A0_T_OFF                  (BASEADDRESS+0x0018)
#define MIP_CTRL_ADC_MIP_ADC07_O24A0_T_OFF                  (BASEADDRESS+0x001C)
