...
#ifndef __OSD_AFBC_REG_O20_H__
#define __OSD_AFBC_REG_O20_H__
...
#define AFBC_CTRL_RdFL(idx,_r)					((g_osd_afbc_o20_reg_shadow[idx]->_r)=(g_osd_afbc_o20_reg[idx]->_r))
#define AFBC_CTRL_WrFL(idx,_r)					((g_osd_afbc_o20_reg[idx]->_r)=(g_osd_afbc_o20_reg_shadow[idx]->_r))

#define AFBC_CTRL_Rd(idx,_r)					*((UINT32*)(&(g_osd_afbc_o20_reg_shadow[idx]->_r)))
#define AFBC_CTRL_Wr(idx,_r,_v)					((AFBC_CTRL_Rd(idx,_r))=((UINT32)(_v)))

#define AFBC_CTRL_Rd01(idx,_r,_f01,_v01)													\
								do { 														\
									(_v01) = (g_osd_afbc_o20_reg_shadow[idx]->_r._f01);	\
								} while(0)

#define AFBC_CTRL_Rd02(idx,_r,_f01,_v01,_f02,_v02)											\
								do { 														\
									(_v01) = (g_osd_afbc_o20_reg_shadow[idx]->_r._f01);	\
									(_v02) = (g_osd_afbc_o20_reg_shadow[idx]->_r._f02);	\
								} while(0)

#define AFBC_CTRL_Wr01(idx,_r,_f01,_v01)													\
								do { 														\
									(g_osd_afbc_o20_reg_shadow[idx]->_r._f01) = (_v01);	\
								} while(0)

#define AFBC_CTRL_Wr02(idx,_r,_f01,_v01,_f02,_v02)											\
								do { 														\
									(g_osd_afbc_o20_reg_shadow[idx]->_r._f01) = (_v01);	\
									(g_osd_afbc_o20_reg_shadow[idx]->_r._f02) = (_v02);	\
								} while(0)

/** @} *//* end of macro documentation */

extern volatile OSD_AFBC_O20_REG_T*		g_osd_afbc_o20_reg[2];
extern OSD_AFBC_O20_REG_T*    			g_osd_afbc_o20_reg_shadow[2];

#ifdef __cplusplus
}
#endif

#endif	/* __OSD_AFBC_REG_O20_H__ */
