...
#ifndef	_PE_TSK_O20_H_
#define	_PE_TSK_O20_H_
...
typedef enum
{
	PE_TSK_O20_RUN_START = 0,	///< run start
	PE_TSK_O20_RUN_STOP_TASK,	///< run stop task
	PE_TSK_O20_RUN_STOP_HDLR,	///< run stop handler
	PE_TSK_O20_RUN_STOP_OVWR,	///< run stop overwrite
	PE_TSK_O20_RUN_STOP_ALGO,	///< run stop algorithm
	PE_TSK_O20_RUN_STOP_MODE,	///< run stop mode
	PE_TSK_O20_RUN_STOP_WIN2,	///< run stop win2
	PE_TSK_O20_RUN_TEST_TASK,	///< use task(force)
	PE_TSK_O20_RUN_NUM			///< max num
}
PE_TSK_O20_OPR_RUN_MODE;
...
typedef enum
{
	PE_TSK_O20_DBG_OFF = 0,		///< off
	PE_TSK_O20_DBG_ON,			///< on
	PE_TSK_O20_DBG_TIME,		///< time check
	PE_TSK_O20_DBG_CNT,			///< count check
	PE_TSK_O20_DBG_BRK,			///< break check
	PE_TSK_O20_DBG_MAX			///< max num
}
PE_TSK_O20_OPR_DBG_MODE;
...
typedef enum
{
	PE_TSK_O20_TIME_TASK = 0,	///< task time
	PE_TSK_O20_TIME_HNDL,		///< handler time
	PE_TSK_O20_TIME_MAX			///< max num
}
PE_TSK_O20_TIME;

/**
 *	pe task o20 operation type
 */
typedef struct
{
...
/**
 *	pe task o20 handler operation type
 */
typedef struct
{
...
PE_TSK_O20_LRC_HST_CTRL_T;

/**
 *	pe task o20 cfg type
 */
typedef struct {
	PE_INF_O20_SETTINGS_T inf;			///< info
	PE_TSK_O20_OPR_T opr;				///< operation mode
	PE_TSK_O20_HDLR_OPR_T hdlr_opr;		///< handler operation mode
	PE_TSK_O20_LRC_HST_CTRL_T lrc;		///< lrcr ctrl
}
PE_TSK_O20_CFG_T;
