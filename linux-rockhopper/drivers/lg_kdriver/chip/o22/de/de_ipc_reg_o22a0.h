...
#ifndef _IPC_REG_O22A0_H_
#define _IPC_REG_O22A0_H_
...
}O22A0_APB_TOUT_CTRL_CH0_PWDATA_T;
...
}O22A0_APB_TOUT_CTRL_CH1_PWDATA_T;
...
}O22A0_APB_TOUT_CTRL_CH2_PWDATA_T;
...
}O22A0_APB_TOUT_CTRL_CH3_PWDATA_T;
...
}O22A0_SROM_BOOT_MAP4_T;

typedef struct {
	O22A0_SET_REG_CTRL0_T                               set_reg_ctrl0;	//0xCC080000
	O22A0_SET_REG_CTRL1_T                               set_reg_ctrl1;	//0xCC080004
	O22A0_EXT_INTR_EVENT_T                             ext_intr_event;	//0xCC080008
	O22A0_EXT_INTR_ENABLE_T                           ext_intr_enable;	//0xCC08000C
	O22A0_EXT_INTR_STATUS_T                           ext_intr_status;	//0xCC080010
	O22A0_EXT_INTR_CLEAR_T                             ext_intr_clear;	//0xCC080014
	O22A0_INT_INTR_EVENT_T                             int_intr_event;	//0xCC080018
	O22A0_INT_INTR_ENABLE_T                           int_intr_enable;	//0xCC08001C
	O22A0_INT_INTR_STATUS_T                           int_intr_status;	//0xCC080020
	O22A0_INT_INTR_CLEAR_T                             int_intr_clear;	//0xCC080024
	O22A0_SROM_BOOT_MAP1_T                             srom_boot_map1;	//0xCC080028
	O22A0_SROM_BOOT_MAP2_T                             srom_boot_map2;	//0xCC08002C
	O22A0_SRAM_PORT_SEL_T                               sram_port_sel;	//0xCC080030
	O22A0_PDEBUG_STATUS_T                               pdebug_status;	//0xCC080034
	O22A0_PDEBUG_DATA_T                                   pdebug_data;	//0xCC080038
	O22A0_PDEBUG_PC_T                                       pdebug_pc;	//0xCC08003C
	O22A0_AXI_USER_ID_T                                   axi_user_id;	//0xCC080040
	O22A0_SRAM0_OFFSET_T                                 sram0_offset;	//0xCC080044
	O22A0_SRAM1_OFFSET_T                                 sram1_offset;	//0xCC080048
	O22A0_SRAM2_OFFSET_T                                 sram2_offset;	//0xCC08004C
	O22A0_SRAM3_OFFSET_T                                 sram3_offset;	//0xCC080050
	O22A0_PDEBUG_DATA1_T                                 pdebug_data1;	//0xCC080054
	O22A0_PDEBUG_PC1_T                                     pdebug_pc1;	//0xCC080058
	O22A0_SPP_MCU_VERSION_T                           spp_mcu_version;	//0xCC08005C
	O22A0_INTR_MCU_FLAG_T                               intr_mcu_flag;	//0xCC080060
	O22A0_INTR_MCU_FLAG_EN_T                         intr_mcu_flag_en;	//0xCC080064
	O22A0_INTR_CPU_FLAG_T                               intr_cpu_flag;	//0xCC080068
	O22A0_INTR_CPU_FLAG_EN_T                         intr_cpu_flag_en;	//0xCC08006C
	O22A0_GLOBAL_STCC0_T                                 global_stcc0;	//0xCC080070
	O22A0_GLOBAL_STCC1_T                                 global_stcc1;	//0xCC080074
	O22A0_GLOBAL_STCC2_T                                 global_stcc2;	//0xCC080078
	O22A0_GLOBAL_STCC3_T                                 global_stcc3;	//0xCC08007C
	O22A0_LIVE_STCC0_T                                     live_stcc0;	//0xCC080080
	O22A0_LIVE_STCC1_T                                     live_stcc1;	//0xCC080084
	O22A0_AD_APB_TOUT_CTRL_T                         ad_apb_tout_ctrl;	//0xCC080088
	O22A0_AD_APB_TOUT_CNT_T                           ad_apb_tout_cnt;	//0xCC08008C
	O22A0_APB_TOUT_CTRL_CH0_ADR_T               apb_tout_ctrl_ch0_adr;	//0xCC080090
	O22A0_APB_TOUT_CTRL_CH0_PW_T                 apb_tout_ctrl_ch0_pw;	//0xCC080094
	O22A0_APB_TOUT_CTRL_CH0_PWDATA_T         apb_tout_ctrl_ch0_pwdata;	//0xCC080098
	O22A0_APB_TOUT_CTRL_CH1_ADR_T               apb_tout_ctrl_ch1_adr;	//0xCC08009C
	O22A0_APB_TOUT_CTRL_CH1_PW_T                 apb_tout_ctrl_ch1_pw;	//0xCC0800A0
	O22A0_APB_TOUT_CTRL_CH1_PWDATA_T         apb_tout_ctrl_ch1_pwdata;	//0xCC0800A4
	O22A0_APB_TOUT_CTRL_CH2_ADR_T               apb_tout_ctrl_ch2_adr;	//0xCC0800A8
	O22A0_APB_TOUT_CTRL_CH2_PW_T                 apb_tout_ctrl_ch2_pw;	//0xCC0800AC
	O22A0_APB_TOUT_CTRL_CH2_PWDATA_T         apb_tout_ctrl_ch2_pwdata;	//0xCC0800B0
	O22A0_APB_TOUT_CTRL_CH3_ADR_T               apb_tout_ctrl_ch3_adr;	//0xCC0800B4
	O22A0_APB_TOUT_CTRL_CH3_PW_T                 apb_tout_ctrl_ch3_pw;	//0xCC0800B8
	O22A0_APB_TOUT_CTRL_CH3_PWDATA_T         apb_tout_ctrl_ch3_pwdata;	//0xCC0800BC
	O22A0_AD_MASK_START_ADDR_T                     ad_mask_start_addr;	//0xCC0800C0
	O22A0_AD_MASK_END_ADDR_T                         ad_mask_end_addr;	//0xCC0800C4
	O22A0_AD_MASK_READ_ADDR_T                       ad_mask_read_addr;	//0xCC0800C8
	O22A0_AD_INTR_PRIORITY_T                         ad_intr_priority;	//0xCC0800CC
	O22A0_AD_UP_COUNTER_T                               ad_up_counter;	//0xCC0800D0
	O22A0_RST_ASYNC_BRIDGE_T                         rst_async_bridge;	//0xCC0800D4
	...
	O22A0_SRAM4_OFFSET_T                                 sram4_offset;	//0xCC0800E4
	O22A0_SRAM5_OFFSET_T                                 sram5_offset;	//0xCC0800E8
	O22A0_INTR_MCU1_FLAG_T                             intr_mcu1_flag;	//0xCC0800EC
	O22A0_INTR_MCU1_FLAG_EN_T                       intr_mcu1_flag_en;	//0xCC0800F0
	O22A0_SROM_BOOT_MAP3_T                             srom_boot_map3;	//0xCC0800F4
	O22A0_SROM_BOOT_MAP4_T                             srom_boot_map4;	//0xCC0800F8
} DE_IPC_REG_O22A0_T;
