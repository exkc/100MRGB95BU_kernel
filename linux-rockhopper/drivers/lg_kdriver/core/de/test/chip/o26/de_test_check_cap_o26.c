...
/*----------------------------------------------------------------------------------------
	global Functions
----------------------------------------------------------------------------------------*/
int de_test_check_cap_o26_run(void);
...
int de_test_check_cap_o26_run(void)
{
	...
	do {
		...
		DE_NOTI("run(%s)\n",pat_str);
		if (0 != (ret = de_test_util_o26_cvi_pat_on(pat_str))) {DE_ERROR("de_test_util_o26_cvi_pat_on(%s) err\n",pat_str);break;}
		if (0 != (ret = de_test_util_o26_check_cvi_o_pixel(pat_str,pos_x,pos_y))) {DE_ERROR("de_test_util_o26_check_cvi_o_pixel(%s) err\n",pat_str);break;}
	} while (0);
