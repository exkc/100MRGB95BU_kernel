...
/** @file pe_vfilt_y_hw_param_m17.h
 *
...
----------------------------------------------------------------------------*/
#include "pe_reg.h"
#include "pe_vflt_y_l_sd_default_m17.h"
#include "pe_vflt_y_l_hd_i_default_m17.h"
#include "pe_vflt_y_l_hd_p_default_m17.h"
#include "pe_vflt_y_l_ud_else_default_m17.h"
#include "pe_vflt_y_l_ud_hdmi_420_default_m17.h"
#include "pe_vflt_y_l_hd_i_dtv_default_m17.h"
#include "pe_vflt_y_l_vr_360_default_m17.h"
#include "pe_vflt_y_l_sd_dtv_default_m17.h"
#ifdef	__cplusplus
extern "C"
{
#endif /* __cplusplus */
 ...
 */
 typedef struct {
	PE_M17_VFILTER_CTRL_00_T			vfilter_ctrl_00; 	//0xc8007180L
	PE_M17_VFILTER_CTRL_01_T			vfilter_ctrl_01; 	//0xc8007184L
	PE_M17_VFILTER_CTRL_02_T			vfilter_ctrl_02; 	//0xc8007188L
...
typedef struct {
	union {
		UINT32			*addr;
		PE_VFY_HW_PARAM_REG_M17_T *data;
	} reg_dflt;
