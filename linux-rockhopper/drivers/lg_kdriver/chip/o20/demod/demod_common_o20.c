...
/* global variables */
UINT8			gO20GBB_PowerOnInit = 1;

/***********************************************************************************
************************************************************************************/
/**
 * DEMOD_O20_GetContext.
...
#if 0
/* 190605, not used */
static void _DEMOD_O20_reset (void)
{
...
*/
int _DEMOD_O20_Get_Lock_FEC (LX_DEMOD_OPER_MODE_T operMode, UINT8 *lockStatus)
{
	*lockStatus = 0;
 ...
 * @author 	Jeongpil.yun (jeongpil.yun@lge.com)
*/
int _DEMOD_O20_Get_Lock_TR (LX_DEMOD_OPER_MODE_T operMode, UINT8 *lockStatus)
{
	*lockStatus = 0;
 ...
 * @author 	Jeongpil.yun (jeongpil.yun@lge.com)
*/
int _DEMOD_O20_Get_Lock_CARR (LX_DEMOD_OPER_MODE_T operMode, UINT8 *lockStatus)
{
	*lockStatus = 0;
 ...
 * @author 	Jeongpil.yun (jeongpil.yun@lge.com)
*/
int _DEMOD_O20_Get_Lock_PSYNC (LX_DEMOD_OPER_MODE_T operMode, UINT8 *lockStatus)
{
	*lockStatus = 0;
 ...
 * @author 	Jeongpil.yun (jeongpil.yun@lge.com)
*/
int _DEMOD_O20_Get_Lock_TPS (LX_DEMOD_OPER_MODE_T operMode, UINT8 *lockStatus)
{
	*lockStatus = 0;
 ...
 * @author 	Jeongpil.yun (jeongpil.yun@lge.com)
*/
int _DEMOD_O20_Get_Lock_AGC (LX_DEMOD_OPER_MODE_T operMode, UINT8 *lockStatus)
{
	*lockStatus = 0;
 ...
 * @author 	Jeongpil.yun (jeongpil.yun@lge.com)
*/
int _DEMOD_O20_Get_Lock_Mode_Det (LX_DEMOD_OPER_MODE_T operMode, UINT8 *lockStatus)
{
	*lockStatus = 0;
...
#if 0
	CTOP_CTRL_O20Ax_RdFL(CTOP_BMC, admd_mip6);
	CTOP_CTRL_O20Ax_Wr01(CTOP_BMC, admd_mip6, reg_admd_t_pdb, 0);
	CTOP_CTRL_O20Ax_WrFL(CTOP_BMC, admd_mip6);
#endif

#if 1
	CTOP_CTRL_O20Ax_RdFL(BMC_SYN, crg_bmc20);
	CTOP_CTRL_O20Ax_Wr01(BMC_SYN, crg_bmc20, reg_dbb_reset, 1);
	CTOP_CTRL_O20Ax_WrFL(BMC_SYN, crg_bmc20);

//	ACE_REG_O20A0_RdFL(dbb_00);
//	ACE_REG_O20A0_Wr01(dbb_00, dbb_reset, 1);
//	ACE_REG_O20A0_WrFL(dbb_00);

	usleep_range(1000,10000);	/* 1ms ~ 10ms */

	CTOP_CTRL_O20Ax_RdFL(BMC_SYN, crg_bmc20);
	CTOP_CTRL_O20Ax_Wr01(BMC_SYN, crg_bmc20, reg_dbb_reset, 0);
	CTOP_CTRL_O20Ax_WrFL(BMC_SYN, crg_bmc20);

//	ACE_REG_O20A0_RdFL(dbb_00);
//	ACE_REG_O20A0_Wr01(dbb_00, dbb_reset, 0);
//	ACE_REG_O20A0_WrFL(dbb_00);
...
//	ACE_REG_O20A0_WrFL(dbb_00);
...
#if 0  //need to be check~!!!!0417

	DEMOD_APB_REG_WR(0xC930E4a0, 0x00110000); // HW release
	usleep_range(1000,2000);	/* 1ms ~ 2ms */
	DEMOD_PRINT_ALWAYS("##### DEMOD_O20_ResetHW() HW reset release #####\n");

	DEMOD_APB_REG_WR(0xC9105000, 0x7E355555); // SYNC1 Reset to 0
	usleep_range(2000,3000);	/* 2ms ~ 3ms */
	DEMOD_PRINT_ALWAYS("##### DEMOD_O20_ResetHW() SYNC1 Reset to 0 Done #####\n");

	DEMOD_APB_REG_WR(0xC930E4a0, 0x00100000); // HW reset
	usleep_range(2000,3000);	/* 2ms ~ 3ms */
	DEMOD_PRINT_ALWAYS("##### DEMOD_O20_ResetHW() HW reset Done #####\n");
	...
	DEMOD_PRINT_ALWAYS("##### DEMOD_O20_ResetHW() Internal CLK Gating ON #####\n");

	DEMOD_APB_REG_WR(0xC9105000, 0xFE355555); // SYNC1 Reset to 1
	usleep_range(1000,2000);	/* 1ms ~ 2ms */

	DEMOD_PRINT_ALWAYS("##### DEMOD_O20_ResetHW() SYNC1 Reset to 1 #####\n");

	DEMOD_APB_REG_WR(0xC9105010, 0x2f40882d); // Internal CLK Gating OFF
	usleep_range(1000,2000);	/* 1ms ~ 2ms */

	DEMOD_PRINT_ALWAYS("##### DEMOD_O20_ResetHW() Internal CLK Gating OFF #####\n");
#endif

#if 1
#ifdef INCLUDE_O20_CHIP_KDRV // For debugging
/////////////////////////////////////////////////////

	CTOP_CTRL_O20Ax_RdFL(BMC_SYN, crg_bmc01);
	CTOP_CTRL_O20Ax_Rd01(BMC_SYN, crg_bmc01, swrst_f24m, swrst_f24m);
...
#if 0
	DEMOD_PRINT("[KDRV_DEMOD] DEMOD_O20_SetI2C Start !! \n");

	ACE_REG_O20A0_RdFL(dbb_00);

	ACE_REG_O20A0_Wr01(dbb_00, dbb_i2csel, 0);

	ACE_REG_O20A0_WrFL(dbb_00);

	DEMOD_PRINT("[KDRV_DEMOD] DEMOD_O20_SetI2C end !! \n");
...
int DEMOD_O20_SetInclk (LX_DEMOD_INCLK_SEL_T *inclk)
{
	...
	CTOP_CTRL_O20Ax_RdFL(CTOP_BMC, admd_mip7);

	switch(*inclk)
	{
		case LX_DEMOD_ARM_SETTING:
		{
			CTOP_CTRL_O20Ax_Wr01(CTOP_BMC, admd_mip7, reg_admd_dpll_insel, 0);
		}
		break;

		case LX_DEMOD_EXTERN_PIN:
		{
			CTOP_CTRL_O20Ax_Wr01(CTOP_BMC, admd_mip7, reg_admd_dpll_insel, 1);
		}
		break;
	...
	CTOP_CTRL_O20Ax_WrFL(CTOP_BMC, admd_mip7);
#endif
	DEMOD_PRINT("[DEMOD_CHIP] End \n");
...
int DEMOD_O20_AdcInit (void)
{
	...
	DEMOD_PRINT("[DEMOD_CHIP] Start \n");
#if 1
	CTOP_CTRL_O20Ax_RdFL(CTOP_BMC, admd_mip8);
	CTOP_CTRL_O20Ax_Wr01(CTOP_BMC, admd_mip8, reg_admd_dpll_pdb, 1);
	CTOP_CTRL_O20Ax_WrFL(CTOP_BMC, admd_mip8);
	...
	CTOP_CTRL_O20Ax_RdFL(CTOP_BMC, admd_mip8);
	CTOP_CTRL_O20Ax_Wr01(CTOP_BMC, admd_mip8, reg_admd_adc_refsel, 0);
	CTOP_CTRL_O20Ax_WrFL(CTOP_BMC, admd_mip8);
#endif
#endif
/////////////////////////////////////////////////////////////////////
	DEMOD_APB_REG_WR(0xC34E0818,0x149A10DE );
	usleep_range(1000,2000);	/* 1ms ~ 2ms */
	DEMOD_APB_REG_WR(0xC34E081C,0x354B011A );
	usleep_range(1000,2000);	/* 1ms ~ 2ms */
	DEMOD_APB_REG_WR(0xC34E0820,0x79EB0B32 );
	usleep_range(1000,2000);	/* 1ms ~ 2ms */
	DEMOD_APB_REG_WR(0xC34E0820,0x79EB0BB2 );
	usleep_range(1000,2000);	/* 1ms ~ 2ms */
/////////////////////////////////////////////////////////////////////
...
int DEMOD_O20_Power_Save (BOOLEAN bEnable)
{
	...
	DEMOD_DEBUG("DEMOD_O20_Power_Save Start \n");
	...
	if(bEnable == TRUE)
	{
		...
		CTOP_CTRL_O20Ax_RdFL(CTOP_BMC, admd_mip7);
		CTOP_CTRL_O20Ax_Wr01(CTOP_BMC, admd_mip7, reg_admd_bias_pdb, 0);
		CTOP_CTRL_O20Ax_WrFL(CTOP_BMC, admd_mip7);
...
//		usleep_range(1000,2000);	/* 1ms ~ 2ms */
		...
		CTOP_CTRL_O20Ax_RdFL(CTOP_BMC, admd_mip7);
		CTOP_CTRL_O20Ax_Wr01(CTOP_BMC, admd_mip7, reg_admd_bias_pdb, 1);
		CTOP_CTRL_O20Ax_WrFL(CTOP_BMC, admd_mip7);
	}

//	DEMOD_PRINT_ALWAYS("DEMOD_O20_Power_Save End \n");
...
/////////////////Add by B0 ////////////////
	UINT8	reg_use_cpu_gpio_8_1 = 1; //fefctrl : 1: TP(default) , 0: fefctrl
	UINT8	reg_use_cpu_gpio_5_0 = 1; //diseqc : 1: TP(default) , 0: diseqc
	
	UINT8	reg_use_cpu_gpio_12_4 = 1; //diseqc_cmd : 1: TP(default) , 0: diseqc_cmd
	UINT8	reg_use_cpu_gpio_12_0 = 1; //diseqci : 1: TP(default) , 0: diseqci
//////////////////////////////////////////
	...
	switch(operMode)
	{
		...
		case LX_DEMOD_DVBS2:
			...
			if ( lx_chip_rev() >= LX_CHIP_REV(O20,B0) ) //B0
			{ 
				reg_use_cpu_gpio_5_0 = 0x0;
				reg_use_cpu_gpio_12_4 = 0x0;
				reg_use_cpu_gpio_12_0 = 0x0;
			}
			register_set_flag = TRUE;
	...
	if (register_set_flag)
	{
...
#if 0
		CTOP_CTRL_O20Ax_RdFL(CTOP_BMC, admd_mip8);
		CTOP_CTRL_O20Ax_Wr01(CTOP_BMC, admd_mip8, reg_admd_dpll_odpost, reg_admd_dpll_odpost);
		CTOP_CTRL_O20Ax_WrFL(CTOP_BMC, admd_mip8);

		CTOP_CTRL_O20Ax_RdFL(CTOP_BMC, admd_mip8);
		CTOP_CTRL_O20Ax_Wr02(CTOP_BMC, admd_mip8, reg_admd_dpll_divint,reg_admd_dpll_divint,reg_admd_dpll_icp,reg_admd_dpll_icp);
		CTOP_CTRL_O20Ax_WrFL(CTOP_BMC, admd_mip8);


		CTOP_CTRL_O20Ax_RdFL(CTOP_BMC, admd_mip6);
		CTOP_CTRL_O20Ax_Wr01(CTOP_BMC, admd_mip6, reg_admd_dpll_odpre, reg_admd_dpll_odpre);
		CTOP_CTRL_O20Ax_WrFL(CTOP_BMC, admd_mip6);


		CTOP_CTRL_O20Ax_RdFL(CTOP_BMC, admd_mip7);
		CTOP_CTRL_O20Ax_Wr01(CTOP_BMC, admd_mip7, reg_admd_dpll_cken, reg_admd_dpll_cken);
		CTOP_CTRL_O20Ax_WrFL(CTOP_BMC, admd_mip7);


		CTOP_CTRL_O20Ax_RdFL(CTOP_BMC, admd_mip8);
		CTOP_CTRL_O20Ax_Wr02(CTOP_BMC, admd_mip8, reg_admd_apll_m, reg_admd_apll_m, reg_admd_adc_refsel, reg_admd_adc_refsel);
		CTOP_CTRL_O20Ax_WrFL(CTOP_BMC, admd_mip8);

		CTOP_CTRL_O20Ax_RdFL(CTOP_BMC, admd_mip6);
		CTOP_CTRL_O20Ax_Wr02(CTOP_BMC, admd_mip6, reg_admd_q_pdb, reg_admd_q_pdb, reg_admd_t_pdb, reg_admd_t_pdb);
		CTOP_CTRL_O20Ax_WrFL(CTOP_BMC, admd_mip6);


		CTOP_CTRL_O20Ax_RdFL(CTOP_BMC, admd_mip5);
		CTOP_CTRL_O20Ax_Wr01(CTOP_BMC, admd_mip5, reg_admd_i_pdb, reg_admd_i_pdb);
		CTOP_CTRL_O20Ax_WrFL(CTOP_BMC, admd_mip5);
#else
		CTOP_CTRL_O20Ax_RdFL(CTOP_BMC, admd_mip5);
		CTOP_CTRL_O20Ax_Wr01(CTOP_BMC, admd_mip5, reg_admd_i_pdb, reg_admd_i_pdb);
		CTOP_CTRL_O20Ax_WrFL(CTOP_BMC, admd_mip5);
		...
		{ 
			...
			DEMOD_PRINT_ALWAYS("[DEMOD_CHIP] Rev.B0 register setting \n");
			CTOP_CTRL_O20Ax_RdFL(CTOP_FMS, gpio12_sel);
			CTOP_CTRL_O20Ax_Wr02(CTOP_FMS, gpio12_sel, reg_use_cpu_gpio_12_4, reg_use_cpu_gpio_12_4,reg_use_cpu_gpio_12_0,reg_use_cpu_gpio_12_0);
			CTOP_CTRL_O20Ax_WrFL(CTOP_FMS, gpio12_sel);

			CTOP_CTRL_O20Ax_RdFL(CTOP_FMS, gpio5_sel);
			CTOP_CTRL_O20Ax_Wr01(CTOP_FMS, gpio5_sel, reg_use_cpu_gpio_5_0,reg_use_cpu_gpio_5_0);
			CTOP_CTRL_O20Ax_WrFL(CTOP_FMS, gpio5_sel);

			CTOP_CTRL_O20Ax_RdFL(CTOP_FMS, gpio8_sel);
			CTOP_CTRL_O20Ax_Wr01(CTOP_FMS, gpio8_sel, reg_use_cpu_gpio_8_1,reg_use_cpu_gpio_8_1);
			CTOP_CTRL_O20Ax_WrFL(CTOP_FMS, gpio8_sel);
		}
		else
		{
			DEMOD_PRINT_ALWAYS("[DEMOD_CHIP] Rev.A0 register setting  \n");
		}
...
int DEMOD_O20_NeverlockScan (DEMOD_CTX_T *pDemodInfo, LX_DEMOD_FLAG_T ResetOn, LX_DEMOD_FLAG_T *pScanProcessing, LX_DEMOD_LOCK_STATE_T *pScanLock)
{
	...
	if (RET_OK != DEMOD_O20_Get_NeverLockStatus(scanMode, &neverLockStatus))
	{
 ...
 * @author 	Jeongpil.yun (jeongpil.yun@lge.com)
*/
int DEMOD_O20_Get_Id (UINT8 *pCellIDLength, UINT16 *pId)
{
	LX_DEMOD_L2_Context *	pFrontend;
...
************************************************************************************/
/**
 * DEMOD_O20_Get_SpectrumInvStatus
...
************************************************************************************/
/**
 * DEMOD_O20_Get_CarrierFreqOffset
...
/*
	if(RET_OK != DEMOD_O20_Get_OperMode(&mode))
	{
		DEMOD_PRINT("[DEMOD] FAIL (%s:%d) DEMOD_O20_Get_OperMode() !!!\n", __F__, __L__);
		return RET_ERROR;
	}
*/
	if (DEMOD_L2_SignalStatus(pFrontend, &signalStatus))
...
int DEMOD_O20_ANALOG_ResetHW (void)
{
	...
	ACE_REG_O20A0_RdFL(abb_00);
	ACE_REG_O20A0_Wr01(abb_00, abb_reset, 1);
	ACE_REG_O20A0_WrFL(abb_00);

	usleep_range(1000,10000);	/* 1ms ~ 10ms */


	ACE_REG_O20A0_Wr01(abb_00, abb_reset, 0);
	ACE_REG_O20A0_WrFL(abb_00);
	...
	ACE_REG_O20A0_RdFL(soft_reset_00);
	ACE_REG_O20A0_Rd01(soft_reset_00, swrst_f24m_bb, swrst_f24m_bb);
...
int DEMOD_O20_ANALOG_SetI2C (void)
{
	...
	ACE_REG_O20A0_RdFL(abb_01);

	ACE_REG_O20A0_Wr01(abb_01, abb_i2csel, 0);

	ACE_REG_O20A0_WrFL(abb_01);
...
{
#if 0
	DEMOD_PRINT("[KDRV_DEMOD] DEMOD_O20_ANALOG_Set_AbbMode Start !! \n");


	if(TRUE == bIsAbbMode)
	{
		ACE_REG_O20A0_RdFL(bbdemod_control_00);
		ACE_REG_O20A0_Wr01(bbdemod_control_00, bbdemod_control, 0);  // 0: ABB, 1 : DBB
		ACE_REG_O20A0_WrFL(bbdemod_control_00);

		ACE_REG_O20A0_RdFL(abb_02);
		ACE_REG_O20A0_Wr01(abb_02, ifagc_sel, 0);  // 0: ABB, 1 : DBB
		ACE_REG_O20A0_WrFL(abb_02);
	}
	else
	{
		ACE_REG_O20A0_RdFL(bbdemod_control_00);
		ACE_REG_O20A0_Wr01(bbdemod_control_00, bbdemod_control, 1);  // 0: ABB, 1 : DBB
		ACE_REG_O20A0_WrFL(bbdemod_control_00);


		ACE_REG_O20A0_RdFL(abb_02);
		ACE_REG_O20A0_Wr01(abb_02, ifagc_sel, 1);  // 0: ABB, 1 : DBB
		ACE_REG_O20A0_WrFL(abb_02);
	}

	DEMOD_PRINT("[KDRV_DEMOD] DEMOD_O20_ANALOG_Set_AbbMode End !! \n");
#endif
...
int DEMOD_O20_OperModeReset(LX_DEMOD_OPER_MODE_T operMode)
{
	...
	CTOP_CTRL_O20Ax_RdFL(CTOP_BMC, admd_mip6);
	CTOP_CTRL_O20Ax_Wr01(CTOP_BMC, admd_mip6, reg_admd_t_pdb, reg_admd_t_pdb);
	CTOP_CTRL_O20Ax_WrFL(CTOP_BMC, admd_mip6);
...
************************************************************************************/
/**
 * DEMOD_O20_Get_Signal_Information
 * Get BER before RS on DVB
 *
 * @param *pVber 	[OUT] UINT32.
 * @return if Succeeded - RET_OK else-RET_ERROR
