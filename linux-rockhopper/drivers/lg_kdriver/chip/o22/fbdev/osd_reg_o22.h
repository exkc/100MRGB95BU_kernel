#ifndef __OSD_REG_O22_H__
#define __OSD_REG_O22_H__
...
/////////////////////////////////////////////////////////////////////////////////////////////////
	...
	/*-----------------------------------------------------------------------------
		0x008c ctrl_sosd_mixer_miracast_ctrl ''
	------------------------------------------------------------------------------*/
	typedef struct {
		UINT32
	...
	typedef struct {
		...
		reg_osd_shp_detour_en           : 1,	//    28
										: 1,	//    29 reserved
		reg_rgb2yc_csc_p_en_oclk        : 1,	//    30					== on/off
		reg_rgb2yc_csc_en_de_clk        : 1;	//    31					== on/off
	} OSD0_BITMAP_CTRL0;
#else
	typedef struct {
		UINT32
...
// http://clm.lge.com/issue/browse/SICDTV-9405?focusedCommentId=3009113&page=com.atlassian.jira.plugin.system.issuetabpanels:comment-tabpanel#comment-3009113
// jihoon82.lee
// OSD_IMAGE1은 e-stream layer용 register인데, 이번에 e-stream layer 삭제로 인해 OSD_IMAGE1은 사용 안하니, 무시하시면 될 것 같습니다.
...
typedef struct
{
		...
		CTRL_SOSD_MIXER_MIRACAST_CTRL   	ctrl_sosd_mixer_miracast_ctrl   ;	// 0x008c : '' O22 new register
...
#if 1
	CTRL_BOSD1_MIXER_MIRACAST_CTRL  	ctrl_bosd_mixer_miracast_ctrl  ;	// 0x018c : '' O22 new register, BOSD1 only (O22)
	UINT32                          	                 __rsvd_03[   3];
#else
...
#if 1
	CTRL_BOSD1_MIXER_OBJ_ALPHA      	ctrl_bosd_mixer_obj_alpha      ;	// 0x01e4 : '' O22 new register, BOSD1 only (O22)
	UINT32                          	                 __rsvd_04[   6];
...
typedef struct
{
	...
	// offset 0x500 - (2) OSD1 (removed)
	// offset 0x600 - (3) CURSOR
	OSDX_CTRL									osdx_ctrl[4];

#define OSDX_O22_Off(_g,_r)             ((UINT32)&(g_osd_o22_reg_shadow->_g._r) - (UINT32)(g_osd_o22_reg_shadow))

#define OSDX_O22_RdFL(_g,_r)            ((g_osd_o22_reg_shadow->_g._r)=(g_osd_o22_reg->_g._r))
#define OSDX_O22_WrFL(_g,_r)            ((g_osd_o22_reg->_g._r)=(g_osd_o22_reg_shadow->_g._r))

#define OSDX_O22_Rd(_g,_r)              *((UINT32*)(&(g_osd_o22_reg_shadow->_g._r)))
#define OSDX_O22_Wr(_g,_r,_v)           ((OSDX_O22_Rd(_g,_r))=((UINT32)(_v)))

#define OSDX_O22_Rd00(_g,_r,_f)         (g_osd_o22_reg_shadow->_g._r._f)
#define OSDX_O22_Rd01(_g,_r,_f01,_v01)  do {                                                \
                                            (_v01) = (g_osd_o22_reg_shadow->_g._r._f01);    \
                                        } while(0)
#define OSDX_O22_Wr01(_g,_r,_f01,_v01)  do {                                                \
                                            (g_osd_o22_reg_shadow->_g._r._f01) = (_v01);    \
                                        } while(0)
#define OSDX_O22_Wr02(_g,_r,_f01,_v01,_f02,_v02)    do {                                    \
                                            (g_osd_o22_reg_shadow->_g._r._f01) = (_v01);    \
                                            (g_osd_o22_reg_shadow->_g._r._f02) = (_v02);    \
                                        } while(0)
...
#define OSD_O22_RdFL(_r)			((g_osd_o22_reg_shadow->_r)=(g_osd_o22_reg->_r))
#define OSD_O22_WrFL(_r)			((g_osd_o22_reg->_r)=(g_osd_o22_reg_shadow->_r))

#define OSD_O22_Rd(_r)				*((UINT32*)(&(g_osd_o22_reg_shadow->_r)))
#define OSD_O22_Wr(_r,_v)			((OSD_O22_Rd(_r))=((UINT32)(_v)))

#define OSD_O22_Rd00(_r,_f)         (g_osd_o22_reg_shadow->_r._f)


#define OSD_O22_Rd01(_r,_f01,_v01)													\
								do { 											\
									(_v01) = (g_osd_o22_reg_shadow->_r._f01);				\
								} while(0)

#define OSD_O22_Rd02(_r,_f01,_v01,_f02,_v02)										\
								do { 											\
									(_v01) = (g_osd_o22_reg_shadow->_r._f01);				\
									(_v02) = (g_osd_o22_reg_shadow->_r._f02);				\
								} while(0)

#define OSD_O22_Rd03(_r,_f01,_v01,_f02,_v02,_f03,_v03)								\
								do { 											\
									(_v01) = (g_osd_o22_reg_shadow->_r._f01);				\
									(_v02) = (g_osd_o22_reg_shadow->_r._f02);				\
									(_v03) = (g_osd_o22_reg_shadow->_r._f03);				\
								} while(0)

#define OSD_O22_Rd04(_r,_f01,_v01,_f02,_v02,_f03,_v03,_f04,_v04)					\
								do { 											\
									(_v01) = (g_osd_o22_reg_shadow->_r._f01);				\
									(_v02) = (g_osd_o22_reg_shadow->_r._f02);				\
									(_v03) = (g_osd_o22_reg_shadow->_r._f03);				\
									(_v04) = (g_osd_o22_reg_shadow->_r._f04);				\
								} while(0)

#define OSD_O22_Wr01(_r,_f01,_v01)													\
								do { 											\
									(g_osd_o22_reg_shadow->_r._f01) = (_v01);				\
								} while(0)

#define OSD_O22_Wr02(_r,_f01,_v01,_f02,_v02)										\
								do { 											\
									(g_osd_o22_reg_shadow->_r._f01) = (_v01);				\
									(g_osd_o22_reg_shadow->_r._f02) = (_v02);				\
								} while(0)

#define OSD_O22_Wr03(_r,_f01,_v01,_f02,_v02,_f03,_v03)								\
								do { 											\
									(g_osd_o22_reg_shadow->_r._f01) = (_v01);				\
									(g_osd_o22_reg_shadow->_r._f02) = (_v02);				\
									(g_osd_o22_reg_shadow->_r._f03) = (_v03);				\
								} while(0)

#define OSD_O22_Wr04(_r,_f01,_v01,_f02,_v02,_f03,_v03,_f04,_v04)					\
								do { 											\
									(g_osd_o22_reg_shadow->_r._f01) = (_v01);				\
									(g_osd_o22_reg_shadow->_r._f02) = (_v02);				\
									(g_osd_o22_reg_shadow->_r._f03) = (_v03);				\
									(g_osd_o22_reg_shadow->_r._f04) = (_v04);				\
								} while(0)

extern volatile OSD_O22_REG_T*	g_osd_o22_reg;
extern OSD_O22_REG_T*			g_osd_o22_reg_shadow;
