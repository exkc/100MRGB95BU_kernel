#ifndef _SCRG_CTRL_EPHY_REG_O24A0_H_
#define _SCRG_CTRL_EPHY_REG_O24A0_H_
...
/*-----------------------------------------------------------------------------------------
    0xC885_0000    crg_ephy0 ''
-----------------------------------------------------------------------------------------*/
typedef struct {
    UINT32
    test_reserved             : 32;    //  31: 0
}SCRG_CTRL_EPHY_CRG_EPHY0_O24A0_T;

/*-----------------------------------------------------------------------------------------
    0xC885_0004    crg_ephy1 ''
-----------------------------------------------------------------------------------------*/
typedef struct {
    UINT32
    test_reserved_ro          : 32;    //  31: 0
}SCRG_CTRL_EPHY_CRG_EPHY1_O24A0_T;

/*-----------------------------------------------------------------------------------------
    0xC885_0008    crg_ephy2 ''
-----------------------------------------------------------------------------------------*/
typedef struct {
    UINT32
    ...
    reg_gmac_tx_clk_gate_en   :  1,    //      4
                              : 27;    //   31:5 reserved
}SCRG_CTRL_EPHY_CRG_EPHY2_O24A0_T;

/*-----------------------------------------------------------------------------------------
    0xC885_000C    crg_ephy3 ''
-----------------------------------------------------------------------------------------*/
typedef struct {
    UINT32
    ...
    reg_soft_rst_x_ephy_0_axi_n: 1,    //      7
                              : 24;    //   31:8 reserved
}SCRG_CTRL_EPHY_CRG_EPHY3_O24A0_T;

/*-----------------------------------------------------------------------------------------
    scrg_ctrl_ephy Register LIst
-----------------------------------------------------------------------------------------*/
typedef struct {
    SCRG_CTRL_EPHY_CRG_EPHY0_O24A0_T    crg_ephy0 ;             // 0xC885_0000
    SCRG_CTRL_EPHY_CRG_EPHY1_O24A0_T    crg_ephy1 ;             // 0xC885_0004
    SCRG_CTRL_EPHY_CRG_EPHY2_O24A0_T    crg_ephy2 ;             // 0xC885_0008
    SCRG_CTRL_EPHY_CRG_EPHY3_O24A0_T    crg_ephy3 ;             // 0xC885_000C
}SCRG_CTRL_EPHY_REG_O24A0_T;
/* 4 regs */
...
#define SCRG_CTRL_EPHY_CRG_EPHY0_O24A0_T_OFF                (BASEADDRESS+0x0000)
#define SCRG_CTRL_EPHY_CRG_EPHY1_O24A0_T_OFF                (BASEADDRESS+0x0004)
#define SCRG_CTRL_EPHY_CRG_EPHY2_O24A0_T_OFF                (BASEADDRESS+0x0008)
#define SCRG_CTRL_EPHY_CRG_EPHY3_O24A0_T_OFF                (BASEADDRESS+0x000C)
