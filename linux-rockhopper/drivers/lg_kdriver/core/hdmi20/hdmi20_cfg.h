...
/*----------------------------------------------------------------------------------------
	Extern Variables
----------------------------------------------------------------------------------------*/
extern HDMI_FEC_MEM_CFG_T *gpHdmiFecMem;
extern HDMI_FEC_MEM_CFG_T gMemCfgHdmiFec[];
extern LX_MEMCFG_T *gpEsmCodeMem;
extern LX_MEMCFG_T *gpEsmDataMem;
extern LX_MEMCFG_T gMemCfgEsm[];
