...
#ifndef  _IPC_DEF_M17_H_
#define  _IPC_DEF_M17_H_

/*----------------------------------------------------------------------------------------
 *   Control Constants
 *---------------------------------------------------------------------------------------*/
#define BE_IPC_FROM_CPU_M17A0_BASE
#define BE_IPC_FROM_MCU_M17A0_BASE
...
typedef struct
{
	...
	UINT32 	uMovTimeSec;
	UINT32 	uMovRange;		// [Justscan mov range] << 16 | [Overscan mov range]
} BE_IPC_ORBIT_T;
