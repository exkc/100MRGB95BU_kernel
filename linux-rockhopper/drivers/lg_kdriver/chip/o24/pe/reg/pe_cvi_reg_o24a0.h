#ifndef _PE_CVI_REG_O24A0_H_
#define _PE_CVI_REG_O24A0_H_
#ifndef UINT32
...
typedef union {
	UINT32 udata32;
	struct {						//0xCCCC0200 RW 0x0008_0024
...
typedef union {
	UINT32 udata32;
	struct {						//0xCCCC020C RW 0x0010_003E
...
}PE_O24_INT_SYNC_CTRL0_T;

typedef union {
	UINT32 udata32;
	struct {						//0xCCCC0210 RW 0x0001_0700
...
}PE_O24_INT_SYNC_CTRL1_T;

typedef union {
	UINT32 udata32;
	struct {						//0xCCCC0214 RW 0x0100_0000
...
}PE_O24_CV_MASK_CTRL_T;

typedef union {
	UINT32 udata32;
	struct {						//0xCCCC0218 RW 0x0000_0000
	...
	UINT32 reserved3                        :1;	//(31:0,RW,0x0000_0000) //
	UINT32 hd_line_size_sel                 :1;	//(24,RW,0x00) //0x0 = normal, 0x1 = average  (hd_line_size)
	UINT32 reserved4                        :7;	//(31:0,RW,0x0000_0000) //
	};
}PE_O24_CV_420_INCTRL_T;

typedef union {
	UINT32 udata32;
	struct {						//0xCCCC021C RO 0x0000_0000
	UINT32 dolby_md_info                    :32;	//(31:0,RO,0x00) //
	};
}PE_O24_CV_HDMI_MD_INFO_T;

typedef union {
	UINT32 udata32;
	struct {						//0xCCCC0220 RO 0x0000_0000
	UINT32 tot_vsize                        :32;	//(31:0,RO,0x00) //avg_sel = 0 tot_vsize [27:0] h_avg = tot_vsize / vd_line_count_curr	avg_sel = 1 min[15:0], max[15:0]
	};
}PE_O24_HD_LINE_INFO_T;

typedef union {
	UINT32 udata32;
	struct {						//0xCCCC0224 RW 0x09D3_00FE
...
typedef union {
	UINT32 udata32;
	struct {						//0xCCCC0228 RW 0x02EE_7A98
...
typedef union {
	UINT32 udata32;
	struct {						//0xCCCC022C RW 0x0706_7E62
...
typedef union {
	UINT32 udata32;
	struct {						//0xCCCC0230 RW 0x799E_7F5C
...
typedef union {
	UINT32 udata32;
	struct {						//0xCCCC0234 RW 0x0706_0000
...
typedef union {
	UINT32 udata32;
	struct {						//0xCCCC0238 RW 0x0000_0000
...
typedef union {
	UINT32 udata32;
	struct {						//0xCCCC023C RW 0x0040_0200
...
typedef union {
	UINT32 udata32;
	struct {						//0xCCCC0240 RW 0x0200_0200
...
typedef union {
	UINT32 udata32;
	struct {						//0xCCCC0244 RW 0x0000_0000
...
typedef union {
	UINT32 udata32;
	struct {						//0xCCCC0248 RO 0x0000_0000
...
}PE_O24_OFFSET_READ_T;

typedef union {
	UINT32 udata32;
	struct {						//0xCCCC024C RW 0x0000_0000
	...
	UINT32 reserved1                        :1;	//(31:0,RW,0x0000_0000) //
...
typedef union {
	UINT32 udata32;
	struct {						//0xCCCC0250 RW 0x021C_0000
...
}PE_O24_PRE3D_CTRL0_T;

typedef union {
	UINT32 udata32;
	struct {						//0xCCCC0254 RO 0x0000_0000
...
}PE_O24_SIZE_STATUS7_T;

typedef union {
	UINT32 udata32;
	struct {						//0xCCCC0258 RO 0x0000_0000
...
}PE_O24_SIZE_STATUS1_T;

typedef union {
	UINT32 udata32;
	struct {						//0xCCCC025C RO 0x0000_0000
...
}PE_O24_SIZE_STATUS2_T;

typedef union {
	UINT32 udata32;
	struct {						//0xCCCC0260 RO 0x0000_0000
...
}PE_O24_SIZE_STATUS3_T;

typedef union {
	UINT32 udata32;
	struct {						//0xCCCC0264 RO 0x0000_0000
...
}PE_O24_SIZE_STATUS4_T;

typedef union {
	UINT32 udata32;
	struct {						//0xCCCC0268 RW 0x0200_0100
...
}PE_O24_SYNC_FIL_CTRL_T;

typedef union {
	UINT32 udata32;
	struct {						//0xCCCC02A8 RO 0x0000_0000
...
}PE_O24_SYNC_FIL_STATUS_T;

typedef union {
	UINT32 udata32;
	struct {						//0xCCCC02AC NA 0x0203_0020
...
}PE_O24_H_DOWN_CTRL0_T;

typedef union {
	UINT32 udata32;
	struct {						//0xCCCC02B0 NA 0x0203_0020
...
}PE_O24_H_DOWN_CTRL1_T;

typedef union {
	UINT32 udata32;
	struct {						//0xCCCC02B4 NA 0x0000_0000
	UINT32 reserved                         :32;	//(31:0,Rsvd,0x00) //
	};
}PE_O24_V_DOWN_CTRL0_T;

typedef union {
	UINT32 udata32;
	struct {						//0xCCCC02B8 NA 0x0000_0000
	UINT32 reserved                         :31;	//(30:0,Rsvd,0x00) //
	UINT32 i_down_420                       :1;	//(31,RW,0x00) //0 : 444 down mode	1 : 420 down mode
	};
}PE_O24_V_DOWN_CTRL1_T;

typedef union {
	UINT32 udata32;
	struct {						//0xCCCC02BC NA 0x0000_0000
	UINT32 hdn_y_coef4                      :10;	//(9:0,RW,0x00) //
	UINT32 resvd0                           :6;
	UINT32 hdn_y_coef0                      :10;	//(25:16,RW,0x00) //
	UINT32 resvd1                           :6;
	};
}PE_O24_H_DOWN_CTRL2_T;

typedef union {
	UINT32 udata32;
	struct {						//0xCCCC02C0 RW 0xC012_8006
...
}PE_O24_SIZE_DETECT_CTRL_T;

typedef union {
	UINT32 udata32;
	struct {						//0xCCCC02C4 RO 0x0000_0000
...
}PE_O24_SIZE_DETECT_READ_T;

typedef union {
	UINT32 udata32;
	struct {						//0xCCCC02C8 RO 0x0000_0000
...
}PE_O24_SIZE_STATUS0_T;

typedef union {
	UINT32 udata32;
	struct {						//0xCCCC02CC RO 0x0000_0000
...
}PE_O24_SIZE_STATUS5_T;

typedef union {
	UINT32 udata32;
	struct {						//0xCCCC02D0 RO 0x0000_0000
...
}PE_O24_SIZE_STATUS6_T;

typedef union {
	UINT32 udata32;
	struct {						//0xCCCC02D4 RW/RO 0x0000_0000
...
}PE_O24_SIZE_DETECT_CTRL1_T;

typedef union {
	UINT32 udata32;
	struct {						//0xCCCC02D8 RW 0x0301_0905
...
}PE_O24_SIZE_DETECT_CTRL2_T;

typedef union {
	UINT32 udata32;
	struct {						//0xCCCC02DC RW 0x0000_0000
	UINT32 resvd0                           :3;
...
typedef union {
	UINT32 udata32;
	struct {						//0xCCCC02E0 RW 0x0210_02C0
...
}PE_O24_PSEUDO_SYNC_CTRL1_T;

typedef union {
	UINT32 udata32;
	struct {						//0xCCCC02E4 RW 0x2260_118F
...
}PE_O24_PSEUDO_SYNC_CTRL2_T;

typedef union {
	UINT32 udata32;
	struct {						//0xCCCC02E8 RW 0x001C_0028
...
}PE_O24_PSEUDO_SYNC_CTRL3_T;

typedef union {
	UINT32 udata32;
	struct {						//0xCCCC02EC RW 0x1194_02D8
...
}PE_O24_PSEUDO_SYNC_CTRL4_T;

typedef union {
	UINT32 udata32;
	struct {						//0xCCCC02F0 RW 0x000A_4000
...
}PE_O24_SIZE_DETECT_CTRL3_T;

typedef union {
	UINT32 udata32;
	struct {						//0xCCCC02F4 NA 0x0000_0000
...
}PE_O24_H_DOWN_CTRL3_T;

typedef union {
	UINT32 udata32;
	struct {						//0xCCCC02F8 RW 0x0016_0017
...
}PE_O24_PRE3D_CTRL1_T;

typedef union {
	UINT32 udata32;
	struct {						//0xCCCC02FC RW 0x0005_0002
...
}PE_O24_PRE3D_CTRL2_T;

typedef struct {
	PE_O24_TOP_CTRL_T                                       top_ctrl;	//0xCCCC0200
	PE_O24_OFFSET_CTRL_T                                 offset_ctrl;	//0xCCCC0204
	PE_O24_SIZE_CTRL_T                                     size_ctrl;	//0xCCCC0208
	PE_O24_INT_SYNC_CTRL0_T                           int_sync_ctrl0;	//0xCCCC020C
	PE_O24_INT_SYNC_CTRL1_T                           int_sync_ctrl1;	//0xCCCC0210
	PE_O24_CV_MASK_CTRL_T                               cv_mask_ctrl;	//0xCCCC0214
	PE_O24_CV_420_INCTRL_T                             cv_420_inctrl;	//0xCCCC0218
	PE_O24_CV_HDMI_MD_INFO_T                         cv_hdmi_md_info;	//0xCCCC021C
	PE_O24_HD_LINE_INFO_T                               hd_line_info;	//0xCCCC0220
	PE_O24_CSC_CTRL0_T                                     csc_ctrl0;	//0xCCCC0224
	PE_O24_CSC_CTRL1_T                                     csc_ctrl1;	//0xCCCC0228
	PE_O24_CSC_CTRL2_T                                     csc_ctrl2;	//0xCCCC022C
	PE_O24_CSC_CTRL3_T                                     csc_ctrl3;	//0xCCCC0230
	PE_O24_CSC_CTRL4_T                                     csc_ctrl4;	//0xCCCC0234
	PE_O24_CSC_CTRL5_T                                     csc_ctrl5;	//0xCCCC0238
	PE_O24_CSC_CTRL6_T                                     csc_ctrl6;	//0xCCCC023C
	PE_O24_CSC_CTRL7_T                                     csc_ctrl7;	//0xCCCC0240
	PE_O24_MISC_CTRL_T                                     misc_ctrl;	//0xCCCC0244
	PE_O24_OFFSET_READ_T                                 offset_read;	//0xCCCC0248
	PE_O24_MISC_CTRL1_T                                   misc_ctrl1;	//0xCCCC024C
	PE_O24_PRE3D_CTRL0_T                                 pre3d_ctrl0;	//0xCCCC0250
	PE_O24_SIZE_STATUS7_T                               size_status7;	//0xCCCC0254
	PE_O24_SIZE_STATUS1_T                               size_status1;	//0xCCCC0258
	PE_O24_SIZE_STATUS2_T                               size_status2;	//0xCCCC025C
	PE_O24_SIZE_STATUS3_T                               size_status3;	//0xCCCC0260
	PE_O24_SIZE_STATUS4_T                               size_status4;	//0xCCCC0264
	PE_O24_PIX_SUM_CTRL0_T                             pix_sum_ctrl0;	//0xCCCC0268
	PE_O24_PIX_SUM_CTRL1_T                             pix_sum_ctrl1;	//0xCCCC026C
	PE_O24_PIX_SUM_CTRL2_T                             pix_sum_ctrl2;	//0xCCCC0270
	PE_O24_PIX_SUM_STATUS0_T                         pix_sum_status0;	//0xCCCC0274
	PE_O24_PIX_SUM_STATUS1_T                         pix_sum_status1;	//0xCCCC0278
	PE_O24_PIX_SUM_STATUS2_T                         pix_sum_status2;	//0xCCCC027C
	PE_O24_PIX_SUM_STATUS3_T                         pix_sum_status3;	//0xCCCC0280
	PE_O24_PIX_SUM_STATUS4_T                         pix_sum_status4;	//0xCCCC0284
	PE_O24_PIX_SUM_STATUS5_T                         pix_sum_status5;	//0xCCCC0288
	PE_O24_PIX_SUM_STATUS6_T                         pix_sum_status6;	//0xCCCC028C
	PE_O24_PIX_SUM_STATUS7_T                         pix_sum_status7;	//0xCCCC0290
	PE_O24_PIX_SUM_STATUS8_T                         pix_sum_status8;	//0xCCCC0294
	PE_O24_PIX_SUM_STATUS9_T                         pix_sum_status9;	//0xCCCC0298
	PE_O24_PIX_SUM_STATUSA_T                         pix_sum_statusa;	//0xCCCC029C
	PE_O24_PIX_SUM_STATUSB_T                         pix_sum_statusb;	//0xCCCC02A0
	PE_O24_SYNC_FIL_CTRL_T                             sync_fil_ctrl;	//0xCCCC02A4
	PE_O24_SYNC_FIL_STATUS_T                         sync_fil_status;	//0xCCCC02A8
	PE_O24_H_DOWN_CTRL0_T                               h_down_ctrl0;	//0xCCCC02AC
	PE_O24_H_DOWN_CTRL1_T                               h_down_ctrl1;	//0xCCCC02B0
	PE_O24_V_DOWN_CTRL0_T                               v_down_ctrl0;	//0xCCCC02B4
	PE_O24_V_DOWN_CTRL1_T                               v_down_ctrl1;	//0xCCCC02B8
	PE_O24_H_DOWN_CTRL2_T                               h_down_ctrl2;	//0xCCCC02BC
	PE_O24_SIZE_DETECT_CTRL_T                       size_detect_ctrl;	//0xCCCC02C0
	PE_O24_SIZE_DETECT_READ_T                       size_detect_read;	//0xCCCC02C4
	PE_O24_SIZE_STATUS0_T                               size_status0;	//0xCCCC02C8
	PE_O24_SIZE_STATUS5_T                               size_status5;	//0xCCCC02CC
	PE_O24_SIZE_STATUS6_T                               size_status6;	//0xCCCC02D0
	PE_O24_SIZE_DETECT_CTRL1_T                     size_detect_ctrl1;	//0xCCCC02D4
	PE_O24_SIZE_DETECT_CTRL2_T                     size_detect_ctrl2;	//0xCCCC02D8
	PE_O24_CV_OUT_MUX_T                                   cv_out_mux;	//0xCCCC02DC
	PE_O24_PSEUDO_SYNC_CTRL1_T                     pseudo_sync_ctrl1;	//0xCCCC02E0
	PE_O24_PSEUDO_SYNC_CTRL2_T                     pseudo_sync_ctrl2;	//0xCCCC02E4
	PE_O24_PSEUDO_SYNC_CTRL3_T                     pseudo_sync_ctrl3;	//0xCCCC02E8
	PE_O24_PSEUDO_SYNC_CTRL4_T                     pseudo_sync_ctrl4;	//0xCCCC02EC
	PE_O24_SIZE_DETECT_CTRL3_T                     size_detect_ctrl3;	//0xCCCC02F0
	PE_O24_H_DOWN_CTRL3_T                               h_down_ctrl3;	//0xCCCC02F4
	PE_O24_PRE3D_CTRL1_T                                 pre3d_ctrl1;	//0xCCCC02F8
	PE_O24_PRE3D_CTRL2_T                                 pre3d_ctrl2;	//0xCCCC02FC
}PE_CVI_REG_O24_T;
#endif