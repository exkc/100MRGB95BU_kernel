...
#ifndef	_PE_WIN_HW_O24_H_
#define	_PE_WIN_HW_O24_H_
...
typedef struct
{
	...
	UINT32 act2_x0;		///< pe DC window2, x0 position
	UINT32 act2_y0;		///< pe DC window2, y0 position
	UINT32 act2_x1;		///< pe DC window2, x1 position
	UINT32 act2_y1;		///< pe DC window2, y1 position
	UINT32 act3_x0;		///< pe DC window3, x0 position
	UINT32 act3_y0;		///< pe DC window3, y0 position
	UINT32 act3_x1;		///< pe DC window3, x1 position
	UINT32 act3_y1;		///< pe DC window3, y1 position
	UINT32 dc_win_en;	///< pe DC window enable PE1_DCE_CTRL_00.window_enable
	UINT32 win_pri[2];	///< pe window priority
}
PE_WIN_HW_O24_CTRL_T;
...
typedef struct
{
	PE_WIN_HW_O24_CTRL_T win_inf;			///< window info
	PE_WIN_HW_O24_LRCR_CTRL_T lrcr_inf;		///< lrcr win info
	PE_WIN_HW_O24_TNR_CTRL_T tnr_inf;		///< tnr measure win info
	UINT32 is_external_chip;		///< 60Hz or 120Hz model, 0:60Hz, 1:120Hz
}
PE_WIN_HW_O24_SETTINGS_T;
