...
extern void FWI_CPU_ISR_FROM_MCU(struct tasklet_struct *temp);
extern void FWI_CPU_ACK_FROM_MCU(struct tasklet_struct *temp);
extern void FWI_CPU_WDG_FROM_MCU(struct tasklet_struct *temp);
#else
...
#if (LINUX_VERSION_CODE >= KERNEL_VERSION(5, 5, 0))
static DECLARE_TASKLET(Video_WDG_tasklet,	FWI_CPU_WDG_FROM_MCU);
static DECLARE_TASKLET(Video_IPC_tasklet,	FWI_CPU_ISR_FROM_MCU);
static DECLARE_TASKLET(VIdeo_ACK_tasklet,	FWI_CPU_ACK_FROM_MCU);
#else
