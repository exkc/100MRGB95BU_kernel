...
#ifndef __TOP_CTRL_OSD_REG_M19_H__
#define __TOP_CTRL_OSD_REG_M19_H__
...
/* 58 regs, 58 types in Total*/

/* from 'M16P3-A0_PQE_TopCTRL_reg_man.csv' 20180327 20:27:19 KST by getregs v2.9 */

/*
 * @{
 * Naming for register pointer.
 * g_osd_top_m19_reg : real register of CCO_CTRL.
 * g_osd_top_m19_reg_shadow     : shadow register.
 *
 * @def OSD_TOP_M19_RdFL: Read  FLushing : Shadow <- Real.
 * @def OSD_TOP_M19_WrFL: Write FLushing : Shadow -> Real.
 * @def OSD_TOP_M19_Rd  : Read  whole register(UINT32) from Shadow register.
 * @def OSD_TOP_M19_Wr  : Write whole register(UINT32) from Shadow register.
 * @def OSD_TOP_M19_Rd01 ~ OSD_TOP_M19_Rdnn: Read  given '01~nn' fields from Shadow register.
 * @def OSD_TOP_M19_Wr01 ~ OSD_TOP_M19_Wrnn: Write given '01~nn' fields to   Shadow register.
 * */
#define OSD_TOP_M19_RdFL(_r)			((g_osd_top_m19_reg_shadow->_r)=(g_osd_top_m19_reg->_r))
#define OSD_TOP_M19_WrFL(_r)			((g_osd_top_m19_reg->_r)=(g_osd_top_m19_reg_shadow->_r))

#define OSD_TOP_M19_Rd(_r)				*((UINT32*)(&(g_osd_top_m19_reg_shadow->_r)))
#define OSD_TOP_M19_Wr(_r,_v)			((OSD_TOP_M19_Rd(_r))=((UINT32)(_v)))

#define OSD_TOP_M19_Rd01(_r,_f01,_v01)													\
								do { 											\
									(_v01) = (g_osd_top_m19_reg_shadow->_r._f01);				\
								} while(0)

#define OSD_TOP_M19_Rd02(_r,_f01,_v01,_f02,_v02)										\
								do { 											\
									(_v01) = (g_osd_top_m19_reg_shadow->_r._f01);				\
									(_v02) = (g_osd_top_m19_reg_shadow->_r._f02);				\
								} while(0)

#define OSD_TOP_M19_Rd03(_r,_f01,_v01,_f02,_v02,_f03,_v03)								\
								do { 											\
									(_v01) = (g_osd_top_m19_reg_shadow->_r._f01);				\
									(_v02) = (g_osd_top_m19_reg_shadow->_r._f02);				\
									(_v03) = (g_osd_top_m19_reg_shadow->_r._f03);				\
								} while(0)

#define OSD_TOP_M19_Rd04(_r,_f01,_v01,_f02,_v02,_f03,_v03,_f04,_v04)					\
								do { 											\
									(_v01) = (g_osd_top_m19_reg_shadow->_r._f01);				\
									(_v02) = (g_osd_top_m19_reg_shadow->_r._f02);				\
									(_v03) = (g_osd_top_m19_reg_shadow->_r._f03);				\
									(_v04) = (g_osd_top_m19_reg_shadow->_r._f04);				\
								} while(0)

#define OSD_TOP_M19_Rd05(_r,_f01,_v01,_f02,_v02,_f03,_v03,_f04,_v04,					\
					_f05,_v05)													\
								do { 											\
									(_v01) = (g_osd_top_m19_reg_shadow->_r._f01);				\
									(_v02) = (g_osd_top_m19_reg_shadow->_r._f02);				\
									(_v03) = (g_osd_top_m19_reg_shadow->_r._f03);				\
									(_v04) = (g_osd_top_m19_reg_shadow->_r._f04);				\
									(_v05) = (g_osd_top_m19_reg_shadow->_r._f05);				\
								} while(0)

#define OSD_TOP_M19_Rd06(_r,_f01,_v01,_f02,_v02,_f03,_v03,_f04,_v04,					\
					_f05,_v05,_f06,_v06)										\
								do { 											\
									(_v01) = (g_osd_top_m19_reg_shadow->_r._f01);				\
									(_v02) = (g_osd_top_m19_reg_shadow->_r._f02);				\
									...
									(_v04) = (g_osd_top_m19_reg_shadow->_r._f04);				\
									(_v05) = (g_osd_top_m19_reg_shadow->_r._f05);				\
									(_v06) = (g_osd_top_m19_reg_shadow->_r._f06);				\
								} while(0)

#define OSD_TOP_M19_Rd07(_r,_f01,_v01,_f02,_v02,_f03,_v03,_f04,_v04,					\
					_f05,_v05,_f06,_v06,_f07,_v07)								\
								do { 											\
									...
									(_v05) = (g_osd_top_m19_reg_shadow->_r._f05);				\
									(_v06) = (g_osd_top_m19_reg_shadow->_r._f06);				\
									(_v07) = (g_osd_top_m19_reg_shadow->_r._f07);				\
								} while(0)

#define OSD_TOP_M19_Rd08(_r,_f01,_v01,_f02,_v02,_f03,_v03,_f04,_v04,					\
					_f05,_v05,_f06,_v06,_f07,_v07,_f08,_v08)					\
								do { 											\
									...
									(_v06) = (g_osd_top_m19_reg_shadow->_r._f06);				\
									(_v07) = (g_osd_top_m19_reg_shadow->_r._f07);				\
									(_v08) = (g_osd_top_m19_reg_shadow->_r._f08);				\
								} while(0)

#define OSD_TOP_M19_Wr01(_r,_f01,_v01)													\
								do { 											\
									(g_osd_top_m19_reg_shadow->_r._f01) = (_v01);				\
								} while(0)

#define OSD_TOP_M19_Wr02(_r,_f01,_v01,_f02,_v02)										\
								do { 											\
									(g_osd_top_m19_reg_shadow->_r._f01) = (_v01);				\
									(g_osd_top_m19_reg_shadow->_r._f02) = (_v02);				\
								} while(0)

#define OSD_TOP_M19_Wr03(_r,_f01,_v01,_f02,_v02,_f03,_v03)								\
								do { 											\
									(g_osd_top_m19_reg_shadow->_r._f01) = (_v01);				\
									(g_osd_top_m19_reg_shadow->_r._f02) = (_v02);				\
									(g_osd_top_m19_reg_shadow->_r._f03) = (_v03);				\
								} while(0)

#define OSD_TOP_M19_Wr04(_r,_f01,_v01,_f02,_v02,_f03,_v03,_f04,_v04)					\
								do { 											\
									(g_osd_top_m19_reg_shadow->_r._f01) = (_v01);				\
									(g_osd_top_m19_reg_shadow->_r._f02) = (_v02);				\
									(g_osd_top_m19_reg_shadow->_r._f03) = (_v03);				\
									(g_osd_top_m19_reg_shadow->_r._f04) = (_v04);				\
								} while(0)

#define OSD_TOP_M19_Wr05(_r,_f01,_v01,_f02,_v02,_f03,_v03,_f04,_v04,					\
					_f05,_v05)													\
								do { 											\
									(g_osd_top_m19_reg_shadow->_r._f01) = (_v01);				\
									(g_osd_top_m19_reg_shadow->_r._f02) = (_v02);				\
									(g_osd_top_m19_reg_shadow->_r._f03) = (_v03);				\
									(g_osd_top_m19_reg_shadow->_r._f04) = (_v04);				\
									(g_osd_top_m19_reg_shadow->_r._f05) = (_v05);				\
								} while(0)

#define OSD_TOP_M19_Wr06(_r,_f01,_v01,_f02,_v02,_f03,_v03,_f04,_v04,					\
					_f05,_v05,_f06,_v06)										\
								do { 											\
									(g_osd_top_m19_reg_shadow->_r._f01) = (_v01);				\
									(g_osd_top_m19_reg_shadow->_r._f02) = (_v02);				\
									...
									(g_osd_top_m19_reg_shadow->_r._f04) = (_v04);				\
									(g_osd_top_m19_reg_shadow->_r._f05) = (_v05);				\
									(g_osd_top_m19_reg_shadow->_r._f06) = (_v06);				\
								} while(0)

#define OSD_TOP_M19_Wr07(_r,_f01,_v01,_f02,_v02,_f03,_v03,_f04,_v04,					\
					_f05,_v05,_f06,_v06,_f07,_v07)								\
								do { 											\
									(g_osd_top_m19_reg_shadow->_r._f01) = (_v01);				\
									(g_osd_top_m19_reg_shadow->_r._f02) = (_v02);				\
									...
									(g_osd_top_m19_reg_shadow->_r._f05) = (_v05);				\
									(g_osd_top_m19_reg_shadow->_r._f06) = (_v06);				\
									(g_osd_top_m19_reg_shadow->_r._f07) = (_v07);				\
								} while(0)

#define OSD_TOP_M19_Wr08(_r,_f01,_v01,_f02,_v02,_f03,_v03,_f04,_v04,					\
					_f05,_v05,_f06,_v06,_f07,_v07,_f08,_v08)					\
								do { 											\
									(g_osd_top_m19_reg_shadow->_r._f01) = (_v01);				\
									(g_osd_top_m19_reg_shadow->_r._f02) = (_v02);				\
									...
									(g_osd_top_m19_reg_shadow->_r._f06) = (_v06);				\
									(g_osd_top_m19_reg_shadow->_r._f07) = (_v07);				\
									(g_osd_top_m19_reg_shadow->_r._f08) = (_v08);				\
								} while(0)


/** @} *//* end of macro documentation */

extern volatile OSD_TOP_M19_REG_T*	g_osd_top_m19_reg;
extern OSD_TOP_M19_REG_T*			g_osd_top_m19_reg_shadow;
...
/* from 'M19_PQE_TopCTRL_reg_man.csv'  대한민국 표준시 by getregs v2.8 */
