...
#define	KDRV_MAJOR_END		1199	/* 1200 */
...
#define TE_MAJOR			(KDRV_MAJOR_BASE+38)
#define TE_MINOR			0

#define CIPLUS_MAJOR		(KDRV_MAJOR_BASE+39)
#define CIPLUS_MINOR		0

#define EMMC_MAJOR              (KDRV_MAJOR_BASE+40)
#define EMMC_MINOR		0

#define ATSC3_MAJOR			(KDRV_MAJOR_BASE+41)
#define ATSC3_MINOR			0

#define SWCEC_MAJOR			(KDRV_MAJOR_BASE+42)
#define SWCEC_MINOR			0

#define AUDFW_MAJOR			(KDRV_MAJOR_BASE+43)
#define AUDFW_MINOR			0

#define UCOM_MAJOR			(KDRV_MAJOR_BASE+44)
#define UCOM_MINOR			0

#define ARIB2_MAJOR			(KDRV_MAJOR_BASE+45)
#define ARIB2_MINOR			0

#define IRB_MAJOR			(KDRV_MAJOR_BASE+46)
#define IRB_MINOR			0

#define CRYPTO_MAJOR		(KDRV_MAJOR_BASE+47)
