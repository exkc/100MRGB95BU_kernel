...
#ifndef	_PE_WIN_HW_O26_H_
#define	_PE_WIN_HW_O26_H_
...
typedef struct
{
	PE_WIN_HW_O26_CTRL_T win_inf;			///< window info
	PE_WIN_HW_O26_LRCR_CTRL_T lrcr_inf;		///< lrcr win info
	PE_WIN_HW_O26_TNR_CTRL_T tnr_inf;		///< tnr measure win info
	UINT32 is_external_chip;		///< 60Hz or 120Hz model, 0:60Hz, 1:120Hz
}
PE_WIN_HW_O26_SETTINGS_T;
