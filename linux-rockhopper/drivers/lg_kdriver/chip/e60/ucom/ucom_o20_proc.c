...
/*----------------------------------------------------------------------------------------
	global Variables
----------------------------------------------------------------------------------------*/
//static ucom_o20_gov_t* ucom_o20_gov = NULL;
...
static ucom_o20_func_t * ucom_func;
...
static OS_PROC_DESC_TABLE_T	_g_ucom_o20_device_proc_table[] =
{
...
int	o20_read_proc(UINT32 procId, char* buffer )
{
	int	status=0,ret = 0 ;
...
int o20_write_proc( UINT32 procId, char* command )
{
	int ret = 0;
	switch( procId ) {
 ...
 * @see UCOM_Init
*/
void o20_ucom_proc_init (void)
{
	ucom_func	= get_o20_ucom_func();
	ucom_drv =  get_o20_ucom_driver();


	OS_PROC_CreateEntryEx ( UCOM_MODULE, _g_ucom_o20_device_proc_table,
										o20_read_proc,
										o20_write_proc );
 ...
 * @see UCOM_Cleanup
*/
void o20_ucom_proc_cleanup (void)
{
	OS_PROC_RemoveEntry( UCOM_MODULE );
}

static ucom_proc_t o20_proc_func =
{
	.init = o20_ucom_proc_init,
	.cleanup = o20_ucom_proc_cleanup,
};
