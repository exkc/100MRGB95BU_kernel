...
#define DEMOD_IOW_APB_AccessControl			    _IOW(DEMOD_IOC_MAGIC, 30, BOOLEAN)
...
#define DEMOD_IOR_DBB_I2C_READ                  _IOR(DEMOD_IOC_MAGIC, 55, LX_DEMOD_I2C_COMM_T)
#define DEMOD_IOW_DBB_I2C_WRITE                 _IOW(DEMOD_IOC_MAGIC, 56, LX_DEMOD_I2C_COMM_T)
#define DEMOD_IO_FW_Initialize                  _IO(DEMOD_IOC_MAGIC, 57)
#define DEMOD_IOR_Get_DBB_FW_Info               _IOR(DEMOD_IOC_MAGIC, 58, UINT32)
#define DEMOD_IO_Get_DBB_Dump                   _IO(DEMOD_IOC_MAGIC, 59)
#define DEMOD_IOR_DBB_APB_Read                  _IOR(DEMOD_IOC_MAGIC, 60, LX_DEMOD_APB_COMM_T)
#define DEMOD_IOR_DBB_APB_Write                 _IOW(DEMOD_IOC_MAGIC, 61, LX_DEMOD_APB_COMM_T)
#define DEMOD_IOW_DBB_PDB_Write                 _IOW(DEMOD_IOC_MAGIC, 62, UINT32)
#define DEMOD_IO_ALL_FW_Initialize              _IO(DEMOD_IOC_MAGIC, 63)

//DVBC (8)
#define DEMOD_IO_DVB_SW_Init                    _IO(DEMOD_IOC_MAGIC, 80)
...
//DTMB (??)
#define DEMOD_IO_DTMB_SW_Init                   _IO(DEMOD_IOC_MAGIC, 100)
...
//VSB(5)
#define DEMOD_IO_ATSC_SW_Init                   _IO(DEMOD_IOC_MAGIC, 150)
...
#define DEMOD_IO_VSB_SetDemod_Simple            _IO(DEMOD_IOC_MAGIC, 155)

//QAM (3)
#define DEMOD_IO_QAM_SET_DEFAULT_VALUE          _IO(DEMOD_IOC_MAGIC, 171)
#define DEMOD_IO_QAM_PRINT_INFO                 _IO(DEMOD_IOC_MAGIC, 172)
#define DEMOD_IO_QAM_SET_FRAME_RESYNC           _IO(DEMOD_IOC_MAGIC, 173)
...
#define DEMOD_IOR_ISDBT_GetEmergencyAlertFlagStatus     _IOR(DEMOD_IOC_MAGIC, 197, BOOLEAN)

//DVBS/S2
#define DEMOD_IOW_DVBS_SET_DISEQC_MESSAGE       _IOW(DEMOD_IOC_MAGIC, 201, LX_DEMOD_DVBS_DiSEqC_MSG_T)
#define DEMOD_IOW_DVBS_SET_MESSAGE_TYPE         _IOW(DEMOD_IOC_MAGIC, 202, LX_DEMOD_MESSAGE_TYPE_T)
#define DEMOD_IOR_DVBS_GET_BLIND_INFO           _IOR(DEMOD_IOC_MAGIC, 203, LX_DEMOD_DVBS_BLIND_PARAM_T)
#define DEMOD_IOW_DVBSX_BLIND_SCAN_INIT         _IOW(DEMOD_IOC_MAGIC, 204, LX_DEMOD_BLIND_SCAN_INIT_FREQ_PARAM_T)
#define DEMOD_IO_DVBSX_BLIND_SCAN_END           _IO(DEMOD_IOC_MAGIC, 205)
#define DEMOD_IOR_DVBSX_GET_TUNER_FREQ          _IOR(DEMOD_IOC_MAGIC, 206, LX_DEMOD_BLIND_SCAN_FREQ_PARAM_T)
#define DEMOD_IOR_DVBSX_GET_OFFSET_FREQUENCY    _IOR(DEMOD_IOC_MAGIC, 207, LX_DEMOD_BLIND_SCAN_OFFSET_PARAM_T)
#define DEMOD_IO_DVBSX_SYMBOL_RATE_DETECT       _IO(DEMOD_IOC_MAGIC, 208)
#define DEMOD_IO_DVBSX_BLIND_LOCK_LOOP          _IO(DEMOD_IOC_MAGIC, 209)
#define DEMOD_IOR_DVBSX_GET_NEXTFREQ_STATUS     _IOR(DEMOD_IOC_MAGIC, 210, BOOLEAN)
...
//ATSC3
#define DEMOD_IOW_ATSC3_SET_PLP                 _IOW(DEMOD_IOC_MAGIC, 237, LX_DEMOD_ATSC3_CONFIG_T)
#define DEMOD_IOR_ATSC3_GET_MPLPInfo            _IOWR(DEMOD_IOC_MAGIC, 238, LX_DEMOD_ATSC3_MULTI_PLP_ID_T)
#define DEMOD_IOW_ATSC3_SELECT_PLP              _IOW(DEMOD_IOC_MAGIC, 237, UINT8)
#define DEMOD_IOW_ATSC3_SET_OIFTYPE             _IOW(DEMOD_IOC_MAGIC, 239, LX_DEMOD_ATSC3_OIF_TYPE_T)    // htlim
...
#define LX_DEMOD_IF_FREQ_00_000_KHZ             0000
...
#define LX_DEMOD_NOT_LOCKED_PAUSE_TIME          10              /* pause 10 msec  in NOT_LOCKED state */
...
#define LX_DEMOD_PACKET_ERROR_THD               255
#define LX_DEMOD_PACKET_ERROR_THD_32700         32700
#define LX_DEMOD_PACKET_ERROR_THD_100           100

#define LX_DEMOD_DVBC_NEVERLOCK_WAIT_TIME       (200 * THR_ADJ) //QAM mode check time
#define LX_DEMOD_DVBT_NEVERLOCK_WAIT_TIME       (500 * THR_ADJ) //1500//500
#define LX_DEMOD_ISDBT_NEVERLOCK_WAIT_TIME      (450 * THR_ADJ)
#define LX_DEMOD_QAM_NEVERLOCK_WAIT_TIME        (500 * THR_ADJ)
#define LX_DEMOD_VSB_NEVERLOCK_WAIT_TIME        (500 * THR_ADJ)
#define LX_DEMOD_DVBS_NEVERLOCK_WAIT_TIME       (600 * THR_ADJ)
#define LX_DEMOD_DVBS2_NEVERLOCK_WAIT_TIME      (600 * THR_ADJ)

#define LX_DEMOD_VSB_SIG_STABLE_WAIT_TIMEOUT    (80 * THR_ADJ)
#define LX_DEMOD_QAM_SIG_STABLE_WAIT_TIMEOUT    (30 * THR_ADJ)
#define LX_DEMOD_ISDBT_SIG_STABLE_WAIT_TIMEOUT  (30 * THR_ADJ)
#define LX_DEMOD_DVBT_SIG_STABLE_WAIT_TIMEOUT   (30 * THR_ADJ)
#define LX_DEMOD_DVBS_SIG_STABLE_WAIT_TIMEOUT   (30 * THR_ADJ)
#define LX_DEMOD_ANALOG_SIG_STABLE_WAIT_TIMEOUT (30 * THR_ADJ)
...
#define LX_DEMOD_LOCK_DEALY_50                  (50 * THR_ADJ)
#define LX_DEMOD_LOCK_DEALY_100                 (100 * THR_ADJ)
#define LX_DEMOD_LOCK_DEALY_120                 (120 * THR_ADJ)
#define LX_DEMOD_LOCK_DEALY_130                 (130 * THR_ADJ)
#define LX_DEMOD_LOCK_DEALY_150                 (150 * THR_ADJ)
#define LX_DEMOD_LOCK_DEALY_170                 (170 * THR_ADJ)
#define LX_DEMOD_LOCK_DEALY_200                 (200 * THR_ADJ)
#define LX_DEMOD_LOCK_DEALY_220                 (220 * THR_ADJ)
#define LX_DEMOD_LOCK_DEALY_250                 (250 * THR_ADJ)
#define LX_DEMOD_LOCK_DEALY_300                 (300 * THR_ADJ)
#define LX_DEMOD_LOCK_DEALY_400                 (400 * THR_ADJ)
#define LX_DEMOD_LOCK_DEALY_500                 (500 * THR_ADJ)
#define LX_DEMOD_LOCK_DEALY_450                 (450 * THR_ADJ)
#define LX_DEMOD_LOCK_DEALY_600                 (600 * THR_ADJ)
#define LX_DEMOD_LOCK_DEALY_800                 (800 * THR_ADJ)

#define LX_DEMOD_LOCK_DEALY_1000                (1000 * THR_ADJ)
#define LX_DEMOD_LOCK_DEALY_1100                (1100 * THR_ADJ)
#define LX_DEMOD_LOCK_DEALY_1500                (1500 * THR_ADJ)
#define LX_DEMOD_LOCK_DEALY_2000                (2000 * THR_ADJ)
#define LX_DEMOD_LOCK_DEALY_2500                (2500 * THR_ADJ)
#define LX_DEMOD_LOCK_DEALY_3000                (3000 * THR_ADJ)
#define LX_DEMOD_LOCK_DEALY_3500                (3500 * THR_ADJ)
#define LX_DEMOD_LOCK_DEALY_4000                (4000 * THR_ADJ)
#define LX_DEMOD_LOCK_DEALY_4500                (4500 * THR_ADJ)
#define LX_DEMOD_LOCK_DEALY_5000                (5000 * THR_ADJ)
#define LX_DEMOD_LOCK_DEALY_6000                (6000 * THR_ADJ)
#define LX_DEMOD_LOCK_DEALY_10000               (10000 * THR_ADJ)
...
#define LX_ABB_M16_DEVICE                       (0x11500000)
#define LX_ABB_L18_DEVICE                       (0x11500000)
...
typedef enum
{
        ...
        LX_DEMOD_UNKOWN_OPMODE = 0x1f,          ///< Oper mode ->  UNKNOWN
...
#define LX_DEMOD_IS_TUNE_SCAN(tuneMode)     (LX_DEMOD_IS_TUNE_AUTO(tuneMode) || (LX_DEMOD_TUNE_MAN_SEARCH_UP == tuneMode) || (LX_DEMOD_TUNE_MAN_SEARCH_DN == tuneMode))
...
typedef enum
{
        ...
        LX_DEMOD_DVBT_ISDBT_FFT_64K,            ///< DVB-T FFT mode -> 32K
...
typedef enum
{
        ...
        LX_DEMOD_DVBT_ISDBT_GIMODE_1_64,        ///< DVB-C2 Guard Interval-> 1/64
...
typedef enum
{
        LX_DEMOD_TPS_GUARD_420_C,
        LX_DEMOD_TPS_GUARD_420_V,
        LX_DEMOD_TPS_GUARD_595,
        LX_DEMOD_TPS_GUARD_945_C,
        LX_DEMOD_TPS_GUARD_945_V,

        LX_DEMOD_TPS_GUARD_UNKNOWN
} LX_DEMOD_PNMODE_T;
...
typedef enum
{
        LX_DEMOD_CARRIER_SINGLE,
        LX_DEMOD_CARRIER_MULTI,

        LX_DEMOD_CARRIER_UNKNOWN
} LX_DEMOD_CARRIERMODE_T;
...
typedef enum
{
        ...
        LX_DEMOD_ADC_SEL_FOR_SAT                ///< ADC voltage for sat selection
...
typedef enum
{
        ...
        LX_DEMOD_DVBS_NO_OPERATION,             ///< DVBS -> No operation
...
typedef enum
{
        ...
        LX_DEMOD_SYMR_DVBS_NO_OPERATION_MODE,   ///< For H15 UBB, no operation for DVBS/DVBS2
...
typedef enum
{
        ...
        LX_DEMOD_BPSK,                          ///< modulation type -> BPSK
...
typedef enum
{
        ...
        LX_DEMOD_CODE_1_3,                      ///< code rate-> 1/3 only DVBS2
        LX_DEMOD_CODE_1_4,                      ///< code rate-> 1/4 only DVBS2
        LX_DEMOD_CODE_2_3,                      ///< code rate-> 2/3
        LX_DEMOD_CODE_3_4,                      ///< code rate-> 3/4
        LX_DEMOD_CODE_2_5,                      ///< code rate-> 2/5 only DVBS2
        LX_DEMOD_CODE_3_5,                      ///< code rate-> 3/5
        LX_DEMOD_CODE_4_5,                      ///< code rate-> 4/5
        LX_DEMOD_CODE_5_6,                      ///< code rate-> 5/6
        LX_DEMOD_CODE_6_7,                      ///< code rate-> 6/7
        LX_DEMOD_CODE_7_8,                      ///< code rate-> 7/8
        LX_DEMOD_CODE_8_9,                      ///< code rate-> 8/9, only DVBS2
        LX_DEMOD_CODE_9_10,                     ///< code rate-> 8/9, only DVBS2
...
typedef enum
{
        LX_DEMOD_DVBS_DEBUGGING_MODE,           ///< DVBS/S2 Operation mode-> Debugging mode
        LX_DEMOD_DVBS_NORMAL_MODE,              ///< DVBS/S2 Operation mode-> normal mode
        LX_DEMOD_DVBS_BLIND_LOCK_MODE,          ///< DVBS/S2 Operation mode-> blind lock mode
        LX_DEMOD_DVBS_BLIND_SCAN_MODE,          ///< DVBS/S2 Operation mode-> blind scan mode
} LX_DEMOD_DVBS_OPERATION_MODE_T;
...
typedef enum
{
        ...
        LX_DEMOD_PLP_CHANGE_REQUEST = 2,        ///< New tune request
        LX_DEMOD_STOP_REQUEST       = 3,
        LX_DEMOD_INSTANTBOOT_TUNE_REQUEST = 4
...
/**
 * Tone burst mod Definition
 */
typedef enum
{
        LX_DEMOD_DISEQC_TONEBURST_UNMODULATED = 0, //TONE A
        LX_DEMOD_DISEQC_TONEBURST_MODULATED     //TONE B

} LX_DEMOD_TONE_BURST_MOD_T;
...
typedef enum
{
        LX_DEMOD_DISEQC_TONE_DISCRETE = 0,
        LX_DEMOD_DISEQC_TONE_CONTINUOUS

} LX_DEMOD_TONE_TYPE_T;
...
typedef enum
{
        LX_DEMOD_DISEQC_TONE_BURST_OFF = 0,
        LX_DEMOD_DISEQC_TONE_BURST_ON

} LX_DEMOD_TONE_BURST_T;
...
typedef enum
{
        LX_DEMOD_DISEQC_ENVELOP_MODE = 0,
        LX_DEMOD_DISEQC_TONE_MODE

} LX_DEMOD_MESSAGE_TYPE_T;
...
/**
 * DVBS total parameter info.
 */
typedef struct
{
        LX_DEMOD_TUNE_MODE_T    tuneMode;       ///< tune Mode
        BOOLEAN                 bSpectrumInv;
        LX_DEMOD_RF_MODE_T      constellation;  ///< Constellation
        LX_DEMOD_CODERATE_T     codeRate;       ///<Code rate at hierachical transmission mode
        UINT32                  symbolRate;
        UINT32                  frequency;
        LX_DEMOD_DVBS_OPERATION_MODE_T operatingMode;
} LX_DEMOD_DVBS_CONFIG_T;


/**
 * DVBS2  total parameter info.
 */
typedef struct
{
        LX_DEMOD_TUNE_MODE_T    tuneMode;       ///< tune Mode
        BOOLEAN                 bSpectrumInv;
        LX_DEMOD_RF_MODE_T      constellation;  ///< Constellation
        LX_DEMOD_CODERATE_T     codeRate;       ///< Code rate at hierachical transmission modee
        UINT8                   bPilot;         ///< For DVBT2 - PLP ID
        UINT32                  symbolRate;
        UINT32                  frequency;
        LX_DEMOD_DVBS_OPERATION_MODE_T operatingMode;
} LX_DEMOD_DVBS2_CONFIG_T;
...
} LX_DEMOD_DVBS_BLIND_INFO_PARAM_T;

typedef struct
{
        UINT32                  totalCount;
        BOOLEAN                 detectDone;
        LX_DEMOD_DVBS_BLIND_INFO_PARAM_T paramInfo[16];

} LX_DEMOD_DVBS_BLIND_PARAM_T;
...
typedef struct
{
        ...
        UINT8                   end_seq ;
        LX_DEMOD_TONE_TYPE_T    cont_tone;
        LX_DEMOD_TONE_BURST_T   tone_burst;
        LX_DEMOD_TONE_BURST_MOD_T burst_sel;

} LX_DEMOD_DVBS_DiSEqC_MSG_T;

/**
 * DTMB total parameter info.
 */
typedef struct
{
        LX_DEMOD_TUNE_MODE_T    tuneMode;       ///< tune Mode
        LX_DEMOD_BWMODE_T       channelBW;      ///< Channel Bandwidth 8MHz
        ...
        LX_DEMOD_RF_MODE_T      constellation;  ///< QAM mode

} LX_DEMOD_DTMB_CONFIG_T;
...
{
        union {
                Handle_t                handleABB __aligned(8); ///< handler
                UINT32                  compat_handleABB __aligned(8);
                UINT64                  sizer __aligned(8);
        };
...
----------------------------------------------------------------------------------------*/
/**
 * ATSC3 Guard Interval
 */
typedef enum
{
        LX_DEMOD_GUARD_ATSC3_1_192 = 0x00,
        LX_DEMOD_GUARD_ATSC3_2_384,
        LX_DEMOD_GUARD_ATSC3_3_512,
        LX_DEMOD_GUARD_ATSC3_4_768,
        LX_DEMOD_GUARD_ATSC3_5_1024,
        LX_DEMOD_GUARD_ATSC3_6_1536,
        LX_DEMOD_GUARD_ATSC3_7_2048,
        LX_DEMOD_GUARD_ATSC3_8_2432,
        LX_DEMOD_GUARD_ATSC3_9_3072,
        LX_DEMOD_GUARD_ATSC3_10_368,
        LX_DEMOD_GUARD_ATSC3_11_4096,
        LX_DEMOD_GUARD_ATSC3_12_4864,
        LX_DEMOD_GUARD_ATSC3_END,
        LX_DEMOD_GUARD_ATSC3_UNKNOWN = 0x0F

} LX_DEMOD_ATSC3_GIMODE_T;

typedef enum                                    // 4 bit
{
        LX_DEMOD_ATSC3_CODE_2_15 =0x00,
        LX_DEMOD_ATSC3_CODE_3_15,
        LX_DEMOD_ATSC3_CODE_4_15,
        LX_DEMOD_ATSC3_CODE_5_15,
        LX_DEMOD_ATSC3_CODE_6_15,
        LX_DEMOD_ATSC3_CODE_7_15,
        LX_DEMOD_ATSC3_CODE_8_15,
        LX_DEMOD_ATSC3_CODE_9_15,
        LX_DEMOD_ATSC3_CODE_10_15,
        LX_DEMOD_ATSC3_CODE_11_15,
        LX_DEMOD_ATSC3_CODE_12_15,
        LX_DEMOD_ATSC3_CODE_13_15,
        LX_DEMOD_ATSC3_CODE_END,
        LX_DEMOD_ATSC3_CODE_UNKNOWN = 0x0F
} LX_DEMOD_ATSC3_CODERATE_T;

typedef enum    /* 4 bit */
{
        LX_DEMOD_CONST_ATSC3_QPSK = 0x00,
        LX_DEMOD_CONST_ATSC3_DQPSK,
        LX_DEMOD_CONST_ATSC3_QAM_4NR,
        LX_DEMOD_CONST_ATSC3_QAM_4,
        LX_DEMOD_CONST_ATSC3_PSK_8,
        LX_DEMOD_CONST_ATSC3_VSB_8,
        LX_DEMOD_CONST_ATSC3_QAM_16,
        LX_DEMOD_CONST_ATSC3_QAM_32,
        LX_DEMOD_CONST_ATSC3_QAM_64,
        LX_DEMOD_CONST_ATSC3_QAM_128,
        LX_DEMOD_CONST_ATSC3_QAM_256,
        LX_DEMOD_CONST_ATSC3_QAM_1024,
        LX_DEMOD_CONST_ATSC3_QAM_4096,
        LX_DEMOD_CONST_ATSC3_END,
        LX_DEMOD_CONST_ATSC3_UNKNOWN = 0x0F
} LX_DEMOD_ATSC3_CONSTELLATION_T;

typedef struct
{
        UINT8                   plpTotalCount;  // number of total PLP
        UINT8                   plpDatacount;
        UINT8                   plpDataID[64];  // array of PLP ID
} LX_DEMOD_ATSC3_MULTI_PLP_ID_T;

typedef enum
{
        LX_DEMOD_NONE_PLP_ID = 0x00,
        LX_DEMOD_FULL_PLP_ID,
        LX_DEMOD_LLS_ONLY_PLP_ID
} LX_DEMOD_ATSC3_MULTI_PLP_ID_SEL_T;

typedef struct
{
        UINT8 oifType; /*oiftype */
} LX_DEMOD_ATSC3_OIF_TYPE_T;

/**
 * ATSC3.0 total parameter info.
 */
typedef struct
{
        BOOLEAN                 bMPLP;
        ...
        UINT8                   plpData[4];
        BOOLEAN                 bSpectrumInv;
        LX_DEMOD_ATSC3_MULTI_PLP_ID_T bMultiPlpID;
        LX_DEMOD_ATSC3_MULTI_PLP_ID_SEL_T plpIdsel;

} LX_DEMOD_ATSC3_CONFIG_T;

/**
 * Special data : ATSC3.0.
 */
typedef struct
{
        LX_DEMOD_OPER_MODE_T    transSystem;    /* 5 bit */ /* Keep the position and size */
        BOOLEAN                 bValid;         /* 1 bit */ /* Keep the position and size */
        BOOLEAN                 bBoosterOn;     /* 1 bit */ /* Keep the position and size */
        LX_DEMOD_BWMODE_T       channelBW;      /* 2 bit */ /* Keep the position and size */
        BOOLEAN                 bMPLP;          /* Reserved */
        UINT8                   groupID;        /* 4 bit */
        LX_DEMOD_FFTMODE_T      FFTMode;        /* 4 bit */
        LX_DEMOD_ATSC3_GIMODE_T guardInterval;  /* 4 bit */
        LX_DEMOD_ATSC3_CODERATE_T codeRate;     /* 4 bit */
        LX_DEMOD_ATSC3_CONSTELLATION_T constellation; /* 4 bit */

} LX_DEMOD_ATSC3_SPECDATA__T;
...
typedef struct
{
        ...
        LX_DEMOD_DVBS_CONFIG_T  dvbs;           ///< DVBS
        LX_DEMOD_DVBS2_CONFIG_T dvbs2;          ///< DVBS2
        LX_DEMOD_DTMB_CONFIG_T  dtmb;           ///< DTMB
        LX_DEMOD_ANALOG_CONFIG_T analog;        ///< ANALOG
        LX_DEMOD_ATSC3_CONFIG_T atsc3;          ///< ATSC3
} LX_DEMOD_CONFIG_T;
...
typedef struct
{
        ...
        SINT32                  freqOff;
        SINT32                  snr;
} LX_DEMOD_SIGNAL_TOTAL_T;

typedef struct
{
        UINT32                  sym_rate;       // for c/s/s2
        UINT8                   constellation;  //for t/c/s/s2/d
        UINT8                   guardInterval;  /// for t
        UINT8                   codeRate;       // for t/s/s2/d
        UINT8                   fftMode;        // for t
        UINT8                   hierarchy;      // for t
        UINT8                   hierarchy_sel;  // for t
        UINT8                   il_mode;        //for d
        UINT8                   pn_const;       //for d
        UINT8                   pn_mode;        //for d
        UINT8                   carr_mode;      //for d
} LX_DEMOD_SIGNAL_TUNE_CFG_T;
...
typedef struct
{
        UINT32                  TunerCenterFreqKhz;
        UINT32                  TunerCutOffFreqKhz;
} LX_DEMOD_BLIND_SCAN_FREQ_PARAM_T;

typedef struct
{
        UINT32                  FreqMhz;
        UINT32                  SymbolRateKhz;
} LX_DEMOD_BLIND_SCAN_OFFSET_PARAM_T;

typedef struct
{
        UINT32                  startFreqKhz;
        UINT32                  endFreqKhz;
} LX_DEMOD_BLIND_SCAN_INIT_FREQ_PARAM_T;
