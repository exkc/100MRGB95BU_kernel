#ifndef _REG_DDRT_M2_h
#define _REG_DDRT_M2_h
//Header File for DDRT_M2 in \O24\O24_DRAM_M2_Register_Manual.xls

#define REG_DDRT_M2_TZC_NSAID_0                                             (APB_DDRT_M2_BASE+0x7100)
#define REG_DDRT_M2_TZC_NSAID_1                                             (APB_DDRT_M2_BASE+0x7104)
#define REG_DDRT_M2_TZC_NSAID_2                                             (APB_DDRT_M2_BASE+0x7108)
#define REG_DDRT_M2_TZC_NSAID_3                                             (APB_DDRT_M2_BASE+0x710C)
#define REG_DDRT_M2_TZC_NSAID_4                                             (APB_DDRT_M2_BASE+0x7110)
#define REG_DDRT_M2_TZC_NSAID_5                                             (APB_DDRT_M2_BASE+0x7114)
#define REG_DDRT_M2_TZC_NSAID_6                                             (APB_DDRT_M2_BASE+0x7118)
#define REG_DDRT_M2_TZC_NSAID_7                                             (APB_DDRT_M2_BASE+0x711C)
#define REG_DDRT_M2_TZC_PATH_ON                                             (APB_DDRT_M2_BASE+0x7130)
#define REG_DDRT_M2_APB_SECURE_CONFIG                                       (APB_DDRT_M2_BASE+0x7200)

typedef union {
	UINT32 udata32;
	struct {						//0xC4507100 RW
...
}REG_DDRT_M2_TZC_NSAID_0_T;

typedef union {
	UINT32 udata32;
	struct {						//0xC4507104 RW
...
}REG_DDRT_M2_TZC_NSAID_1_T;

typedef union {
	UINT32 udata32;
	struct {						//0xC4507108 RW
...
}REG_DDRT_M2_TZC_NSAID_2_T;

typedef union {
	UINT32 udata32;
	struct {						//0xC450710C RW
...
}REG_DDRT_M2_TZC_NSAID_3_T;

typedef union {
	UINT32 udata32;
	struct {						//0xC4507110 RW
...
}REG_DDRT_M2_TZC_NSAID_4_T;

typedef union {
	UINT32 udata32;
	struct {						//0xC4507114 RW
...
}REG_DDRT_M2_TZC_NSAID_5_T;

typedef union {
	UINT32 udata32;
	struct {						//0xC4507118 RW
...
}REG_DDRT_M2_TZC_NSAID_6_T;

typedef union {
	UINT32 udata32;
	struct {						//0xC450711C RW
...
}REG_DDRT_M2_TZC_NSAID_7_T;

typedef union {
	UINT32 udata32;
	struct {						//0xC4507130 RW
...
}REG_DDRT_M2_TZC_PATH_ON_T;

typedef union {
	UINT32 udata32;
	struct {						//0xC4507200 RW
...
}REG_DDRT_M2_APB_SECURE_CONFIG_T;

typedef struct {
	REG_DDRT_M2_TZC_NSAID_0_T                               tzc_nsaid_0;	//0xC4507100
	REG_DDRT_M2_TZC_NSAID_1_T                               tzc_nsaid_1;	//0xC4507104
	REG_DDRT_M2_TZC_NSAID_2_T                               tzc_nsaid_2;	//0xC4507108
	REG_DDRT_M2_TZC_NSAID_3_T                               tzc_nsaid_3;	//0xC450710C
	REG_DDRT_M2_TZC_NSAID_4_T                               tzc_nsaid_4;	//0xC4507110
	REG_DDRT_M2_TZC_NSAID_5_T                               tzc_nsaid_5;	//0xC4507114
	REG_DDRT_M2_TZC_NSAID_6_T                               tzc_nsaid_6;	//0xC4507118
	REG_DDRT_M2_TZC_NSAID_7_T                               tzc_nsaid_7;	//0xC450711C
	UINT32                                                    reserved0;	//0xC4507120
	UINT32                                                    reserved1;	//0xC4507124
	UINT32                                                    reserved2;	//0xC4507128
	UINT32                                                    reserved3;	//0xC450712C
	REG_DDRT_M2_TZC_PATH_ON_T                               tzc_path_on;	//0xC4507130
	UINT32                                                    reserved4;	//0xC4507134
	UINT32                                                    reserved5;	//0xC4507138
	UINT32                                                    reserved6;	//0xC450713C
	UINT32                                                    reserved7;	//0xC4507140
	UINT32                                                    reserved8;	//0xC4507144
	UINT32                                                    reserved9;	//0xC4507148
	UINT32                                                   reserved10;	//0xC450714C
	UINT32                                                   reserved11;	//0xC4507150
	UINT32                                                   reserved12;	//0xC4507154
	UINT32                                                   reserved13;	//0xC4507158
	UINT32                                                   reserved14;	//0xC450715C
	UINT32                                                   reserved15;	//0xC4507160
	UINT32                                                   reserved16;	//0xC4507164
	UINT32                                                   reserved17;	//0xC4507168
	UINT32                                                   reserved18;	//0xC450716C
	UINT32                                                   reserved19;	//0xC4507170
	UINT32                                                   reserved20;	//0xC4507174
	UINT32                                                   reserved21;	//0xC4507178
	UINT32                                                   reserved22;	//0xC450717C
	UINT32                                                   reserved23;	//0xC4507180
	UINT32                                                   reserved24;	//0xC4507184
	UINT32                                                   reserved25;	//0xC4507188
	UINT32                                                   reserved26;	//0xC450718C
	UINT32                                                   reserved27;	//0xC4507190
	UINT32                                                   reserved28;	//0xC4507194
	UINT32                                                   reserved29;	//0xC4507198
	UINT32                                                   reserved30;	//0xC450719C
	UINT32                                                   reserved31;	//0xC45071A0
	UINT32                                                   reserved32;	//0xC45071A4
	UINT32                                                   reserved33;	//0xC45071A8
	UINT32                                                   reserved34;	//0xC45071AC
	UINT32                                                   reserved35;	//0xC45071B0
	UINT32                                                   reserved36;	//0xC45071B4
	UINT32                                                   reserved37;	//0xC45071B8
	UINT32                                                   reserved38;	//0xC45071BC
	UINT32                                                   reserved39;	//0xC45071C0
	UINT32                                                   reserved40;	//0xC45071C4
	UINT32                                                   reserved41;	//0xC45071C8
	UINT32                                                   reserved42;	//0xC45071CC
	UINT32                                                   reserved43;	//0xC45071D0
	UINT32                                                   reserved44;	//0xC45071D4
	UINT32                                                   reserved45;	//0xC45071D8
	UINT32                                                   reserved46;	//0xC45071DC
	UINT32                                                   reserved47;	//0xC45071E0
	UINT32                                                   reserved48;	//0xC45071E4
	UINT32                                                   reserved49;	//0xC45071E8
	UINT32                                                   reserved50;	//0xC45071EC
	UINT32                                                   reserved51;	//0xC45071F0
	UINT32                                                   reserved52;	//0xC45071F4
	UINT32                                                   reserved53;	//0xC45071F8
	UINT32                                                   reserved54;	//0xC45071FC
	REG_DDRT_M2_APB_SECURE_CONFIG_T                   apb_secure_config;	//0xC4507200
}REG_DDRT_M2_T;
