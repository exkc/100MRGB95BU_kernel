#ifndef _BND_CTRL_M0_M23A0_REG_H_
#define _BND_CTRL_M0_M23A0_REG_H_
...
}BND_CTRL_M0_M0_SYN_00_M23A0_T;

/*-----------------------------------------------------------------------------------------
    0xC4F7_2004    m0_syn_01 ''
-----------------------------------------------------------------------------------------*/
typedef struct {
    UINT32
...
}BND_CTRL_M0_M0_SYN_01_M23A0_T;

/*-----------------------------------------------------------------------------------------
    0xC4F7_2008    m0_syn_02 ''
-----------------------------------------------------------------------------------------*/
typedef struct {
    UINT32
...
}BND_CTRL_M0_M0_SYN_02_M23A0_T;

/*-----------------------------------------------------------------------------------------
    0xC4F7_200C    m0_syn_03 ''
-----------------------------------------------------------------------------------------*/
typedef struct {
    UINT32
...
typedef struct {
    ...
    reg_pll_mon_en            :  1,    //      0
                              : 31;    //   31:1 reserved
}BND_CTRL_M0_PLL_MON_M23A0_T;

/*-----------------------------------------------------------------------------------------
    base_address Register LIst
-----------------------------------------------------------------------------------------*/
typedef struct {
    BND_CTRL_M0_M0_SYN_00_M23A0_T     m0_syn_00  ;             // 0xC4F7_2000
    BND_CTRL_M0_M0_SYN_01_M23A0_T     m0_syn_01  ;             // 0xC4F7_2004
    BND_CTRL_M0_M0_SYN_02_M23A0_T     m0_syn_02  ;             // 0xC4F7_2008
    BND_CTRL_M0_M0_SYN_03_M23A0_T     m0_syn_03  ;             // 0xC4F7_200C
    BND_CTRL_M0_PLL_MON_M23A0_T       pll_mon    ;             // 0xC4F7_2010
}BND_CTRL_M0_REG_M23A0_T;
/* 5 regs */
...
#define BND_CTRL_M0_M0_SYN_00_M23A0_T_OFF                  (BASEADDRESS+0x0000)
#define BND_CTRL_M0_M0_SYN_01_M23A0_T_OFF                  (BASEADDRESS+0x0004)
#define BND_CTRL_M0_M0_SYN_02_M23A0_T_OFF                  (BASEADDRESS+0x0008)
#define BND_CTRL_M0_M0_SYN_03_M23A0_T_OFF                  (BASEADDRESS+0x000C)
#define BND_CTRL_M0_PLL_MON_M23A0_T_OFF                    (BASEADDRESS+0x0010)
