...
#define	VBI_DEBUG(format, args...)			DBG_PRINT( g_vbi_debug_fd, LX_LOGM_LEVEL_DEBUG, format, ##args)
...
#define	VBI_TRACE4(format, args...)			DBG_PRINT( g_vbi_debug_fd, LX_LOGM_LEVEL_TRACE+4, format, ##args)
#define VBI_TRACE5(format, args...)			DBG_PRINT( g_vbi_debug_fd, LX_LOGM_LEVEL_TRACE+5, format, ##args)
#define	VBI_TRACE6(format, args...)			DBG_PRINT( g_vbi_debug_fd, LX_LOGM_LEVEL_TRACE+6, format, ##args)
#define VBI_TRACE7(format, args...)			DBG_PRINT( g_vbi_debug_fd, LX_LOGM_LEVEL_TRACE+7, format, ##args)
...
#define TTX_PKT_PRINT					VBI_TRACE4
#define CC_PKT_PRINT					VBI_TRACE5
#define VPS_PKT_PRINT					VBI_TRACE6
#define WSS_PKT_PRINT					VBI_TRACE7

#define USE_VBI_DEVICE_DRIVER_MEMORY	(0)
/*----------------------------------------------------------------------------------------
    Type Definitions
----------------------------------------------------------------------------------------*/
