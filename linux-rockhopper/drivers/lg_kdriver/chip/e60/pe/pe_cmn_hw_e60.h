...
#ifndef	_PE_CMN_HW_E60_H_
#define	_PE_CMN_HW_E60_H_
...
typedef enum
{
	PE_CMN_HW_E60_DB_INF_IS_DB_INIT =  0, ///< is initialized or not
	PE_CMN_HW_E60_DB_INF_TOP_VERSION,     ///< top version
	PE_CMN_HW_E60_DB_INF_TOP_BASE,        ///< top base addr
	PE_CMN_HW_E60_DB_INF_TOP_SEC_NUM,     ///< top section total number
	PE_CMN_HW_E60_DB_INF_SEC_BASE,        ///< section base address
	PE_CMN_HW_E60_DB_INF_SEC_SIZE,        ///< section size
	PE_CMN_HW_E60_DB_INF_SEC_VERSION,     ///< section version
	PE_CMN_HW_E60_DB_INF_SEC_TYPE,        ///< section type
	PE_CMN_HW_E60_DB_INF_SEC_ITEM_NUM,    ///< section item total number
	PE_CMN_HW_E60_DB_INF_SEC_ITEM_SIZE,   ///< section item size
	PE_CMN_HW_E60_DB_INF_SEC_DATA_BASE,   ///< section data base
	PE_CMN_HW_E60_DB_INF_MD0_SHP_FW_EN,   ///< md0 shp fw en
	PE_CMN_HW_E60_DB_INF_MD0_HST_FW_EN,   ///< md0 hst fw en
	PE_CMN_HW_E60_DB_INF_MD0_SCL_FW_EN,   ///< md0 scl fw en
	PE_CMN_HW_E60_DB_INF_MD0_TNR_FW_EN,   ///< md0 tnr fw en
	PE_CMN_HW_E60_DB_INF_MD0_DNR_FW_EN,   ///< md0 dnr fw en
	PE_CMN_HW_E60_DB_INF_NUM              ///< max num
}
PE_CMN_HW_E60_DB_INF_TYPE;
...
#if 0
int PE_CMN_HW_E60_DownloadLGSRDb(PE_CFG_CTRL_T *pstParams);
int PE_CMN_HW_E60F20_DownloadLGSRDb(PE_CFG_CTRL_T *pstParams);
#endif
