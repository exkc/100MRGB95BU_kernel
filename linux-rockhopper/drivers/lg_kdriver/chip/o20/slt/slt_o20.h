...
#ifndef __SLT_O20_H__
#define __SLT_O20_H__
...
#include "dpe_crc_a0_reg.h"
#include "vsd_crc_a0_reg.h"

//#define SLT_VSD
//
#ifdef SLT_VSD
#define O20_SLT_REG_T		VSD_CRC_REG_O20_A0
#define O20_IRQ_SLT			(O20_IRQ_INTR_CRC0)
#define O20_SLT_BASE		(0xC930D800)
#else
#define O20_SLT_REG_T		DPE_CRC_REG_O20_A0
#define O20_IRQ_SLT			(O20_IRQ_INTR_CRC1)
#define O20_SLT_BASE		(0xC930F600)
#endif
...
static volatile O20_SLT_REG_T		*SLT_REG = NULL;
static volatile O20_SLT_REG_T		SLT_REG_Shadow[1];
