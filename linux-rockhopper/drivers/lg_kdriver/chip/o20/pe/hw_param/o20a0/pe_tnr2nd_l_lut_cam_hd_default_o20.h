...
const PE_REG_PARAM_T tnr2nd_l_lut_cam_hd_default_o20[] =
{
	/* nd tnr lut */
	...
	{0x1A1D4, 0x60005000},	//x5y5 x4y4 [0008]
	{0x1A1D4, 0x40403050},	//x3y3 x2y2 [0009]
	{0x1A1D4, 0x28702080},	//x1y1 x0y0 [0010]
	{0x1A1D4, 0xB0008000},	//x7y7 x6y6 [0011]	 reg_detail_cir_pt
	{0x1A1D4, 0x60004B00},	//x5y5 x4y4 [0012]
	{0x1A1D4, 0x28402350},	//x3y3 x2y2 [0013]
	{0x1A1D4, 0x1E701880},	//x1y1 x0y0 [0014]
	{0x1A1D4, 0xB0008000},	//x7y7 x6y6 [0015]	 default
	{0x1A1D4, 0x60004B00},	//x5y5 x4y4 [0016]
	{0x1A1D4, 0x28402350},	//x3y3 x2y2 [0017]
	{0x1A1D4, 0x1E701880},	//x1y1 x0y0 [0018]
	{0x1A1D4, 0xB0008000},	//x7y7 x6y6 [0019]	 default
	{0x1A1D4, 0x60004B00},	//x5y5 x4y4 [0020]
	{0x1A1D4, 0x28402350},	//x3y3 x2y2 [0021]
	{0x1A1D4, 0x1E701880},	//x1y1 x0y0 [0022]
	...
	{0x1A1D4, 0x12FF00E0},	//x1y1x0y0	[0027]	 reg_skin_motion_ctrl
	...
	{0x1A1D4, 0x90605040},	//x3x2x1x0	[0024]	 reg_skin_gain_ctrl_yy
	{0x1A1D4, 0x90807060},	//x3x2x1x0	[0025]	 reg_skin_gain_ctrl_cb
	{0x1A1D4, 0x70605850},	//x3x2x1x0	[0026]	 reg_skin_gain_ctrl_cr
	{0x1A1D4, 0x10FF00E0},	//x1y1x0y0	[0027]	 reg_skin_motion_ctrl
	{0x1A1D4, 0xB0808080},	//x7y7 x6y6 [0015]	 default
	{0x1A1D4, 0x60805080},	//x5y5 x4y4 [0016]
	{0x1A1D4, 0x48803080},	//x3y3 x2y2 [0017]
	{0x1A1D4, 0x28802080},	//x1y1 x0y0 [0018]
};
