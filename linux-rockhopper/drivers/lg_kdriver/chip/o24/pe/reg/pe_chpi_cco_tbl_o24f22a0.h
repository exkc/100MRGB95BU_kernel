#ifndef _PE_CHPI_CCO_TBL_O24F22A0_H_
#define _PE_CHPI_CCO_TBL_O24F22A0_H_
...
}PE_O24F22_PE1_APL_CTRL_02_T;

typedef struct {
	UINT32 uaddr32;
	union {
	UINT32 udata32;
	struct {						//0xF4060720 RW
...
}PE_O24F22_PE1_DCE_CTRL_00_T;

typedef struct {
	UINT32 uaddr32;
	union {
	UINT32 udata32;
	struct {						//0xF4060770 RW
...
}PE_O24F22_PE1_DSE_CTRL_00_T;

typedef struct
{
	PE_O24F22_PE1_DCE_CTRL_00_T                    pe1_dce_ctrl_00;	//0xF4060720
	PE_O24F22_PE1_DSE_CTRL_00_T                    pe1_dse_ctrl_00;	//0xF4060770
}PE_CHPI_CCO_TBL_O24F22_T;
