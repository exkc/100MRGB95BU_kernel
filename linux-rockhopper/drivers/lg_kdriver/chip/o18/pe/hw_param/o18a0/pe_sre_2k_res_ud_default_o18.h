...
const PE_REG_PARAM_T sre_2k_res_ud_default_o18[] =
{
    {0x9100, 0x00000000},      // SHP_DP_CTRL_00
    {0x9110, 0x0671031B},      // SHP_FD_CTRL_00
    {0x9114, 0x0E000404},      // SHP_FD_CTRL_01
    {0x9118, 0x10020404},      // SHP_FD_CTRL_02
    {0x911C, 0x80FF5000},      // SHP_FD_CTRL_03
    {0x9120, 0x20800400},      // SHP_FD_CTRL_04
    {0x9124, 0x50FF1000},      // SHP_FD_CTRL_05
    {0x9128, 0x32FF0040},      // SHP_FD_CTRL_06
    {0x912C, 0x800C0008},      // SHP_FD_CTRL_07
    {0x9130, 0xFF20000C},      // SHP_FD_CTRL_08
    ...
    {0x916C, 0x62000600},      // SHP_MP_CTRL_03
    {0x9170, 0x00601000},      // SHP_MP_CTRL_04
    {0x9174, 0x00100401},      // SHP_MP_CTRL_05
    {0x9178, 0x00020201},      // SHP_MP_CTRL_06
    {0x917C, 0x00802020},      // SHP_MP_CTRL_07
    {0x9180, 0xC0603010},      // SHP_MP_CTRL_08
    {0x9184, 0x10FFC080},      // SHP_MP_CTRL_09
    {0x9188, 0x80C06030},      // SHP_MP_CTRL_0A
    {0x918C, 0x0000FFC0},      // SHP_MP_CTRL_0B
    {0x9190, 0x20201020},      // SHP_MP_CTRL_0C
    ...
    {0x91B0, 0x08080101},      // SHP_LC_CTRL_04
    ...
    {0x91D8, 0x30041800},      // SHP_DER_CTRL_06
    {0x91DC, 0x60C04008},      // SHP_DER_CTRL_07
    ...
    {0x91FC, 0xC0603010},      // SHP_SP_CTRL_07
    {0x9200, 0x10FFC080},      // SHP_SP_CTRL_08
    {0x9204, 0x80C06030},      // SHP_SP_CTRL_09
    {0x9208, 0x0000FFC0},      // SHP_SP_CTRL_0A
    {0x920C, 0x00000007},      // SHP_SP_CTRL_0B
    {0x9210, 0x10100818},      // SHP_SP_CTRL_0C
    {0x9220, 0x00008015},      // SHP_PTI_CTRL_00
    {0x9224, 0x00008014},      // SHP_PTI_CTRL_01
    {0x9228, 0x00000007},      // SHP_PTI_CTRL_02
    {0x922C, 0x00002020},      // SHP_PTI_CTRL_03
    {0x9230, 0x04002014},      // SHP_STI_CTRL_00
    {0x9240, 0x80000011},      // SHP_TGEN_CTRL_00
    ...
    {0x9270, 0x20200000},      // SHP_TGEN_CTRL_0B
    ...
    {0x92FC, 0x10100810},      // SHP_DCTP_CTRL_1F
    ...
    {0x9474, 0x00FF0620},      // SHP_DJ_CTRL_1D
    {0x9478, 0x00FF0414},      // SHP_DJ_CTRL_1E
    {0x947C, 0x00FF0620},      // SHP_DJ_CTRL_1F
