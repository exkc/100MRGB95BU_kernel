...
int DEMOD_E60_API_Suspend (void) {
	LX_DEMOD_L2_Context * frontend = NULL;

	frontend = DEMOD_E60_GetContext();
...
int DEMOD_E60_API_Status(char * pDbglog, int * pDbgidx) {
...
int DEMOD_E60_API_Dump(char * pDbglog, int * pDbgidx) {
