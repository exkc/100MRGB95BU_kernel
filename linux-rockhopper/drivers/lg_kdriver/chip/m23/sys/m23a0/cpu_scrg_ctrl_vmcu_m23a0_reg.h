#ifndef _CPU_SCRG_CTRL_VMCU_M23A0_REG_H_
#define _CPU_SCRG_CTRL_VMCU_M23A0_REG_H_
...
/*-----------------------------------------------------------------------------------------
    0xCABF_0000    crg_vmcu00 ''
-----------------------------------------------------------------------------------------*/
typedef struct {
    UINT32
    test_reserved             : 32;    //  31: 0
}CPU_SCRG_CTRL_VMCU_CRG_VMCU00_M23A0_T;

/*-----------------------------------------------------------------------------------------
    0xCABF_0004    crg_vmcu01 ''
-----------------------------------------------------------------------------------------*/
typedef struct {
    UINT32
    test_reserved_ro          : 32;    //  31: 0
}CPU_SCRG_CTRL_VMCU_CRG_VMCU01_M23A0_T;

/*-----------------------------------------------------------------------------------------
    0xCABF_0008    crg_vmcu02 ''
-----------------------------------------------------------------------------------------*/
typedef struct {
    UINT32
    reg_axi0_clk_gate_en      :  1,    //      0
    reg_axi1_clk_gate_en      :  1,    //      1
    reg_bus_clk_gate_en       :  1,    //      2
    reg_sys_0_clk_gate_en     :  1,    //      3
    reg_sys_1_clk_gate_en     :  1,    //      4
    reg_sys_2_clk_gate_en     :  1,    //      5
    reg_sys_3_clk_gate_en     :  1,    //      6
    reg_sys_4_clk_gate_en     :  1,    //      7
    reg_sys_5_clk_gate_en     :  1,    //      8
    reg_te_clk_gate_en        :  1,    //      9
    reg_vmcu_apb_clk_gate_en  :  1,    //     10
    reg_vmcu_mcu_clk_gate_en  :  1,    //     11
                              : 20;    //  31:12 reserved
}CPU_SCRG_CTRL_VMCU_CRG_VMCU02_M23A0_T;

/*-----------------------------------------------------------------------------------------
    0xCABF_000C    crg_vmcu03 ''
-----------------------------------------------------------------------------------------*/
typedef struct {
    UINT32
    ...
    reg_soft_rst_x_vmcu_0_axi_n: 1,    //     21
                              : 10;    //  31:22 reserved
}CPU_SCRG_CTRL_VMCU_CRG_VMCU03_M23A0_T;

/*-----------------------------------------------------------------------------------------
    cpu_scrg_ctrl_vmcu Register LIst
-----------------------------------------------------------------------------------------*/
typedef struct {
    CPU_SCRG_CTRL_VMCU_CRG_VMCU00_M23A0_T    crg_vmcu00;        // 0xCABF_0000
    CPU_SCRG_CTRL_VMCU_CRG_VMCU01_M23A0_T    crg_vmcu01;        // 0xCABF_0004
    CPU_SCRG_CTRL_VMCU_CRG_VMCU02_M23A0_T    crg_vmcu02;        // 0xCABF_0008
    CPU_SCRG_CTRL_VMCU_CRG_VMCU03_M23A0_T    crg_vmcu03;        // 0xCABF_000C
}CPU_SCRG_CTRL_VMCU_REG_M23A0_T;
/* 4 regs */
...
#define CPU_SCRG_CTRL_VMCU_CRG_VMCU00_M23A0_T_OFF           (BASEADDRESS+0x0000)
#define CPU_SCRG_CTRL_VMCU_CRG_VMCU01_M23A0_T_OFF           (BASEADDRESS+0x0004)
#define CPU_SCRG_CTRL_VMCU_CRG_VMCU02_M23A0_T_OFF           (BASEADDRESS+0x0008)
#define CPU_SCRG_CTRL_VMCU_CRG_VMCU03_M23A0_T_OFF           (BASEADDRESS+0x000C)
...
typedef union {
    UINT32 udata32;
    struct {
    UINT32 reg_axi0_clk_gate_en: 1;    //      0
    UINT32 reg_axi1_clk_gate_en: 1;    //      1
    UINT32 reg_bus_clk_gate_en:  1;    //      2
    UINT32 reg_sys_0_clk_gate_en: 1;    //     3
    UINT32 reg_sys_1_clk_gate_en: 1;    //     4
    UINT32 reg_sys_2_clk_gate_en: 1;    //     5
    UINT32 reg_sys_3_clk_gate_en: 1;    //     6
    UINT32 reg_sys_4_clk_gate_en: 1;    //     7
    UINT32 reg_sys_5_clk_gate_en: 1;    //     8
    UINT32 reg_te_clk_gate_en :  1;    //      9
    UINT32 reg_vmcu_apb_clk_gate_en: 1;    //  10
    UINT32 reg_vmcu_mcu_clk_gate_en: 1;    //  11
