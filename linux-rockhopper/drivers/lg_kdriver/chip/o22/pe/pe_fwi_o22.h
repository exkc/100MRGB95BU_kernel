...
#ifndef	_PE_FWI_O22_H_
#define	_PE_FWI_O22_H_
...
----------------------------------------------------------------------------------------*/
#define PE_FWI_O22_BASE_OFFSET				0
#define PE_FWI_O22_TNR_CTRL_OFFSET			PE_FWI_O22_BASE_OFFSET
#define PE_FWI_O22_FW_CTRL_OFFSET			(PE_FWI_O22_TNR_CTRL_OFFSET+sizeof(PE_FWI_O22_TNR_CTRL))
#define PE_FWI_O22_SRC_INFO_OFFSET			(PE_FWI_O22_FW_CTRL_OFFSET+sizeof(PE_FWI_O22_FW_CTRL))
#define PE_FWI_O22_DNR_COMMON_OFFSET		(PE_FWI_O22_SRC_INFO_OFFSET+sizeof(PE_FWI_O22_SRC_INFO))
#define PE_FWI_O22_DNR_DETAIL_OFFSET		(PE_FWI_O22_DNR_COMMON_OFFSET+sizeof(PE_FWI_O22_DNR_COMMON))

#define PE_FWI_O22_EDGE_GAIN_OFFSET			(PE_FWI_O22_DNR_DETAIL_OFFSET+sizeof(PE_FWI_O22_DNR_DETAIL))
#define PE_FWI_O22_TEXTURE_GAIN_OFFSET		(PE_FWI_O22_EDGE_GAIN_OFFSET+sizeof(PE_FWI_O22_EDGE_GAIN))

#define PE_FWI_O22_REFRESH_TBL_OFST			PE_FWI_O22_BASE_OFFSET
#define PE_FWI_O22_REFRESH_TBL_SIZE			(PE_FWI_O22_TEXTURE_GAIN_OFFSET+sizeof(PE_FWI_O22_TEXTURE_GAIN))

#if 0	//not_used
#define PE_FWI_O22_HOR_CTRL_OFFSET			(PE_FWI_O22_FW_CTRL_OFFSET+sizeof(PE_FWI_O22_FW_CTRL))
#define PE_FWI_O22_MISC_CTRL_OFFSET			(PE_FWI_O22_HOR_CTRL_OFFSET+sizeof(PE_FWI_O22_HOR_CTRL))
#define PE_FWI_O22_CEN_CTRL_OFFSET			(PE_FWI_O22_TEXTURE_GAIN_OFFSET+sizeof(PE_FWI_O22_TEXTURE_GAIN))
#endif
...
#define PE_FWI_O22_DNR_CMN_SIZE	10
/**
...
typedef struct
{
	UINT8 data[PE_FWI_O22_DNR_CMN_SIZE];	///< dnr data
}
PE_FWI_O22_DNR_COMMON;

/* see LX_PE_NRD_DNR6_DTL_DCBNR_SIZE, LX_PE_NRD_DNR6_DTL_ACBNR_SIZE, LX_PE_NRD_DNR6_DTL_MSQNR_SIZE */
#define PE_FWI_O22_DNR_DCB_SIZE	24
#define PE_FWI_O22_DNR_ACB_SIZE	31
/**
...
typedef struct
{
	UINT8 dc_bnr[PE_FWI_O22_DNR_DCB_SIZE];	///< dc bnr
	UINT8 ac_bnr[PE_FWI_O22_DNR_ACB_SIZE];	///< ac bnr
}
PE_FWI_O22_DNR_DETAIL;
 ...
 */
typedef struct {
	PE_FWI_O22_TNR_CTRL			tnr_ctrl;		///< tnr ctrl
	PE_FWI_O22_FW_CTRL			fw_ctrl;		///< fwi ctrl
	PE_FWI_O22_SRC_INFO			src_info;		///< src info
	PE_FWI_O22_DNR_COMMON		dnr_common;		///< dnr common
	PE_FWI_O22_DNR_DETAIL		dnr_detail;		///< dnr detail
	PE_FWI_O22_EDGE_GAIN		shp_e_ctrl;		///< edge ctrl
	PE_FWI_O22_TEXTURE_GAIN		shp_t_ctrl;		///< texture ctrl
	#if 0	//not_used
	PE_FWI_O22_HOR_CTRL			shp_h_ctrl;		///< hor ctrl
	PE_FWI_O22_MISC_CTRL		shp_m_ctrl;		///< misc ctrl
	PE_FWI_O22_CEN_CTRL			cen_ctrl;		///< cen ctrl
	#endif
}
PE_FWI_O22_PQ_IPC_CTRL;
...
typedef struct
{
	PE_FWI_O22_TNR_CTRL			tnr_ctrl[LX_PE_WIN_NUM];		///< tnr ctrl
	PE_FWI_O22_FW_CTRL			fw_ctrl;						///< fwi ctrl
	PE_FWI_O22_SRC_INFO			src_info;						///< src info
	PE_FWI_O22_STATUS_T			fw_status;						///< fw status
	PE_FWI_O22_HOR_CTRL			shp_h_ctrl;						///< hor ctrl
	PE_FWI_O22_MISC_CTRL		shp_m_ctrl;						///< misc ctrl
	PE_FWI_O22_EDGE_GAIN		shp_e_ctrl;						///< edge ctrl
	PE_FWI_O22_TEXTURE_GAIN		shp_t_ctrl;						///< texture ctrl
	PE_FWI_O22_CEN_CTRL			cen_ctrl[LX_PE_CMG_REGION_NUM];	///< cen ctrl
	PE_FWI_O22_DNR_COMMON		dnr_common;						///< dnr common
	PE_FWI_O22_DNR_DETAIL		dnr_detail;						///< dnr detail
	UINT32 							pre_colormetry[2]; ///<pre colormetry info
}
PE_FWI_O22_SETTINGS_T;
/**
...
PE_FWI_O22_PUSH_MODE_T;

/**
 * PE_FWI_O22_CSC_INPUT_T
 */
typedef struct
{
...
int PE_FWI_O22_SetColorFilter(UINT32 value);
