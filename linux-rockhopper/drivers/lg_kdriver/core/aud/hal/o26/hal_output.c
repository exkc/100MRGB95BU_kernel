...
------------------------------------------------------------------------------*/
#define LOCAL_DEFINE_EARC_PHY

#ifndef CHIP_TYPE_FPGA
#define EARC_LINK0_REG_BASE         0xC8713900
#define EARC_LINK0_REG_SIZE         0x100

#define EARC_LINK_REG_BASE          0xC8714000
#define EARC_LINK_REG_SIZE          0x1000

#define EARC_INT_REG_BASE           0xC8715300
#define EARC_INT_REG_SIZE           0x1000

#ifdef LOCAL_DEFINE_EARC_PHY
...
static unsigned int gEarcDmacConfig0 = 0x00008020;      // I2S 24bits, I2S IF(up to 8 ch)
#else
...
#else
static unsigned int gEarcAudioBpClkRatio = 0x1;
static unsigned int gEarcAudioClkSampleFreq = 0x1;
#endif
...
{
    aud_hal_output_set_number_of_i2s (1);
...
{
    AUD_REG_Wr (PERI_CTRL, pcmsub0outcmda, (on) ? 1 : 0);
    AUD_REG_WrFL (PERI_CTRL, pcmsub0outcmda);
    AUD_REG_Wr (PERI_CTRL, pcmsub0starta, (on) ? 1 : 0);
    AUD_REG_WrFL (PERI_CTRL, pcmsub0starta);
}
...
#else
    earc_user_pdb = AUD_REG_Rd (EARC_PHY, reg0x1);
    if (earc_user_pdb != 0x11)
    {
        AUD_REG_Wr (EARC_PHY, reg0x1, 0x00);      // USER_PDB, USER_APHY_DMAC_DRV_8PHASE_EN
        AUD_REG_Wr (EARC_PHY, reg0x1, 0x11);      // USER_PDB, USER_APHY_DMAC_DRV_8PHASE_EN
...
int aud_hal_output_init (void)
{
    ...
    ret =
        request_irq (O26_IRQ_HDMIRX_PRT2_EARC_CPU, audio_hal_earc_irq, IRQF_TRIGGER_NONE,
        "eARC", NULL);
    if (ret < 0)
...
void aud_hal_output_exit (void)
{
    free_irq (O26_IRQ_HDMIRX_PRT2_EARC_CPU, NULL);
...
void aud_hal_output_set_number_of_i2s (int number)
{
    ...
    if (number >= 1)
    {
        ...
        CTOP_CTRL_O26Ax_Wr01 (CPU_IOMUX_CTRL_WOC, pad_woc64, reg_pad_aec_lrch0_mux_sel, 0x0);
    ...
    {
        CTOP_CTRL_O26Ax_RdFL (CPU_IOMUX_CTRL_WOC, pad_woc65);
        CTOP_CTRL_O26Ax_Wr01 (CPU_IOMUX_CTRL_WOC, pad_woc65, reg_pad_dacslrch_mux_sel, 0x0);
        CTOP_CTRL_O26Ax_WrFL (CPU_IOMUX_CTRL_WOC, pad_woc65);
    }
#else
    // 0 ~ 5 ch : 12 ch, ws, bck
    if (number >= 1)
    {
        ...
        // (MODE4):i2s_sb_dac_bck, (MODE5):aud_clk_out
        CTOP_CTRL_O26Ax_Wr01 (IOMUX_CTRL_AUD, pad_aud64, reg_pad_gpio00_mux_sel, 0x5);
        // (MODE4):i2s_sb_dac_bck
        CTOP_CTRL_O26Ax_Wr01 (IOMUX_CTRL_AUD, pad_aud64, reg_pad_gpio05_mux_sel, 0x4);
        // (MODE4):i2s_sb_dac0lrch
        CTOP_CTRL_O26Ax_Wr01 (IOMUX_CTRL_AUD, pad_aud64, reg_pad_gpio01_mux_sel, 0x4);
        CTOP_CTRL_O26Ax_WrFL (IOMUX_CTRL_AUD, pad_aud64);

        CTOP_CTRL_O26Ax_RdFL (IOMUX_CTRL_AUD, pad_aud66);
        // (MODE4):i2s_sb_dac_ws
        CTOP_CTRL_O26Ax_Wr01 (IOMUX_CTRL_AUD, pad_aud66, reg_pad_gpio18_mux_sel, 0x4);
        CTOP_CTRL_O26Ax_WrFL (IOMUX_CTRL_AUD, pad_aud66);
    }

    if (number >= 2)
    {
        CTOP_CTRL_O26Ax_RdFL (IOMUX_CTRL_AUD, pad_aud64);
        // (MODE4):i2s_sb_dac1lrch
        CTOP_CTRL_O26Ax_Wr01 (IOMUX_CTRL_AUD, pad_aud64, reg_pad_gpio02_mux_sel, 0x4);
        CTOP_CTRL_O26Ax_WrFL (IOMUX_CTRL_AUD, pad_aud64);
    }
    ...
    if (number >= 4)
    {
        ...
        // (MODE4):i2s_sb_dac2_lrch
        CTOP_CTRL_O26Ax_Wr01 (IOMUX_CTRL_AUD, pad_aud65, reg_pad_gpio16_mux_sel, 0x4);
        CTOP_CTRL_O26Ax_WrFL (IOMUX_CTRL_AUD, pad_aud65);

        CTOP_CTRL_O26Ax_RdFL (IOMUX_CTRL_AUD, pad_aud64);
        // (MODE4):i2s_sb_dac3lrch
        CTOP_CTRL_O26Ax_Wr01 (IOMUX_CTRL_AUD, pad_aud64, reg_pad_gpio07_mux_sel, 0x4);
        CTOP_CTRL_O26Ax_WrFL (IOMUX_CTRL_AUD, pad_aud64);
    }
    ...
    {
        CTOP_CTRL_O26Ax_RdFL (IOMUX_CTRL_AUD, pad_aud64);
        // (MODE4):i2s_sb_dac4lrch
        CTOP_CTRL_O26Ax_Wr01 (IOMUX_CTRL_AUD, pad_aud64, reg_pad_gpio08_mux_sel, 0x4);
        CTOP_CTRL_O26Ax_WrFL (IOMUX_CTRL_AUD, pad_aud64);

        CTOP_CTRL_O26Ax_WrFL (IOMUX_CTRL_AUD, pad_aud64);
        // (MODE4):i2s_sb_dac5_lrch
        CTOP_CTRL_O26Ax_Wr01 (IOMUX_CTRL_AUD, pad_aud65, reg_pad_gpio09_mux_sel, 0x4);
        CTOP_CTRL_O26Ax_WrFL (IOMUX_CTRL_AUD, pad_aud65);
    }
    ...
    {
        CTOP_CTRL_O26Ax_RdFL (IOMUX_CTRL_AUD, pad_aud65);
        // (MODE4):i2s_sb_dac6lrch
        CTOP_CTRL_O26Ax_Wr01 (IOMUX_CTRL_AUD, pad_aud65, reg_pad_gpio10_mux_sel, 0x4);
        CTOP_CTRL_O26Ax_WrFL (IOMUX_CTRL_AUD, pad_aud65);

        CTOP_CTRL_O26Ax_RdFL (IOMUX_CTRL_AUD, pad_aud65);
        // (MODE4):i2s_sb_dac7lrch
        CTOP_CTRL_O26Ax_Wr01 (IOMUX_CTRL_AUD, pad_aud65, reg_pad_gpio11_mux_sel, 0x4);
        CTOP_CTRL_O26Ax_WrFL (IOMUX_CTRL_AUD, pad_aud65);
    }
    ...
    if (number >= 10)
    {
        // for pc out
        CTOP_CTRL_O26Ax_RdFL (IOMUX_CTRL_AUD, pad_aud65);
        // (MODE4):i2s_sb_dac8lrch
        CTOP_CTRL_O26Ax_Wr01 (IOMUX_CTRL_AUD, pad_aud65, reg_pad_gpio12_mux_sel, 0x4);
        CTOP_CTRL_O26Ax_WrFL (IOMUX_CTRL_AUD, pad_aud65);

        // for hp out
        CTOP_CTRL_O26Ax_RdFL (IOMUX_CTRL_AUD, pad_aud66);
        // (MODE4):i2s_sb_dac9lrch
        CTOP_CTRL_O26Ax_Wr01 (IOMUX_CTRL_AUD, pad_aud66, reg_pad_gpio17_mux_sel, 0x4);
        CTOP_CTRL_O26Ax_WrFL (IOMUX_CTRL_AUD, pad_aud66);
    }
#endif
    ...
    {
        CTOP_CTRL_O26Ax_RdFL (CPU_IOMUX_CTRL_WOC, pad_woc64);
        CTOP_CTRL_O26Ax_Wr01 (CPU_IOMUX_CTRL_WOC, pad_woc64, reg_pad_pcmi3lrck_mux_sel, 0x0);
        CTOP_CTRL_O26Ax_Wr01 (CPU_IOMUX_CTRL_WOC, pad_woc64, reg_pad_pcmi3sck_mux_sel, 0x0);
        CTOP_CTRL_O26Ax_WrFL (CPU_IOMUX_CTRL_WOC, pad_woc64);
    ...
    if (number == 0)
    {
        ...
        AUD_REG_WrFL (PERI_CTRL, ocma);
#ifdef SUPPORT_SOUNDBAR
        AUD_REG_RdFL (PERI_CTRL, earc_ocma);
        AUD_REG_WrFd (PERI_CTRL, earc_ocma, earc_dack_mask, 0);
        AUD_REG_WrFL (PERI_CTRL, earc_ocma);
#endif
    }
    else
    {
...
#ifdef SUPPORT_SOUNDBAR
        AUD_REG_RdFL (PERI_CTRL, earc_ocma);
        AUD_REG_WrFd (PERI_CTRL, earc_ocma, earc_dack_mask, 1);
        AUD_REG_WrFL (PERI_CTRL, earc_ocma);
#endif
    }

    noti ("O26 I2S Number(%d)\n", number);
}
...
static void audio_hal_earc_monitor_lock (void)
{
    ...
    do
    {
        ...
        earc_phy_lock &= 0x10;
        if (!(earc_phy_lock & 0x10))
            usleep_range (200, 200);
        else
            break;
#else
        AUD_REG_RdFL (EARC_PHY, reg0x17);
        earc_phy_lock = AUD_REG_Rd01 (EARC_PHY, reg0x17, monitor_aphy_frpll_lock_out);
        if (!earc_phy_lock)
            usleep_range (200, 200);
        else
            break;
    ...
    if (!earc_phy_lock)
        error ("[%d] earc_phy_lock:%x\n", count, earc_phy_lock);
    else
        info ("[%d] earc_phy_lock:%x\n", count, earc_phy_lock);
}
...
{
#ifdef LOCAL_DEFINE_EARC_PHY
    EARC_PHY_WR (0x05C, 0x01);  // USER_DMAC_DRV_EN_FORCE : 1 : controlled by phy
#else
    AUD_REG_RdFL (EARC_PHY, reg0x17);
    AUD_REG_WrFd (EARC_PHY, reg0x17, user_dmac_drv_en_force, 0x01);  // USER_DMAC_DRV_EN_FORCE : 1 force to high
    AUD_REG_WrFL (EARC_PHY, reg0x17);
#endif
    debug ("Start Sending.\n");
}
...
{
#ifdef LOCAL_DEFINE_EARC_PHY
    EARC_PHY_WR (0x05C, 0x01);  // USER_DMAC_DRV_EN_FORCE : 1 force to high
#else
    AUD_REG_RdFL (EARC_PHY, reg0x17);
    AUD_REG_WrFd (EARC_PHY, reg0x17, user_dmac_drv_en_force, 0x01);  // USER_DMAC_DRV_EN_FORCE : 1 force to high
    AUD_REG_WrFL (EARC_PHY, reg0x17);
...
#ifdef LOCAL_DEFINE_EARC_PHY
    EARC_PHY_WR (0x05C, 0x00);  // USER_DMAC_DRV_EN_FORCE : 2 : force to low
#else
    AUD_REG_RdFL (EARC_PHY, reg0x17);
    AUD_REG_WrFd (EARC_PHY, reg0x17, user_dmac_drv_en_force, 0x00);  // USER_DMAC_DRV_EN_FORCE : 0 force to low
    AUD_REG_WrFL (EARC_PHY, reg0x17);
#endif
...
void audio_hal_earc_set_on (bool on)
{
    if (on == ON)
    {
        ...
        EARC_PHY_WR (0x04C, 0x00);      // USER_DMAC_FEM_CLK_SEL
        EARC_PHY_WR (0x014, 0x01);      // USER_APHY_PLL_FORCE
        EARC_PHY_WR (0x030, gEarcPllBpClk);
#else
        if (lx_chip_rev () >= LX_CHIP_REV (O20, B0))
            AUD_REG_Wr (EARC_PHY, reg0x2, 0x43);  // DMAC Driver Current Control (default : 0x43)
        else
            AUD_REG_Wr (EARC_PHY, reg0x2, 0x63);  // DMAC Driver Current Control (default : 0x43)

        AUD_REG_Wr (EARC_PHY, reg0x1b, 0x00);    // USER_CMDC_RX_EN_FORCE 0(controlled by hdmi), USER_CMDC_DRV_EN_FORCE 0(controlled by hdmi)
        AUD_REG_Wr (EARC_PHY, reg0x1, 0x11);    // USER_PDB, USER_APHY_DMAC_DRV_PHASE_EN
        AUD_REG_Wr (EARC_PHY, reg0x13, 0x00);   // USER_DMAC_FEM_CLK_SEL : 0(non-inversion dmac clk)
        AUD_REG_Wr (EARC_PHY, reg0x5, 0x01);    // USER_APHY_PLL_FORCE

        AUD_REG_RdFL (EARC_PHY, reg0xc);
        AUD_REG_WrFd (EARC_PHY, reg0xc, user_audio_bp_clk_ratio, gEarcAudioBpClkRatio);
        AUD_REG_WrFd (EARC_PHY, reg0xc, user_audio_clk_sample_freq, gEarcAudioClkSampleFreq);
        AUD_REG_WrFL (EARC_PHY, reg0xc);
#endif
...
#ifdef LOCAL_DEFINE_EARC_PHY
        EARC_PHY_WR (0x05C, 0x01);      // DMAC_DIFF_PHY_DRV_EN 0x01 : enable
        EARC_PHY_WR (0x054, 0x00);      // USER_DMAC_FEM_MODE 0 : FEM Enable
#else
        AUD_REG_RdFL (EARC_PHY, reg0x17);
        AUD_REG_WrFd (EARC_PHY, reg0x17, user_dmac_drv_en_force, 0x01);  // USER_DMAC_DRV_EN_FORCE : 1 force to high
        AUD_REG_WrFL (EARC_PHY, reg0x17);
        AUD_REG_RdFL (EARC_PHY, reg0x15);
        AUD_REG_WrFd (EARC_PHY, reg0x15, user_dmac_fem_mode, 0x00);  // USER_DMAC_FEM_MODE : 0 FEM Enable
        AUD_REG_WrFL (EARC_PHY, reg0x15);
#endif
...
#else
        AUD_REG_Wr (EARC_PHY, reg0xe, 0x2f);      // USER_AUD_SPDIF_DATA_SEL(1:aoc 2:extern) USER_AUD_EXTERN_SPDIF_DATA_CTRL
        AUD_REG_Wr (EARC_PHY, reg0xf, 0x2f);      // USER_AUD_I2S_DATA_SEL(1:aoc 2:extern) USER_AUD_EXTERN_I2S_DATA_CTRL

        AUD_REG_Wr (EARC_PHY, reg0x14, 0x00);      // USER_DMAC_BP_MODE USER_DMAC_FEM_IN_SEL
#endif
...
static void audio_hal_earc_set_pll_bp_clock (unsigned int sampling_freq)
{
    ...
    AUD_REG_RdFL (EARC_PHY, reg0xc);
    if (sampling_freq == 32000)
        gEarcAudioClkSampleFreq = 0;
    else if (sampling_freq == 64000)
        gEarcAudioClkSampleFreq = 1;
    else if (sampling_freq == 128000)
        gEarcAudioClkSampleFreq = 2;
    else if (sampling_freq == 44100)
        gEarcAudioClkSampleFreq = 3;
    else if (sampling_freq == 88200)
        gEarcAudioClkSampleFreq = 4;
    else if (sampling_freq == 176400)
        gEarcAudioClkSampleFreq = 5;
    else if (sampling_freq == 48000)
        gEarcAudioClkSampleFreq = 6;
    else if (sampling_freq == 96000)
        gEarcAudioClkSampleFreq = 7;
    else if (sampling_freq == 192000)
        gEarcAudioClkSampleFreq = 8;
    else
    {
        error ("sampling freq(%d) is invalid.\n", sampling_freq);
        gEarcAudioClkSampleFreq = 6;
...
void audio_hal_earc_set_channel (unsigned int channel, unsigned int acmod)
{
    ...
    AUD_REG_RdFL (EARC_PHY, reg0xc);
    if ((channel == 8) || (channel == 6))
        gEarcAudioBpClkRatio = 1;
    else
        gEarcAudioBpClkRatio = 0;
    AUD_REG_WrFd (EARC_PHY, reg0xc, user_audio_bp_clk_ratio, gEarcAudioBpClkRatio);
    AUD_REG_WrFL (EARC_PHY, reg0xc);
#endif
...
void audio_hal_speaker_start (bool on)
{
    if (on == false)
    {
        //SPK I2S enable
        CTOP_CTRL_O26Ax_RdFL (CPU_IOMUX_CTRL_WOC, pad_woc64);
        CTOP_CTRL_O26Ax_Wr01 (CPU_IOMUX_CTRL_WOC, pad_woc64, reg_pad_daclrch_mux_sel, 0x1);
        CTOP_CTRL_O26Ax_WrFL (CPU_IOMUX_CTRL_WOC, pad_woc64);

        CTOP_CTRL_O26Ax_RdFL (CPU_IOMUX_CTRL_WOC, pad_woc65);
        CTOP_CTRL_O26Ax_Wr01 (CPU_IOMUX_CTRL_WOC, pad_woc65, reg_pad_daclrck_mux_sel, 0x1);
        CTOP_CTRL_O26Ax_Wr01 (CPU_IOMUX_CTRL_WOC, pad_woc65, reg_pad_dacsck_mux_sel, 0x1);
        CTOP_CTRL_O26Ax_WrFL (CPU_IOMUX_CTRL_WOC, pad_woc65);
...
void audio_hal_pc_start (bool on)
{
    AUD_REG_Wr (PERI_CTRL, pcmsub1outcmda, (on) ? 1 : 0);
    AUD_REG_WrFL (PERI_CTRL, pcmsub1outcmda);
    AUD_REG_Wr (PERI_CTRL, pcmsub1starta, (on) ? 1 : 0);
    AUD_REG_WrFL (PERI_CTRL, pcmsub1starta);
}
#endif
