...
} LX_DEMOD_L2_DVB_MULTI_PLP_ID_T;
...
{
	UINT8 plpTotalCount; /*number of total PLP */
	UINT8 plpID[255]; /* array of PLP ID */

} LX_DEMOD_L2_DVBT2_MULTI_PLP_ID_T;
...
extern UINT8 DEMOD_L2_DVB_SW_Init            (LX_DEMOD_L2_Context *front_end  , UINT32 demodAdd);

extern UINT8   DEMOD_L2_DVB_Set_demod   (LX_DEMOD_L2_Context *front_end
												, UINT8 standard
												, UINT32 freq
												, UINT8 tuneMode
...
extern UINT8  DEMOD_L2_DVB_AutoModeDetectOn         (LX_DEMOD_L2_Context *front_end);

extern UINT8  DEMOD_L2_DVB_AutoModeDetectOff      (LX_DEMOD_L2_Context *front_end);
extern UINT8  DEMOD_L2_DVB_Set_PLP_Select(LX_DEMOD_L2_Context *frontend,  UINT8 plp_id, UINT8   plp_id_sel_mode);
extern UINT8  DEMOD_L2_DVBC_Set_SymbolRate_Detect(LX_DEMOD_L2_Context *frontend,  UINT8 autoEn, UINT8   symbol_rate_Kbps);
extern UINT8  DEMOD_L2_DVB_Get_PLP_ID   (LX_DEMOD_L2_Context *front_end, LX_DEMOD_L2_DVB_MULTI_PLP_ID_T *pPlpParams);
extern UINT8  DEMOD_L2_DVBT2_Set_BaseAddr_AXI(LX_DEMOD_L2_Context *frontend, UINT32 baseAddr1, UINT32 baseAddr2 );
extern UINT8  DEMOD_L2_DVB_Set_BaseAddr_AXI(LX_DEMOD_L2_Context *frontend, UINT32 baseAddr1, UINT32 baseAddr2, UINT32 baseAddr3 );
