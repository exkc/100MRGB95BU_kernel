 ...
 *	by defualt, all firmwares are NOT used
 */
#ifndef CONFIG_LX_H13_CHIP_FIRMWARE
#define CONFIG_LX_H13_CHIP_FIRMWARE 0	/* off by default */
#endif

#ifndef CONFIG_LX_M14_CHIP_FIRMWARE
#define CONFIG_LX_M14_CHIP_FIRMWARE 0	/* off by default */
#endif

#ifndef CONFIG_LX_H14_CHIP_FIRMWARE
#define CONFIG_LX_H14_CHIP_FIRMWARE 0	/* off by default */
#endif

#ifndef CONFIG_LX_H15_CHIP_FIRMWARE
#define CONFIG_LX_H15_CHIP_FIRMWARE 0	/* off by default */
#endif

#ifndef CONFIG_LX_M16_CHIP_FIRMWARE
#define CONFIG_LX_M16_CHIP_FIRMWARE 0	/* off by default */
#endif

#ifndef CONFIG_LX_M17_CHIP_FIRMWARE
#define CONFIG_LX_M17_CHIP_FIRMWARE 0	/* off by default */
#endif

#ifndef CONFIG_LX_O18_CHIP_FIRMWARE
#define CONFIG_LX_O18_CHIP_FIRMWARE 0	/* off by default */
#endif

#ifndef CONFIG_LX_M19_CHIP_FIRMWARE
#define CONFIG_LX_M19_CHIP_FIRMWARE 0	/* off by default */
#endif
...
#ifndef CONFIG_LX_FB3_WIDTH
#define CONFIG_LX_FB3_WIDTH			0		/* auto detect */
#endif

#ifndef CONFIG_LX_FB3_HEIGHT
#define CONFIG_LX_FB3_HEIGHT		0		/* auto detect */
#endif
...
/*----------------------------------------------------------------------------------------
 * CMA stage definition -- CMA will be used with step-by-step policy
 *
 ...
 * STAGE3 -- FULL CMA
 *
 * @note many kdirver might use the CMA STAGE variable
 * @note CMA is actually activated by kernel. contact to chanho.min@lge.com
 * @note CMA stage level might be useless. only STAGE_0 and STAGE_1 is meaningful.
 *
 ----------------------------------------------------------------------------------------*/
#define LX_CMA_STAGE_0     0
#define LX_CMA_STAGE_1     1
#define LX_CMA_STAGE_2     2
#define LX_CMA_STAGE_3     3

#ifndef LX_CMA_STAGE
#define LX_CMA_STAGE       LX_CMA_STAGE_0	/* DO NOT use CMA by default */
#endif
