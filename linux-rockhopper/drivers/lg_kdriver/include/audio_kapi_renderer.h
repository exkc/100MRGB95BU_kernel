...
#define AUD_REN_IOR_GET_UNLOCKED_STATUS     _IOR(AUD_REN_IOC_MAGIC, 19, LX_AUD_RENDERED_STATUS_T)
...
#define AUD_REN_IOW_SET_INDEX_CTX_ES        _IOW(AUD_REN_IOC_MAGIC, 23, LX_AUD_DEV_INDEX_CTX_T)
#define AUD_REN_IOW_SET_INPUTCTRL_VOLUME    _IOW(AUD_REN_IOC_MAGIC, 24, UINT32)
#define AUD_REN_IOW_SET_INPUTCTRL_MUTE      _IOW(AUD_REN_IOC_MAGIC, 25, UINT32)
#define AUD_REN_IOW_SET_INPUTCTRL_DELAY     _IOW(AUD_REN_IOC_MAGIC, 26, UINT32)
...
#define AUD_REN_IOW_SET_LIPSYNC_CONFIG      _IOW(AUD_REN_IOC_MAGIC, 30, LX_AUD_RENDER_CONFIG_LIPSYNC_T)
#define AUD_REN_IOW_SET_PLAY_TO_PTS         _IOW(AUD_REN_IOC_MAGIC, 31, UINT32)
#define AUD_REN_IOW_SET_EASE_VOLUME         _IOW(AUD_REN_IOC_MAGIC, 32, LX_AUD_RENDER_EASE_VOLUME_T)
#define AUD_REN_IOW_SET_PROTECT_MODE        _IOW(AUD_REN_IOC_MAGIC, 33, UINT32)
#define AUD_REN_IOR_GET_EASE_VOLUME         _IOR(AUD_REN_IOC_MAGIC, 34, UINT32)
#define AUD_REN_IOW_SAVE_MEDIA_INFO         _IOW(AUD_REN_IOC_MAGIC, 35, LX_AUD_REN_MEDIA_INFO_T)

#define AUD_REN_IOW_FEED_BLOCKING           _IOW(AUD_REN_IOC_MAGIC, 40, LX_AUD_RENDER_FEED_T)
#define AUD_REN_IOW_SET_EVENT_MASK          _IOW(AUD_REN_IOC_MAGIC, 41, LX_AUD_EVENT_MSG_T)
#define AUD_REN_IOR_GET_EVENT_MSG           _IOR(AUD_REN_IOC_MAGIC, 42, LX_AUD_EVENT_MSG_T)
#define AUD_REN_IOW_FEED_BYPASS             _IOW(AUD_REN_IOC_MAGIC, 43, LX_AUD_RENDER_FEED_T)
#define AUD_REN_IOW_FEED_BYPASS_BLOCKING    _IOW(AUD_REN_IOC_MAGIC, 44, LX_AUD_RENDER_FEED_T)
#define AUD_REN_IOW_FEED_ASYNC              _IOW(AUD_REN_IOC_MAGIC, 45, LX_AUD_RENDER_FEED_T)

#define AUD_REN_IOW_SET_MIXER_ACMOD			_IOW(AUD_REN_IOC_MAGIC, 50, UINT32)

#define AUD_REN_IOW_SET_GAP_INFO			_IOW(AUD_REN_IOC_MAGIC, 51, LX_AUD_GAP_INFO_T)

#define AUD_REN_IOR_GET_RTS_QUEUE_INFO      _IOR(AUD_REN_IOC_MAGIC, 52, LX_AUD_RENDER_RTS_QUEUE_INFO_T)
...
typedef enum {
    ...
    LX_AUD_RENDER_CLK_TYPE_GSTC         =   0x100,      ///< global STC 0.
    LX_AUD_RENDER_CLK_TYPE_GSTC_1       =   0x101,      ///< global STC 1.
...
typedef  enum
{
    ...
    LX_AUD_TRICK_FAST_FOWARD_1P25X  = 10,   ///<  rate : 1.25 硅加Play
    LX_AUD_TRICK_MAX,
} LX_AUD_TRICK_MODE_T;
...
typedef struct {
    ...
    BOOLEAN                         bSetTrickMode;      ///< Render mode for trick play control.(TRUE : sola is used, FALSE : not used)
} LX_AUD_RENDER_PARAM_T;

/**
 * AUDIO Renderer EaseVolume For Netflix Ease .
 */
typedef struct {
...
typedef struct {
    ...
    LX_AUD_EASE_TYPE_T          ui32EaseType;           ///< easeType.
} LX_AUD_RENDER_EASE_VOLUME_T;
...
typedef struct {
    ...
    LX_AUD_DATA_TYPE_T          dataType;               ///< audio data type(0:PCM, 1:ES, 2:Metadata)
 ...
 */
typedef struct {
    UINT32                      preroll;                ///< prerolled or not
    UINT32                      currentState;           ///< current state
    UINT32                      reserved[5];            ///< reserved
} LX_AUD_REN_MEDIA_INFO_T;

/**
 * RTS Queue Info from DSP.
 * adec ioctl parameter.
 * @see AUD_REN_IOR_GET_RTS_QUEUE_INFO
*/
struct LX_AUD_RENDER_RTS_QUEUE_INFO_T {
    UINT32                ui32QueueMax;
    UINT32                ui32QueuedByte;
};

typedef struct LX_AUD_RENDER_RTS_QUEUE_INFO_T LX_AUD_RENDER_RTS_QUEUE_INFO_T;

/**
 * Lip Sync Info from DSP for audio drop status.
*/
struct LX_AUD_RENDER_LIPSYNC_INFO_T {
    UINT32                ui32SkipCount;
    UINT32                ui32RepeatCount;
    UINT32                ui32DiscontinuityCount;
    UINT32                ui32FreeRunCount;
};
typedef struct LX_AUD_RENDER_LIPSYNC_INFO_T LX_AUD_RENDER_LIPSYNC_INFO_T;
