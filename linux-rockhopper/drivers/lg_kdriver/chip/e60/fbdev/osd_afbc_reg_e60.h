...
#ifndef __OSD_AFBC_REG_E60_H__
#define __OSD_AFBC_REG_E60_H__
...
#define AFBC_CTRL_Off(id,_r)     	 			((UINT64)&(g_osd_afbc_e60_reg_shadow[id]->_r) - (UINT64)(g_osd_afbc_e60_reg_shadow[id]))
#define AFBC_CTRL_RdFL(id,_r)					((g_osd_afbc_e60_reg_shadow[id]->_r)=(g_osd_afbc_e60_reg[id]->_r))
#ifdef FBDEV_E60_USE_REG_DEBUG
#define AFBC_CTRL_WrFL(id,_r) \
	do { \
		FBDEV_E60_CMN_RegDebug((id==0)? CCO_OSD_AFBC0_BASE:CCO_OSD_AFBC1_BASE, AFBC_CTRL_Off(id,_r), AFBC_CTRL_Rd(id,_r)); \
		((g_osd_afbc_e60_reg[id]->_r)=(g_osd_afbc_e60_reg_shadow[id]->_r)); \
	} while(0)

#else
#define AFBC_CTRL_WrFL(id,_r)					((g_osd_afbc_e60_reg[id]->_r)=(g_osd_afbc_e60_reg_shadow[id]->_r))
#endif

#define AFBC_CTRL_Rd(id,_r)						*((UINT32*)(&(g_osd_afbc_e60_reg_shadow[id]->_r)))
#define AFBC_CTRL_Wr(id,_r,_v)					((AFBC_CTRL_Rd(id,_r))=((UINT32)(_v)))

#define AFBC_CTRL_Rd01(id,_r,_f01,_v01) \
	do { \
		(_v01) = (g_osd_afbc_e60_reg_shadow[id]->_r._f01);	\
	} while(0)

#define AFBC_CTRL_Rd02(id,_r,_f01,_v01,_f02,_v02) \
	do { `\
		(_v01) = (g_osd_afbc_e60_reg_shadow[id]->_r._f01);	\
		(_v02) = (g_osd_afbc_e60_reg_shadow[id]->_r._f02);	\
	} while(0)

#define AFBC_CTRL_Wr01(id,_r,_f01,_v01) \
	do { \
		(g_osd_afbc_e60_reg_shadow[id]->_r._f01) = (_v01);	\
	} while(0)

#define AFBC_CTRL_Wr02(id,_r,_f01,_v01,_f02,_v02) \
	do { \
		(g_osd_afbc_e60_reg_shadow[id]->_r._f01) = (_v01);	\
		(g_osd_afbc_e60_reg_shadow[id]->_r._f02) = (_v02);	\
	} while(0)

/** @} *//* end of macro documentation */

extern volatile OSD_AFBC_E60_REG_T*		g_osd_afbc_e60_reg[2];
extern OSD_AFBC_E60_REG_T*    			g_osd_afbc_e60_reg_shadow[2];

#ifdef __cplusplus
}
#endif

#endif	/* __OSD_AFBC_REG_E60_H__ */
