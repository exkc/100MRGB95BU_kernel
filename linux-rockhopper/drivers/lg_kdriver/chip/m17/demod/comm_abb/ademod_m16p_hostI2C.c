...
**
**  Description:   ABB M16P Demodulator Host I2C communication interface.
**
**  Functions
**  Implemented:    LX_ADEMOD_Result  DEMOD_M16P_Analog_HostI2C_Write
**                  LX_ADEMOD_Result  DEMOD_M16P_Analog_HostI2C_Read
**
**  References:
**
**  Exports:        LX_ADEMOD_Result  DEMOD_M16P_Analog_HostI2C_Write
**                  LX_ADEMOD_Result  DEMOD_M16P_Analog_HostI2C_Read
**
**  Dependencies:  ademod_M16P_config.h for system configuration data.
**
**  Revision History:
**
...
/******************************************************************************
**
**  Name: DEMOD_M16P_Analog_HostI2C_Write
**
...
**
******************************************************************************/
LX_ADEMOD_Result DEMOD_M16P_Analog_HostI2C_Write(Handle_t hDevice, UINT8 DevAddr, UINT8 RegAddr, UINT8* pData, UINT32 Size)
{
...
/******************************************************************************
**
**  Name: DEMOD_M16P_Analog_HostI2C_Read
**
**  Description:    Writes data to host I2C.
**
**  Parameters:     hDevice      - Device Handle returned by FmLg_Demod_Open,
...
**
******************************************************************************/
LX_ADEMOD_Result DEMOD_M16P_Analog_HostI2C_Read(Handle_t hDevice, UINT8 DevAddr, UINT8 RegAddr, UINT8* pData, UINT32 Size)
{
    LX_ADEMOD_Result status = retOK; /*  Status to be returned.  */
    pLX_ADEMOD_Demod_Instance pInstance = (pLX_ADEMOD_Demod_Instance)hDevice;
	UINT8 data;
...
/******************************************************************************
**
**  Name: DEMOD_M16P_Analog_HostI2C_WriteX
**
**  Description:    Writes data to host I2C.
**
**  Parameters:     hDevice      - Device Handle returned by FmLg_Demod_Open,
...
**
******************************************************************************/
LX_ADEMOD_Result DEMOD_M16P_Analog_HostI2C_WriteX(Handle_t hDevice, UINT8 DevAddr, UINT32 RegAddr, UINT32 Options, UINT8* pData, UINT32 Size)
{
    LX_ADEMOD_Result status = retOK; /*  Status to be returned.  */
    pLX_ADEMOD_Demod_Instance pInstance = (pLX_ADEMOD_Demod_Instance)hDevice;
	UINT32 i;
...
/******************************************************************************
**
**  Name: DEMOD_M16P_Analog_HostI2C_ReadX
**
**  Description:    Writes data to host I2C.
**
**  Parameters:     hDevice      - Device Handle returned by FmLg_Demod_Open,
...
**
******************************************************************************/
LX_ADEMOD_Result DEMOD_M16P_Analog_HostI2C_ReadX(Handle_t hDevice, UINT8 DevAddr, UINT32 RegAddr, UINT32 Options, UINT8* pData, UINT32 Size)
{
    LX_ADEMOD_Result status = retOK; /*  Status to be returned.  */
    pLX_ADEMOD_Demod_Instance pInstance = (pLX_ADEMOD_Demod_Instance)hDevice;
	UINT8 data;
