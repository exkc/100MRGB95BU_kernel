...
// KyuYeunKim: applied same changes from mali_kbase_device.c, commit: 23f9d729304b7ae3c93cd71ea0b8e8ab96dbf6f4
#elif defined(CONFIG_ARM64) && LINUX_VERSION_CODE >= KERNEL_VERSION(4, 1, 0)
#if LINUX_VERSION_CODE >= KERNEL_VERSION(5, 4, 0)
	of_dma_configure(kbdev->dev, kbdev->dev->of_node, true);
#else
	of_dma_configure(kbdev->dev, kbdev->dev->of_node);
#endif
#endif
