...
#ifndef	_PM_E60_COMMON_H_
#define	_PM_E60_COMMON_H_
...
/* e60_gov_status.governor status  */
...
#define E60_AVS_SET_DELAY 	30	/* sec */

#define GOV_START_DELAY 	60

#define AVS_NOT_INITED 0

/* e60_load_dump related*/
...
#define CPU_AVS_INVALID_MAX   6  /* invalid max */
...
#define E60_AVS_STEP_DELAY	2000
...
typedef struct
{
	...
	void  			(*run)(pms_e60_work_t e60work);
	void  			(*run_regul)(pms_e60_work_t e60work);
	void  			(*reset)(void);
...
typedef struct
{
	...
	void  			(*reinit)(void);
	int 			(*set_avs)(void);
	int 			(*get_cpu_avs_type)(pms_e60_avsinto_t *);
	int 			(*get_core_avs_type)(pms_e60_avsinto_t *);
	unsigned char * (*get_cpu_avs_type_str)(void);
	unsigned char *	(*get_core_avs_type_str)(void);
	unsigned char * (*get_cpu_volt_str)(void);
	unsigned char *	(*get_core_volt_str)(void);
