...
#ifndef _BE_BE_O26A0_REG_PWM_O26A0_H_
#define _BE_BE_O26A0_REG_PWM_O26A0_H_
...
typedef union {
	UINT32 udata32;
	struct {						//0xCC950100 RW 0x0000_0000
...
}BE_O26A0_REG_PWM_PWM_INTR_STATUS_EN_T;

typedef union {
	UINT32 udata32;
	struct {						//0xCC950104 RW 0x0000_0000
	UINT32 pwm0_tx_intr                     :1;	//(0,RW,0x00) //pwm0 tx interrupt
	UINT32 pwm1_tx_intr                     :1;	//(1,RW,0x00) //pwm1 tx interrupt
	UINT32 pwm2_tx_intr                     :1;	//(2,RW,0x00) //pwm2 tx interrupt
	UINT32 pwm3_rx_intr0                    :1;	//(3,RW,0x00) //pwm3 rx0 interrupt
...
}BE_O26A0_REG_PWM_PWM_INTR_CLEAR_T;

typedef union {
	UINT32 udata32;
	struct {						//0xCC950108 RO 0x0000_0000
...
}BE_O26A0_REG_PWM_PWM_INTR_STATUS_T;

typedef union {
	UINT32 udata32;
	struct {						//0xCC95010C RW 0x0000_001F
...
}BE_O26A0_REG_PWM_PWM_INTR_MASK_T;

typedef union {
	UINT32 udata32;
	struct {						//0xCC950110 RW 0x0000_0000
...
}BE_O26A0_REG_PWM_PWM0_CTRL0_T;

typedef union {
	UINT32 udata32;
	struct {						//0xCC950114 RW 0x0000_0000
...
}BE_O26A0_REG_PWM_PWM0_CTRL1_T;

typedef union {
	UINT32 udata32;
	struct {						//0xCC950118 RW 0x0000_0000
...
}BE_O26A0_REG_PWM_PWM0_CTRL2_T;

typedef union {
	UINT32 udata32;
	struct {						//0xCC95011C RW 0x0000_0000
...
}BE_O26A0_REG_PWM_PWM1_CTRL0_T;

typedef union {
	UINT32 udata32;
	struct {						//0xCC950120 RW 0x0000_0000
...
}BE_O26A0_REG_PWM_PWM1_CTRL1_T;

typedef union {
	UINT32 udata32;
	struct {						//0xCC950124 RW 0x0000_0000
...
}BE_O26A0_REG_PWM_PWM1_CTRL2_T;

typedef union {
	UINT32 udata32;
	struct {						//0xCC950128 RW 0x0000_0000
...
}BE_O26A0_REG_PWM_PWM2_CTRL0_T;

typedef union {
	UINT32 udata32;
	struct {						//0xCC95012C RW 0x0000_0000
...
}BE_O26A0_REG_PWM_PWM2_CTRL1_T;

typedef union {
	UINT32 udata32;
	struct {						//0xCC950130 RW 0x0000_0000
...
}BE_O26A0_REG_PWM_PWM2_CTRL2_T;

typedef union {
	UINT32 udata32;
	struct {						//0xCC950134 RW 0x0000_0000
...
}BE_O26A0_REG_PWM_PWM3_CTRL0_T;

typedef union {
	UINT32 udata32;
	struct {						//0xCC950138 RW 0x0000_0000
...
}BE_O26A0_REG_PWM_PWM3_CTRL1_T;

typedef union {
	UINT32 udata32;
	struct {						//0xCC95013C RO 0x0000_0000
	UINT32 pwm3_0_low                       :24;	//(23:0,RO,0x0000_0000) //
	UINT32 resvd                            :8;
	};
}BE_O26A0_REG_PWM_PWM3_0_LOW_T;

typedef union {
	UINT32 udata32;
	struct {						//0xCC950140 RO 0x0000_0000
	UINT32 pwm3_0_high                      :24;	//(23:0,RO,0x0000_0000) //
	UINT32 resvd                            :8;
	};
}BE_O26A0_REG_PWM_PWM3_0_HIGH_T;

typedef union {
	UINT32 udata32;
	struct {						//0xCC950144 RO 0x0000_0000
	UINT32 pwm3_1_low                       :24;	//(23:0,RO,0x0000_0000) //
	UINT32 resvd                            :8;
	};
}BE_O26A0_REG_PWM_PWM3_1_LOW_T;

typedef union {
	UINT32 udata32;
	struct {						//0xCC950148 RO 0x0000_0000
	UINT32 pwm3_1_high                      :24;	//(23:0,RO,0x0000_0000) //
	UINT32 resvd                            :8;
	};
}BE_O26A0_REG_PWM_PWM3_1_HIGH_T;

typedef union {
	UINT32 udata32;
	struct {						//0xCC95014C RO 0x0000_0000
	UINT32 pwm3_2_low                       :24;	//(23:0,RO,0x0000_0000) //
	UINT32 resvd                            :8;
	};
}BE_O26A0_REG_PWM_PWM3_2_LOW_T;

typedef union {
	UINT32 udata32;
	struct {						//0xCC950150 RO 0x0000_0000
	UINT32 pwm3_2_high                      :24;	//(23:0,RO,0x0000_0000) //
	UINT32 resvd                            :8;
	};
}BE_O26A0_REG_PWM_PWM3_2_HIGH_T;

typedef union {
	UINT32 udata32;
	struct {						//0xCC950154 RO 0x0000_0000
	UINT32 pwm3_3_low                       :24;	//(23:0,RO,0x0000_0000) //
	UINT32 resvd                            :8;
	};
}BE_O26A0_REG_PWM_PWM3_3_LOW_T;

typedef union {
	UINT32 udata32;
	struct {						//0xCC950158 RO 0x0000_0000
	UINT32 pwm3_3_high                      :24;	//(23:0,RO,0x0000_0000) //
	UINT32 resvd                            :8;
	};
}BE_O26A0_REG_PWM_PWM3_3_HIGH_T;

typedef union {
	UINT32 udata32;
	struct {						//0xCC95015C RO 0x0000_0000
	UINT32 pwm3_4_low                       :24;	//(23:0,RO,0x0000_0000) //
	UINT32 resvd                            :8;
	};
}BE_O26A0_REG_PWM_PWM3_4_LOW_T;

typedef union {
	UINT32 udata32;
	struct {						//0xCC950160 RO 0x0000_0000
	UINT32 pwm3_4_high                      :24;	//(23:0,RO,0x0000_0000) //
	UINT32 resvd                            :8;
	};
}BE_O26A0_REG_PWM_PWM3_4_HIGH_T;

typedef union {
	UINT32 udata32;
	struct {						//0xCC950164 RO 0x0000_0000
	UINT32 pwm3_5_low                       :24;	//(23:0,RO,0x0000_0000) //
	UINT32 resvd                            :8;
	};
}BE_O26A0_REG_PWM_PWM3_5_LOW_T;

typedef union {
	UINT32 udata32;
	struct {						//0xCC950168 RO 0x0000_0000
	UINT32 pwm3_5_high                      :24;	//(23:0,RO,0x0000_0000) //
	UINT32 resvd                            :8;
	};
}BE_O26A0_REG_PWM_PWM3_5_HIGH_T;

typedef union {
	UINT32 udata32;
	struct {						//0xCC95016C RO 0x0000_0000
	UINT32 pwm3_6_low                       :24;	//(23:0,RO,0x0000_0000) //
	UINT32 resvd                            :8;
	};
}BE_O26A0_REG_PWM_PWM3_6_LOW_T;

typedef union {
	UINT32 udata32;
	struct {						//0xCC950170 RO 0x0000_0000
	UINT32 pwm3_6_high                      :24;	//(23:0,RO,0x0000_0000) //
	UINT32 resvd                            :8;
	};
}BE_O26A0_REG_PWM_PWM3_6_HIGH_T;

typedef union {
	UINT32 udata32;
	struct {						//0xCC950174 RO 0x0000_0000
	UINT32 pwm3_7_low                       :24;	//(23:0,RO,0x0000_0000) //
	UINT32 resvd                            :8;
	};
}BE_O26A0_REG_PWM_PWM3_7_LOW_T;

typedef union {
	UINT32 udata32;
	struct {						//0xCC950178 RO 0x0000_0000
	UINT32 pwm3_7_high                      :24;	//(23:0,RO,0x0000_0000) //
	UINT32 resvd                            :8;
	};
}BE_O26A0_REG_PWM_PWM3_7_HIGH_T;

typedef union {
	UINT32 udata32;
	struct {						//0xCC95017C RW 0x0000_0000
...
}BE_O26A0_REG_PWM_PWM_V_LOAD_WRITE_T;

typedef union {
	UINT32 udata32;
	struct {						//0xCC950180 RW 0x0000_0000
...
}BE_O26A0_REG_PWM_PWM0_V_R_T;

typedef union {
	UINT32 udata32;
	struct {						//0xCC950184 RW 0x0000_0000
...
}BE_O26A0_REG_PWM_PWM0_V_F_T;

typedef union {
	UINT32 udata32;
	struct {						//0xCC950188 RW 0x0000_0000
...
}BE_O26A0_REG_PWM_PWM1_V_R_T;

typedef union {
	UINT32 udata32;
	struct {						//0xCC95018C RW 0x0000_0000
...
}BE_O26A0_REG_PWM_PWM1_V_F_T;

typedef union {
	UINT32 udata32;
	struct {						//0xCC950190 RW 0x0000_0000
...
}BE_O26A0_REG_PWM_PWM2_V_R_T;

typedef union {
	UINT32 udata32;
	struct {						//0xCC950194 RW 0x0000_0000
...
}BE_O26A0_REG_PWM_PWM2_V_F_T;

typedef union {
	UINT32 udata32;
	struct {						//0xCC950198 RW 0x0000_0000
...
}BE_O26A0_REG_PWM_PWM0_V_SUB_R_T;

typedef union {
	UINT32 udata32;
	struct {						//0xCC95019C RW 0x0000_0000
...
}BE_O26A0_REG_PWM_PWM1_V_SUB_R_T;

typedef union {
	UINT32 udata32;
	struct {						//0xCC9501A0 RW 0x0000_0000
	UINT32 pwm2_v_sub                       :16;	//(15:0,RW,0x0) //PWM2 sub rising count	pwm1_resoultion 에 따라 full pixel count/256, /512, /1024를 처리한 값.
	UINT32 resvd                            :12;
	UINT32 pwm2_v_sub_id                    :4;	//(31:28,RW,0x00) //This register can be used for duty control and width control.	For duty control, you can use pwm#_v_r/f register and pwm#_v_sub register for controlling pwm rising and falling count.	For width control, you can use pwm#_v_r register and pwm#_v_sub register for pwm width pixel count. For example,	pwm#_0_width[23:0] = {pwm#_v_sub[7:0], pwm#_v_r[15:0]} for index 0.	pwm#_1_width[23:0] = {pwm#_v_sub[7:0], pwm#_v_r[15:0]} for index 1.	pwm#_2_width[23:0] = {pwm#_v_sub[7:0], pwm#_v_r[15:0]} for index 2.	pwm#_3_width[23:0] = {pwm#_v_sub[7:0], pwm#_v_r[15:0]} for index 3.	pwm#_4_width[23:0] = {pwm#_v_sub[7:0], pwm#_v_r[15:0]} for index 4.	pwm#_5_width[23:0] = {pwm#_v_sub[7:0], pwm#_v_r[15:0]} for index 5.	pwm#_6_width[23:0] = {pwm#_v_sub[7:0], pwm#_v_r[15:0]} for index 6.	pwm#_7_width[23:0] = {pwm#_v_sub[7:0], pwm#_v_r[15:0]} for index 7.	pwm#_8_width[23:0] = {pwm#_v_sub[7:0], pwm#_v_r[15:0]} for index 8.
	};
}BE_O26A0_REG_PWM_PWM2_V_SUB_R_T;

typedef union {
	UINT32 udata32;
	struct {						//0xCC9501A4 RW 0x0005_0000
...
}BE_O26A0_REG_PWM_PWM0_LOCK_PULSE_XY_T;

typedef union {
	UINT32 udata32;
	struct {						//0xCC9501A8 RW 0x0005_0000
...
}BE_O26A0_REG_PWM_PWM1_LOCK_PULSE_XY_T;

typedef union {
	UINT32 udata32;
	struct {						//0xCC9501AC RW 0x0005_0000
...
}BE_O26A0_REG_PWM_PWM2_LOCK_PULSE_XY_T;

typedef union {
	UINT32 udata32;
	struct {						//0xCC9501B0 RW 0x0005_0000
...
}BE_O26A0_REG_PWM_PWM3_LOCK_PULSE_XY_T;

typedef union {
	UINT32 udata32;
	struct {						//0xCC9501B4 RO 0x0000_0000
	UINT32 tdata0                           :32;	//(31:0,,) //
	};
}BE_O26A0_REG_PWM_PWM0_WIDTH_T;

typedef union {
	UINT32 udata32;
	struct {						//0xCC9501B8 RO 0x0000_0000
	UINT32 tdata0                           :32;	//(31:0,,) //
	};
}BE_O26A0_REG_PWM_PWM0_OFFSET_T;

typedef union {
	UINT32 udata32;
	struct {						//0xCC9501BC RO 0x0000_0000
	UINT32 tdata0                           :32;	//(31:0,,) //
	};
}BE_O26A0_REG_PWM_PWM0_OFFSET_SUM_T;

typedef union {
	UINT32 udata32;
	struct {						//0xCC9501C0 RO 0x0000_0000
	UINT32 tdata0                           :32;	//(31:0,,) //
	};
}BE_O26A0_REG_PWM_PWM1_WIDTH_T;

typedef union {
	UINT32 udata32;
	struct {						//0xCC9501C4 RO 0x0000_0000
	UINT32 tdata0                           :32;	//(31:0,,) //
	};
}BE_O26A0_REG_PWM_PWM1_OFFSET_T;

typedef union {
	UINT32 udata32;
	struct {						//0xCC9501C8 RO 0x0000_0000
	UINT32 tdata0                           :32;	//(31:0,,) //
	};
}BE_O26A0_REG_PWM_PWM1_OFFSET_SUM_T;

typedef union {
	UINT32 udata32;
	struct {						//0xCC9501CC RW 0x0000_0000
...
}BE_O26A0_REG_PWM_PWM0_VWIDTH_MAN_T;

typedef union {
	UINT32 udata32;
	struct {						//0xCC9501D0 RW 0x0000_0000
...
}BE_O26A0_REG_PWM_PWM1_VWIDTH_MAN_T;

typedef union {
	UINT32 udata32;
	struct {						//0xCC9501D4 RW 0x0000_0000
...
}BE_O26A0_REG_PWM_PWM2_VWIDTH_MAN_T;

typedef union {
	UINT32 udata32;
	struct {						//0xCC9501D8 RW 0x0000_0000
	UINT32 tdata00                          :16;	//(31:0,,) //
...
}BE_O26A0_REG_PWM_PWM0_V_SUB_F_T;

typedef union {
	UINT32 udata32;
	struct {						//0xCC9501E0 RW 0x0000_0000
...
}BE_O26A0_REG_PWM_PWM1_V_SUB_F_T;

typedef union {
	UINT32 udata32;
	struct {						//0xCC9501E4 RW 0x0000_0000
...
}BE_O26A0_REG_PWM_PWM2_V_SUB_F_T;

typedef union {
	UINT32 udata32;
	struct {						//0xCC9501EC RW 0x0000_0000
...
}BE_O26A0_REG_PWM_SW_RESET_LOCK_T;

typedef union {
	UINT32 udata32;
	struct {						//0xCC9501F0 RW 0x0000_C000
...
}BE_O26A0_REG_PWM_PWM_TRG_CTRL0_T;

typedef union {
	UINT32 udata32;
	struct {						//0xCC9501F4 RW 0x0003_0000
	UINT32 trigger_high_num                 :28;	//(27:0,RW,0x03_0000) //trigger_out high signal's position from trigger point
	UINT32 resvd                            :4;
	};
}BE_O26A0_REG_PWM_PWM_TRG_CTRL1_T;

typedef union {
	UINT32 udata32;
	struct {						//0xCC9501F8 RW 0x0000_0000
	UINT32 pwm_gain                         :13;	//(12:0,RW,0x0000_0000) //PWM gain
	UINT32 resvd                            :19;
	};
}BE_O26A0_REG_PWM_PWM_GAIN_T;

typedef union {
	UINT32 udata32;
	struct {						//0xCC9501FC RW 0x0000_0000
...
}BE_O26A0_REG_PWM_PWM_OUT_SEL_T;

typedef struct {
	BE_O26A0_REG_PWM_PWM_INTR_STATUS_EN_T                     pwm_intr_status_en;	//0xCC950100
	BE_O26A0_REG_PWM_PWM_INTR_CLEAR_T                             pwm_intr_clear;	//0xCC950104
	BE_O26A0_REG_PWM_PWM_INTR_STATUS_T                           pwm_intr_status;	//0xCC950108
	BE_O26A0_REG_PWM_PWM_INTR_MASK_T                               pwm_intr_mask;	//0xCC95010C
	BE_O26A0_REG_PWM_PWM0_CTRL0_T                                     pwm0_ctrl0;	//0xCC950110
	BE_O26A0_REG_PWM_PWM0_CTRL1_T                                     pwm0_ctrl1;	//0xCC950114
	BE_O26A0_REG_PWM_PWM0_CTRL2_T                                     pwm0_ctrl2;	//0xCC950118
	BE_O26A0_REG_PWM_PWM1_CTRL0_T                                     pwm1_ctrl0;	//0xCC95011C
	BE_O26A0_REG_PWM_PWM1_CTRL1_T                                     pwm1_ctrl1;	//0xCC950120
	BE_O26A0_REG_PWM_PWM1_CTRL2_T                                     pwm1_ctrl2;	//0xCC950124
	BE_O26A0_REG_PWM_PWM2_CTRL0_T                                     pwm2_ctrl0;	//0xCC950128
	BE_O26A0_REG_PWM_PWM2_CTRL1_T                                     pwm2_ctrl1;	//0xCC95012C
	BE_O26A0_REG_PWM_PWM2_CTRL2_T                                     pwm2_ctrl2;	//0xCC950130
	BE_O26A0_REG_PWM_PWM3_CTRL0_T                                     pwm3_ctrl0;	//0xCC950134
	BE_O26A0_REG_PWM_PWM3_CTRL1_T                                     pwm3_ctrl1;	//0xCC950138
	BE_O26A0_REG_PWM_PWM3_0_LOW_T                                     pwm3_0_low;	//0xCC95013C
	BE_O26A0_REG_PWM_PWM3_0_HIGH_T                                   pwm3_0_high;	//0xCC950140
	BE_O26A0_REG_PWM_PWM3_1_LOW_T                                     pwm3_1_low;	//0xCC950144
	BE_O26A0_REG_PWM_PWM3_1_HIGH_T                                   pwm3_1_high;	//0xCC950148
	BE_O26A0_REG_PWM_PWM3_2_LOW_T                                     pwm3_2_low;	//0xCC95014C
	BE_O26A0_REG_PWM_PWM3_2_HIGH_T                                   pwm3_2_high;	//0xCC950150
	BE_O26A0_REG_PWM_PWM3_3_LOW_T                                     pwm3_3_low;	//0xCC950154
	BE_O26A0_REG_PWM_PWM3_3_HIGH_T                                   pwm3_3_high;	//0xCC950158
	BE_O26A0_REG_PWM_PWM3_4_LOW_T                                     pwm3_4_low;	//0xCC95015C
	BE_O26A0_REG_PWM_PWM3_4_HIGH_T                                   pwm3_4_high;	//0xCC950160
	BE_O26A0_REG_PWM_PWM3_5_LOW_T                                     pwm3_5_low;	//0xCC950164
	BE_O26A0_REG_PWM_PWM3_5_HIGH_T                                   pwm3_5_high;	//0xCC950168
	BE_O26A0_REG_PWM_PWM3_6_LOW_T                                     pwm3_6_low;	//0xCC95016C
	BE_O26A0_REG_PWM_PWM3_6_HIGH_T                                   pwm3_6_high;	//0xCC950170
	BE_O26A0_REG_PWM_PWM3_7_LOW_T                                     pwm3_7_low;	//0xCC950174
	BE_O26A0_REG_PWM_PWM3_7_HIGH_T                                   pwm3_7_high;	//0xCC950178
	BE_O26A0_REG_PWM_PWM_V_LOAD_WRITE_T                         pwm_v_load_write;	//0xCC95017C
	BE_O26A0_REG_PWM_PWM0_V_R_T                                         pwm0_v_r;	//0xCC950180
	BE_O26A0_REG_PWM_PWM0_V_F_T                                         pwm0_v_f;	//0xCC950184
	BE_O26A0_REG_PWM_PWM1_V_R_T                                         pwm1_v_r;	//0xCC950188
	BE_O26A0_REG_PWM_PWM1_V_F_T                                         pwm1_v_f;	//0xCC95018C
	BE_O26A0_REG_PWM_PWM2_V_R_T                                         pwm2_v_r;	//0xCC950190
	BE_O26A0_REG_PWM_PWM2_V_F_T                                         pwm2_v_f;	//0xCC950194
	BE_O26A0_REG_PWM_PWM0_V_SUB_R_T                                 pwm0_v_sub_r;	//0xCC950198
	BE_O26A0_REG_PWM_PWM1_V_SUB_R_T                                 pwm1_v_sub_r;	//0xCC95019C
	BE_O26A0_REG_PWM_PWM2_V_SUB_R_T                                 pwm2_v_sub_r;	//0xCC9501A0
	BE_O26A0_REG_PWM_PWM0_LOCK_PULSE_XY_T                     pwm0_lock_pulse_xy;	//0xCC9501A4
	BE_O26A0_REG_PWM_PWM1_LOCK_PULSE_XY_T                     pwm1_lock_pulse_xy;	//0xCC9501A8
	BE_O26A0_REG_PWM_PWM2_LOCK_PULSE_XY_T                     pwm2_lock_pulse_xy;	//0xCC9501AC
	BE_O26A0_REG_PWM_PWM3_LOCK_PULSE_XY_T                     pwm3_lock_pulse_xy;	//0xCC9501B0
	BE_O26A0_REG_PWM_PWM0_WIDTH_T                                     pwm0_width;	//0xCC9501B4
	BE_O26A0_REG_PWM_PWM0_OFFSET_T                                   pwm0_offset;	//0xCC9501B8
	BE_O26A0_REG_PWM_PWM0_OFFSET_SUM_T                           pwm0_offset_sum;	//0xCC9501BC
	BE_O26A0_REG_PWM_PWM1_WIDTH_T                                     pwm1_width;	//0xCC9501C0
	BE_O26A0_REG_PWM_PWM1_OFFSET_T                                   pwm1_offset;	//0xCC9501C4
	BE_O26A0_REG_PWM_PWM1_OFFSET_SUM_T                           pwm1_offset_sum;	//0xCC9501C8
	BE_O26A0_REG_PWM_PWM0_VWIDTH_MAN_T                           pwm0_vwidth_man;	//0xCC9501CC
	BE_O26A0_REG_PWM_PWM1_VWIDTH_MAN_T                           pwm1_vwidth_man;	//0xCC9501D0
	BE_O26A0_REG_PWM_PWM2_VWIDTH_MAN_T                           pwm2_vwidth_man;	//0xCC9501D4
	BE_O26A0_REG_PWM_PWM_MASTER_T                                     pwm_master;	//0xCC9501D8
	BE_O26A0_REG_PWM_PWM0_V_SUB_F_T                                 pwm0_v_sub_f;	//0xCC9501DC
	BE_O26A0_REG_PWM_PWM1_V_SUB_F_T                                 pwm1_v_sub_f;	//0xCC9501E0
	BE_O26A0_REG_PWM_PWM2_V_SUB_F_T                                 pwm2_v_sub_f;	//0xCC9501E4
	UINT32                                                    reserved0;	//0xCC9501E8
	BE_O26A0_REG_PWM_SW_RESET_LOCK_T                               sw_reset_lock;	//0xCC9501EC
	BE_O26A0_REG_PWM_PWM_TRG_CTRL0_T                               pwm_trg_ctrl0;	//0xCC9501F0
	BE_O26A0_REG_PWM_PWM_TRG_CTRL1_T                               pwm_trg_ctrl1;	//0xCC9501F4
	BE_O26A0_REG_PWM_PWM_GAIN_T                                         pwm_gain;	//0xCC9501F8
	BE_O26A0_REG_PWM_PWM_OUT_SEL_T                                   pwm_out_sel;	//0xCC9501FC
}BE_O26A0_REG_PWM_T;
