#ifndef _PE_ND_REG_M19A0_H_
#define _PE_ND_REG_M19A0_H_
#ifndef UINT32
...
typedef struct
{
	...
	reserved01                         :4 ,	// reserved
	manual_mem_en                      :1 ,	// 15
	global_cg_blk_off                  :4 ,	// 19:16
	power_cg_blk_off                   :4 ;	// 23:20
}PE_M19_PE0_DEBUG_MEM_REQ_T;
/*-----------------------------------------------------------------------------
...
typedef struct
{
	...
	cb_b_s_apl                         :10,	// 19:10
	cr_r_s_apl                         :10;	// 29:20
}PE_M19_APL_STAT_00_T;
/*-----------------------------------------------------------------------------
		0xc9003388L pe1_fsw_ctrl_00 ''
-----------------------------------------------------------------------------*/
typedef struct {
...
} PE_M19_PE1_FSW_CTRL_00_T;

/*-----------------------------------------------------------------------------
		0xc900338cL pe1_fsw_ctrl_01 ''
-----------------------------------------------------------------------------*/
typedef struct {
...
typedef struct
{
	...
	y_gain                             :8 ;	// 31:24
}PE_M19_LVCRTL_CTRL_00_T;
/*-----------------------------------------------------------------------------
                             0xc900339cL tpd_stat_01                             
-----------------------------------------------------------------------------*/
typedef struct
{
	UINT32 hist_pixel_count                   :22;	//21:0
}PE_M19_TPD_STAT_01_T;
/*-----------------------------------------------------------------------------
...
typedef struct
{
	...
	reserved02                         :1 ,	// reserved
	reg_abab_th                        :6 ;	// 15:10
}PE_M19_FBC_CTRL_02_T;
/*-----------------------------------------------------------------------------
                             0xc90034c4L fbc_ctrl_03                             
-----------------------------------------------------------------------------*/
typedef struct
{
	UINT32
...
}PE_M19_VFILTER_CTRL_02_T;
/*-----------------------------------------------------------------------------
                             0xc900358cL cti_ctrl_0                             
-----------------------------------------------------------------------------*/
typedef struct
{
	UINT32
...
typedef struct
{
	...
	reg_gain_y5                        :8 ,	// 23:16
	reg_gain_y4                        :8 ;	// 31:24
}PE_M19_REG_DC_BNR_CTRL_11_T;
/*-----------------------------------------------------------------------------
                             0xc90037a0L reg_cti_ctrl_2                             
-----------------------------------------------------------------------------*/
typedef struct
{
	UINT32
	...
	reg_ycm_en                         :1 ;	// 31
}PE_M19_REG_CTI_CTRL_2_T;
/*-----------------------------------------------------------------------------
                             0xc90037a4L reg_cti_ctrl_3                             
-----------------------------------------------------------------------------*/
typedef struct
{
	UINT32
...
}PE_M19_REG_CTI_CTRL_3_T;
/*-----------------------------------------------------------------------------
                             0xc90037a8L reg_mnr_ctrl_6                             
-----------------------------------------------------------------------------*/
typedef struct
{
	UINT32
...
}PE_M19_REG_MNR_CTRL_6_T;
/*-----------------------------------------------------------------------------
                             0xc90037acL reg_mnr_ctrl_7                             
-----------------------------------------------------------------------------*/
typedef struct
{
	UINT32
...
}PE_M19_REG_MNR_CTRL_7_T;
/*-----------------------------------------------------------------------------
                             0xc90037b0L reg_mnr_ctrl_8                             
-----------------------------------------------------------------------------*/
typedef struct
{
	UINT32
...
}PE_M19_REG_MNR_CTRL_8_T;
/*-----------------------------------------------------------------------------
                             0xc90037b4L reg_mnr_ctrl_9                             
-----------------------------------------------------------------------------*/
typedef struct
{
	UINT32
...
}PE_M19_REG_MNR_CTRL_9_T;
/*-----------------------------------------------------------------------------
                             0xc90037b8L reg_mnr_ctrl_10                             
-----------------------------------------------------------------------------*/
typedef struct
{
	UINT32
...
}PE_M19_REG_MNR_CTRL_10_T;
/*-----------------------------------------------------------------------------
                             0xc90037bcL reg_mnr_ctrl_11                             
-----------------------------------------------------------------------------*/
typedef struct
{
	UINT32
...
}PE_M19_REG_MNR_CTRL_11_T;
/*-----------------------------------------------------------------------------
                             0xc90037c0L reg_mnr_ctrl_12                             
-----------------------------------------------------------------------------*/
typedef struct
{
	UINT32
...
}PE_M19_REG_MNR_CTRL_12_T;
/*-----------------------------------------------------------------------------
                             0xc90037c4L reg_decon_ctrl_11                             
-----------------------------------------------------------------------------*/
typedef struct
{
	UINT32
	reg_2nd_out_rd_init_yy;	// 31:0
}PE_M19_REG_DECON_CTRL_11_T;
/*-----------------------------------------------------------------------------
                             0xc90037c8L reg_decon_ctrl_12                             
-----------------------------------------------------------------------------*/
typedef struct
{
	UINT32
	reg_2nd_out_rd_init_cb;	// 31:0
}PE_M19_REG_DECON_CTRL_12_T;
/*-----------------------------------------------------------------------------
                             0xc90037ccL reg_decon_ctrl_13                             
-----------------------------------------------------------------------------*/
typedef struct
{
	UINT32
	reg_2nd_out_rd_init_cr;	// 31:0
}PE_M19_REG_DECON_CTRL_13_T;
/*-----------------------------------------------------------------------------
                             0xc90037d0L reg_decon_ctrl_14                             
-----------------------------------------------------------------------------*/
typedef struct
{
	UINT32
	reg_err_out_rd_simple_init_yy;	// 31:0
}PE_M19_REG_DECON_CTRL_14_T;
/*-----------------------------------------------------------------------------
                             0xc90037d4L reg_decon_ctrl_15                             
-----------------------------------------------------------------------------*/
typedef struct
{
	UINT32
	reg_err_out_rd_simple_init_cb;	// 31:0
}PE_M19_REG_DECON_CTRL_15_T;
/*-----------------------------------------------------------------------------
                             0xc90037d8L reg_decon_ctrl_16                             
-----------------------------------------------------------------------------*/
typedef struct
{
	UINT32
	reg_err_out_rd_simple_init_cr;	// 31:0
}PE_M19_REG_DECON_CTRL_16_T;
/*-----------------------------------------------------------------------------
                             0xc90037dcL reg_decon_ctrl_17                             
-----------------------------------------------------------------------------*/
typedef struct
{
	UINT32
...
}PE_M19_REG_DECON_CTRL_17_T;
/*-----------------------------------------------------------------------------
                             0xc90037e0L reg_decon_ctrl_18                             
-----------------------------------------------------------------------------*/
typedef struct
{
	UINT32
	...
	reg_var_h_gain                     :4 ,	// 27:24
	reg_var_cut_resolution             :4 ;	// 31:28
}PE_M19_REG_DECON_CTRL_18_T;
/*-----------------------------------------------------------------------------
                             0xc90037e4L reg_decon_ctrl_19                             
-----------------------------------------------------------------------------*/
typedef struct
{
	UINT32
...
}PE_M19_REG_DECON_CTRL_19_T;
/*-----------------------------------------------------------------------------
                             0xc90037e8L reg_decon_ctrl_20                             
-----------------------------------------------------------------------------*/
typedef struct
{
	UINT32
...
}PE_M19_REG_DECON_CTRL_20_T;
/*-----------------------------------------------------------------------------
                             0xc90037ecL reg_decon_ctrl_21                             
-----------------------------------------------------------------------------*/
typedef struct
{
	UINT32
...
}PE_M19_REG_DECON_CTRL_21_T;
/*-----------------------------------------------------------------------------
                             0xc90037f0L reg_decon_ctrl_22                             
-----------------------------------------------------------------------------*/
typedef struct
{
	UINT32
...
}PE_M19_REG_DECON_CTRL_22_T;
/*-----------------------------------------------------------------------------
                             0xc90037f4L reg_decon_ctrl_23                             
-----------------------------------------------------------------------------*/
typedef struct
{
	UINT32
...
}PE_M19_REG_DECON_CTRL_23_T;
/*-----------------------------------------------------------------------------
                             0xc90037f8L reg_decon_ctrl_24                             
-----------------------------------------------------------------------------*/
typedef struct
{
	UINT32
...
}PE_M19_REG_DECON_CTRL_24_T;
/*-----------------------------------------------------------------------------
                             0xc90037fcL reg_decon_ctrl_25                             
-----------------------------------------------------------------------------*/
typedef struct
{
	UINT32
...
}PE_M19_REG_DECON_CTRL_25_T;
/*-----------------------------------------------------------------------------
                             0xc9003800L reg_decon_ctrl_26                             
-----------------------------------------------------------------------------*/
typedef struct
{
	UINT32
...
}PE_M19_REG_DECON_CTRL_26_T;
/*-----------------------------------------------------------------------------
                             0xc9003804L reg_decon_ctrl_27                             
-----------------------------------------------------------------------------*/
typedef struct
{
	UINT32
...
}PE_M19_REG_DECON_CTRL_27_T;
/*-----------------------------------------------------------------------------
                             0xc9003808L reg_decon_ctrl_28                             
-----------------------------------------------------------------------------*/
typedef struct
{
	UINT32
...
}PE_M19_REG_DECON_CTRL_28_T;
/*-----------------------------------------------------------------------------
                             0xc900380cL reg_decon_ctrl_29                             
-----------------------------------------------------------------------------*/
typedef struct
{
	UINT32
...
}PE_M19_REG_DECON_CTRL_29_T;
/*-----------------------------------------------------------------------------
                             0xc9003810L reg_decon_ctrl_30                             
-----------------------------------------------------------------------------*/
typedef struct
{
	UINT32
...
}PE_M19_REG_DECON_CTRL_30_T;
/*-----------------------------------------------------------------------------
                             0xc9003814L reg_decon_ctrl_31                             
-----------------------------------------------------------------------------*/
typedef struct
{
	UINT32
...
}PE_M19_REG_DECON_CTRL_31_T;
/*-----------------------------------------------------------------------------
                             0xc9003818L reg_decon_ctrl_32                             
-----------------------------------------------------------------------------*/
typedef struct
{
	UINT32
...
}PE_M19_REG_DECON_CTRL_32_T;
/*-----------------------------------------------------------------------------
                             0xc900381cL reg_decon_ctrl_33                             
-----------------------------------------------------------------------------*/
typedef struct
{
	UINT32
...
}PE_M19_REG_DECON_CTRL_33_T;
/*-----------------------------------------------------------------------------
                             0xc9003820L reg_decon_ctrl_34                             
-----------------------------------------------------------------------------*/
typedef struct
{
	UINT32
...
}PE_M19_REG_DECON_CTRL_34_T;
/*-----------------------------------------------------------------------------
                             0xc9003824L reg_decon_ctrl_35                             
-----------------------------------------------------------------------------*/
typedef struct
{
	UINT32
	reg_decon_rd_simple_init_yy;	// 31:0
}PE_M19_REG_DECON_CTRL_35_T;
/*-----------------------------------------------------------------------------
                             0xc9003828L reg_decon_ctrl_36                             
-----------------------------------------------------------------------------*/
typedef struct
{
	UINT32
	reg_decon_rd_simple_init_cb;	// 31:0
}PE_M19_REG_DECON_CTRL_36_T;
/*-----------------------------------------------------------------------------
                             0xc900382cL reg_decon_ctrl_37                             
-----------------------------------------------------------------------------*/
typedef struct
{
	UINT32
	reg_decon_rd_simple_init_cr;	// 31:0
}PE_M19_REG_DECON_CTRL_37_T;
/*-----------------------------------------------------------------------------
                             0xc9003830L reg_decon_ctrl_38                             
-----------------------------------------------------------------------------*/
typedef struct
{
	UINT32
...
}PE_M19_REG_DECON_CTRL_38_T;
/*-----------------------------------------------------------------------------
                             0xc9003834L reg_decon_ctrl_39                             
-----------------------------------------------------------------------------*/
typedef struct
{
	UINT32
...
}PE_M19_REG_DECON_CTRL_39_T;
/*-----------------------------------------------------------------------------
                             0xc9003838L reg_decon_ctrl_40                             
-----------------------------------------------------------------------------*/
typedef struct
{
	UINT32
...
}PE_M19_REG_DECON_CTRL_40_T;
/*-----------------------------------------------------------------------------
                             0xc900383cL reg_decon_ctrl_41                             
-----------------------------------------------------------------------------*/
typedef struct
{
	UINT32
	reg_rd_init_yy;	// 31:0
}PE_M19_REG_DECON_CTRL_41_T;
/*-----------------------------------------------------------------------------
                             0xc9003840L reg_decon_ctrl_42                             
-----------------------------------------------------------------------------*/
typedef struct
{
	UINT32
	reg_rd_init_cb;	// 31:0
}PE_M19_REG_DECON_CTRL_42_T;
/*-----------------------------------------------------------------------------
                             0xc9003844L reg_decon_ctrl_43                             
-----------------------------------------------------------------------------*/
typedef struct
{
	UINT32
	reg_rd_init_cr;	// 31:0
}PE_M19_REG_DECON_CTRL_43_T;
/*-----------------------------------------------------------------------------
                             0xc9003848L reg_decon_ctrl_44                             
-----------------------------------------------------------------------------*/
typedef struct
{
	UINT32
...
}PE_M19_REG_DECON_CTRL_44_T;
/*-----------------------------------------------------------------------------
                             0xc900384cL reg_decon_ctrl_45                             
-----------------------------------------------------------------------------*/
typedef struct
{
	UINT32
...
}PE_M19_REG_DECON_CTRL_45_T;
/*-----------------------------------------------------------------------------
                             0xc9003850L reg_decon_ctrl_46                             
-----------------------------------------------------------------------------*/
typedef struct
{
	UINT32
	...
	reg_bbd_en                         :1 ;	// 31
}PE_M19_REG_DECON_CTRL_46_T;
/*-----------------------------------------------------------------------------
                             0xc9003854L reg_decon_ctrl_47                             
-----------------------------------------------------------------------------*/
typedef struct
{
	UINT32
...
}PE_M19_REG_DECON_CTRL_47_T;
/*-----------------------------------------------------------------------------
                             0xc9003858L reg_decon_ctrl_48                             
-----------------------------------------------------------------------------*/
typedef struct
{
	UINT32
...
}PE_M19_REG_DECON_CTRL_48_T;
/*-----------------------------------------------------------------------------
                             0xc900385cL reg_decon_ctrl_49                             
-----------------------------------------------------------------------------*/
typedef struct
{
	UINT32
...
}PE_M19_REG_DECON_CTRL_49_T;
/*-----------------------------------------------------------------------------
                             0xc9003860L reg_decon_ctrl_50                             
-----------------------------------------------------------------------------*/
typedef struct
{
	UINT32
...
}PE_M19_REG_DECON_CTRL_50_T;
/*-----------------------------------------------------------------------------
                             0xc9003864L reg_decon_ctrl_51                             
-----------------------------------------------------------------------------*/
typedef struct
{
	UINT32
	...
	reserved01                         :1 ,	// reserved
	reg_444_mode                       :1 ;	// 31
}PE_M19_REG_DECON_CTRL_51_T;
/*-----------------------------------------------------------------------------
                             0xc9003868L reg_decon_ctrl_52                             
-----------------------------------------------------------------------------*/
typedef struct
{
	UINT32
...
}PE_M19_REG_DECON_CTRL_52_T;
/*-----------------------------------------------------------------------------
                             0xc900386cL reg_decon_ctrl_53                             
-----------------------------------------------------------------------------*/
typedef struct
{
	UINT32
...
}PE_M19_REG_DECON_CTRL_53_T;
/*-----------------------------------------------------------------------------
                             0xc9003870L reg_decon_ctrl_54                             
-----------------------------------------------------------------------------*/
typedef struct
{
	UINT32
...
}PE_M19_REG_DECON_CTRL_54_T;
/*-----------------------------------------------------------------------------
                             0xc9003874L reg_decon_ctrl_55                             
-----------------------------------------------------------------------------*/
typedef struct
{
	UINT32
...
}PE_M19_REG_DECON_CTRL_55_T;
/*-----------------------------------------------------------------------------
                             0xc9003878L reg_decon_ctrl_56                             
-----------------------------------------------------------------------------*/
typedef struct
{
	UINT32
...
}PE_M19_REG_DECON_CTRL_56_T;
/*-----------------------------------------------------------------------------
                             0xc900387cL reg_decon_ctrl_57                             
-----------------------------------------------------------------------------*/
typedef struct
{
	UINT32
...
}PE_M19_REG_DECON_CTRL_57_T;
/*-----------------------------------------------------------------------------
                             0xc9003880L reg_decon_ctrl_58                             
-----------------------------------------------------------------------------*/
typedef struct
{
	UINT32
...
}PE_M19_REG_DECON_CTRL_58_T;
/*-----------------------------------------------------------------------------
                             0xc9003884L reg_decon_ctrl_59                             
-----------------------------------------------------------------------------*/
typedef struct
{
	UINT32
...
}PE_M19_REG_DECON_CTRL_59_T;
/*-----------------------------------------------------------------------------
                             0xc9003888L reg_decon_ctrl_60                             
-----------------------------------------------------------------------------*/
typedef struct
{
	UINT32
...
}PE_M19_REG_DECON_CTRL_60_T;
/*-----------------------------------------------------------------------------
                             0xc900388cL reg_decon_ctrl_61                             
-----------------------------------------------------------------------------*/
typedef struct
{
	UINT32
	reg_2nd_rd_simple_init_yy;	// 31:0
}PE_M19_REG_DECON_CTRL_61_T;
/*-----------------------------------------------------------------------------
                             0xc9003890L reg_decon_ctrl_62                             
-----------------------------------------------------------------------------*/
typedef struct
{
	UINT32
	reg_2nd_rd_simple_init_cb;	// 31:0
}PE_M19_REG_DECON_CTRL_62_T;
/*-----------------------------------------------------------------------------
                             0xc9003894L reg_decon_ctrl_63                             
-----------------------------------------------------------------------------*/
typedef struct
{
	UINT32
	reg_2nd_rd_simple_init_cr;	// 31:0
}PE_M19_REG_DECON_CTRL_63_T;
...
}PE_M19_CTRL_M0_Y_LEVEL_CTRL_T;

typedef struct
{ 
	PE_M19_PE0_ND_LOAD_T                            pe0_load;	//0x0000
	PE_M19_PE0_ND_INTR_T                            pe0_intr;	//0x0004
	PE_M19_PE0_ND_STATUS0_T                         pe0_status0;	//0x0008
	PE_M19_PE0_ND_STATUS1_T                         pe0_status1;	//0x000C
	PE_M19_PE0_ND_OPMODE_T                          pe0_opmode;	//0x0010
	PE_M19_PE0_ND_SRC_SIZE_T                        pe0_src_size;	//0x0014
	PE_M19_PE0_FIELD_T                              pe0_field;	//0x0018
	PE_M19_PE0_DEBUG_LEND_CTRL_T                    pe0_debug_lend_ctrl;	//0x001C
	PE_M19_PE0_ND_IN_OFFSET_T                       pe0_in_offset;	//0x0020
	PE_M19_PE0_ND_IN_SIZE_T                         pe0_in_size;	//0x0024
	PE_M19_FBC_CTRL0_T                              fbc_ctrl0;	//0x0028
	PE_M19_FBC_CTRL1_T                              fbc_ctrl1;	//0x002C
	PE_M19_PE0_DEBUG_MEM_REQ_T                      pe0_debug_mem_req;	//0x0030
	PE_M19_PE0_DEBUG_LREQ_DLY_T                     pe0_debug_lreq_dly;	//0x0034
	PE_M19_TNRW_IN_OFFSET_T                         tnrw_in_offset;	//0x0038
	PE_M19_TNRW_OUT_SIZE_T                          tnrw_out_size;	//0x003C
	...
	PE_M19_TNR_STATUS_00_T                          tnr_status_00;	//0x00C0
	PE_M19_TNR_STATUS_01_T                          tnr_status_01;	//0x00C4
	PE_M19_TNR_STATUS_02_T                          tnr_status_02;	//0x00C8
	PE_M19_TNR_STATUS_03_T                          tnr_status_03;	//0x00CC
	PE_M19_TNR_MAIN_LUT_00_T                        tnr_main_lut_00;	//0x00D0
	PE_M19_TNR_MAIN_LUT_01_T                        tnr_main_lut_01;	//0x00D4
	UINT32                                            reserved00;	//0x00D8-0x00D8
	PE_M19_TNR_STATUS_04_T                          tnr_status_04;	//0x00DC
	...
	PE_M19_IPC_CTRL_00_T                            ipc_ctrl_00;	//0x0100
	PE_M19_IPC_CTRL_01_T                            ipc_ctrl_01;	//0x0104
	PE_M19_IPC_CTRL_02_T                            ipc_ctrl_02;	//0x0108
	PE_M19_IPC_CTRL_03_T                            ipc_ctrl_03;	//0x010C
	PE_M19_IPC_CTRL_04_T                            ipc_ctrl_04;	//0x0110
	PE_M19_IPC_CTRL_05_T                            ipc_ctrl_05;	//0x0114
	PE_M19_IPC_CTRL_06_T                            ipc_ctrl_06;	//0x0118
	PE_M19_IPC_CTRL_07_T                            ipc_ctrl_07;	//0x011C
	PE_M19_IPC_CTRL_08_T                            ipc_ctrl_08;	//0x0120
	PE_M19_IPC_CTRL_09_T                            ipc_ctrl_09;	//0x0124
	PE_M19_IPC_CTRL_10_T                            ipc_ctrl_10;	//0x0128
	PE_M19_IPC_CTRL_11_T                            ipc_ctrl_11;	//0x012C
	PE_M19_IPC_CTRL_12_T                            ipc_ctrl_12;	//0x0130
	PE_M19_IPC_CTRL_13_T                            ipc_ctrl_13;	//0x0134
	PE_M19_IPC_CTRL_14_T                            ipc_ctrl_14;	//0x0138
	PE_M19_IPC_CTRL_15_T                            ipc_ctrl_15;	//0x013C
	PE_M19_IPC_CTRL_16_T                            ipc_ctrl_16;	//0x0140
	PE_M19_IPC_CTRL_17_T                            ipc_ctrl_17;	//0x0144
	PE_M19_IPC_CTRL_18_T                            ipc_ctrl_18;	//0x0148
	PE_M19_IPC_CTRL_19_T                            ipc_ctrl_19;	//0x014C
	PE_M19_IPC_STATUS_00_T                          ipc_status_00;	//0x0150
	PE_M19_IPC_STATUS_01_T                          ipc_status_01;	//0x0154
	PE_M19_IPC_STATUS_02_T                          ipc_status_02;	//0x0158
	PE_M19_IPC_STATUS_03_T                          ipc_status_03;	//0x015C
	PE_M19_CLC_CTRL_00_T                            clc_ctrl_00;	//0x0160
	PE_M19_CLC_CTRL_01_T                            clc_ctrl_01;	//0x0164
	PE_M19_CLC_CTRL_02_T                            clc_ctrl_02;	//0x0168
	PE_M19_CLC_CTRL_03_T                            clc_ctrl_03;	//0x016C
	PE_M19_CLC_CTRL_04_T                            clc_ctrl_04;	//0x0170
	PE_M19_CLC_CTRL_05_T                            clc_ctrl_05;	//0x0174
	PE_M19_CLC_CTRL_06_T                            clc_ctrl_06;	//0x0178
	PE_M19_CLC_STAT_00_T                            clc_stat_00;	//0x017C
	PE_M19_IPC_CTRL_34_T                            ipc_ctrl_34;	//0x0180
	PE_M19_IPC_CTRL_35_T                            ipc_ctrl_35;	//0x0184
	PE_M19_IPC_CTRL_36_T                            ipc_ctrl_36;	//0x0188
	PE_M19_IPC_CTRL_37_T                            ipc_ctrl_37;	//0x018C
	PE_M19_IPC_CTRL_38_T                            ipc_ctrl_38;	//0x0190
	PE_M19_IPC_CTRL_39_T                            ipc_ctrl_39;	//0x0194
	PE_M19_IPC_CTRL_40_T                            ipc_ctrl_40;	//0x0198
	PE_M19_IPC_CTRL_41_T                            ipc_ctrl_41;	//0x019C
	PE_M19_IPC_CTRL_42_T                            ipc_ctrl_42;	//0x01A0
	PE_M19_IPC_CTRL_43_T                            ipc_ctrl_43;	//0x01A4
	PE_M19_IPC_CTRL_44_T                            ipc_ctrl_44;	//0x01A8
	PE_M19_IPC_CTRL_45_T                            ipc_ctrl_45;	//0x01AC
	PE_M19_IPC_CTRL_46_T                            ipc_ctrl_46;	//0x01B0
	PE_M19_IPC_CTRL_47_T                            ipc_ctrl_47;	//0x01B4
	PE_M19_IPC_CTRL_48_T                            ipc_ctrl_48;	//0x01B8
	PE_M19_IPC_CTRL_49_T                            ipc_ctrl_49;	//0x01BC
	PE_M19_IPC_CTRL_50_T                            ipc_ctrl_50;	//0x01C0
	PE_M19_IPC_CTRL_51_T                            ipc_ctrl_51;	//0x01C4
	PE_M19_IPC_CTRL_52_T                            ipc_ctrl_52;	//0x01C8
	PE_M19_IPC_CTRL_53_T                            ipc_ctrl_53;	//0x01CC
	PE_M19_IPC_CTRL_54_T                            ipc_ctrl_54;	//0x01D0
	PE_M19_IPC_CTRL_55_T                            ipc_ctrl_55;	//0x01D4
	UINT32                                            reserved01[2];	//0x01D8-0x01DC
	PE_M19_MMD_CTRL_T                               mmd_ctrl;	//0x01E0
	UINT32                                            reserved02[3];	//0x01E4-0x01EC
	PE_M19_IPC_CTRL_20_T                            ipc_ctrl_20;	//0x01F0
	PE_M19_IPC_CTRL_21_T                            ipc_ctrl_21;	//0x01F4
	PE_M19_IPC_CTRL_22_T                            ipc_ctrl_22;	//0x01F8
	PE_M19_IPC_CTRL_23_T                            ipc_ctrl_23;	//0x01FC
	PE_M19_IPC_CTRL_24_T                            ipc_ctrl_24;	//0x0200
	PE_M19_IPC_CTRL_25_T                            ipc_ctrl_25;	//0x0204
	PE_M19_IPC_CTRL_26_T                            ipc_ctrl_26;	//0x0208
	PE_M19_IPC_CTRL_27_T                            ipc_ctrl_27;	//0x020C
	PE_M19_IPC_CTRL_28_T                            ipc_ctrl_28;	//0x0210
	PE_M19_IPC_CTRL_29_T                            ipc_ctrl_29;	//0x0214
	PE_M19_IPC_CTRL_30_T                            ipc_ctrl_30;	//0x0218
	PE_M19_IPC_CTRL_31_T                            ipc_ctrl_31;	//0x021C
	PE_M19_IPC_CTRL_32_T                            ipc_ctrl_32;	//0x0220
	PE_M19_IPC_CTRL_33_T                            ipc_ctrl_33;	//0x0224
	PE_M19_IPC_STATUS_04_T                          ipc_status_04;	//0x0228
	PE_M19_IPC_STATUS_05_T                          ipc_status_05;	//0x022C
	PE_M19_IPC_STATUS_06_T                          ipc_status_06;	//0x0230
	PE_M19_IPC_STATUS_07_T                          ipc_status_07;	//0x0234
	PE_M19_IPC_STATUS_08_T                          ipc_status_08;	//0x0238
	PE_M19_IPC_STATUS_09_T                          ipc_status_09;	//0x023C
	PE_M19_TPD_CTRL_00_T                            tpd_ctrl_00;	//0x0240
	PE_M19_TPD_CTRL_01_T                            tpd_ctrl_01;	//0x0244
	PE_M19_TPD_CTRL_02_T                            tpd_ctrl_02;	//0x0248
	PE_M19_TPD_CTRL_03_T                            tpd_ctrl_03;	//0x024C
	PE_M19_TPD_CTRL_04_T                            tpd_ctrl_04;	//0x0250
	PE_M19_TPD_CTRL_05_T                            tpd_ctrl_05;	//0x0254
	PE_M19_TPD_CTRL_06_T                            tpd_ctrl_06;	//0x0258
	PE_M19_TPD_CTRL_07_T                            tpd_ctrl_07;	//0x025C
	PE_M19_TPD_CTRL_08_T                            tpd_ctrl_08;	//0x0260
	PE_M19_TPD_CTRL_09_T                            tpd_ctrl_09;	//0x0264
	PE_M19_TPD_STAT_00_T                            tpd_stat_00;	//0x0268
	PE_M19_CLC_CTRL_07_T                            clc_ctrl_07;	//0x026C
	PE_M19_BBD_CTRL_00_T                            bbd_ctrl_00;	//0x0270
	PE_M19_BBD_CTRL_01_T                            bbd_ctrl_01;	//0x0274
	PE_M19_BBD_CTRL_02_T                            bbd_ctrl_02;	//0x0278
	PE_M19_BBD_STAT_00_T                            bbd_stat_00;	//0x027C
	PE_M19_BBD_STAT_01_T                            bbd_stat_01;	//0x0280
	PE_M19_APL_STAT_00_T                            apl_stat_00;	//0x0284
	PE_M19_PE1_FSW_CTRL_00_T                        pe1_fsw_ctrl_00;
	PE_M19_PE1_FSW_CTRL_01_T                        pe1_fsw_ctrl_01;//0x0288-0x028C
	PE_M19_TPD_HIST_AI_CTRL_T                       tpd_hist_ai_ctrl;	//0x0290
	PE_M19_TPD_HIST_AI_DATA_T                       tpd_hist_ai_data;	//0x0294
	PE_M19_LVCRTL_CTRL_00_T                         lvcrtl_ctrl_00;	//0x0298
	PE_M19_TPD_STAT_01_T                            tpd_stat_01;	//0x029C
	PE_M19_TNR_STATUS_05_T                          tnr_status_05;	//0x02A0
	PE_M19_TNR_STATUS_06_T                          tnr_status_06;	//0x02A4
	PE_M19_TNR_STATUS_07_T                          tnr_status_07;	//0x02A8
	PE_M19_TNR_STATUS_08_T                          tnr_status_08;	//0x02AC
	UINT32                                            reserved04[4];	//0x02B0-0x02BC
	PE_M19_TNR_RESET_T                              tnr_reset;	//0x02C0
	UINT32                                            reserved05[3];	//0x02C4-0x02CC
	...
	UINT32                                            reserved06[3];	//0x02F4-0x02FC
	PE_M19_TNR_NE_STAT_00_T                         tnr_ne_stat_00;	//0x0300
	PE_M19_TNR_NE_STAT_01_T                         tnr_ne_stat_01;	//0x0304
	PE_M19_TNR_NE_STAT_02_T                         tnr_ne_stat_02;	//0x0308
	PE_M19_TNR_NE_STAT_03_T                         tnr_ne_stat_03;	//0x030C
	PE_M19_TNR_NE_STAT_04_T                         tnr_ne_stat_04;	//0x0310
	PE_M19_TNR_NE_STAT_05_T                         tnr_ne_stat_05;	//0x0314
	PE_M19_TNR_NE_STAT_06_T                         tnr_ne_stat_06;	//0x0318
	PE_M19_TNR_NE_STAT_07_T                         tnr_ne_stat_07;	//0x031C
	PE_M19_TNR_NE_STAT_08_T                         tnr_ne_stat_08;	//0x0320
	UINT32                                            reserved07[4];	//0x0324-0x0330
	UINT32                                            reserved205[19];	//0x334-0x37c
	PE_M19_ND_FSW_CTRL_00_T                         nd_fsw_ctrl_00;	//0x0380
	PE_M19_ND_FSW_CTRL_01_T                         nd_fsw_ctrl_01;	//0x0384
	PE_M19_ND_FSW_CTRL_02_T                         nd_fsw_ctrl_02;	//0x0388
	PE_M19_ND_FSW_CTRL_03_T                         nd_fsw_ctrl_03;	//0x038C
	PE_M19_TNR_ETC_CTRL_00_T                        tnr_etc_ctrl_00;	//0x0390
	PE_M19_TNR_ETC_CTRL_01_T                        tnr_etc_ctrl_01;	//0x0394
	PE_M19_TNR_ETC_CTRL_02_T                        tnr_etc_ctrl_02;	//0x0398
	PE_M19_TNR_ETC_CTRL_03_T                        tnr_etc_ctrl_03;	//0x039C
	...
	PE_M19_PE0_DEBUG3_T                             pe0_debug3;	//0x03B8
	UINT32                                            reserved08;	//0x03BC-0x03BC
	PE_M19_FBC_CTRL_02_T                            fbc_ctrl_02;	//0x03C0
	PE_M19_FBC_CTRL_03_T                            fbc_ctrl_03;	//0x03C4
	UINT32                                            reserved09[2];	//0x03C8-0x03CC
	PE_M19_GFD_CTRL_00_T                            gfd_ctrl_00;	//0x03D0
	PE_M19_GFD_CTRL_01_T                            gfd_ctrl_01;	//0x03D4
	PE_M19_GFD_STAT_00_T                            gfd_stat_00;	//0x03D8
	PE_M19_GFD_STAT_01_T                            gfd_stat_01;	//0x03DC
	PE_M19_GFD_STAT_02_T                            gfd_stat_02;	//0x03E0
	PE_M19_GFD_STAT_03_T                            gfd_stat_03;	//0x03E4
}PE_ND_ND0_REG_M19_T;

typedef struct
{ 
	PE_M19_PE0_LOAD_T                               pe0_load;	//0x0000
	PE_M19_PE0_INTR_T                               pe0_intr;	//0x0004
	PE_M19_PE0_STATUS0_T                            pe0_status0;	//0x0008
	PE_M19_PE0_STATUS1_T                            pe0_status1;	//0x000C
	PE_M19_PE0_OPMODE_T                             pe0_opmode;	//0x0010
	PE_M19_PE0_IN_SIZE_T                            pe0_in_size;	//0x0014
	PE_M19_PE0_IN_OFFSET_T                          pe0_in_offset;	//0x0018
	PE_M19_PE0_OUT_SIZE_T                           pe0_out_size;	//0x001C
	PE_M19_WIN_CTRL_0_T                             win_ctrl_0;	//0x0020
	PE_M19_WIN_CTRL_1_T                             win_ctrl_1;	//0x0024
	PE_M19_WIN_CTRL_2_T                             win_ctrl_2;	//0x0028
	PE_M19_WIN_CTRL_3_T                             win_ctrl_3;	//0x002C
	PE_M19_CUP_CTRL_00_T                            cup_ctrl_00;	//0x0030
	PE_M19_CUP_CTRL_01_T                            cup_ctrl_01;	//0x0034
	PE_M19_CUP_CTRL_02_T                            cup_ctrl_02;	//0x0038
	UINT32                                            reserved00[17];	//0x003C-0x007C
	PE_M19_VFILTER_CTRL_00_T                        vfilter_ctrl_00;	//0x0080
	PE_M19_VFILTER_CTRL_01_T                        vfilter_ctrl_01;	//0x0084
	PE_M19_VFILTER_CTRL_02_T                        vfilter_ctrl_02;	//0x0088
	PE_M19_CTI_CTRL_0_T                             cti_ctrl_0;	//0x008C
	PE_M19_CTI_CTRL_1_T                             cti_ctrl_1;	//0x0090
	PE_M19_DNR_MAX_CTRL_T                           dnr_max_ctrl;	//0x0094
	PE_M19_DNR_DBAR_CTRL_T                          dnr_dbar_ctrl;	//0x0098
	PE_M19_REG_C420_CTRL_T                          reg_c420_ctrl;	//0x009C
	PE_M19_MNR_CTRL_0_T                             mnr_ctrl_0;	//0x00A0
	PE_M19_MNR_CTRL_1_T                             mnr_ctrl_1;	//0x00A4
	PE_M19_MNR_CTRL_2_T                             mnr_ctrl_2;	//0x00A8
	PE_M19_MNR_CTRL_3_T                             mnr_ctrl_3;	//0x00AC
	PE_M19_MNR_CTRL_4_T                             mnr_ctrl_4;	//0x00B0
	PE_M19_MNR_CTRL_5_T                             mnr_ctrl_5;	//0x00B4
	PE_M19_DETAIL_CTRL_T                            detail_ctrl;	//0x00B8
	PE_M19_DC_BNR_CTRL_0_T                          dc_bnr_ctrl_0;	//0x00BC
	PE_M19_DC_BNR_CTRL_1_T                          dc_bnr_ctrl_1;	//0x00C0
	PE_M19_DC_BNR_CTRL_2_T                          dc_bnr_ctrl_2;	//0x00C4
	PE_M19_DC_BNR_CTRL_3_T                          dc_bnr_ctrl_3;	//0x00C8
	PE_M19_DC_BNR_CTRL_4_T                          dc_bnr_ctrl_4;	//0x00CC
	PE_M19_DC_BNR_CTRL_5_T                          dc_bnr_ctrl_5;	//0x00D0
	PE_M19_AC_BNR_CTRL_0_T                          ac_bnr_ctrl_0;	//0x00D4
	PE_M19_AC_BNR_CTRL_1_T                          ac_bnr_ctrl_1;	//0x00D8
	PE_M19_AC_BNR_CTRL_2_T                          ac_bnr_ctrl_2;	//0x00DC
	PE_M19_DNR_STAT_0_T                             dnr_stat_0;	//0x00E0
	PE_M19_AC_BNR_CTRL_3_T                          ac_bnr_ctrl_3;	//0x00E4
	PE_M19_AC_BNR_CTRL_4_T                          ac_bnr_ctrl_4;	//0x00E8
	PE_M19_DNR_STAT_1_T                             dnr_stat_1;	//0x00EC
	PE_M19_AC_BNR_CTRL_5_T                          ac_bnr_ctrl_5;	//0x00F0
	PE_M19_AC_BNR_CTRL_6_T                          ac_bnr_ctrl_6;	//0x00F4
	PE_M19_AC_BNR_CTRL_7_T                          ac_bnr_ctrl_7;	//0x00F8
	PE_M19_DNR_STAT_2_T                             dnr_stat_2;	//0x00FC
	PE_M19_AC_BNR_CTRL_8_T                          ac_bnr_ctrl_8;	//0x0100
	PE_M19_AC_BNR_CTRL_9_T                          ac_bnr_ctrl_9;	//0x0104
	PE_M19_AC_BNR_CTRL_10_T                         ac_bnr_ctrl_10;	//0x0108
	PE_M19_AC_BNR_CTRL_11_T                         ac_bnr_ctrl_11;	//0x010C
	PE_M19_AC_BNR_CTRL_12_T                         ac_bnr_ctrl_12;	//0x0110
	...
	PE_M19_IFC_CTRL_6_T                             ifc_ctrl_6;	//0x012C
	PE_M19_IFC_CTRL_7_T                             ifc_ctrl_7;	//0x0130
	PE_M19_IFC_CTRL_8_T                             ifc_ctrl_8;	//0x0134
	PE_M19_IFC_CTRL_9_T                             ifc_ctrl_9;	//0x0138
	PE_M19_IFC_CTRL_10_T                            ifc_ctrl_10;	//0x013C
	PE_M19_IFC_CTRL_11_T                            ifc_ctrl_11;	//0x0140
	PE_M19_IFC_CTRL_12_T                            ifc_ctrl_12;	//0x0144
	PE_M19_IFC_CTRL_13_T                            ifc_ctrl_13;	//0x0148
	PE_M19_IFC_CTRL_14_T                            ifc_ctrl_14;	//0x014C
	PE_M19_IFC_CTRL_15_T                            ifc_ctrl_15;	//0x0150
	PE_M19_IFC_CTRL_16_T                            ifc_ctrl_16;	//0x0154
	PE_M19_IFC_CTRL_17_T                            ifc_ctrl_17;	//0x0158
	PE_M19_IFC_CTRL_18_T                            ifc_ctrl_18;	//0x015C
	PE_M19_IFC_CTRL_19_T                            ifc_ctrl_19;	//0x0160
	PE_M19_IFC_CTRL_20_T                            ifc_ctrl_20;	//0x0164
	PE_M19_IFC_CTRL_21_T                            ifc_ctrl_21;	//0x0168
	PE_M19_SC_BNR_CTRL_0_T                          sc_bnr_ctrl_0;	//0x016C
	PE_M19_SC_BNR_CTRL_1_T                          sc_bnr_ctrl_1;	//0x0170
	PE_M19_SC_BNR_CTRL_2_T                          sc_bnr_ctrl_2;	//0x0174
	PE_M19_SC_BNR_CTRL_3_T                          sc_bnr_ctrl_3;	//0x0178
	PE_M19_SC_BNR_CTRL_4_T                          sc_bnr_ctrl_4;	//0x017C
	PE_M19_SC_BNR_CTRL_5_T                          sc_bnr_ctrl_5;	//0x0180
	PE_M19_SC_BNR_CTRL_6_T                          sc_bnr_ctrl_6;	//0x0184
	PE_M19_C_PRE_BLUR_CTRL_0_T                      c_pre_blur_ctrl_0;	//0x0188
	UINT32                                            reserved01[4];	//0x018C-0x0198
	PE_M19_AC_BNR_CTRL_13_T                         ac_bnr_ctrl_13;	//0x019C
	PE_M19_AC_BNR_CTRL_14_T                         ac_bnr_ctrl_14;	//0x01A0
	PE_M19_DC_BNR_CTRL_6_T                          dc_bnr_ctrl_6;	//0x01A4
	PE_M19_DC_BNR_CTRL_7_T                          dc_bnr_ctrl_7;	//0x01A8
	PE_M19_SQM_CTRL_0_T                             sqm_ctrl_0;	//0x01AC
	PE_M19_SQM_CTRL_1_T                             sqm_ctrl_1;	//0x01B0
	PE_M19_SQM_CTRL_2_T                             sqm_ctrl_2;	//0x01B4
	PE_M19_SQM_CTRL_3_T                             sqm_ctrl_3;	//0x01B8
	PE_M19_SQM_CTRL_4_T                             sqm_ctrl_4;	//0x01BC
	PE_M19_TPD_CTRL_0_T                             tpd_ctrl_0;	//0x01C0
	PE_M19_WINDOW_MODE_0_T                          window_mode_0;	//0x01C4
	PE_M19_WINDOW_MODE_1_T                          window_mode_1;	//0x01C8
	UINT32                                            reserved115;	//0x1cc
	PE_M19_DNR_STAT_3_T                             dnr_stat_3;	//0x01D0
	PE_M19_DNR_STAT_4_T                             dnr_stat_4;	//0x01D4
	PE_M19_DNR_STAT_5_T                             dnr_stat_5;	//0x01D8
	PE_M19_DNR_STAT_6_T                             dnr_stat_6;	//0x01DC
	PE_M19_DNR_STAT_7_T                             dnr_stat_7;	//0x01E0
	PE_M19_DNR_STAT_8_SC_BNR0_T                     dnr_stat_8_sc_bnr0;	//0x01E4
	PE_M19_DNR_STAT_9_SC_BNR1_T                     dnr_stat_9_sc_bnr1;	//0x01E8
	PE_M19_DNR_STAT_10_SC_BNR2_T                    dnr_stat_10_sc_bnr2;	//0x01EC
	PE_M19_DNR_STAT_11_SQM_00_T                     dnr_stat_11_sqm_00;	//0x01F0
	PE_M19_DNR_STAT_12_SQM_01_T                     dnr_stat_12_sqm_01;	//0x01F4
	PE_M19_DNR_STAT_13_SQM_02_T                     dnr_stat_13_sqm_02;	//0x01F8
	PE_M19_DNR_STAT_14_SQM_03_T                     dnr_stat_14_sqm_03;	//0x01FC
	PE_M19_DNR_STAT_15_SQM_04_T                     dnr_stat_15_sqm_04;	//0x0200
	PE_M19_DNR_STAT_16_SQM_05_T                     dnr_stat_16_sqm_05;	//0x0204
	PE_M19_DNR_STAT_17_SQM_06_T                     dnr_stat_17_sqm_06;	//0x0208
	PE_M19_DNR_STAT_18_SQM_07_T                     dnr_stat_18_sqm_07;	//0x020C
	PE_M19_DNR_STAT_19_SQM_08_T                     dnr_stat_19_sqm_08;	//0x0210
	PE_M19_DNR_STAT_20_SQM_09_T                     dnr_stat_20_sqm_09;	//0x0214
	PE_M19_DNR_STAT_21_SQM_10_T                     dnr_stat_21_sqm_10;	//0x0218
	PE_M19_DNR_STAT_22_SQM_11_T                     dnr_stat_22_sqm_11;	//0x021C
	PE_M19_DNR_STAT_23_TPD_0_T                      dnr_stat_23_tpd_0;	//0x0220
	PE_M19_DNR_STAT_24_TPD_1_T                      dnr_stat_24_tpd_1;	//0x0224
	PE_M19_DNR_STAT_25_TPD_2_T                      dnr_stat_25_tpd_2;	//0x0228
	UINT32                                            reserved02;	//0x022C-0x022C
	PE_M19_AC_BNR_15_T                              ac_bnr_15;	//0x0230
	PE_M19_AC_BNR_16_T                              ac_bnr_16;	//0x0234
	...
	PE_M19_REG_DECON_CTRL_0_T                       reg_decon_ctrl_0;	//0x0264
	PE_M19_REG_DECON_CTRL_1_T                       reg_decon_ctrl_1;	//0x0268
	PE_M19_REG_DECON_CTRL_2_T                       reg_decon_ctrl_2;	//0x026C
	PE_M19_REG_DECON_CTRL_3_T                       reg_decon_ctrl_3;	//0x0270
	PE_M19_REG_DECON_CTRL_4_T                       reg_decon_ctrl_4;	//0x0274
	PE_M19_REG_DECON_CTRL_5_T                       reg_decon_ctrl_5;	//0x0278
	PE_M19_REG_DECON_CTRL_6_T                       reg_decon_ctrl_6;	//0x027C
	PE_M19_REG_DECON_CTRL_7_T                       reg_decon_ctrl_7;	//0x0280
	PE_M19_REG_DECON_CTRL_8_T                       reg_decon_ctrl_8;	//0x0284
	PE_M19_REG_DECON_CTRL_9_T                       reg_decon_ctrl_9;	//0x0288
	PE_M19_REG_DECON_CTRL_10_T                      reg_decon_ctrl_10;	//0x028C
	PE_M19_REG_DC_BNR_CTRL_8_T                      reg_dc_bnr_ctrl_8;	//0x0290
	PE_M19_REG_DC_BNR_CTRL_9_T                      reg_dc_bnr_ctrl_9;	//0x0294
	PE_M19_REG_DC_BNR_CTRL_10_T                     reg_dc_bnr_ctrl_10;	//0x0298
	PE_M19_REG_DC_BNR_CTRL_11_T                     reg_dc_bnr_ctrl_11;	//0x029C
	PE_M19_REG_CTI_CTRL_2_T                         reg_cti_ctrl_2;	//0x02A0
	PE_M19_REG_CTI_CTRL_3_T                         reg_cti_ctrl_3;	//0x02A4
	PE_M19_REG_MNR_CTRL_6_T                         reg_mnr_ctrl_6;	//0x02A8
	PE_M19_REG_MNR_CTRL_7_T                         reg_mnr_ctrl_7;	//0x02AC
	PE_M19_REG_MNR_CTRL_8_T                         reg_mnr_ctrl_8;	//0x02B0
	PE_M19_REG_MNR_CTRL_9_T                         reg_mnr_ctrl_9;	//0x02B4
	PE_M19_REG_MNR_CTRL_10_T                        reg_mnr_ctrl_10;	//0x02B8
	PE_M19_REG_MNR_CTRL_11_T                        reg_mnr_ctrl_11;	//0x02BC
	PE_M19_REG_MNR_CTRL_12_T                        reg_mnr_ctrl_12;	//0x02C0
	PE_M19_REG_DECON_CTRL_11_T                      reg_decon_ctrl_11;	//0x02C4
	PE_M19_REG_DECON_CTRL_12_T                      reg_decon_ctrl_12;	//0x02C8
	PE_M19_REG_DECON_CTRL_13_T                      reg_decon_ctrl_13;	//0x02CC
	PE_M19_REG_DECON_CTRL_14_T                      reg_decon_ctrl_14;	//0x02D0
	PE_M19_REG_DECON_CTRL_15_T                      reg_decon_ctrl_15;	//0x02D4
	PE_M19_REG_DECON_CTRL_16_T                      reg_decon_ctrl_16;	//0x02D8
	PE_M19_REG_DECON_CTRL_17_T                      reg_decon_ctrl_17;	//0x02DC
	PE_M19_REG_DECON_CTRL_18_T                      reg_decon_ctrl_18;	//0x02E0
	PE_M19_REG_DECON_CTRL_19_T                      reg_decon_ctrl_19;	//0x02E4
	PE_M19_REG_DECON_CTRL_20_T                      reg_decon_ctrl_20;	//0x02E8
	PE_M19_REG_DECON_CTRL_21_T                      reg_decon_ctrl_21;	//0x02EC
	PE_M19_REG_DECON_CTRL_22_T                      reg_decon_ctrl_22;	//0x02F0
	PE_M19_REG_DECON_CTRL_23_T                      reg_decon_ctrl_23;	//0x02F4
	PE_M19_REG_DECON_CTRL_24_T                      reg_decon_ctrl_24;	//0x02F8
	PE_M19_REG_DECON_CTRL_25_T                      reg_decon_ctrl_25;	//0x02FC
	PE_M19_REG_DECON_CTRL_26_T                      reg_decon_ctrl_26;	//0x0300
	PE_M19_REG_DECON_CTRL_27_T                      reg_decon_ctrl_27;	//0x0304
	PE_M19_REG_DECON_CTRL_28_T                      reg_decon_ctrl_28;	//0x0308
	PE_M19_REG_DECON_CTRL_29_T                      reg_decon_ctrl_29;	//0x030C
	PE_M19_REG_DECON_CTRL_30_T                      reg_decon_ctrl_30;	//0x0310
	PE_M19_REG_DECON_CTRL_31_T                      reg_decon_ctrl_31;	//0x0314
	PE_M19_REG_DECON_CTRL_32_T                      reg_decon_ctrl_32;	//0x0318
	PE_M19_REG_DECON_CTRL_33_T                      reg_decon_ctrl_33;	//0x031C
	PE_M19_REG_DECON_CTRL_34_T                      reg_decon_ctrl_34;	//0x0320
	PE_M19_REG_DECON_CTRL_35_T                      reg_decon_ctrl_35;	//0x0324
	PE_M19_REG_DECON_CTRL_36_T                      reg_decon_ctrl_36;	//0x0328
	PE_M19_REG_DECON_CTRL_37_T                      reg_decon_ctrl_37;	//0x032C
	PE_M19_REG_DECON_CTRL_38_T                      reg_decon_ctrl_38;	//0x0330
	PE_M19_REG_DECON_CTRL_39_T                      reg_decon_ctrl_39;	//0x0334
	PE_M19_REG_DECON_CTRL_40_T                      reg_decon_ctrl_40;	//0x0338
	PE_M19_REG_DECON_CTRL_41_T                      reg_decon_ctrl_41;	//0x033C
	PE_M19_REG_DECON_CTRL_42_T                      reg_decon_ctrl_42;	//0x0340
	PE_M19_REG_DECON_CTRL_43_T                      reg_decon_ctrl_43;	//0x0344
	PE_M19_REG_DECON_CTRL_44_T                      reg_decon_ctrl_44;	//0x0348
	PE_M19_REG_DECON_CTRL_45_T                      reg_decon_ctrl_45;	//0x034C
	PE_M19_REG_DECON_CTRL_46_T                      reg_decon_ctrl_46;	//0x0350
	PE_M19_REG_DECON_CTRL_47_T                      reg_decon_ctrl_47;	//0x0354
	PE_M19_REG_DECON_CTRL_48_T                      reg_decon_ctrl_48;	//0x0358
	PE_M19_REG_DECON_CTRL_49_T                      reg_decon_ctrl_49;	//0x035C
	PE_M19_REG_DECON_CTRL_50_T                      reg_decon_ctrl_50;	//0x0360
	PE_M19_REG_DECON_CTRL_51_T                      reg_decon_ctrl_51;	//0x0364
	PE_M19_REG_DECON_CTRL_52_T                      reg_decon_ctrl_52;	//0x0368
	PE_M19_REG_DECON_CTRL_53_T                      reg_decon_ctrl_53;	//0x036C
	PE_M19_REG_DECON_CTRL_54_T                      reg_decon_ctrl_54;	//0x0370
	PE_M19_REG_DECON_CTRL_55_T                      reg_decon_ctrl_55;	//0x0374
	PE_M19_REG_DECON_CTRL_56_T                      reg_decon_ctrl_56;	//0x0378
	PE_M19_REG_DECON_CTRL_57_T                      reg_decon_ctrl_57;	//0x037C
	PE_M19_REG_DECON_CTRL_58_T                      reg_decon_ctrl_58;	//0x0380
	PE_M19_REG_DECON_CTRL_59_T                      reg_decon_ctrl_59;	//0x0384
	PE_M19_REG_DECON_CTRL_60_T                      reg_decon_ctrl_60;	//0x0388
	PE_M19_REG_DECON_CTRL_61_T                      reg_decon_ctrl_61;	//0x038C
	PE_M19_REG_DECON_CTRL_62_T                      reg_decon_ctrl_62;	//0x0390
	PE_M19_REG_DECON_CTRL_63_T                      reg_decon_ctrl_63;	//0x0394
}PE_ND_DNR0_REG_M19_T;

typedef struct {
	PE_M19_CTRL_M0_Y_LEVEL_CTRL_T         ctrl_m0_y_level_ctrl;
}PE_TOP_IMX_REG_M19_T;
