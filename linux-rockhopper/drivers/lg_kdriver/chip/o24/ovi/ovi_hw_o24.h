...
#ifndef  OVI_HW_O24_INC
#define  OVI_HW_O24_INC
/*----------------------------------------------------------------------------------------
 *   Control Constants
 *---------------------------------------------------------------------------------------*/
#if (CONFIG_LX_O24_CHIP_FIRMWARE == 1)
#undef BE_OVI_HW_O24_USE_VX1_CHIP_INFO
#endif
...
#define BE_OVI_HW_O24_USE_VX1_CHIP_INFO_APB_SLAVE

#define BE_OVI_HW_O24_VX1_CHIP_INFO_TOTAL_MEM_SIZE 0x00100000
#define BE_OVI_HW_O24_VX1_CHIP_INFO_MEM_BUFF_SIZE 49152
#define BE_OVI_HW_O24_VX1_CHIP_INFO_MEM_BUFF_TOTAL_NUM 6 // including the buffer for PE
#define BE_OVI_HW_O24_VX1_CHIP_INFO_MEM_BUFF_NUM 2
#define BE_OVI_HW_O24_VX1_CHIP_INFO_MEM_BUFF_IDX_TAP 3
#define BE_OVI_HW_O24_VX1_CHIP_INFO_MEM_DATA_PACK_OFFSET 31732
#define BE_OVI_HW_O24_VX1_CHIP_INFO_MEM_DATA_SIZE 17408 // == 0x4400
#define BE_OVI_HW_O24_VX1_CHIP_INFO_MEM_DATA_PACK_SIZE (BE_OVI_HW_O24_VX1_CHIP_INFO_MEM_DATA_SIZE+12) // 12 = 4:Header + 4:CRC + 4:End Packet

#define OVI_HW_O24_GAMMA_TABLE_SIZENUM 1024

#define OVI_HW_O24_VX1_CHIP_INFO_DPG_DATA_SIZENUM ((1024*3)+1)
#define OVI_HW_O24_VX1_CHIP_INFO_DPG_CTRL_SIZENUM (4)
#define OVI_HW_O24_VX1_CHIP_INFO_COLOR_TEMP_SIZENUM (14)
#define BE_HW_O24_VX1_CHIP_INFO_LED_SPI_CTRL_SIZENUM (2)
#define BE_HW_O24_VX1_CHIP_INFO_PCC_SIZENUM (18)
#define BE_HW_O24_VX1_CHIP_INFO_OSD_RGBLV_CTRL_SIZENUM (2)
#define BE_HW_O24_VX1_CHIP_INFO_PHDR_SIZENUM (128)
#ifdef BE_OVI_HW_O24_USE_VX1_CHIP_INFO_APB_SLAVE
#define BE_HW_O24_VX1_CHIP_INFO_RSVD_SIZENUM (1074)
#else
#define BE_HW_O24_VX1_CHIP_INFO_RSVD_SIZENUM (1097)
#endif
#define OVI_HW_O24_VX1_CHIP_INFO_DPG_DATA_SIZE (OVI_HW_O24_VX1_CHIP_INFO_DPG_DATA_SIZENUM*sizeof(UINT32))
#define OVI_HW_O24_VX1_CHIP_INFO_DPG_CTRL_SIZE (OVI_HW_O24_VX1_CHIP_INFO_DPG_CTRL_SIZENUM*sizeof(UINT32))
#define OVI_HW_O24_VX1_CHIP_INFO_COLOR_TEMP_SIZE (OVI_HW_O24_VX1_CHIP_INFO_COLOR_TEMP_SIZENUM*sizeof(UINT32))
#define BE_HW_O24_VX1_CHIP_INFO_LED_SPI_CTRL_SIZE (BE_HW_O24_VX1_CHIP_INFO_LED_SPI_CTRL_SIZENUM*sizeof(UINT32))
#define BE_HW_O24_VX1_CHIP_INFO_PCC_SIZE (BE_HW_O24_VX1_CHIP_INFO_PCC_SIZENUM*sizeof(UINT32))
#define BE_HW_O24_VX1_CHIP_INFO_OSD_RGBLV_CTRL_SIZE (BE_HW_O24_VX1_CHIP_INFO_OSD_RGBLV_CTRL_SIZENUM*sizeof(UINT32))
#define BE_HW_O24_VX1_CHIP_INFO_PHDR_SIZE (BE_HW_O24_VX1_CHIP_INFO_PHDR_SIZENUM*sizeof(UINT32))
#define BE_HW_O24_VX1_CHIP_INFO_RSVD_SIZE (BE_HW_O24_VX1_CHIP_INFO_RSVD_SIZENUM*sizeof(UINT32))

#ifdef BE_OVI_HW_O24_USE_VX1_CHIP_INFO_APB_SLAVE
typedef enum {
	OVI_HW_O24_VX1_CHIP_INFO_DPG = 0,
	OVI_HW_O24_VX1_CHIP_INFO_CLR_TMP = 1,
	BE_HW_O24_VX1_CHIP_INFO_LED_CTRL = 4,
	BE_HW_O24_VX1_CHIP_INFO_PCC = 5,
	BE_HW_O24_VX1_CHIP_INFO_OSD_LVL = 8,
	BE_HW_O24_VX1_CHIP_INFO_PHDR = 9,
	BE_OVI_HW_O24_VX1_CHIP_INFO_APB_MAX
} BE_OVI_HW_O24_VX1_CHIP_INFO_APB_TYPE;

#define BE_OVI_HW_O24_VX1_CHIP_INFO_APB_NUM BE_OVI_HW_O24_VX1_CHIP_INFO_APB_MAX
#define BE_OVI_HW_O24_VX1_CHIP_INFO_HDR		(0x05190000)
#define BE_OVI_HW_O24_VX1_CHIP_INFO_EP		(0x8ED00000)
...
} BE_OVI_HW_O24_VX1_CHIP_INFO_APB_INFO_T;
...
} BE_OVI_HW_O24_VX1_CHIP_INFO_APB_POS_T;
...
} BE_OVI_HW_O24_VX1_CHIP_INFO_APB_CNT0_T;
...
} BE_OVI_HW_O24_VX1_CHIP_INFO_APB_CNT1_T;
...
} BE_OVI_HW_O24_VX1_CHIP_INFO_APB_CNT2_T;
...
} BE_OVI_HW_O24_VX1_CHIP_INFO_APB_CNT3_T;
...
} BE_OVI_HW_O24_VX1_CHIP_INFO_APB_CNT4_T;
...
} BE_OVI_HW_O24_VX1_CHIP_INFO_APB_CNT5_T;
...
} BE_OVI_HW_O24_VX1_CHIP_INFO_APB_CNT6_T;
...
} BE_OVI_HW_O24_VX1_CHIP_INFO_APB_CNT7_T;

typedef struct
{
	BE_OVI_HW_O24_VX1_CHIP_INFO_APB_INFO_T info;
	BE_OVI_HW_O24_VX1_CHIP_INFO_APB_CNT0_T cnt0;
	BE_OVI_HW_O24_VX1_CHIP_INFO_APB_CNT1_T cnt1;
	BE_OVI_HW_O24_VX1_CHIP_INFO_APB_CNT2_T cnt2;
	BE_OVI_HW_O24_VX1_CHIP_INFO_APB_CNT3_T cnt3;
	BE_OVI_HW_O24_VX1_CHIP_INFO_APB_CNT4_T cnt4;
	BE_OVI_HW_O24_VX1_CHIP_INFO_APB_CNT5_T cnt5;
	BE_OVI_HW_O24_VX1_CHIP_INFO_APB_CNT6_T cnt6;
	BE_OVI_HW_O24_VX1_CHIP_INFO_APB_CNT7_T cnt7;
	BE_OVI_HW_O24_VX1_CHIP_INFO_APB_POS_T pos[32];
} BE_OVI_HW_O24_VX1_CHIP_INFO_DAT_HDR_T;

typedef struct {
	UINT32 wDataRegAddr; // offset [0x98]
	UINT32 wdata[OVI_HW_O24_GAMMA_TABLE_SIZENUM*3];
/*
	UINT32 wrDoneRegAddr;
	UINT32 wrDoneVal;
	UINT32 enRegAddr;
	UINT32 enVal;*/ // Write in F/W
} OVI_HW_O24_VX1_CHIP_INFO_DPG_T;
...
typedef struct {
	...
	UINT32 wbBOffsetVal;
} OVI_HW_O24_VX1_CHIP_INFO_COLOR_TEMP_T;

typedef struct {
	UINT32 ledSpiCtrlRegAddr;
	UINT32 ledSpiCtrlVal;
} BE_HW_O24_VX1_CHIP_INFO_LED_SPI_CTRL_T;
...
typedef struct {
	...
	UINT32 pccCtrlVal;
} BE_HW_O24_VX1_CHIP_INFO_PCC_T;

typedef struct {
	UINT32 osdLvCtrlRegAddr;
	UINT32 osdLvCtrlVal;
} BE_HW_O24_VX1_CHIP_INFO_OSD_RGBLV_CTRL_T;
...
} BE_HW_O24_VX1_CHIP_INFO_PHDR_T;

typedef struct {
	UINT32 rsvd[BE_HW_O24_VX1_CHIP_INFO_RSVD_SIZENUM];
} BE_HW_O24_VX1_CHIP_INFO_RSVD_T;

typedef struct {
	UINT32 hwHdr; 										// offset [0x0] 
	BE_OVI_HW_O24_VX1_CHIP_INFO_DAT_HDR_T datHdr;		//		 [0x4]
	OVI_HW_O24_VX1_CHIP_INFO_DPG_T dpg;					//		 [0xA8]
	OVI_HW_O24_VX1_CHIP_INFO_COLOR_TEMP_T colorTemp;	//		 [0x30AC]
	BE_HW_O24_VX1_CHIP_INFO_LED_SPI_CTRL_T ledSpiCtrl;	//		 [0x30E4]
	BE_HW_O24_VX1_CHIP_INFO_PCC_T pcc;					//		 [0x30EC]
	BE_HW_O24_VX1_CHIP_INFO_OSD_RGBLV_CTRL_T osdLvCtrl;	//		 [0x3134]
	BE_HW_O24_VX1_CHIP_INFO_PHDR_T phdr; 				//       [0x313C]
	BE_HW_O24_VX1_CHIP_INFO_RSVD_T rsvd;				//		 [0x333C]
	UINT32 hwCrc;										//		 [0x4404]
	UINT32 endPacket; // end of APB slave buffer			//		 [0x4408]
} BE_OVI_HW_O24_VX1_CHIP_INFO_T;
...
typedef struct {
	OVI_HW_O24_VX1_CHIP_INFO_DPG_T dpg;					// offset [0x0] 
	OVI_HW_O24_VX1_CHIP_INFO_COLOR_TEMP_T colorTemp;	//		 [0x3024] 
	BE_HW_O24_VX1_CHIP_INFO_LED_SPI_CTRL_T ledSpiCtrl;	//		 [0x3064] 
	BE_HW_O24_VX1_CHIP_INFO_PCC_T pcc;					//		 [0x3074] 
	BE_HW_O24_VX1_CHIP_INFO_OSD_RGBLV_CTRL_T osdLvCtrl;	//		 [0x30C4] 
	BE_HW_O24_VX1_CHIP_INFO_PHDR_T phdr; 				//       [0x30D4]
	BE_HW_O24_VX1_CHIP_INFO_RSVD_T rsvd;				//		 [0x32DC]
