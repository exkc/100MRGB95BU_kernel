...
#if 1   //nalm
#ifdef INCLUDE_KDRV_DE
    LX_MEMCFG_ENTRY_EX(gMemCfgDeFwO20[4], MEM_DESC(DE_FW0)),   /* DE FW(1MB)_M0 reserved */
    LX_MEMCFG_ENTRY_EX(gMemCfgO20[0], MEM_DESC(DE_PREW)),   /* DE PREW_M0 */   
    LX_MEMCFG_ENTRY_EX(gMemCfgO20[1],  MEM_DESC(DE_FRM1)),  /* DE_FRM1 */
    LX_MEMCFG_ENTRY_EX(gMemCfgO20[3], MEM_DESC(BT0)),       /* DE_BT0 */
    LX_MEMCFG_ENTRY_EX(gMemCfgO20[5], MEM_DESC(VT0)),       /* DE_VT0 */
    LX_MEMCFG_ENTRY_EX(gMemCfgHDR[2], MEM_DESC(HDR)),       /* HDR(3MB) M0 */
    LX_MEMCFG_ENTRY_EX(gMemCfgBe[6], MEM_DESC(BE)),         /* BE DB  */
#endif
#endif
...
#ifdef INCLUDE_KDRV_DE
    LX_MEMCFG_ENTRY_EX(gMemCfgDeFwO20[1], MEM_DESC(DE_FW1)),   /* DE FW(4MB)_M1 MCU1 + shared mem */
    LX_MEMCFG_ENTRY_EX(gMemCfgDeFwO20[0], MEM_DESC(DE_FW2)),   /* DE FW(4MB)_M1 MCU0  */
    LX_MEMCFG_ENTRY_EX(gMemCfgO20[2], MEM_DESC(DE_FRM2)),   /* DE FRM2 */

	LX_MEMCFG_ENTRY_EX(gMemCfgBeFrc[2], MEM_DESC(BE_FRC0)), /* BE FPP  */
...
#ifdef INCLUDE_KDRV_DE
    LX_MEMCFG_ENTRY_EX(gMemCfgO20[4], MEM_DESC(BT1)),        /* DE_BT1 */
    LX_MEMCFG_ENTRY_EX(gMemCfgO20[6], MEM_DESC(VT1)),        /* DE_VT1 */
#endif
