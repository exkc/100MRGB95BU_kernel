...
**
**  Functions
**  Implemented:   char*	DEMOD_M16P_ANALOG_WhatAudioSystem
**                  int DEMOD_M16P_ANALOG_Demod_Open
**                  int DEMOD_M16P_ANALOG_Demod_Open
**                  int DEMOD_M16P_ANALOG_Set_IF_Frq
**                  int DEMOD_M16P_ANALOG_Set_AftRange
**                  int DEMOD_M16P_ANALOG_ChangeAudioSystem
**                  int DEMOD_M16P_ANALOG_SetAudioSystem
**                  int DEMOD_M16P_ANALOG_SetAudioSystem
**                  int DEMOD_M16P_ANALOG_SetLowIFinput
**                  LX_ADEMOD_VideoStandard DEMOD_M16P_ANALOG_GetVideoStandard
**                  int DEMOD_M16P_ANALOG_SetSIFMode
**                  int DEMOD_M16P_ANALOG_SetAGCTOP
**                  int DEMOD_M16P_ANALOG_SmartTune
**                  int DEMOD_M16P_ANALOG_CheckVideoCarrier
**                  int DEMOD_M16P_ANALOG_CheckVideoSync
**                  int DEMOD_M16P_ANALOG_ControlOutput
**                  int DEMOD_M16P_ANALOG_Get_FreqOffset
**                  int DEMOD_M16P_ANALOG_ChangeFilter4SIF
**                  int DEMOD_M16P_ANALOG_CarrierlockScan
**                  int DEMOD_M16P_ANALOG_SoftReset
**                  int DEMOD_M16P_ANALOG_Set_CvbsDecCtrl
**                  int DEMOD_M16P_ANALOG_Set_CvbsRateConversion
**                  int DEMOD_M16P_ANALOG_Set_HighCvbsRateOffset
**                  int DEMOD_M16P_ANALOG_Set_SifCtrl
**                  int DEMOD_M16P_ANALOG_Set_SifPathCtrl
**                  int DEMOD_M16P_ANALOG_Set_SpectrumInv
**                  int DEMOD_M16P_ANALOG_Obtaining_Signal_Lock
**                  int DEMOD_M16P_ANALOG_Monitoring_Signal_Lock
**
**                  int DEMOD_M16P_ANALOG_Dbg_Get_RegDump
**                  int DEMOD_M16P_ANALOG_Dbg_Set_RegisterValue
**                  int DEMOD_M16P_ANALOG_Dbg_SmartTune
**                  int DEMOD_M16P_ANALOG_Dbg_Get_RegisterValue
**                  int DEMOD_M16P_ANALOG_Dbg_TestFunctions
**                  int DEMOD_M16P_ANALOG_OptimizingTunerInBrazil
**                  int DEMOD_M16P_ANALOG_OptimizingTunerInBrazil
**
**  References:
**
...
extern BOOLEAN _gM16PSpectrumInv;
...
*/
char*	DEMOD_M16P_ANALOG_WhatAudioSystem(LX_DEMOD_ANALOG_SIF_SOUNDSYSTEM_T audioSystem)
{
	UINT8	index = 0;
 ...
 * @author	Jeongpil Yun (jeongpil.yun@lge.com)
 */
int DEMOD_M16P_ANALOG_Demod_Open(UINT32 chipDevID, UINT32 handleI2C,  Handle_t *phDevice)
{
	Handle_t pFmHandle = NULL;

	if (retOK != DEMOD_M16P_Analog_Demod_Open(chipDevID, &handleI2C, sizeof(handleI2C), &pFmHandle))
	{
		DEMOD_PRINT( "^r^[M16P  ATV] FAIL (%s:%d) ADEMOD_Demod_Open  !!!\n",  __F__, __L__);
...
/**
 * DEMOD_M16P_ANALOG_Init.
 *
 * @param	phDevice	[in] UINT32
 * @return	OK/FAIL
 * @author	Jeongpil Yun (jeongpil.yun@lge.com)
 */
int DEMOD_M16P_ANALOG_Init(Handle_t phDevice, LX_DEMOD_RF_MODE_T rfMode)
{
	...
	{
		DEMOD_PRINT( "^r^[M16P  ATV] FAIL (%s:%d) DEMOD_M16P_ANALOG_Init - Invaild rf mode !!!\n",  __F__, __L__);
		DEMOD_RETURN_FAIL(__F__);

	}
	if (retOK != DEMOD_M16P_ANALOG_SetLowIFinput(phDevice, pllClkSource, ifFreq, 1))
	{
		DEMOD_PRINT( "^r^[M16P  ATV] FAIL (%s:%d) DEMOD_M16P_ANALOG_SetLowIFinput  !!!\n",  __F__, __L__);
		DEMOD_RETURN_FAIL(__F__);
	}
 ...
 * @author	Jeongpil Yun (jeongpil.yun@lge.com)
 */
int DEMOD_M16P_ANALOG_Set_IF_Frq(Handle_t phDevice, UINT32 pllClkSource, UINT32 ifFrq)
{
	int ifFreq;
	...
	switch(pllClkSource)
	{
		...
		default :
			DEMOD_PRINT( "^r^[M16P  ATV] FAIL (%s:%d) Invaild symbol rate, going to default setting(27MHz) !!!\n",  __F__, __L__);
			{
				dmd_mc_dmdpll		= 0xd;
				dmd_div_adc_dmdpll	= 0x1;
				dmd_div1_dmdpll 	= 0x4;
	...
	if (retOK != DEMOD_M16P_ANALOG_Set_CvbsRateConversion(phDevice, pllClkSource))
	{
		DEMOD_PRINT( "^r^[M16P  ATV] FAIL (%s:%d) DEMOD_M16P_ANALOG_Set_CvbsRateConversion !!!\n",  __F__, __L__);
		DEMOD_RETURN_FAIL(__F__);
	}
...
/**
 * DEMOD_M16P_ANALOG_Set_AftRange.
 *
 * @param	phDevice	[in] UINT32
 * @return	OK/FAIL
 * @author	Jeongpil Yun (jeongpil.yun@lge.com)
 */
int DEMOD_M16P_ANALOG_Set_AftRange(Handle_t phDevice, LX_DEMOD_ANALOG_ATFRANGE_PARAM_T aftRange)
{
	UINT32 rangeValue[3];
 ...
 * @author 	Jeongpil Yun (jeongpil.yun@lge.com)
 */
 int DEMOD_M16P_ANALOG_ChangeAudioSystem(LX_DEMOD_SMARTTUNE_PARAM_T *pSmartTuneParam)
{
	...
	videoStd	= DEMOD_M16P_ANALOG_GetVideoStandard(audioSystem);


	// Execute System Init preset
	if (retOK != ADEMOD_Preset_Set(phDevice, NULL, LX_ADEMOD_PRESET_SYSTEM_INIT))
	{
		DEMOD_PRINT( "[ABB M16P] FAIL (%s:%d) ADEMOD_Preset_Set !!!\n",  __F__, __L__);
		DEMOD_RETURN_FAIL(__F__);
	}

	DEMOD_M16P_ANALOG_SmartTune(pSmartTuneParam, TRUE);

	ADEMOD_SetGroupDelay(phDevice, videoStd);

	DEMOD_PRINT( "[ABB M16P] Set %s !!!\n",  DEMOD_M16P_ANALOG_WhatAudioSystem(audioSystem));
 ...
 * @author 	Jeongpil Yun (jeongpil.yun@lge.com)
 */
 int DEMOD_M16P_ANALOG_SetAudioSystem(LX_DEMOD_SMARTTUNE_PARAM_T *pSmartTuneParam)
{
    ...
    DEMOD_PRINT( "[ABB M16P](%s:%d) !!!\n",__F__,__L__);

    DEMOD_PRINT( "[ABB M16P](%s:%d) tune mode = %d !!!\n",__F__,__L__,tuneMode);

	DEMOD_PRINT( "[ABB M16P] gPreviousAudio = %d, nextAudioSystem = %d !!!\n", gPreviousAudio,nextAudioSystem);

	if (LX_DEMOD_NTSC == pSmartTuneParam->rfMode)
	{
		if (gPreviousAudio == nextAudioSystem)
		{
			DEMOD_PRINT( "[ABB M16P] Same %s : Only SmartTune() !!!\n",  DEMOD_M16P_ANALOG_WhatAudioSystem(nextAudioSystem));
			if(tuneMode != LX_DEMOD_TUNE_NORMAL)
			{
				if(retOK != DEMOD_M16P_ANALOG_SoftReset(phDevice))
				{
					DEMOD_PRINT("[ABB M16P] FAIL (%s:%d) DEMOD_M16P_ANALOG_SoftReset !!!\n", __F__, __L__);
					DEMOD_RETURN_FAIL(__F__);
				}
		...
		{
			DEMOD_M16P_ANALOG_ChangeAudioSystem( pSmartTuneParam);
		}

//		DEMOD_M16P_ANALOG_SetSIFMode(phDevice);
		DEMOD_M16P_ANALOG_SetAGCTOP(phDevice, pSmartTuneParam->frequency,LX_DEMOD_NTSC);
	...
	else if (LX_DEMOD_PAL == rfMode)
	{
		...
		{
			DEMOD_PRINT( "[ABB M16P] ** LX_DEMOD_TUNE_AUTO_START **** !!!\n");
			if (!((LX_DEMOD_ANALOG_SIF_SYSTEM_L == nextAudioSystem) || (LX_DEMOD_ANALOG_SIF_SYSTEM_LP == nextAudioSystem)))
			{
				...
				DEMOD_PRINT( "[ABB M16P] Auto Start : Not NTSC, Not L(P) ==> Force to DK !!!\n");
			}
...
//		DEMOD_M16P_ANALOG_SetSIFMode(phDevice);
		DEMOD_M16P_ANALOG_SetAGCTOP(phDevice, pSmartTuneParam->frequency, LX_DEMOD_PAL);
 ...
 * @author
*/
 int DEMOD_M16P_ANALOG_CheckIFLevel(Handle_t phDevice,  UINT32 *pIFLevel)
{
    ...
    {
        DEMOD_PRINT( "[M16P ABB] FAIL (%s:%d) ADEMOD_Parameter_Get(LXDEMOD_M16P_ANALOG_PARM_IF_LEVEL_STAT)\n",  __F__, __L__);
		*pIFLevel = 0;
		DEMOD_RETURN_FAIL(__F__);
    }
...
int DEMOD_M16P_ANALOG_SetLowIFinput(Handle_t phDevice, UINT32 pllClkSource, int lif_freq, UINT8 isdefault)
{
	...
	{
		DEMOD_PRINT("[ABB M16P] FAIL (%s:%d) ADEMOD_Register_Set() !!!\n", __F__, __L__);
		DEMOD_RETURN_FAIL(__F__);
	}
 ...
 * @author 	Jeongpil Yun (jeongpil.yun@lge.com)
 */
LX_ADEMOD_VideoStandard DEMOD_M16P_ANALOG_GetVideoStandard(LX_DEMOD_ANALOG_SIF_SOUNDSYSTEM_T audioSystem)
{
	switch(audioSystem)
	{
 ...
 * @author 	Jeongpil Yun (jeongpil.yun@lge.com)
 */
int DEMOD_M16P_ANALOG_SetSIFMode(Handle_t phDevice)
{
	...
	{
		DEMOD_PRINT( "[ABB M16P] FAIL (%s:%d) ADEMOD_Parameter_Set(LX_ADEMOD_PARM_AUD_MODE) !!!\n",  __F__, __L__);
		DEMOD_RETURN_FAIL(__F__);
	}
 ...
 * @author 	Jeongpil Yun (jeongpil.yun@lge.com)
 */
int DEMOD_M16P_ANALOG_SetAGCTOP(Handle_t phDevice, UINT32 frequency, LX_DEMOD_RF_MODE_T rfMode )
{
	...
	{
		DEMOD_PRINT( "[ABB M16P] FAIL (%s:%d) ADEMOD_Parameter_Set(LX_ADEMOD_PARM_AGC_BACKOFF) !!!\n",  __F__, __L__);
		DEMOD_RETURN_FAIL(__F__);
	}

	DEMOD_PRINT( "[M16P  ATV] ABB : AGC TOP %d dB  !!!\n",  data[1]/10);
	return RET_OK;
}
 ...
 * @author 	Jeongpil Yun (jeongpil.yun@lge.com)
 */
int DEMOD_M16P_ANALOG_SmartTune(LX_DEMOD_SMARTTUNE_PARAM_T *pSmartTuneParam,  BOOLEAN bForce)
{
	...
	DEMOD_PRINT( "[ABB M16P] _____(%s(%c))_____\n",  __F__, bForce ? 'T' : 'F');
	...
	{
		DEMOD_PRINT( "[ABB M16P] ERR (%s:%d) INVALID audio system(%s) !!!\n",  __F__, __L__, DEMOD_M16P_ANALOG_WhatAudioSystem(audioSystem));
		DEMOD_RETURN_FAIL(__F__);
	}
	...
	smartTune.Update	= 1;
	DEMOD_PRINT("[ABB M16P](%s) smartTune.IF %d Hz !!!\n",  __F__, smartTune.IF);
	DEMOD_PRINT("[ABB M16P](%s) smartTune.SmplRate %d Hz !!!\n", __F__, smartTune.SmplRate);
	DEMOD_PRINT("[ABB M16P](%s) smartTune.Filter %d  !!!\n", __F__, smartTune.Filter);
	DEMOD_PRINT("[ABB M16P](%s) smartTune.Freq %d Hz !!!\n",  __F__, smartTune.Freq);
	...
	if(LX_DEMOD_IS_TUNE_SCAN(tuneMode))
	{
		...
		{
			DEMOD_PRINT( "[ABB M16P] FAIL (%s:%d) ADEMOD_Demodulator_Set_ChannelScan !!!\n",  __F__, __L__);
			DEMOD_RETURN_FAIL(__F__);
		}
		...
		if((tuneMode == LX_DEMOD_TUNE_AUTO_START) && (rfMode == LX_DEMOD_NTSC))
		{
				UINT32 value;
				value = 4500000L;
				DEMOD_PRINT( "[ABB M16P] Set to BW 4.5Mhz !!!\n");
...
#endif
	{
		...
		{
			DEMOD_PRINT( "[ABB M16P]] FAIL (%s:%d) ADEMOD_Channel_Set !!!\n",  __F__, __L__);
			DEMOD_RETURN_FAIL(__F__);
		}
 ...
 */
int DEMOD_M16P_ANALOG_CheckVideoCarrier(Handle_t phDevice, LX_DEMOD_LOCK_STATE_T *pCarrierLockStatus)
{
	...
	{
		DEMOD_PRINT( "[ABB M16P]] FAIL (%s:%d) ADEMOD_Parameter_Get !!!\n",  __F__, __L__);
		DEMOD_RETURN_FAIL(__F__);
	}

//	DEMOD_PRINT( "[ABB M16P] ABB CarrierCheck %d\n", lockState[0]);

	if(lockState[0]) // H/V Sync Lock
	{
		*pCarrierLockStatus = LX_DEMOD_LOCKED;
		DEMOD_PRINT( "^g^[M16P  ABB] (%s:%d) ABB Carrier Lock [OK]\n",  __F__, __L__);
	}
	else
	{
		*pCarrierLockStatus = LX_DEMOD_UNLOCKED;
		DEMOD_PRINT( "^c^[M16P  ABB] (%s:%d) ABB Carrier Lock [NG]\n",  __F__, __L__);
	}
 ...
 */
static int DEMOD_M16P_ANALOG_CheckVideoSync(Handle_t phDevice, LX_DEMOD_LOCK_STATE_T *pLockState)
{
	UINT32 	stat;
...
//	DEMOD_PRINT("V-sync status: %s,%s\n", (stat & 0x2) ? "locked" : "unlocked", (stat & 0x8) ? "stable" : "unstable");
	...
	{
		DEMOD_PRINT( "^b^[M16P ] (%s:%d) ADEMOD UNLOCKED\n",  __F__, __L__);
		*pLockState = LX_DEMOD_UNLOCKED;
	}
	else
	{
		DEMOD_PRINT( "^g^[M16P ] (%s:%d) ADEMOD LOCKED\n",  __F__, __L__);
 ...
 * @author 	Jeongpil Yun (jeongpil.yun@lge.com)
 */
int DEMOD_M16P_ANALOG_ControlOutput(Handle_t phDevice,  BOOLEAN bOutputON)
{
	/* Check */
	return RET_OK;
}
 ...
 */
int DEMOD_M16P_ANALOG_Get_FreqOffset(DEMOD_CTX_T *pDemodInfo, SINT32 *pFreqOffset)
{
	...
	*pFreqOffset = 0; // All related to AFT is controlled by Tuner 2158B
	...
	{
		if (RET_OK != DEMOD_M16P_ANALOG_CheckVideoCarrier(phDevice, &carrierLockStatus))
		{
			DEMOD_PRINT("[ABB M16P] FAIL (%s:%d) DEMOD_M16P_ANALOG_CheckVideoCarrier() !!!\n", __F__, __L__);
			DEMOD_RETURN_FAIL(__F__);
		}
		DEMOD_PRINT("[ABB M16P](%s:%d) carrierLockStatus = %d,count = %d !!!\n", __F__, __L__,carrierLockStatus,count);
 ...
 * @author 	Jeongpil Yun (jeongpil.yun@lge.com)
 */
int DEMOD_M16P_ANALOG_ChangeFilter4SIF(Handle_t	phDevice,  LX_DEMOD_ANALOG_SIF_SOUNDSYSTEM_T audioSystem)
{
	...
	switch(audioSystem)
	{
		...
		default:
			DEMOD_PRINT( "[M16P ABB] FAIL (%s:%d) INVALID %s !!!\n",  __F__, __L__, DEMOD_M16P_ANALOG_WhatAudioSystem(audioSystem));
			DEMOD_RETURN_FAIL(__F__);
			break;
	}
	...
	{
		DEMOD_PRINT( "[M16P ABB] FAIL (%s:%d) ADEMOD_Parameter_Set(LX_ADEMOD_PARM_VID_BNDW) !!!\n",  __F__, __L__);
		DEMOD_RETURN_FAIL(__F__);
	}

	if (retOK != ADEMOD_Parameter_Set(phDevice, LX_ADEMOD_PARM_AUD_SIF_FRQ, dataFreq, TRUE))
	{
		DEMOD_PRINT( "[M16P ABB] FAIL (%s:%d) ADEMOD_Parameter_Set(LX_ADEMOD_PARM_AUD_SIF_FRQ) !!!\n",  __F__, __L__);
		DEMOD_RETURN_FAIL(__F__);
	}



	DEMOD_PRINT( "[M16P ABB] _ADEMOD_ChangeFilter4SIF(%s) : VIDEO BW(%d Hz), %d Hz ~ %d Hz !!!\n",
				DEMOD_M16P_ANALOG_WhatAudioSystem(audioSystem), videoBW[0], dataFreq[0], dataFreq[1]);
...
/**
 * DEMOD_M16P_ANALOG_CarrierlockScan
 ...
 * @author 	Jeongpil.yun(jeongpil.yun@lge.com)
*/
int DEMOD_M16P_ANALOG_CarrierlockScan(DEMOD_CTX_T *pDemodInfo, LX_DEMOD_FLAG_T ResetOn, LX_DEMOD_FLAG_T *pScanProcessing, LX_DEMOD_LOCK_STATE_T *pScanLock)
{
	...
	if (carrierLockStatus != LX_DEMOD_LOCKED)
	{
			...
			if(elapsedTime > _maxTimeOut)
			{
				...
				*pScanLock			= LX_DEMOD_UNLOCKED;
				DEMOD_PRINT( "[ABB M16P] Carrier lock : LX_DEMOD_UNLOCKED \n");
	...
	else
	{
		...
		*pScanLock			= LX_DEMOD_LOCKED;
		DEMOD_PRINT( "[ABB M16P] NEVERSCAN :  LX_DEMOD_NEVERLOCK DETECTED	!! \n");
 ...
 * @author 	Jeongpil.yun (jeongpil.yun@lge.com)
*/
int DEMOD_M16P_ANALOG_SoftReset(Handle_t	phDevice)
{
...
************************************************************************************/
/**
 * DEMOD_M16P_ANALOG_Set_CvbsRateConversion.
 * Reset Analog module by software.
 *
 * @param  NONE
 * @param	phDevice 	[in] 	Handle_t
 ...
 * @author 	Jeongpil.yun (jeongpil.yun@lge.com)
*/
int DEMOD_M16P_ANALOG_Set_CvbsRateConversion(Handle_t	phDevice, UINT32 pllClkSource)
{
	UINT32 prevData = 0;

	if(retOK != ADEMOD_Register_Set(phDevice, 0xb01, 1, 0xa))
	{
		DEMOD_PRINT("[ABB M16P] FAIL (%s:%d) ADEMOD_Register_Set(0xb01, 0xa) !!!\n", __F__, __L__);
		DEMOD_RETURN_FAIL(__F__);
	}
	if(retOK != ADEMOD_Register_Set(phDevice, 0xb02, 1, 0xa))
	{
		DEMOD_PRINT("[ABB M16P] FAIL (%s:%d) ADEMOD_Register_Set(0xb02, 0xa) !!!\n", __F__, __L__);
		DEMOD_RETURN_FAIL(__F__);
	}
	...
	{
		DEMOD_PRINT("[ABB M16P] FAIL (%s:%d) ADEMOD_Register_Get(0xb56, 0x2) !!!\n", __F__, __L__);
		DEMOD_RETURN_FAIL(__F__);
	}

	if(retOK != ADEMOD_Register_Set(phDevice, 0xb46, 2, 0xf))
	{
		DEMOD_PRINT("[ABB M16P] FAIL (%s:%d) ADEMOD_Register_Set(0xb56, audioMinClipData) !!!\n", __F__, __L__);
		DEMOD_RETURN_FAIL(__F__);
	}
	if(retOK != ADEMOD_Register_Set(phDevice, 0xb61, 2, 0xf))
	{
		DEMOD_PRINT("[ABB M16P] FAIL (%s:%d) ADEMOD_Register_Set(0xb61, 0x4) !!!\n", __F__, __L__);
		DEMOD_RETURN_FAIL(__F__);
	}
	...
	switch(pllClkSource)
	{
		...
		default :
			DEMOD_PRINT( "^r^[M16P  ATV] FAIL (%s:%d) Invaild sample rate, going to default setting(27MHz) !!!\n",  __F__, __L__);
			ADEMOD_Register_Set(phDevice, 0xb10, 1, 0x99);
			ADEMOD_Register_Set(phDevice, 0xb11, 1, 0x99);
			ADEMOD_Register_Set(phDevice, 0xb12, 1, 0x99);
			ADEMOD_Register_Set(phDevice, 0xb13, 1, 0x99);
 ...
 * @author 	Jeongpil.yun (jeongpil.yun@lge.com)
*/
int DEMOD_M16P_ANALOG_Set_HighCvbsRateOffset(Handle_t	phDevice, BOOLEAN bInitOffsetHigh)
{
...
************************************************************************************/
/**
 * DEMOD_M16P_ANALOG_Set_ClampingCtrl.
 ...
 * @author 	Jeongpil.yun (jeongpil.yun@lge.com)
*/
int DEMOD_M16P_ANALOG_Set_ClampingCtrl(Handle_t phDevice, UINT8 clampCount, UINT16 stepsize)
{
	...
	{
		DEMOD_PRINT("[ABB M16P] FAIL (%s:%d) ADEMOD_Register_Set(0xb01, 0x%x) !!!\n", __F__, __L__,clampCount);
		DEMOD_RETURN_FAIL(__F__);
	}
	if(retOK != ADEMOD_Register_Set(phDevice, 0xb02, 1, (UINT32)clampCount))
	{
		DEMOD_PRINT("[ABB M16P] FAIL (%s:%d) ADEMOD_Register_Set(0xb02, 0x%x) !!!\n", __F__, __L__,clampCount);
		DEMOD_RETURN_FAIL(__F__);
	}
	...
	if(retOK != ADEMOD_Register_Get(phDevice, 0xb46, 2, &prevData))
	{
		DEMOD_PRINT("[ABB M16P] FAIL (%s:%d) ADEMOD_Register_Get(0xb56, 0x%x) !!!\n", __F__, __L__,prevData);
		DEMOD_RETURN_FAIL(__F__);
	}
	...
	{
		DEMOD_PRINT("[ABB M16P] FAIL (%s:%d) ADEMOD_Register_Set(0xb61, 0x%x) !!!\n", __F__, __L__,stepsize);
		DEMOD_RETURN_FAIL(__F__);
	}
	...
	{
		DEMOD_PRINT("[ABB M16P] Success !! (%s:%d) RdClampingCount(0x%x), RdstepSize(0x%x)  !!!\n", __F__, __L__,RdClampingCount,RdstepSize);
		return RET_OK;

	}
	else
	{
		DEMOD_PRINT("[ABB M16P] FAIL (%s:%d) RdClampingCount(0x%x), RdstepSize(0x%x)  !!!\n", __F__, __L__,RdClampingCount,RdstepSize);
		DEMOD_RETURN_FAIL(__F__);
...
************************************************************************************/
/**
 * DEMOD_M16P_ANALOG_Set_CvbsDecCtrl.
 * Select CVBS DEC sel.
 *
 * @param  NONE
 * @param	phDevice 	[in] 	Handle_t
 ...
 * @author 	Jeongpil.yun (jeongpil.yun@lge.com)
*/
int DEMOD_M16P_ANALOG_Set_CvbsDecCtrl(Handle_t phDevice, LX_DEMOD_ANALOG_CVBSDEC_SEL_T sel )
{
	...
	if(LX_DEMOD_ANALOG_DTV == sel)
	{
		...
		DEMOD_PRINT("[ABB M16P]SUCCESS (%s:%d) Going to LX_DEMOD_ANALOG_DTV... !!!\n", __F__, __L__);
	}
	else if(LX_DEMOD_ANALOG_ATV == sel)
	{
		...
		DEMOD_PRINT("[ABB M16P] SUCCESS (%s:%d) Going to LX_DEMOD_ANALOG_ATV... !!!\n", __F__, __L__);
	}
	else if(LX_DEMOD_ANALOG_ATV_RC == sel)
	{
		...
		DEMOD_PRINT("[ABB M16P] SUCCESS (%s:%d) Going to LX_DEMOD_ANALOG_ATV_RC... !!!\n", __F__, __L__);
	}
	else
	{
		DEMOD_PRINT("[ABB M16P] FAIL (%s:%d) Invalid sel !!!\n", __F__, __L__);
		DEMOD_RETURN_FAIL(__F__);
	}
 ...
 * @author 	Jeongpil.yun (jeongpil.yun@lge.com)
*/
int DEMOD_M16P_ANALOG_Set_SifCtrl(Handle_t	phDevice, UINT32 pllClkSource)
{
 ...
 * @author 	Jeongpil.yun (jeongpil.yun@lge.com)
*/
int DEMOD_M16P_ANALOG_Set_SifPathCtrl(Handle_t phDevice, UINT32 pllClkSource, LX_DEMOD_ANALOG_SIFPATH_SEL_T sel )
{
#if 0 //temp	 chungiii 2016_0425
	switch(sel)
	{
...
//				ACE_REG_M16PA0_Wr01(abb_2, abb_mux_sel_vdac, 0x1);
				...
				if(retOK !=DEMOD_M16P_ANALOG_Set_SifCtrl(phDevice, pllClkSource))
				{
					DEMOD_PRINT("[ABB M16P] FAIL (%s:%d) ADEMOD_Register_Set() !!!\n", __F__, __L__);
					DEMOD_RETURN_FAIL(__F__);
				}
		...
		default :
			{
				DEMOD_PRINT("[ABB M16P] FAIL (%s:%d) Invalid SIF PATH !!!\n", __F__, __L__);
				DEMOD_RETURN_FAIL(__F__);
...
************************************************************************************/
/**
 * DEMOD_M16P_ANALOG_Set_SpectrumInv.
 * Reset Analog module by software.
 *
 * @param  NONE
 * @param	phDevice 	[in] 	Handle_t
 ...
 * @author 	Jeongpil.yun (jeongpil.yun@lge.com)
*/
int DEMOD_M16P_ANALOG_Set_SpectrumInv(Handle_t phDevice, BOOLEAN bInv, BOOLEAN bforce)
{
	UINT32 spectrum[LX_ADEMOD_PARM_SIZE(LX_ADEMOD_PARM_SPCTR_INV)];

	spectrum[0] = (bInv == TRUE) ? 1 : 0;

	_gM16PSpectrumInv = bInv;

	if(retOK != ADEMOD_Parameter_Set(phDevice, LX_ADEMOD_PARM_SPCTR_INV, spectrum, bforce))
	{
		DEMOD_PRINT("[ABB M16P] FAIL (%s:%d) ADEMOD_Parameter_Set() !!!\n", __F__, __L__);
		DEMOD_RETURN_FAIL(__F__);
	}


	DEMOD_PRINT("[ABB M16P] (%s:%d) SPECTURM INV = %s !!!\n", __F__, __L__,(_gM16PSpectrumInv == TRUE) ? "TRUE" : "FALSE");
	DEMOD_PRINT("[ABB M16P] (%s:%d) spectrum[0] = %d !!!\n", __F__, __L__,spectrum[0]);
 ...
 * @author 	Jeongpil.yun (jeongpil.yun@lge.com)
*/
int DEMOD_M16P_ANALOG_ClampingCtrlEnable(Handle_t phDevice, BOOLEAN Enable)
{
	UINT32 wrData;
	...
	{
		wrData = 0x0;
		DEMOD_PRINT("[ABB M16P] (%s:%d) Clamping control ON !!!\n", __F__, __L__);
	}
	else
	{
		wrData = 0x1;
		DEMOD_PRINT("[ABB M16P] (%s:%d) Clamping control OFF !!!\n", __F__, __L__);
	}


	 if(retOK != ADEMOD_Register_Set(phDevice, 0xb00, 1, wrData))
	 {
		 DEMOD_PRINT("[ABB M16P] FAIL (%s:%d) ADEMOD_Register_Set(0xB00, CLAMP_CLR) !!!\n", __F__, __L__);
		 DEMOD_RETURN_FAIL(__F__);
	 }
...
************************************************************************************/
/**
 * DEMOD_M16P_ANALOG_Obtaining_Signal_Lock.
...
int DEMOD_M16P_ANALOG_Obtaining_Signal_Lock(DEMOD_CTX_T *pDemodInfo)
{
	...
	DEMOD_PRINT( "^R^[ABB M16P] pDemodInfo->controlState= %d..... ^0^\n",pDemodInfo->controlState);
		...
		case LX_DEMOD_RETUNE_RF:			/***************************************************/
			{
				...
				DEMOD_PRINT( "^R^[ABB M16P] LX_DEMOD_TUNE_START  start..... ^0^\n");

				phDevice = pDemodInfo->setCfgParam.analog.handleABB;

				gPreviousAudio	 =	LX_DEMOD_ANALOG_SIF_SYSTEM_UNKNOWN;

				DEMOD_M16P_ANALOG_SoftReset(phDevice);

				pDemodInfo->controlState = LX_DEMOD_TUNE_START;
				DEMOD_PRINT( "^R^[ABB M16P] LX_DEMOD_RETUNE_RF : Going to LX_DEMOD_TUNE_START..... ^0^\n");
				g_RetuneStartTime = jiffies_to_msecs(jiffies);

				DEMOD_PRINT( "^R^[ABB M16P] LX_DEMOD_TUNE_START	end..... ^0^\n");
			}
		...
		case LX_DEMOD_TUNE_START:			/***************************************************/
			{
				...
				DEMOD_PRINT("[ABB M16P](%s:%d)smartTuneParam.tuneMode = %d !!!\n", __F__, __L__,smartTuneParam.tuneMode);

				if (retOK != DEMOD_M16P_ANALOG_SetAudioSystem(&smartTuneParam))
				{
					DEMOD_PRINT("[ABB M16P] FAIL (%s:%d) DEMOD_M16P_ANALOG_SetAudioSystem() !!!\n", __F__, __L__);
					DEMOD_RETURN_FAIL(__F__);
				}

				if(LX_DEMOD_TUNE_AUTO == (pDemodInfo->setCfgParam.analog.tuneMode & 0xf0))
				{
					if(RET_OK != DEMOD_M16P_ANALOG_ClampingCtrlEnable(phDevice, FALSE))
					{
						DEMOD_PRINT("[ABB M16P] FAIL (%s:%d) DEMOD_M16P_ANALOG_ClampingCtrlEnable(FALSE) !!!\n", __F__, __L__);
						DEMOD_RETURN_FAIL(__F__);
					}
				}
				else
				{
					if(RET_OK != DEMOD_M16P_ANALOG_ClampingCtrlEnable(phDevice, TRUE))
					{
						DEMOD_PRINT("[ABB M16P] FAIL (%s:%d) DEMOD_M16P_ANALOG_ClampingCtrlEnable(TRUE) !!!\n", __F__, __L__);
						DEMOD_RETURN_FAIL(__F__);
					}
					...
					if(RET_OK != DEMOD_M16P_ANALOG_Set_ClampingCtrl(phDevice, clampCount, stepsize))
					{
						DEMOD_PRINT("[ABB M16P] FAIL (%s:%d) DEMOD_M16P_ANALOG_Set_ClampingCtrl !!!\n", __F__, __L__);
						DEMOD_RETURN_FAIL(__F__);
					}
				...
				if(LX_DEMOD_TUNE_NORMAL != (pDemodInfo->setCfgParam.analog.tuneMode & 0xf0))
				{
					...
					if(RET_OK != DEMOD_M16P_ANALOG_CarrierlockScan(pDemodInfo, LX_DEMOD_FLAG_ON, &scanProcessing, &scanLock))
					{
						DEMOD_PRINT("[ABB M16P] FAIL (%s:%d) DEMOD_M16P_ANALOG_CarrierlockScan() !!!\n", __F__, __L__);
						DEMOD_RETURN_FAIL(__F__);
					}

					pDemodInfo->controlState = LX_DEMOD_TUNE_SCAN;
					DEMOD_PRINT( "[ABB M16P] LX_DEMOD_TUNE_START : Going to LX_DEMOD_TUNE_SCAN..... ^0^\n");
				...
				else  //normal mode
				{
					...
					DEMOD_PRINT( "[ABB M16P] LX_DEMOD_TUNE_START : Going to LX_DEMOD_SYNC_CHECKING..... ^0^\n");


				}

//					DEMOD_M16P_ANALOG_Set_HighCvbsRateOffset(phDevice, TRUE);
					DEMOD_PRINT( "^R^[ABB M16P] LX_DEMOD_TUNE_START	end..... ^0^\n");
		...
		case LX_DEMOD_TUNE_SCAN:			/***************************************************/
			{
				...
				DEMOD_PRINT( "^R^[ABB M16P] LX_DEMOD_TUNE_SCAN  start..... ^0^\n");
				if((LX_DEMOD_FLAG_COMPLETE == pDemodInfo->scanJobFlag) || (LX_DEMOD_FLAG_FINISH == pDemodInfo->scanJobFlag))
				{

					pDemodInfo->controlState = LX_DEMOD_SYNC_CHECKING;

					DEMOD_PRINT( "[ABB M16P] ERR (%s:%d) Already Done !!!\n", __F__, __L__);
					DEMOD_PRINT( "[ABB M16P] LX_DEMOD_TUNE_SCAN : Going to LX_DEMOD_SYNC_CHECKING..... ^0^\n");
					return RET_OK;
				}

				if(RET_OK != DEMOD_M16P_ANALOG_CarrierlockScan(pDemodInfo, LX_DEMOD_FLAG_OFF, &scanProcessing, &scanLock))
				{
					DEMOD_PRINT("[ABB M16P] FAIL (%s:%d) DEMOD_M16P_ANALOG_CarrierlockScan() !!!\n", __F__, __L__);
					DEMOD_RETURN_FAIL(__F__);
				}
				...
				if((LX_DEMOD_FLAG_FINISH == scanProcessing) && (LX_DEMOD_LOCKED == scanLock))
				{
					...
					DEMOD_PRINT( "[ABB M16P] (%s:%d) Signal is Found  !!!\n", __F__, __L__);
					DEMOD_PRINT( "[ABB M16P] LX_DEMOD_TUNE_SCAN : Going to LX_DEMOD_SYNC_CHECKING..... ^0^\n");
				...
				else if((LX_DEMOD_FLAG_FINISH == scanProcessing)&& (LX_DEMOD_UNLOCKED == scanLock))
				{
					...
					DEMOD_PRINT_ALWAYS( "[ABB M16P] (%s:%d) Signal is NOT Found  !!!\n", __F__, __L__);
				...
				else
				{
					...
					DEMOD_PRINT( "[ABB M16P] (%s:%d) Detection is on processing	!!!\n", __F__, __L__);
				}

				DEMOD_PRINT( "^R^[ABB M16P] LX_DEMOD_TUNE_SCAN  end..... ^0^\n");
			}
			break;
		...
		case LX_DEMOD_TUNE_SCAN_FINISH_UNLOCK : 	/********************************************/
			{
				...
				DEMOD_PRINT( "^R^[ABB M16P] LX_DEMOD_TUNE_SCAN_FINISH_UNLOCK  start...end..... ^0^\n");
		...
		case LX_DEMOD_SYNC_CHECKING : 		/********************************************/
			{
				...
				DEMOD_PRINT( "^R^[ABB M16P] LX_DEMOD_SYNC_CHECKING  start..... ^0^\n");
				...
				if(RET_OK != DEMOD_M16P_ANALOG_CheckVideoSync(phDevice, &lockState))
				{
					DEMOD_PRINT("[ABB M16P] FAIL (%s:%d) DEMOD_M16P_ANALOG_CheckVideoSync() !!!\n", __F__, __L__);
					DEMOD_RETURN_FAIL(__F__);
				}
#else
				if(RET_OK != DEMOD_M16P_ANALOG_CheckVideoCarrier(phDevice, &lockState))
				{
					DEMOD_PRINT("[ABB M16P] FAIL (%s:%d) DEMOD_M16P_ANALOG_CheckVideoCarrier() !!!\n", __F__, __L__);
					DEMOD_RETURN_FAIL(__F__);
				}
				...
				{
					pDemodInfo->controlState	= LX_DEMOD_SIGNAL_STABLE;
					DEMOD_PRINT( "^R^[ABB M16P] LX_DEMOD_SYNC_CHECKING : Going to LX_DEMOD_SIGNAL_STABLE..... ^0^\n");
				}

				notifyinglockTimeOut = LX_DEMOD_LOCK_DEALY_400;

				DEMOD_PRINT( "^R^[ABB M16P] LX_DEMOD_SYNC_CHECKING  end..... ^0^\n");
			}
	   	...
	   	case LX_DEMOD_SIGNAL_STABLE: 		/********************************************/
			{
				...
				DEMOD_PRINT( "^R^[ABB M16P] LX_DEMOD_SIGNAL_STABLE  start..... ^0^\n");
				phDevice = pDemodInfo->setCfgParam.analog.handleABB;
				audioSystem = pDemodInfo->setCfgParam.analog.audioSystem;
				...
				if(LX_DEMOD_LOCKED == lockState)
				{
					...
					if (RET_OK != DEMOD_M16P_ANALOG_Get_FreqOffset(pDemodInfo, &freqOffset))
					{
						DEMOD_PRINT( "[ABB M16P] FAIL (%s:%d) DEMOD_M16P_ANALOG_Get_FreqOffset() !!!\n", __F__, __L__);
						DEMOD_RETURN_FAIL(__F__);
					}
					...
					DEMOD_PRINT_ALWAYS( "[ABB M16P] LX_DEMOD_SIGNAL_STABLE : MSG_ANALOG_FRONT_END_LOCKED..... ^^^0^^^\n");
					DEMOD_PRINT_ALWAYS( "[ABB M16P] LX_DEMOD_SIGNAL_STABLE : Elapsed Time = %d [ms] ..... ^^^0^^^\n", elapsedTime);
					DEMOD_PRINT_ALWAYS( "^R^[ABB M16P] LX_DEMOD_SIGNAL_STABLE : Frequency offset = %d [KHz](Center = %d KHz) ..... ^^^0^^^\n", freqOffset,pDemodInfo->setCfgParam.analog.tunedFreq);

#if 1
					if (RET_OK != DEMOD_Get_TunedCFG(pDemodInfo))
					{
						DEMOD_PRINT( "[ABB M16P] FAIL (%s:%d) DEMOD_Get_TunedCFG() !!!\n", __F__, __L__);
						DEMOD_RETURN_FAIL(__F__);
					}
#endif
//						DEMOD_M16P_ANALOG_Set_HighCvbsRateOffset(phDevice, FALSE);


				}

				DEMOD_PRINT( "^R^[ABB M16P] LX_DEMOD_SIGNAL_STABLE  end..... ^0^\n");
	   		}
			break;
		...
		default:
			DEMOD_PRINT( "[ABB M16P] FAIL (%s:%d) pDemodInfo->controlState = %d !!!\n", __F__, __L__,pDemodInfo->controlState);
			pDemodInfo->controlState = LX_DEMOD_TUNE_START;
...
************************************************************************************/
/**
 * DEMOD_M16P_ANALOG_Monitoring_Signal_Lock.
 * Set channel change parameters
 *
 * @param *pDemodInfo [IN] DEMOD_CTX_T
 * @return if Succeeded - RET_OK else-RET_ERROR
...
int DEMOD_M16P_ANALOG_Monitoring_Signal_Lock(DEMOD_CTX_T *pDemodInfo)
{
	...
	DEMOD_PRINT( "^R^[ABB M16P] DEMOD_M16P_ANALOG_Monitoring_Signal_Lock  start..... ^0^\n");
	phDevice = pDemodInfo->setCfgParam.analog.handleABB;
	audioSystem = pDemodInfo->setCfgParam.analog.audioSystem;
...
//	DEMOD_M16P_ANALOG_Set_HighCvbsRateOffset(phDevice, FALSE);
	...
	if(LX_DEMOD_LOCKED == lockState)  //&& (TRUE == pDemodInfo->setCfgParam.analog.cvdLock))
	{
		...
		{
			DEMOD_PRINT("[ABB M16P] FAIL (%s:%d) ADEMOD_Register_Get(0x2d4) !!!\n", __F__, __L__);
			DEMOD_RETURN_FAIL(__F__);
		}

		if(RET_OK != DEMOD_M16P_ANALOG_CheckVideoSync(phDevice, &syncLockState))
		{
			DEMOD_PRINT("[ABB M16P] FAIL (%s:%d) DEMOD_M16P_ANALOG_CheckVideoSync() !!!\n", __F__, __L__);
			DEMOD_RETURN_FAIL(__F__);
		}
		...
		if((LX_DEMOD_LOCKED != pDemodInfo->lockStatus)  && (TRUE != pDemodInfo->bNotifiedLock))
		{
			...
			DEMOD_PRINT( "[ABB M16P](%s) pDemodInfo->lockCount = %d !!!\n", __F__,pDemodInfo->lockCount);
		...
		if(pDemodInfo->lockCount == 1)
		{
			...
			DEMOD_PRINT_ALWAYS( "[ABB M16P] MONITORING FUNC : MSG_ANALOG_FRONT_END_LOCKED..... ^0^\n");
		...
		pDemodInfo->freqOffset = freqOffset;
		DEMOD_PRINT( "[ABB M16P](%s:%d)freqOffset = %d KHz !!!\n", __F__, __L__,freqOffset);
		DEMOD_PRINT( "[ABB M16P](%s:%d)frequency center = %d KHz !!!\n", __F__, __L__,pDemodInfo->setCfgParam.analog.frequency);
		DEMOD_PRINT( "[ABB M16P](%s:%d)tuned frq = %d KHz !!!\n", __F__, __L__,pDemodInfo->setCfgParam.analog.tunedFreq);
	...
	else
	{
		...
		if((LX_DEMOD_UNLOCKED != pDemodInfo->lockStatus)  && (TRUE != pDemodInfo->bNotifiedUnlock))
		{
			...
			DEMOD_PRINT( "[ABB M16P](%s) pDemodInfo->unLockCount = %d !!!\n", __F__,pDemodInfo->unLockCount);
			...
			if(pDemodInfo->unLockCount == 2)
			{
				...
				DEMOD_PRINT_ALWAYS( "[ABB M16P] MONITORING FUNC : MSG_ANALOG_FRONT_END_NOT_LOCKED..... -_-\n");
	...
	DEMOD_PRINT( "^R^[ABB M16P] DEMOD_M16P_ANALOG_Monitoring_Signal_Lock  end..... ^0^\n");
 ...
 * @author	Jeongpil.yun (jeongpil.yun@lge.com)
*/
int DEMOD_M16P_ANALOG_Dbg_Get_RegDump(Handle_t	phDevice)
{
...
************************************************************************************/
/**
 * DEMOD_M16P_ANALOG_Dbg_Set_RegisterValue.
 * Reset Analog module by software.
 *
 * @param  NONE
 * @param	phDevice	[in]	Handle_t
 ...
 * @author	Jeongpil.yun (jeongpil.yun@lge.com)
*/
int DEMOD_M16P_ANALOG_Dbg_Set_RegisterValue(Handle_t phDevice,  UINT32 RegAddr, UINT32 RegSize, UINT32 RegData)
{
...
************************************************************************************/
/**
 * DEMOD_M16P_ANALOG_Dbg_SmartTune.
 * Reset Analog module by software.
 *
 * @param  NONE
 * @param	*pSmartTuneParam	[in]	LX_DEMOD_SMARTTUNE_PARAM_T
 ...
 * @author	Jeongpil.yun (jeongpil.yun@lge.com)
*/
int DEMOD_M16P_ANALOG_Dbg_SmartTune(LX_DEMOD_SMARTTUNE_PARAM_T *pSmartTuneParam)
{
...
************************************************************************************/
/**
 * DEMOD_M16P_ANALOG_Dbg_Get_RegisterValue.
 * Reset Analog module by software.
 *
 * @param  NONE
 * @param	phDevice	[in]	Handle_t
 ...
 * @author	Jeongpil.yun (jeongpil.yun@lge.com)
*/
int DEMOD_M16P_ANALOG_Dbg_Get_RegisterValue(Handle_t phDevice, UINT32 RegAddr, UINT32 RegSize, UINT32 *pRegData)
{
...
************************************************************************************/
/**
 * DEMOD_M16P_ANALOG_Dbg_TestFunctions.
 * Reset Analog module by software.
 *
 * @param  NONE
 * @param	phDevice	[in]	Handle_t
 ...
 * @author	Jeongpil.yun (jeongpil.yun@lge.com)
*/
int DEMOD_M16P_ANALOG_Dbg_TestFunctions(Handle_t phDevice, UINT32 argc, UINT32 *val)
{
 ...
 */
void DEMOD_M16P_ANALOG_OptimizingTunerInBrazil(Handle_t phDevice)
{
	int i;
 ...
 * @author 	sungbin.na(sungbin.na@lge.com)
 */
int DEMOD_M16P_ANALOG_OptimizingTunerSetting(Handle_t phDevice)
{
