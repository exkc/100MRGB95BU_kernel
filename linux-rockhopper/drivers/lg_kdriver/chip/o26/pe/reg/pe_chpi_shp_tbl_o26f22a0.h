#ifndef _PE_CHPI_SHP_TBL_O26F22A0_H_
#define _PE_CHPI_SHP_TBL_O26F22A0_H_
...
typedef struct {
	...
	union {
	UINT32 udata32;
	struct {						//0xF3410000 RW 0x0019_0021
...
}PE_O26F22_VSD1_SHP_CORE_CTRL_00_T;

typedef struct {
	UINT32 uaddr32;
	union {
	UINT32 udata32;
	struct {						//0xF3410004 RW 0x10E0_0880
	UINT32 reg_core0_width                  :16;	//(15:0,NA,2176) //processing width (imaeg_width + overlap)
	UINT32 reg_core0_height                 :16;	//(31:16,NA,4320) //processing height (default : 2160)
	};
	};

}PE_O26F22_VSD1_SHP_CORE0_CTRL_01_T;

typedef struct {
	UINT32 uaddr32;
	union {
	UINT32 udata32;
	struct {						//0xF3410008 RW 0x10E0_0880
	UINT32 reg_core1_width                  :16;	//(15:0,NA,2176) //processing width (imaeg_width + overlap)
	UINT32 reg_core1_height                 :16;	//(31:16,NA,4320) //processing height (default : 2160)
	};
	};

}PE_O26F22_VSD1_SHP_CORE1_CTRL_01_T;

typedef struct {
	UINT32 uaddr32;
	union {
	UINT32 udata32;
	struct {						//0xF341000C RW 0x0118_0002
...
}PE_O26F22_VSD1_SHP_CORE_CTRL_02_T;

typedef struct {
	UINT32 uaddr32;
	union {
	UINT32 udata32;
	struct {						//0xF3410010 RW 0x0000_000F
	UINT32 reg_top_pic_init_latency         :12;	//(11:0,NA,15) //pic init latency
	UINT32 resvd                            :20;
	};
	};

}PE_O26F22_VSD1_SHP_CORE_CTRL_03_T;

typedef struct {
	UINT32 uaddr32;
	union {
	UINT32 udata32;
	struct {						//0xF3410014 RW 0x0000_0019
	UINT32 reg_top_update_ctrl              :5;	//(4:0,NA,25) //[0]: master_select	[1]: update_force_r	[2]: update_force_w	[3]: update_flag_r	[4]: update_flag_w
	UINT32 resvd0                           :11;
	UINT32 reg_top_rst_async_bridge         :8;	//(23:16,NA,0) //pqe_vsd_top control register
	UINT32 resvd1                           :8;
	};
	};

}PE_O26F22_VSD1_SHP_CORE_CTRL_04_T;
...
}PE_O26F22_VSD1_SHP_NEW_FD_CTRL_00_T;
...
}PE_O26F22_VSD1_SHP_NEW_FD_CTRL_01_T;
...
}PE_O26F22_VSD1_SHP_NEW_FD_CTRL_02_T;
...
}PE_O26F22_VSD1_SHP_NEW_FD_CTRL_03_T;
...
}PE_O26F22_VSD1_SHP_NEW_FD_CTRL_04_T;
...
}PE_O26F22_VSD1_SHP_TEXT_REGION_MAP_00_T;

typedef struct {
	UINT32 uaddr32;
	union {
	UINT32 udata32;
	struct {						//0xF3410040 RW 0xFFFF_FF00
...
}PE_O26F22_VSD1_SHP_PAT_GEN_CTRL_00_T;

typedef struct {
	UINT32 uaddr32;
	union {
	UINT32 udata32;
	struct {						//0xF3410050 RW 0x0F00_0020
...
}PE_O26F22_VSD1_SHP_GOS_CTRL_00_T;

typedef struct {
	UINT32 uaddr32;
	union {
	UINT32 udata32;
	struct {						//0xF3410060 RW 0x0004_0005
	UINT32 reg_core0_sync_dly_vsync         :16;	//(15:0,NA,5) //v sync (2K
	UINT32 reg_core0_sync_dly_vfp           :16;	//(31:16,NA,4) //v front porch (2K
	};
	};

}PE_O26F22_VSD1_SHP_CORE0_SYNC_DLY_CTRL_00_T;

typedef struct {
	UINT32 uaddr32;
	union {
	UINT32 udata32;
	struct {						//0xF3410064 RW 0x0024_0438
	UINT32 reg_core0_sync_dly_va            :16;	//(15:0,NA,1080) //v active (2K
	UINT32 reg_core0_sync_dly_vbp           :16;	//(31:16,NA,36) //v back porch (2K
	};
	};

}PE_O26F22_VSD1_SHP_CORE0_SYNC_DLY_CTRL_01_T;

typedef struct {
	UINT32 uaddr32;
	union {
	UINT32 udata32;
	struct {						//0xF3410068 RW 0x0058_002C
	UINT32 reg_core0_sync_dly_hsync         :16;	//(15:0,NA,44) //h sync (2K
	UINT32 reg_core0_sync_dly_hfp           :16;	//(31:16,NA,88) //h front porch (2K
	};
	};

}PE_O26F22_VSD1_SHP_CORE0_SYNC_DLY_CTRL_02_T;

typedef struct {
	UINT32 uaddr32;
	union {
	UINT32 udata32;
	struct {						//0xF341006C RW 0x0094_0780
	UINT32 reg_core0_sync_dly_ha            :16;	//(15:0,NA,1920) //h active (2K
	UINT32 reg_core0_sync_dly_hbp           :16;	//(31:16,NA,148) //h back porch (2K
	};
	};

}PE_O26F22_VSD1_SHP_CORE0_SYNC_DLY_CTRL_03_T;

typedef struct {
	UINT32 uaddr32;
	union {
	UINT32 udata32;
	struct {						//0xF3410070 RW 0x0000_0060
	UINT32 reg_core0_sync_dly_line_start    :16;	//(15:0,NA,96) //line increase position
	UINT32 reg_core0_sync_dly_actv_sel_in_h_src :1;	//(16:16,NA,0) //select inverse in ha source
	UINT32 reg_core0_sync_dly_actv_sel_in_v_src :1;	//(17:17,NA,0) //select inverse in va source
	UINT32 reg_core0_sync_dly_actv_sel_in_h_inv :1;	//(18:18,NA,0) //inverse in ha
	UINT32 reg_core0_sync_dly_actv_sel_in_v_inv :1;	//(19:19,NA,0) //inverse in va
	UINT32 reg_core0_sync_dly_actv_sel_out_ha :1;	//(20:20,NA,0) //select out ha
	UINT32 reg_core0_sync_dly_actv_sel_out_va :1;	//(21:21,NA,0) //select out va
	UINT32 reg_core0_sync_dly_actv_sel_out_hs :1;	//(22:22,NA,0) //select out hs
	UINT32 reg_core0_sync_dly_actv_sel_out_vs :1;	//(23:23,NA,0) //select out vs
	UINT32 reg_core0_sync_dly_tp_update_hv_zero :1;	//(24:24,NA,0) //sync parameter update
	UINT32 reg_core0_sync_dly_force_out_ha  :1;	//(25:25,NA,0) //force out ha
	UINT32 reg_core0_sync_dly_force_out_va  :1;	//(26:26,NA,0) //force out va
	UINT32 reg_core0_sync_dly_force_out_hs  :1;	//(27:27,NA,0) //force out hs
	UINT32 reg_core0_sync_dly_cnt_rst_h_value_en :1;	//(28:28,NA,0) //manual cnt h value enable
	UINT32 reg_core0_sync_dly_cnt_rst_v_value_en :1;	//(29:29,NA,0) //manual cnt v value enable
	UINT32 reg_core0_sync_dly_force_out_vs  :1;	//(30:30,NA,0) //force out vs
	UINT32 reg_core0_sync_dly_force_update  :1;	//(31:31,NA,0) //force update
	};
	};

}PE_O26F22_VSD1_SHP_CORE0_SYNC_DLY_CTRL_04_T;

typedef struct {
	UINT32 uaddr32;
	union {
	UINT32 udata32;
	struct {						//0xF3410074 RW 0x000A_00F4
	UINT32 reg_core0_sync_dly_sync_h_dly    :16;	//(15:0,NA,244) //pixel delay
	UINT32 reg_core0_sync_dly_sync_v_dly    :16;	//(31:16,NA,10) //line delay
	};
	};

}PE_O26F22_VSD1_SHP_CORE0_SYNC_DLY_CTRL_05_T;

typedef struct {
	UINT32 uaddr32;
	union {
	UINT32 udata32;
	struct {						//0xF3410078 RW 0x0008_0058
	UINT32 reg_core0_sync_dly_cnt_rst_h_value :16;	//(15:0,NA,88) //disp_pulse_dly Delay
	UINT32 reg_core0_sync_dly_cnt_rst_v_value :16;	//(31:16,NA,8) //[RO] disp_pulse_dly Counter
	};
	};

}PE_O26F22_VSD1_SHP_CORE0_SYNC_DLY_CTRL_06_T;

typedef struct {
	UINT32 uaddr32;
	union {
	UINT32 udata32;
	struct {						//0xF341007C RW 0x000A_00F4
	UINT32 reg_core0_sync_dly_auto_actv_h_dly :15;	//(14:0,NA,244) //auto actv pixel delay
	UINT32 reg_core0_sync_dly_auto_actv_gen_en :1;	//(15:15,NA,0) //auto actv gen enable
	UINT32 reg_core0_sync_dly_auto_actv_v_dly :15;	//(30:16,NA,10) //auto actv line delay
	UINT32 reg_core0_sync_dly_auto_actv_seam_en :1;	//(31:31,NA,0) //auto actv seam enable
	};
	};

}PE_O26F22_VSD1_SHP_CORE0_SYNC_DLY_CTRL_07_T;

typedef struct {
	UINT32 uaddr32;
	union {
	UINT32 udata32;
	struct {						//0xF3410080 RW 0x000A_00F4
	UINT32 reg_core0_sync_dly_auto_sync_h_dly :15;	//(14:0,NA,244) //auto sync pixel delay
	UINT32 reg_core0_sync_dly_auto_sync_gen_en :1;	//(15:15,NA,0) //auto sync gen enable
	UINT32 reg_core0_sync_dly_auto_sync_v_dly :15;	//(30:16,NA,10) //auto sync line delay
	UINT32 reg_core0_sync_dly_auto_sync_seam_en :1;	//(31:31,NA,0) //auto sync seam enable
	};
	};

}PE_O26F22_VSD1_SHP_CORE0_SYNC_DLY_CTRL_08_T;

typedef struct {
	UINT32 uaddr32;
	union {
	UINT32 udata32;
	struct {						//0xF3410084 RW 0x0000_0000
	UINT32 reg_core0_sync_dly_normal_number :16;	//(15:0,NA,0) //protection mode
	UINT32 resvd                            :16;
	};
	};

}PE_O26F22_VSD1_SHP_CORE0_SYNC_DLY_CTRL_09_T;

typedef struct {
	UINT32 uaddr32;
	union {
	UINT32 udata32;
	struct {						//0xF3410088 RW 0x0000_0000
	UINT32 reg_core0_sync_dly_cnt_h_rst_position :16;	//(15:0,NA,0) //manual cnt h value position
	UINT32 reg_core0_sync_dly_cnt_v_rst_position :16;	//(31:16,NA,0) //manual cnt v value position
	};
	};

}PE_O26F22_VSD1_SHP_CORE0_SYNC_DLY_CTRL_0A_T;

typedef struct {
	UINT32 uaddr32;
	union {
	UINT32 udata32;
	struct {						//0xF3410090 RW 0x0004_0005
	UINT32 reg_core1_sync_dly_vsync         :16;	//(15:0,NA,5) //v sync (2K
	UINT32 reg_core1_sync_dly_vfp           :16;	//(31:16,NA,4) //v front porch (2K
	};
	};

}PE_O26F22_VSD1_SHP_CORE1_SYNC_DLY_CTRL_00_T;

typedef struct {
	UINT32 uaddr32;
	union {
	UINT32 udata32;
	struct {						//0xF3410094 RW 0x0024_0438
	UINT32 reg_core1_sync_dly_va            :16;	//(15:0,NA,1080) //v active (2K
	UINT32 reg_core1_sync_dly_vbp           :16;	//(31:16,NA,36) //v back porch (2K
	};
	};

}PE_O26F22_VSD1_SHP_CORE1_SYNC_DLY_CTRL_01_T;

typedef struct {
	UINT32 uaddr32;
	union {
	UINT32 udata32;
	struct {						//0xF3410098 RW 0x0058_002C
	UINT32 reg_core1_sync_dly_hsync         :16;	//(15:0,NA,44) //h sync (2K
	UINT32 reg_core1_sync_dly_hfp           :16;	//(31:16,NA,88) //h front porch (2K
	};
	};

}PE_O26F22_VSD1_SHP_CORE1_SYNC_DLY_CTRL_02_T;

typedef struct {
	UINT32 uaddr32;
	union {
	UINT32 udata32;
	struct {						//0xF341009C RW 0x0094_0780
	UINT32 reg_core1_sync_dly_ha            :16;	//(15:0,NA,1920) //h active (2K
	UINT32 reg_core1_sync_dly_hbp           :16;	//(31:16,NA,148) //h back porch (2K
	};
	};

}PE_O26F22_VSD1_SHP_CORE1_SYNC_DLY_CTRL_03_T;

typedef struct {
	UINT32 uaddr32;
	union {
	UINT32 udata32;
	struct {						//0xF34100A0 RW 0x0000_0060
	UINT32 reg_core1_sync_dly_line_start    :16;	//(15:0,NA,96) //line increase position
	UINT32 reg_core1_sync_dly_actv_sel_in_h_src :1;	//(16:16,NA,0) //select inverse in ha source
	UINT32 reg_core1_sync_dly_actv_sel_in_v_src :1;	//(17:17,NA,0) //select inverse in va source
	UINT32 reg_core1_sync_dly_actv_sel_in_h_inv :1;	//(18:18,NA,0) //inverse in ha
	UINT32 reg_core1_sync_dly_actv_sel_in_v_inv :1;	//(19:19,NA,0) //inverse in va
	UINT32 reg_core1_sync_dly_actv_sel_out_ha :1;	//(20:20,NA,0) //select out ha
	UINT32 reg_core1_sync_dly_actv_sel_out_va :1;	//(21:21,NA,0) //select out va
	UINT32 reg_core1_sync_dly_actv_sel_out_hs :1;	//(22:22,NA,0) //select out hs
	UINT32 reg_core1_sync_dly_actv_sel_out_vs :1;	//(23:23,NA,0) //select out vs
	UINT32 reg_core1_sync_dly_tp_update_hv_zero :1;	//(24:24,NA,0) //sync parameter update
	UINT32 reg_core1_sync_dly_force_out_ha  :1;	//(25:25,NA,0) //force out ha
	UINT32 reg_core1_sync_dly_force_out_va  :1;	//(26:26,NA,0) //force out va
	UINT32 reg_core1_sync_dly_force_out_hs  :1;	//(27:27,NA,0) //force out hs
	UINT32 reg_core1_sync_dly_cnt_rst_h_value_en :1;	//(28:28,NA,0) //manual cnt h value enable
	UINT32 reg_core1_sync_dly_cnt_rst_v_value_en :1;	//(29:29,NA,0) //manual cnt v value enable
	UINT32 reg_core1_sync_dly_force_out_vs  :1;	//(30:30,NA,0) //force out vs
	UINT32 reg_core1_sync_dly_force_update  :1;	//(31:31,NA,0) //force update
	};
	};

}PE_O26F22_VSD1_SHP_CORE1_SYNC_DLY_CTRL_04_T;

typedef struct {
	UINT32 uaddr32;
	union {
	UINT32 udata32;
	struct {						//0xF34100A4 RW 0x000A_00F4
	UINT32 reg_core1_sync_dly_sync_h_dly    :16;	//(15:0,NA,244) //pixel delay
	UINT32 reg_core1_sync_dly_sync_v_dly    :16;	//(31:16,NA,10) //line delay
	};
	};

}PE_O26F22_VSD1_SHP_CORE1_SYNC_DLY_CTRL_05_T;

typedef struct {
	UINT32 uaddr32;
	union {
	UINT32 udata32;
	struct {						//0xF34100A8 RW 0x0008_0058
	UINT32 reg_core1_sync_dly_cnt_rst_h_value :16;	//(15:0,NA,88) //disp_pulse_dly Delay
	UINT32 reg_core1_sync_dly_cnt_rst_v_value :16;	//(31:16,NA,8) //[RO] disp_pulse_dly Counter
	};
	};

}PE_O26F22_VSD1_SHP_CORE1_SYNC_DLY_CTRL_06_T;

typedef struct {
	UINT32 uaddr32;
	union {
	UINT32 udata32;
	struct {						//0xF34100AC RW 0x000A_00F4
	UINT32 reg_core1_sync_dly_auto_actv_h_dly :15;	//(14:0,NA,244) //auto actv pixel delay
	UINT32 reg_core1_sync_dly_auto_actv_gen_en :1;	//(15:15,NA,0) //auto actv gen enable
	UINT32 reg_core1_sync_dly_auto_actv_v_dly :15;	//(30:16,NA,10) //auto actv line delay
	UINT32 reg_core1_sync_dly_auto_actv_seam_en :1;	//(31:31,NA,0) //auto actv seam enable
	};
	};

}PE_O26F22_VSD1_SHP_CORE1_SYNC_DLY_CTRL_07_T;

typedef struct {
	UINT32 uaddr32;
	union {
	UINT32 udata32;
	struct {						//0xF34100B0 RW 0x000A_00F4
	UINT32 reg_core1_sync_dly_auto_sync_h_dly :15;	//(14:0,NA,244) //auto sync pixel delay
	UINT32 reg_core1_sync_dly_auto_sync_gen_en :1;	//(15:15,NA,0) //auto sync gen enable
	UINT32 reg_core1_sync_dly_auto_sync_v_dly :15;	//(30:16,NA,10) //auto sync line delay
	UINT32 reg_core1_sync_dly_auto_sync_seam_en :1;	//(31:31,NA,0) //auto sync seam enable
	};
	};

}PE_O26F22_VSD1_SHP_CORE1_SYNC_DLY_CTRL_08_T;

typedef struct {
	UINT32 uaddr32;
	union {
	UINT32 udata32;
	struct {						//0xF34100B4 RW 0x0000_0000
	UINT32 reg_core1_sync_dly_normal_number :16;	//(15:0,NA,0) //protection mode
	UINT32 resvd                            :16;
	};
	};

}PE_O26F22_VSD1_SHP_CORE1_SYNC_DLY_CTRL_09_T;

typedef struct {
	UINT32 uaddr32;
	union {
	UINT32 udata32;
	struct {						//0xF34100B8 RW 0x0000_0000
	UINT32 reg_core1_sync_dly_cnt_h_rst_position :16;	//(15:0,NA,0) //manual cnt h value position
	UINT32 reg_core1_sync_dly_cnt_v_rst_position :16;	//(31:16,NA,0) //manual cnt v value position
	};
	};

}PE_O26F22_VSD1_SHP_CORE1_SYNC_DLY_CTRL_0A_T;

typedef struct {
	UINT32 uaddr32;
	union {
	UINT32 udata32;
	struct {						//0xF34100C0 RW 0x0000_0000
	UINT32 reg_core0_roi_mask_en            :1;	//(0:0,NA,0) //ROI mask enable
	UINT32 resvd                            :7;
	UINT32 reg_core0_roi_mask_pix_val_yy    :8;	//(15:8,NA,0) //ROI mask pixel value (Y)
	UINT32 reg_core0_roi_mask_pix_val_cb    :8;	//(23:16,NA,0) //ROI mask pixel value (Cb)
	UINT32 reg_core0_roi_mask_pix_val_cr    :8;	//(31:24,NA,0) //ROI mask pixel value (Cr)
	};
	};

}PE_O26F22_VSD1_SHP_CORE0_ROI_MASK_CTRL_00_T;

typedef struct {
	UINT32 uaddr32;
	union {
	UINT32 udata32;
	struct {						//0xF34100C4 RW 0x0000_0000
	UINT32 reg_core0_roi_mask_win_x0        :16;	//(15:0,NA,0) //ROI mask window start position, x0
	UINT32 reg_core0_roi_mask_win_y0        :16;	//(31:16,NA,0) //ROI mask window start position, y0
	};
	};

}PE_O26F22_VSD1_SHP_CORE0_ROI_MASK_CTRL_01_T;

typedef struct {
	UINT32 uaddr32;
	union {
	UINT32 udata32;
	struct {						//0xF34100C8 RW 0x0000_0000
	UINT32 reg_core0_roi_mask_win_x1        :16;	//(15:0,NA,0) //ROI mask window end position, x1
	UINT32 reg_core0_roi_mask_win_y1        :16;	//(31:16,NA,0) //ROI mask window end position, y1
	};
	};

}PE_O26F22_VSD1_SHP_CORE0_ROI_MASK_CTRL_02_T;

typedef struct {
	UINT32 uaddr32;
	union {
	UINT32 udata32;
	struct {						//0xF34100D0 RW 0x0000_0000
	UINT32 reg_core1_roi_mask_en            :1;	//(0:0,NA,0) //ROI mask enable
	UINT32 resvd                            :7;
	UINT32 reg_core1_roi_mask_pix_val_yy    :8;	//(15:8,NA,0) //ROI mask pixel value (Y)
	UINT32 reg_core1_roi_mask_pix_val_cb    :8;	//(23:16,NA,0) //ROI mask pixel value (Cb)
	UINT32 reg_core1_roi_mask_pix_val_cr    :8;	//(31:24,NA,0) //ROI mask pixel value (Cr)
	};
	};

}PE_O26F22_VSD1_SHP_CORE1_ROI_MASK_CTRL_00_T;

typedef struct {
	UINT32 uaddr32;
	union {
	UINT32 udata32;
	struct {						//0xF34100D4 RW 0x0000_0000
	UINT32 reg_core1_roi_mask_win_x0        :16;	//(15:0,NA,0) //ROI mask window start position, x0
	UINT32 reg_core1_roi_mask_win_y0        :16;	//(31:16,NA,0) //ROI mask window start position, y0
	};
	};

}PE_O26F22_VSD1_SHP_CORE1_ROI_MASK_CTRL_01_T;

typedef struct {
	UINT32 uaddr32;
	union {
	UINT32 udata32;
	struct {						//0xF34100D8 RW 0x0000_0000
	UINT32 reg_core1_roi_mask_win_x1        :16;	//(15:0,NA,0) //ROI mask window end position, x1
	UINT32 reg_core1_roi_mask_win_y1        :16;	//(31:16,NA,0) //ROI mask window end position, y1
	};
	};

}PE_O26F22_VSD1_SHP_CORE1_ROI_MASK_CTRL_02_T;
...
}PE_O26F22_VSD1_SHP_ESF_CTRL_00_T;
...
}PE_O26F22_VSD1_SHP_ESF_CTRL_01_T;
...
}PE_O26F22_VSD1_SHP_ESF_CTRL_02_T;
...
}PE_O26F22_VSD1_SHP_CORE0_ESF_WIN_CTRL_00_T;
...
}PE_O26F22_VSD1_SHP_CORE0_ESF_WIN_CTRL_01_T;
...
}PE_O26F22_VSD1_SHP_CORE0_ESF_WIN_CTRL_02_T;
...
}PE_O26F22_VSD1_SHP_CORE0_ESF_WIN_CTRL_03_T;
...
}PE_O26F22_VSD1_SHP_CORE0_ESF_WIN_CTRL_04_T;
...
}PE_O26F22_VSD1_SHP_CORE1_ESF_WIN_CTRL_00_T;
...
}PE_O26F22_VSD1_SHP_CORE1_ESF_WIN_CTRL_01_T;
...
}PE_O26F22_VSD1_SHP_CORE1_ESF_WIN_CTRL_02_T;
...
}PE_O26F22_VSD1_SHP_CORE1_ESF_WIN_CTRL_03_T;
...
}PE_O26F22_VSD1_SHP_CORE1_ESF_WIN_CTRL_04_T;
...
}PE_O26F22_VSD1_SHP_DP_CTRL_00_T;
...
}PE_O26F22_VSD1_SHP_FD_CTRL_00_T;
...
}PE_O26F22_VSD1_SHP_FD_CTRL_01_T;
...
}PE_O26F22_VSD1_SHP_FD_CTRL_02_T;
...
}PE_O26F22_VSD1_SHP_FD_CTRL_03_T;
...
}PE_O26F22_VSD1_SHP_FD_CTRL_04_T;
...
}PE_O26F22_VSD1_SHP_FD_CTRL_05_T;
...
}PE_O26F22_VSD1_SHP_FD_CTRL_06_T;
...
}PE_O26F22_VSD1_SHP_FD_CTRL_07_T;
...
}PE_O26F22_VSD1_SHP_FD_CTRL_08_T;
...
}PE_O26F22_VSD1_SHP_FD_CTRL_09_T;
...
}PE_O26F22_VSD1_SHP_FD_CTRL_0A_T;
...
}PE_O26F22_VSD1_SHP_FD_CTRL_0B_T;
...
}PE_O26F22_VSD1_SHP_FD_CTRL_0C_T;
...
}PE_O26F22_VSD1_SHP_FD_CTRL_0D_T;
...
}PE_O26F22_VSD1_SHP_FD_CTRL_0E_T;
...
}PE_O26F22_VSD1_SHP_FD_CTRL_0F_T;
...
}PE_O26F22_VSD1_SHP_FD_CTRL_10_T;
...
}PE_O26F22_VSD1_SHP_FD_CTRL_11_T;
...
}PE_O26F22_VSD1_SHP_FD_CTRL_12_T;
...
}PE_O26F22_VSD1_SHP_FD_CTRL_13_T;
...
}PE_O26F22_VSD1_SHP_FD_CTRL_14_T;
...
}PE_O26F22_VSD1_SHP_FD_CTRL_15_T;
...
}PE_O26F22_VSD1_SHP_FD_CTRL_16_T;
...
}PE_O26F22_VSD1_SHP_MP_CTRL_00_T;
...
}PE_O26F22_VSD1_SHP_MP_CTRL_01_T;
...
}PE_O26F22_VSD1_SHP_MP_CTRL_02_T;
...
}PE_O26F22_VSD1_SHP_MP_CTRL_03_T;
...
}PE_O26F22_VSD1_SHP_MP_CTRL_04_T;
...
}PE_O26F22_VSD1_SHP_MP_CTRL_05_T;
...
}PE_O26F22_VSD1_SHP_MP_CTRL_06_T;
...
}PE_O26F22_VSD1_SHP_MP_CTRL_07_T;
...
}PE_O26F22_VSD1_SHP_MP_CTRL_08_T;
...
}PE_O26F22_VSD1_SHP_MP_CTRL_09_T;
...
}PE_O26F22_VSD1_SHP_MP_CTRL_0A_T;
...
}PE_O26F22_VSD1_SHP_MP_CTRL_0B_T;
...
}PE_O26F22_VSD1_SHP_MP_CTRL_0C_T;
...
}PE_O26F22_VSD1_SHP_APL_CTRL_00_T;
...
}PE_O26F22_VSD1_SHP_LC_CTRL_00_T;
...
}PE_O26F22_VSD1_SHP_LC_CTRL_01_T;
...
}PE_O26F22_VSD1_SHP_LC_CTRL_02_T;
...
}PE_O26F22_VSD1_SHP_LC_CTRL_03_T;
...
}PE_O26F22_VSD1_SHP_LC_CTRL_04_T;
...
}PE_O26F22_VSD1_SHP_DER_CTRL_00_T;
...
}PE_O26F22_VSD1_SHP_DER_CTRL_01_T;
...
}PE_O26F22_VSD1_SHP_DER_CTRL_02_T;
...
}PE_O26F22_VSD1_SHP_DER_CTRL_03_T;
...
}PE_O26F22_VSD1_SHP_DER_CTRL_04_T;
...
}PE_O26F22_VSD1_SHP_DER_CTRL_05_T;
...
}PE_O26F22_VSD1_SHP_DER_CTRL_06_T;
...
}PE_O26F22_VSD1_SHP_DER_CTRL_07_T;
...
}PE_O26F22_VSD1_SHP_SP_CTRL_00_T;
...
}PE_O26F22_VSD1_SHP_SP_CTRL_01_T;
...
}PE_O26F22_VSD1_SHP_SP_CTRL_02_T;
...
}PE_O26F22_VSD1_SHP_SP_CTRL_03_T;
...
}PE_O26F22_VSD1_SHP_SP_CTRL_04_T;
...
}PE_O26F22_VSD1_SHP_SP_CTRL_05_T;
...
}PE_O26F22_VSD1_SHP_SP_CTRL_06_T;
...
}PE_O26F22_VSD1_SHP_SP_CTRL_07_T;
...
}PE_O26F22_VSD1_SHP_SP_CTRL_08_T;
...
}PE_O26F22_VSD1_SHP_SP_CTRL_09_T;
...
}PE_O26F22_VSD1_SHP_SP_CTRL_0A_T;
...
}PE_O26F22_VSD1_SHP_SP_CTRL_0B_T;
...
}PE_O26F22_VSD1_SHP_SP_CTRL_0C_T;
...
}PE_O26F22_VSD1_SHP_PTI_CTRL_00_T;
...
}PE_O26F22_VSD1_SHP_PTI_CTRL_01_T;
...
}PE_O26F22_VSD1_SHP_PTI_CTRL_02_T;
...
}PE_O26F22_VSD1_SHP_PTI_CTRL_03_T;
...
}PE_O26F22_VSD1_SHP_STI_CTRL_00_T;
...
}PE_O26F22_VSD1_SHP_TGEN_CTRL_00_T;
...
}PE_O26F22_VSD1_SHP_TGEN_CTRL_01_T;
...
}PE_O26F22_VSD1_SHP_TGEN_CTRL_02_T;
...
}PE_O26F22_VSD1_SHP_CORE0_TGEN_CTRL_03_C0_T;
...
}PE_O26F22_VSD1_SHP_CORE0_TGEN_CTRL_03_C1_T;
...
}PE_O26F22_VSD1_SHP_CORE1_TGEN_CTRL_03_C0_T;
...
}PE_O26F22_VSD1_SHP_CORE1_TGEN_CTRL_03_C1_T;
...
}PE_O26F22_VSD1_SHP_TGEN_CTRL_04_T;
...
}PE_O26F22_VSD1_SHP_TGEN_CTRL_05_T;
...
}PE_O26F22_VSD1_SHP_TGEN_CTRL_06_T;
...
}PE_O26F22_VSD1_SHP_TGEN_CTRL_07_T;
...
}PE_O26F22_VSD1_SHP_TGEN_CTRL_08_T;
...
}PE_O26F22_VSD1_SHP_TGEN_CTRL_09_T;
...
}PE_O26F22_VSD1_SHP_TGEN_CTRL_0A_T;
...
}PE_O26F22_VSD1_SHP_TGEN_CTRL_0B_T;
...
}PE_O26F22_VSD1_SHP_SNR_CTRL_00_T;
...
}PE_O26F22_VSD1_SHP_DCTP_CTRL_00_T;
...
}PE_O26F22_VSD1_SHP_DCTP_CTRL_01_T;
...
}PE_O26F22_VSD1_SHP_DCTP_CTRL_02_T;
...
}PE_O26F22_VSD1_SHP_DCTP_CTRL_03_T;
...
}PE_O26F22_VSD1_SHP_DCTP_CTRL_04_T;
...
}PE_O26F22_VSD1_SHP_DCTP_CTRL_05_T;
...
}PE_O26F22_VSD1_SHP_DCTP_CTRL_06_T;
...
}PE_O26F22_VSD1_SHP_DCTP_CTRL_07_T;
...
}PE_O26F22_VSD1_SHP_DCTP_CTRL_08_T;
...
}PE_O26F22_VSD1_SHP_DCTP_CTRL_09_T;
...
}PE_O26F22_VSD1_SHP_DCTP_CTRL_0A_T;
...
}PE_O26F22_VSD1_SHP_DCTP_CTRL_0B_T;
...
}PE_O26F22_VSD1_SHP_DCTP_CTRL_0C_T;
...
}PE_O26F22_VSD1_SHP_DCTP_CTRL_0D_T;
...
}PE_O26F22_VSD1_SHP_DCTP_CTRL_0E_T;
...
}PE_O26F22_VSD1_SHP_DCTP_CTRL_0F_T;
...
}PE_O26F22_VSD1_SHP_DCTP_CTRL_10_T;
...
}PE_O26F22_VSD1_SHP_DCTP_CTRL_11_T;
...
}PE_O26F22_VSD1_SHP_DCTP_CTRL_12_T;
...
}PE_O26F22_VSD1_SHP_DCTP_CTRL_13_T;
...
}PE_O26F22_VSD1_SHP_DCTP_CTRL_14_T;
...
}PE_O26F22_VSD1_SHP_DCTP_CTRL_15_T;
...
}PE_O26F22_VSD1_SHP_DCTP_CTRL_16_T;
...
}PE_O26F22_VSD1_SHP_DCTP_CTRL_17_T;
...
}PE_O26F22_VSD1_SHP_DCTP_CTRL_18_T;
...
}PE_O26F22_VSD1_SHP_DCTP_CTRL_19_T;
...
}PE_O26F22_VSD1_SHP_DCTP_CTRL_1A_T;
...
}PE_O26F22_VSD1_SHP_DCTP_CTRL_1B_T;
...
}PE_O26F22_VSD1_SHP_DCTP_CTRL_1C_T;
...
}PE_O26F22_VSD1_SHP_DCTP_CTRL_1D_T;
...
}PE_O26F22_VSD1_SHP_DCTP_CTRL_1E_T;
...
}PE_O26F22_VSD1_SHP_DCTP_CTRL_1F_T;
...
}PE_O26F22_VSD1_SHP_NNTG_CTRL_00_T;
...
}PE_O26F22_VSD1_SHP_CORE0_NNTG_CTRL_01_C0_T;
...
}PE_O26F22_VSD1_SHP_CORE0_NNTG_CTRL_02_C0_T;
...
}PE_O26F22_VSD1_SHP_CORE0_NNTG_CTRL_03_C0_T;
...
}PE_O26F22_VSD1_SHP_CORE0_NNTG_CTRL_04_C0_T;
...
}PE_O26F22_VSD1_SHP_CORE0_NNTG_CTRL_05_C0_T;
...
}PE_O26F22_VSD1_SHP_CORE0_NNTG_CTRL_01_C1_T;
...
}PE_O26F22_VSD1_SHP_CORE0_NNTG_CTRL_02_C1_T;
...
}PE_O26F22_VSD1_SHP_CORE0_NNTG_CTRL_03_C1_T;
...
}PE_O26F22_VSD1_SHP_CORE0_NNTG_CTRL_04_C1_T;
...
}PE_O26F22_VSD1_SHP_CORE0_NNTG_CTRL_05_C1_T;
...
}PE_O26F22_VSD1_SHP_CORE1_NNTG_CTRL_01_C0_T;
...
}PE_O26F22_VSD1_SHP_CORE1_NNTG_CTRL_02_C0_T;
...
}PE_O26F22_VSD1_SHP_CORE1_NNTG_CTRL_03_C0_T;
...
}PE_O26F22_VSD1_SHP_CORE1_NNTG_CTRL_04_C0_T;
...
}PE_O26F22_VSD1_SHP_CORE1_NNTG_CTRL_05_C0_T;
...
}PE_O26F22_VSD1_SHP_CORE1_NNTG_CTRL_01_C1_T;
...
}PE_O26F22_VSD1_SHP_CORE1_NNTG_CTRL_02_C1_T;
...
}PE_O26F22_VSD1_SHP_CORE1_NNTG_CTRL_03_C1_T;
...
}PE_O26F22_VSD1_SHP_CORE1_NNTG_CTRL_04_C1_T;
...
}PE_O26F22_VSD1_SHP_CORE1_NNTG_CTRL_05_C1_T;
...
}PE_O26F22_VSD1_SHP_NNTG_CTRL_06_T;
...
}PE_O26F22_VSD1_SHP_NNTG_CTRL_07_T;
...
}PE_O26F22_VSD1_SHP_NNTG_CTRL_08_T;
...
}PE_O26F22_VSD1_SHP_NNTG_CTRL_09_T;
...
}PE_O26F22_VSD1_SHP_NNTG_CTRL_0A_T;
...
}PE_O26F22_VSD1_SHP_NNTG_CTRL_0B_T;
...
}PE_O26F22_VSD1_SHP_NNTG_CTRL_0C_T;
...
}PE_O26F22_VSD1_SHP_NNTG_CTRL_0D_T;
...
}PE_O26F22_VSD1_SHP_NNTG_CTRL_0E_T;
...
}PE_O26F22_VSD1_SHP_NNTG_CTRL_0F_T;
...
}PE_O26F22_VSD1_SHP_NNTG_CTRL_10_T;
...
}PE_O26F22_VSD1_SHP_DP_SUM_CTRL_00_T;
...
}PE_O26F22_VSD1_SHP_DP_SUM_CTRL_01_T;
...
}PE_O26F22_VSD1_SHP_DP_SUM_CTRL_02_T;
...
}PE_O26F22_VSD1_SHP_DP_SUM_CTRL_03_T;
...
}PE_O26F22_VSD1_SHP_DP_SUM_CTRL_04_T;
...
}PE_O26F22_VSD1_SHP_DP_SUM_CTRL_05_T;
...
}PE_O26F22_VSD1_SHP_DP_SUM_CTRL_06_T;
...
}PE_O26F22_VSD1_SHP_DP_SUM_CTRL_07_T;
...
}PE_O26F22_VSD1_SHP_DP_SUM_CTRL_08_T;
...
}PE_O26F22_VSD1_SHP_DP_SUM_CTRL_09_T;
...
}PE_O26F22_VSD1_SHP_DP_SUM_CTRL_0A_T;
...
}PE_O26F22_VSD1_SHP_PSP_CTRL_00_T;
...
}PE_O26F22_VSD1_SHP_DP_SUM_CTRL_0B_T;
...
}PE_O26F22_VSD1_SHP_DP_SUM_CTRL_0C_T;
...
}PE_O26F22_VSD1_SHP_CORE0_DP_WIN_CTRL_00_T;
...
}PE_O26F22_VSD1_SHP_CORE0_DP_WIN_CTRL_01_T;
...
}PE_O26F22_VSD1_SHP_CORE0_DP_WIN_CTRL_02_T;
...
}PE_O26F22_VSD1_SHP_CORE0_DP_WIN_CTRL_03_T;
...
}PE_O26F22_VSD1_SHP_CORE0_DP_WIN_CTRL_04_T;
...
}PE_O26F22_VSD1_SHP_CORE1_DP_WIN_CTRL_00_T;
...
}PE_O26F22_VSD1_SHP_CORE1_DP_WIN_CTRL_01_T;
...
}PE_O26F22_VSD1_SHP_CORE1_DP_WIN_CTRL_02_T;
...
}PE_O26F22_VSD1_SHP_CORE1_DP_WIN_CTRL_03_T;
...
}PE_O26F22_VSD1_SHP_CORE1_DP_WIN_CTRL_04_T;
...
}PE_O26F22_VSD1_SHP_FD_REGION_TEXT_00_T;
...
}PE_O26F22_VSD1_SHP_FD_REGION_TEXT_01_T;
...
}PE_O26F22_VSD1_SHP_FD_REGION_TEXT_02_T;
...
}PE_O26F22_VSD1_SHP_FD_TMAP_TEMP_00_T;
...
}PE_O26F22_VSD1_SHP_FD_TMAP_TEMP_01_T;
...
}PE_O26F22_VSD1_SHP_FD_TMAP_TEMP_02_T;
...
}PE_O26F22_VSD1_SHP_FD_TMAP_TEMP_03_T;
...
}PE_O26F22_VSD1_SHP_FD_TMAP_TEMP_04_T;
...
}PE_O26F22_VSD1_SHP_FD_TMAP_TEMP_05_T;
...
}PE_O26F22_VSD1_SHP_FD_TMAP_TEMP_06_T;
...
}PE_O26F22_VSD1_SHP_FD_TMAP_TEMP_07_T;
...
}PE_O26F22_VSD1_SHP_FD_TMAP_TEMP_08_T;
...
}PE_O26F22_VSD1_SHP_FD_TMAP_TEMP_09_T;
...
}PE_O26F22_VSD1_SHP_FD_TMAP_TEMP_0A_T;
...
}PE_O26F22_VSD1_SHP_FD_TMAP_TEMP_0B_T;
...
}PE_O26F22_VSD1_SHP_FD_TMAP_TEMP_0C_T;
...
}PE_O26F22_VSD1_SHP_DJ_CTRL_00_T;
...
}PE_O26F22_VSD1_SHP_DJ_CTRL_01_T;
...
}PE_O26F22_VSD1_SHP_DJ_CTRL_02_T;
...
}PE_O26F22_VSD1_SHP_DJ_CTRL_03_T;
...
}PE_O26F22_VSD1_SHP_DJ_CTRL_04_T;
...
}PE_O26F22_VSD1_SHP_DJ_CTRL_05_T;
...
}PE_O26F22_VSD1_SHP_DJ_CTRL_06_T;
...
}PE_O26F22_VSD1_SHP_DJ_CTRL_07_T;
...
}PE_O26F22_VSD1_SHP_DJ_CTRL_08_T;
...
}PE_O26F22_VSD1_SHP_DJ_CTRL_09_T;
...
}PE_O26F22_VSD1_SHP_DJ_CTRL_0A_T;
...
}PE_O26F22_VSD1_SHP_DJ_CTRL_0B_T;
...
}PE_O26F22_VSD1_SHP_DJ_CTRL_0C_T;
...
}PE_O26F22_VSD1_SHP_DJ_CTRL_0D_T;
...
}PE_O26F22_VSD1_SHP_DJ_CTRL_0E_T;
...
}PE_O26F22_VSD1_SHP_DJ_CTRL_0F_T;
...
}PE_O26F22_VSD1_SHP_DJ_CTRL_10_T;
...
}PE_O26F22_VSD1_SHP_DJ_CTRL_11_T;
...
}PE_O26F22_VSD1_SHP_DJ_CTRL_12_T;
...
}PE_O26F22_VSD1_SHP_DJ_CTRL_13_T;
...
}PE_O26F22_VSD1_SHP_DJ_CTRL_14_T;
...
}PE_O26F22_VSD1_SHP_DJ_CTRL_15_T;
...
}PE_O26F22_VSD1_SHP_DJ_CTRL_16_T;
...
}PE_O26F22_VSD1_SHP_DJ_CTRL_17_T;
...
}PE_O26F22_VSD1_SHP_DJ_CTRL_18_T;
...
}PE_O26F22_VSD1_SHP_DJ_CTRL_19_T;
...
}PE_O26F22_VSD1_SHP_DJ_CTRL_1A_T;
...
}PE_O26F22_VSD1_SHP_DJ_CTRL_1B_T;
...
}PE_O26F22_VSD1_SHP_DJ_CTRL_1C_T;
...
}PE_O26F22_VSD1_SHP_DJ_CTRL_1D_T;
...
}PE_O26F22_VSD1_SHP_DJ_CTRL_1E_T;
...
}PE_O26F22_VSD1_SHP_DJ_CTRL_1F_T;
...
}PE_O26F22_VSD1_SHP_DJ_CTRL_20_T;
...
}PE_O26F22_VSD1_SHP_DB_CTRL_00_T;
...
}PE_O26F22_VSD1_SHP_DB_CTRL_01_T;
...
}PE_O26F22_VSD1_SHP_CORE0_DJ_WIN_CTRL_00_T;
...
}PE_O26F22_VSD1_SHP_CORE0_DJ_WIN_CTRL_01_T;
...
}PE_O26F22_VSD1_SHP_CORE0_DJ_WIN_CTRL_02_T;
...
}PE_O26F22_VSD1_SHP_CORE0_DJ_WIN_CTRL_03_T;
...
}PE_O26F22_VSD1_SHP_CORE0_DJ_WIN_CTRL_04_T;
...
}PE_O26F22_VSD1_SHP_CORE1_DJ_WIN_CTRL_00_T;
...
}PE_O26F22_VSD1_SHP_CORE1_DJ_WIN_CTRL_01_T;
...
}PE_O26F22_VSD1_SHP_CORE1_DJ_WIN_CTRL_02_T;
...
}PE_O26F22_VSD1_SHP_CORE1_DJ_WIN_CTRL_03_T;
...
}PE_O26F22_VSD1_SHP_CORE1_DJ_WIN_CTRL_04_T;
...
}PE_O26F22_VSD1_SHP_CHROMA_CTRL_00_T;
...
}PE_O26F22_VSD1_SHP_CHROMA_CTRL_01_T;
...
}PE_O26F22_VSD1_SHP_CHROMA_CTRL_02_T;
...
}PE_O26F22_VSD1_SHP_CHROMA_CTRL_03_T;
...
}PE_O26F22_VSD1_SHP_CHROMA_CTRL_04_T;
...
}PE_O26F22_VSD1_SHP_CHROMA_CTRL_05_T;
...
}PE_O26F22_VSD1_SHP_CHROMA_CTRL_06_T;
...
}PE_O26F22_VSD1_SHP_CHROMA_CTRL_07_T;
...
}PE_O26F22_VSD1_SHP_CHROMA_CTRL_08_T;
...
}PE_O26F22_VSD1_SHP_CHROMA_CTRL_09_T;
...
}PE_O26F22_VSD1_SHP_CHROMA_CTRL_0A_T;
...
}PE_O26F22_VSD1_SHP_CHROMA_CTRL_0B_T;
...
}PE_O26F22_VSD1_SHP_CHROMA_CTRL_0C_T;
...
}PE_O26F22_VSD1_SHP_CHROMA_CTRL_0D_T;
...
}PE_O26F22_VSD1_SHP_CHROMA_CTRL_0E_T;
...
}PE_O26F22_VSD1_SHP_CTI_CTRL_00_T;
...
}PE_O26F22_VSD1_SHP_CTI_CTRL_01_T;
...
}PE_O26F22_VSD1_SHP_CTI_CTRL_02_T;
...
}PE_O26F22_VSD1_SHP_FRC_FLICK_CTRL_00_T;
...
}PE_O26F22_VSD1_SHP_FRC_FLICK_CTRL_01_T;
...
}PE_O26F22_VSD1_SHP_FRC_FLICK_CTRL_02_T;
...
}PE_O26F22_VSD1_SHP_FRC_FLICK_CTRL_03_T;
...
}PE_O26F22_VSD1_SHP_FRC_BLUR_CTRL_00_T;
...
}PE_O26F22_VSD1_SHP_FRC_BLUR_CTRL_01_T;
...
}PE_O26F22_VSD1_SHP_FRC_BLUR_CTRL_02_T;
...
}PE_O26F22_VSD1_SHP_FRC_BLUR_CTRL_03_T;
...
}PE_O26F22_VSD1_SHP_FRC_BLUR_CTRL_04_T;
...
}PE_O26F22_VSD1_SHP_FRC_BLUR_CTRL_05_T;
...
}PE_O26F22_VSD1_SHP_FRC_BLUR_CTRL_06_T;
...
}PE_O26F22_VSD1_SHP_FRC_HALO_CTRL_00_T;
...
}PE_O26F22_VSD1_SHP_FRC_HALO_CTRL_01_T;
...
}PE_O26F22_VSD1_SHP_FRC_HALO_CTRL_02_T;
...
}PE_O26F22_VSD1_SHP_FRC_HALO_CTRL_03_T;
...
}PE_O26F22_VSD1_SHP_CORE0_FRC_WIN_CTRL_00_T;
...
}PE_O26F22_VSD1_SHP_CORE0_FRC_WIN_CTRL_01_T;
...
}PE_O26F22_VSD1_SHP_CORE0_FRC_WIN_CTRL_02_T;
...
}PE_O26F22_VSD1_SHP_CORE0_FRC_WIN_CTRL_03_T;
...
}PE_O26F22_VSD1_SHP_CORE0_FRC_WIN_CTRL_04_T;
...
}PE_O26F22_VSD1_SHP_CORE1_FRC_WIN_CTRL_00_T;
...
}PE_O26F22_VSD1_SHP_CORE1_FRC_WIN_CTRL_01_T;
...
}PE_O26F22_VSD1_SHP_CORE1_FRC_WIN_CTRL_02_T;
...
}PE_O26F22_VSD1_SHP_CORE1_FRC_WIN_CTRL_03_T;
...
}PE_O26F22_VSD1_SHP_CORE1_FRC_WIN_CTRL_04_T;
...
}PE_O26F22_VSD1_SHP_MOTION_GAIN_CTRL_00_T;
...
}PE_O26F22_VSD1_SHP_MOTION_GAIN_CTRL_01_T;
...
}PE_O26F22_VSD1_SHP_MOTION_GAIN_CTRL_02_T;
...
}PE_O26F22_VSD1_SHP_MOTION_GAIN_CTRL_03_T;
...
}PE_O26F22_VSD1_SHP_MOTION_GAIN_CTRL_04_T;
...
}PE_O26F22_VSD1_SHP_MOTION_GAIN_CTRL_05_T;
...
}PE_O26F22_VSD1_SHP_MOTION_GAIN_CTRL_06_T;
...
}PE_O26F22_VSD1_SHP_MOTION_GAIN_CTRL_07_T;
...
}PE_O26F22_VSD1_SHP_MOTION_GAIN_CTRL_08_T;
...
}PE_O26F22_VSD1_SHP_MOTION_GAIN_CTRL_09_T;
...
}PE_O26F22_VSD1_SHP_MOTION_GAIN_CTRL_0A_T;
...
}PE_O26F22_VSD1_SHP_MOTION_GAIN_CTRL_0B_T;
...
}PE_O26F22_VSD1_SHP_MOTION_GAIN_CTRL_0C_T;
...
}PE_O26F22_VSD1_SHP_MOTION_PROT_CTRL_00_T;
...
}PE_O26F22_VSD1_SHP_MOTION_PROT_CTRL_01_T;
...
}PE_O26F22_VSD1_SHP_MOTION_PROT_CTRL_02_T;
...
}PE_O26F22_VSD1_SHP_MOTION_PROT_CTRL_03_T;
...
}PE_O26F22_VSD1_SHP_MOTION_PROT_CTRL_04_T;
...
}PE_O26F22_VSD1_SHP_CORE0_MOT_WIN_CTRL_00_T;
...
}PE_O26F22_VSD1_SHP_CORE0_MOT_WIN_CTRL_01_T;
...
}PE_O26F22_VSD1_SHP_CORE0_MOT_WIN_CTRL_02_T;
...
}PE_O26F22_VSD1_SHP_CORE0_MOT_WIN_CTRL_03_T;
...
}PE_O26F22_VSD1_SHP_CORE0_MOT_WIN_CTRL_04_T;
...
}PE_O26F22_VSD1_SHP_CORE1_MOT_WIN_CTRL_00_T;
...
}PE_O26F22_VSD1_SHP_CORE1_MOT_WIN_CTRL_01_T;
...
}PE_O26F22_VSD1_SHP_CORE1_MOT_WIN_CTRL_02_T;
...
}PE_O26F22_VSD1_SHP_CORE1_MOT_WIN_CTRL_03_T;
...
}PE_O26F22_VSD1_SHP_CORE1_MOT_WIN_CTRL_04_T;
...
}PE_O26F22_VSD1_SHP_OBJ_CTRL_00_T;
...
}PE_O26F22_VSD1_SHP_OBJ_CTRL_01_T;
...
}PE_O26F22_VSD1_SHP_OBJ_CTRL_02_T;
...
}PE_O26F22_VSD1_SHP_OBJ_CTRL_03_T;
...
}PE_O26F22_VSD1_SHP_OBJ_CTRL_04_T;
...
}PE_O26F22_VSD1_SHP_OBJ_CTRL_05_T;
...
}PE_O26F22_VSD1_SHP_OBJ_CTRL_06_T;
...
}PE_O26F22_VSD1_SHP_OBJ_CTRL_07_T;
...
}PE_O26F22_VSD1_SHP_OBJ_CTRL_08_T;
...
typedef struct {
	...
	UINT32 reg_obj_master_gain_lut_y0       :8;	//(7:0,NA,80) //object master_gain LUT , y2
	UINT32 reg_obj_master_gain_lut_x0       :8;	//(15:8,NA,0) //object master_gain LUT , x2
	UINT32 reg_obj_master_gain_lut_y1       :8;	//(23:16,NA,96) //object master_gain LUT , y3
	UINT32 reg_obj_master_gain_lut_x1       :8;	//(31:24,NA,48) //object master_gain LUT , x3
	};
	};

}PE_O26F22_VSD1_SHP_OBJ_CTRL_09_T;
...
typedef struct {
	...
	UINT32 reg_obj_master_gain_lut_y2       :8;	//(7:0,NA,128) //object master_gain LUT , y0
	UINT32 reg_obj_master_gain_lut_x2       :8;	//(15:8,NA,96) //object master_gain LUT , x0
	UINT32 reg_obj_master_gain_lut_y3       :8;	//(23:16,NA,128) //object master_gain LUT , y1
	UINT32 reg_obj_master_gain_lut_x3       :8;	//(31:24,NA,144) //object master_gain LUT , x1
	};
	};

}PE_O26F22_VSD1_SHP_OBJ_CTRL_0A_T;
...
}PE_O26F22_VSD1_SHP_OBJ_CTRL_0B_T;
...
}PE_O26F22_VSD1_SHP_OBJ_CTRL_0C_T;
...
}PE_O26F22_VSD1_SHP_CORE0_STAT_00_T;
...
}PE_O26F22_VSD1_SHP_CORE0_STAT_01_T;
...
}PE_O26F22_VSD1_SHP_CORE0_STAT_02_T;
...
}PE_O26F22_VSD1_SHP_CORE0_STAT_03_T;
...
}PE_O26F22_VSD1_SHP_CORE0_STAT_04_T;
...
}PE_O26F22_VSD1_SHP_CORE0_STAT_05_T;
...
}PE_O26F22_VSD1_SHP_CORE0_FD_STAT_00_T;
...
}PE_O26F22_VSD1_SHP_CORE0_FD_STAT_01_T;
...
}PE_O26F22_VSD1_SHP_CORE0_FD_STAT_02_T;
...
}PE_O26F22_VSD1_SHP_CORE0_FD_STAT_03_T;
...
}PE_O26F22_VSD1_SHP_MOTION_GAIN_STAT_00_T;
...
}PE_O26F22_VSD1_SHP_MOTION_GAIN_STAT_01_T;
...
}PE_O26F22_VSD1_SHP_CORE0_EDGE_STAT_00_T;
...
}PE_O26F22_VSD1_SHP_CORE0_EDGE_STAT_01_T;
...
}PE_O26F22_VSD1_SHP_CORE0_EDGE_STAT_02_T;
...
}PE_O26F22_VSD1_SHP_CORE0_EDGE_STAT_03_T;
...
}PE_O26F22_VSD1_SHP_CORE0_EDGE_STAT_04_T;
...
}PE_O26F22_VSD1_SHP_CORE0_EDGE_STAT_05_T;
...
}PE_O26F22_VSD1_SHP_CORE0_TMAP_STAT_00_T;
...
}PE_O26F22_VSD1_SHP_CORE0_TMAP_STAT_01_T;
...
}PE_O26F22_VSD1_SHP_CORE0_TMAP_STAT_02_T;
...
}PE_O26F22_VSD1_SHP_CORE0_TMAP_STAT_03_T;
...
}PE_O26F22_VSD1_SHP_CORE0_TMAP_STAT_04_T;
...
}PE_O26F22_VSD1_SHP_CORE0_TMAP_STAT_05_T;
...
}PE_O26F22_VSD1_SHP_CORE0_TMAP_STAT_06_T;
...
}PE_O26F22_VSD1_SHP_CORE0_TMAP_STAT_07_T;
...
}PE_O26F22_VSD1_SHP_CORE0_FACE_WIN_CTRL_00_T;
...
}PE_O26F22_VSD1_SHP_CORE0_FACE_WIN_CTRL_01_T;
...
}PE_O26F22_VSD1_SHP_CORE0_FACE_WIN_CTRL_02_T;
...
}PE_O26F22_VSD1_SHP_CORE0_FACE_WIN_CTRL_03_T;
...
}PE_O26F22_VSD1_SHP_CORE0_FACE_WIN_CTRL_04_T;
...
}PE_O26F22_VSD1_SHP_CORE0_FACE_WIN_CTRL_05_T;
...
}PE_O26F22_VSD1_SHP_CORE0_BODY_WIN_CTRL_00_T;
...
}PE_O26F22_VSD1_SHP_CORE0_BODY_WIN_CTRL_01_T;
...
}PE_O26F22_VSD1_SHP_CORE0_BODY_WIN_CTRL_02_T;
...
}PE_O26F22_VSD1_SHP_CORE0_BODY_WIN_CTRL_03_T;
...
}PE_O26F22_VSD1_SHP_CORE0_BODY_WIN_CTRL_04_T;
...
}PE_O26F22_VSD1_SHP_CORE0_BODY_WIN_CTRL_05_T;
...
}PE_O26F22_VSD1_SHP_CORE1_STAT_00_T;
...
}PE_O26F22_VSD1_SHP_CORE1_STAT_01_T;
...
}PE_O26F22_VSD1_SHP_CORE1_STAT_02_T;
...
}PE_O26F22_VSD1_SHP_CORE1_STAT_03_T;
...
}PE_O26F22_VSD1_SHP_CORE1_STAT_04_T;
...
}PE_O26F22_VSD1_SHP_CORE1_STAT_05_T;
...
}PE_O26F22_VSD1_SHP_CORE1_FD_STAT_00_T;
...
}PE_O26F22_VSD1_SHP_CORE1_FD_STAT_01_T;
...
}PE_O26F22_VSD1_SHP_CORE1_FD_STAT_02_T;
...
}PE_O26F22_VSD1_SHP_CORE1_FD_STAT_03_T;
...
}PE_O26F22_VSD1_SHP_CORE1_EDGE_STAT_00_T;
...
}PE_O26F22_VSD1_SHP_CORE1_EDGE_STAT_01_T;
...
}PE_O26F22_VSD1_SHP_CORE1_EDGE_STAT_02_T;
...
}PE_O26F22_VSD1_SHP_CORE1_EDGE_STAT_03_T;
...
}PE_O26F22_VSD1_SHP_CORE1_EDGE_STAT_04_T;
...
}PE_O26F22_VSD1_SHP_CORE1_EDGE_STAT_05_T;
...
}PE_O26F22_VSD1_SHP_CORE1_TMAP_STAT_00_T;
...
}PE_O26F22_VSD1_SHP_CORE1_TMAP_STAT_01_T;
...
}PE_O26F22_VSD1_SHP_CORE1_TMAP_STAT_02_T;
...
}PE_O26F22_VSD1_SHP_CORE1_TMAP_STAT_03_T;
...
}PE_O26F22_VSD1_SHP_CORE1_TMAP_STAT_04_T;
...
}PE_O26F22_VSD1_SHP_CORE1_TMAP_STAT_05_T;
...
}PE_O26F22_VSD1_SHP_CORE1_TMAP_STAT_06_T;
...
}PE_O26F22_VSD1_SHP_CORE1_TMAP_STAT_07_T;
...
}PE_O26F22_VSD1_SHP_CORE1_FACE_WIN_CTRL_00_T;
...
}PE_O26F22_VSD1_SHP_CORE1_FACE_WIN_CTRL_01_T;
...
}PE_O26F22_VSD1_SHP_CORE1_FACE_WIN_CTRL_02_T;
...
}PE_O26F22_VSD1_SHP_CORE1_FACE_WIN_CTRL_03_T;
...
}PE_O26F22_VSD1_SHP_CORE1_FACE_WIN_CTRL_04_T;
...
}PE_O26F22_VSD1_SHP_CORE1_FACE_WIN_CTRL_05_T;
...
}PE_O26F22_VSD1_SHP_CORE1_BODY_WIN_CTRL_00_T;
...
}PE_O26F22_VSD1_SHP_CORE1_BODY_WIN_CTRL_01_T;
...
}PE_O26F22_VSD1_SHP_CORE1_BODY_WIN_CTRL_02_T;
...
}PE_O26F22_VSD1_SHP_CORE1_BODY_WIN_CTRL_03_T;
...
}PE_O26F22_VSD1_SHP_CORE1_BODY_WIN_CTRL_04_T;
...
}PE_O26F22_VSD1_SHP_CORE1_BODY_WIN_CTRL_05_T;
...
}PE_O26F22_DNR0_REG_CTI_CTRL_2_T;
...
}PE_O26F22_DNR0_REG_CTI_CTRL_3_T;
...
}PE_O26F22_SR_MERGE_BLEND_00_T;

typedef struct
{
	PE_O26F22_VSD1_SHP_NEW_FD_CTRL_00_T                shp_new_fd_ctrl_00;	//0xF3410020
	PE_O26F22_VSD1_SHP_NEW_FD_CTRL_01_T                shp_new_fd_ctrl_01;	//0xF3410024
	PE_O26F22_VSD1_SHP_NEW_FD_CTRL_02_T                shp_new_fd_ctrl_02;	//0xF3410028
	PE_O26F22_VSD1_SHP_NEW_FD_CTRL_03_T                shp_new_fd_ctrl_03;	//0xF341002C
	PE_O26F22_VSD1_SHP_NEW_FD_CTRL_04_T                shp_new_fd_ctrl_04;	//0xF3410030
	PE_O26F22_VSD1_SHP_TEXT_REGION_MAP_00_T        shp_text_region_map_00;	//0xF3410034
	PE_O26F22_VSD1_SHP_ESF_CTRL_00_T                          shp_esf_ctrl_00;	//0x00A0
	PE_O26F22_VSD1_SHP_ESF_CTRL_01_T                          shp_esf_ctrl_01;	//0x00A4
	PE_O26F22_VSD1_SHP_ESF_CTRL_02_T                          shp_esf_ctrl_02;	//0x00A8
	PE_O26F22_VSD1_SHP_DP_CTRL_00_T                           shp_dp_ctrl_00;	//0x0100
	PE_O26F22_VSD1_SHP_FD_CTRL_00_T                           shp_fd_ctrl_00;	//0x0110
	PE_O26F22_VSD1_SHP_FD_CTRL_01_T                           shp_fd_ctrl_01;	//0x0114
	PE_O26F22_VSD1_SHP_FD_CTRL_02_T                           shp_fd_ctrl_02;	//0x0118
	PE_O26F22_VSD1_SHP_FD_CTRL_03_T                           shp_fd_ctrl_03;	//0x011C
	PE_O26F22_VSD1_SHP_FD_CTRL_04_T                           shp_fd_ctrl_04;	//0x0120
	PE_O26F22_VSD1_SHP_FD_CTRL_05_T                           shp_fd_ctrl_05;	//0x0124
	PE_O26F22_VSD1_SHP_FD_CTRL_06_T                           shp_fd_ctrl_06;	//0x0128
	PE_O26F22_VSD1_SHP_FD_CTRL_07_T                           shp_fd_ctrl_07;	//0x012C
	PE_O26F22_VSD1_SHP_FD_CTRL_08_T                           shp_fd_ctrl_08;	//0x0130
	PE_O26F22_VSD1_SHP_FD_CTRL_09_T                           shp_fd_ctrl_09;	//0x0134
	PE_O26F22_VSD1_SHP_FD_CTRL_0A_T                           shp_fd_ctrl_0a;	//0x0138
	PE_O26F22_VSD1_SHP_FD_CTRL_0B_T                           shp_fd_ctrl_0b;	//0x013C
	PE_O26F22_VSD1_SHP_FD_CTRL_0C_T                           shp_fd_ctrl_0c;	//0x0140
	PE_O26F22_VSD1_SHP_FD_CTRL_0D_T                           shp_fd_ctrl_0d;	//0x0144
	PE_O26F22_VSD1_SHP_FD_CTRL_0E_T                           shp_fd_ctrl_0e;	//0x0148
	PE_O26F22_VSD1_SHP_FD_CTRL_0F_T                           shp_fd_ctrl_0f;	//0x014C
	PE_O26F22_VSD1_SHP_FD_CTRL_10_T                           shp_fd_ctrl_10;	//0x0150
	PE_O26F22_VSD1_SHP_FD_CTRL_11_T                           shp_fd_ctrl_11;	//0x0154
	PE_O26F22_VSD1_SHP_FD_CTRL_12_T                           shp_fd_ctrl_12;	//0x0158
	PE_O26F22_VSD1_SHP_FD_CTRL_13_T                           shp_fd_ctrl_13;	//0x014C
	PE_O26F22_VSD1_SHP_FD_CTRL_14_T                           shp_fd_ctrl_14;	//0x0150
	PE_O26F22_VSD1_SHP_FD_CTRL_15_T                           shp_fd_ctrl_15;	//0x0154
	PE_O26F22_VSD1_SHP_FD_CTRL_16_T                           shp_fd_ctrl_16;	//0x0158
	PE_O26F22_VSD1_SHP_MP_CTRL_00_T                           shp_mp_ctrl_00;	//0x0160
	PE_O26F22_VSD1_SHP_MP_CTRL_01_T                           shp_mp_ctrl_01;	//0x0164
	PE_O26F22_VSD1_SHP_MP_CTRL_02_T                           shp_mp_ctrl_02;	//0x0168
	PE_O26F22_VSD1_SHP_MP_CTRL_03_T                           shp_mp_ctrl_03;	//0x016C
	PE_O26F22_VSD1_SHP_MP_CTRL_04_T                           shp_mp_ctrl_04;	//0x0170
	PE_O26F22_VSD1_SHP_MP_CTRL_05_T                           shp_mp_ctrl_05;	//0x0174
	PE_O26F22_VSD1_SHP_MP_CTRL_06_T                           shp_mp_ctrl_06;	//0x0178
	PE_O26F22_VSD1_SHP_MP_CTRL_07_T                           shp_mp_ctrl_07;	//0x017C
	PE_O26F22_VSD1_SHP_MP_CTRL_08_T                           shp_mp_ctrl_08;	//0x0180
	PE_O26F22_VSD1_SHP_MP_CTRL_09_T                           shp_mp_ctrl_09;	//0x0184
	PE_O26F22_VSD1_SHP_MP_CTRL_0A_T                           shp_mp_ctrl_0a;	//0x0188
	PE_O26F22_VSD1_SHP_MP_CTRL_0B_T                           shp_mp_ctrl_0b;	//0x018C
	PE_O26F22_VSD1_SHP_MP_CTRL_0C_T                           shp_mp_ctrl_0c;	//0x0190
	PE_O26F22_VSD1_SHP_APL_CTRL_00_T                          shp_apl_ctrl_00;	//0x0194
	PE_O26F22_VSD1_SHP_LC_CTRL_00_T                           shp_lc_ctrl_00;	//0x01A0
	PE_O26F22_VSD1_SHP_LC_CTRL_01_T                           shp_lc_ctrl_01;	//0x01A4
	PE_O26F22_VSD1_SHP_LC_CTRL_02_T                           shp_lc_ctrl_02;	//0x01A8
	PE_O26F22_VSD1_SHP_LC_CTRL_03_T                           shp_lc_ctrl_03;	//0x01AC
	PE_O26F22_VSD1_SHP_LC_CTRL_04_T                           shp_lc_ctrl_04;	//0x01B0
	PE_O26F22_VSD1_SHP_DER_CTRL_00_T                          shp_der_ctrl_00;	//0x01C0
	PE_O26F22_VSD1_SHP_DER_CTRL_01_T                          shp_der_ctrl_01;	//0x01C4
	PE_O26F22_VSD1_SHP_DER_CTRL_02_T                          shp_der_ctrl_02;	//0x01C8
	PE_O26F22_VSD1_SHP_DER_CTRL_03_T                          shp_der_ctrl_03;	//0x01CC
	PE_O26F22_VSD1_SHP_DER_CTRL_04_T                          shp_der_ctrl_04;	//0x01D0
	PE_O26F22_VSD1_SHP_DER_CTRL_05_T                          shp_der_ctrl_05;	//0x01D4
	PE_O26F22_VSD1_SHP_DER_CTRL_06_T                          shp_der_ctrl_06;	//0x01D8
	PE_O26F22_VSD1_SHP_DER_CTRL_07_T                          shp_der_ctrl_07;	//0x01DC
	PE_O26F22_VSD1_SHP_SP_CTRL_00_T                           shp_sp_ctrl_00;	//0x01E0
	PE_O26F22_VSD1_SHP_SP_CTRL_01_T                           shp_sp_ctrl_01;	//0x01E4
	PE_O26F22_VSD1_SHP_SP_CTRL_02_T                           shp_sp_ctrl_02;	//0x01E8
	PE_O26F22_VSD1_SHP_SP_CTRL_03_T                           shp_sp_ctrl_03;	//0x01EC
	PE_O26F22_VSD1_SHP_SP_CTRL_04_T                           shp_sp_ctrl_04;	//0x01F0
	PE_O26F22_VSD1_SHP_SP_CTRL_05_T                           shp_sp_ctrl_05;	//0x01F4
	PE_O26F22_VSD1_SHP_SP_CTRL_06_T                           shp_sp_ctrl_06;	//0x01F8
	PE_O26F22_VSD1_SHP_SP_CTRL_07_T                           shp_sp_ctrl_07;	//0x01FC
	PE_O26F22_VSD1_SHP_SP_CTRL_08_T                           shp_sp_ctrl_08;	//0x0200
	PE_O26F22_VSD1_SHP_SP_CTRL_09_T                           shp_sp_ctrl_09;	//0x0204
	PE_O26F22_VSD1_SHP_SP_CTRL_0A_T                           shp_sp_ctrl_0a;	//0x0208
	PE_O26F22_VSD1_SHP_SP_CTRL_0B_T                           shp_sp_ctrl_0b;	//0x020C
	PE_O26F22_VSD1_SHP_SP_CTRL_0C_T                           shp_sp_ctrl_0c;	//0x0210
	PE_O26F22_VSD1_SHP_PTI_CTRL_00_T                          shp_pti_ctrl_00;	//0x0220
	PE_O26F22_VSD1_SHP_PTI_CTRL_01_T                          shp_pti_ctrl_01;	//0x0224
	PE_O26F22_VSD1_SHP_PTI_CTRL_02_T                          shp_pti_ctrl_02;	//0x0228
	PE_O26F22_VSD1_SHP_PTI_CTRL_03_T                          shp_pti_ctrl_03;	//0x022C
	PE_O26F22_VSD1_SHP_STI_CTRL_00_T                          shp_sti_ctrl_00;	//0x0230
	PE_O26F22_VSD1_SHP_TGEN_CTRL_00_T                         shp_tgen_ctrl_00;	//0x0240
	PE_O26F22_VSD1_SHP_TGEN_CTRL_01_T                         shp_tgen_ctrl_01;	//0x0244
	PE_O26F22_VSD1_SHP_TGEN_CTRL_02_T                         shp_tgen_ctrl_02;	//0x0248
	PE_O26F22_VSD1_SHP_CORE0_TGEN_CTRL_03_C0_T             shp_core0_tgen_ctrl_03_c0;	//0xF34102AC
	PE_O26F22_VSD1_SHP_CORE0_TGEN_CTRL_03_C1_T             shp_core0_tgen_ctrl_03_c1;	//0xF34102B0
	PE_O26F22_VSD1_SHP_CORE1_TGEN_CTRL_03_C0_T             shp_core1_tgen_ctrl_03_c0;	//0xF34102B4
	PE_O26F22_VSD1_SHP_CORE1_TGEN_CTRL_03_C1_T             shp_core1_tgen_ctrl_03_c1;	//0xF34102B8
	PE_O26F22_VSD1_SHP_TGEN_CTRL_04_T                         shp_tgen_ctrl_04;	//0x0254
	PE_O26F22_VSD1_SHP_TGEN_CTRL_05_T                         shp_tgen_ctrl_05;	//0x0258
	PE_O26F22_VSD1_SHP_TGEN_CTRL_06_T                         shp_tgen_ctrl_06;	//0x025C
	PE_O26F22_VSD1_SHP_TGEN_CTRL_07_T                         shp_tgen_ctrl_07;	//0x0260
	PE_O26F22_VSD1_SHP_TGEN_CTRL_08_T                         shp_tgen_ctrl_08;	//0x0264
	PE_O26F22_VSD1_SHP_TGEN_CTRL_09_T                         shp_tgen_ctrl_09;	//0x0268
	PE_O26F22_VSD1_SHP_TGEN_CTRL_0A_T                         shp_tgen_ctrl_0a;	//0x026C
	PE_O26F22_VSD1_SHP_TGEN_CTRL_0B_T                         shp_tgen_ctrl_0b;	//0x0270
	PE_O26F22_VSD1_SHP_SNR_CTRL_00_T                          shp_snr_ctrl_00;	//0x0274
	PE_O26F22_VSD1_SHP_DCTP_CTRL_00_T                         shp_dctp_ctrl_00;	//0x0280
	PE_O26F22_VSD1_SHP_DCTP_CTRL_01_T                         shp_dctp_ctrl_01;	//0x0284
	PE_O26F22_VSD1_SHP_DCTP_CTRL_02_T                         shp_dctp_ctrl_02;	//0x0288
	PE_O26F22_VSD1_SHP_DCTP_CTRL_03_T                         shp_dctp_ctrl_03;	//0x028C
	PE_O26F22_VSD1_SHP_DCTP_CTRL_04_T                         shp_dctp_ctrl_04;	//0x0290
	PE_O26F22_VSD1_SHP_DCTP_CTRL_05_T                         shp_dctp_ctrl_05;	//0x0294
	PE_O26F22_VSD1_SHP_DCTP_CTRL_06_T                         shp_dctp_ctrl_06;	//0x0298
	PE_O26F22_VSD1_SHP_DCTP_CTRL_07_T                         shp_dctp_ctrl_07;	//0x029C
	PE_O26F22_VSD1_SHP_DCTP_CTRL_08_T                         shp_dctp_ctrl_08;	//0x02A0
	PE_O26F22_VSD1_SHP_DCTP_CTRL_09_T                         shp_dctp_ctrl_09;	//0x02A4
	PE_O26F22_VSD1_SHP_DCTP_CTRL_0A_T                         shp_dctp_ctrl_0a;	//0x02A8
	PE_O26F22_VSD1_SHP_DCTP_CTRL_0B_T                         shp_dctp_ctrl_0b;	//0x02AC
	PE_O26F22_VSD1_SHP_DCTP_CTRL_0C_T                         shp_dctp_ctrl_0c;	//0x02B0
	PE_O26F22_VSD1_SHP_DCTP_CTRL_0D_T                         shp_dctp_ctrl_0d;	//0x02B4
	PE_O26F22_VSD1_SHP_DCTP_CTRL_0E_T                         shp_dctp_ctrl_0e;	//0x02B8
	PE_O26F22_VSD1_SHP_DCTP_CTRL_0F_T                         shp_dctp_ctrl_0f;	//0x02BC
	PE_O26F22_VSD1_SHP_DCTP_CTRL_10_T                         shp_dctp_ctrl_10;	//0x02C0
	PE_O26F22_VSD1_SHP_DCTP_CTRL_11_T                         shp_dctp_ctrl_11;	//0x02C4
	PE_O26F22_VSD1_SHP_DCTP_CTRL_12_T                         shp_dctp_ctrl_12;	//0x02C8
	PE_O26F22_VSD1_SHP_DCTP_CTRL_13_T                         shp_dctp_ctrl_13;	//0x02CC
	PE_O26F22_VSD1_SHP_DCTP_CTRL_14_T                         shp_dctp_ctrl_14;	//0x02D0
	PE_O26F22_VSD1_SHP_DCTP_CTRL_15_T                         shp_dctp_ctrl_15;	//0x02D4
	PE_O26F22_VSD1_SHP_DCTP_CTRL_16_T                         shp_dctp_ctrl_16;	//0x02D8
	PE_O26F22_VSD1_SHP_DCTP_CTRL_17_T                         shp_dctp_ctrl_17;	//0x02DC
	PE_O26F22_VSD1_SHP_DCTP_CTRL_18_T                         shp_dctp_ctrl_18;	//0x02E0
	PE_O26F22_VSD1_SHP_DCTP_CTRL_19_T                         shp_dctp_ctrl_19;	//0x02E4
	PE_O26F22_VSD1_SHP_DCTP_CTRL_1A_T                         shp_dctp_ctrl_1a;	//0x02E8
	PE_O26F22_VSD1_SHP_DCTP_CTRL_1B_T                         shp_dctp_ctrl_1b;	//0x02EC
	PE_O26F22_VSD1_SHP_DCTP_CTRL_1C_T                         shp_dctp_ctrl_1c;	//0x02F0
	PE_O26F22_VSD1_SHP_DCTP_CTRL_1D_T                         shp_dctp_ctrl_1d;	//0x02F4
	PE_O26F22_VSD1_SHP_DCTP_CTRL_1E_T                         shp_dctp_ctrl_1e;	//0x02F8
	PE_O26F22_VSD1_SHP_DCTP_CTRL_1F_T                         shp_dctp_ctrl_1f;	//0x02FC
	PE_O26F22_VSD1_SHP_NNTG_CTRL_00_T                         shp_nntg_ctrl_00;	//0x0300
	PE_O26F22_VSD1_SHP_CORE0_NNTG_CTRL_01_C0_T        shp_core0_nntg_ctrl_01_c0;	//0xF3410374
	PE_O26F22_VSD1_SHP_CORE0_NNTG_CTRL_02_C0_T        shp_core0_nntg_ctrl_02_c0;	//0xF3410378
	PE_O26F22_VSD1_SHP_CORE0_NNTG_CTRL_03_C0_T        shp_core0_nntg_ctrl_03_c0;	//0xF341037C
	PE_O26F22_VSD1_SHP_CORE0_NNTG_CTRL_04_C0_T        shp_core0_nntg_ctrl_04_c0;	//0xF3410380
	PE_O26F22_VSD1_SHP_CORE0_NNTG_CTRL_05_C0_T        shp_core0_nntg_ctrl_05_c0;	//0xF3410384
	PE_O26F22_VSD1_SHP_CORE0_NNTG_CTRL_01_C1_T        shp_core0_nntg_ctrl_01_c1;	//0xF3410388
	PE_O26F22_VSD1_SHP_CORE0_NNTG_CTRL_02_C1_T        shp_core0_nntg_ctrl_02_c1;	//0xF341038C
	PE_O26F22_VSD1_SHP_CORE0_NNTG_CTRL_03_C1_T        shp_core0_nntg_ctrl_03_c1;	//0xF3410390
	PE_O26F22_VSD1_SHP_CORE0_NNTG_CTRL_04_C1_T        shp_core0_nntg_ctrl_04_c1;	//0xF3410394
	PE_O26F22_VSD1_SHP_CORE0_NNTG_CTRL_05_C1_T        shp_core0_nntg_ctrl_05_c1;	//0xF3410398
	PE_O26F22_VSD1_SHP_CORE1_NNTG_CTRL_01_C0_T        shp_core1_nntg_ctrl_01_c0;	//0xF341039C
	PE_O26F22_VSD1_SHP_CORE1_NNTG_CTRL_02_C0_T        shp_core1_nntg_ctrl_02_c0;	//0xF34103A0
	PE_O26F22_VSD1_SHP_CORE1_NNTG_CTRL_03_C0_T        shp_core1_nntg_ctrl_03_c0;	//0xF34103A4
	PE_O26F22_VSD1_SHP_CORE1_NNTG_CTRL_04_C0_T        shp_core1_nntg_ctrl_04_c0;	//0xF34103A8
	PE_O26F22_VSD1_SHP_CORE1_NNTG_CTRL_05_C0_T        shp_core1_nntg_ctrl_05_c0;	//0xF34103AC
	PE_O26F22_VSD1_SHP_CORE1_NNTG_CTRL_01_C1_T        shp_core1_nntg_ctrl_01_c1;	//0xF34103B0
	PE_O26F22_VSD1_SHP_CORE1_NNTG_CTRL_02_C1_T        shp_core1_nntg_ctrl_02_c1;	//0xF34103B4
	PE_O26F22_VSD1_SHP_CORE1_NNTG_CTRL_03_C1_T        shp_core1_nntg_ctrl_03_c1;	//0xF34103B8
	PE_O26F22_VSD1_SHP_CORE1_NNTG_CTRL_04_C1_T        shp_core1_nntg_ctrl_04_c1;	//0xF34103BC
	PE_O26F22_VSD1_SHP_CORE1_NNTG_CTRL_05_C1_T        shp_core1_nntg_ctrl_05_c1;	//0xF34103C0
	PE_O26F22_VSD1_SHP_NNTG_CTRL_06_T                         shp_nntg_ctrl_06;	//0x032C
	PE_O26F22_VSD1_SHP_NNTG_CTRL_07_T                         shp_nntg_ctrl_07;	//0x0330
	PE_O26F22_VSD1_SHP_NNTG_CTRL_08_T                         shp_nntg_ctrl_08;	//0x0334
	PE_O26F22_VSD1_SHP_NNTG_CTRL_09_T                         shp_nntg_ctrl_09;	//0x0338
	PE_O26F22_VSD1_SHP_NNTG_CTRL_0A_T                         shp_nntg_ctrl_0a;	//0x033C
	PE_O26F22_VSD1_SHP_NNTG_CTRL_0B_T                         shp_nntg_ctrl_0b;	//0x0340
	PE_O26F22_VSD1_SHP_NNTG_CTRL_0C_T                         shp_nntg_ctrl_0c;	//0x0344
	PE_O26F22_VSD1_SHP_NNTG_CTRL_0D_T                         shp_nntg_ctrl_0d;	//0x0348
	PE_O26F22_VSD1_SHP_NNTG_CTRL_0E_T                         shp_nntg_ctrl_0e;	//0x034C
	PE_O26F22_VSD1_SHP_NNTG_CTRL_0F_T                         shp_nntg_ctrl_0f;	//0x0350
	PE_O26F22_VSD1_SHP_NNTG_CTRL_10_T                         shp_nntg_ctrl_10;	//0x0354
	PE_O26F22_VSD1_SHP_DP_SUM_CTRL_00_T                       shp_dp_sum_ctrl_00;	//0x0360
	PE_O26F22_VSD1_SHP_DP_SUM_CTRL_01_T                       shp_dp_sum_ctrl_01;	//0x0364
	PE_O26F22_VSD1_SHP_DP_SUM_CTRL_02_T                       shp_dp_sum_ctrl_02;	//0x0368
	PE_O26F22_VSD1_SHP_DP_SUM_CTRL_03_T                       shp_dp_sum_ctrl_03;	//0x036C
	PE_O26F22_VSD1_SHP_DP_SUM_CTRL_04_T                       shp_dp_sum_ctrl_04;	//0x0370
	PE_O26F22_VSD1_SHP_DP_SUM_CTRL_05_T                       shp_dp_sum_ctrl_05;	//0x0374
	PE_O26F22_VSD1_SHP_DP_SUM_CTRL_06_T                       shp_dp_sum_ctrl_06;	//0x0378
	PE_O26F22_VSD1_SHP_DP_SUM_CTRL_07_T                       shp_dp_sum_ctrl_07;	//0x037C
	PE_O26F22_VSD1_SHP_DP_SUM_CTRL_08_T                       shp_dp_sum_ctrl_08;	//0x0380
	PE_O26F22_VSD1_SHP_DP_SUM_CTRL_09_T                       shp_dp_sum_ctrl_09;	//0xCC462384
	PE_O26F22_VSD1_SHP_DP_SUM_CTRL_0A_T                       shp_dp_sum_ctrl_0a;	//0xCC462388
	PE_O26F22_VSD1_SHP_PSP_CTRL_00_T                          shp_psp_ctrl_00;	    //0x0390
	PE_O26F22_VSD1_SHP_DP_SUM_CTRL_0B_T                       shp_dp_sum_ctrl_0b;	//0xCC462394
	PE_O26F22_VSD1_SHP_DP_SUM_CTRL_0C_T                       shp_dp_sum_ctrl_0c;	//0xCC462398
	PE_O26F22_VSD1_SHP_FD_REGION_TEXT_00_T                    shp_fd_region_text_00;	//0x03C0
	PE_O26F22_VSD1_SHP_FD_REGION_TEXT_01_T                    shp_fd_region_text_01;	//0x03C4
	PE_O26F22_VSD1_SHP_FD_REGION_TEXT_02_T                    shp_fd_region_text_02;	//0x03C8
	PE_O26F22_VSD1_SHP_FD_TMAP_TEMP_00_T                      shp_fd_tmap_temp_00;	//0x03CC
	PE_O26F22_VSD1_SHP_FD_TMAP_TEMP_01_T                      shp_fd_tmap_temp_01;	//0x03D0
	PE_O26F22_VSD1_SHP_FD_TMAP_TEMP_02_T                      shp_fd_tmap_temp_02;	//0x03D4
	PE_O26F22_VSD1_SHP_FD_TMAP_TEMP_03_T                      shp_fd_tmap_temp_03;	//0x03D8
	PE_O26F22_VSD1_SHP_FD_TMAP_TEMP_04_T                      shp_fd_tmap_temp_04;	//0x03DC
	PE_O26F22_VSD1_SHP_FD_TMAP_TEMP_05_T                      shp_fd_tmap_temp_05;	//0x03E0
	PE_O26F22_VSD1_SHP_FD_TMAP_TEMP_06_T                      shp_fd_tmap_temp_06;	//0x03E4
	PE_O26F22_VSD1_SHP_FD_TMAP_TEMP_07_T                      shp_fd_tmap_temp_07;	//0x03E8
	PE_O26F22_VSD1_SHP_FD_TMAP_TEMP_08_T                      shp_fd_tmap_temp_08;	//0x03EC
	PE_O26F22_VSD1_SHP_FD_TMAP_TEMP_09_T                      shp_fd_tmap_temp_09;	//0x03F0
	PE_O26F22_VSD1_SHP_FD_TMAP_TEMP_0A_T                      shp_fd_tmap_temp_0a;	//0x03F4
	PE_O26F22_VSD1_SHP_FD_TMAP_TEMP_0B_T                      shp_fd_tmap_temp_0b;	//0x03F8
	PE_O26F22_VSD1_SHP_FD_TMAP_TEMP_0C_T                      shp_fd_tmap_temp_0c;	//0x03FC
	PE_O26F22_VSD1_SHP_DJ_CTRL_00_T                           shp_dj_ctrl_00;	//0x0400
	PE_O26F22_VSD1_SHP_DJ_CTRL_01_T                           shp_dj_ctrl_01;	//0x0404
	PE_O26F22_VSD1_SHP_DJ_CTRL_02_T                           shp_dj_ctrl_02;	//0x0408
	PE_O26F22_VSD1_SHP_DJ_CTRL_03_T                           shp_dj_ctrl_03;	//0x040C
	PE_O26F22_VSD1_SHP_DJ_CTRL_04_T                           shp_dj_ctrl_04;	//0x0410
	PE_O26F22_VSD1_SHP_DJ_CTRL_05_T                           shp_dj_ctrl_05;	//0x0414
	PE_O26F22_VSD1_SHP_DJ_CTRL_06_T                           shp_dj_ctrl_06;	//0x0418
	PE_O26F22_VSD1_SHP_DJ_CTRL_07_T                           shp_dj_ctrl_07;	//0x041C
	PE_O26F22_VSD1_SHP_DJ_CTRL_08_T                           shp_dj_ctrl_08;	//0x0420
	PE_O26F22_VSD1_SHP_DJ_CTRL_09_T                           shp_dj_ctrl_09;	//0x0424
	PE_O26F22_VSD1_SHP_DJ_CTRL_0A_T                           shp_dj_ctrl_0a;	//0x0428
	PE_O26F22_VSD1_SHP_DJ_CTRL_0B_T                           shp_dj_ctrl_0b;	//0x042C
	PE_O26F22_VSD1_SHP_DJ_CTRL_0C_T                           shp_dj_ctrl_0c;	//0x0430
	PE_O26F22_VSD1_SHP_DJ_CTRL_0D_T                           shp_dj_ctrl_0d;	//0x0434
	PE_O26F22_VSD1_SHP_DJ_CTRL_0E_T                           shp_dj_ctrl_0e;	//0x0438
	PE_O26F22_VSD1_SHP_DJ_CTRL_0F_T                           shp_dj_ctrl_0f;	//0x043C
	PE_O26F22_VSD1_SHP_DJ_CTRL_10_T                           shp_dj_ctrl_10;	//0x0440
	PE_O26F22_VSD1_SHP_DJ_CTRL_11_T                           shp_dj_ctrl_11;	//0x0444
	PE_O26F22_VSD1_SHP_DJ_CTRL_12_T                           shp_dj_ctrl_12;	//0x0448
	PE_O26F22_VSD1_SHP_DJ_CTRL_13_T                           shp_dj_ctrl_13;	//0x044C
	PE_O26F22_VSD1_SHP_DJ_CTRL_14_T                           shp_dj_ctrl_14;	//0x0450
	PE_O26F22_VSD1_SHP_DJ_CTRL_15_T                           shp_dj_ctrl_15;	//0x0454
	PE_O26F22_VSD1_SHP_DJ_CTRL_16_T                           shp_dj_ctrl_16;	//0x0458
	PE_O26F22_VSD1_SHP_DJ_CTRL_17_T                           shp_dj_ctrl_17;	//0x045C
	PE_O26F22_VSD1_SHP_DJ_CTRL_18_T                           shp_dj_ctrl_18;	//0x0460
	PE_O26F22_VSD1_SHP_DJ_CTRL_19_T                           shp_dj_ctrl_19;	//0x0464
	PE_O26F22_VSD1_SHP_DJ_CTRL_1A_T                           shp_dj_ctrl_1a;	//0x0468
	PE_O26F22_VSD1_SHP_DJ_CTRL_1B_T                           shp_dj_ctrl_1b;	//0x046C
	PE_O26F22_VSD1_SHP_DJ_CTRL_1C_T                           shp_dj_ctrl_1c;	//0x0470
	PE_O26F22_VSD1_SHP_DJ_CTRL_1D_T                           shp_dj_ctrl_1d;	//0x0474
	PE_O26F22_VSD1_SHP_DJ_CTRL_1E_T                           shp_dj_ctrl_1e;	//0x0478
	PE_O26F22_VSD1_SHP_DJ_CTRL_1F_T                           shp_dj_ctrl_1f;	//0x047C
	PE_O26F22_VSD1_SHP_DJ_CTRL_20_T                           shp_dj_ctrl_20;	//0x0480
	PE_O26F22_VSD1_SHP_CHROMA_CTRL_00_T                       shp_chroma_ctrl_00;	//0x0500
	PE_O26F22_VSD1_SHP_CHROMA_CTRL_01_T                       shp_chroma_ctrl_01;	//0x0504
	PE_O26F22_VSD1_SHP_CHROMA_CTRL_02_T                       shp_chroma_ctrl_02;	//0x0508
	PE_O26F22_VSD1_SHP_CHROMA_CTRL_03_T                       shp_chroma_ctrl_03;	//0x050C
	PE_O26F22_VSD1_SHP_CHROMA_CTRL_04_T                       shp_chroma_ctrl_04;	//0x0510
	PE_O26F22_VSD1_SHP_CHROMA_CTRL_05_T                       shp_chroma_ctrl_05;	//0x0514
	PE_O26F22_VSD1_SHP_CHROMA_CTRL_06_T                       shp_chroma_ctrl_06;	//0x0518
	PE_O26F22_VSD1_SHP_CHROMA_CTRL_07_T                       shp_chroma_ctrl_07;	//0x051C
	PE_O26F22_VSD1_SHP_CHROMA_CTRL_08_T                       shp_chroma_ctrl_08;	//0x0520
	PE_O26F22_VSD1_SHP_CHROMA_CTRL_09_T                       shp_chroma_ctrl_09;	//0x0524
	PE_O26F22_VSD1_SHP_CHROMA_CTRL_0A_T                       shp_chroma_ctrl_0a;	//0x0528
	PE_O26F22_VSD1_SHP_CHROMA_CTRL_0B_T                       shp_chroma_ctrl_0b;	//0x052C
	PE_O26F22_VSD1_SHP_CHROMA_CTRL_0C_T                       shp_chroma_ctrl_0c;	//0x0530
	PE_O26F22_VSD1_SHP_CHROMA_CTRL_0D_T                       shp_chroma_ctrl_0d;	//0x0534
	PE_O26F22_VSD1_SHP_CHROMA_CTRL_0E_T                       shp_chroma_ctrl_0e;	//0x0538
	PE_O26F22_VSD1_SHP_FRC_FLICK_CTRL_00_T                    shp_frc_flick_ctrl_00;	//0x0560
	PE_O26F22_VSD1_SHP_FRC_FLICK_CTRL_01_T                    shp_frc_flick_ctrl_01;	//0x0564
	PE_O26F22_VSD1_SHP_FRC_FLICK_CTRL_02_T                    shp_frc_flick_ctrl_02;	//0x0568
	PE_O26F22_VSD1_SHP_FRC_FLICK_CTRL_03_T                    shp_frc_flick_ctrl_03;	//0x056C
	PE_O26F22_VSD1_SHP_FRC_BLUR_CTRL_00_T                     shp_frc_blur_ctrl_00;	//0xCC462570
	PE_O26F22_VSD1_SHP_FRC_BLUR_CTRL_01_T                     shp_frc_blur_ctrl_01;	//0xCC462574
	PE_O26F22_VSD1_SHP_FRC_BLUR_CTRL_02_T                     shp_frc_blur_ctrl_02;	//0xCC462578
	PE_O26F22_VSD1_SHP_FRC_BLUR_CTRL_03_T                     shp_frc_blur_ctrl_03;	//0xCC46257C
	PE_O26F22_VSD1_SHP_FRC_BLUR_CTRL_04_T                     shp_frc_blur_ctrl_04;	//0xCC462580
	PE_O26F22_VSD1_SHP_FRC_BLUR_CTRL_05_T                     shp_frc_blur_ctrl_05;	//0xCC462584
	PE_O26F22_VSD1_SHP_FRC_BLUR_CTRL_06_T                     shp_frc_blur_ctrl_06;	//0xCC462588
	PE_O26F22_VSD1_SHP_FRC_HALO_CTRL_00_T                     shp_frc_halo_ctrl_00;	//0xCC462590
	PE_O26F22_VSD1_SHP_FRC_HALO_CTRL_01_T                     shp_frc_halo_ctrl_01;	//0xCC462594
	PE_O26F22_VSD1_SHP_FRC_HALO_CTRL_02_T                     shp_frc_halo_ctrl_02;	//0xCC462598
	PE_O26F22_VSD1_SHP_FRC_HALO_CTRL_03_T                     shp_frc_halo_ctrl_03;	//0xCC46259C
	PE_O26F22_VSD1_SHP_MOTION_GAIN_CTRL_00_T                  shp_motion_gain_ctrl_00;	//0x0600
	PE_O26F22_VSD1_SHP_MOTION_GAIN_CTRL_01_T                  shp_motion_gain_ctrl_01;	//0x0604
	PE_O26F22_VSD1_SHP_MOTION_GAIN_CTRL_02_T                  shp_motion_gain_ctrl_02;	//0x0608
	PE_O26F22_VSD1_SHP_MOTION_GAIN_CTRL_03_T                  shp_motion_gain_ctrl_03;	//0x060C
	PE_O26F22_VSD1_SHP_MOTION_GAIN_CTRL_04_T                  shp_motion_gain_ctrl_04;	//0x0610
	PE_O26F22_VSD1_SHP_MOTION_GAIN_CTRL_05_T                  shp_motion_gain_ctrl_05;	//0x0614
	PE_O26F22_VSD1_SHP_MOTION_GAIN_CTRL_06_T                  shp_motion_gain_ctrl_06;	//0x0618
	PE_O26F22_VSD1_SHP_MOTION_GAIN_CTRL_07_T                  shp_motion_gain_ctrl_07;	//0x061C
	PE_O26F22_VSD1_SHP_MOTION_GAIN_CTRL_08_T                  shp_motion_gain_ctrl_08;	//0x0620
	PE_O26F22_VSD1_SHP_MOTION_GAIN_CTRL_09_T                  shp_motion_gain_ctrl_09;	//0x0624
	PE_O26F22_VSD1_SHP_MOTION_GAIN_CTRL_0A_T                  shp_motion_gain_ctrl_0a;	//0x0628
	PE_O26F22_VSD1_SHP_MOTION_GAIN_CTRL_0B_T                  shp_motion_gain_ctrl_0b;	//0x062C
	PE_O26F22_VSD1_SHP_MOTION_GAIN_CTRL_0C_T                  shp_motion_gain_ctrl_0c;	//0x0630
	PE_O26F22_VSD1_SHP_MOTION_PROT_CTRL_00_T                  shp_motion_prot_ctrl_00;	//0x0640
	PE_O26F22_VSD1_SHP_MOTION_PROT_CTRL_01_T                  shp_motion_prot_ctrl_01;	//0x0644
	PE_O26F22_VSD1_SHP_MOTION_PROT_CTRL_02_T                  shp_motion_prot_ctrl_02;	//0x0648
	PE_O26F22_VSD1_SHP_MOTION_PROT_CTRL_03_T                  shp_motion_prot_ctrl_03;	//0x064C
	PE_O26F22_VSD1_SHP_MOTION_PROT_CTRL_04_T                  shp_motion_prot_ctrl_04;	//0x0650
	PE_O26F22_VSD1_SHP_OBJ_CTRL_00_T                          shp_obj_ctrl_00;	//0x0690
	PE_O26F22_VSD1_SHP_OBJ_CTRL_01_T                          shp_obj_ctrl_01;	//0x0694
	PE_O26F22_VSD1_SHP_OBJ_CTRL_02_T                          shp_obj_ctrl_02;	//0x0698
	PE_O26F22_VSD1_SHP_OBJ_CTRL_03_T                          shp_obj_ctrl_03;	//0x069C
	PE_O26F22_VSD1_SHP_OBJ_CTRL_04_T                          shp_obj_ctrl_04;	//0x06A0
	PE_O26F22_VSD1_SHP_OBJ_CTRL_05_T                          shp_obj_ctrl_05;	//0x06A4
	PE_O26F22_VSD1_SHP_OBJ_CTRL_06_T                          shp_obj_ctrl_06;	//0x06A8
	PE_O26F22_VSD1_SHP_OBJ_CTRL_07_T                          shp_obj_ctrl_07;	//0x06AC
	PE_O26F22_VSD1_SHP_OBJ_CTRL_08_T                          shp_obj_ctrl_08;	//0x06B0
	PE_O26F22_VSD1_SHP_OBJ_CTRL_09_T                          shp_obj_ctrl_09;	//0x06B4
	PE_O26F22_VSD1_SHP_OBJ_CTRL_0A_T                          shp_obj_ctrl_0a;	//0x06B8
	PE_O26F22_VSD1_SHP_OBJ_CTRL_0B_T                          shp_obj_ctrl_0b;	//0xCC4626BC
	PE_O26F22_VSD1_SHP_OBJ_CTRL_0C_T                          shp_obj_ctrl_0c;	//0xCC4626C0
	PE_O26F22_SR_MERGE_BLEND_00_T                         sr_merge_blend_00; //0xF0394E50
}PE_CHPI_RES_TBL_O26F22_T;

typedef struct {
	PE_O26F22_DNR0_CTI_CTRL_0_T                                    cti_ctrl_0;	//0xF022158C
	PE_O26F22_DNR0_CTI_CTRL_1_T                                    cti_ctrl_1;	//0xF0221590
	PE_O26F22_DNR0_REG_CTI_CTRL_2_T                            reg_cti_ctrl_2;	//0xF02217A0
	PE_O26F22_DNR0_REG_CTI_CTRL_3_T                            reg_cti_ctrl_3;	//0xF02217A4
	PE_O26F22_VSD1_SHP_CTI_CTRL_00_T                          shp_cti_ctrl_00;	//0xF017B5A0
	PE_O26F22_VSD1_SHP_CTI_CTRL_01_T                          shp_cti_ctrl_01;	//0xF017B5A4
	PE_O26F22_VSD1_SHP_CTI_CTRL_02_T                          shp_cti_ctrl_02;	//0xF017B5A8
}PE_CHPI_CTI_TBL_O26F22_T;

//see PE_DDR_O26_SHP_UI_SQM_VSD_SIZE
typedef struct {
	UINT32     cnt32;
	UINT32     ui32;
	UINT32     data32[40];
}PE_CHPI_SHP_UI_SQM_O26F22_T;

//see PE_DDR_O26_SHP_SQM_CMN_VSD_SIZE
typedef struct {
	UINT32     cnt32;
	UINT32     ui32;
	UINT32     data32[71];
}PE_CHPI_SHP_CMN_SQM_O26F22_T;
