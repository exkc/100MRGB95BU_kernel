...
const PE_REG_PARAM_T dnr_l_sd_p_default_m17c0[] =
{
	/* dnr, 0x7194~0x7198, 0x71A0~0x71DC, 0x71E4~0x71E8, 0x71F0~0x71F8, 0x7200~0x7210, 0x726C~0x728C */
	{0x4594, 0x01380201},    // DNR_MAX_CTRL
	{0x45A0, 0x80008041},    // MNR_CTRL_0
