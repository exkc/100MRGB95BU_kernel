...
-----------------------------------------------------------------------------*/
typedef struct {
	UINT32 reg_cg_off						: 8 ;  // 7:0     
	UINT32 reg_cg_on_adc_clp				: 2 ;  // 9:8
	UINT32 reg_reg_meeoff                   : 4 ;  // 15:12
} IRIS_063_T;
...
} IRIS_GMAU_CMD_QOS_REF0_001_T;

/*-----------------------------------------------------------------------------
		0xc8000e8cL iris_gmau_cmd_qos_ctrl0_001 ''
-----------------------------------------------------------------------------*/
typedef struct {
...
} IRIS_GMAU_MD_CMD_QOS_CTRL0_001_T;

/*-----------------------------------------------------------------------------
		0xc8000e90L iris_gmau_cmd_qos_ref0_001 ''
-----------------------------------------------------------------------------*/
typedef struct {
	UINT32 reg_gmau_md_qos_period_value       : 16;  // 15: 0     
	UINT32 reg_gmau_md_qos_check_timer        : 16;  // 31:16     
} IRIS_GMAU_MD_CMD_QOS_REF0_001_T;

typedef struct {
	CVD_INTR1_ENABLE0_T          	cvd_intr1_enable0;            //0xc8000600L
	CVD_INTR1_INTR0_T            	cvd_intr1_intr0;              //0xc8000604L
	CVD_INTR1_CLEAR0_T           	cvd_intr1_clear0;             //0xc8000608L
	CVD_INTR1_ENABLE1_T          	cvd_intr1_enable1;            //0xc800060cL
	CVD_INTR1_INTR1_T            	cvd_intr1_intr1;              //0xc8000610L
	CVD_INTR1_CLEAR1_T           	cvd_intr1_clear1;             //0xc8000614L
	CVD_INTR2_ENABLE0_T          	cvd_intr2_enable0;            //0xc8000618L
	CVD_INTR2_INTR0_T            	cvd_intr2_intr0;              //0xc800061cL
	CVD_INTR2_CLEAR0_T           	cvd_intr2_clear0;             //0xc8000620L
	CVD_INTR2_ENABLE1_T          	cvd_intr2_enable1;            //0xc8000624L
	CVD_INTR2_INTR1_T            	cvd_intr2_intr1;              //0xc8000628L
	CVD_INTR2_CLEAR1_T           	cvd_intr2_clear1;             //0xc800062cL
	TOP_001_T                    	top_001;                      //0xc8000630L
	UINT32                             	reserved00[3];                //0xc8000634L~0xc800063cL
	IRIS_MIF_GMAU_001_T          	iris_mif_gmau_001;            //0xc8000640L
	IRIS_MIF_GMAU_002_T          	iris_mif_gmau_002;            //0xc8000644L
	IRIS_MIF_GMAU_003_T          	iris_mif_gmau_003;            //0xc8000648L
	IRIS_MIF_GMAU_004_T          	iris_mif_gmau_004;            //0xc800064cL
	IRIS_MIF_GMAU_005_T          	iris_mif_gmau_005;            //0xc8000650L
	IRIS_MIF_GMAU_006_T          	iris_mif_gmau_006;            //0xc8000654L
	IRIS_MIF_GMAU_007_T          	iris_mif_gmau_007;            //0xc8000658L
	IRIS_MIF_GMAU_008_T          	iris_mif_gmau_008;            //0xc800065cL
	IRIS_MIF_GMAU_009_T          	iris_mif_gmau_009;            //0xc8000660L
	IRIS_MIF_GMAU_010_T          	iris_mif_gmau_010;            //0xc8000664L
	FASTBLANK_001_T              	fastblank_001;                //0xc8000668L
	FASTBLANK_002_T              	fastblank_002;                //0xc800066cL
	FASTBLANK_003_T              	fastblank_003;                //0xc8000670L
	FASTBLANK_004_T              	fastblank_004;                //0xc8000674L
	FASTBLANK_005_T              	fastblank_005;                //0xc8000678L
	FASTBLANK_006_T              	fastblank_006;                //0xc800067cL
	FASTBLANK_007_T              	fastblank_007;                //0xc8000680L
	FASTBLANK_008_T              	fastblank_008;                //0xc8000684L
	FASTBLANK_009_T              	fastblank_009;                //0xc8000688L
	FASTBLANK_010_T              	fastblank_010;                //0xc800068cL
	IRIS_DE_CTRL_001_T           	iris_de_ctrl_001;             //0xc8000690L
	VBI_CTRL_001_T               	vbi_ctrl_001;                 //0xc8000694L
	VBI_CTRL_002_T               	vbi_ctrl_002;                 //0xc8000698L
	VBI_CTRL_003_T               	vbi_ctrl_003;                 //0xc800069cL
	VBI_CTRL_004_T               	vbi_ctrl_004;                 //0xc80006a0L
	VBI_CTRL_005_T               	vbi_ctrl_005;                 //0xc80006a4L
	VBI_CTRL_006_T               	vbi_ctrl_006;                 //0xc80006a8L
	VBI_CTRL_007_T               	vbi_ctrl_007;                 //0xc80006acL
	VBI_CTRL_008_T               	vbi_ctrl_008;                 //0xc80006b0L
	VBI_CTRL_009_T               	vbi_ctrl_009;                 //0xc80006b4L
	VBI_CTRL_010_T               	vbi_ctrl_010;                 //0xc80006b8L
	UINT32                             	reserved01;                   //0xc80006bcL
	FAST_BLANK_STATUS_001_T      	fast_blank_status_001;        //0xc80006c0L
	CVBSAFE_001_T                	cvbsafe_001;                  //0xc80006c4L
	IRIS_MIF_GMAU_MD_001_T       	iris_mif_gmau_md_001;         //0xc80006c8L
	IRIS_MIF_GMAU_MD_002_T       	iris_mif_gmau_md_002;         //0xc80006ccL
	IRIS_MIF_GMAU_MD_003_T       	iris_mif_gmau_md_003;         //0xc80006d0L
	IRIS_MIF_GMAU_MD_004_T       	iris_mif_gmau_md_004;         //0xc80006d4L
	IRIS_MIF_GMAU_MD_005_T       	iris_mif_gmau_md_005;         //0xc80006d8L
	IRIS_MIF_GMAU_MD_006_T       	iris_mif_gmau_md_006;         //0xc80006dcL
	IRIS_MIF_GMAU_MD_007_T       	iris_mif_gmau_md_007;         //0xc80006e0L
	IRIS_MIF_GMAU_MD_008_T       	iris_mif_gmau_md_008;         //0xc80006e4L
	IRIS_MIF_GMAU_MD_009_T       	iris_mif_gmau_md_009;         //0xc80006e8L
	IRIS_MIF_GMAU_MD_010_T       	iris_mif_gmau_md_010;         //0xc80006ecL
	IRIS_MIF_GMAU_MD_011_T       	iris_mif_gmau_md_011;         //0xc80006f0L
	IRIS_MIF_GMAU_MD_012_T       	iris_mif_gmau_md_012;         //0xc80006f4L
	IRIS_MIF_GMAU_MD_013_T       	iris_mif_gmau_md_013;         //0xc80006f8L
	UINT32                             	reserved02;                   //0xc80006fcL
	IRIS_001_T                   	iris_001;                     //0xc8000700L
	IRIS_002_T                   	iris_002;                     //0xc8000704L
	IRIS_003_T                   	iris_003;                     //0xc8000708L
	IRIS_004_T                   	iris_004;                     //0xc800070cL
	IRIS_005_T                   	iris_005;                     //0xc8000710L
	IRIS_006_T                   	iris_006;                     //0xc8000714L
	IRIS_007_T                   	iris_007;                     //0xc8000718L
	IRIS_008_T                   	iris_008;                     //0xc800071cL
	IRIS_009_T                   	iris_009;                     //0xc8000720L
	IRIS_010_T                   	iris_010;                     //0xc8000724L
	IRIS_011_T                   	iris_011;                     //0xc8000728L
	UINT32                             	reserved03;                   //0xc800072cL
	IRIS_012_T                   	iris_012;                     //0xc8000730L
	IRIS_013_T                   	iris_013;                     //0xc8000734L
	IRIS_014_T                   	iris_014;                     //0xc8000738L
	IRIS_015_T                   	iris_015;                     //0xc800073cL
	IRIS_016_T                   	iris_016;                     //0xc8000740L
	IRIS_017_T                   	iris_017;                     //0xc8000744L
	IRIS_018_T                   	iris_018;                     //0xc8000748L
	IRIS_019_T                   	iris_019;                     //0xc800074cL
	IRIS_020_T                   	iris_020;                     //0xc8000750L
	IRIS_021_T                   	iris_021;                     //0xc8000754L
	IRIS_022_T                   	iris_022;                     //0xc8000758L
	IRIS_023_T                   	iris_023;                     //0xc800075cL
	IRIS_024_T                   	iris_024;                     //0xc8000760L
	IRIS_025_T                   	iris_025;                     //0xc8000764L
	IRIS_026_T                   	iris_026;                     //0xc8000768L
	IRIS_027_T                   	iris_027;                     //0xc800076cL
	IRIS_028_T                   	iris_028;                     //0xc8000770L
	IRIS_029_T                   	iris_029;                     //0xc8000774L
	IRIS_030_T                   	iris_030;                     //0xc8000778L
	IRIS_031_T                   	iris_031;                     //0xc800077cL
	IRIS_032_T                   	iris_032;                     //0xc8000780L
	IRIS_033_T                   	iris_033;                     //0xc8000784L
	IRIS_034_T                   	iris_034;                     //0xc8000788L
	IRIS_035_T                   	iris_035;                     //0xc800078cL
	IRIS_036_T                   	iris_036;                     //0xc8000790L
	IRIS_037_T                   	iris_037;                     //0xc8000794L
	IRIS_038_T                   	iris_038;                     //0xc8000798L
	IRIS_039_T                   	iris_039;                     //0xc800079cL
	IRIS_040_T                   	iris_040;                     //0xc80007a0L
	IRIS_041_T                   	iris_041;                     //0xc80007a4L
	IRIS_042_T                   	iris_042;                     //0xc80007a8L
	IRIS_043_T                   	iris_043;                     //0xc80007acL
	IRIS_044_T                   	iris_044;                     //0xc80007b0L
	IRIS_045_T                   	iris_045;                     //0xc80007b4L
	IRIS_046_T                   	iris_046;                     //0xc80007b8L
	IRIS_047_T                   	iris_047;                     //0xc80007bcL
	IRIS_048_T                   	iris_048;                     //0xc80007c0L
	IRIS_049_T                   	iris_049;                     //0xc80007c4L
	IRIS_050_T                   	iris_050;                     //0xc80007c8L
	IRIS_051_T                   	iris_051;                     //0xc80007ccL
	IRIS_052_T                   	iris_052;                     //0xc80007d0L
	IRIS_053_T                   	iris_053;                     //0xc80007d4L
	IRIS_054_T                   	iris_054;                     //0xc80007d8L
	IRIS_055_T                   	iris_055;                     //0xc80007dcL
	IRIS_056_T                   	iris_056;                     //0xc80007e0L
	IRIS_057_T                   	iris_057;                     //0xc80007e4L
	IRIS_058_T                   	iris_058;                     //0xc80007e8L
	IRIS_059_T                   	iris_059;                     //0xc80007ecL
	IRIS_060_T                   	iris_060;                     //0xc80007f0L
	IRIS_061_T                   	iris_061;                     //0xc80007f4L
	IRIS_062_T                   	iris_062;                     //0xc80007f8L
	IRIS_063_T                   	iris_063;                     //0xc80007fcL
	IRIS_064_T                   	iris_064;                     //0xc8000800L
	IRIS_065_T                   	iris_065;                     //0xc8000804L
	IRIS_066_T                   	iris_066;                     //0xc8000808L
	IRIS_067_T                   	iris_067;                     //0xc800080cL
	IRIS_068_T                   	iris_068;                     //0xc8000810L
	IRIS_069_T                   	iris_069;                     //0xc8000814L
	IRIS_070_T                   	iris_070;                     //0xc8000818L
	IRIS_071_T                   	iris_071;                     //0xc800081cL
	IRIS_072_T                   	iris_072;                     //0xc8000820L
	IRIS_073_T                   	iris_073;                     //0xc8000824L
	IRIS_074_T                   	iris_074;                     //0xc8000828L
	IRIS_075_T                   	iris_075;                     //0xc800082cL
	IRIS_076_T                   	iris_076;                     //0xc8000830L
	IRIS_077_T                   	iris_077;                     //0xc8000834L
	IRIS_078_T                   	iris_078;                     //0xc8000838L
	IRIS_079_T                   	iris_079;                     //0xc800083cL
	IRIS_080_T                   	iris_080;                     //0xc8000840L
	IRIS_081_T                   	iris_081;                     //0xc8000844L
	IRIS_082_T                   	iris_082;                     //0xc8000848L
	IRIS_083_T                   	iris_083;                     //0xc800084cL
	IRIS_084_T                   	iris_084;                     //0xc8000850L
	IRIS_085_T                   	iris_085;                     //0xc8000854L
	IRIS_086_T                   	iris_086;                     //0xc8000858L
	IRIS_087_T                   	iris_087;                     //0xc800085cL
	IRIS_088_T                   	iris_088;                     //0xc8000860L
	IRIS_089_T                   	iris_089;                     //0xc8000864L
	IRIS_090_T                   	iris_090;                     //0xc8000868L
	IRIS_091_T                   	iris_091;                     //0xc800086cL
	IRIS_092_T                   	iris_092;                     //0xc8000870L
	IRIS_093_T                   	iris_093;                     //0xc8000874L
	IRIS_094_T                   	iris_094;                     //0xc8000878L
	IRIS_095_T                   	iris_095;                     //0xc800087cL
	IRIS_096_T                   	iris_096;                     //0xc8000880L
	IRIS_097_T                   	iris_097;                     //0xc8000884L
	IRIS_098_T                   	iris_098;                     //0xc8000888L
	IRIS_099_T                   	iris_099;                     //0xc800088cL
	IRIS_100_T                   	iris_100;                     //0xc8000890L
	IRIS_101_T                   	iris_101;                     //0xc8000894L
	IRIS_102_T                   	iris_102;                     //0xc8000898L
	IRIS_103_T                   	iris_103;                     //0xc800089cL
	IRIS_104_T                   	iris_104;                     //0xc80008a0L
	IRIS_105_T                   	iris_105;                     //0xc80008a4L
	IRIS_106_T                   	iris_106;                     //0xc80008a8L
	IRIS_107_T                   	iris_107;                     //0xc80008acL
	IRIS_108_T                   	iris_108;                     //0xc80008b0L
	IRIS_109_T                   	iris_109;                     //0xc80008b4L
	IRIS_110_T                   	iris_110;                     //0xc80008b8L
	IRIS_111_T                   	iris_111;                     //0xc80008bcL
	IRIS_112_T                   	iris_112;                     //0xc80008c0L
	IRIS_113_T                   	iris_113;                     //0xc80008c4L
	IRIS_114_T                   	iris_114;                     //0xc80008c8L
	IRIS_115_T                   	iris_115;                     //0xc80008ccL
	IRIS_116_T                   	iris_116;                     //0xc80008d0L
	IRIS_117_T                   	iris_117;                     //0xc80008d4L
	IRIS_118_T                   	iris_118;                     //0xc80008d8L
	IRIS_119_T                   	iris_119;                     //0xc80008dcL
	IRIS_120_T                   	iris_120;                     //0xc80008e0L
	IRIS_121_T                   	iris_121;                     //0xc80008e4L
	IRIS_122_T                   	iris_122;                     //0xc80008e8L
	IRIS_123_T                   	iris_123;                     //0xc80008ecL
	IRIS_124_T                   	iris_124;                     //0xc80008f0L
	IRIS_125_T                   	iris_125;                     //0xc80008f4L
	IRIS_126_T                   	iris_126;                     //0xc80008f8L
	IRIS_127_T                   	iris_127;                     //0xc80008fcL
	IRIS_128_T                   	iris_128;                     //0xc8000900L
	IRIS_129_T                   	iris_129;                     //0xc8000904L
	IRIS_130_T                   	iris_130;                     //0xc8000908L
	IRIS_131_T                   	iris_131;                     //0xc800090cL
	IRIS_132_T                   	iris_132;                     //0xc8000910L
	IRIS_133_T                   	iris_133;                     //0xc8000914L
	IRIS_134_T                   	iris_134;                     //0xc8000918L
	IRIS_135_T                   	iris_135;                     //0xc800091cL
	IRIS_136_T                   	iris_136;                     //0xc8000920L
	IRIS_137_T                   	iris_137;                     //0xc8000924L
	IRIS_138_T                   	iris_138;                     //0xc8000928L
	IRIS_139_T                   	iris_139;                     //0xc800092cL
	IRIS_140_T                   	iris_140;                     //0xc8000930L
	IRIS_141_T                   	iris_141;                     //0xc8000934L
	IRIS_142_T                   	iris_142;                     //0xc8000938L
	IRIS_143_T                   	iris_143;                     //0xc800093cL
	IRIS_144_T                   	iris_144;                     //0xc8000940L
	IRIS_145_T                   	iris_145;                     //0xc8000944L
	IRIS_146_T                   	iris_146;                     //0xc8000948L
	IRIS_147_T                   	iris_147;                     //0xc800094cL
	IRIS_148_T                   	iris_148;                     //0xc8000950L
	IRIS_149_T                   	iris_149;                     //0xc8000954L
	IRIS_150_T                   	iris_150;                     //0xc8000958L
	IRIS_151_T                   	iris_151;                     //0xc800095cL
	IRIS_152_T                   	iris_152;                     //0xc8000960L
	IRIS_153_T                   	iris_153;                     //0xc8000964L
	IRIS_154_T                   	iris_154;                     //0xc8000968L
	IRIS_155_T                   	iris_155;                     //0xc800096cL
	IRIS_156_T                   	iris_156;                     //0xc8000970L
	IRIS_157_T                   	iris_157;                     //0xc8000974L
	IRIS_158_T                   	iris_158;                     //0xc8000978L
	IRIS_159_T                   	iris_159;                     //0xc800097cL
	IRIS_160_T                   	iris_160;                     //0xc8000980L
	IRIS_161_T                   	iris_161;                     //0xc8000984L
	IRIS_162_T                   	iris_162;                     //0xc8000988L
	IRIS_163_T                   	iris_163;                     //0xc800098cL
	IRIS_164_T                   	iris_164;                     //0xc8000990L
	IRIS_165_T                   	iris_165;                     //0xc8000994L
	IRIS_166_T                   	iris_166;                     //0xc8000998L
	IRIS_167_T                   	iris_167;                     //0xc800099cL
	IRIS_168_T                   	iris_168;                     //0xc80009a0L
	IRIS_169_T                   	iris_169;                     //0xc80009a4L
	IRIS_170_T                   	iris_170;                     //0xc80009a8L
	IRIS_171_T                   	iris_171;                     //0xc80009acL
	IRIS_172_T                   	iris_172;                     //0xc80009b0L
	IRIS_173_T                   	iris_173;                     //0xc80009b4L
	IRIS_174_T                   	iris_174;                     //0xc80009b8L
	IRIS_175_T                   	iris_175;                     //0xc80009bcL
	IRIS_176_T                   	iris_176;                     //0xc80009c0L
	IRIS_177_T                   	iris_177;                     //0xc80009c4L
	IRIS_178_T                   	iris_178;                     //0xc80009c8L
	IRIS_179_T                   	iris_179;                     //0xc80009ccL
	IRIS_180_T                   	iris_180;                     //0xc80009d0L
	IRIS_181_T                   	iris_181;                     //0xc80009d4L
	IRIS_182_T                   	iris_182;                     //0xc80009d8L
	IRIS_183_T                   	iris_183;                     //0xc80009dcL
	IRIS_184_T                   	iris_184;                     //0xc80009e0L
	IRIS_185_T                   	iris_185;                     //0xc80009e4L
	IRIS_186_T                   	iris_186;                     //0xc80009e8L
	IRIS_187_T                   	iris_187;                     //0xc80009ecL
	IRIS_188_T                   	iris_188;                     //0xc80009f0L
	IRIS_189_T                   	iris_189;                     //0xc80009f4L
	IRIS_190_T                   	iris_190;                     //0xc80009f8L
	IRIS_191_T                   	iris_191;                     //0xc80009fcL
	IRIS_192_T                   	iris_192;                     //0xc8000a00L
	IRIS_193_T                   	iris_193;                     //0xc8000a04L
	IRIS_194_T                   	iris_194;                     //0xc8000a08L
	IRIS_195_T                   	iris_195;                     //0xc8000a0cL
	IRIS_196_T                   	iris_196;                     //0xc8000a10L
	IRIS_197_T                   	iris_197;                     //0xc8000a14L
	IRIS_198_T                   	iris_198;                     //0xc8000a18L
	IRIS_199_T                   	iris_199;                     //0xc8000a1cL
	IRIS_200_T                   	iris_200;                     //0xc8000a20L
	IRIS_201_T                   	iris_201;                     //0xc8000a24L
	IRIS_202_T                   	iris_202;                     //0xc8000a28L
	IRIS_203_T                   	iris_203;                     //0xc8000a2cL
	IRIS_204_T                   	iris_204;                     //0xc8000a30L
	IRIS_205_T                   	iris_205;                     //0xc8000a34L
	IRIS_206_T                   	iris_206;                     //0xc8000a38L
	IRIS_207_T                   	iris_207;                     //0xc8000a3cL
	IRIS_208_T                   	iris_208;                     //0xc8000a40L
	IRIS_209_T                   	iris_209;                     //0xc8000a44L
	IRIS_210_T                   	iris_210;                     //0xc8000a48L
	IRIS_211_T                   	iris_211;                     //0xc8000a4cL
	IRIS_212_T                   	iris_212;                     //0xc8000a50L
	IRIS_213_T                   	iris_213;                     //0xc8000a54L
	IRIS_214_T                   	iris_214;                     //0xc8000a58L
	IRIS_215_T                   	iris_215;                     //0xc8000a5cL
	IRIS_216_T                   	iris_216;                     //0xc8000a60L
	IRIS_217_T                   	iris_217;                     //0xc8000a64L
	IRIS_218_T                   	iris_218;                     //0xc8000a68L
	IRIS_219_T                   	iris_219;                     //0xc8000a6cL
	IRIS_220_T                   	iris_220;                     //0xc8000a70L
	IRIS_221_T                   	iris_221;                     //0xc8000a74L
	IRIS_222_T                   	iris_222;                     //0xc8000a78L
	IRIS_223_T                   	iris_223;                     //0xc8000a7cL
	IRIS_224_T                   	iris_224;                     //0xc8000a80L
	IRIS_225_T                   	iris_225;                     //0xc8000a84L
	IRIS_226_T                   	iris_226;                     //0xc8000a88L
	IRIS_227_T                   	iris_227;                     //0xc8000a8cL
	IRIS_228_T                   	iris_228;                     //0xc8000a90L
	IRIS_229_T                   	iris_229;                     //0xc8000a94L
	IRIS_230_T                   	iris_230;                     //0xc8000a98L
	IRIS_231_T                   	iris_231;                     //0xc8000a9cL
	IRIS_232_T                   	iris_232;                     //0xc8000aa0L
	IRIS_233_T                   	iris_233;                     //0xc8000aa4L
	IRIS_234_T                   	iris_234;                     //0xc8000aa8L
	IRIS_235_T                   	iris_235;                     //0xc8000aacL
	IRIS_236_T                   	iris_236;                     //0xc8000ab0L
	IRIS_237_T                   	iris_237;                     //0xc8000ab4L
	IRIS_238_T                   	iris_238;                     //0xc8000ab8L
	IRIS_239_T                   	iris_239;                     //0xc8000abcL
	IRIS_240_T                   	iris_240;                     //0xc8000ac0L
	IRIS_241_T                   	iris_241;                     //0xc8000ac4L
	IRIS_242_T                   	iris_242;                     //0xc8000ac8L
	IRIS_243_T                   	iris_243;                     //0xc8000accL
	IRIS_244_T                   	iris_244;                     //0xc8000ad0L
	IRIS_245_T                   	iris_245;                     //0xc8000ad4L
	IRIS_246_T                   	iris_246;                     //0xc8000ad8L
	IRIS_247_T                   	iris_247;                     //0xc8000adcL
	IRIS_248_T                   	iris_248;                     //0xc8000ae0L
	IRIS_249_T                   	iris_249;                     //0xc8000ae4L
	IRIS_250_T                   	iris_250;                     //0xc8000ae8L
	IRIS_251_T                   	iris_251;                     //0xc8000aecL
	IRIS_252_T                   	iris_252;                     //0xc8000af0L
	IRIS_253_T                   	iris_253;                     //0xc8000af4L
	IRIS_254_T                   	iris_254;                     //0xc8000af8L
	IRIS_255_T                   	iris_255;                     //0xc8000afcL
	IRIS_256_T                   	iris_256;                     //0xc8000b00L
	IRIS_257_T                   	iris_257;                     //0xc8000b04L
	IRIS_258_T                   	iris_258;                     //0xc8000b08L
	IRIS_259_T                   	iris_259;                     //0xc8000b0cL
	IRIS_260_T                   	iris_260;                     //0xc8000b10L
	IRIS_261_T                   	iris_261;                     //0xc8000b14L
	IRIS_262_T                   	iris_262;                     //0xc8000b18L
	IRIS_263_T                   	iris_263;                     //0xc8000b1cL
	IRIS_264_T                   	iris_264;                     //0xc8000b20L
	IRIS_265_T                   	iris_265;                     //0xc8000b24L
	UINT32                             	reserved04[2];                //0xc8000b28L~0xc8000b2cL
	IRIS_266_T                   	iris_266;                     //0xc8000b30L
	IRIS_267_T                   	iris_267;                     //0xc8000b34L
	IRIS_268_T                   	iris_268;                     //0xc8000b38L
	IRIS_269_T                   	iris_269;                     //0xc8000b3cL
	IRIS_270_T                   	iris_270;                     //0xc8000b40L
	IRIS_271_T                   	iris_271;                     //0xc8000b44L
	IRIS_272_T                   	iris_272;                     //0xc8000b48L
	IRIS_273_T                   	iris_273;                     //0xc8000b4cL
	IRIS_274_T                   	iris_274;                     //0xc8000b50L
	IRIS_275_T                   	iris_275;                     //0xc8000b54L
	IRIS_276_T                   	iris_276;                     //0xc8000b58L
	IRIS_277_T                   	iris_277;                     //0xc8000b5cL
	IRIS_278_T                   	iris_278;                     //0xc8000b60L
	IRIS_279_T                   	iris_279;                     //0xc8000b64L
	IRIS_280_T                   	iris_280;                     //0xc8000b68L
	IRIS_281_T                   	iris_281;                     //0xc8000b6cL
	IRIS_282_T                   	iris_282;                     //0xc8000b70L
	IRIS_283_T                   	iris_283;                     //0xc8000b74L
	IRIS_284_T                   	iris_284;                     //0xc8000b78L
	IRIS_285_T                   	iris_285;                     //0xc8000b7cL
	IRIS_286_T                   	iris_286;                     //0xc8000b80L
	IRIS_287_T                   	iris_287;                     //0xc8000b84L
	IRIS_288_T                   	iris_288;                     //0xc8000b88L
	IRIS_289_T                   	iris_289;                     //0xc8000b8cL
	IRIS_290_T                   	iris_290;                     //0xc8000b90L
	IRIS_291_T                   	iris_291;                     //0xc8000b94L
	IRIS_292_T                   	iris_292;                     //0xc8000b98L
	IRIS_293_T                   	iris_293;                     //0xc8000b9cL
	IRIS_294_T                   	iris_294;                     //0xc8000ba0L
	IRIS_295_T                   	iris_295;                     //0xc8000ba4L
	IRIS_296_T                   	iris_296;                     //0xc8000ba8L
	IRIS_297_T                   	iris_297;                     //0xc8000bacL
	IRIS_298_T                   	iris_298;                     //0xc8000bb0L
	IRIS_299_T                   	iris_299;                     //0xc8000bb4L
	IRIS_300_T                   	iris_300;                     //0xc8000bb8L
	IRIS_301_T                   	iris_301;                     //0xc8000bbcL
	IRIS_302_T                   	iris_302;                     //0xc8000bc0L
	IRIS_303_T                   	iris_303;                     //0xc8000bc4L
	IRIS_304_T                   	iris_304;                     //0xc8000bc8L
	IRIS_305_T                   	iris_305;                     //0xc8000bccL
	IRIS_306_T                   	iris_306;                     //0xc8000bd0L
	IRIS_307_T                   	iris_307;                     //0xc8000bd4L
	IRIS_308_T                   	iris_308;                     //0xc8000bd8L
	IRIS_309_T                   	iris_309;                     //0xc8000bdcL
	IRIS_310_T                   	iris_310;                     //0xc8000be0L
	IRIS_311_T                   	iris_311;                     //0xc8000be4L
	IRIS_312_T                   	iris_312;                     //0xc8000be8L
	IRIS_313_T                   	iris_313;                     //0xc8000becL
	IRIS_314_T                   	iris_314;                     //0xc8000bf0L
	IRIS_315_T                   	iris_315;                     //0xc8000bf4L
	IRIS_316_T                   	iris_316;                     //0xc8000bf8L
	IRIS_317_T                   	iris_317;                     //0xc8000bfcL
	IRIS_318_T                   	iris_318;                     //0xc8000c00L
	IRIS_319_T                   	iris_319;                     //0xc8000c04L
	IRIS_320_T                   	iris_320;                     //0xc8000c08L
	IRIS_321_T                   	iris_321;                     //0xc8000c0cL
	IRIS_322_T                   	iris_322;                     //0xc8000c10L
	IRIS_323_T                   	iris_323;                     //0xc8000c14L
	IRIS_324_T                   	iris_324;                     //0xc8000c18L
	IRIS_325_T                   	iris_325;                     //0xc8000c1cL
	IRIS_326_T                   	iris_326;                     //0xc8000c20L
	IRIS_327_T                   	iris_327;                     //0xc8000c24L
	IRIS_328_T                   	iris_328;                     //0xc8000c28L
	IRIS_329_T                   	iris_329;                     //0xc8000c2cL
	IRIS_330_T                   	iris_330;                     //0xc8000c30L
	IRIS_331_T                   	iris_331;                     //0xc8000c34L
	IRIS_332_T                   	iris_332;                     //0xc8000c38L
	IRIS_333_T                   	iris_333;                     //0xc8000c3cL
	IRIS_334_T                   	iris_334;                     //0xc8000c40L
	IRIS_335_T                   	iris_335;                     //0xc8000c44L
	IRIS_336_T                   	iris_336;                     //0xc8000c48L
	IRIS_337_T                   	iris_337;                     //0xc8000c4cL
	IRIS_338_T                   	iris_338;                     //0xc8000c50L
	IRIS_339_T                   	iris_339;                     //0xc8000c54L
	IRIS_340_T                   	iris_340;                     //0xc8000c58L
	IRIS_341_T                   	iris_341;                     //0xc8000c5cL
	IRIS_342_T                   	iris_342;                     //0xc8000c60L
	IRIS_343_T                   	iris_343;                     //0xc8000c64L
	IRIS_344_T                   	iris_344;                     //0xc8000c68L
	IRIS_345_T                   	iris_345;                     //0xc8000c6cL
	IRIS_346_T                   	iris_346;                     //0xc8000c70L
	IRIS_347_T                   	iris_347;                     //0xc8000c74L
	IRIS_348_T                   	iris_348;                     //0xc8000c78L
	IRIS_349_T                   	iris_349;                     //0xc8000c7cL
	IRIS_350_T                   	iris_350;                     //0xc8000c80L
	IRIS_351_T                   	iris_351;                     //0xc8000c84L
	IRIS_352_T                   	iris_352;                     //0xc8000c88L
	IRIS_353_T                   	iris_353;                     //0xc8000c8cL
	IRIS_354_T                   	iris_354;                     //0xc8000c90L
	IRIS_355_T                   	iris_355;                     //0xc8000c94L
	IRIS_356_T                   	iris_356;                     //0xc8000c98L
	IRIS_357_T                   	iris_357;                     //0xc8000c9cL
	IRIS_358_T                   	iris_358;                     //0xc8000ca0L
	IRIS_359_T                   	iris_359;                     //0xc8000ca4L
	IRIS_360_T                   	iris_360;                     //0xc8000ca8L
	IRIS_361_T                   	iris_361;                     //0xc8000cacL
	IRIS_362_T                   	iris_362;                     //0xc8000cb0L
	IRIS_363_T                   	iris_363;                     //0xc8000cb4L
	IRIS_364_T                   	iris_364;                     //0xc8000cb8L
	IRIS_365_T                   	iris_365;                     //0xc8000cbcL
	IRIS_366_T                   	iris_366;                     //0xc8000cc0L
	IRIS_367_T                   	iris_367;                     //0xc8000cc4L
	IRIS_368_T                   	iris_368;                     //0xc8000cc8L
	IRIS_369_T                   	iris_369;                     //0xc8000cccL
	IRIS_370_T                   	iris_370;                     //0xc8000cd0L
	IRIS_371_T                   	iris_371;                     //0xc8000cd4L
	IRIS_372_T                   	iris_372;                     //0xc8000cd8L
	IRIS_373_T                   	iris_373;                     //0xc8000cdcL
	IRIS_374_T                   	iris_374;                     //0xc8000ce0L
	IRIS_375_T                   	iris_375;                     //0xc8000ce4L
	UINT32                             	reserved05[6];                //0xc8000ce8L~0xc8000cfcL
	VBI_001_T                    	vbi_001;                      //0xc8000d00L
	VBI_002_T                    	vbi_002;                      //0xc8000d04L
	VBI_003_T                    	vbi_003;                      //0xc8000d08L
	VBI_004_T                    	vbi_004;                      //0xc8000d0cL
	VBI_005_T                    	vbi_005;                      //0xc8000d10L
	VBI_006_T                    	vbi_006;                      //0xc8000d14L
	VBI_007_T                    	vbi_007;                      //0xc8000d18L
	VBI_008_T                    	vbi_008;                      //0xc8000d1cL
	VBI_009_T                    	vbi_009;                      //0xc8000d20L
	VBI_010_T                    	vbi_010;                      //0xc8000d24L
	VBI_011_T                    	vbi_011;                      //0xc8000d28L
	VBI_012_T                    	vbi_012;                      //0xc8000d2cL
	VBI_013_T                    	vbi_013;                      //0xc8000d30L
	VBI_014_T                    	vbi_014;                      //0xc8000d34L
	VBI_015_T                    	vbi_015;                      //0xc8000d38L
	VBI_016_T                    	vbi_016;                      //0xc8000d3cL
	VBI_017_T                    	vbi_017;                      //0xc8000d40L
	VBI_018_T                    	vbi_018;                      //0xc8000d44L
	VBI_019_T                    	vbi_019;                      //0xc8000d48L
	VBI_020_T                    	vbi_020;                      //0xc8000d4cL
	VBI_021_T                    	vbi_021;                      //0xc8000d50L
	VBI_022_T                    	vbi_022;                      //0xc8000d54L
	VBI_023_T                    	vbi_023;                      //0xc8000d58L
	VBI_024_T                    	vbi_024;                      //0xc8000d5cL
	VBI_025_T                    	vbi_025;                      //0xc8000d60L
	VBI_026_T                    	vbi_026;                      //0xc8000d64L
	VBI_027_T                    	vbi_027;                      //0xc8000d68L
	VBI_028_T                    	vbi_028;                      //0xc8000d6cL
	VBI_029_T                    	vbi_029;                      //0xc8000d70L
	VBI_030_T                    	vbi_030;                      //0xc8000d74L
	VBI_031_T                    	vbi_031;                      //0xc8000d78L
	VBI_032_T                    	vbi_032;                      //0xc8000d7cL
	VBI_033_T                    	vbi_033;                      //0xc8000d80L
	VBI_034_T                    	vbi_034;                      //0xc8000d84L
	VBI_035_T                    	vbi_035;                      //0xc8000d88L
	VBI_036_T                    	vbi_036;                      //0xc8000d8cL
	VBI_037_T                    	vbi_037;                      //0xc8000d90L
	VBI_038_T                    	vbi_038;                      //0xc8000d94L
	VBI_039_T                    	vbi_039;                      //0xc8000d98L
	VBI_040_T                    	vbi_040;                      //0xc8000d9cL
	VBI_041_T                    	vbi_041;                      //0xc8000da0L
	VBI_042_T                    	vbi_042;                      //0xc8000da4L
	VBI_043_T                    	vbi_043;                      //0xc8000da8L
	VBI_044_T                    	vbi_044;                      //0xc8000dacL
	AGC_001_T                    	agc_001;                      //0xc8000db0L
	LVL_001_T                    	lvl_001;                      //0xc8000db4L
	LVL_002_T                    	lvl_002;                      //0xc8000db8L
	LVL_003_T                    	lvl_003;                      //0xc8000dbcL
	LVL_004_T                    	lvl_004;                      //0xc8000dc0L
	LVL_005_T                    	lvl_005;                      //0xc8000dc4L
	LVL_006_T                    	lvl_006;                      //0xc8000dc8L
	LVL_007_T                    	lvl_007;                      //0xc8000dccL
	LVL_008_T                    	lvl_008;                      //0xc8000dd0L
	LVL_009_T                    	lvl_009;                      //0xc8000dd4L
	LVL_010_T                    	lvl_010;                      //0xc8000dd8L
	LVL_011_T                    	lvl_011;                      //0xc8000ddcL
	LVL_012_T                    	lvl_012;                      //0xc8000de0L
	LVL_013_T                    	lvl_013;                      //0xc8000de4L
	LVL_014_T                    	lvl_014;                      //0xc8000de8L
	LVL_015_T                    	lvl_015;                      //0xc8000decL
	LVL_016_T                    	lvl_016;                      //0xc8000df0L
	LVL_017_T                    	lvl_017;                      //0xc8000df4L
	LVL_018_T                    	lvl_018;                      //0xc8000df8L
	LVL_019_T                    	lvl_019;                      //0xc8000dfcL
	LVL_020_T                    	lvl_020;                      //0xc8000e00L
	LVL_021_T                    	lvl_021;                      //0xc8000e04L
	IRIS_MIF_GMAU_MON_001_T      	iris_mif_gmau_mon_001;        //0xc8000e08L
	IRIS_MIF_GMAU_MON_002_T      	iris_mif_gmau_mon_002;        //0xc8000e0cL
	IRIS_MIF_GMAU_MON_003_T      	iris_mif_gmau_mon_003;        //0xc8000e10L
	IRIS_MIF_GMAU_MON_004_T      	iris_mif_gmau_mon_004;        //0xc8000e14L
	IRIS_MIF_GMAU_MON_005_T      	iris_mif_gmau_mon_005;        //0xc8000e18L
	IRIS_MIF_GMAU_MON_006_T      	iris_mif_gmau_mon_006;        //0xc8000e1cL
	IRIS_MIF_GMAU_MON_007_T      	iris_mif_gmau_mon_007;        //0xc8000e20L
	IRIS_MIF_GMAU_MON_008_T      	iris_mif_gmau_mon_008;        //0xc8000e24L
	IRIS_MIF_GMAU_MON_009_T      	iris_mif_gmau_mon_009;        //0xc8000e28L
	IRIS_MIF_GMAU_MON_010_T      	iris_mif_gmau_mon_010;        //0xc8000e2cL
	IRIS_MIF_GMAU_MON_011_T      	iris_mif_gmau_mon_011;        //0xc8000e30L
	IRIS_MIF_GMAU_MON_012_T      	iris_mif_gmau_mon_012;        //0xc8000e34L
	IRIS_MIF_GMAU_MON_013_T      	iris_mif_gmau_mon_013;        //0xc8000e38L
	IRIS_MIF_GMAU_MON_014_T      	iris_mif_gmau_mon_014;        //0xc8000e3cL
	IRIS_MIF_GMAU_MON_015_T      	iris_mif_gmau_mon_015;        //0xc8000e40L
	IRIS_MIF_GMAU_MON_016_T      	iris_mif_gmau_mon_016;        //0xc8000e44L
	IRIS_MIF_GMAU_MON_017_T      	iris_mif_gmau_mon_017;        //0xc8000e48L
	IRIS_MIF_GMAU_MON_018_T      	iris_mif_gmau_mon_018;        //0xc8000e4cL
	IRIS_MIF_GMAU_MON_019_T      	iris_mif_gmau_mon_019;        //0xc8000e50L
	IRIS_MIF_GMAU_MON_020_T      	iris_mif_gmau_mon_020;        //0xc8000e54L
	IRIS_HIF_CTRL0_001_T         	iris_hif_ctrl0_001;           //0xc8000e58L
	IRIS_HIF_CTRL1_001_T         	iris_hif_ctrl1_001;           //0xc8000e5cL
	IRIS_MIF_VBI_MA_MON_00_001_T 	iris_mif_vbi_ma_mon_00_001;   //0xc8000e60L
	IRIS_MIF_VBI_MA_MON_01_001_T 	iris_mif_vbi_ma_mon_01_001;   //0xc8000e64L
	IRIS_MIF_VBI_MA_MON_02_001_T 	iris_mif_vbi_ma_mon_02_001;   //0xc8000e68L
	IRIS_MIF_VBI_MA_MON_03_001_T 	iris_mif_vbi_ma_mon_03_001;   //0xc8000e6cL
	IRIS_MIF_VBI_MA_MON_04_001_T 	iris_mif_vbi_ma_mon_04_001;   //0xc8000e70L
	IRIS_MIF_VBI_MA_MON_05_001_T 	iris_mif_vbi_ma_mon_05_001;   //0xc8000e74L
	IRIS_MIF_VBI_MA_MON_06_001_T 	iris_mif_vbi_ma_mon_06_001;   //0xc8000e78L
	IRIS_MIF_VBI_MA_MON_07_001_T 	iris_mif_vbi_ma_mon_07_001;   //0xc8000e7cL
	IRIS_MIF_VBI_MA_MON_08_001_T 	iris_mif_vbi_ma_mon_08_001;   //0xc8000e80L
	IRIS_GMAU_CMD_QOS_CTRL0_001_T	iris_gmau_cmd_qos_ctrl0_001;  //0xc8000e84L
	IRIS_GMAU_CMD_QOS_REF0_001_T 	iris_gmau_cmd_qos_ref0_001;   //0xc8000e88L
	IRIS_GMAU_MD_CMD_QOS_CTRL0_001_T	iris_gmau_md_cmd_qos_ctrl0_001;  //0xc8000e8cL
	IRIS_GMAU_MD_CMD_QOS_REF0_001_T 	iris_gmau_md_cmd_qos_ref0_001;   //0xc8000e90L
}DE_CVD_REG_T;

/*
 * @{
 * Naming for register pointer.
 * gpRealRegCVD : real register of VPORT_L9B0.
 * gpRegCVD     : shadow register.
 *
 * @def CVD_Reg_RdFL: Read  FLushing : Shadow <- Real.
 * @def CVD_Reg_WrFL: Write FLushing : Shadow -> Real.
 * @def CVD_Reg_Rd  : Read  whole register(UINT32) from Shadow register.
 * @def CVD_Reg_Wr  : Write whole register(UINT32) from Shadow register.
 * @def CVD_Reg_Rd01 ~ CVD_Reg_Rdnn: Read  given '01~nn' fields from Shadow register.
 * @def CVD_Reg_Wr01 ~ CVD_Reg_Wrnn: Write given '01~nn' fields to   Shadow register.
 * */
#define CVD_Reg_RdFL(_r)			((gpRegCVD->_r)=(gpRealRegCVD->_r))
#define CVD_Reg_WrFL(_r)			((gpRealRegCVD->_r)=(gpRegCVD->_r))

#define CVD_Reg_Rd(_r)			*((UINT32*)(&(gpRegCVD->_r)))
#define CVD_Reg_Wr(_r,_v)			((CVD_Reg_Rd(_r))=((UINT32)(_v)))

#define CVD_Reg_Rd01(_r,_f01,_v01)													\
								do { 											\
									(_v01) = (gpRegCVD->_r._f01);				\
								} while(0)

#define CVD_Reg_Rd02(_r,_f01,_v01,_f02,_v02)										\
								do { 											\
									(_v01) = (gpRegCVD->_r._f01);				\
									(_v02) = (gpRegCVD->_r._f02);				\
								} while(0)

#define CVD_Reg_Rd03(_r,_f01,_v01,_f02,_v02,_f03,_v03)								\
								do { 											\
									(_v01) = (gpRegCVD->_r._f01);				\
									(_v02) = (gpRegCVD->_r._f02);				\
									(_v03) = (gpRegCVD->_r._f03);				\
								} while(0)

#define CVD_Reg_Rd04(_r,_f01,_v01,_f02,_v02,_f03,_v03,_f04,_v04)					\
								do { 											\
									(_v01) = (gpRegCVD->_r._f01);				\
									(_v02) = (gpRegCVD->_r._f02);				\
									(_v03) = (gpRegCVD->_r._f03);				\
									(_v04) = (gpRegCVD->_r._f04);				\
								} while(0)

#define CVD_Reg_Rd05(_r,_f01,_v01,_f02,_v02,_f03,_v03,_f04,_v04,					\
					_f05,_v05)													\
								do { 											\
									(_v01) = (gpRegCVD->_r._f01);				\
									(_v02) = (gpRegCVD->_r._f02);				\
									(_v03) = (gpRegCVD->_r._f03);				\
									(_v04) = (gpRegCVD->_r._f04);				\
									(_v05) = (gpRegCVD->_r._f05);				\
								} while(0)

#define CVD_Reg_Rd06(_r,_f01,_v01,_f02,_v02,_f03,_v03,_f04,_v04,					\
					_f05,_v05,_f06,_v06)										\
								do { 											\
									(_v01) = (gpRegCVD->_r._f01);				\
									(_v02) = (gpRegCVD->_r._f02);				\
									...
									(_v04) = (gpRegCVD->_r._f04);				\
									(_v05) = (gpRegCVD->_r._f05);				\
									(_v06) = (gpRegCVD->_r._f06);				\
								} while(0)

#define CVD_Reg_Rd07(_r,_f01,_v01,_f02,_v02,_f03,_v03,_f04,_v04,					\
					_f05,_v05,_f06,_v06,_f07,_v07)								\
								do { 											\
									...
									(_v05) = (gpRegCVD->_r._f05);				\
									(_v06) = (gpRegCVD->_r._f06);				\
									(_v07) = (gpRegCVD->_r._f07);				\
								} while(0)

#define CVD_Reg_Rd08(_r,_f01,_v01,_f02,_v02,_f03,_v03,_f04,_v04,					\
					_f05,_v05,_f06,_v06,_f07,_v07,_f08,_v08)					\
								do { 											\
									...
									(_v06) = (gpRegCVD->_r._f06);				\
									(_v07) = (gpRegCVD->_r._f07);				\
									(_v08) = (gpRegCVD->_r._f08);				\
								} while(0)

#define CVD_Reg_Wr01(_r,_f01,_v01)													\
								do { 											\
									(gpRegCVD->_r._f01) = (_v01);				\
								} while(0)

#define CVD_Reg_Wr02(_r,_f01,_v01,_f02,_v02)										\
								do { 											\
									(gpRegCVD->_r._f01) = (_v01);				\
									(gpRegCVD->_r._f02) = (_v02);				\
								} while(0)

#define CVD_Reg_Wr03(_r,_f01,_v01,_f02,_v02,_f03,_v03)								\
								do { 											\
									(gpRegCVD->_r._f01) = (_v01);				\
									(gpRegCVD->_r._f02) = (_v02);				\
									(gpRegCVD->_r._f03) = (_v03);				\
								} while(0)

#define CVD_Reg_Wr04(_r,_f01,_v01,_f02,_v02,_f03,_v03,_f04,_v04)					\
								do { 											\
									(gpRegCVD->_r._f01) = (_v01);				\
									(gpRegCVD->_r._f02) = (_v02);				\
									(gpRegCVD->_r._f03) = (_v03);				\
									(gpRegCVD->_r._f04) = (_v04);				\
								} while(0)

#define CVD_Reg_Wr05(_r,_f01,_v01,_f02,_v02,_f03,_v03,_f04,_v04,					\
					_f05,_v05)													\
								do { 											\
									(gpRegCVD->_r._f01) = (_v01);				\
									(gpRegCVD->_r._f02) = (_v02);				\
									(gpRegCVD->_r._f03) = (_v03);				\
									(gpRegCVD->_r._f04) = (_v04);				\
									(gpRegCVD->_r._f05) = (_v05);				\
								} while(0)

#define CVD_Reg_Wr06(_r,_f01,_v01,_f02,_v02,_f03,_v03,_f04,_v04,					\
					_f05,_v05,_f06,_v06)										\
								do { 											\
									(gpRegCVD->_r._f01) = (_v01);				\
									(gpRegCVD->_r._f02) = (_v02);				\
									...
									(gpRegCVD->_r._f04) = (_v04);				\
									(gpRegCVD->_r._f05) = (_v05);				\
									(gpRegCVD->_r._f06) = (_v06);				\
								} while(0)

#define CVD_Reg_Wr07(_r,_f01,_v01,_f02,_v02,_f03,_v03,_f04,_v04,					\
					_f05,_v05,_f06,_v06,_f07,_v07)								\
								do { 											\
									(gpRegCVD->_r._f01) = (_v01);				\
									(gpRegCVD->_r._f02) = (_v02);				\
									...
									(gpRegCVD->_r._f05) = (_v05);				\
									(gpRegCVD->_r._f06) = (_v06);				\
									(gpRegCVD->_r._f07) = (_v07);				\
								} while(0)

#define CVD_Reg_Wr08(_r,_f01,_v01,_f02,_v02,_f03,_v03,_f04,_v04,					\
					_f05,_v05,_f06,_v06,_f07,_v07,_f08,_v08)					\
								do { 											\
									(gpRegCVD->_r._f01) = (_v01);				\
									(gpRegCVD->_r._f02) = (_v02);				\
 ...
 * _rwname: name of rw    bit field : shall be 0 after CVD_Reg_Wind(), 1 for CVD_Reg_Rind()
 * _iname : name of index bit field
 * _ival  : index value
 * _fname : field name
 * _fval  : field variable that field value shall be stored.
 *
 * CVD_Reg_Rind : General indexed register Read.(
 * CVD_Reg_Wind : General indexed register Read.
 *
 * CVD_Reg_Ridx : For 'index', 'rw', 'load' field name
 * CVD_Reg_Widx : For 'index', 'rw', 'load' field name and NO_LOAD.
 */
#define CVD_Reg_Rind(_r, _lname, _rwname, _iname, _ival, _fname, _fval)				\
							do {												\
								CVD_Reg_Wr03(_r,_lname,0,_rwname,1,_iname,_ival);	\
								CVD_Reg_WrFL(_r);									\
								CVD_Reg_RdFL(_r);									\
								CVD_Reg_Rd01(_r,_fname,_fval);						\
							} while (0)

#define CVD_Reg_Wind(_r, _lname, _rwname, _iname, _ival, _fname, _fval)				\
				CVD_Reg_Wr04(_r, _lname,0, _rwname,0, _iname,_ival, _fname,_fval)


#define CVD_Reg_Ridx(_r, _ival, _fname, _fval)	CVD_Reg_Rind(_r,load,rw,index,_ival,_fname,_fval)

#define CVD_Reg_Widx(_r, _ival, _fname, _fval)	CVD_Reg_Wind(_r,load,rw,index,_ival,_fname,_fval)
