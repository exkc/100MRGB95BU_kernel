...
#ifndef	_PE_HW_M17_H_
#define	_PE_HW_M17_H_
...
#undef PE_HW_M17_PROTECT_OVERLAP_SETTINGS
/* for pe hw bringup */
#undef PE_HW_M17_BRINGUP
/* for pe hw use f/w src apl */
#define PE_HW_M17_USE_FW_SRC_APL

/*----------------------------------------------------------------------------
	Macro Definitions
----------------------------------------------------------------------------*/
#define PE_HW_M17_CHK_MULTI_PATH_OUT(_x)		\
	((_x)>=LX_PE_OUT_TB && (_x)<=LX_PE_OUT_DUAL_FULL)

#define PE_HW_M17_CHK_MULTI_PATH_FMT(_x)		\
	((_x)==LX_PE_FMT_UHD)

#define PE_HW_M17_CHK_UHD_FMT_N_3D_CASE(_x)		\
...
#define PE_HW_M17_MEMCPY(dest, src, len)	\
	do {	\
		char *dp = (char *)dest;	\
