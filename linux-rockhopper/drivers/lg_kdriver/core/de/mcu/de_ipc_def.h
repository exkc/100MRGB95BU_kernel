 ...
 *---------------------------------------------------------------------------------------*/
#define DTVSOC_IPC_CPUMCU_SIZE		 0x100
#define VIDEO_IPC_BUFF_NUM			 100
#define VIDEO_MSG_STR_MAX			 2048

#define DTVSOC_IPC_FROM_CPU_SIZE     (DTVSOC_IPC_CPUMCU_SIZE/2)
#define DTVSOC_IPC_FROM_MCU_SIZE     (DTVSOC_IPC_CPUMCU_SIZE/2)
#define DTVSOC_IPC_FROM_VDEC_SIZE    (0x1E0)
#define DTVSOC_IPC_TOTAL_SIZE        (DTVSOC_IPC_CPUMCU_SIZE+DTVSOC_IPC_FROM_VDEC_SIZE)
...
#define	VIDEO_WDG_MCU1_INTERRUPT_ARM_BIT  30
...
#define	VIDEO_AMZ_INTERRUPT_ARM_BIT  23 // webcodec GPS write-done
#define	VIDEO_DHDR_INTERRUPT_ARM_BIT 22
#define	VIDEO_IPC_INTERRUPT_ARM_BIT  21
#define	VIDEO_CB_INTERRUPT_ARM_BIT   20
#define VIDEO_GPS_INTERRUPT_ARM_BIT  19
#define VIDEO_GPW_INTERRUPT_ARM_BIT  18
#define VIDEO_LED_INTERRUPT_ARM_BIT  17
#define VIDEO_CTOP_INTERRUPT_ARM_BIT 16 //mhlee, ctop ctrl by interrupt
#define VIDEO_LSB_INTERRUPT_ARM_BIT  VIDEO_CTOP_INTERRUPT_ARM_BIT
// #define	VIDEO_VDEC_INTERRUPT_ARM_BIT  0


#define	VIDEO_WDG_INTERRUPT_ARM_MASK (1 << VIDEO_WDG_INTERRUPT_ARM_BIT)
#define	VIDEO_WDG_MCU1_INTERRUPT_ARM_MASK (1 << VIDEO_WDG_MCU1_INTERRUPT_ARM_BIT)
...
#define	VIDEO_DHDR_INTERRUPT_ARM_MASK (1 << VIDEO_DHDR_INTERRUPT_ARM_BIT)
#define	VIDEO_DELAY_INTERRUPT_ARM_MASK (1 << VIDEO_CB_INTERRUPT_ARM_BIT)
#define	VIDEO_GPS_INTERRUPT_ARM_MASK (1 << VIDEO_GPS_INTERRUPT_ARM_BIT)
#define	VIDEO_GPW_INTERRUPT_ARM_MASK (1 << VIDEO_GPW_INTERRUPT_ARM_BIT)
#define	VIDEO_LED_INTERRUPT_ARM_MASK (1 << VIDEO_LED_INTERRUPT_ARM_BIT)
#define	VIDEO_CTOP_INTERRUPT_ARM_MASK (1 << VIDEO_CTOP_INTERRUPT_ARM_BIT) //mhlee, ctop ctrl by interrupt
#define	VIDEO_UNUSED_INTERRUPT_ARM_MASK ((1<<VIDEO_LSB_INTERRUPT_ARM_BIT)-1)
...
typedef enum {
	...
	DE_IPC_SET_SUSPEND                  /* 0x00000058 */, ///< set suspend
	DE_IPC_SET_FRAME_DELAY              /* 0x00000059 */, ///< set frame delay number
	DE_IPC_SET_SUB_MODE                 /* 0x0000005a */, ///< set the mode of sub window(PIP/PBP)
	DE_IPC_SET_SUB_SHAPE                /* 0x0000005b */, ///< set the shape of sub window
	DE_IPC_SET_SIGNAGE_MODE             /* 0x0000005c */, ///<set signage mode
	DE_IPC_SET_HDMITX_OUT_INFO          /* 0x0000005d */, ///<set hdmi-tx
	DE_IPC_SET_GCP_MODE                 /* 0x0000005e */, ///<set General Capture Path
	DE_IPC_SET_SOURCE_SIZE_INFO         /* 0x0000005f */, ///<set info of source size & input window
	DE_IPC_SET_DUAL_MODE_ENABLE         /* 0x00000060 */, ///<set 4k dual mode for netflix
	DE_IPC_SET_HDR_MODE                 /* 0x00000061 */, ///<set HDR Mode
	DE_IPC_SET_LOW_DELAY_BY_SRC         /* 0x00000062 */, ///<set new low delay mode by source sync
	DE_IPC_SET_HIGH_FRAME_RATE          /* 0x00000063 */, ///<set high frame rate mode (4k 120Hz)
	DE_IPC_SET_ROTATE                   /* 0x00000064 */, ///<set rotate info from platform
	DE_IPC_SET_PATTERN                  /* 0x00000065 */, ///<set pattern control
	DE_IPC_SET_FPP_INFO                 /* 0x00000066 */, ///<set fpp info mode for smart local dimming
	DE_IPC_SET_VTG                      /* 0x00000067 */, ///<set new vtg (small cmd)
	DE_IPC_SET_WIN_INFO                 /* 0x00000068 */, ///<set rotate, source size, input window, output window
	DE_IPC_GET_WIN_INFO                 /* 0x00000069 */, ///<get rotate, source size, input window, output window
	DE_IPC_SET_DFT_MODE                 /* 0x0000006a */, ///<set dft mode (SICDTV-5471)
	DE_IPC_SET_NETWORK_SYNC             /* 0x0000006b */, ///<set syncronous frame control with network time	
	DE_IPC_SET_VTV_POSITION             /* 0x0000006c */, ///<set position of vtv input buffer
	DE_IPC_SET_GPS                      /* 0x0000006d */, ///<set GP-Scaler control
	DE_IPC_SET_ORBIT                    /* 0x0000006e */, ///<set orbit control
	DE_IPC_SET_PD_MODE                  /*0x0000006f */, ///<enable/disable precision detail mode
	DE_IPC_SET_GPS_DMA                  /*0x00000070 */, ///<enable/disable gps dma
	DE_IPC_SET_VTG_EXT_BUF              /*0x00000071 */, ///< external buffer info
	DE_IPC_SET_PIXELTOPIXEL             /*0x00000072*/, ///< pixel to pixel (no scale)
...
//#endif
	...
	PQL_IPC_SET_COLORIMETRY				/* 0x50000009 */, ///< set colorimetry
	...
	PQL_IPC_SET_APL_MODE                /* 0x50000019 */, ///< set apl mode
	PQL_IPC_SET_HDR_HALF                /* 0x5000001a */, ///< set hdr half mode
	PQL_IPC_LOAD_HDR_INFO               /* 0x5000001b */, ///< load hdr info
	PQL_IPC_SET_HDR_INFO                /* 0x5000001c */, ///< set hdr info
	PQL_IPC_SET_PIC_MODE                /* 0x5000001d */, ///< set picture mode
	PQL_IPC_GET_HDR_MODE                /* 0x5000001e */, ///< get hdr mode
	PQL_IPC_LOAD_SRINF_DB_DATA			/* 0x5000001f */, ///< load SR Inference(LGSR) DB data
	PQL_IPC_SET_DNNSR_MODE				/* 0x50000020 */, ///< load SR Inference(LGSR) Setting data [12] TRA STOP [8] consumer 8H On [4] SR-SQM En [0] SRINF En
	PQL_IPC_SET_SRSQM_POS				/* 0x50000021 */, ///< load SRSQM Patch crop position [31:16] posX, []15:0] posY
	PQL_IPC_SET_SRTRAVLD_RUN			/* 0x50000022 */, ///< load SRTRA TraRun / ValidRun [0:off, 1:traRun, 2:validRun]
	PQL_IPC_SET_PQ_STOREMODE			/* 0x50000023 */, ///< Store demo mode [16] OBC Demo mode [4] SR merge left/right [0] SR merge Demo mode
	PQL_IPC_LOAD_DB_DONE				/* 0x50000024 */, ///< load db done, [0]base(u32), [1]size(u32)
#endif
...
typedef enum {
	...
	VIDEO_GPW_CPU,
	VIDEO_LED_CPU,
	VIDEO_CTOP_CPU, //mhlee, ctop ctrl by interrupt
