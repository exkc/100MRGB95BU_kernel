#ifndef _PE_CCO_REG_M19A0_H_
#define _PE_CCO_REG_M19A0_H_
#ifndef UINT32
...
typedef struct
{
	...
	reg_is_oled                        : 1 ,  //    11
	motion_reg                         : 2 ,  // 13:12     motion sad
	reg_hdr_effect                     : 2 ,  // 15:14
	tnr_sc_measure_th                  : 16;  // 31:16
}PE_M19_CE_PE1_FSW_CTRL_01_T;
/*-----------------------------------------------------------------------------
...
}PE_M19_PE1_CEN_DELTA_IA_CTRL_T;
/*-----------------------------------------------------------------------------
...
}PE_M19_PE1_CEN_DELTA_IA_DATA_T;
/*-----------------------------------------------------------------------------
...
}PE_M19_PE1_DCE_HIST_IA_DATA1_T;
/*-----------------------------------------------------------------------------
...
}PE_M19_PE1_DCE_HIST_IA_DATA2_T;
/*-----------------------------------------------------------------------------
...
}PE_M19_PE1_LOGO_L7SC_CTRL_00_T;
/*-----------------------------------------------------------------------------
...
}PE_M19_PE1_LOGO_L7SC_CTRL_01_T;
/*-----------------------------------------------------------------------------
...
}PE_M19_PE1_LOGO_L7SC_CTRL_02_T;
/*-----------------------------------------------------------------------------
...
}PE_M19_PE1_LOGO_L7SC_CTRL_03_T;
/*-----------------------------------------------------------------------------
...
}PE_M19_PE1_LOGO_L7SC_CTRL_04_T;
/*-----------------------------------------------------------------------------
...
}PE_M19_PE1_LOGO_L7SC_CTRL_05_T;
/*-----------------------------------------------------------------------------
...
}PE_M19_PE1_LOGO_L7SC_CTRL_06_T;
/*-----------------------------------------------------------------------------
...
}PE_M19_PE1_LOGO_L7SC_CTRL_07_T;
/*-----------------------------------------------------------------------------
...
typedef struct
{
	...
	cb5                                :5 ,	//25:21
	yy6                                :6 ;	//31:26
}PE_M19_PE1_LOGO_L7SC_CTRL_08_T;
/*-----------------------------------------------------------------------------
...
typedef struct
{
	...
	reserved01                         :4 ,	//reserved
	win_w0_y0                          :12;	//27:16
}PE_M19_PE1_LOGO_L7SC_CTRL_09_T;
/*-----------------------------------------------------------------------------
...
typedef struct
{
	...
	reserved01                         :4 ,	//reserved
	win_w0_y1                          :12;	//27:16
}PE_M19_PE1_LOGO_L7SC_CTRL_10_T;
/*-----------------------------------------------------------------------------
...
}PE_M19_PE1_LOGO_L7SC_CTRL_11_T;
/*-----------------------------------------------------------------------------
...
}PE_M19_PE1_LOGO_L7SC_CTRL_12_T;
/*-----------------------------------------------------------------------------
...
}PE_M19_PE1_LOGO_L7SC_CTRL_13_T;
/*-----------------------------------------------------------------------------
...
typedef struct
{
	...
	disp_clk_cg_on                     :1 ,	// 30:30
	de_clk_cg_on                       :1 ;	// 31:31
}PE_M19_PE1_LOGO_L3SC_CTRL_00_T;
/*-----------------------------------------------------------------------------
...
typedef struct
{
	...
	reserved01                         :3 , // reserved
	reg_in_voffset                     :12;	// 27:16
}PE_M19_PE1_LOGO_L3SC_CTRL_01_T;
/*-----------------------------------------------------------------------------
...
typedef struct
{
	...
	reserved01                         :3 , // reserved
	reg_in_vactive                     :12;	// 27:16
}PE_M19_PE1_LOGO_L3SC_CTRL_02_T;
/*-----------------------------------------------------------------------------
...
typedef struct
{
	...
	reserved01                         :3 , // reserved
	reg_in_vsize                       :12;	// 27:16
}PE_M19_PE1_LOGO_L3SC_CTRL_03_T;
/*-----------------------------------------------------------------------------
...
typedef struct
{
	...
	reserved01                         :3 , // reserved
	reg_out_pic_height                 :12;	// 27:16
}PE_M19_PE1_LOGO_L3SC_CTRL_04_T;
/*-----------------------------------------------------------------------------
...
typedef struct
{
	...
	reserved02                         :17, // reserved
	reg_sampling_mode                  :1 ;	// 31
}PE_M19_PE1_LOGO_L3SC_CTRL_05_T;
/*-----------------------------------------------------------------------------
...
typedef struct
{
	...
	reserved01                         :3 , // reserved
	reg_numerator_v                    :12;	// 27:16
}PE_M19_PE1_LOGO_L3SC_CTRL_06_T;
/*-----------------------------------------------------------------------------
...
typedef struct
{
	...
	reserved01                         :3 , // reserved
	reg_denominator_v                  :12;	// 27:16
}PE_M19_PE1_LOGO_L3SC_CTRL_07_T;
/*-----------------------------------------------------------------------------
...
typedef struct
{
	...
	cb5                                :5 ,	// 25:21
	yy6                                :6 ;	// 31:26
}PE_M19_PE1_LOGO_L3SC_CTRL_08_T;
/*-----------------------------------------------------------------------------
...
typedef struct
{
	...
	reserved01                         :4 ,	// reserved
	win_w0_y0                          :12;	// 27:16
}PE_M19_PE1_LOGO_L3SC_CTRL_09_T;
/*-----------------------------------------------------------------------------
...
typedef struct
{
	...
	reserved01                         :4 ,	// reserved
	win_w0_y1                          :12;	// 27:16
}PE_M19_PE1_LOGO_L3SC_CTRL_10_T;
/*-----------------------------------------------------------------------------
...
typedef struct
{
	...
	reserved01                         :3 , // reserved
	reg_out_voffset                    :12;	// 27:16
}PE_M19_PE1_LOGO_L3SC_CTRL_11_T;
/*-----------------------------------------------------------------------------
...
typedef struct
{
	...
	reserved01                         :3 , // reserved
	reg_out_vactive                    :12;	// 27:16
}PE_M19_PE1_LOGO_L3SC_CTRL_12_T;
typedef struct
{ 
	PE_M19_PE1_TOP_CTRL_00_T                          pe1_top_ctrl_00;	//0x0000
	PE_M19_PE1_TOP_CTRL_01_T                          pe1_top_ctrl_01;	//0x0004
	PE_M19_PE1_TOP_CTRL_02_T                          pe1_top_ctrl_02;	//0x0008
	PE_M19_PE1_TOP_CTRL_03_T                          pe1_top_ctrl_03;	//0x000C
	PE_M19_PE1_TOP_CTRL_04_T                          pe1_top_ctrl_04;	//0x0010
	UINT32                                            reserved5[3];	//0x14-0x1c
	PE_M19_CE_PE1_FSW_CTRL_00_T                          pe1_fsw_ctrl_00;	//0x0020
	PE_M19_CE_PE1_FSW_CTRL_01_T                          pe1_fsw_ctrl_01;	//0x0024
	PE_M19_CE_PE1_FSW_CTRL_02_T                          pe1_fsw_ctrl_02;	//0x0028
	PE_M19_CE_PE1_FSW_CTRL_03_T                          pe1_fsw_ctrl_03;	//0x002C
	UINT32                                            reserved9;	//0x30
	PE_M19_PE1_WIN2_CTRL_00_T                         pe1_win2_ctrl_00;	//0x0034
	PE_M19_PE1_WIN2_CTRL_01_T                         pe1_win2_ctrl_01;	//0x0038
	PE_M19_PE1_WIN2_CTRL_02_T                         pe1_win2_ctrl_02;	//0x003C
	PE_M19_PE1_WIN2_CTRL_03_T                         pe1_win2_ctrl_03;	//0x0040
	PE_M19_PE1_WIN2_CTRL_04_T                         pe1_win2_ctrl_04;	//0x0044
	UINT32                                            reserved14[2];	//0x48-0x4c
	PE_M19_PE1_APL_CTRL_00_T                          pe1_apl_ctrl_00;	//0x0050
	PE_M19_PE1_APL_CTRL_01_T                          pe1_apl_ctrl_01;	//0x0054
	PE_M19_PE1_APL_CTRL_02_T                          pe1_apl_ctrl_02;	//0x0058
	PE_M19_PE1_APL_STAT_00_T                          pe1_apl_stat_00;	//0x005C
	PE_M19_PE1_APL_STAT_01_T                          pe1_apl_stat_01;	//0x0060
	UINT32                                            reserved19[3];	//0x64-0x6c
	PE_M19_PE1_TPG_CTRL_00_T                          pe1_tpg_ctrl_00;	//0x0070
	PE_M19_PE1_TPG_CTRL_01_T                          pe1_tpg_ctrl_01;	//0x0074
	PE_M19_PE1_TPG_CTRL_02_T                          pe1_tpg_ctrl_02;	//0x0078
	PE_M19_PE1_TPG_CTRL_03_T                          pe1_tpg_ctrl_03;	//0x007C
	PE_M19_PE1_TPG_CTRL_04_T                          pe1_tpg_ctrl_04;	//0x0080
	PE_M19_PE1_TPG_IA_CTRL_T                          pe1_tpg_ia_ctrl;	//0x0084
	PE_M19_PE1_TPG_IA_DATA_T                          pe1_tpg_ia_data;	//0x0088
	UINT32                                            reserved26;	//0x8c
	PE_M19_PE1_VSPYC_CTRL_00_T                        pe1_vspyc_ctrl_00;	//0x0090
	PE_M19_PE1_VSPYC_CTRL_01_T                        pe1_vspyc_ctrl_01;	//0x0094
	PE_M19_PE1_VSPYC_CTRL_02_T                        pe1_vspyc_ctrl_02;	//0x0098
	PE_M19_PE1_VSPYC_CTRL_03_T                        pe1_vspyc_ctrl_03;	//0x009C
	PE_M19_PE1_VSPYC_CTRL_04_T                        pe1_vspyc_ctrl_04;	//0x00A0
	PE_M19_PE1_VSPYC_CTRL_05_T                        pe1_vspyc_ctrl_05;	//0x00A4
	PE_M19_PE1_VSPYC_CTRL_06_T                        pe1_vspyc_ctrl_06;	//0x00A8
	PE_M19_PE1_VSPYC_CTRL_07_T                        pe1_vspyc_ctrl_07;	//0x00AC
	PE_M19_PE1_VSPYC_CTRL_08_T                        pe1_vspyc_ctrl_08;	//0x00B0
	PE_M19_PE1_VSPYC_CTRL_09_T                        pe1_vspyc_ctrl_09;	//0x00B4
	PE_M19_PE1_VSPYC_CTRL_10_T                        pe1_vspyc_ctrl_10;	//0x00B8
	PE_M19_PE1_VSPYC_CTRL_11_T                        pe1_vspyc_ctrl_11;	//0x00BC
	PE_M19_PE1_VSPYC_CTRL_12_T                        pe1_vspyc_ctrl_12;	//0x00C0
	PE_M19_PE1_VSPYC_CTRL_13_T                        pe1_vspyc_ctrl_13;	//0x00C4
	PE_M19_PE1_VSPYC_CTRL_14_T                        pe1_vspyc_ctrl_14;	//0x00C8
	PE_M19_PE1_VSPYC_CTRL_15_T                        pe1_vspyc_ctrl_15;	//0x00CC
	PE_M19_PE1_VSPYC_CTRL_16_T                        pe1_vspyc_ctrl_16;	//0x00D0
	PE_M19_PE1_VSPYC_CTRL_17_T                        pe1_vspyc_ctrl_17;	//0x00D4
	PE_M19_PE1_VSPYC_CTRL_18_T                        pe1_vspyc_ctrl_18;	//0x00D8
	UINT32                                            reserved45;	//0xdc
	PE_M19_PE1_CEN_CTRL_00_T                          pe1_cen_ctrl_00;	//0x00E0
	PE_M19_PE1_CEN_CTRL_01_T                          pe1_cen_ctrl_01;	//0x00E4
	PE_M19_PE1_CEN_CTRL_02_T                          pe1_cen_ctrl_02;	//0x00E8
	PE_M19_PE1_CEN_CTRL_03_T                          pe1_cen_ctrl_03;	//0x00EC
	PE_M19_PE1_CEN_CTRL_04_T                          pe1_cen_ctrl_04;	//0x00F0
	PE_M19_PE1_CEN_CTRL_05_T                          pe1_cen_ctrl_05;	//0x00F4
	PE_M19_PE1_CEN_CTRL_06_T                          pe1_cen_ctrl_06;	//0x00F8
	PE_M19_PE1_CEN_CTRL_07_T                          pe1_cen_ctrl_07;	//0x00FC
	UINT32                                            reserved53[4];	//0x100-0x10c
	PE_M19_PE1_CEN_IA_CTRL_T                          pe1_cen_ia_ctrl;	//0x0110
	PE_M19_PE1_CEN_IA_DATA_T                          pe1_cen_ia_data;	//0x0114
	PE_M19_PE1_CEN_DELTA_IA_CTRL_T                    pe1_cen_delta_ia_ctrl;	//0x0118
	PE_M19_PE1_CEN_DELTA_IA_DATA_T                    pe1_cen_delta_ia_data;	//0x011C
	PE_M19_PE1_DCE_CTRL_00_T                          pe1_dce_ctrl_00;	//0x0120
	PE_M19_PE1_DCE_CTRL_01_T                          pe1_dce_ctrl_01;	//0x0124
	PE_M19_PE1_DCE_CTRL_02_T                          pe1_dce_ctrl_02;	//0x0128
	PE_M19_PE1_DCE_CTRL_03_T                          pe1_dce_ctrl_03;	//0x012C
	PE_M19_PE1_DCE_CTRL_04_T                          pe1_dce_ctrl_04;	//0x0130
	PE_M19_PE1_DCE_CTRL_05_T                          pe1_dce_ctrl_05;	//0x0134
	PE_M19_PE1_DCE_IA_CTRL_T                          pe1_dce_ia_ctrl;	//0x0138
	PE_M19_PE1_DCE_IA_DATA_T                          pe1_dce_ia_data;	//0x013C
	PE_M19_PE1_DCE_CTRL_08_T                          pe1_dce_ctrl_08;	//0x0140
	PE_M19_PE1_DCE_CTRL_09_T                          pe1_dce_ctrl_09;	//0x0144
	PE_M19_PE1_DCE_HIST_IA_CTRL_T                     pe1_dce_hist_ia_ctrl;	//0x0148
	PE_M19_PE1_DCE_HIST_IA_DATA1_T                    pe1_dce_hist_ia_data1;	//0x014C
	PE_M19_PE1_DCE_HIST_IA_DATA2_T                    pe1_dce_hist_ia_data2;	//0x0150
	PE_M19_PE1_DCE_CHR_GAIN_T                         pe1_dce_chr_gain;	//0x0154
	PE_M19_PE1_DCE_CHR_ALPHA_T                        pe1_dce_chr_alpha;	//0x0158
	UINT32                                            reserved72;	//0x15c
	PE_M19_PE1_DSE_CTRL_00_T                          pe1_dse_ctrl_00;	//0x0160
	PE_M19_PE1_DSE_CTRL_01_T                          pe1_dse_ctrl_01;	//0x0164
	PE_M19_PE1_DSE_CTRL_02_T                          pe1_dse_ctrl_02;	//0x0168
	PE_M19_PE1_DSE_IA_CTRL_T                          pe1_dse_ia_ctrl;	//0x016C
	PE_M19_PE1_DSE_IA_DATA_T                          pe1_dse_ia_data;	//0x0170
	PE_M19_PE1_DSE_CTRL_03_T                          pe1_dse_ctrl_03;	//0x0174
	PE_M19_PE1_DSE_CTRL_04_T                          pe1_dse_ctrl_04;	//0x0178
	UINT32                                            reserved79;	//0x17c
	PE_M19_PE1_CW_CTRL_00_T                           pe1_cw_ctrl_00;	//0x0180
	PE_M19_PE1_CW_CTRL_01_T                           pe1_cw_ctrl_01;	//0x0184
	UINT32                                            reserved81[2];	//0x188-0x18c
	PE_M19_PE1_CW_CTRL_04_T                           pe1_cw_ctrl_04;	//0x0190
	PE_M19_PE1_LBLUR_CTRL_00_T                        pe1_lblur_ctrl_00;	//0x0194
	PE_M19_PE1_LBLUR_CTRL_01_T                        pe1_lblur_ctrl_01;	//0x0198
	PE_M19_PE1_LBLUR_CTRL_02_T                        pe1_lblur_ctrl_02;	//0x019C
	PE_M19_PE1_CONV_CTRL_00_T                         pe1_conv_ctrl_00;	//0x01A0
	PE_M19_PE1_CONV_CTRL_01_T                         pe1_conv_ctrl_01;	//0x01A4
	PE_M19_PE1_CONV_CTRL_02_T                         pe1_conv_ctrl_02;	//0x01A8
	PE_M19_PE1_CONV_CTRL_03_T                         pe1_conv_ctrl_03;	//0x01AC
	PE_M19_PE1_CONV_CTRL_04_T                         pe1_conv_ctrl_04;	//0x01B0
	PE_M19_PE1_CONV_CTRL_05_T                         pe1_conv_ctrl_05;	//0x01B4
	PE_M19_PE1_CONV_CTRL_06_T                         pe1_conv_ctrl_06;	//0x01B8
	PE_M19_PE1_CONV_CTRL_07_T                         pe1_conv_ctrl_07;	//0x01BC
	PE_M19_PE1_CONV_CTRL_08_T                         pe1_conv_ctrl_08;	//0x01C0
	PE_M19_PE1_CONV_CTRL_09_T                         pe1_conv_ctrl_09;	//0x01C4
	PE_M19_PE1_CONV_CTRL_0A_T                         pe1_conv_ctrl_0a;	//0x01C8
	PE_M19_PE1_CONV_CTRL_0B_T                         pe1_conv_ctrl_0b;	//0x01CC
	PE_M19_PE1_CONV_CTRL_0C_T                         pe1_conv_ctrl_0c;	//0x01D0
	PE_M19_PE1_CONV_CTRL_0D_T                         pe1_conv_ctrl_0d;	//0x01D4
	PE_M19_PE1_CONV_CTRL_0E_T                         pe1_conv_ctrl_0e;	//0x01D8
	PE_M19_PE1_CONV_CTRL_0F_T                         pe1_conv_ctrl_0f;	//0x01DC
	PE_M19_PE1_CONV_CTRL_10_T                         pe1_conv_ctrl_10;	//0x01E0
	PE_M19_PE1_CONV_CTRL_11_T                         pe1_conv_ctrl_11;	//0x01E4
	PE_M19_PE1_CONV_CTRL_12_T                         pe1_conv_ctrl_12;	//0x01E8
	UINT32                                            reserved104;	//0x1ec
	PE_M19_PE1_MUTE_CTRL_00_T                         pe1_mute_ctrl_00;	//0x01F0
	PE_M19_PE1_MUTE_CTRL_01_T                         pe1_mute_ctrl_01;	//0x01F4
	PE_M19_PE1_MUTE_CTRL_02_T                         pe1_mute_ctrl_02;	//0x01F8
	PE_M19_PE1_MUTE_CTRL_03_T                         pe1_mute_ctrl_03;	//0x01FC
	PE_M19_PE1_MUTE_CTRL_04_T                         pe1_mute_ctrl_04;	//0x0200
	PE_M19_PE1_MUTE_CTRL_05_T                         pe1_mute_ctrl_05;	//0x0204
	PE_M19_PE1_MUTE_CTRL_06_T                         pe1_mute_ctrl_06;	//0x0208
	PE_M19_PE1_MUTE_CTRL_07_T                         pe1_mute_ctrl_07;	//0x020C
	PE_M19_PE1_MUTE_CTRL_08_T                         pe1_mute_ctrl_08;	//0x0210
	PE_M19_PE1_MUTE_CTRL_09_T                         pe1_mute_ctrl_09;	//0x0214
	PE_M19_PE1_MUTE_CTRL_0A_T                         pe1_mute_ctrl_0a;	//0x0218
	PE_M19_PE1_MUTE_CTRL_0B_T                         pe1_mute_ctrl_0b;	//0x021C
	PE_M19_PE1_MUTE_CTRL_0C_T                         pe1_mute_ctrl_0c;	//0x0220
	PE_M19_PE1_MUTE_CTRL_0D_T                         pe1_mute_ctrl_0d;	//0x0224
	PE_M19_PE1_MUTE_CTRL_0E_T                         pe1_mute_ctrl_0e;	//0x0228
	PE_M19_PE1_MUTE_CTRL_0F_T                         pe1_mute_ctrl_0f;	//0x022C
	PE_M19_PE_PCC_CTRL_T                              pe_pcc_ctrl;	//0x0230
	PE_M19_PE1_PCC_COEF0_T                            pe1_pcc_coef0;	//0x0234
	PE_M19_PE1_PCC_COEF1_T                            pe1_pcc_coef1;	//0x0238
	PE_M19_PE1_PCC_COEF2_T                            pe1_pcc_coef2;	//0x023C
	PE_M19_PE1_PCC_COEF3_T                            pe1_pcc_coef3;	//0x0240
	PE_M19_PE1_PCC_COEF4_T                            pe1_pcc_coef4;	//0x0244
	PE_M19_PE1_PCC_COEF5_T                            pe1_pcc_coef5;	//0x0248
	PE_M19_PE1_PCC_COEF6_T                            pe1_pcc_coef6;	//0x024C
	PE_M19_PE1_PCC_COEF7_T                            pe1_pcc_coef7;	//0x0250
	PE_M19_PE1_OETF_IA_CTRL_T                         pe1_oetf_ia_ctrl;	//0x0254
	PE_M19_PE1_OETF_IA_DATA_T                         pe1_oetf_ia_data;	//0x0258
	PE_M19_PE1_EOTF_WDATA_T                           pe1_eotf_wdata;	//0x025C
	PE_M19_PE1_EOTF_WDONE_T                           pe1_eotf_wdone;	//0x0260
	PE_M19_PE1_EOTF_RDATA_T                           pe1_eotf_rdata;	//0x0264
	PE_M19_PE1_LOGO_L7SC_CTRL_00_T                    pe1_logo_l7sc_ctrl_00;	//0x0268
	PE_M19_PE1_LOGO_L7SC_CTRL_01_T                    pe1_logo_l7sc_ctrl_01;	//0x026C
	PE_M19_PE1_LOGO_L7SC_CTRL_02_T                    pe1_logo_l7sc_ctrl_02;	//0x0270
	PE_M19_PE1_LOGO_L7SC_CTRL_03_T                    pe1_logo_l7sc_ctrl_03;	//0x0274
	PE_M19_PE1_LOGO_L7SC_CTRL_04_T                    pe1_logo_l7sc_ctrl_04;	//0x0278
	PE_M19_PE1_LOGO_L7SC_CTRL_05_T                    pe1_logo_l7sc_ctrl_05;	//0x027C
	PE_M19_PE1_LOGO_L7SC_CTRL_06_T                    pe1_logo_l7sc_ctrl_06;	//0x0280
	PE_M19_PE1_LOGO_L7SC_CTRL_07_T                    pe1_logo_l7sc_ctrl_07;	//0x0284
	PE_M19_PE1_LOGO_L7SC_CTRL_08_T                    pe1_logo_l7sc_ctrl_08;	//0x0288
	PE_M19_PE1_LOGO_L7SC_CTRL_09_T                    pe1_logo_l7sc_ctrl_09;	//0x028C
	PE_M19_PE1_LOGO_L7SC_CTRL_10_T                    pe1_logo_l7sc_ctrl_10;	//0x0290
	PE_M19_PE1_LOGO_L7SC_CTRL_11_T                    pe1_logo_l7sc_ctrl_11;	//0x0294
	PE_M19_PE1_LOGO_L7SC_CTRL_12_T                    pe1_logo_l7sc_ctrl_12;	//0x0298
	PE_M19_PE1_LOGO_L7SC_CTRL_13_T                    pe1_logo_l7sc_ctrl_13;	//0x029C
	PE_M19_PE1_LRCR_CTRL_00_T                         pe1_lrcr_ctrl_00;	//0x02A0
	PE_M19_PE1_LRCR_CTRL_01_T                         pe1_lrcr_ctrl_01;	//0x02A4
	PE_M19_PE1_LRCR_CTRL_02_T                         pe1_lrcr_ctrl_02;	//0x02A8
	PE_M19_PE1_LRCR_CTRL_03_T                         pe1_lrcr_ctrl_03;	//0x02AC
	PE_M19_PE1_LRCR_CTRL_04_T                         pe1_lrcr_ctrl_04;	//0x02B0
	PE_M19_PE1_LRCR_CTRL_05_T                         pe1_lrcr_ctrl_05;	//0x02B4
	PE_M19_PE1_LRCR_CTRL_06_T                         pe1_lrcr_ctrl_06;	//0x02B8
	PE_M19_PE1_LRCR_CTRL_07_T                         pe1_lrcr_ctrl_07;	//0x02BC
	PE_M19_G_ADJ_GAIN_T                               g_adj_gain;	//0x02C0
	PE_M19_B_ADJ_GAIN_T                               b_adj_gain;	//0x02C4
	PE_M19_R_ADJ_GAIN_T                               r_adj_gain;	//0x02C8
	PE_M19_HIST_CTRL_MODE_T                           hist_ctrl_mode;	//0x02CC
	PE_M19_PE1_L_G_HIST_IA_CTRL_T                     pe1_l_g_hist_ia_ctrl;	//0x02D0
	PE_M19_PE1_L_G_HIST_IA_DATA_T                     pe1_l_g_hist_ia_data;	//0x02D4
	PE_M19_PE1_L_B_HIST_IA_CTRL_T                     pe1_l_b_hist_ia_ctrl;	//0x02D8
	PE_M19_PE1_L_B_HIST_IA_DATA_T                     pe1_l_b_hist_ia_data;	//0x02DC
	PE_M19_PE1_L_R_HIST_IA_CTRL_T                     pe1_l_r_hist_ia_ctrl;	//0x02E0
	PE_M19_PE1_L_R_HIST_IA_DATA_T                     pe1_l_r_hist_ia_data;	//0x02E4
	PE_M19_PE1_R_G_HIST_IA_CTRL_T                     pe1_r_g_hist_ia_ctrl;	//0x02E8
	PE_M19_PE1_R_G_HIST_IA_DATA_T                     pe1_r_g_hist_ia_data;	//0x02EC
	PE_M19_PE1_R_B_HIST_IA_CTRL_T                     pe1_r_b_hist_ia_ctrl;	//0x02F0
	PE_M19_PE1_R_B_HIST_IA_DATA_T                     pe1_r_b_hist_ia_data;	//0x02F4
	PE_M19_PE1_R_R_HIST_IA_CTRL_T                     pe1_r_r_hist_ia_ctrl;	//0x02F8
	PE_M19_PE1_R_R_HIST_IA_DATA_T                     pe1_r_r_hist_ia_data;	//0x02FC
	PE_M19_PE1_DEBUG_CTRL_00_T                        pe1_debug_ctrl_00;	//0x0300
	PE_M19_PE1_DEBUG_CTRL_01_T                        pe1_debug_ctrl_01;	//0x0304
	PE_M19_PE1_DEBUG_CTRL_02_T                        pe1_debug_ctrl_02;	//0x0308
	UINT32                                            reserved175;	//0x30c
	PE_M19_PE1_BT20_CTRL_00_T                         pe1_bt20_ctrl_00;	//0x0310
	PE_M19_PE1_BT20_CTRL_01_T                         pe1_bt20_ctrl_01;	//0x0314
	PE_M19_PE1_BT20_CTRL_02_T                         pe1_bt20_ctrl_02;	//0x0318
	PE_M19_PE1_BT20_CTRL_03_T                         pe1_bt20_ctrl_03;	//0x031C
	PE_M19_PE1_BT20_CTRL_04_T                         pe1_bt20_ctrl_04;	//0x0320
	PE_M19_PE1_BT20_CTRL_05_T                         pe1_bt20_ctrl_05;	//0x0324
	PE_M19_PE1_BT20_CTRL_06_T                         pe1_bt20_ctrl_06;	//0x0328
	PE_M19_PE1_BT20_CTRL_07_T                         pe1_bt20_ctrl_07;	//0x032C
	PE_M19_PE1_BT20_CTRL_08_T                         pe1_bt20_ctrl_08;	//0x0330
	PE_M19_PE1_BT20_CTRL_09_T                         pe1_bt20_ctrl_09;	//0x0334
	PE_M19_PE1_BT20_CTRL_0A_T                         pe1_bt20_ctrl_0a;	//0x0338
	PE_M19_PE1_BT20_CTRL_0B_T                         pe1_bt20_ctrl_0b;	//0x033C
	PE_M19_PE1_BT20_CTRL_0C_T                         pe1_bt20_ctrl_0c;	//0x0340
	PE_M19_PE1_BT20_CTRL_0D_T                         pe1_bt20_ctrl_0d;	//0x0344
	PE_M19_PE1_BT20_CTRL_0E_T                         pe1_bt20_ctrl_0e;	//0x0348
	PE_M19_PE1_BT20_CTRL_0F_T                         pe1_bt20_ctrl_0f;	//0x034C
	PE_M19_PE1_BT20_CTRL_10_T                         pe1_bt20_ctrl_10;	//0x0350
	PE_M19_PE1_BT20_CTRL_11_T                         pe1_bt20_ctrl_11;	//0x0354
	PE_M19_PE1_BT20_CTRL_12_T                         pe1_bt20_ctrl_12;	//0x0358
	PE_M19_PE1_BT20_CTRL_13_T                         pe1_bt20_ctrl_13;	//0x035C
	PE_M19_PE1_BT20_CTRL_14_T                         pe1_bt20_ctrl_14;	//0x0360
	PE_M19_PE1_BT20_CTRL_15_T                         pe1_bt20_ctrl_15;	//0x0364
	PE_M19_PE1_BT20_CTRL_STAT_T                       pe1_bt20_ctrl_stat;	//0x0368
	UINT32                                            reserved198;	//0x36c
	PE_M19_PE1_LOGO_CTRL_00_T                         pe1_logo_ctrl_00;	//0x0370
	PE_M19_PE1_LOGO_CTRL_01_T                         pe1_logo_ctrl_01;	//0x0374
	PE_M19_PE1_LOGO_CTRL_02_T                         pe1_logo_ctrl_02;	//0x0378
	PE_M19_PE1_LOGO_CTRL_03_T                         pe1_logo_ctrl_03;	//0x037C
	PE_M19_PE1_LOGO_CTRL_04_T                         pe1_logo_ctrl_04;	//0x0380
	PE_M19_PE1_LOGO_CTRL_05_T                         pe1_logo_ctrl_05;	//0x0384
	PE_M19_PE1_LOGO_CTRL_06_T                         pe1_logo_ctrl_06;	//0x0388
	PE_M19_PE1_LOGO_CTRL_07_T                         pe1_logo_ctrl_07;	//0x038C
	PE_M19_PE1_LOGO_CTRL_08_T                         pe1_logo_ctrl_08;	//0x0390
	PE_M19_PE1_LOGO_CTRL_09_T                         pe1_logo_ctrl_09;	//0x0394
	PE_M19_PE1_LOGO_CTRL_10_T                         pe1_logo_ctrl_10;	//0x0398
	PE_M19_PE1_LOGO_CTRL_11_T                         pe1_logo_ctrl_11;	//0x039C
	PE_M19_PE1_LOGO_CTRL_12_T                         pe1_logo_ctrl_12;	//0x03A0
	PE_M19_PE1_LOGO_CTRL_13_T                         pe1_logo_ctrl_13;	//0x03A4
	PE_M19_PE1_LOGO_CTRL_14_T                         pe1_logo_ctrl_14;	//0x03A8
	PE_M19_PE1_LOGO_CTRL_15_T                         pe1_logo_ctrl_15;	//0x03AC
	PE_M19_PE1_LOGO_CTRL_16_T                         pe1_logo_ctrl_16;	//0x03B0
	PE_M19_PE1_LOGO_CTRL_17_T                         pe1_logo_ctrl_17;	//0x03B4
	PE_M19_PE1_LOGO_CTRL_18_T                         pe1_logo_ctrl_18;	//0x03B8
	PE_M19_PE1_LOGO_CTRL_19_T                         pe1_logo_ctrl_19;	//0x03BC
	PE_M19_PE1_LOGO_CTRL_20_T                         pe1_logo_ctrl_20;	//0x03C0
	PE_M19_PE1_LOGO_CTRL_21_T                         pe1_logo_ctrl_21;	//0x03C4
	PE_M19_PE1_LOGO_CTRL_22_T                         pe1_logo_ctrl_22;	//0x03C8
	PE_M19_PE1_LOGO_CTRL_23_T                         pe1_logo_ctrl_23;	//0x03CC
	PE_M19_PE1_LOGO_CTRL_24_T                         pe1_logo_ctrl_24;	//0x03D0
	PE_M19_PE1_LOGO_CTRL_25_T                         pe1_logo_ctrl_25;	//0x03D4
	PE_M19_PE1_LOGO_CTRL_26_T                         pe1_logo_ctrl_26;	//0x03D8
	PE_M19_PE1_LOGO_CTRL_27_T                         pe1_logo_ctrl_27;	//0x03DC
	PE_M19_PE1_LOGO_CTRL_28_T                         pe1_logo_ctrl_28;	//0x03E0
	PE_M19_PE1_LOGO_CTRL_29_T                         pe1_logo_ctrl_29;	//0x03E4
	PE_M19_PE1_LOGO_CTRL_30_T                         pe1_logo_ctrl_30;	//0x03E8
	PE_M19_PE1_LOGO_CTRL_31_T                         pe1_logo_ctrl_31;	//0x03EC
	PE_M19_PE1_LOGO_CTRL_32_T                         pe1_logo_ctrl_32;	//0x03F0
	PE_M19_PE1_LOGO_CTRL_33_T                         pe1_logo_ctrl_33;	//0x03F4
	PE_M19_PE1_LOGO_CTRL_34_T                         pe1_logo_ctrl_34;	//0x03F8
	PE_M19_PE1_LOGO_CTRL_35_T                         pe1_logo_ctrl_35;	//0x03FC
	PE_M19_PE1_LOGO_CTRL_36_T                         pe1_logo_ctrl_36;	//0x0400
	PE_M19_PE1_LOGO_CTRL_37_T                         pe1_logo_ctrl_37;	//0x0404
	PE_M19_PE1_LOGO_CTRL_38_T                         pe1_logo_ctrl_38;	//0x0408
	PE_M19_PE1_LOGO_CTRL_39_T                         pe1_logo_ctrl_39;	//0x040C
	PE_M19_PE1_LOGO_CTRL_40_T                         pe1_logo_ctrl_40;	//0x0410
	PE_M19_PE1_LOGO_CTRL_41_T                         pe1_logo_ctrl_41;	//0x0414
	PE_M19_PE1_LOGO_CTRL_42_T                         pe1_logo_ctrl_42;	//0x0418
	PE_M19_PE1_LOGO_CTRL_43_T                         pe1_logo_ctrl_43;	//0x041C
	PE_M19_PE1_LOGO_STAT_00_T                         pe1_logo_stat_00;	//0x0420
	PE_M19_PE1_LOGO_STAT_01_T                         pe1_logo_stat_01;	//0x0424
	PE_M19_PE1_LOGO_CTRL_44_T                         pe1_logo_ctrl_44;	//0x0428
	UINT32                                            reserved245;	//0x42c
	PE_M19_PE_DSE_Y_REGION_PT0_T                      pe_dse_y_region_pt0;	//0x0430
	PE_M19_PE_DSE_Y_REGION_PT1_T                      pe_dse_y_region_pt1;	//0x0434
	PE_M19_PE_DSE_Y_REGION_PT2_T                      pe_dse_y_region_pt2;	//0x0438
	PE_M19_PE_DSE_Y_REGION_PT3_T                      pe_dse_y_region_pt3;	//0x043C
	PE_M19_PE_DSE_Y_REGION_PT4_T                      pe_dse_y_region_pt4;	//0x0440
	PE_M19_PE_DSE_Y_REGION_PT5_T                      pe_dse_y_region_pt5;	//0x0444
	PE_M19_PE_DSE_Y_REGION_PT6_T                      pe_dse_y_region_pt6;	//0x0448
	PE_M19_PE_DSE_Y_REGION_PT7_T                      pe_dse_y_region_pt7;	//0x044C
	PE_M19_PE_DSE_H_REGION_PT0_T                      pe_dse_h_region_pt0;	//0x0450
	PE_M19_PE_DSE_H_REGION_PT1_T                      pe_dse_h_region_pt1;	//0x0454
	PE_M19_PE_DSE_H_REGION_PT2_T                      pe_dse_h_region_pt2;	//0x0458
	PE_M19_PE_DSE_H_REGION_PT3_T                      pe_dse_h_region_pt3;	//0x045C
	PE_M19_PE_DSE_H_REGION_PT4_T                      pe_dse_h_region_pt4;	//0x0460
	PE_M19_PE_DSE_H_REGION_PT5_T                      pe_dse_h_region_pt5;	//0x0464
	PE_M19_PE_DSE_H_REGION_PT6_T                      pe_dse_h_region_pt6;	//0x0468
	PE_M19_PE_DSE_H_REGION_PT7_T                      pe_dse_h_region_pt7;	//0x046C
	PE_M19_PE1_DRC_CTRL_00_T                          pe1_drc_ctrl_00;	//0x0470
	PE_M19_PE1_DRC_CTRL_01_T                          pe1_drc_ctrl_01;	//0x0474
	PE_M19_PE1_DRC_CTRL_02_T                          pe1_drc_ctrl_02;	//0x0478
	PE_M19_PE1_DRC_CTRL_03_T                          pe1_drc_ctrl_03;	//0x047C
	PE_M19_PE1_DRC_CTRL_04_T                          pe1_drc_ctrl_04;	//0x0480
	PE_M19_PE1_DRC_CTRL_05_T                          pe1_drc_ctrl_05;	//0x0484
	PE_M19_PE1_DRC_CTRL_06_T                          pe1_drc_ctrl_06;	//0x0488
	PE_M19_PE1_DRC_CTRL_07_T                          pe1_drc_ctrl_07;	//0x048C
	PE_M19_PE1_DRC_CTRL_08_T                          pe1_drc_ctrl_08;	//0x0490
	PE_M19_PE1_DRC_CTRL_09_T                          pe1_drc_ctrl_09;	//0x0494
	PE_M19_PE1_DRC_CTRL_10_T                          pe1_drc_ctrl_10;	//0x0498
	PE_M19_PE1_DRC_CTRL_11_T                          pe1_drc_ctrl_11;	//0x049C
	PE_M19_PE1_DRC_CTRL_12_T                          pe1_drc_ctrl_12;	//0x04A0
	PE_M19_PE1_DRC_CTRL_13_T                          pe1_drc_ctrl_13;	//0x04A4
	PE_M19_PE1_DRC_CTRL_14_T                          pe1_drc_ctrl_14;	//0x04A8
	PE_M19_PE1_DRC_CTRL_15_T                          pe1_drc_ctrl_15;	//0x04AC
	PE_M19_PE1_DRC_CTRL_16_T                          pe1_drc_ctrl_16;	//0x04B0
	PE_M19_PE1_DRC_CTRL_17_T                          pe1_drc_ctrl_17;	//0x04B4
	PE_M19_PE1_DRC_CTRL_18_T                          pe1_drc_ctrl_18;	//0x04B8
	PE_M19_PE1_DRC_CTRL_19_T                          pe1_drc_ctrl_19;	//0x04BC
	PE_M19_PE1_DRC_CTRL_20_T                          pe1_drc_ctrl_20;	//0x04C0
	PE_M19_PE1_DRC_CTRL_21_T                          pe1_drc_ctrl_21;	//0x04C4
	PE_M19_PE1_DRC_CTRL_22_T                          pe1_drc_ctrl_22;	//0x04C8
	PE_M19_PE1_DRC_CTRL_23_T                          pe1_drc_ctrl_23;	//0x04CC
	PE_M19_PE1_DRC_CTRL_24_T                          pe1_drc_ctrl_24;	//0x04D0
	PE_M19_PE1_DRC_CTRL_25_T                          pe1_drc_ctrl_25;	//0x04D4
	PE_M19_PE1_DRC_CTRL_26_T                          pe1_drc_ctrl_26;	//0x04D8
	PE_M19_PE1_DRC_CTRL_27_T                          pe1_drc_ctrl_27;	//0x04DC
	PE_M19_PE1_DRC_CTRL_28_T                          pe1_drc_ctrl_28;	//0x04E0
	PE_M19_PE1_DRC_CTRL_29_T                          pe1_drc_ctrl_29;	//0x04E4
	PE_M19_PE1_DRC_CTRL_30_T                          pe1_drc_ctrl_30;	//0x04E8
	PE_M19_PE1_DRC_CTRL_31_T                          pe1_drc_ctrl_31;	//0x04EC
	PE_M19_PE1_DRC_CTRL_32_T                          pe1_drc_ctrl_32;	//0x04F0
	PE_M19_PE1_DRC_CTRL_33_T                          pe1_drc_ctrl_33;	//0x04F4
	PE_M19_PE1_DRC_CTRL_34_T                          pe1_drc_ctrl_34;	//0x04F8
	PE_M19_PE1_DRC_CTRL_35_T                          pe1_drc_ctrl_35;	//0x04FC
}PE_CE_PE1_REG_M19_T;
...
{ 
	...
	PE_M19_PE1_TOP_CTRL_04_T                          pe1_top_ctrl_04;	//0x0010
	UINT32                                            reserved5[3];	//0x14-0x1c
	PE_M19_CO_PE1_FSW_CTRL_00_T                          pe1_fsw_ctrl_00;	//0x0020
	PE_M19_CO_PE1_FSW_CTRL_01_T                          pe1_fsw_ctrl_01;	//0x0024
	PE_M19_CO_PE1_FSW_CTRL_02_T                          pe1_fsw_ctrl_02;	//0x0028
	PE_M19_CO_PE1_FSW_CTRL_03_T                          pe1_fsw_ctrl_03;	//0x002C
	UINT32                                            reserved9;	//0x30
	PE_M19_PE1_WIN2_CTRL_00_T                         pe1_win2_ctrl_00;	//0x0034
	PE_M19_PE1_WIN2_CTRL_01_T                         pe1_win2_ctrl_01;	//0x0038
	PE_M19_PE1_WIN2_CTRL_02_T                         pe1_win2_ctrl_02;	//0x003C
	...
	PE_M19_PE1_LOGO_L3SC_CTRL_00_T                    pe1_logo_l3sc_ctrl_00;	//0x0268
	PE_M19_PE1_LOGO_L3SC_CTRL_01_T                    pe1_logo_l3sc_ctrl_01;	//0x026C
	PE_M19_PE1_LOGO_L3SC_CTRL_02_T                    pe1_logo_l3sc_ctrl_02;	//0x0270
	PE_M19_PE1_LOGO_L3SC_CTRL_03_T                    pe1_logo_l3sc_ctrl_03;	//0x0274
	PE_M19_PE1_LOGO_L3SC_CTRL_04_T                    pe1_logo_l3sc_ctrl_04;	//0x0278
	PE_M19_PE1_LOGO_L3SC_CTRL_05_T                    pe1_logo_l3sc_ctrl_05;	//0x027C
	PE_M19_PE1_LOGO_L3SC_CTRL_06_T                    pe1_logo_l3sc_ctrl_06;	//0x0280
	PE_M19_PE1_LOGO_L3SC_CTRL_07_T                    pe1_logo_l3sc_ctrl_07;	//0x0284
	PE_M19_PE1_LOGO_L3SC_CTRL_08_T                    pe1_logo_l3sc_ctrl_08;	//0x0288
	PE_M19_PE1_LOGO_L3SC_CTRL_09_T                    pe1_logo_l3sc_ctrl_09;	//0x028C
	PE_M19_PE1_LOGO_L3SC_CTRL_10_T                    pe1_logo_l3sc_ctrl_10;	//0x0290
	PE_M19_PE1_LOGO_L3SC_CTRL_11_T                    pe1_logo_l3sc_ctrl_11;	//0x0294
	PE_M19_PE1_LOGO_L3SC_CTRL_12_T                    pe1_logo_l3sc_ctrl_12;	//0x0298
