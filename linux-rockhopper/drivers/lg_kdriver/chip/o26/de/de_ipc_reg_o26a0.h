...
#ifndef _IPC_REG_O26A0_H_
#define _IPC_REG_O26A0_H_
...
typedef union {
	...
	UINT32 flush_mcu1_rst_ctrl_status       :4;	//(15:12,RO,0x00) //Only Debug
	...
	UINT32 reset_bus_sel                    :1;	//(20,RW,0x00) //sub bus reset's source	0 : rst_bus_n	1 : S/W reset
	UINT32 reset_mcu1_sel                   :1;	//(21,RW,0x00) //mcu1 reset's source	0 : sw_reset	1 : only mcu1_reset
	UINT32 soft_reset_mcu1_without_fdone    :1;	//(22,RW,0x00) //MCU1 Software Reset without flush done	0 := disable	1  = Reset
	UINT32 resvd0                           :1;
	UINT32 mask_pslverr                     :4;	//(27:24,RW,0x00) //[27:24] port3,port2,port1,port0
	UINT32 soft_reset                       :1;	//(28,RW,0x00) //MCU Software Reset	0 := disable	1  = Reset
	UINT32 soft_reset_mcu1                  :1;	//(29,RW,0x00) //only MCU1 Software Reset	0 := disable	1  = Reset
	UINT32 resvd1                           :2;
	};
}O26A0_SET_REG_CTRL0_T;

typedef union {
	UINT32 udata32;
	struct {						//0xCC080004 RW 0x0000_0000
	UINT32 ipc_interrupt2_event_arm         :32;	//(31:0,RW,0x0000_0000) //IPC interrupt event for ARM
	};
}O26A0_EXT_INTR2_EVENT_T;
...
typedef union {
	...
	UINT32 dar_interrupt                    :1;	//27 //MCU dar interrupt event
	UINT32 ack_interrupt                    :1;	//28 //MCU ack interrupt event
	UINT32 reserved1						:1; //29 reserved
	UINT32 wdg_interrupt_event_mcu1         :1;	//(30,NA,0x00) //MCU1 watch dog interrupt event
	UINT32 wdg_interrupt_event              :1;	//(31,RW,0x00) //MCU watch dog interrupt event
	};
	struct {						//0xCC080008 RW 0x0000_0000
	UINT32 ipc_interrupt_event_arm          :30;//29:0
	};
}O26A0_EXT_INTR_EVENT_T;
...
typedef union {
	...
	UINT32 dar_interrupt                    :1;	//27 //MCU dar interrupt enable
	UINT32 ack_interrupt                    :1;	//28 //MCU ack interrupt enable
	UINT32 reserved1						:1; //29 reserved
	UINT32 wdg_interrupt_enable_mcu1        :1;	//(30,RW,0x00) //MCU1 watch dog interrupt enable
	UINT32 wdg_interrupt_enable             :1;	//(31,RW,0x00) //MCU watch dog interrupt enable
	};
	struct {						//0xCC08000C RW 0x0000_0000
	UINT32 ipc_interrupt_enable_arm          :30;//29:0
	};
}O26A0_EXT_INTR_ENABLE_T;
...
typedef union {
	...
	UINT32 dar_interrupt                    :1;	//27 //MCU dar interrupt status
...
typedef union {
	...
	UINT32 dar_interrupt                    :1;	//27 //MCU dar interrupt clear
	UINT32 ack_interrupt                    :1;	//28 //MCU ack interrupt clear
	UINT32 reserved1						:1; //29 reserved
	UINT32 wdg_interrupt_clear_mcu1         :1;	//30 //MCU1 watch dog interrupt enable
	UINT32 wdg_interrupt_clear              :1;	//(31,WO,0x00) //MCU watch dog interrupt enable - This register is auto cleared after set 1
	};
	struct {						//0xCC080014 WO 0x0000_0000
	UINT32 ipc_interrupt_clear_arm          :30;//29:0
	};
}O26A0_EXT_INTR_CLEAR_T;
...
typedef union {
	...
	struct {						//0xCC080020 RO 0x0000_0000
	UINT32 ipc_interrupt_status_mcu          :29;//28:0
	};
}O26A0_INT_INTR_STATUS_T;
...
typedef union {
	...
	UINT32 prid                             :16;	//(31:16,RW,0x00) //Processor ID
	};
}O26A0_AXI_USER_ID_T;
...
typedef union {
	UINT32 udata32;
	struct {						//0xCC08005C RO 0x2024_0701
	UINT32 mcu_version                      :32;	//(31:0,RO,0x2024_0701) //
	};
}O26A0_SPP_MCU_VERSION_T;
...
typedef union {
	...
	UINT32 lnx0_mcu_intr_mcu                :1;	//(17,RO,0x00) //
	UINT32 lnx1_mcu_intr_mcu                :1;	//(18,RO,0x00) //
	UINT32 gav_mcu_intr_mcu                 :1;	//(19,RO,0x00) //
	UINT32 dnsr_mcu_intr_mcu                :1;	//(20,RO,0x00) //
	UINT32 dnnr_mcu_intr_mcu                :1;	//(21,RO,0x00) //
	UINT32 vdo_mcu_intr_mcu                 :1;	//(22,RO,0x00) //
	UINT32 i2c_mcu_intr_mcu                 :1;	//(23,RO,0x00) //
	UINT32 gk_mcu_intr_mcu                  :1;	//(24,RO,0x00) //
	UINT32 mcu0_mcu_intr_mcu                :1;	//(25,RO,0x00) //
	UINT32 mcu1_mcu_intr_mcu                :1;	//(26,RO,0x00) //
	UINT32 npp_mcu_intr_mcu                 :1;	//(27,RO,0x00) //
	UINT32 reserved                         :4;	//(31:28,Rsvd,0x0) //
	};
}O26A0_INTR_MCU_FLAG_T;
...
typedef union {
	...
	UINT32 lnx0_mcu_intr_mcu_en             :1;	//(17,RW,0x00) //
	UINT32 lnx1_mcu_intr_mcu_en             :1;	//(18,RW,0x00) //
	UINT32 gav_mcu_intr_mcu_en              :1;	//(19,RW,0x00) //
	UINT32 dnsr_mcu_intr_mcu_en             :1;	//(20,RW,0x00) //
	UINT32 dnnr_mcu_intr_mcu_en             :1;	//(21,RW,0x00) //
	UINT32 vdo_mcu_intr_mcu_en              :1;	//(22,RW,0x00) //
	UINT32 i2c_mcu_intr_mcu_en              :1;	//(23,RW,0x00) //
	UINT32 gk_mcu_intr_mcu_en               :1;	//(24,RW,0x00) //
	UINT32 mcu0_mcu_intr_mcu_en             :1;	//(25,RW,0x00) //write 1하면 직접 interrupt 발생, clear 하기 위해 write 0
	UINT32 mcu1_mcu_intr_mcu_en             :1;	//(26,RW,0x00) //write 1하면 직접 interrupt 발생, clear 하기 위해 write 0
	UINT32 reserved                         :5;	//(31:27,Rsvd,0x0) //
	};
}O26A0_INTR_MCU_FLAG_EN_T;
...
typedef union {
	...
	UINT32 reserved0                        :2;	//(17,RO,0x00) //
	UINT32 gav_mcu_intr_cpu                 :1;	//(19,RO,0x00) //
	UINT32 dnsr_mcu_intr_cpu                :1;	//(20,RO,0x00) //
	UINT32 dnnr_mcu_intr_cpu                :1;	//(21,RO,0x00) //
	UINT32 vdo_mcu_intr_cpu                 :1;	//(22,RO,0x00) //
	UINT32 i2c_mcu_intr_cpu                 :1;	//(23,RO,0x00) //
	UINT32 gk_mcu_intr_cpu                  :1;	//(24,RO,0x00) //
	UINT32 reserved1                        :7;	//(31:25,Rsvd,0x0000_0000) //
	};
}O26A0_INTR_CPU_FLAG_T;
...
typedef union {
	...
	UINT32 reserved0                        :2;	//(17,RW,0x00) //
	UINT32 gav_mcu_intr_cpu_en              :1;	//(19,RW,0x00) //
	UINT32 dnsr_mcu_intr_cpu_en             :1;	//(20,RW,0x00) //
	UINT32 dnnr_mcu_intr_cpu_en             :1;	//(21,RW,0x00) //
	UINT32 vdo_mcu_intr_cpu_en              :1;	//(22,RW,0x00) //
	UINT32 i2c_mcu_intr_cpu_en              :1;	//(23,RW,0x00) //
	UINT32 gk_mcu_intr_cpu_en               :1;	//(24,RW,0x00) //
	UINT32 reserved1                        :7;	//(31:25,Rsvd,0x0) //
	};
}O26A0_INTR_CPU_FLAG_EN_T;

typedef union {
	UINT32 udata32;
	struct {						//0xCC080070 RW 0x0000_0000
	UINT32 ipc_interrupt2_enable_arm        :32;	//(31:0,RW,0x0000_0000) //IPC interrupt2 enable for ARM
	};
}O26A0_EXT_INTR2_ENABLE_T;

typedef union {
	UINT32 udata32;
	struct {						//0xCC080074 RO 0x0000_0000
	UINT32 ipc_interrupt2_status_arm        :32;	//(31:0,RO,0x0000_0000) //IPC interrupt2 enable for ARM
	};
}O26A0_EXT_INTR2_STATUS_T;

typedef union {
	UINT32 udata32;
	struct {						//0xCC080078 WO 0x0000_0000
	UINT32 ipc_interrupt2_clear_arm         :32;	//(31:0,WO,0x0000_0000) //IPC interrupt2 clear for ARM - This register is auto cleared after set 1
	};
}O26A0_EXT_INTR2_CLEAR_T;

typedef union {
	UINT32 udata32;
	struct {						//0xCC08007C RW 0x0000_0000
	UINT32 ipc_interrupt3_event_arm         :32;	//(31:0,RW,0x0000_0000) //IPC interrupt3 event for ARM
	};
}O26A0_EXT_INTR3_EVENT_T;

typedef union {
	UINT32 udata32;
	struct {						//0xCC080080 RW 0x0000_0000
	UINT32 ipc_interrupt3_enable_arm        :32;	//(31:0,RW,0x0000_0000) //IPC interrupt3 enable for ARM
	};
}O26A0_EXT_INTR3_ENABLE_T;

typedef union {
	UINT32 udata32;
	struct {						//0xCC080084 RO 0x0000_0000
	UINT32 ipc_interrupt3_status_arm        :32;	//(31:0,RO,0x0000_0000) //IPC interrupt3 enable for ARM
	};
}O26A0_EXT_INTR3_STATUS_T;

typedef union {
	UINT32 udata32;
	struct {						//0xCC080088 RW/RO 0x0000_0000
...
}O26A0_AD_APB_TOUT_CNT_T;

typedef union {
	UINT32 udata32;
	struct {						//0xCC080090 RO 0x0000_0000
	UINT32 apb_tout_ch0_address             :32;	//(31:0,RO,VNA) //read ma paddr
	};
}O26A0_APB_TOUT_CTRL_CH0_ADR_T;

typedef union {
	UINT32 udata32;
	struct {						//0xCC080094 RO 0x0000_0000
	UINT32 apb_tout_ch0_pwrite              :32;	//(31:0,RO,VNA) //read ma pwrite
	};
}O26A0_APB_TOUT_CTRL_CH0_PW_T;

typedef union {
	UINT32 udata32;
	struct {						//0xCC080098 RO 0x0000_0000
	UINT32 apb_tout_ch0_pwdata              :32;	//(31:0,RO,VNA) //read ma pwdata
	};
}O26A0_APB_TOUT_CTRL_CH0_PWDATA_T;

typedef union {
	UINT32 udata32;
	struct {						//0xCC08009C RO 0x0000_0000
	UINT32 apb_tout_ch1_address             :32;	//(31:0,RO,VNA) //read mb paddr
	};
}O26A0_APB_TOUT_CTRL_CH1_ADR_T;

typedef union {
	UINT32 udata32;
	struct {						//0xCC0800A0 RO 0x0000_0000
	UINT32 apb_tout_ch1_pwrite              :32;	//(31:0,RO,VNA) //read mb pwrite
	};
}O26A0_APB_TOUT_CTRL_CH1_PW_T;

typedef union {
	UINT32 udata32;
	struct {						//0xCC0800A4 RO 0x0000_0000
	UINT32 apb_tout_ch1_pwdata              :32;	//(31:0,RO,VNA) //read mb pwdata
	};
}O26A0_APB_TOUT_CTRL_CH1_PWDATA_T;

typedef union {
	UINT32 udata32;
	struct {						//0xCC0800A8 RO 0x0000_0000
	UINT32 apb_tout_ch2_address             :32;	//(31:0,RO,VNA) //read mc paddr
	};
}O26A0_APB_TOUT_CTRL_CH2_ADR_T;

typedef union {
	UINT32 udata32;
	struct {						//0xCC0800AC RO 0x0000_0000
	UINT32 apb_tout_ch2_pwrite              :32;	//(31:0,RO,VNA) //read mc pwrite
	};
}O26A0_APB_TOUT_CTRL_CH2_PW_T;

typedef union {
	UINT32 udata32;
	struct {						//0xCC0800B0 RO 0x0000_0000
	UINT32 apb_tout_ch2_pwdata              :32;	//(31:0,RO,VNA) //read mc pwdata
	};
}O26A0_APB_TOUT_CTRL_CH2_PWDATA_T;

typedef union {
	UINT32 udata32;
	struct {						//0xCC0800B4 RO 0x0000_0000
	UINT32 apb_tout_ch3_address             :32;	//(31:0,RO,VNA) //read md paddr
	};
}O26A0_APB_TOUT_CTRL_CH3_ADR_T;

typedef union {
	UINT32 udata32;
	struct {						//0xCC0800B8 RO 0x0000_0000
	UINT32 apb_tout_ch3_pwrite              :32;	//(31:0,RO,VNA) //read md pwrite
	};
}O26A0_APB_TOUT_CTRL_CH3_PW_T;

typedef union {
	UINT32 udata32;
	struct {						//0xCC0800BC RO 0x0000_0000
	UINT32 apb_tout_ch3_pwdata              :32;	//(31:0,RO,VNA) //read md pwdata
	};
}O26A0_APB_TOUT_CTRL_CH3_PWDATA_T;
...
}O26A0_AD_INTR_PRIORITY_T;

typedef union {
	UINT32 udata32;
	struct {						//0xCC0800D0 WO 0x0000_0000
	UINT32 ipc_interrupt3_clear_arm         :32;	//(31:0,WO,0x0000_0000) //IPC interrupt3 clear for ARM - This register is auto cleared after set 1
	};
}O26A0_EXT_INTR3_CLEAR_T;
...
}O26A0_SROM_BOOT_MAP4_T;

typedef struct {
	O26A0_SET_REG_CTRL0_T                               set_reg_ctrl0;	//0xCC080000
	O26A0_EXT_INTR2_EVENT_T                           ext_intr2_event;	//0xCC080004
	O26A0_EXT_INTR_EVENT_T                             ext_intr_event;	//0xCC080008
	O26A0_EXT_INTR_ENABLE_T                           ext_intr_enable;	//0xCC08000C
	O26A0_EXT_INTR_STATUS_T                           ext_intr_status;	//0xCC080010
	O26A0_EXT_INTR_CLEAR_T                             ext_intr_clear;	//0xCC080014
	O26A0_INT_INTR_EVENT_T                             int_intr_event;	//0xCC080018
	O26A0_INT_INTR_ENABLE_T                           int_intr_enable;	//0xCC08001C
	O26A0_INT_INTR_STATUS_T                           int_intr_status;	//0xCC080020
	O26A0_INT_INTR_CLEAR_T                             int_intr_clear;	//0xCC080024
	O26A0_SROM_BOOT_MAP1_T                             srom_boot_map1;	//0xCC080028
	O26A0_SROM_BOOT_MAP2_T                             srom_boot_map2;	//0xCC08002C
	O26A0_SRAM_PORT_SEL_T                               sram_port_sel;	//0xCC080030
	O26A0_PDEBUG_STATUS_T                               pdebug_status;	//0xCC080034
	O26A0_PDEBUG_DATA_T                                   pdebug_data;	//0xCC080038
	O26A0_PDEBUG_PC_T                                       pdebug_pc;	//0xCC08003C
	O26A0_AXI_USER_ID_T                                   axi_user_id;	//0xCC080040
	O26A0_SRAM0_OFFSET_T                                 sram0_offset;	//0xCC080044
	O26A0_SRAM1_OFFSET_T                                 sram1_offset;	//0xCC080048
	O26A0_SRAM2_OFFSET_T                                 sram2_offset;	//0xCC08004C
	O26A0_SRAM3_OFFSET_T                                 sram3_offset;	//0xCC080050
	O26A0_PDEBUG_DATA1_T                                 pdebug_data1;	//0xCC080054
	O26A0_PDEBUG_PC1_T                                     pdebug_pc1;	//0xCC080058
	O26A0_SPP_MCU_VERSION_T                           spp_mcu_version;	//0xCC08005C
	O26A0_INTR_MCU_FLAG_T                               intr_mcu_flag;	//0xCC080060
	O26A0_INTR_MCU_FLAG_EN_T                         intr_mcu_flag_en;	//0xCC080064
	O26A0_INTR_CPU_FLAG_T                               intr_cpu_flag;	//0xCC080068
	O26A0_INTR_CPU_FLAG_EN_T                         intr_cpu_flag_en;	//0xCC08006C
	O26A0_EXT_INTR2_ENABLE_T                         ext_intr2_enable;	//0xCC080070
	O26A0_EXT_INTR2_STATUS_T                         ext_intr2_status;	//0xCC080074
	O26A0_EXT_INTR2_CLEAR_T                           ext_intr2_clear;	//0xCC080078
	O26A0_EXT_INTR3_EVENT_T                           ext_intr3_event;	//0xCC08007C
	O26A0_EXT_INTR3_ENABLE_T                         ext_intr3_enable;	//0xCC080080
	O26A0_EXT_INTR3_STATUS_T                         ext_intr3_status;	//0xCC080084
	O26A0_AD_APB_TOUT_CTRL_T                         ad_apb_tout_ctrl;	//0xCC080088
	O26A0_AD_APB_TOUT_CNT_T                           ad_apb_tout_cnt;	//0xCC08008C
	O26A0_APB_TOUT_CTRL_CH0_ADR_T               apb_tout_ctrl_ch0_adr;	//0xCC080090
	O26A0_APB_TOUT_CTRL_CH0_PW_T                 apb_tout_ctrl_ch0_pw;	//0xCC080094
	O26A0_APB_TOUT_CTRL_CH0_PWDATA_T         apb_tout_ctrl_ch0_pwdata;	//0xCC080098
	O26A0_APB_TOUT_CTRL_CH1_ADR_T               apb_tout_ctrl_ch1_adr;	//0xCC08009C
	O26A0_APB_TOUT_CTRL_CH1_PW_T                 apb_tout_ctrl_ch1_pw;	//0xCC0800A0
	O26A0_APB_TOUT_CTRL_CH1_PWDATA_T         apb_tout_ctrl_ch1_pwdata;	//0xCC0800A4
	O26A0_APB_TOUT_CTRL_CH2_ADR_T               apb_tout_ctrl_ch2_adr;	//0xCC0800A8
	O26A0_APB_TOUT_CTRL_CH2_PW_T                 apb_tout_ctrl_ch2_pw;	//0xCC0800AC
	O26A0_APB_TOUT_CTRL_CH2_PWDATA_T         apb_tout_ctrl_ch2_pwdata;	//0xCC0800B0
	O26A0_APB_TOUT_CTRL_CH3_ADR_T               apb_tout_ctrl_ch3_adr;	//0xCC0800B4
	O26A0_APB_TOUT_CTRL_CH3_PW_T                 apb_tout_ctrl_ch3_pw;	//0xCC0800B8
	O26A0_APB_TOUT_CTRL_CH3_PWDATA_T         apb_tout_ctrl_ch3_pwdata;	//0xCC0800BC
	O26A0_AD_MASK_START_ADDR_T                     ad_mask_start_addr;	//0xCC0800C0
	O26A0_AD_MASK_END_ADDR_T                         ad_mask_end_addr;	//0xCC0800C4
	O26A0_AD_MASK_READ_ADDR_T                       ad_mask_read_addr;	//0xCC0800C8
	O26A0_AD_INTR_PRIORITY_T                         ad_intr_priority;	//0xCC0800CC
	O26A0_EXT_INTR3_CLEAR_T                           ext_intr3_clear;	//0xCC0800D0
	O26A0_RST_ASYNC_BRIDGE_T                         rst_async_bridge;	//0xCC0800D4
	O26A0_PFAULT_STATUS0_T                             pfault_status0;	//0xCC0800D8
	O26A0_PFAULT_STATUS1_T                             pfault_status1;	//0xCC0800DC
	O26A0_PFAULT_STATUS2_T                             pfault_status2;	//0xCC0800E0
	O26A0_SRAM4_OFFSET_T                                 sram4_offset;	//0xCC0800E4
	O26A0_SRAM5_OFFSET_T                                 sram5_offset;	//0xCC0800E8
	O26A0_INTR_MCU1_FLAG_T                             intr_mcu1_flag;	//0xCC0800EC
	O26A0_INTR_MCU1_FLAG_EN_T                       intr_mcu1_flag_en;	//0xCC0800F0
	O26A0_SROM_BOOT_MAP3_T                             srom_boot_map3;	//0xCC0800F4
	O26A0_SROM_BOOT_MAP4_T                             srom_boot_map4;	//0xCC0800F8
}DE_IPC_REG_O26A0_T;
...
typedef union {
	...
	UINT32 p_debug_enable1                  :1;	//(18,RW,0x00) //Trace output port enable	0 := disable	1  = enable
	UINT32 tmode_clkgate_override1          :1;	//(19,RW,0x00) //1: ClkGateDisable in test mode
	UINT32 reset_bus_sel                    :1;	//(20,RW,0x00) //sub bus reset 	0 : rst_bus_n	1 : apb reset
	UINT32 resvd1                           :3;
	UINT32 mask_pslverr                     :4;	//(27:24,RW,0x00) //[27:24] port3,port2,port1,port0
	UINT32 soft_reset                       :1;	//(28,RW,0x00) //MCU Software Reset	0 := disable	1  = Reset
	UINT32 resvd2                           :3;
...
typedef union {
	...
	UINT32 gav_mcu_intr_mcu_en              :1;	//(19,RW,0x00) //
	UINT32 dnsr_mcu_intr_mcu_en             :1;	//(20,RW,0x00) //
	UINT32 dnnr_mcu_intr_mcu_en             :1;	//(21,RO,0x00) //
...
typedef union {
	...
	UINT32 gk_mcu_intr_cpu_en               :1;	//(24,RO,0x00) //
	UINT32 reserved1                        :7;	//(31:25,Rsvd,0x0) //
	};
}O26A0_INTR_CPU_FLAG_EN_T;
...
typedef struct {
	O26A0_SET_REG_CTRL0_T                               set_reg_ctrl0;	//0xCC080000
	O26A0_SET_REG_CTRL1_T                               set_reg_ctrl1;	//0xCC080004
	O26A0_EXT_INTR_EVENT_T                             ext_intr_event;	//0xCC080008
	O26A0_EXT_INTR_ENABLE_T                           ext_intr_enable;	//0xCC08000C
	O26A0_EXT_INTR_STATUS_T                           ext_intr_status;	//0xCC080010
	O26A0_EXT_INTR_CLEAR_T                             ext_intr_clear;	//0xCC080014
	...
	O26A0_INTR_CPU_FLAG_T                               intr_cpu_flag;	//0xCC080068
	O26A0_INTR_CPU_FLAG_EN_T                         intr_cpu_flag_en;	//0xCC08006C
	O26A0_RESERVED00_T                                     reserved00;	//0xCC080070
	O26A0_RESERVED01_T                                     reserved01;	//0xCC080074
	O26A0_RESERVED02_T                                     reserved02;	//0xCC080078
	O26A0_RESERVED03_T                                     reserved03;	//0xCC08007C
	O26A0_RESERVED04_T                                     reserved04;	//0xCC080080
	O26A0_RESERVED05_T                                     reserved05;	//0xCC080084
	O26A0_AD_APB_TOUT_CTRL_T                         ad_apb_tout_ctrl;	//0xCC080088
	O26A0_AD_APB_TOUT_CNT_T                           ad_apb_tout_cnt;	//0xCC08008C
	O26A0_APB_TOUT_CTRL_CH0_ADR_T               apb_tout_ctrl_ch0_adr;	//0xCC080090
	O26A0_APB_TOUT_CTRL_CH0_PW_T                 apb_tout_ctrl_ch0_pw;	//0xCC080094
	...
	O26A0_AD_MASK_READ_ADDR_T                       ad_mask_read_addr;	//0xCC0800C8
	O26A0_AD_INTR_PRIORITY_T                         ad_intr_priority;	//0xCC0800CC
	O26A0_AD_UP_COUNTER_T                               ad_up_counter;	//0xCC0800D0
	O26A0_RST_ASYNC_BRIDGE_T                         rst_async_bridge;	//0xCC0800D4
	O26A0_PFAULT_STATUS0_T                             pfault_status0;	//0xCC0800D8
	O26A0_PFAULT_STATUS1_T                             pfault_status1;	//0xCC0800DC
	O26A0_PFAULT_STATUS2_T                             pfault_status2;	//0xCC0800E0
