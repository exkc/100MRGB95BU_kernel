...
------------------------------------------------------------------------------*/
#ifndef CHIP_TYPE_FPGA
#define EARC_LINK0_REG_BASE          0xC8D13900
#define EARC_LINK0_REG_SIZE          0x100

#define EARC_LINK_REG_BASE          0xC8D14000
#define EARC_LINK_REG_SIZE          0x1000

#define EARC_INT_REG_BASE           0xC8D15300
#define EARC_INT_REG_SIZE           0x1000

#define EARC_PHY_REG_BASE           0xC8D50000
...
int aud_hal_output_init (void)
{
    ...
    ret =
        request_irq (O24_IRQ_HDMIRX_PRT2_EARC_CPU, audio_hal_earc_irq, IRQF_TRIGGER_NONE,
        "eARC", NULL);
    if (ret < 0)
...
void aud_hal_output_exit (void)
{
    free_irq (O24_IRQ_HDMIRX_PRT2_EARC_CPU, NULL);
...
void aud_hal_output_set_number_of_i2s (int number)
{
    if (number >= 1)
    {
        CTOP_CTRL_O24Ax_RdFL (IOMUX_CTRL_LNX1, pad_lnx1_64);
        CTOP_CTRL_O24Ax_Wr01 (IOMUX_CTRL_LNX1, pad_lnx1_64, reg_pad_aec_lrch0_mux_sel, 0x0);
        CTOP_CTRL_O24Ax_WrFL (IOMUX_CTRL_LNX1, pad_lnx1_64);

        CTOP_CTRL_O24Ax_RdFL (IOMUX_CTRL_LNX1, pad_lnx1_64);
        CTOP_CTRL_O24Ax_Wr01 (IOMUX_CTRL_LNX1, pad_lnx1_64, reg_pad_daclrck_mux_sel, 0x2);
        CTOP_CTRL_O24Ax_Wr01 (IOMUX_CTRL_LNX1, pad_lnx1_64, reg_pad_dacsck_mux_sel, 0x2);
        CTOP_CTRL_O24Ax_Wr01 (IOMUX_CTRL_LNX1, pad_lnx1_64, reg_pad_daclrch_mux_sel, 0x2);
        CTOP_CTRL_O24Ax_WrFL (IOMUX_CTRL_LNX1, pad_lnx1_64);
    }

    if (number >= 2)
    {
        CTOP_CTRL_O24Ax_RdFL (IOMUX_CTRL_LNX1, pad_lnx1_65);
        CTOP_CTRL_O24Ax_Wr01 (IOMUX_CTRL_LNX1, pad_lnx1_65, reg_pad_dacslrch_mux_sel, 0x0);
        CTOP_CTRL_O24Ax_WrFL (IOMUX_CTRL_LNX1, pad_lnx1_65);
    }
    ...
    if (number >= 4)
    {
        // Center, LFE channels
        CTOP_CTRL_O24Ax_RdFL (IOMUX_CTRL_LNX1, pad_lnx1_64);
        CTOP_CTRL_O24Ax_Wr01 (IOMUX_CTRL_LNX1, pad_lnx1_64, reg_pad_dacclfch_mux_sel, 0x0);
        CTOP_CTRL_O24Ax_WrFL (IOMUX_CTRL_LNX1, pad_lnx1_64);

        // Rear Left, Rear Right channels
        CTOP_CTRL_O24Ax_RdFL (IOMUX_CTRL_LNX1, pad_lnx1_70);
        CTOP_CTRL_O24Ax_Wr01 (IOMUX_CTRL_LNX1, pad_lnx1_70, reg_pad_gpio25_mux_sel, 0x2);
        CTOP_CTRL_O24Ax_WrFL (IOMUX_CTRL_LNX1, pad_lnx1_70);
    }
#endif
    ...
    if (lx_board_opt () & LX_BOARD_OPT_SLT)
    {
        ...
        CTOP_CTRL_O24Ax_Wr01 (IOMUX_CTRL_LNX1, pad_lnx1_66, reg_pad_pcmi3lrck_mux_sel, 0x0);
        CTOP_CTRL_O24Ax_Wr01 (IOMUX_CTRL_LNX1, pad_lnx1_66, reg_pad_pcmi3lrch_mux_sel, 0x0);
        CTOP_CTRL_O24Ax_WrFL (IOMUX_CTRL_LNX1, pad_lnx1_66);

        CTOP_CTRL_O24Ax_RdFL (IOMUX_CTRL_LNX1, pad_lnx1_67);
        CTOP_CTRL_O24Ax_Wr01 (IOMUX_CTRL_LNX1, pad_lnx1_67, reg_pad_pcmi3sck_mux_sel, 0x0);
...
static void audio_hal_earc_monitor_lock (void)
{
    ...
    do
    {
        ...
        CTOP_CTRL_O24Ax_Rd01 (TRG_CTRL, earcpll_frpll_02, reg_earcpll_frpll_lock, frpll_lock);
        earc_phy_lock = EARC_PHY_RD (0x05C);
        earc_phy_lock &= 0x10;
        if (frpll_lock && !(earc_phy_lock & 0x10))
        {
            EARC_PHY_WR (0x054, 0x12);  // BPCLOCK_EN low
            usleep_range (200, 200);
            EARC_PHY_WR (0x054, 0x11);  // BPCLOCK_EN link control
        }
        else
        {
...
{
    EARC_PHY_WR (0x05C, 0x01);  // MONITOR_DMAC_BIPHASE_CLK_UP USER_DMAC_DRV_EN_FORCE : 1 : controlled by phy
...
void audio_hal_earc_set_on (bool on)
{
    if (on == ON)
    {
        ...
        EARC_PHY_WR (0x04C, 0x10);      // USER_DMAC_FEM_CLK_SEL
        ...
        EARC_PHY_WR (0x054, 0x11);      // DMAC_BIPHASE_CLK_EN 0x11 : enable
...
static void audio_hal_earc_set_es_mode (unsigned int sampling_freq)
{
    ...
    EARC_PHY_WR (0x054, 0x12);  // DMAC_BIPHASE_CLK_EN 0x12 : disable
    EARC_PHY_WR (0x054, 0x11);  // DMAC_BIPHASE_CLK_EN 0x11 : enable
...
void audio_hal_speaker_start (bool on)
{
    if (on == false)
    {
        //SPK I2S enable
        CTOP_CTRL_O24Ax_RdFL (IOMUX_CTRL_LNX1, pad_lnx1_64);
        CTOP_CTRL_O24Ax_Wr01 (IOMUX_CTRL_LNX1, pad_lnx1_64, reg_pad_daclrck_mux_sel, 0x1);
        CTOP_CTRL_O24Ax_Wr01 (IOMUX_CTRL_LNX1, pad_lnx1_64, reg_pad_dacsck_mux_sel, 0x1);
        CTOP_CTRL_O24Ax_Wr01 (IOMUX_CTRL_LNX1, pad_lnx1_64, reg_pad_daclrch_mux_sel, 0x1);
        CTOP_CTRL_O24Ax_WrFL (IOMUX_CTRL_LNX1, pad_lnx1_64);
