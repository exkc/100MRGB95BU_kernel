...
/** @file pe_cti_dnr_hw_param_m23.h
 *
...
#ifndef	_PE_CTI_DNR_HW_PARAM_M23_H_
#define	_PE_CTI_DNR_HW_PARAM_M23_H_
...
}PE_M23F22_SHP_CTI_CTRL_02_T;
#endif

typedef struct {
#ifndef PE_HW_M23_BRINGUP
	PE_M23_CTI_CTRL_0_T                 cti_ctrl_0;	//0xC900E58C
	PE_M23_CTI_CTRL_1_T                 cti_ctrl_1;	//0xC900E590
	PE_M23_REG_CTI_CTRL_2_T             reg_cti_ctrl_2;	//0x03BC
	PE_M23_REG_CTI_CTRL_3_T             reg_cti_ctrl_3;	//0x03C0
	PE_M23_SHP_CTI_CTRL_00_T            shp_cti_ctrl_00;	//0x0550
	PE_M23_SHP_CTI_CTRL_01_T            shp_cti_ctrl_01;	//0x0554
	PE_M23_SHP_CTI_CTRL_02_T            shp_cti_ctrl_02;	//0x0558
#endif
}PE_CTI_HW_PARAM_REG_M23_T;
...
typedef struct {
	union {
		UINT32			*addr;
		PE_CTI_HW_PARAM_REG_M23_T *data;
	} reg_dflt;
...
#endif /* _PE_CTI_DNR_HW_PARAM_M23_H_ */
