...
**
**  Functions
**  Implemented:   int	DEMOD_M23_ResetHW
**                  int DEMOD_M23_SetI2C
**                  int DEMOD_M23_SetInclk
**                  int DEMOD_M23_AdcInit
**                  int DEMOD_M23_RepeaterEnable
**                  int DEMOD_M23_SoftwareReset
**                  int DEMOD_M23_Power_Save
**                  int DEMOD_M23_StdOperModeContrl
**                  int DEMOD_M23_NeverlockScan
**                  int DEMOD_M23_TPOutEnable
**                  int DEMOD_M23_Set_IF_Frq
**                  int DEMOD_M23_Set_AGCPolarity
**                  int DEMOD_M23_Get_Id
**                  int DEMOD_M23_Get_SpectrumStatus
**                  int DEMOD_M23_Get_IFAGC
**                  int DEMOD_M23_Get_OperMode
**                  int DEMOD_M23_Get_NeverLockStatus
**                  int DEMOD_M23_Get_CarrierFreqOffset
**                  int DEMOD_M23_Get_VABER
**                  int DEMOD_M23_Get_Packet_Error
**                  int DEMOD_M23_Get_BandWidthMode
**                  int DEMOD_M23_Get_QAMMode
**                  int DEMOD_M23_Get_MseInfo
**                  int DEMOD_M23_Get_Lock
**
**  References:
**
**  Exports:
...
//		_LGDBB_Context.L2_Context.demod->status		= &_LGDBB_Context.L1_CommonReply;
...
int DEMOD_M23_ResetHW (void)
{
	...
	CTOP_CTRL_M23Ax_Wr01(IP_CTRL_DBB, ipw_dbb_005, reg_dbb_reset, 1);
	...
	CTOP_CTRL_M23Ax_RdFL(IP_CTRL_DBB, ipw_dbb_005);
	CTOP_CTRL_M23Ax_Wr01(IP_CTRL_DBB, ipw_dbb_005, reg_dbb_reset, 0);
	CTOP_CTRL_M23Ax_WrFL(IP_CTRL_DBB, ipw_dbb_005);
	...
	CTOP_CTRL_M23Ax_Wr02(MIP_ADC_CTRL_BMC, mip_adc03, reg_admd_dpll_pdb,1,reg_admd_apll_pdb,1);
	CTOP_CTRL_M23Ax_WrFL(MIP_ADC_CTRL_BMC, mip_adc03);
	
	usleep_range(1000,10000);	// 1ms ~ 10ms

	CTOP_CTRL_M23Ax_RdFL(MIP_ADC_CTRL_BMC, mip_adc02);
	CTOP_CTRL_M23Ax_Wr01(MIP_ADC_CTRL_BMC, mip_adc02, reg_admd_dpll_insel, 1);
	CTOP_CTRL_M23Ax_WrFL(MIP_ADC_CTRL_BMC, mip_adc02);

	usleep_range(1000,10000);	// 1ms ~ 10ms
 

	CTOP_CTRL_M23Ax_RdFL(IP_CTRL_DBB, ipw_dbb_003);
	CTOP_CTRL_M23Ax_Wr01(IP_CTRL_DBB, ipw_dbb_003, pll_cgen, 1);
	CTOP_CTRL_M23Ax_WrFL(IP_CTRL_DBB, ipw_dbb_003);
 ...
 * @author 	Jeongpil.yun (jeongpil.yun@lge.com)
*/
int DEMOD_M23_AdcInit (void)
{
	DEMOD_PRINT("Start \n");

	CTOP_CTRL_M23Ax_RdFL(MIP_ADC_CTRL_BMC, mip_adc03);
	CTOP_CTRL_M23Ax_Wr01(MIP_ADC_CTRL_BMC, mip_adc03, reg_admd_dpll_pdb,1);
	CTOP_CTRL_M23Ax_WrFL(MIP_ADC_CTRL_BMC, mip_adc03);
 ...
 * @author 	Jeongpil.yun (jeongpil.yun@lge.com)
*/
int DEMOD_M23_RepeaterEnable (BOOLEAN bEnable)
{
 ...
 * @author 	Jeongpil.yun (jeongpil.yun@lge.com)
*/
int DEMOD_M23_SoftwareReset (void)
{
	LX_DEMOD_L2_Context *	pFrontend;
...
int DEMOD_M23_Power_Save (BOOLEAN bEnable)
{
	LX_DEMOD_L2_Context *	pFrontend;
	...
	if(bEnable == TRUE)
	{
		...
		if (DEMOD_L2_Set_Property(pFrontend, DEMOD_PROP_MODE_CODE)!= NO_DEMOD_ERROR)
		{
	...
	DEMOD_PRINT("DEMOD_M23_Power_Save End \n");
 ...
 * @author 	Jeongpil.yun (jeongpil.yun@lge.com)
*/
int DEMOD_M23_StdOperModeContrl (LX_DEMOD_OPER_MODE_T operMode, LX_DEMOD_BWMODE_T bandWd, LX_DEMOD_SYMRDET_MODE_T symbr)
{
	LX_DEMOD_L2_Context *	pFrontend;
	...
	//UINT8	reg_pad_gpio22_mux_sel =0; //0: gp2_in[6] (gp2_out[6]), 3: fefctrl
	UINT8	reg_pad_diseqc_mux_sel = 0; //0: diseqco, 1: gp6_in[2] (gp6_out[2]) 
	//UINT8	reg_pad_gpio18_mux_sel =0; //0: gp2_in[2] (gp2_out[2]), 1: main_uart_txd2, 3: diseqc_cmd 
	//UINT8	reg_pad_gpio19_mux_sel =0; //0: gp2_in[3] (gp2_out[3]), 1: main_uart_rxd2, 3: diseqci 
	...
	if (register_set_flag)
	{
		...
		CTOP_CTRL_M23Ax_Wr01(MIP_ADC_CTRL_BMC, mip_adc00, reg_admd_i_pdb,reg_admd_i_pdb);
		CTOP_CTRL_M23Ax_WrFL(MIP_ADC_CTRL_BMC, mip_adc00);

		CTOP_CTRL_M23Ax_RdFL(MIP_ADC_CTRL_BMC, mip_adc01);
		CTOP_CTRL_M23Ax_Wr01(MIP_ADC_CTRL_BMC, mip_adc01, reg_admd_dpll_odpre, reg_admd_dpll_odpre);
		CTOP_CTRL_M23Ax_Wr02(MIP_ADC_CTRL_BMC, mip_adc01, reg_admd_q_pdb, reg_admd_q_pdb, reg_admd_t_pdb, reg_admd_t_pdb);
		CTOP_CTRL_M23Ax_WrFL(MIP_ADC_CTRL_BMC, mip_adc01);

		CTOP_CTRL_M23Ax_RdFL(MIP_ADC_CTRL_BMC, mip_adc02);
		CTOP_CTRL_M23Ax_Wr01(MIP_ADC_CTRL_BMC, mip_adc02, reg_admd_dpll_cken, reg_admd_dpll_cken);
		CTOP_CTRL_M23Ax_Wr01(MIP_ADC_CTRL_BMC, mip_adc02, reg_admd_bias_pdb, reg_admd_bias_pdb);
		CTOP_CTRL_M23Ax_WrFL(MIP_ADC_CTRL_BMC, mip_adc02);

		CTOP_CTRL_M23Ax_RdFL(MIP_ADC_CTRL_BMC, mip_adc03);
		CTOP_CTRL_M23Ax_Wr01(MIP_ADC_CTRL_BMC, mip_adc03, reg_admd_dpll_odpost, reg_admd_dpll_odpost);
		CTOP_CTRL_M23Ax_Wr02(MIP_ADC_CTRL_BMC, mip_adc03, reg_admd_dpll_divint,reg_admd_dpll_divint,reg_admd_dpll_icp,reg_admd_dpll_icp);
		CTOP_CTRL_M23Ax_Wr02(MIP_ADC_CTRL_BMC, mip_adc03, reg_admd_apll_m, reg_admd_apll_m, reg_admd_adc_refsel, reg_admd_adc_refsel);
		CTOP_CTRL_M23Ax_WrFL(MIP_ADC_CTRL_BMC, mip_adc03);

		CTOP_CTRL_M23Ax_RdFL(IOMUX_CTRL_BMC, pad_bmc64);
		CTOP_CTRL_M23Ax_Wr02(IOMUX_CTRL_BMC, pad_bmc64, reg_pad_ifagc_s_mux_sel, reg_pad_ifagc_s_mux_sel, reg_pad_ifagc_mux_sel, reg_pad_ifagc_mux_sel);
		CTOP_CTRL_M23Ax_WrFL(IOMUX_CTRL_BMC, pad_bmc64);
		...
		{			
			...
			//CTOP_CTRL_M23Ax_Wr02(IOMUX_CTRL_BMC, pad_bmc65, reg_pad_gpio18_mux_sel, reg_pad_gpio18_mux_sel, reg_pad_gpio19_mux_sel, reg_pad_gpio19_mux_sel);
			//CTOP_CTRL_M23Ax_WrFL(IOMUX_CTRL_BMC, pad_bmc65);

			CTOP_CTRL_M23Ax_RdFL(IOMUX_CTRL_BMC, pad_bmc64);
			CTOP_CTRL_M23Ax_Wr01(IOMUX_CTRL_BMC, pad_bmc64, reg_pad_diseqc_mux_sel, reg_pad_diseqc_mux_sel);
			CTOP_CTRL_M23Ax_WrFL(IOMUX_CTRL_BMC, pad_bmc64);
			
			//DEMOD_NOTI("DVB-S/S2 BND Control \n");

			//CTOP_CTRL_M23Ax_RdFL(BND_CTRL_CPU, bnd_cpu_r18);
			//CTOP_CTRL_M23Ax_Wr01(BND_CTRL_CPU, bnd_cpu_r18, reg_tpi_cam_mux_sel, reg_tpi_cam_mux_sel);
			//CTOP_CTRL_M23Ax_WrFL(BND_CTRL_CPU, bnd_cpu_r18);
		}
		...
		if (new_standard == DEMOD_MODULATION_DVBT)
		{
			...
			//CTOP_CTRL_M23Ax_RdFL(IOMUX_CTRL_BMC, pad_bmc65);
			//CTOP_CTRL_M23Ax_Wr01(IOMUX_CTRL_BMC, pad_bmc65, reg_pad_gpio22_mux_sel, reg_pad_gpio22_mux_sel);
			//CTOP_CTRL_M23Ax_WrFL(IOMUX_CTRL_BMC, pad_bmc65);
 ...
 * @author 	Jeongpil.yun(jeongpil.yun@lge.com)
*/
int DEMOD_M23_NeverlockScan (DEMOD_CTX_T *pDemodInfo, LX_DEMOD_FLAG_T ResetOn, LX_DEMOD_FLAG_T *pScanProcessing, LX_DEMOD_LOCK_STATE_T *pScanLock)
{
	...
	if (RET_OK != DEMOD_M23_Get_NeverLockStatus(scanMode, &neverLockStatus))
	{
 ...
 * @author 	Jeongpil.yun (jeongpil.yun@lge.com)
*/
int DEMOD_M23_TPOutEnable (BOOLEAN bEnable)
{
	LX_DEMOD_L2_Context *	pFrontend;
 ...
 * @author 	Jeongpil.yun (jeongpil.yun@lge.com)
*/
int DEMOD_M23_GetTsClkRate (UINT32 *demodTsClkRate)
{
 ...
 * @author 	Jeongpil.yun (jeongpil.yun@lge.com)
*/
int DEMOD_M23_Set_IF_Frq (UINT32 ifFrq)
{
#if 1
	LX_DEMOD_L2_Context *	pFrontend;
 ...
 * @author 	Jeongpil.yun (jeongpil.yun@lge.com)
*/
int DEMOD_M23_Set_AGCPolarity (LX_DEMOD_AGC_POLAR_T agcPola)
{
	LX_DEMOD_L2_Context *	pFrontend;
 ...
 * @author 	Jeongpil.yun (jeongpil.yun@lge.com)
*/
int DEMOD_M23_Get_Id (UINT8 *pCellIDLength, UINT16 *pId)
{
	LX_DEMOD_L2_Context *	pFrontend;
...
************************************************************************************/
/**
 * DEMOD_M23_Get_SpectrumInvStatus
 ...
 * @author 	Jeongpil.yun (jeongpil.yun@lge.com)
*/
int DEMOD_M23_Get_SpectrumStatus (LX_DEMOD_LOCK_STATE_T *pSpectrumAuto, LX_DEMOD_LOCK_STATE_T *pSpectrumInv)
{
	LX_DEMOD_L2_Context *	pFrontend;
	LX_DEMOD_L2_SIG_STATUS	signalStatus;
 ...
 * @author 	Jeongpil.yun (jeongpil.yun@lge.com)
*/
int DEMOD_M23_Get_IFAGC (UINT16 *pIfAgc)
{
	LX_DEMOD_L2_Context *	pFrontend;
	LX_DEMOD_L2_SIG_STATUS	signalStatus;
 ...
 * @author 	Jeongpil.yun (jeongpil.yun@lge.com)
*/
int DEMOD_M23_Get_OperMode (LX_DEMOD_OPER_MODE_T *pOperMode)
{
	LX_DEMOD_L2_Context *	pFrontend;
 ...
 * @author 	Jeongpil.yun (jeongpil.yun@lge.com)
*/
int DEMOD_M23_Get_NeverLockStatus (LX_DEMOD_OPER_MODE_T scanMode, LX_DEMOD_LOCK_STATE_T *pNeverLockStatus)
{
	LX_DEMOD_L2_Context *	pFrontend;
...
************************************************************************************/
/**
 * DEMOD_M23_Get_CarrierFreqOffset
 ...
 * @author 	Jeongpil.yun (jeongpil.yun@lge.com)
*/
int DEMOD_M23_Get_CarrierFreqOffset (SINT32 *pFreqOff)
{
	LX_DEMOD_L2_Context *	pFrontend;
	LX_DEMOD_L2_SIG_STATUS 	signalStatus;
	SINT32			freqOffset;
 ...
 * @author 	Jeongpil.yun (jeongpil.yun@lge.com)
*/
int DEMOD_M23_Get_VABER (UINT32 *pVber)
{
	LX_DEMOD_L2_Context *	pFrontend;
	LX_DEMOD_L2_SIG_STATUS 	signalStatus;
 ...
 * @author 	Jeongpil.yun (jeongpil.yun@lge.com)
*/
int DEMOD_M23_Get_Packet_Error (UINT32 *pError)
{
	LX_DEMOD_L2_Context *	pFrontend;
	LX_DEMOD_L2_SIG_STATUS	signalStatus;
 ...
 * @author 	Jeongpil.yun (jeongpil.yun@lge.com)
*/
int DEMOD_M23_Get_BandWidthMode (LX_DEMOD_BWMODE_T *ChannelBW )
{
	LX_DEMOD_L2_Context *	pFrontend;
	LX_DEMOD_L2_SIG_STATUS	signalStatus;
 ...
 * @author 	Jeongpil.yun (jeongpil.yun@lge.com)
*/
int DEMOD_M23_Get_QAMMode (LX_DEMOD_RF_MODE_T *pQamMode )
{
	LX_DEMOD_L2_Context *	pFrontend;
	LX_DEMOD_L2_SIG_STATUS	signalStatus;
...
/*
	if(RET_OK != DEMOD_M23_Get_OperMode(&mode))
	{
		DEMOD_PRINT("[DEMOD] FAIL (%s:%d) DEMOD_M23_Get_OperMode() !!!\n", __F__, __L__);
		return RET_ERROR;
	}
*/
	if (DEMOD_L2_SignalStatus(pFrontend, &signalStatus))
 ...
 * @author 	Jeongpil.yun (jeongpil.yun@lge.com)
*/
int DEMOD_M23_Get_MseInfo (LX_DEMOD_MSE_T *pSigMse)
{
	LX_DEMOD_L2_Context *	pFrontend;
	LX_DEMOD_L2_SIG_STATUS	signalStatus;
 ...
 * @author 	Jeongpil.yun (jeongpil.yun@lge.com)
*/
int DEMOD_M23_Get_Lock (LX_DEMOD_LOCK_STATUS_T whatLock, LX_DEMOD_LOCK_STATE_T *lockState)
{
...
int DEMOD_M23_CountryGrpSetting (BOOLEAN bEnable)
{
	LX_DEMOD_L2_Context *	pFrontend;
...
int DEMOD_M23_Get_I2C_Handle (UINT8 portI2C, UINT16 deviceID)
{
	LX_DEMOD_L2_Context *	pFrontend;
	UINT32			handle;
...
int DEMOD_M23_OperModeReset(LX_DEMOD_OPER_MODE_T operMode)
{
	UINT8	reg_admd_t_pdb = 0;
...
// M23 TODO:
	CTOP_CTRL_M23Ax_RdFL(MIP_ADC_CTRL_BMC, mip_adc01);
	CTOP_CTRL_M23Ax_Wr01(MIP_ADC_CTRL_BMC, mip_adc01, reg_admd_t_pdb, reg_admd_t_pdb);
	CTOP_CTRL_M23Ax_WrFL(MIP_ADC_CTRL_BMC, mip_adc01);
...
int DEMOD_M23_FW_Configuration_Initialize (LX_DEMOD_OPER_MODE_T operMode)
{
	LX_DEMOD_L2_Context *	pFrontend;
	UINT32			retc;
...
int DEMOD_M23_Opermode (DEMOD_CTX_T *pDemodInfo)
{
	UINT8  new_opermode;
...
int DEMOD_M23_Get_BW (DEMOD_CTX_T *pDemodInfo, UINT16 *pter_bandwidth_KHz)
{
...
int DEMOD_M23_Get_FW_PartInfo (UINT32 *pFW_Info)
{
	LX_DEMOD_L2_Context *	pFrontend;
...
int DEMOD_M23_Debug_ReadREGvalue (UINT16 address, UINT32 *pData)
{
	LX_DEMOD_L2_Context *	pFrontend;
	UINT8					pvalue[4];
...
int DEMOD_M23_Debug_ATSC_ReadREGvalue (UINT16 address, UINT32 *pData)
{
	LX_DEMOD_L2_Context *	pFrontend;
...
int DEMOD_M23_Debug_ATSC_WriteREGvalue (UINT16 address, UINT32 *pData)
{
	LX_DEMOD_L2_Context *	pFrontend;
...
************************************************************************************/
/**
 * DEMOD_M23_Get_Signal_Information
 * Get BER before RS on DVB
 *
 * @param *pVber 	[OUT] UINT32.
 * @return if Succeeded - RET_OK else-RET_ERROR
 ...
 * @author 	Jeongpil.yun (jeongpil.yun@lge.com)
*/
int DEMOD_M23_Get_Signal_Information (LX_DEMOD_SIGNAL_TOTAL_T *pSignalStatus)
{
	LX_DEMOD_L2_Context *	pFrontend;
	LX_DEMOD_L2_SIG_STATUS 	signalStatus;
 ...
 * @author 	Jeongpil.yun (jeongpil.yun@lge.com)
*/
int DEMOD_M23_Get_CFG_Information (LX_DEMOD_SIGNAL_TUNE_CFG_T *pSignalStatus)
{
	LX_DEMOD_L2_Context *	pFrontend;
	LX_DEMOD_L2_SIG_STATUS 	signalStatus;
...
int DEMOD_M23_DVB_Set_MemSconfig (void)
{
	LX_DEMOD_L2_Context *	pFrontend;
