#ifndef _PE_SRE_SHP_REG_M17A0_H_
#define _PE_SRE_SHP_REG_M17A0_H_
/*-----------------------------------------------------------------------------
...
typedef struct
{
	...
	UINT32 reg_top_ode_3d                     :1 ;	//12:12
}PE_M17_SR_SHP_CTRL_00_T;
/*-----------------------------------------------------------------------------
...
}PE_M17_SR_SHP_CORING_CTRL_00_T;
/*-----------------------------------------------------------------------------
...
}PE_M17_SR_SHP_CORING_CTRL_01_T;
/*-----------------------------------------------------------------------------
...
}PE_M17_SR_SHP_CORING_CTRL_02_T;
/*-----------------------------------------------------------------------------
...
}PE_M17_SR_SHP_CORING_CTRL_03_T;
/*-----------------------------------------------------------------------------
...
}PE_M17_SR_SHP_CORING_CTRL_04_T;
/*-----------------------------------------------------------------------------
...
}PE_M17_SR_SHP_CORING_CTRL_05_T;
/*-----------------------------------------------------------------------------
...
}PE_M17_SR_SHP_CORING_CTRL_06_T;
/*-----------------------------------------------------------------------------
...
}PE_M17_SR_SHP_CORING_CTRL_07_T;
/*-----------------------------------------------------------------------------
...
}PE_M17_SR_SHP_CORING_CTRL_08_T;
/*-----------------------------------------------------------------------------
...
}PE_M17_SR_SHP_CORING_CTRL_09_T;
/*-----------------------------------------------------------------------------
...
}PE_M17_SR_SHP_TGEN_CTRL_02_T;
/*-----------------------------------------------------------------------------
                             0xc90092acL SHP_TGEN_CTRL_03                             
-----------------------------------------------------------------------------*/
typedef struct
{
	UINT32 reg_tgen_rand_x0;	//31:0
}PE_M17_SR_SHP_TGEN_CTRL_03_T;
/*-----------------------------------------------------------------------------
...
}PE_M17_SR_SHP_CONTRAST_CTRL_00_T;
/*-----------------------------------------------------------------------------
...
}PE_M17_SR_SHP_CONTRAST_CTRL_01_T;
/*-----------------------------------------------------------------------------
...
}PE_M17_SR_SHP_CONTRAST_CTRL_02_T;
/*-----------------------------------------------------------------------------
...
}PE_M17_SR_SHP_CONTRAST_CTRL_03_T;
/*-----------------------------------------------------------------------------
...
}PE_M17_SR_SHP_CONTRAST_CTRL_04_T;
/*-----------------------------------------------------------------------------
...
}PE_M17_SR_SHP_MNR_CTRL_02_T;
/*-----------------------------------------------------------------------------
                             0xc9009350L SHP_WIN2_CTRL_00                             
-----------------------------------------------------------------------------*/
typedef struct
{
	UINT32 reg_win_dp_win0_en                 :1 ;	//0:0
	UINT32 reg_win_dp_win1_en                 :1 ;	//1:1
	UINT32 reg_win_dp_win01_en                :1 ;	//2:2
	UINT32 reserved01                         :3 ;	//reserved
	UINT32 reg_win_dp_win_outside             :1 ;	//6:6
	UINT32 reg_win_dp_win_en                  :1 ;	//7:7
	UINT32 reg_win_dp_bdr_alpha               :5 ;	//12:8
	UINT32 reg_win_dp_bdr_wid                 :2 ;	//14:13
	UINT32 reg_win_dp_bdr_en                  :1 ;	//15:15
	UINT32 reg_win_dp_cr5                     :5 ;	//20:16
	UINT32 reg_win_dp_cb5                     :5 ;	//25:21
	UINT32 reg_win_dp_yy6                     :6 ;	//31:26
}PE_M17_SR_SHP_WIN2_CTRL_00_T;
/*-----------------------------------------------------------------------------
                             0xc9009354L SHP_WIN2_CTRL_01                             
-----------------------------------------------------------------------------*/
typedef struct
{
	UINT32 reg_win_dp_win_w0_x0               :12;	//11:0
	UINT32 reserved01                         :4 ;	//reserved
	UINT32 reg_win_dp_win_w0_y0               :12;	//27:16
}PE_M17_SR_SHP_WIN2_CTRL_01_T;
/*-----------------------------------------------------------------------------
                             0xc9009358L SHP_WIN2_CTRL_02                             
-----------------------------------------------------------------------------*/
typedef struct
{
	UINT32 reg_win_dp_win_w0_x1               :12;	//11:0
	UINT32 reserved01                         :4 ;	//reserved
	UINT32 reg_win_dp_win_w0_y1               :12;	//27:16
}PE_M17_SR_SHP_WIN2_CTRL_02_T;
/*-----------------------------------------------------------------------------
                             0xc900935cL SHP_WIN2_CTRL_03                             
-----------------------------------------------------------------------------*/
typedef struct
{
	UINT32 reg_win_dp_win_w1_x0               :12;	//11:0
	UINT32 reserved01                         :4 ;	//reserved
	UINT32 reg_win_dp_win_w1_y0               :12;	//27:16
}PE_M17_SR_SHP_WIN2_CTRL_03_T;
/*-----------------------------------------------------------------------------
                             0xc9009360L SHP_WIN2_CTRL_04                             
-----------------------------------------------------------------------------*/
typedef struct
{
	UINT32 reg_win_dp_win_w1_x1               :12;	//11:0
	UINT32 reserved01                         :4 ;	//reserved
	UINT32 reg_win_dp_win_w1_y1               :12;	//27:16
}PE_M17_SR_SHP_WIN2_CTRL_04_T;
/*-----------------------------------------------------------------------------
                             0xc90093a0L SHP_WIN3_CTRL_00                             
-----------------------------------------------------------------------------*/
typedef struct
{
	UINT32 reg_win_dj_win0_en                 :1 ;	//0:0
	UINT32 reg_win_dj_win1_en                 :1 ;	//1:1
	UINT32 reg_win_dj_win01_en                :1 ;	//2:2
	UINT32 reserved01                         :3 ;	//reserved
	UINT32 reg_win_dj_win_outside             :1 ;	//6:6
	UINT32 reg_win_dj_win_en                  :1 ;	//7:7
	UINT32 reg_win_dj_bdr_alpha               :5 ;	//12:8
	UINT32 reg_win_dj_bdr_wid                 :2 ;	//14:13
	UINT32 reg_win_dj_bdr_en                  :1 ;	//15:15
	UINT32 reg_win_dj_cr5                     :5 ;	//20:16
	UINT32 reg_win_dj_cb5                     :5 ;	//25:21
	UINT32 reg_win_dj_yy6                     :6 ;	//31:26
}PE_M17_SR_SHP_WIN3_CTRL_00_T;
/*-----------------------------------------------------------------------------
                             0xc90093a4L SHP_WIN3_CTRL_01                             
-----------------------------------------------------------------------------*/
typedef struct
{
	UINT32 reg_win_dj_win_w0_x0               :12;	//11:0
	UINT32 reserved01                         :4 ;	//reserved
	UINT32 reg_win_dj_win_w0_y0               :12;	//27:16
}PE_M17_SR_SHP_WIN3_CTRL_01_T;
/*-----------------------------------------------------------------------------
                             0xc90093a8L SHP_WIN3_CTRL_02                             
-----------------------------------------------------------------------------*/
typedef struct
{
	UINT32 reg_win_dj_win_w0_x1               :12;	//11:0
	UINT32 reserved01                         :4 ;	//reserved
	UINT32 reg_win_dj_win_w0_y1               :12;	//27:16
}PE_M17_SR_SHP_WIN3_CTRL_02_T;
/*-----------------------------------------------------------------------------
                             0xc90093acL SHP_WIN3_CTRL_03                             
-----------------------------------------------------------------------------*/
typedef struct
{
	UINT32 reg_win_dj_win_w1_x0               :12;	//11:0
	UINT32 reserved01                         :4 ;	//reserved
	UINT32 reg_win_dj_win_w1_y0               :12;	//27:16
}PE_M17_SR_SHP_WIN3_CTRL_03_T;
/*-----------------------------------------------------------------------------
                             0xc90093b0L SHP_WIN3_CTRL_04                             
-----------------------------------------------------------------------------*/
typedef struct
{
	UINT32 reg_win_dj_win_w1_x1               :12;	//11:0
	UINT32 reserved01                         :4 ;	//reserved
	UINT32 reg_win_dj_win_w1_y1               :12;	//27:16
}PE_M17_SR_SHP_WIN3_CTRL_04_T;
/*-----------------------------------------------------------------------------
...
}PE_M17_SR_SHP_DEBUG_CTRL_02_T;
/*-----------------------------------------------------------------------------
                             0xc9009600L SHP_STAT_00                             
-----------------------------------------------------------------------------*/
typedef struct
{
	UINT32 reg_mon_vcnt                       :12;	//11:0
	UINT32 reg_mon_va_pe1_in                  :1 ;	//12:12
	UINT32 reg_mon_va_pe1_out                 :1 ;	//13:13
	UINT32 reserved01                         :2 ;	//reserved
	UINT32 reg_mon_vcnt2                      :12;	//27:16
}PE_M17_SR_SHP_STAT_00_T;
/*-----------------------------------------------------------------------------
...
{
	UINT32 reserved01                         :32 ;	//reserved
}PE_M17_SR_SHP_CORING_STAT_00_T;
/*-----------------------------------------------------------------------------
...
{
	UINT32 reserved01                         :32 ;	//reserved
}PE_M17_SR_SHP_CORING_STAT_01_T;
/*-----------------------------------------------------------------------------
...
{
	UINT32 reserved01                         :32 ;	//reserved
}PE_M17_SR_SHP_CORING_STAT_02_T;
/*-----------------------------------------------------------------------------
...
{
	UINT32 reserved01                         :32 ;	//reserved
}PE_M17_SR_SHP_CORING_STAT_03_T;
/*-----------------------------------------------------------------------------
                             0xc90096e0L SHP_SQM_STAT_00                             
-----------------------------------------------------------------------------*/
typedef struct
{
	UINT32 reg_mon_sqm_blur_pixel             :10;	//9:0
	UINT32 reg_mon_sqm_sharp_pixel            :10;	//19:10
	UINT32 reg_mon_sqm_output                 :10;	//29:20
	UINT32 reg_mon_sqm_pc_detect              :1 ;	//30:30
}PE_M17_SR_SHP_SQM_STAT_00_T;
/*-----------------------------------------------------------------------------
                             0xc90096f0L SHP_BBD_STAT_00                             
-----------------------------------------------------------------------------*/
typedef struct
{
	UINT32 reg_mon_bbd_x0                     :12;	//11:0
	UINT32 reserved01                         :4 ;	//reserved
	UINT32 reg_mon_bbd_y0                     :12;	//27:16
}PE_M17_SR_SHP_BBD_STAT_00_T;
/*-----------------------------------------------------------------------------
                             0xc90096f4L SHP_BBD_STAT_01                             
-----------------------------------------------------------------------------*/
typedef struct
{
	UINT32 reg_mon_bbd_x1                     :12;	//11:0
	UINT32 reserved01                         :4 ;	//reserved
	UINT32 reg_mon_bbd_y1                     :12;	//27:16
}PE_M17_SR_SHP_BBD_STAT_01_T;
/*-----------------------------------------------------------------------------
...
{
	UINT32 reserved01                         :32 ;	//reserved
}PE_M17_SR_SHP_FSW_CTRL_01_T;
/*-----------------------------------------------------------------------------
                             0xc90097e8L SHP_FSW_CTRL_02                             
-----------------------------------------------------------------------------*/
typedef struct
{
	UINT32 js_mode_en                         :1  ;	//0:0
	UINT32 offset_x                           :4  ;	//4:1
	UINT32 offset_y                           :4  ;	//8:5
	UINT32 direct_x                           :1  ;	//9:9
	UINT32 direct_y                           :1  ;	//10:10
}PE_M17_SR_SHP_FSW_CTRL_02_T;
/*-----------------------------------------------------------------------------
...
{
	UINT32 reserved01                         :32 ;	//reserved
}PE_M17_SR_SHP_FSW_CTRL_03_T;

/*-----------------------------------------------------------------------------
                             0xc9009f00L PIX2LINE_PIC_SIZE                             
-----------------------------------------------------------------------------*/
typedef struct
{
	UINT32 reg_pix2line_vsize                 :12;	//11:0
	UINT32 reserved01                         :4 ;	//reserved
	UINT32 reg_pix2line_hsize                 :12;	//27:16
}PE_M17_PIX2LINE_PIC_SIZE_T;
/*-----------------------------------------------------------------------------
                             0xc9009f04L PIX2LINE_PIC_HDUMMY                             
-----------------------------------------------------------------------------*/
typedef struct
{
	UINT32 reg_pix2line_dummy_vsize           :12;	//11:0
}PE_M17_PIX2LINE_PIC_HDUMMY_T;
/*-----------------------------------------------------------------------------
                             0xc9009f08L PIX2LINE_PIC_GAP                             
-----------------------------------------------------------------------------*/
typedef struct
{
	UINT32 reg_pix2line_hd_gap                :12;	//11:0
	UINT32 reserved01                         :4 ;	//reserved
	UINT32 reg_pix2line_vh_gap                :12;	//27:16
}PE_M17_PIX2LINE_PIC_GAP_T;
/*-----------------------------------------------------------------------------
                             0xc9009f0cL PIX2LINE_PIC_HBLANK                             
-----------------------------------------------------------------------------*/
typedef struct
{
	UINT32 reg_pix2line_hblank1               :12;	//11:0
	UINT32 reserved01                         :4 ;	//reserved
	UINT32 reg_pix2line_hblank0               :12;	//27:16
}PE_M17_PIX2LINE_PIC_HBLANK_T;
/*-----------------------------------------------------------------------------
                             0xc9009f10L PIX2LINE_PIC_HSSIZE                             
-----------------------------------------------------------------------------*/
typedef struct
{
	UINT32 reg_pix2line_hssize                :12;	//11:0
}PE_M17_PIX2LINE_PIC_HSSIZE_T;
/*-----------------------------------------------------------------------------
                             0xc9009f14L PIX2LINE_PIC_VSPACE                             
-----------------------------------------------------------------------------*/
typedef struct
{
	UINT32 reg_pix2line_vspace                :12;	//11:0
}PE_M17_PIX2LINE_PIC_VSPACE_T;
/*-----------------------------------------------------------------------------
                             0xc9009f18L PIX2LINE_PIC_PREHSYNC                             
-----------------------------------------------------------------------------*/
typedef struct
{
	UINT32 reg_pix2line_1pre_hsync            :1 ;	//0:0
}PE_M17_PIX2LINE_PIC_PREHSYNC_T;
/*-----------------------------------------------------------------------------
                             0xc9009f1cL LINE2PIX_PIC_SIZE                             
-----------------------------------------------------------------------------*/
typedef struct
{
	UINT32 reg_line2pix_vsize                 :12;	//11:0
	UINT32 reserved01                         :4 ;	//reserved
	UINT32 reg_line2pix_hsize                 :12;	//27:16
}PE_M17_LINE2PIX_PIC_SIZE_T;
/*-----------------------------------------------------------------------------
                             0xc9009f20L LINE2PIX_PIC_ESPACE                             
-----------------------------------------------------------------------------*/
typedef struct
{
	UINT32 reg_line2pix_espace                :12;	//11:0
}PE_M17_LINE2PIX_PIC_ESPACE_T;
/*-----------------------------------------------------------------------------
                             0xc9009f24L PIX2LINE_MON0                             
-----------------------------------------------------------------------------*/
typedef struct
{
	UINT32 mon_pix2line0;	//31:0
}PE_M17_PIX2LINE_MON0_T;
/*-----------------------------------------------------------------------------
                             0xc9009f28L PIX2LINE_MON1                             
-----------------------------------------------------------------------------*/
typedef struct
{
	UINT32 mon_pix2line1;	//31:0
}PE_M17_PIX2LINE_MON1_T;
/*-----------------------------------------------------------------------------
                             0xc9009f2cL PIX2LINE_MON2                             
-----------------------------------------------------------------------------*/
typedef struct
{
	UINT32 mon_pix2line2;	//31:0
}PE_M17_PIX2LINE_MON2_T;
/*-----------------------------------------------------------------------------
                             0xc9009f30L LINE2PIX_MON0                             
-----------------------------------------------------------------------------*/
typedef struct
{
	UINT32 mon_line2pix0;	//31:0
}PE_M17_LINE2PIX_MON0_T;
/*-----------------------------------------------------------------------------
                             0xc9009f34L LINE2PIX_MON1                             
-----------------------------------------------------------------------------*/
typedef struct
{
	UINT32 mon_line2pix1;	//31:0
}PE_M17_LINE2PIX_MON1_T;
/*-----------------------------------------------------------------------------
                             0xc9009f38L LINE2PIX_MON2                             
-----------------------------------------------------------------------------*/
typedef struct
{
	UINT32 mon_line2pix2;	//31:0
}PE_M17_LINE2PIX_MON2_T;
/*-----------------------------------------------------------------------------
                             0xc9009f40L LINE2PIX_MON3                             
-----------------------------------------------------------------------------*/
typedef struct
{
	UINT32 mon_line2pix3;	//31:0
}PE_M17_LINE2PIX_MON3_T;
/*-----------------------------------------------------------------------------
                             0xc9009f4cL LINE2PIX_MON4                             
-----------------------------------------------------------------------------*/
typedef struct
{
	UINT32 mon_line2pix4;	//31:0
}PE_M17_LINE2PIX_MON4_T;
...
typedef struct
{
	UINT32 reserved01                         :10;	//reserved
	UINT32 blending_range                     :2 ;	//11:10
	UINT32 reg_vsc_mode_m1                    :1 ;	//3:3
	UINT32 reg_adaptive_on_m1                 :1 ;	//4:4
	UINT32 reg_bilinear_on_m1                 :1 ;	//5:5
	UINT32 reg_th                             :4 ;	//9:6
	UINT32 reg_min_max_on_m1                  :1 ;	//14:14
	UINT32 reg_min_max_th_m1                  :10;	//24:15
	UINT32 reg_sampling_mode_m1               :1 ;	//31:31
}PE_M17_SR_PSC_Y_CTRL_T;
/*-----------------------------------------------------------------------------
...
}PE_M17_SR_PSC_Y_PHASE_OFFSET_T;
/*-----------------------------------------------------------------------------
...
}PE_M17_SR_PSC_Y_SAMPLING_V_T;
/*-----------------------------------------------------------------------------
                             0xc900a044L SR_PSC_Y_V1_FIR_COEF_CTRL                             
-----------------------------------------------------------------------------*/
typedef struct
{
	UINT32 update_v1                          :1 ;	//0:0
	UINT32 rnw_v1                             :1 ;	//1:1
	UINT32 addr_v1                            :8 ;	//9:2
}PE_M17_SR_PSC_Y_V1_FIR_COEF_CTRL_T;
/*-----------------------------------------------------------------------------
                             0xc900a048L SR_PSC_Y_V1_Y_FIR_COEF_DATA0                             
-----------------------------------------------------------------------------*/
typedef struct
{
	UINT32 y_coefficient0_v1                  :12;	//11:0
	UINT32 reserved01                         :4 ;	//reserved
	UINT32 y_coefficient1_v1                  :12;	//27:16
}PE_M17_SR_PSC_Y_V1_Y_FIR_COEF_DATA0_T;
/*-----------------------------------------------------------------------------
                             0xc900a04cL SR_PSC_Y_V1_Y_FIR_COEF_DATA1                             
-----------------------------------------------------------------------------*/
typedef struct
{
	UINT32 y_coefficient2_v1                  :12;	//11:0
	UINT32 reserved01                         :4 ;	//reserved
	UINT32 y_coefficient3_v1                  :12;	//27:16
}PE_M17_SR_PSC_Y_V1_Y_FIR_COEF_DATA1_T;
/*-----------------------------------------------------------------------------
                             0xc900a050L SR_PSC_Y_V1_Y_FIR_COEF_DATA2                             
-----------------------------------------------------------------------------*/
typedef struct
{
	UINT32 y_coefficient4_v1                  :12;	//11:0
	UINT32 reserved01                         :4 ;	//reserved
	UINT32 y_coefficient5_v1                  :12;	//27:16
}PE_M17_SR_PSC_Y_V1_Y_FIR_COEF_DATA2_T;
/*-----------------------------------------------------------------------------
                             0xc900a054L SR_PSC_Y_V1_Y_FIR_COEF_DATA3                             
-----------------------------------------------------------------------------*/
typedef struct
{
	UINT32 y_coefficient6_v1                  :12;	//11:0
	UINT32 reserved01                         :4 ;	//reserved
	UINT32 y_coefficient7_v1                  :12;	//27:16
}PE_M17_SR_PSC_Y_V1_Y_FIR_COEF_DATA3_T;
/*-----------------------------------------------------------------------------
                             0xc900a058L SR_PSC_Y_V1_Y_FIR_COEF_DATA4                             
-----------------------------------------------------------------------------*/
typedef struct
{
	UINT32 y_coefficient8_v1                  :12;	//11:0
	UINT32 reserved01                         :4 ;	//reserved
	UINT32 y_coefficient9_v1                  :12;	//27:16
}PE_M17_SR_PSC_Y_V1_Y_FIR_COEF_DATA4_T;
/*-----------------------------------------------------------------------------
                             0xc900a05cL SR_PSC_Y_V1_Y_FIR_COEF_DATA5                             
-----------------------------------------------------------------------------*/
typedef struct
{
	UINT32 y_coefficient10_v1                 :12;	//11:0
	UINT32 reserved01                         :4 ;	//reserved
	UINT32 y_coefficient11_v1                 :12;	//27:16
}PE_M17_SR_PSC_Y_V1_Y_FIR_COEF_DATA5_T;
/*-----------------------------------------------------------------------------
                             0xc900a060L SR_PSC_Y_V2_FIR_COEF_CTRL                             
-----------------------------------------------------------------------------*/
typedef struct
{
	UINT32 update_v2                          :1 ;	//0:0
	UINT32 rnw_v2                             :1 ;	//1:1
	UINT32 addr_v2                            :8 ;	//9:2
}PE_M17_SR_PSC_Y_V2_FIR_COEF_CTRL_T;
/*-----------------------------------------------------------------------------
                             0xc900a064L SR_PSC_Y_V2_Y_FIR_COEF_DATA0                             
-----------------------------------------------------------------------------*/
typedef struct
{
	UINT32 y_coefficient0_v2                  :12;	//11:0
	UINT32 reserved01                         :4 ;	//reserved
	UINT32 y_coefficient1_v2                  :12;	//27:16
}PE_M17_SR_PSC_Y_V2_Y_FIR_COEF_DATA0_T;
/*-----------------------------------------------------------------------------
                             0xc900a068L SR_PSC_Y_V2_Y_FIR_COEF_DATA1                             
-----------------------------------------------------------------------------*/
typedef struct
{
	UINT32 y_coefficient2_v2                  :12;	//11:0
	UINT32 reserved01                         :4 ;	//reserved
	UINT32 y_coefficient3_v2                  :12;	//27:16
}PE_M17_SR_PSC_Y_V2_Y_FIR_COEF_DATA1_T;
/*-----------------------------------------------------------------------------
                             0xc900a06cL SR_PSC_Y_V2_Y_FIR_COEF_DATA2                             
-----------------------------------------------------------------------------*/
typedef struct
{
	UINT32 y_coefficient4_v2                  :12;	//11:0
	UINT32 reserved01                         :4 ;	//reserved
	UINT32 y_coefficient5_v2                  :12;	//27:16
}PE_M17_SR_PSC_Y_V2_Y_FIR_COEF_DATA2_T;
/*-----------------------------------------------------------------------------
                             0xc900a070L SR_PSC_Y_V2_Y_FIR_COEF_DATA3                             
-----------------------------------------------------------------------------*/
typedef struct
{
	UINT32 y_coefficient6_v2                  :12;	//11:0
	UINT32 reserved01                         :4 ;	//reserved
	UINT32 y_coefficient7_v2                  :12;	//27:16
}PE_M17_SR_PSC_Y_V2_Y_FIR_COEF_DATA3_T;
/*-----------------------------------------------------------------------------
                             0xc900a074L SR_PSC_Y_H1_FIR_COEF_CTRL                             
-----------------------------------------------------------------------------*/
typedef struct
{
	UINT32 update_h1                          :1 ;	//0:0
	UINT32 rnw_h1                             :1 ;	//1:1
	UINT32 addr_h1                            :8 ;	//9:2
}PE_M17_SR_PSC_Y_H1_FIR_COEF_CTRL_T;
/*-----------------------------------------------------------------------------
                             0xc900a078L SR_PSC_Y_H1_Y_FIR_COEF_DATA0                             
-----------------------------------------------------------------------------*/
typedef struct
{
	UINT32 y_coefficient0_h1                  :12;	//11:0
	UINT32 reserved01                         :4 ;	//reserved
	UINT32 y_coefficient1_h1                  :12;	//27:16
}PE_M17_SR_PSC_Y_H1_Y_FIR_COEF_DATA0_T;
/*-----------------------------------------------------------------------------
                             0xc900a07cL SR_PSC_Y_H1_Y_FIR_COEF_DATA1                             
-----------------------------------------------------------------------------*/
typedef struct
{
	UINT32 y_coefficient2_h1                  :12;	//11:0
	UINT32 reserved01                         :4 ;	//reserved
	UINT32 y_coefficient3_h1                  :12;	//27:16
}PE_M17_SR_PSC_Y_H1_Y_FIR_COEF_DATA1_T;
/*-----------------------------------------------------------------------------
                             0xc900a080L SR_PSC_Y_H1_Y_FIR_COEF_DATA2                             
-----------------------------------------------------------------------------*/
typedef struct
{
	UINT32 y_coefficient4_h1                  :12;	//11:0
	UINT32 reserved01                         :4 ;	//reserved
	UINT32 y_coefficient5_h1                  :12;	//27:16
}PE_M17_SR_PSC_Y_H1_Y_FIR_COEF_DATA2_T;
/*-----------------------------------------------------------------------------
                             0xc900a084L SR_PSC_Y_H1_Y_FIR_COEF_DATA3                             
-----------------------------------------------------------------------------*/
typedef struct
{
	UINT32 y_coefficient6_h1                  :12;	//11:0
	UINT32 reserved01                         :4 ;	//reserved
	UINT32 y_coefficient7_h1                  :12;	//27:16
}PE_M17_SR_PSC_Y_H1_Y_FIR_COEF_DATA3_T;
/*-----------------------------------------------------------------------------
                             0xc900a088L SR_PSC_Y_H1_Y_FIR_COEF_DATA4                             
-----------------------------------------------------------------------------*/
typedef struct
{
	UINT32 y_coefficient8_h1                  :12;	//11:0
	UINT32 reserved01                         :4 ;	//reserved
	UINT32 y_coefficient9_h1                  :12;	//27:16
}PE_M17_SR_PSC_Y_H1_Y_FIR_COEF_DATA4_T;
/*-----------------------------------------------------------------------------
                             0xc900a08cL SR_PSC_Y_H1_Y_FIR_COEF_DATA5                             
-----------------------------------------------------------------------------*/
typedef struct
{
	UINT32 y_coefficient10_h1                 :12;	//11:0
	UINT32 reserved01                         :4 ;	//reserved
	UINT32 y_coefficient11_h1                 :12;	//27:16
}PE_M17_SR_PSC_Y_H1_Y_FIR_COEF_DATA5_T;
/*-----------------------------------------------------------------------------
                             0xc900a090L SR_PSC_Y_H2_FIR_COEF_CTRL                             
-----------------------------------------------------------------------------*/
typedef struct
{
	UINT32 update_h2                          :1 ;	//0:0
	UINT32 rnw_h2                             :1 ;	//1:1
	UINT32 addr_h2                            :8 ;	//9:2
}PE_M17_SR_PSC_Y_H2_FIR_COEF_CTRL_T;
/*-----------------------------------------------------------------------------
                             0xc900a094L SR_PSC_Y_H2_Y_FIR_COEF_DATA0                             
-----------------------------------------------------------------------------*/
typedef struct
{
	UINT32 y_coefficient0_h2                  :12;	//11:0
	UINT32 reserved01                         :4 ;	//reserved
	UINT32 y_coefficient1_h2                  :12;	//27:16
}PE_M17_SR_PSC_Y_H2_Y_FIR_COEF_DATA0_T;
/*-----------------------------------------------------------------------------
                             0xc900a098L SR_PSC_Y_H2_Y_FIR_COEF_DATA1                             
-----------------------------------------------------------------------------*/
typedef struct
{
	UINT32 y_coefficient2_h2                  :12;	//11:0
	UINT32 reserved01                         :4 ;	//reserved
	UINT32 y_coefficient3_h2                  :12;	//27:16
}PE_M17_SR_PSC_Y_H2_Y_FIR_COEF_DATA1_T;
/*-----------------------------------------------------------------------------
                             0xc900a09cL SR_PSC_Y_H2_Y_FIR_COEF_DATA2                             
-----------------------------------------------------------------------------*/
typedef struct
{
	UINT32 y_coefficient4_h2                  :12;	//11:0
	UINT32 reserved01                         :4 ;	//reserved
	UINT32 y_coefficient5_h2                  :12;	//27:16
}PE_M17_SR_PSC_Y_H2_Y_FIR_COEF_DATA2_T;
/*-----------------------------------------------------------------------------
                             0xc900a0a0L SR_PSC_Y_H2_Y_FIR_COEF_DATA3                             
-----------------------------------------------------------------------------*/
typedef struct
{
	UINT32 y_coefficient6_h2                  :12;	//11:0
	UINT32 reserved01                         :4 ;	//reserved
	UINT32 y_coefficient7_h2                  :12;	//27:16
}PE_M17_SR_PSC_Y_H2_Y_FIR_COEF_DATA3_T;
...
typedef struct
{
	...
	UINT32 reg_bilinear_on_g0                 :1 ;	//5:5
	UINT32 reg_mode_32p_g0                    :1 ;	//6:6
	UINT32 reserved02                         :7 ;	//reserved
	UINT32 reg_min_max_on_g0                  :1 ;	//14:14
	UINT32 reg_min_max_th_g0                  :10;	//24:15
	UINT32 reg_v_reverse_g0                   :1 ;	//25:25
	UINT32 reserved03                         :1 ;	//reserved
	UINT32 reg_min_max_on_h_g0                :1 ;	//27:27
	UINT32 reg_v_cti_en_g0                    :1 ;	//28:28
	UINT32 reg_v_cti_ratio_g0                 :2 ;	//30:29
	UINT32 reg_sampling_mode_g0               :1 ;	//31:31
}PE_M17_SR_PSC_C_CTRL_T;
/*-----------------------------------------------------------------------------
...
typedef struct
{
	...
	UINT32 reserved01                         :7 ;	//reserved
	UINT32 reg_phase_off_h_m1                 :9 ;	//24:16
}PE_M17_SR_PSC_C_PHASE_OFFSET_T;
/*-----------------------------------------------------------------------------
...
typedef struct
{
	...
	UINT32 rnw_v1                             :1 ;	//1:1
	UINT32 addr_v1                            :8 ;	//9:2
}PE_M17_SR_PSC_C_V1_FIR_COEF_CTRL_T;
/*-----------------------------------------------------------------------------
...
typedef struct
{
	...
	UINT32 reserved01                         :4 ;	//reserved
	UINT32 y_coefficient1_v1                  :12;	//27:16
}PE_M17_SR_PSC_C_V1_Y_FIR_COEF_DATA0_T;
/*-----------------------------------------------------------------------------
...
typedef struct
{
	...
	UINT32 reserved01                         :4 ;	//reserved
	UINT32 y_coefficient3_v1                  :12;	//27:16
}PE_M17_SR_PSC_C_V1_Y_FIR_COEF_DATA1_T;
/*-----------------------------------------------------------------------------
...
typedef struct
{
	...
	UINT32 reserved01                         :4 ;	//reserved
	UINT32 y_coefficient5_v1                  :12;	//27:16
}PE_M17_SR_PSC_C_V1_Y_FIR_COEF_DATA2_T;
/*-----------------------------------------------------------------------------
...
typedef struct
{
	...
	UINT32 reserved01                         :4 ;	//reserved
	UINT32 y_coefficient7_v1                  :12;	//27:16
}PE_M17_SR_PSC_C_V1_Y_FIR_COEF_DATA3_T;
/*-----------------------------------------------------------------------------
...
typedef struct
{
	...
	UINT32 reserved01                         :4 ;	//reserved
	UINT32 y_coefficient9_v1                  :12;	//27:16
}PE_M17_SR_PSC_C_V1_Y_FIR_COEF_DATA4_T;
/*-----------------------------------------------------------------------------
...
typedef struct
{
	...
	UINT32 reserved01                         :4 ;	//reserved
	UINT32 y_coefficient11_v1                 :12;	//27:16
}PE_M17_SR_PSC_C_V1_Y_FIR_COEF_DATA5_T;
/*-----------------------------------------------------------------------------
...
typedef struct
{
	...
	UINT32 rnw_h1                             :1 ;	//1:1
	UINT32 addr_h1                            :8 ;	//9:2
}PE_M17_SR_PSC_C_H1_FIR_COEF_CTRL_T;
/*-----------------------------------------------------------------------------
...
typedef struct
{
	...
	UINT32 reserved01                         :4 ;	//reserved
	UINT32 y_coefficient1_h1                  :12;	//27:16
}PE_M17_SR_PSC_C_H1_Y_FIR_COEF_DATA0_T;
/*-----------------------------------------------------------------------------
...
typedef struct
{
	...
	UINT32 reserved01                         :4 ;	//reserved
	UINT32 y_coefficient3_h1                  :12;	//27:16
}PE_M17_SR_PSC_C_H1_Y_FIR_COEF_DATA1_T;
/*-----------------------------------------------------------------------------
...
typedef struct
{
	...
	UINT32 reserved01                         :4 ;	//reserved
	UINT32 y_coefficient5_h1                  :12;	//27:16
}PE_M17_SR_PSC_C_H1_Y_FIR_COEF_DATA2_T;
/*-----------------------------------------------------------------------------
...
typedef struct
{
	...
	UINT32 reserved01                         :4 ;	//reserved
	UINT32 y_coefficient7_h1                  :12;	//27:16
}PE_M17_SR_PSC_C_H1_Y_FIR_COEF_DATA3_T;
/*-----------------------------------------------------------------------------
...
typedef struct
{
	...
	UINT32 reserved01                         :4 ;	//reserved
	UINT32 y_coefficient9_h1                  :12;	//27:16
}PE_M17_SR_PSC_C_H1_Y_FIR_COEF_DATA4_T;
/*-----------------------------------------------------------------------------
...
typedef struct
{
	...
	UINT32 reserved01                         :4 ;	//reserved
	UINT32 y_coefficient11_h1                 :12;	//27:16
}PE_M17_SR_PSC_C_H1_Y_FIR_COEF_DATA5_T;


typedef struct
{ 
	PE_M17_SR_SHP_CTRL_00_T                              shp_ctrl_00;	//0x0000
	PE_M17_SR_SHP_CTRL_01_T                              shp_ctrl_01;	//0x0004
	PE_M17_SR_SHP_CTRL_02_T                              shp_ctrl_02;	//0x0008
	UINT32                                            reserved3[41];	//0xc-0xac
	PE_M17_SR_SHP_DERH_CTRL_00_T                         shp_derh_ctrl_00;	//0x00B0
	PE_M17_SR_SHP_DERH_CTRL_01_T                         shp_derh_ctrl_01;	//0x00B4
	PE_M17_SR_SHP_DERH_CTRL_02_T                         shp_derh_ctrl_02;	//0x00B8
	PE_M17_SR_SHP_DERH_CTRL_03_T                         shp_derh_ctrl_03;	//0x00BC
	PE_M17_SR_SHP_DERH_CTRL_04_T                         shp_derh_ctrl_04;	//0x00C0
	...
	PE_M17_SR_SHP_DERH_CTRL_08_T                         shp_derh_ctrl_08;	//0x00D0
	PE_M17_SR_SHP_DERH_CTRL_09_T                         shp_derh_ctrl_09;	//0x00D4
	PE_M17_SR_SHP_DERH_CTRL_0A_T                         shp_derh_ctrl_0a;	//0x00D8
	PE_M17_SR_SHP_DERH_CTRL_0B_T                         shp_derh_ctrl_0b;	//0x00DC
	PE_M17_SR_SHP_DERH_CTRL_0C_T                         shp_derh_ctrl_0c;	//0x00E0
	...
	PE_M17_SR_SHP_DERV_CTRL_2_T                          shp_derv_ctrl_2;	//0x00F8
	...
	PE_M17_SR_SHP_SP_CTRL_05_T                           shp_sp_ctrl_05;	//0x0144
	...
	PE_M17_SR_SHP_MP_CTRL_05_T                           shp_mp_ctrl_05;	//0x0184
	...
	PE_M17_SR_SHP_STI_CTRL_01_T                          shp_sti_ctrl_01;	//0x020C
	...
	PE_M17_SR_SHP_BBD_CTRL_00_T                          shp_bbd_ctrl_00;	//0x0280
	PE_M17_SR_SHP_BBD_CTRL_01_T                          shp_bbd_ctrl_01;	//0x0284
	PE_M17_SR_SHP_BBD_CTRL_02_T                          shp_bbd_ctrl_02;	//0x0288
	...
	PE_M17_SR_SHP_WIN2_CTRL_00_T                         shp_win2_ctrl_00;	//0x0350
	PE_M17_SR_SHP_WIN2_CTRL_01_T                         shp_win2_ctrl_01;	//0x0354
	PE_M17_SR_SHP_WIN2_CTRL_02_T                         shp_win2_ctrl_02;	//0x0358
	PE_M17_SR_SHP_WIN2_CTRL_03_T                         shp_win2_ctrl_03;	//0x035C
	PE_M17_SR_SHP_WIN2_CTRL_04_T                         shp_win2_ctrl_04;	//0x0360
	UINT32                                            reserved105[15];	//0x364-0x39c
	PE_M17_SR_SHP_WIN3_CTRL_00_T                         shp_win3_ctrl_00;	//0x03A0
	PE_M17_SR_SHP_WIN3_CTRL_01_T                         shp_win3_ctrl_01;	//0x03A4
	PE_M17_SR_SHP_WIN3_CTRL_02_T                         shp_win3_ctrl_02;	//0x03A8
	PE_M17_SR_SHP_WIN3_CTRL_03_T                         shp_win3_ctrl_03;	//0x03AC
	PE_M17_SR_SHP_WIN3_CTRL_04_T                         shp_win3_ctrl_04;	//0x03B0
	UINT32                                            reserved110[15];	//0x3b4-0x3ec
	PE_M17_SR_SHP_DEBUG_CTRL_00_T                        shp_debug_ctrl_00;	//0x03F0
	PE_M17_SR_SHP_DEBUG_CTRL_01_T                        shp_debug_ctrl_01;	//0x03F4
	PE_M17_SR_SHP_DEBUG_CTRL_02_T                        shp_debug_ctrl_02;	//0x03F8
	UINT32                                            reserved113[129];	//0x3fc-0x5fc
	PE_M17_SR_SHP_STAT_00_T                              shp_stat_00;	//0x0600
	PE_M17_SR_SHP_STAT_01_T                              shp_stat_01;	//0x0604
	PE_M17_SR_SHP_STAT_02_T                              shp_stat_02;	//0x0608
	PE_M17_SR_SHP_STAT_03_T                              shp_stat_03;	//0x060C
	PE_M17_SR_SHP_STAT_04_T                              shp_stat_04;	//0x0610
	PE_M17_SR_SHP_STAT_05_T                              shp_stat_05;	//0x0614
	PE_M17_SR_SHP_STAT_06_T                              shp_stat_06;	//0x0618
	PE_M17_SR_SHP_STAT_07_T                              shp_stat_07;	//0x061C
	UINT32                                            reserved121[32];	//0x620-0x69c
	PE_M17_SR_SHP_CORING_STAT_00_T                       shp_coring_stat_00;	//0x06A0
	PE_M17_SR_SHP_CORING_STAT_01_T                       shp_coring_stat_01;	//0x06A4
	PE_M17_SR_SHP_CORING_STAT_02_T                       shp_coring_stat_02;	//0x06A8
	PE_M17_SR_SHP_CORING_STAT_03_T                       shp_coring_stat_03;	//0x06AC
	UINT32                                            reserved125[12];	//0x6b0-0x6dc
	PE_M17_SR_SHP_SQM_STAT_00_T                          shp_sqm_stat_00;	//0x06E0
	UINT32                                            reserved126[3];	//0x6e4-0x6ec
	PE_M17_SR_SHP_BBD_STAT_00_T                          shp_bbd_stat_00;	//0x06F0
	PE_M17_SR_SHP_BBD_STAT_01_T                          shp_bbd_stat_01;	//0x06F4
	UINT32                                            reserved128[58];	//0x6f8-0x7dc
	PE_M17_SR_SHP_FSW_CTRL_00_T                          shp_fsw_ctrl_00;	//0x07E0
	PE_M17_SR_SHP_FSW_CTRL_01_T                          shp_fsw_ctrl_01;	//0x07E4
	PE_M17_SR_SHP_FSW_CTRL_02_T                          shp_fsw_ctrl_02;	//0x07E8
	PE_M17_SR_SHP_FSW_CTRL_03_T                          shp_fsw_ctrl_03;	//0x07EC
}PE_SR_SHP_REG_M17_T;


typedef struct
{ 
	PE_M17_PIX2LINE_PIC_SIZE_T                        pix2line_pic_size;	//0x0000
	PE_M17_PIX2LINE_PIC_HDUMMY_T                      pix2line_pic_hdummy;	//0x0004
	PE_M17_PIX2LINE_PIC_GAP_T                         pix2line_pic_gap;	//0x0008
	PE_M17_PIX2LINE_PIC_HBLANK_T                      pix2line_pic_hblank;	//0x000C
	PE_M17_PIX2LINE_PIC_HSSIZE_T                      pix2line_pic_hssize;	//0x0010
	PE_M17_PIX2LINE_PIC_VSPACE_T                      pix2line_pic_vspace;	//0x0014
	PE_M17_PIX2LINE_PIC_PREHSYNC_T                    pix2line_pic_prehsync;	//0x0018
	PE_M17_LINE2PIX_PIC_SIZE_T                        line2pix_pic_size;	//0x001C
	PE_M17_LINE2PIX_PIC_ESPACE_T                      line2pix_pic_espace;	//0x0020
	PE_M17_PIX2LINE_MON0_T                            pix2line_mon0;	//0x0024
	PE_M17_PIX2LINE_MON1_T                            pix2line_mon1;	//0x0028
	PE_M17_PIX2LINE_MON2_T                            pix2line_mon2;	//0x002C
	PE_M17_LINE2PIX_MON0_T                            line2pix_mon0;	//0x0030
	PE_M17_LINE2PIX_MON1_T                            line2pix_mon1;	//0x0034
	PE_M17_LINE2PIX_MON2_T                            line2pix_mon2;	//0x0038
	UINT32                                            reserved15;	//0x3c
	PE_M17_LINE2PIX_MON3_T                            line2pix_mon3;	//0x0040
	UINT32                                            reserved16[2];	//0x44-0x48
	PE_M17_LINE2PIX_MON4_T                            line2pix_mon4;	//0x004C
}PE_SR_SHP_BRG_REG_M17_T;


typedef struct
{ 
	PE_M17_SR_PSC_Y_CTRL_T                            sr_psc_y_ctrl;	//0x0000
	UINT32                                            reserved1;	//0x4
	PE_M17_SR_PSC_Y_OUTSIZE_T                         sr_psc_y_outsize;	//0x0008
	UINT32                                            reserved2[3];	//0xc-0x14
	PE_M17_SR_PSC_Y_INSIZE_T                          sr_psc_y_insize;	//0x0018
	UINT32                                            reserved3;	//0x1c
	PE_M17_SR_PSC_Y_PHASE_OFFSET_T                    sr_psc_y_phase_offset;	//0x0020
	PE_M17_SR_PSC_Y_SAMPLING_H_T                      sr_psc_y_sampling_h;	//0x0024
	PE_M17_SR_PSC_Y_SAMPLING_V_T                      sr_psc_y_sampling_v;	//0x0028
	UINT32                                            reserved6[6];	//0x2c-0x40
	PE_M17_SR_PSC_Y_V1_FIR_COEF_CTRL_T                sr_psc_y_v1_fir_coef_ctrl;	//0x0044
	PE_M17_SR_PSC_Y_V1_Y_FIR_COEF_DATA0_T             sr_psc_y_v1_y_fir_coef_data0;	//0x0048
	PE_M17_SR_PSC_Y_V1_Y_FIR_COEF_DATA1_T             sr_psc_y_v1_y_fir_coef_data1;	//0x004C
	PE_M17_SR_PSC_Y_V1_Y_FIR_COEF_DATA2_T             sr_psc_y_v1_y_fir_coef_data2;	//0x0050
	PE_M17_SR_PSC_Y_V1_Y_FIR_COEF_DATA3_T             sr_psc_y_v1_y_fir_coef_data3;	//0x0054
	PE_M17_SR_PSC_Y_V1_Y_FIR_COEF_DATA4_T             sr_psc_y_v1_y_fir_coef_data4;	//0x0058
	PE_M17_SR_PSC_Y_V1_Y_FIR_COEF_DATA5_T             sr_psc_y_v1_y_fir_coef_data5;	//0x005C
	PE_M17_SR_PSC_Y_V2_FIR_COEF_CTRL_T                sr_psc_y_v2_fir_coef_ctrl;	//0x0060
	PE_M17_SR_PSC_Y_V2_Y_FIR_COEF_DATA0_T             sr_psc_y_v2_y_fir_coef_data0;	//0x0064
	PE_M17_SR_PSC_Y_V2_Y_FIR_COEF_DATA1_T             sr_psc_y_v2_y_fir_coef_data1;	//0x0068
	PE_M17_SR_PSC_Y_V2_Y_FIR_COEF_DATA2_T             sr_psc_y_v2_y_fir_coef_data2;	//0x006C
	PE_M17_SR_PSC_Y_V2_Y_FIR_COEF_DATA3_T             sr_psc_y_v2_y_fir_coef_data3;	//0x0070
	PE_M17_SR_PSC_Y_H1_FIR_COEF_CTRL_T                sr_psc_y_h1_fir_coef_ctrl;	//0x0074
	PE_M17_SR_PSC_Y_H1_Y_FIR_COEF_DATA0_T             sr_psc_y_h1_y_fir_coef_data0;	//0x0078
	PE_M17_SR_PSC_Y_H1_Y_FIR_COEF_DATA1_T             sr_psc_y_h1_y_fir_coef_data1;	//0x007C
	PE_M17_SR_PSC_Y_H1_Y_FIR_COEF_DATA2_T             sr_psc_y_h1_y_fir_coef_data2;	//0x0080
	PE_M17_SR_PSC_Y_H1_Y_FIR_COEF_DATA3_T             sr_psc_y_h1_y_fir_coef_data3;	//0x0084
	PE_M17_SR_PSC_Y_H1_Y_FIR_COEF_DATA4_T             sr_psc_y_h1_y_fir_coef_data4;	//0x0088
	PE_M17_SR_PSC_Y_H1_Y_FIR_COEF_DATA5_T             sr_psc_y_h1_y_fir_coef_data5;	//0x008C
	PE_M17_SR_PSC_Y_H2_FIR_COEF_CTRL_T                sr_psc_y_h2_fir_coef_ctrl;	//0x0090
	PE_M17_SR_PSC_Y_H2_Y_FIR_COEF_DATA0_T             sr_psc_y_h2_y_fir_coef_data0;	//0x0094
	PE_M17_SR_PSC_Y_H2_Y_FIR_COEF_DATA1_T             sr_psc_y_h2_y_fir_coef_data1;	//0x0098
	PE_M17_SR_PSC_Y_H2_Y_FIR_COEF_DATA2_T             sr_psc_y_h2_y_fir_coef_data2;	//0x009C
	PE_M17_SR_PSC_Y_H2_Y_FIR_COEF_DATA3_T             sr_psc_y_h2_y_fir_coef_data3;	//0x00A0
}PE_SR_PSC_Y_REG_M17_T;


typedef struct
{ 
	PE_M17_SR_PSC_C_CTRL_T                            sr_psc_c_ctrl;	//0x0000
	UINT32                                            reserved1;	//0x4
	PE_M17_SR_PSC_C_OUTSIZE_T                         sr_psc_c_outsize;	//0x0008
	UINT32                                            reserved2[3];	//0xc-0x14
	PE_M17_SR_PSC_C_INSIZE_T                          sr_psc_c_insize;	//0x0018
	UINT32                                            reserved3;	//0x1c
	PE_M17_SR_PSC_C_PHASE_OFFSET_T                    sr_psc_c_phase_offset;	//0x0020
	PE_M17_SR_PSC_C_SAMPLING_H_T                      sr_psc_c_sampling_h;	//0x0024
	PE_M17_SR_PSC_C_SAMPLING_V_T                      sr_psc_c_sampling_v;	//0x0028
	UINT32                                            reserved6[6];	//0x2c-0x40
	PE_M17_SR_PSC_C_V1_FIR_COEF_CTRL_T                sr_psc_c_v1_fir_coef_ctrl;	//0x0044
	PE_M17_SR_PSC_C_V1_Y_FIR_COEF_DATA0_T             sr_psc_c_v1_y_fir_coef_data0;	//0x0048
	PE_M17_SR_PSC_C_V1_Y_FIR_COEF_DATA1_T             sr_psc_c_v1_y_fir_coef_data1;	//0x004C
	PE_M17_SR_PSC_C_V1_Y_FIR_COEF_DATA2_T             sr_psc_c_v1_y_fir_coef_data2;	//0x0050
	PE_M17_SR_PSC_C_V1_Y_FIR_COEF_DATA3_T             sr_psc_c_v1_y_fir_coef_data3;	//0x0054
	PE_M17_SR_PSC_C_V1_Y_FIR_COEF_DATA4_T             sr_psc_c_v1_y_fir_coef_data4;	//0x0058
	PE_M17_SR_PSC_C_V1_Y_FIR_COEF_DATA5_T             sr_psc_c_v1_y_fir_coef_data5;	//0x005C
	UINT32                                            reserved13[5];	//0x60-0x70
	PE_M17_SR_PSC_C_H1_FIR_COEF_CTRL_T                sr_psc_c_h1_fir_coef_ctrl;	//0x0074
	PE_M17_SR_PSC_C_H1_Y_FIR_COEF_DATA0_T             sr_psc_c_h1_y_fir_coef_data0;	//0x0078
	PE_M17_SR_PSC_C_H1_Y_FIR_COEF_DATA1_T             sr_psc_c_h1_y_fir_coef_data1;	//0x007C
	PE_M17_SR_PSC_C_H1_Y_FIR_COEF_DATA2_T             sr_psc_c_h1_y_fir_coef_data2;	//0x0080
	PE_M17_SR_PSC_C_H1_Y_FIR_COEF_DATA3_T             sr_psc_c_h1_y_fir_coef_data3;	//0x0084
	PE_M17_SR_PSC_C_H1_Y_FIR_COEF_DATA4_T             sr_psc_c_h1_y_fir_coef_data4;	//0x0088
	PE_M17_SR_PSC_C_H1_Y_FIR_COEF_DATA5_T             sr_psc_c_h1_y_fir_coef_data5;	//0x008C
}PE_SR_PSC_C_REG_M17_T;
#endif