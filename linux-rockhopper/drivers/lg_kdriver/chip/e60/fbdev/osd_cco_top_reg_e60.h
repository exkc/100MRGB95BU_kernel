#ifndef __OSD_TOP_CCO1_CTRL_E60_H__
#define __OSD_TOP_CCO1_CTRL_E60_H__

/* this register is generated from TopCTRL_D.CCO1_CTRL */
/* this register is generated from TopCTRL_D.CCO2_CTRL */
...
typedef struct {
	UINT32
	reg_sel_dpath                   : 2,	//  0: 1
	reg_endian_sel_csr              : 1,	//     2
	reg_endian_sel_txt              : 1,	//     3
	reg_rgb2yc_o_en                 : 1,	//     4
	reg_rgb2yc_e_en                 : 1,	//     5
	reg_yc2rgb_o_en                 : 1,	//     6
	reg_yc2rgb_e_en                 : 1,	//     7
	reg_endian_sel_fac              : 1,	//     8
	reg_endian_sel_obj              : 1,	//     9
	reg_gate_cmd_len1               : 1,	//    10
	reg_gate_cmd_len0               : 1,	//    11
	reg_dsc_detour_en               : 1,	//    12
	sel_osd_src_bosd0               : 1,	//    13
...
typedef struct {
	...
	reg_path_reset_en_osd           : 1,	//     1
	reg_path_reset_en_sosd          : 1,	//     2
	                                : 5,	//  3: 7 reserved
	reg_osdsr_auto_picinit_en       : 2,	//  8: 9
	                                :21,	// 10:30 reserved
	reg_isync_pulse_sel             : 1;	//    31
} CTRL_BLOCK;
...
typedef struct {
	UINT32
	sosd_init_2nd_line              :16,	//  0:15
	                                :12,	// 16:27 reserved
	sosd_init_2nd_en                : 1;	//    28
} CTRL_SOSD_INIT_2ND;
...
typedef struct {
	UINT32
	reg_cc_eo_hif_en                : 1,	//     0
	                                : 3,	//  1: 3 reserved
	reg_cc_detour_en                : 1;	//     4
} CTRL_CC_TOP;
...
typedef struct {
	UINT32
	rst_async_bridge_video          : 1,	//     0
	rst_async_bridge_osd_img0       : 1,	//     1
	                                : 1,	//     2 reserved
	rst_async_bridge_csr0           : 1,	//     3
	                                : 1,	//     4 reserved
	rst_async_bridge_l3d            : 1,	//     5
	                                : 1,	//     6 reserved
	rst_async_bridge_logo           : 1,	//     7
	reg_gater_rx_osdysr0_en         : 1,	//     8
	reg_gater_rx_osdysr1_en         : 1,	//     9
	reg_gater_rx_osdasr0_en         : 1,	//    10
	reg_gater_rx_osdasr1_en         : 1,	//    11
	reg_gate_tx_osd_est_en          : 1,	//    12
	reg_gate_tx_osd_est_dp_sel      : 3,	// 13:15
	reg_gate_tx_l3d_en              : 1,	//    16
	reg_gate_tx_l3d_dp_sel          : 3,	// 17:19
	reg_gate_tx_csr_en              : 1,	//    20
	reg_gate_tx_csr_dp_sel          : 3,	// 21:23
	reg_ctrl_fpga                   : 8;	// 24:31
} CTRL_GPIO;
...
OSD_CCO_TOP_E60_REG_T, OSD_CCO1_TOP_E60_REG_T, OSD_CCO2_TOP_E60_REG_T; /* 59 regs, 59 types */

/* 59 regs, 59 types in Total*/

#define OSD_CCO1_TOP_E60_RdFL(_r)	OSD_CCO_TOP_RdFL(osdx_cco1_top,_r)
#define OSD_CCO1_TOP_E60_WrFL(_r) 	OSD_CCO_TOP_WrFL(osdx_cco1_top,_r)

#define OSD_CCO1_TOP_E60_Rd(_r)		OSD_CCO_TOP_Rd(osdx_cco1_top,_r)
#define OSD_CCO1_TOP_E60_Wr(_r,_v)	OSD_CCO_TOP_Wr(osdx_cco1_top,_r,_v)

#define OSD_CCO1_TOP_E60_Rd01(_r,_f01,_v01)	\
									OSD_CCO_TOP_Rd01(osdx_cco1_top,_r,_f01,_v01)
#define OSD_CCO1_TOP_E60_Rd02(_r,_f01,_v01,_f02,_v02) \
									OSD_CCO_TOP_Rd02(osdx_cco1_top,_r,_f01,_v01,_f02,_v02)
#define OSD_CCO1_TOP_E60_Wr01(_r,_f01,_v01) \
									OSD_CCO_TOP_Wr01(osdx_cco1_top,_r,_f01,_v01)

#define OSD_CCO1_TOP_E60_Wr02(_r,_f01,_v01,_f02,_v02) \
									OSD_CCO_TOP_Wr02(osdx_cco1_top,_r,_f01,_v01,_f02,_v02)

#define OSD_CCO1_TOP_E60_Wr07(_r,_f01,_v01,_f02,_v02,_f03,_v03,_f04,_v04,_f05,_v05,_f06,_v06,_f07,_v07) \
									OSD_CCO_TOP_Wr07(osdx_cco1_top,_r,_f01,_v01,_f02,_v02,_f03,_v03,_f04,_v04,_f05,_v05,_f06,_v06,_f07,_v07)

#define OSD_CCO2_TOP_E60_RdFL(_r)	OSD_CCO_TOP_RdFL(osdx_cco2_top,_r)
#define OSD_CCO2_TOP_E60_WrFL(_r) 	OSD_CCO_TOP_WrFL(osdx_cco2_top,_r)

#define OSD_CCO2_TOP_E60_Rd(_r)		OSD_CCO_TOP_Rd(osdx_cco2_top,_r)
#define OSD_CCO2_TOP_E60_Wr(_r,_v)	OSD_CCO_TOP_Wr(osdx_cco2_top,_r,_v)

#define OSD_CCO2_TOP_E60_Rd01(_r,_f01,_v01)	\
									OSD_CCO_TOP_Rd01(osdx_cco2_top,_r,_f01,_v01)
#define OSD_CCO2_TOP_E60_Rd02(_r,_f01,_v01,_f02,_v02) \
									OSD_CCO_TOP_Rd02(osdx_cco2_top,_r,_f01,_v01,_f02,_v02)
#define OSD_CCO2_TOP_E60_Wr01(_r,_f01,_v01) \
									OSD_CCO_TOP_Wr01(osdx_cco2_top,_r,_f01,_v01)

#define OSD_CCO2_TOP_E60_Wr02(_r,_f01,_v01,_f02,_v02) \
									OSD_CCO_TOP_Wr02(osdx_cco2_top,_r,_f01,_v01,_f02,_v02)


// cco top ctrl 에 대한 access 개선
#define OSD_CCO_TOP_Off(id,_r) 		((UINT64)&(g_osd_cco_top_e60_reg_shadow[id]->_r) - (UINT64)(g_osd_cco_top_e60_reg_shadow[id]))
#define OSD_CCO_TOP_RdFL(id,_r)		((g_osd_cco_top_e60_reg_shadow[id]->_r)=(g_osd_cco_top_e60_reg[id]->_r))
#ifdef	FBDEV_E60_USE_REG_DEBUG
#define OSD_CCO_TOP_WrFL(id,_r) \
									do { \
										FBDEV_E60_CMN_RegDebug((id==0)? CCO_CCO1_CTRL_BASE:CCO_CCO2_CTRL_BASE, OSD_CCO_TOP_Off(id,_r), OSD_CCO_TOP_Rd(id,_r)); \
										(g_osd_cco_top_e60_reg[id]->_r)=(g_osd_cco_top_e60_reg_shadow[id]->_r); \
									} while(0)
#else
#define OSD_CCO_TOP_WrFL(id,_r) 	((g_osd_cco_top_e60_reg[id]->_r)=(g_osd_cco_top_e60_reg_shadow[id]->_r))
#endif

#define OSD_CCO_TOP_Rd(id,_r) 		*((UINT32*)(&(g_osd_cco_top_e60_reg_shadow[id]->_r)))
#define OSD_CCO_TOP_Wr(id,_r,_v)	((OSD_CCO_TOP_Rd(id,_r))=((UINT32)(_v)))

#define OSD_CCO_TOP_E60_Rd01(id,_r,_f01,_v01) \
									do { \
										(_v01) = (g_osd_cco_top_e60_reg_shadow[id]->_r._f01); \
									} while(0)

#define OSD_CCO_TOP_Rd01(id,_r,_f01,_v01) \
									do { \
										(_v01) = (g_osd_cco_top_e60_reg_shadow[id]->_r._f01); \
									} while(0)

#define OSD_CCO_TOP_Rd02(id,_r,_f01,_v01,_f02,_v02) \
									do { \
										(_v01) = (g_osd_cco_top_e60_reg_shadow[id]->_r._f01); \
										(_v02) = (g_osd_cco_top_e60_reg_shadow[id]->_r._f02); \
									} while(0)

#define OSD_CCO_TOP_Wr01(id,_r,_f01,_v01) \
									do { \
										(g_osd_cco_top_e60_reg_shadow[id]->_r._f01) = (_v01); \
									} while(0)

#define OSD_CCO_TOP_Wr02(id,_r,_f01,_v01,_f02,_v02) \
									do { \
										(g_osd_cco_top_e60_reg_shadow[id]->_r._f01) = (_v01); \
										(g_osd_cco_top_e60_reg_shadow[id]->_r._f02) = (_v02); \
									} while(0)

#define OSD_CCO_TOP_Wr07(id,_r,_f01,_v01,_f02,_v02,_f03,_v03,_f04,_v04,_f05,_v05,_f06,_v06,_f07,_v07) \
									do { \
										(g_osd_cco_top_e60_reg_shadow[id]->_r._f01) = (_v01); \
										(g_osd_cco_top_e60_reg_shadow[id]->_r._f02) = (_v02); \
										(g_osd_cco_top_e60_reg_shadow[id]->_r._f03) = (_v03); \
										(g_osd_cco_top_e60_reg_shadow[id]->_r._f04) = (_v04); \
										(g_osd_cco_top_e60_reg_shadow[id]->_r._f05) = (_v05); \
										(g_osd_cco_top_e60_reg_shadow[id]->_r._f06) = (_v06); \
										(g_osd_cco_top_e60_reg_shadow[id]->_r._f07) = (_v07); \
							} while(0)

#define	osdx_cco1_top	0
#define	osdx_cco2_top	1

extern volatile OSD_CCO_TOP_E60_REG_T*  g_osd_cco_top_e60_reg[2];
extern OSD_CCO_TOP_E60_REG_T*           g_osd_cco_top_e60_reg_shadow[2];
...
/* from 'E60-A0_PQE_TopCTRL_D_reg_man0.csv' 20191214 00:11:17 KST by getregs v2.9 */
