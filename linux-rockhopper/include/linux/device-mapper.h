...
#ifdef CONFIG_DM_WEBOS_VERITY
typedef int (*dm_verity_clear_validated_blocks_fn) (struct dm_target *ti);
#endif
...
#ifdef CONFIG_DM_WEBOS_VERITY
	dm_verity_clear_validated_blocks_fn clear_validated_blocks;
#endif
...
void clear_all_validated_blocks(void);
#endif
