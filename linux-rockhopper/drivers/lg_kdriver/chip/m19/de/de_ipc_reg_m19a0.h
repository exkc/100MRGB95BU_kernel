...
#ifndef _IPC_REG_M19A0_H_
#define _IPC_REG_M19A0_H_
...
typedef struct {
	M19A0_SET_REG_CTRL0_T              	set_reg_ctrl0;                //0xc8026000L
	M19A0_SET_REG_CTRL1_T              	set_reg_ctrl1;                //0xc8026004L
	M19A0_EXT_INTR_EVENT_T             	ext_intr_event;               //0xc8026008L
	M19A0_EXT_INTR_ENABLE_T            	ext_intr_enable;              //0xc802600cL
	M19A0_EXT_INTR_STATUS_T            	ext_intr_status;              //0xc8026010L
	M19A0_EXT_INTR_CLEAR_T             	ext_intr_clear;               //0xc8026014L
	M19A0_INT_INTR_EVENT_T             	int_intr_event;               //0xc8026018L
	M19A0_INT_INTR_ENABLE_T            	int_intr_enable;              //0xc802601cL
	M19A0_INT_INTR_STATUS_T            	int_intr_status;              //0xc8026020L
	M19A0_INT_INTR_CLEAR_T             	int_intr_clear;               //0xc8026024L
	M19A0_SROM_BOOT_MAP1_T             	srom_boot_map1;               //0xc8026028L
	M19A0_SROM_BOOT_MAP2_T             	srom_boot_map2;               //0xc802602cL
	M19A0_SRAM_PORT_SEL_T              	sram_port_sel;                //0xc8026030L
	M19A0_PDEBUG_STATUS_T              	pdebug_status;                //0xc8026034L
	M19A0_PDEBUG_DATA_T                	pdebug_data;                  //0xc8026038L
	M19A0_PDEBUG_PC_T                  	pdebug_pc;                    //0xc802603cL
	M19A0_AXI_USER_ID_T                	axi_user_id;                  //0xc8026040L
	M19A0_SRAM0_OFFSET_T               	sram0_offset;                 //0xc8026044L
	M19A0_SRAM1_OFFSET_T               	sram1_offset;                 //0xc8026048L
	M19A0_SRAM2_OFFSET_T               	sram2_offset;                 //0xc802604cL
	M19A0_SRAM3_OFFSET_T               	sram3_offset;                 //0xc8026050L
	UINT32                             	reserved00[2];                //0xc8026054L~0xc8026058L
	M19A0_SPP_MCU_VERSION_T            	spp_mcu_version;              //0xc802605cL
	M19A0_INTR_MCU_FLAG_T              	intr_mcu_flag;                //0xc8026060L
	M19A0_INTR_MCU_FLAG_EN_T           	intr_mcu_flag_en;             //0xc8026064L
	M19A0_INTR_CPU_FLAG_T              	intr_cpu_flag;                //0xc8026068L
	M19A0_INTR_CPU_FLAG_EN_T            intr_cpu_flag_en;             //0xc802606cL
	UINT32                             	reserved01[36];               //0xc8026070L~0xc80260fcL
	M19A0_CPU_IPC0_T                   	cpu_ipc0;                     //0xc8026100L
	UINT32                             	reserved02[62];               //0xc8026104L~0xc80261f8L
	M19A0_CPU_IPC63_T                  	cpu_ipc63;                    //0xc80261fcL
	UINT32                             	reserved03[63];               //0xc8026200L~0xc80262f8L
	M19A0_VDEC_INTR_T                  	vdec_intr;                    //0xc80262fcL
	UINT32                             	reserved04[64];               //0xc8026300L~0xc80263fcL
	M19A0_TX_LOCKED_ID_T               	tx_locked_id;                 //0xc8026400L
	M19A0_TX_SRC_ADDR_T                	tx_src_addr;                  //0xc8026404L
	M19A0_TX_DST_ADDR_T                	tx_dst_addr;                  //0xc8026408L
	M19A0_TX_NXT_ADDR_T                	tx_nxt_addr;                  //0xc802640cL
	M19A0_TX_LENGTH_T                  	tx_length;                    //0xc8026410L
	M19A0_EDMA_CTRL_T                  	edma_ctrl;                    //0xc8026414L
} DE_IPC_REG_M19A0_T;
