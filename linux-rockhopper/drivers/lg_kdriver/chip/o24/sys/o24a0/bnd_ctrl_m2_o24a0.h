#ifndef _BND_CTRL_M2_REG_O24A0_H_
#define _BND_CTRL_M2_REG_O24A0_H_
...
}BND_CTRL_M2_M2_SYN_00_O24A0_T;

/*-----------------------------------------------------------------------------------------
    0xC453_2004    m2_syn_01 ''
-----------------------------------------------------------------------------------------*/
typedef struct {
    UINT32
...
}BND_CTRL_M2_M2_SYN_01_O24A0_T;

/*-----------------------------------------------------------------------------------------
    0xC453_2008    m2_syn_02 ''
-----------------------------------------------------------------------------------------*/
typedef struct {
    UINT32
...
}BND_CTRL_M2_M2_SYN_02_O24A0_T;

/*-----------------------------------------------------------------------------------------
    0xC453_200C    m2_syn_03 ''
-----------------------------------------------------------------------------------------*/
typedef struct {
    UINT32
...
typedef struct {
    ...
    reg_pll_mon_en            :  1,    //      0
                              : 31;    //   31:1 reserved
}BND_CTRL_M2_PLL_MON_O24A0_T;

/*-----------------------------------------------------------------------------------------
    bnd_ctrl_m2 Register LIst
-----------------------------------------------------------------------------------------*/
typedef struct {
    BND_CTRL_M2_M2_SYN_00_O24A0_T      m2_syn_00  ;             // 0xC453_2000
    BND_CTRL_M2_M2_SYN_01_O24A0_T      m2_syn_01  ;             // 0xC453_2004
    BND_CTRL_M2_M2_SYN_02_O24A0_T      m2_syn_02  ;             // 0xC453_2008
    BND_CTRL_M2_M2_SYN_03_O24A0_T      m2_syn_03  ;             // 0xC453_200C
    UINT32                             _rsvd_00[1];             // 0xC453_2010
    BND_CTRL_M2_PLL_MON_O24A0_T        pll_mon    ;             // 0xC453_2014
}BND_CTRL_M2_REG_O24A0_T;
/* 5 regs */
...
#define BND_CTRL_M2_M2_SYN_00_O24A0_T_OFF                   (BASEADDRESS+0x0000)
#define BND_CTRL_M2_M2_SYN_01_O24A0_T_OFF                   (BASEADDRESS+0x0004)
#define BND_CTRL_M2_M2_SYN_02_O24A0_T_OFF                   (BASEADDRESS+0x0008)
#define BND_CTRL_M2_M2_SYN_03_O24A0_T_OFF                   (BASEADDRESS+0x000C)
#define BND_CTRL_M2_PLL_MON_O24A0_T_OFF                     (BASEADDRESS+0x0014)
