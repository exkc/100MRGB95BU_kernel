...
#ifndef	_PM_O24_COMMON_H_
#define	_PM_O24_COMMON_H_
...
/* o24_gov_status.governor status  */
...
#define O24_DVFS_ENABLE
	//#define USE_KER_CPUFREQ
	/*defined: use kernel cpufreq ndefined: use kdrv cpuferq */


#define O24_CPU_FREQ_OD 1400
#define O24_CPU_FREQ_ND 1400
#define O24_CPU_FREQ_UD 1050
...
#define O24_SLT_HIGH_AVS_SET_DELAY 1 /* sec */
#define O24_SLT_LOW_AVS_SET_DELAY 1 /* sec */
#define O24_AVS_SET_DELAY 30 /* sec */

#define O24_GOV_START_DELAY 50

#define AVS_NOT_INITED 0

/* o24_load_dump related*/
...
#define O24_CPU_DFTFREQ	660 //Mhz
#define O24_CPU_NORMALFREQ	1400 //Mhz

#define O24_CORE_AVS_INVALID_MAX   6  /* invalid max */
...
#define O24_CPU_AVS_INVALID_MAX   5  /* invalid max */
...
#define O24_CPU_AVS_S_UV            981000
#define O24_CPU_AVS_N_UV            960000
#define O24_CPU_AVS_F_UV            941000
#define O24_CPU_AVS_FF_UV           920000

/* need to update jun.kong */
#define O24_CPU_AVS_FF_HTEMP_UV     920000

#define O24_CORE_AVS_S_UV           981000
#define O24_CORE_AVS_N_UV           960000
#define O24_CORE_AVS_F_UV           941000
#define O24_CORE_AVS_FF_UV          920000

/* need to update jun.kong */
#define O24_CORE_AVS_S_HTEMP_UV     981000
#define O24_CORE_AVS_N_HTEMP_UV     960000
#define O24_CORE_AVS_F_HTEMP_UV     941000
#define O24_CORE_AVS_FF_HTEMP_UV    920000

#define O24_AVS_STEP_DELAY          2000 /* ms */
#define O24_AVS_STEP_DELAY_SLT      500  /* ms */
...
typedef struct
{
	...
	void  		(*run)(pms_o24_work_t * o24work);
	void  		(*run_clk)(pms_o24_work_t * o24work);
	void  		(*run_regul)(pms_o24_work_t  * o24work);
	void  		(*run_coreregul)(pms_o24_work_t  * o24work);
	void  		(*reset)(void);
...
typedef struct
{
	...
	int 			(*get_cpu_avs_type)(pms_o24_avsinto_t *);
	int 			(*get_core_avs_type)(pms_o24_avsinto_t *);
...
pms_o24_cg_t* get_o24_pm_cg(void);
...
int o24_set_clock_gating(unsigned int module, unsigned int sub, unsigned int state);
int o24_get_clock_gating(unsigned int module, unsigned int sub, unsigned int *state);
