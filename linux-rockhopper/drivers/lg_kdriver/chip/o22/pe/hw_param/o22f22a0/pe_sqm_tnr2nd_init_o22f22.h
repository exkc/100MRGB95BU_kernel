...
const UINT32 sqm_tnr2nd_init_o22f22[] =
{
	0x00001409,  //UINT32 reg_SQM_master_gain [4];
	0x00002101,  //UINT32 reg_temp_0[4];
	0xC6804000,  //UINT32 reg_temp_1[4];
	0x06000000,  //UINT32 reg_temp_2[4];
	0x00002051,  //UINT32 reg_temp_3[4];
