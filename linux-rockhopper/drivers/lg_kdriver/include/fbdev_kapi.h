...
#define FBDEV_IOW_SET_USER_FLIP_HANDLER _IOW( FBDEV_IOC_MAGIC, FBDEV_IOC_IDX(34), UINT32 )
#define FBDEV_IOW_SET_USER_FLIP_ACK     _IOW( FBDEV_IOC_MAGIC, FBDEV_IOC_IDX(35), LX_FBDEV_USER_FLIP_T )
...
/*----------------------------------------------------------------------------------------
    Macro Definitions
----------------------------------------------------------------------------------------*/
#define LX_FBDEV_SCREEN_PER_DEVICE  2       /** obsolete. DO NOT use this */
#define LX_FBDEV_GFX_PLANE_MAX      2       /** OSD driver supports maximum two graphic plane */

#define LX_FBDEV_STR_ARGS_MAX       32      /** max length of string argument */
...
typedef enum
{
    ...
    LX_FBDEV_ID_OSD2    = 2,    /**< obsolete. DO NOT use this */
...
typedef struct
{
    ...
    struct
    {
        UINT32      b_little_endian     : 1, /**< OSD data is assumed to little endian ? */
                    ...
                    b_gfx_lock_req      : 1, /**< OSD is using GFX block for some H/W workaround.
                                                  so application should consider GFX lock when requesting FB operation */
                    b_use_trid_hw       : 1,
                    b_use_builtin_fbmem : 1, /**< OSD contains dedicated FB memory ? */
                    b_use_afbc          : 1, /**< OSD can display AFBC formated image */
                    b_cursor            : 1, /*<< OSD is used for cursor ? */
                    rsvd: 3;
...
typedef enum
{
    LX_FBDEV_PIXEL_FORMAT_NOT_DEFINED = 0,

    LX_FBDEV_PIXEL_FORMAT_YCBCR_655,
    LX_FBDEV_PIXEL_FORMAT_YCBCR_2644,
    LX_FBDEV_PIXEL_FORMAT_YCBCR_4833,
    LX_FBDEV_PIXEL_FORMAT_YCBCR_6433,
    LX_FBDEV_PIXEL_FORMAT_YCBCR_888,
    LX_FBDEV_PIXEL_FORMAT_YCBCR_8655,
    LX_FBDEV_PIXEL_FORMAT_YCBCR_8888,

    LX_FBDEV_PIXEL_FORMAT_RGB_565,
    LX_FBDEV_PIXEL_FORMAT_RGB_1555,
    LX_FBDEV_PIXEL_FORMAT_RGB_4444,
    LX_FBDEV_PIXEL_FORMAT_RGB_6343,
    LX_FBDEV_PIXEL_FORMAT_RGB_888,
    LX_FBDEV_PIXEL_FORMAT_RGB_8565,
    LX_FBDEV_PIXEL_FORMAT_RGB_8888,
    LX_FBDEV_PIXEL_FORMAT_BGR_8888,
}
LX_FBDEV_PIXEL_FORMAT_T;

/** OSD frame buffer format
 *
 */
typedef enum
{
    LX_FBDEV_FBC_FORMAT_RAW     = 0,            /**< RAW format. non compressed. default format */
    LX_FBDEV_FBC_FORMAT_AFBC    = 1,            /**< compressed by AFBC */
    LX_FBDEV_FBC_FORMAT_FBC0    = 2,            /**< compressed by LG FBC (compact mode) */
    LX_FBDEV_FBC_FORMAT_FBC1    = 3,            /**< compressed by LG FBC (sparse mode) */
    LX_FBDEV_FBC_FORMAT_AFRC    = 4,            /**< compressed by AFRC */
}
LX_FBDEV_FBC_FORMAT_T;

#define LX_FBDEV_FBC_FORMAT_TYPE_DEFINED        /* DO NOT undef */
...
typedef struct
{
    ...
    UINT32                  color_key_enable: 1,    ///< enable/disable color key.
                             ...
                             * OBSOLETE !! reverse_screen_enable is not supported anymore.
                             */
...
#define LX_FBDEV_VIDEO_MIXER_ID_MAX 2   /**< LG soc supports the max 3 independent video mixer. but it's enough to support only two region */
    ...
    LX_RECT_T
    mix_win;                            /**< rectangular information for video mixer area. its valid region is (0,0,1920,1080) */
}
...
typedef struct
{
#ifdef LX_FBDEV_FBC_FORMAT_TYPE_DEFINED
    LX_FBDEV_FBC_FORMAT_T   fbc_fmt;    /**< RAW or FBC format */
#endif
    ...
    LX_FBDEV_PIXEL_FORMAT_T     pixel_fmt;      /**< pixel format - ARGB/ABGR only */
}
LX_FBDEV_FB_IMAGE_T;


/** user controlled flip context
 *
 *
 */
typedef struct
{
    ...
    UINT32              session_no;     /**< different value per earch pan_display */
}
LX_FBDEV_USER_FLIP_T;
...
/*----------------------------------------------------------------------------------------
    Linux FrameBuffer Extention
----------------------------------------------------------------------------------------*/
#define FB_ACCEL_LG_AFBC        0xb0 /* fb_fix_screeninfo.accel for FBIOGET_FSCREENINFO ioctl */
#define FB_ACCEL_LG_AFBC_1_0    (FB_ACCEL_LG_AFBC|0x0)
#define FB_ACCEL_LG_AFBC_1_1    (FB_ACCEL_LG_AFBC|0x1)

#define FB_ACCELF_LG_AFBC       0x02 /* fb_var_screeninfo.accel_flags for pan_display ioctl */
