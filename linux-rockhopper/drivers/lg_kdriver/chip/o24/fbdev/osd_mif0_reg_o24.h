...
#ifndef __OSD_MIF0_REG_O24_H__
#define __OSD_MIF0_REG_O24_H__
...
typedef struct {
	...
	cmd_stride_mod                  : 2,	// 26:27
	reserved_1                      : 2;	// 28:29
} R_LSR_L3_M_CMD_STRIDE;

/*-----------------------------------------------------------------------------
	0x004c r_lsr_l3_m_cmd_saddr ''
------------------------------------------------------------------------------*/
typedef struct {
	UINT32
	cmd_saddr                       ;   	// 31: 0
} R_LSR_L3_M_CMD_SADDR;

/*-----------------------------------------------------------------------------
	0x0050 r_lsr_l3_m_cmd_canvas_r ''
------------------------------------------------------------------------------*/
typedef struct {
	UINT32
	cmd_canvas_r_y                  :12,	//  0:11
	...
	cmd_canvas_r_c_on               : 1,	//    30
	cmd_canvas_r_on                 : 1;	//    31
} R_LSR_L3_M_CMD_CANVAS_R;

/*-----------------------------------------------------------------------------
	0x0054 r_lsr_l3_m_cmd_saddr_r ''
------------------------------------------------------------------------------*/
typedef struct {
	UINT32
	cmd_saddr_8b_r                  ;   	// 31: 0
} R_LSR_L3_M_CMD_SADDR_R;

/*-----------------------------------------------------------------------------
	0x0058 r_lsr_l3_m_fbc_status ''
------------------------------------------------------------------------------*/
typedef struct {
	UINT32
	fbd50_ll_status                 :12;	//  0:11
} R_LSR_L3_M_FBC_STATUS;

/*-----------------------------------------------------------------------------
	0x005c r_lsr_l3_m_fbc_ctrl ''
------------------------------------------------------------------------------*/
typedef struct {
	UINT32
	fbc_en                          : 1,	//     0
	fbc_mode                        : 1,	//     1
	fbc_reset_step                  : 2,	//  2: 3
	fbc_idx_reg_data                :16,	//  4:19
	fbc_idx_reg_addr                : 4,	// 20:23
	fbc_idx_reg_wen                 : 1;	//    24
} R_LSR_L3_M_FBC_CTRL;
...
/*-----------------------------------------------------------------------------
	0x00bc r_mgs_fbc_ctrl_reserved ''
------------------------------------------------------------------------------*/
/*	no field */

/*-----------------------------------------------------------------------------
	0x00c0 osd0_reserved0 ''
------------------------------------------------------------------------------*/
/*	no field */

/*-----------------------------------------------------------------------------
	0x00c4 osd0_reserved1 ''
------------------------------------------------------------------------------*/
/*	no field */

/*-----------------------------------------------------------------------------
	0x00c8 osd0_reserved2 ''
------------------------------------------------------------------------------*/
/*	no field */

/*-----------------------------------------------------------------------------
	0x00cc osd0_reserved3 ''
------------------------------------------------------------------------------*/
/*	no field */

/*-----------------------------------------------------------------------------
	0x00d0 osd0_reserved4 ''
------------------------------------------------------------------------------*/
/*	no field */

/*-----------------------------------------------------------------------------
	0x00d4 osd0_reserved5 ''
------------------------------------------------------------------------------*/
/*	no field */

/*-----------------------------------------------------------------------------
	0x00d8 osd0_reserved6 ''
------------------------------------------------------------------------------*/
/*	no field */

/*-----------------------------------------------------------------------------
	0x00dc osd0_reserved7 ''
------------------------------------------------------------------------------*/
/*	no field */
...
/*-----------------------------------------------------------------------------
	0x00e4 r_lsr_l3_m_cmd_qos_ctrl ''
------------------------------------------------------------------------------*/
typedef struct {
	UINT32
	cmd_qos_urgent                  : 8,	//  0: 7
	...
	cmd_qos_en                      : 1,	//    30
	cmd_qos_reg_sel                 : 1;	//    31
} R_LSR_L3_M_CMD_QOS_CTRL;

/*-----------------------------------------------------------------------------
	0x00e8 r_csr0_cmd_qos_ctrl ''
------------------------------------------------------------------------------*/
typedef struct {
	UINT32
	cmd_qos_urgent                  : 8,	//  0: 7
...
typedef struct {
	...
	R_LSR_L3_M_MB_REQ               	r_lsr_l3_m_mb_req               ;	// 0x0040 : ''
	R_LSR_L3_M_CMD_REQ              	r_lsr_l3_m_cmd_req              ;	// 0x0044 : ''
	R_LSR_L3_M_CMD_STRIDE           	r_lsr_l3_m_cmd_stride           ;	// 0x0048 : ''
	R_LSR_L3_M_CMD_SADDR            	r_lsr_l3_m_cmd_saddr            ;	// 0x004c : ''
	R_LSR_L3_M_CMD_CANVAS_R         	r_lsr_l3_m_cmd_canvas_r         ;	// 0x0050 : ''
	R_LSR_L3_M_CMD_SADDR_R          	r_lsr_l3_m_cmd_saddr_r          ;	// 0x0054 : ''
	R_LSR_L3_M_FBC_STATUS           	r_lsr_l3_m_fbc_status           ;	// 0x0058 : ''
	R_LSR_L3_M_FBC_CTRL             	r_lsr_l3_m_fbc_ctrl             ;	// 0x005c : ''
	...
	R_MGS_MB_REQ                    	r_mgs_mb_req                    ;	// 0x00a0 : ''
	R_MGS_CMD_REQ                   	r_mgs_cmd_req                   ;	// 0x00a4 : ''
	R_MGS_CMD_STRIDE                	r_mgs_cmd_stride                ;	// 0x00a8 : ''
	R_MGS_CMD_SADDR                 	r_mgs_cmd_saddr                 ;	// 0x00ac : ''
	R_MGS_CMD_CANVAS_R              	r_mgs_cmd_canvas_r              ;	// 0x00b0 : ''
	R_MGS_CMD_SADDR_R               	r_mgs_cmd_saddr_r               ;	// 0x00b4 : ''
	R_MGS_FBC_STATUS                	r_mgs_fbc_status                ;	// 0x00b8 : ''
	UINT32                          	r_mgs_fbc_ctrl_reserved         ;	// 0x00bc : ''
	UINT32                          	osd0_reserved0                  ;	// 0x00c0 : ''
	UINT32                          	osd0_reserved1                  ;	// 0x00c4 : ''
	UINT32                          	osd0_reserved2                  ;	// 0x00c8 : ''
	UINT32                          	osd0_reserved3                  ;	// 0x00cc : ''
	UINT32                          	osd0_reserved4                  ;	// 0x00d0 : ''
	UINT32                          	osd0_reserved5                  ;	// 0x00d4 : ''
	UINT32                          	osd0_reserved6                  ;	// 0x00d8 : ''
	UINT32                          	osd0_reserved7                  ;	// 0x00dc : ''
	R_OSD0_CMD_QOS_CTRL             	r_osd0_cmd_qos_ctrl             ;	// 0x00e0 : ''
	R_LSR_L3_M_CMD_QOS_CTRL         	r_lsr_l3_m_cmd_qos_ctrl         ;	// 0x00e4 : ''
	R_CSR0_CMD_QOS_CTRL             	r_csr0_cmd_qos_ctrl             ;	// 0x00e8 : ''
	R_L3D_CMD_QOS_CTRL              	r_l3d_cmd_qos_ctrl              ;	// 0x00ec : ''
	R_MGS_CMD_QOS_CTRL              	r_mgs_cmd_qos_ctrl              ;	// 0x00f0 : ''
...
#define OSD_MIF0_CTRL_RdFL(_r)                  ((g_osd_mif0_o24_reg_shadow->_r)=(g_osd_mif0_o24_reg->_r))
#define OSD_MIF0_CTRL_WrFL(_r)                  ((g_osd_mif0_o24_reg->_r)=(g_osd_mif0_o24_reg_shadow->_r))

#define OSD_MIF0_CTRL_Rd(_r)                    *((UINT32*)(&(g_osd_mif0_o24_reg_shadow->_r)))
#define OSD_MIF0_CTRL_Wr(_r,_v)                 ((OSD_MIF0_CTRL_Rd(_r))=((UINT32)(_v)))

#define OSD_MIF0_CTRL_Rd01(_r,_f01,_v01)                                            \
                                do {                                                \
                                    (_v01) = (g_osd_mif0_o24_reg_shadow->_r._f01);  \
                                } while(0)

#define OSD_MIF0_CTRL_Rd02(_r,_f01,_v01,_f02,_v02)                                  \
                                do {                                                \
                                    (_v01) = (g_osd_mif0_o24_reg_shadow->_r._f01);  \
                                    (_v02) = (g_osd_mif0_o24_reg_shadow->_r._f02);  \
                                } while(0)

#define OSD_MIF0_CTRL_Wr01(_r,_f01,_v01)                                            \
                                do {                                                \
                                    (g_osd_mif0_o24_reg_shadow->_r._f01) = (_v01);  \
                                } while(0)

#define OSD_MIF0_CTRL_Wr02(_r,_f01,_v01,_f02,_v02)                                  \
                                do {                                                \
                                    (g_osd_mif0_o24_reg_shadow->_r._f01) = (_v01);  \
                                    (g_osd_mif0_o24_reg_shadow->_r._f02) = (_v02);  \
                                } while(0)

/** @} *//* end of macro documentation */

extern volatile OSD_MIF0_CTRL_O24_REG_T*     g_osd_mif0_o24_reg;
extern OSD_MIF0_CTRL_O24_REG_T*              g_osd_mif0_o24_reg_shadow;
...
/* from 'O24-A0_PQE_MIF_reg_man.csv' 20230407 17:28:54 KST by getregs v2.9 */
