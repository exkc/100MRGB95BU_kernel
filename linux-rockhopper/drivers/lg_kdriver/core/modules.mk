...
include $(KDRV_PLT_DIR)/$(KDRV_PLATFORM_CFG)/platform_dev.mk

ifneq ($(filter $(PLATFORM_CHIP_NAME),o26),)
BASE_SUFFIX=_r2
endif
...
#------------------------------------------------------------------------------
BASE_MODULE     :=
BASE_MODULE     += base$(BASE_SUFFIX)
BASE_MODULE     += afbc_sw

BASE_MODULE     += $(call cond_assign, YES, INCLUDE_KDRV_AFE,       afe,)
BASE_MODULE     += $(call cond_assign, YES, INCLUDE_KDRV_LEGACY_CI, ci,)
...
BASE_MODULE     += $(call cond_assign, YES, INCLUDE_KDRV_EMMC,      emmc,)
BASE_MODULE     += fbdev
...
BASE_MODULE     += $(call cond_assign, YES, INCLUDE_KDRV_UCOM,      ucom,)
BASE_MODULE     += $(call cond_assign, YES, INCLUDE_KDRV_IRB,       irb,)

BASE_MODULE     += $(call cond_assign, YES, INCLUDE_KDRV_PQE_PM,	pqepm,)
BASE_MODULE     += $(call cond_assign, YES, INCLUDE_KDRV_PWM,       pwm,)

BASE_MODULE     += $(call cond_assign, y, BUILD_FEATURE_audio_board, dummy/audio_board,)
...
EXTRA_CFLAGS	+= -include $(KDRV_PLT_DIR)/$(KDRV_PLATFORM_CFG)/platform_config.h

# include kdriver main header file(s) and HAL file(s)
EXTRA_CFLAGS	+= -I$(KDRV_INC_DIR)
EXTRA_CFLAGS	+= -I$(KDRV_CHIP_DIR)
EXTRA_CFLAGS	+= -I$(KDRV_PLT_DIR)

EXTRA_CFLAGS	+= $(call cond_assign, y, DEBUG, -DKDRV_DEBUG_BUILD,)
EXTRA_CFLAGS	+= -DKDRV_TOP_DIR=\"$(KDRV_TOP_DIR)\"

EXTRA_CFLAGS	+= -I$(KDRV_TOP_DIR)
...
EXTRA_CFLAGS	+= -DCHIP_NAME_$(PLATFORM_CHIP_NAME)
EXTRA_CFLAGS	+= -DCHIP_NAME=\"$(PLATFORM_CHIP_NAME)\"

EXTRA_CFLAGS	+= $(call cond_define, YES, INCLUDE_O20_CHIP_KDRV)
EXTRA_CFLAGS	+= $(call cond_define, YES, INCLUDE_E60_CHIP_KDRV)
EXTRA_CFLAGS	+= $(call cond_define, YES, INCLUDE_O22_CHIP_KDRV)
EXTRA_CFLAGS	+= $(call cond_define, YES, INCLUDE_M23_CHIP_KDRV)
EXTRA_CFLAGS	+= $(call cond_define, YES, INCLUDE_O24_CHIP_KDRV)
EXTRA_CFLAGS	+= $(call cond_define, YES, INCLUDE_O26_CHIP_KDRV)

EXTRA_CFLAGS	+= $(call cond_define, YES, INCLUDE_KDRV_VER_FPGA)

EXTRA_CFLAGS	+= $(addprefix -DBUILD_FEATURE_,$(BUILD_FEATURES))

ifeq ($(USE_SIGNAGE_FHD), YES)
EXTRA_CFLAGS	+= -DINCLUDE_KDRV_SIGNAGE_FHD
endif

ifeq ($(USE_SIGNAGE_FEATURE), YES)
EXTRA_CFLAGS	+= -DINCLUDE_KDRV_SIGNAGE
endif

export INCLUDE_L8_CHIP_KDRV
export INCLUDE_L9_CHIP_KDRV
export INCLUDE_H13_CHIP_KDRV
export INCLUDE_H14_CHIP_KDRV
export INCLUDE_H15_CHIP_KDRV
export INCLUDE_M14_CHIP_KDRV
export INCLUDE_M16_CHIP_KDRV
export INCLUDE_M16P_CHIP_KDRV
export INCLUDE_M17_CHIP_KDRV
export INCLUDE_L18_CHIP_KDRV
export INCLUDE_M18_CHIP_KDRV
export INCLUDE_O18_CHIP_KDRV
export INCLUDE_M19_CHIP_KDRV
export INCLUDE_O20_CHIP_KDRV
export INCLUDE_E60_CHIP_KDRV
export INCLUDE_O22_CHIP_KDRV
export INCLUDE_M23_CHIP_KDRV
export INCLUDE_O24_CHIP_KDRV
export INCLUDE_O26_CHIP_KDRV
...
EXTRA_CFLAGS	+= $(call cond_define, YES, INCLUDE_KDRV_LEGACY_CI)
EXTRA_CFLAGS	+= $(call cond_define, YES, INCLUDE_KDRV_DE)
EXTRA_CFLAGS	+= $(call cond_define, YES, INCLUDE_KDRV_PQE)
EXTRA_CFLAGS	+= $(call cond_define, YES, INCLUDE_KDRV_DEMOD)
#EXTRA_CFLAGS	+= $(call cond_define, YES, INCLUDE_KDRV_DENC)
EXTRA_CFLAGS	+= $(call cond_define, YES, INCLUDE_KDRV_EMMC)
...
EXTRA_CFLAGS	+= $(call cond_define, YES, INCLUDE_KDRV_TE)
EXTRA_CFLAGS	+= $(call cond_define, YES, INCLUDE_KDRV_PVR)
EXTRA_CFLAGS	+= $(call cond_define, YES, INCLUDE_KDRV_SDEC)
EXTRA_CFLAGS	+= $(call cond_define, YES, INCLUDE_KDRV_ATSC3)
EXTRA_CFLAGS	+= $(call cond_define, YES, INCLUDE_KDRV_ARIB2)
EXTRA_CFLAGS	+= $(call cond_define, YES, INCLUDE_KDRV_CIPLUS)
EXTRA_CFLAGS	+= $(call cond_define, YES, INCLUDE_KDRV_CI20)
...
EXTRA_CFLAGS	+= $(call cond_define, YES, INCLUDE_KDRV_SPI)
EXTRA_CFLAGS	+= $(call cond_define, YES, INCLUDE_KDRV_IRB)
EXTRA_CFLAGS	+= $(call cond_define, YES, INCLUDE_KDRV_SWCEC)
...
EXTRA_CFLAGS	+= $(call cond_define, YES, INCLUDE_KDRV_UCOM)

EXTRA_CFLAGS	+= $(call cond_define, YES, INCLUDE_KDRV_PQE_PM)
EXTRA_CFLAGS	+= $(call cond_define, YES, INCLUDE_KDRV_PWM)
...
EXTRA_CFLAGS	+= $(call cond_define, YES, KDRV_CONFIG_PM_LEGACY_CI)
...
EXTRA_CFLAGS	+= $(call cond_define, YES, KDRV_CONFIG_PM_ATSC3)
EXTRA_CFLAGS	+= $(call cond_define, YES, KDRV_CONFIG_PM_ARIB2)
EXTRA_CFLAGS	+= $(call cond_define, YES, KDRV_CONFIG_PM_TE)
EXTRA_CFLAGS	+= $(call cond_define, YES, KDRV_CONFIG_PM_CIPLUS)
EXTRA_CFLAGS	+= $(call cond_define, YES, KDRV_CONFIG_PM_CI20)
...
EXTRA_CFLAGS	+= $(call cond_define, YES, KDRV_CONFIG_PM_SPI)
EXTRA_CFLAGS	+= $(call cond_define, YES, KDRV_CONFIG_PM_IRB)
EXTRA_CFLAGS	+= $(call cond_define, YES, KDRV_CONFIG_PM_SWCEC)
EXTRA_CFLAGS	+= $(call cond_define, YES, KDRV_CONFIG_PM_UCOM)
#
# EXTRA FLAGS
#
...
# see http://clm.lge.com/issue/browse/SICDTV-13811
EXTRA_CFLAGS   += $(call cond_define, y, BUILD_FEATURE_y22_board)
EXTRA_CFLAGS   += $(call cond_define, y, BUILD_FEATURE_y23_board)
EXTRA_CFLAGS   += $(call cond_define, y, BUILD_FEATURE_y24_board)
EXTRA_CFLAGS   += $(call cond_define, y, BUILD_FEATURE_y25_board)
EXTRA_CFLAGS   += $(call cond_define, y, BUILD_FEATURE_y26_board)
EXTRA_CFLAGS   += $(call cond_define, y, BUILD_FEATURE_y27_board)
EXTRA_CFLAGS   += $(call cond_define, y, BUILD_FEATURE_y28_board)
EXTRA_CFLAGS   += $(call cond_define, y, BUILD_FEATURE_y29_board)
...
EXTRA_CFLAGS	+= $(call cond_define, y, BUILD_FEATURE_ddr_96bit)
# see http://collab.lge.com/main/x/PNT0rg
EXTRA_CFLAGS	+= $(call cond_define, y, BUILD_FEATURE_audio_board)
