...
/*----------------------------------------------------------------------------------------
	global Variables
----------------------------------------------------------------------------------------*/
//static ucom_o22_gov_t* ucom_o22_gov = NULL;
...
static ucom_o22_func_t * ucom_func;
...
static OS_PROC_DESC_TABLE_T	_g_ucom_o22_device_proc_table[] =
{
...
int	o22_read_proc(UINT32 procId, char* buffer );
int o22_write_proc( UINT32 procId, char* command );
void o22_ucom_proc_init (void);
void o22_ucom_proc_cleanup (void);
...
void o22_ucom_proc_init (void)
{
	ucom_func	= get_o22_ucom_func();
	ucom_drv =  get_o22_ucom_driver();


	OS_PROC_CreateEntryEx ( UCOM_MODULE, _g_ucom_o22_device_proc_table,
										o22_read_proc,
										o22_write_proc );
...
static ucom_proc_t o22_proc_func =
{
	.init = o22_ucom_proc_init,
	.cleanup = o22_ucom_proc_cleanup,
};

ucom_proc_t* get_o22_ucom_proc(void)
{
