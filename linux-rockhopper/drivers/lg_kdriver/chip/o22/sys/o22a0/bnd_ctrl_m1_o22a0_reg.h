#ifndef _BND_CTRL_M1_REG_H_
#define _BND_CTRL_M1_REG_H_
...
/*-----------------------------------------------------------------------------------------
    0xF303_2000    aiopllss_m1_o22_r00 ''
-----------------------------------------------------------------------------------------*/
typedef struct {
    UINT32
    ...
    reg_aiopll_m              :  6,    //  29:24
                              :  2;    //  31:30 reserved
}BND_CTRL_M1_AIOPLLSS_M1_O22_R00_O22A0_T;

/*-----------------------------------------------------------------------------------------
    0xF303_2004    aiopllss_m1_o22_r01 ''
-----------------------------------------------------------------------------------------*/
typedef struct {
    UINT32
...
}BND_CTRL_M1_AIOPLLSS_M1_O22_R01_O22A0_T;

/*-----------------------------------------------------------------------------------------
    0xF303_2008    aiopllss_m1_o22_r02 ''
-----------------------------------------------------------------------------------------*/
typedef struct {
    UINT32
...
}BND_CTRL_M1_AIOPLLSS_M1_O22_R02_O22A0_T;

/*-----------------------------------------------------------------------------------------
    0xF303_2010    bnd_m1_r03 ''
-----------------------------------------------------------------------------------------*/
typedef struct {
    UINT32
    ...
    mon_gfmrbgen_lockhold_lockd: 1,    //      2
                              : 29;    //   31:3 reserved
}BND_CTRL_M1_SYN_BND_M1_R03_O22A0_T;
...
typedef struct {
    ...
    reg_gfm_lockd_en          :  1,    //      4
                              : 27;    //   31:5 reserved
}BND_CTRL_M1_PLL_MON_O22A0_T;

/*-----------------------------------------------------------------------------------------
    0xF303_201C    syn_tx_lo_drv_00 ''
-----------------------------------------------------------------------------------------*/
typedef struct {
    UINT32
    ...
    reg_tx_lo_drv_nisol_top2m0_ck_div: 1,    //  1
                              : 30;    //   31:2 reserved
}BND_CTRL_M1_SYN_TX_LO_DRV_00_O22A0_T;

/*-----------------------------------------------------------------------------------------
    bnd_m1 Register LIst
-----------------------------------------------------------------------------------------*/
typedef struct {
    BND_CTRL_M1_AIOPLLSS_M1_O22_R00_O22A0_T    aiopllss_m1_o22_r00;    // 0xF303_2000
    BND_CTRL_M1_AIOPLLSS_M1_O22_R01_O22A0_T    aiopllss_m1_o22_r01;    // 0xF303_2004
    BND_CTRL_M1_AIOPLLSS_M1_O22_R02_O22A0_T    aiopllss_m1_o22_r02;    // 0xF303_2008
    UINT32                             _rsvd_00[1];             // 0xF303_200C
    BND_CTRL_M1_SYN_BND_M1_R03_O22A0_T          bnd_m1_r03 ;             // 0xF303_2010
    BND_CTRL_M1_PLL_MON_O22A0_T             pll_mon    ;             // 0xF303_2014
    UINT32                             _rsvd_01[1];             // 0xF303_2018
    BND_CTRL_M1_SYN_TX_LO_DRV_00_O22A0_T    syn_tx_lo_drv_00;        // 0xF303_201C
}BND_CTRL_M1_REG_O22A0_T;
/* 6 regs */
...
#define BND_CTRL_M1_AIOPLLSS_M1_O22_R00_O22A0_T_OFF              (BASEADDRESS+0x0000)
#define BND_CTRL_M1_AIOPLLSS_M1_O22_R01_O22A0_T_OFF              (BASEADDRESS+0x0004)
#define BND_CTRL_M1_AIOPLLSS_M1_O22_R02_O22A0_T_OFF              (BASEADDRESS+0x0008)
#define BND_CTRL_M1_SYN_BND_M1_R03_O22A0_T_OFF                       (BASEADDRESS+0x0010)
#define BND_CTRL_M1_PLL_MON_O22A0_T_OFF                          (BASEADDRESS+0x0014)
#define BND_CTRL_M1_SYN_TX_LO_DRV_00_O22A0_T_OFF                 (BASEADDRESS+0x001C)
