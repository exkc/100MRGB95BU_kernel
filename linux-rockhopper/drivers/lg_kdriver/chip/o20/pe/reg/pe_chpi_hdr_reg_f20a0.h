#ifndef _PE_CHPI_HDR_REG_F20A0_H_
#define _PE_CHPI_HDR_REG_F20A0_H_
#ifndef UINT32
...
}PE_F20_SDR2HDR_LLUT0_CTRL_05_T;
...
}PE_F20_SDR2HDR_LLUT0_IA_CTRL_T;
...
}PE_F20_SDR2HDR_LLUT0_IA_DATA_T;
...
}PE_F20_SDR2HDR_LLUT1_CTRL_05_T;
...
}PE_F20_SDR2HDR_LLUT1_IA_CTRL_T;
...
}PE_F20_SDR2HDR_LLUT1_IA_DATA_T;
...
}PE_F20_SDR2HDR_FBSLUT_CTRL_05_T;
...
}PE_F20_SDR2HDR_FBSLUT_IA_CTRL_T;
...
}PE_F20_HDR_YGAIN_LUT_CTRL_05_T;
...
}PE_F20_HDR_YGAIN_LUT_IA_CTRL_T;
...
}PE_F20_HDR_YGAIN_LUT_IA_DATA_T;
...
}PE_F20_HDR_LGAIN_LUT_CTRL_00_T;
...
}PE_F20_HDR_LGAIN_LUT_CTRL_01_T;
...
}PE_F20_HDR_LGAIN_LUT_CTRL_02_T;
...
}PE_F20_HDR_LGAIN_LUT_CTRL_03_T;
...
}PE_F20_HDR_LGAIN_LUT_CTRL_04_T;
...
}PE_F20_HDR_LGAIN_LUT_CTRL_05_T;
...
}PE_F20_HDR_LGAIN_LUT_CTRL_06_T;
...
}PE_F20_HDR_LGAIN_LUT_CTRL_07_T;
...
}PE_F20_HDR_SGAIN_LUT_CTRL_00_T;
...
}PE_F20_HDR_SGAIN_LUT_CTRL_01_T;
...
}PE_F20_HDR_SGAIN_LUT_CTRL_02_T;
...
}PE_F20_HDR_SGAIN_LUT_CTRL_03_T;
...
}PE_F20_HDR_SGAIN_LUT_CTRL_04_T;
...
}PE_F20_HDR_SGAIN_LUT_CTRL_05_T;
...
}PE_F20_HDR_SGAIN_LUT_CTRL_06_T;
...
}PE_F20_HDR_SGAIN_LUT_CTRL_07_T;
...
}PE_F20_HDR_PCC_CTRL_05_T;

#ifdef PE_CHPI_DEF_F20_USE_REG
typedef struct
{
	PE_F20_HDR_LLUT0_IA_CTRL_T                 hdr_llut0_ia_ctrl_x;	//0xF0205A20
	PE_F20_HDR_LLUT1_IA_CTRL_T                 hdr_llut1_ia_ctrl_x;	//0xF0205A50
	PE_F20_HDR_LLUT2_IA_CTRL_T                 hdr_llut2_ia_ctrl_x;	//0xF0205A80
	PE_F20_HDR_LLUT0_IA_DATA_T                 hdr_llut0_ia_data_x[32];	//0xF0205A24
	PE_F20_HDR_LLUT1_IA_DATA_T                 hdr_llut1_ia_data_x[32];	//0xF0205A54
	PE_F20_HDR_LLUT2_IA_DATA_T                 hdr_llut2_ia_data_x[32];	//0xF0205A84
	PE_F20_HDR_LLUT0_CTRL_05_T                 hdr_llut0_ctrl_05;	//0xF0205A14
	PE_F20_HDR_LLUT1_CTRL_05_T                 hdr_llut1_ctrl_05;	//0xF0205A44
	PE_F20_HDR_LLUT2_CTRL_05_T                 hdr_llut2_ctrl_05;	//0xF0205A74
	PE_F20_HDR_LLUT0_IA_CTRL_T                 hdr_llut0_ia_ctrl_y;	//0xF0205A20
	PE_F20_HDR_LLUT1_IA_CTRL_T                 hdr_llut1_ia_ctrl_y;	//0xF0205A50
	PE_F20_HDR_LLUT2_IA_CTRL_T                 hdr_llut2_ia_ctrl_y;	//0xF0205A80
	PE_F20_HDR_LLUT0_IA_DATA_T                 hdr_llut0_ia_data_y[32];	//0xF0205A24
	PE_F20_HDR_LLUT1_IA_DATA_T                 hdr_llut1_ia_data_y[32];	//0xF0205A54
	PE_F20_HDR_LLUT2_IA_DATA_T                 hdr_llut2_ia_data_y[32];	//0xF0205A84
	PE_F20_HDR_LLUT0_CTRL_06_T                 hdr_llut0_ctrl_06;	//0xF0205A18
	PE_F20_HDR_LLUT1_CTRL_06_T                 hdr_llut1_ctrl_06;	//0xF0205A48
	PE_F20_HDR_LLUT2_CTRL_06_T                 hdr_llut2_ctrl_06;	//0xF0205A78
	PE_F20_HDR_LLUT0_IA_CTRL_T                 hdr_llut0_ia_ctrl_e;	//0xF0205A20
	PE_F20_HDR_LLUT1_IA_CTRL_T                 hdr_llut1_ia_ctrl_e;	//0xF0205A50
	PE_F20_HDR_LLUT2_IA_CTRL_T                 hdr_llut2_ia_ctrl_e;	//0xF0205A80
}PE_CHPI_HDR_TM_F20_T;

typedef struct
{
	PE_F20_SDR2HDR_LLUT0_IA_CTRL_T             sdr2hdr_llut0_ia_ctrl_s;	//0xF0205CE8
	PE_F20_SDR2HDR_LLUT1_IA_CTRL_T             sdr2hdr_llut1_ia_ctrl_s;	//0xF0205D08
	PE_F20_SDR2HDR_FBSLUT_IA_CTRL_T            sdr2hdr_fbslut_ia_ctrl_s;	//0xF0205D68
	PE_F20_SDR2HDR_LLUT1_IA_DATA_T             sdr2hdr_llut1_ia_data[32];	//0xF0205D0C
	PE_F20_SDR2HDR_LLUT0_IA_DATA_T             sdr2hdr_llut0_ia_data[32];	//0xF0205CEC
	PE_F20_HDR_FBS_LUT_IA_DATA_T               hdr_fbs_lut_ia_data[32];	//0xF0205D6C
	PE_F20_SDR2HDR_LLUT0_IA_CTRL_T             sdr2hdr_llut0_ia_ctrl_e;	//0xF0205CE8
	PE_F20_SDR2HDR_LLUT1_IA_CTRL_T             sdr2hdr_llut1_ia_ctrl_e;	//0xF0205D08
	PE_F20_SDR2HDR_FBSLUT_IA_CTRL_T            sdr2hdr_fbslut_ia_ctrl_e;	//0xF0205D68
	PE_F20_SDR2HDR_LLUT0_CTRL_05_T             sdr2hdr_llut0_ctrl_05;	//0xF0205CE4
	PE_F20_SDR2HDR_LLUT1_CTRL_05_T             sdr2hdr_llut1_ctrl_05;	//0xF0205D04
	PE_F20_SDR2HDR_FBSLUT_CTRL_05_T            sdr2hdr_fbslut_ctrl_05;	//0xF0205D64
}PE_CHPI_HDR_S2H_F20_T;

typedef struct
{
	PE_F20_HDR_YGAIN_LUT_IA_CTRL_T             hdr_ygain_lut_ia_ctrl_s;	//0xF0205B38
	PE_F20_HDR_YGAIN_LUT_IA_DATA_T             hdr_ygain_lut_ia_data[32];	//0xF0205B3C
	PE_F20_HDR_YGAIN_LUT_IA_CTRL_T             hdr_ygain_lut_ia_ctrl_e;	//0xF0205B38
	PE_F20_HDR_YGAIN_LUT_CTRL_05_T             hdr_ygain_lut_ctrl_05;	//0xF0205B34
}PE_CHPI_HDR_YG_F20_T;

typedef struct
{
	PE_F20_HDR_HUE_SAT_CTRL_T                  hdr_hue_sat_ctrl;	//0xF02058D0
	PE_F20_HDR_LGAIN_LUT_CTRL_00_T             hdr_lgain_lut_ctrl_00;	//0xF0205B60
	PE_F20_HDR_LGAIN_LUT_CTRL_01_T             hdr_lgain_lut_ctrl_01;	//0xF0205B64
	PE_F20_HDR_LGAIN_LUT_CTRL_02_T             hdr_lgain_lut_ctrl_02;	//0xF0205B68
	PE_F20_HDR_LGAIN_LUT_CTRL_03_T             hdr_lgain_lut_ctrl_03;	//0xF0205B6C
	PE_F20_HDR_LGAIN_LUT_CTRL_04_T             hdr_lgain_lut_ctrl_04;	//0xF0205B70
	PE_F20_HDR_LGAIN_LUT_CTRL_05_T             hdr_lgain_lut_ctrl_05;	//0xF0205B74
	PE_F20_HDR_LGAIN_LUT_CTRL_06_T             hdr_lgain_lut_ctrl_06;	//0xF0205B78
	PE_F20_HDR_LGAIN_LUT_CTRL_07_T             hdr_lgain_lut_ctrl_07;	//0xF0205B7C
	PE_F20_HDR_SGAIN_LUT_CTRL_00_T             hdr_sgain_lut_ctrl_00;	//0xF0205B80
	PE_F20_HDR_SGAIN_LUT_CTRL_01_T             hdr_sgain_lut_ctrl_01;	//0xF0205B84
	PE_F20_HDR_SGAIN_LUT_CTRL_02_T             hdr_sgain_lut_ctrl_02;	//0xF0205B88
	PE_F20_HDR_SGAIN_LUT_CTRL_03_T             hdr_sgain_lut_ctrl_03;	//0xF0205B8C
	PE_F20_HDR_SGAIN_LUT_CTRL_04_T             hdr_sgain_lut_ctrl_04;	//0xF0205B90
	PE_F20_HDR_SGAIN_LUT_CTRL_05_T             hdr_sgain_lut_ctrl_05;	//0xF0205B94
	PE_F20_HDR_SGAIN_LUT_CTRL_06_T             hdr_sgain_lut_ctrl_06;	//0xF0205B98
	PE_F20_HDR_SGAIN_LUT_CTRL_07_T             hdr_sgain_lut_ctrl_07;	//0xF0205B9C
}PE_CHPI_HDR_HS_F20_T;

typedef struct
{
	PE_F20_HDR_PCC_CTRL_01_T                   hdr_pcc_ctrl_01;	//0xF02058A4
	PE_F20_HDR_PCC_CTRL_02_T                   hdr_pcc_ctrl_02;	//0xF02058A8
	PE_F20_HDR_PCC_CTRL_03_T                   hdr_pcc_ctrl_03;	//0xF02058AC
	PE_F20_HDR_PCC_CTRL_04_T                   hdr_pcc_ctrl_04;	//0xF02058B0
	PE_F20_HDR_PCC_CTRL_05_T                   hdr_pcc_ctrl_05;	//0xF02058B4
}PE_CHPI_HDR_PCC_F20_T;
