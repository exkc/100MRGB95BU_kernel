...
/*****************************************************************************************/
extern UINT8 DEMOD_L2_DTMB_SW_Init  (LX_DEMOD_L2_Context *front_end, UINT32 demodAdd);

extern UINT8  DEMOD_L2_DTMB_Set_demod   (LX_DEMOD_L2_Context *front_end
											, UINT8  standard
											, UINT32 freq
											, UINT8  tuneMode
...
extern UINT8  DEMOD_L2_DTMB_Set_BaseAddr_AXI(LX_DEMOD_L2_Context *frontend, UINT32 baseAddr );
