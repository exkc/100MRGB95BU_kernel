...
#ifndef _IPP_REG_O20A0_H_
#define _IPP_REG_O20A0_H_
...
typedef struct {
	...
	UINT32                                    : 3 ;  // 15:13     reserved
	UINT32 vactive                            : 12;  // 27:16     
} O20A0_IPP_OUT_CROP_ACTIVE_T;

typedef struct {
	O20A0_IPP_CTRL0_T                  	ipp_ctrl0;                    //0xc8001400L
	O20A0_IPP_CTRL1_T                  	ipp_ctrl1;                    //0xc8001404L
	O20A0_IPP_CTRL2_T                  	ipp_ctrl2;                    //0xc8001408L
	O20A0_IPP_CTRL3_T                  	ipp_ctrl3;                    //0xc800140cL
	O20A0_IPP_CTRLR_T                  	ipp_ctrlr;                    //0xc8001410L
	O20A0_IPP_HSC_Y_SET_VAL_0_T        	ipp_hsc_y_set_val_0;          //0xc8001414L
	O20A0_IPP_HSC_Y_SET_VAL_1_T        	ipp_hsc_y_set_val_1;          //0xc8001418L
	O20A0_IPP_HSC_Y_SET_VAL_2_T        	ipp_hsc_y_set_val_2;          //0xc800141cL
	O20A0_IPP_HSC_Y_SET_VAL_3_T        	ipp_hsc_y_set_val_3;          //0xc8001420L
	O20A0_IPP_HSC_C_SET_VAL_0_T        	ipp_hsc_c_set_val_0;          //0xc8001424L
	O20A0_IPP_HSC_C_SET_VAL_1_T        	ipp_hsc_c_set_val_1;          //0xc8001428L
	O20A0_IPP_HSC_C_SET_VAL_2_T        	ipp_hsc_c_set_val_2;          //0xc800142cL
	O20A0_IPP_HSC_C_SET_VAL_3_T        	ipp_hsc_c_set_val_3;          //0xc8001430L
	O20A0_IPP_SIZE_I_T                 	ipp_size_i;                   //0xc8001434L
	O20A0_IPP_SIZE_O_T                 	ipp_size_o;                   //0xc8001438L
	O20A0_IPP_SIZE_R_T                 	ipp_size_r;                   //0xc800143cL
	O20A0_IPP_CROP_OFFSET_T            	ipp_crop_offset;              //0xc8001440L
	O20A0_IPP_CROP_ACTIVE_T            	ipp_crop_active;              //0xc8001444L
	O20A0_IPP_PIXEL_CTRL_T             	ipp_pixel_ctrl;               //0xc8001448L
	O20A0_IPP_HSC_INPUT_INFO_T         	ipp_hsc_input_info;           //0xc800144cL
	O20A0_IPP_STATUS_T                 	ipp_status;                   //0xc8001450L
	O20A0_IPP_STATUS1_T                	ipp_status1;                  //0xc8001454L
	O20A0_IPP_VSC_Y_SET_VAL_0_T        	ipp_vsc_y_set_val_0;          //0xc8001458L
	O20A0_IPP_VSC_Y_SET_VAL_1_T        	ipp_vsc_y_set_val_1;          //0xc800145cL
	O20A0_IPP_VSC_Y_SET_VAL_2_T        	ipp_vsc_y_set_val_2;          //0xc8001460L
	O20A0_IPP_VSC_Y_SET_VAL_3_T        	ipp_vsc_y_set_val_3;          //0xc8001464L
	O20A0_IPP_VSC_C_SET_VAL_0_T        	ipp_vsc_c_set_val_0;          //0xc8001468L
	O20A0_IPP_VSC_C_SET_VAL_1_T        	ipp_vsc_c_set_val_1;          //0xc800146cL
	O20A0_IPP_VSC_C_SET_VAL_2_T        	ipp_vsc_c_set_val_2;          //0xc8001470L
	O20A0_IPP_VSC_C_SET_VAL_3_T        	ipp_vsc_c_set_val_3;          //0xc8001474L
	O20A0_IPP_VSC_Y_CTRL_T             	ipp_vsc_y_ctrl;               //0xc8001478L
	O20A0_IPP_VSC_C_CTRL_T             	ipp_vsc_c_ctrl;               //0xc800147cL
	O20A0_IPP_SC_CTRL_T                	ipp_sc_ctrl;                  //0xc8001480L
	O20A0_IPP_SC_DECTECT_T             	ipp_sc_dectect;               //0xc8001484L
	O20A0_IPP_SC_DECTECT1_T            	ipp_sc_dectect1;              //0xc8001488L
	O20A0_DEBUG_T                      	debug;                        //0xc800148cL
	O20A0_DEC3D_CTRL_0_T               	dec3d_ctrl_0;                 //0xc8001490L
	O20A0_DEC3D_CTRL_1_T               	dec3d_ctrl_1;                 //0xc8001494L
	O20A0_DEC3D_CTRL_2_T               	dec3d_ctrl_2;                 //0xc8001498L
	O20A0_IPP_OUT_CROP_OFFSET_T        	ipp_out_crop_offset;          //0xc800149cL
	O20A0_IPP_OUT_CROP_ACTIVE_T        	ipp_out_crop_active;          //0xc80014a0L
} DE_IPP_REG_O20A0_T;

#endif //#ifdef _IPP_REG_O20A0_H_
