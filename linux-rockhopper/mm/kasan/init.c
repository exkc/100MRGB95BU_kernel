...
#ifdef CONFIG_EKP
p4d_t kasan_early_shadow_p4d[MAX_PTRS_PER_P4D] __ekp_rodata;
#else
...
#ifdef CONFIG_EKP
pud_t kasan_early_shadow_pud[MAX_PTRS_PER_PUD] __ekp_rodata;
#else
...
#ifdef CONFIG_EKP
pmd_t kasan_early_shadow_pmd[MAX_PTRS_PER_PMD] __ekp_rodata;
#else
