...
static void free_module(struct module *mod)
{
	...
	/* Disable EKP protection for core layout */
	ekp_module_protection_disable_core(mod);
...
static noinline int do_init_module(struct module *mod)
{
...
#endif
	/* Enable EKP protection for rodata after init */
	ekp_module_protection_after_init(mod);
	...
	/* Disable EKP protection for init layout */
	ekp_module_protection_disable_init(mod);
...
static int complete_formation(struct module *mod, struct load_info *info)
{
	...
	/* Prepare EKP protection for init and core layout */
	ekp_module_protection_prepare(mod);
...
static int prepare_coming_module(struct module *mod)
{
	...
	/*
	 * NOTE: EKP does not support CONFIG_LIVEPATCH, so klp_module_coming()
	 *       function always returns 0 when EKP is used. And EKP module
	 *       protection must be enabled here regardless of the return
	 *       value of blocking_notifier_call_chain_robust() function.
	 */

	/* Enable EKP protection for init and core layout */
	ekp_module_protection_enable(mod);
		       ...
		       int flags)
{
 ...
 bug_cleanup:
	...
	/* Disable EKP protection for init and core layout */
	ekp_module_protection_disable(mod);
