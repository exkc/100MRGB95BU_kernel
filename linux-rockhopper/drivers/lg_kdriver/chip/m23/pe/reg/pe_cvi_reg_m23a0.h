#ifndef _PE_CVI_REG_M23A0_H_
#define _PE_CVI_REG_M23A0_H_
#ifndef UINT32
...
typedef union {
	UINT32 udata32;
	struct {						//0xCC690200 RW 0x0008_0024
...
}PE_M23_CVI_A_INT_SYNC_CTRL0_T;

typedef union {
	UINT32 udata32;
	struct {						//0xCC690210 RW 0x0001_0700
...
}PE_M23_CVI_A_INT_SYNC_CTRL1_T;

typedef union {
	UINT32 udata32;
	struct {						//0xCC690214 RW 0x0100_0000
...
}PE_M23_CVI_A_CV_MASK_CTRL_T;

typedef union {
	UINT32 udata32;
	struct {						//0xCC690218 RW 0x0000_0000
...
}PE_M23_CVI_A_CV_420_INCTRL_T;

typedef union {
	UINT32 udata32;
	struct {						//0xCC69021C RO 0x0000_0000
	UINT32 dolby_md_info                    :32;	//(31:0,RO,0x00) //
	};
}PE_M23_CVI_A_CV_HDMI_MD_INFO_T;

typedef union {
	UINT32 udata32;
	struct {						//0xCC690220 NA 0x0000_0000
	UINT32 reserved                         :32;	//(0,Rsvd,0x00) //
	};
}PE_M23_CVI_A_RESERVED001_T;

typedef union {
	UINT32 udata32;
	struct {						//0xCC690224 RW 0x09D3_00FE
...
}PE_M23_CVI_A_CSC_CTRL0_T;

typedef union {
	UINT32 udata32;
	struct {						//0xCC690228 RW 0x02EE_7A98
...
}PE_M23_CVI_A_CSC_CTRL1_T;

typedef union {
	UINT32 udata32;
	struct {						//0xCC69022C RW 0x0706_7E62
...
}PE_M23_CVI_A_CSC_CTRL2_T;

typedef union {
	UINT32 udata32;
	struct {						//0xCC690230 RW 0x799E_7F5C
...
}PE_M23_CVI_A_CSC_CTRL3_T;

typedef union {
	UINT32 udata32;
	struct {						//0xCC690234 RW 0x0706_0000
...
}PE_M23_CVI_A_CSC_CTRL4_T;

typedef union {
	UINT32 udata32;
	struct {						//0xCC690238 RW 0x0000_0000
...
}PE_M23_CVI_A_CSC_CTRL5_T;

typedef union {
	UINT32 udata32;
	struct {						//0xCC69023C RW 0x0040_0200
...
}PE_M23_CVI_A_CSC_CTRL6_T;

typedef union {
	UINT32 udata32;
	struct {						//0xCC690240 RW 0x0200_0200
...
}PE_M23_CVI_A_MISC_CTRL_T;

typedef union {
	UINT32 udata32;
	struct {						//0xCC690248 RO 0x0000_0000
...
}PE_M23_CVI_A_OFFSET_READ_T;

typedef union {
	UINT32 udata32;
	struct {						//0xCC69024C RW 0x0000_0001
	UINT32 cv_4p_manual_en                  :1;	//(0,RW,0x01) //0 := auto mode all mode is 4p except component(1p) and CVD(1p)	1 : manual mode
	...
	UINT32 reserved                         :21;	//(31:0,RW,0x0000_0001) //
	};
}PE_M23_CVI_A_MISC_CTRL1_T;

typedef union {
	UINT32 udata32;
	struct {						//0xCC690250 NA 0x0000_0000
	UINT32 reserved                         :32;	//(0,Rsvd,0x00) //
	};
}PE_M23_CVI_A_RESERVED002_T;

typedef union {
	UINT32 udata32;
	struct {						//0xCC690254 RO 0x0000_0000
...
}PE_M23_CVI_A_SIZE_STATUS7_T;

typedef union {
	UINT32 udata32;
	struct {						//0xCC690258 RO 0x0000_0000
...
}PE_M23_CVI_A_SIZE_STATUS1_T;

typedef union {
	UINT32 udata32;
	struct {						//0xCC69025C RO 0x0000_0000
...
}PE_M23_CVI_A_SIZE_STATUS2_T;

typedef union {
	UINT32 udata32;
	struct {						//0xCC690260 RO 0x0000_0000
...
}PE_M23_CVI_A_SIZE_STATUS3_T;

typedef union {
	UINT32 udata32;
	struct {						//0xCC690264 RO 0x0000_0000
...
}PE_M23_CVI_A_SIZE_STATUS4_T;

typedef union {
	UINT32 udata32;
	struct {						//0xCC690268 RW 0x0200_0100
...
}PE_M23_CVI_A_PIX_SUM_CTRL0_T;

typedef union {
	UINT32 udata32;
	struct {						//0xCC69026C RW 0x0080_0040
	UINT32 start_pos_y                      :13;	//(12:0,RW,0x40) //Start position of Y range
	UINT32 resvd0                           :3;
	UINT32 end_pos_y                        :13;	//(28:16,RW,0x80) //End position of Y range
	UINT32 resvd1                           :3;
	};
}PE_M23_CVI_A_PIX_SUM_CTRL1_T;

typedef union {
	UINT32 udata32;
	struct {						//0xCC690270 NA 0x3004_0100
...
}PE_M23_CVI_A_PIX_SUM_CTRL2_T;

typedef union {
	UINT32 udata32;
	struct {						//0xCC690274 RO 0x0000_0000
	UINT32 pix_sum_g0                       :32;	//(31:0,RO,0x0000_0000) //G port pixel sum read
	};
}PE_M23_CVI_A_PIX_SUM_STATUS0_T;

typedef union {
	UINT32 udata32;
	struct {						//0xCC690278 RO 0x0000_0000
	UINT32 pix_sum_b0                       :32;	//(31:0,RO,0x0000_0000) //B port pixel sum read
	};
}PE_M23_CVI_A_PIX_SUM_STATUS1_T;

typedef union {
	UINT32 udata32;
	struct {						//0xCC69027C RO 0x0000_0000
	UINT32 pix_sum_r0                       :32;	//(31:0,RO,0x0000_0000) //R port pixel sum read
	};
}PE_M23_CVI_A_PIX_SUM_STATUS2_T;

typedef union {
	UINT32 udata32;
	struct {						//0xCC690280 RO 0x0000_0000
	UINT32 pix_sum_g1                       :32;	//(31:0,RO,0x0000_0000) //G port pixel sum read
	};
}PE_M23_CVI_A_PIX_SUM_STATUS3_T;

typedef union {
	UINT32 udata32;
	struct {						//0xCC690284 RO 0x0000_0000
	UINT32 pix_sum_b1                       :32;	//(31:0,RO,0x0000_0000) //B port pixel sum read
	};
}PE_M23_CVI_A_PIX_SUM_STATUS4_T;

typedef union {
	UINT32 udata32;
	struct {						//0xCC690288 RO 0x0000_0000
	UINT32 pix_sum_r1                       :32;	//(31:0,RO,0x0000_0000) //R port pixel sum read
	};
}PE_M23_CVI_A_PIX_SUM_STATUS5_T;

typedef union {
	UINT32 udata32;
	struct {						//0xCC69028C RO 0x0000_0000
	UINT32 pix_sum_g2                       :32;	//(31:0,RO,0x0000_0000) //G port pixel sum read
	};
}PE_M23_CVI_A_PIX_SUM_STATUS6_T;

typedef union {
	UINT32 udata32;
	struct {						//0xCC690290 RO 0x0000_0000
	UINT32 pix_sum_b2                       :32;	//(31:0,RO,0x0000_0000) //B port pixel sum read
	};
}PE_M23_CVI_A_PIX_SUM_STATUS7_T;

typedef union {
	UINT32 udata32;
	struct {						//0xCC690294 RO 0x0000_0000
	UINT32 pix_sum_r2                       :32;	//(31:0,RO,0x0000_0000) //R port pixel sum read
	};
}PE_M23_CVI_A_PIX_SUM_STATUS8_T;

typedef union {
	UINT32 udata32;
	struct {						//0xCC690298 RO 0x0000_0000
	UINT32 pix_sum_g3                       :32;	//(31:0,RO,0x0000_0000) //G port pixel sum read
	};
}PE_M23_CVI_A_PIX_SUM_STATUS9_T;

typedef union {
	UINT32 udata32;
	struct {						//0xCC69029C RO 0x0000_0000
	UINT32 pix_sum_b3                       :32;	//(31:0,RO,0x0000_0000) //B port pixel sum read
	};
}PE_M23_CVI_A_PIX_SUM_STATUSA_T;

typedef union {
	UINT32 udata32;
	struct {						//0xCC6902A0 RO 0x0000_0000
	UINT32 pix_sum_r3                       :32;	//(31:0,RO,0x0000_0000) //R port pixel sum read
	};
}PE_M23_CVI_A_PIX_SUM_STATUSB_T;

typedef union {
	UINT32 udata32;
	struct {						//0xCC6902A4 RW 0x00C8_0000
...
}PE_M23_CVI_A_SYNC_FIL_CTRL_T;

typedef union {
	UINT32 udata32;
	struct {						//0xCC6902A8 RO 0x0000_0000
...
}PE_M23_CVI_A_SYNC_FIL_STATUS_T;

typedef union {
	UINT32 udata32;
	struct {						//0xCC6902AC NA 0x0000_0000
	UINT32 reserved                         :32;	//(0,Rsvd,0x00) //
	};
}PE_M23_CVI_A_RESERVED00E_T;

typedef union {
	UINT32 udata32;
	struct {						//0xCC6902B0 NA 0x0000_0000
	UINT32 reserved                         :32;	//(0,Rsvd,0x00) //
	};
}PE_M23_CVI_A_RESERVED00F_T;

typedef union {
	UINT32 udata32;
	struct {						//0xCC6902B4 NA 0x0000_0000
	UINT32 reserved                         :32;	//(0,Rsvd,0x00) //
	};
}PE_M23_CVI_A_RESERVED010_T;

typedef union {
	UINT32 udata32;
	struct {						//0xCC6902B8 NA 0x0000_0000
	UINT32 reserved                         :32;	//(0,Rsvd,0x00) //
	};
}PE_M23_CVI_A_RESERVED011_T;

typedef union {
	UINT32 udata32;
	struct {						//0xCC6902BC NA 0x0000_0000
	UINT32 reserved                         :32;	//(0,Rsvd,0x00) //
	};
}PE_M23_CVI_A_RESERVED012_T;

typedef union {
	UINT32 udata32;
	struct {						//0xCC6902C0 RW 0xC012_8006
...
}PE_M23_CVI_A_SIZE_DETECT_CTRL_T;

typedef union {
	UINT32 udata32;
	struct {						//0xCC6902C4 RO 0x0000_0000
...
}PE_M23_CVI_A_SIZE_DETECT_READ_T;

typedef union {
	UINT32 udata32;
	struct {						//0xCC6902C8 RO 0x0000_0000
...
}PE_M23_CVI_A_SIZE_STATUS0_T;

typedef union {
	UINT32 udata32;
	struct {						//0xCC6902CC RO 0x0000_0000
...
}PE_M23_CVI_A_SIZE_STATUS5_T;

typedef union {
	UINT32 udata32;
	struct {						//0xCC6902D0 RO 0x0000_0000
...
}PE_M23_CVI_A_SIZE_STATUS6_T;

typedef union {
	UINT32 udata32;
	struct {						//0xCC6902D4 RW/RO 0x0000_0000
...
}PE_M23_CVI_A_SIZE_DETECT_CTRL1_T;

typedef union {
	UINT32 udata32;
	struct {						//0xCC6902D8 RW 0x0301_0905
...
}PE_M23_CVI_A_SIZE_DETECT_CTRL2_T;

typedef union {
	UINT32 udata32;
	struct {						//0xCC6902DC RW 0x0000_0000
	UINT32 resvd0                           :3;
...
}PE_M23_CVI_A_CV_OUT_MUX_T;

typedef union {
	UINT32 udata32;
	struct {						//0xCC6902E0 RW 0x0210_02C0
...
}PE_M23_CVI_A_PSEUDO_SYNC_CTRL1_T;

typedef union {
	UINT32 udata32;
	struct {						//0xCC6902E4 RW 0x2260_118F
...
}PE_M23_CVI_A_PSEUDO_SYNC_CTRL2_T;

typedef union {
	UINT32 udata32;
	struct {						//0xCC6902E8 RW 0x001C_0028
...
}PE_M23_CVI_A_PSEUDO_SYNC_CTRL3_T;

typedef union {
	UINT32 udata32;
	struct {						//0xCC6902EC RW 0x1194_02D8
...
}PE_M23_CVI_A_PSEUDO_SYNC_CTRL4_T;

typedef union {
	UINT32 udata32;
	struct {						//0xCC6902F0 RW 0x000A_4000
...
}PE_M23_CVI_A_SIZE_DETECT_CTRL3_T;

typedef struct {
	PE_M23_CVI_A_TOP_CTRL_T                                       top_ctrl;	//0xCC690200
	PE_M23_CVI_A_OFFSET_CTRL_T                                 offset_ctrl;	//0xCC690204
	PE_M23_CVI_A_SIZE_CTRL_T                                     size_ctrl;	//0xCC690208
	PE_M23_CVI_A_INT_SYNC_CTRL0_T                           int_sync_ctrl0;	//0xCC69020C
	PE_M23_CVI_A_INT_SYNC_CTRL1_T                           int_sync_ctrl1;	//0xCC690210
	PE_M23_CVI_A_CV_MASK_CTRL_T                               cv_mask_ctrl;	//0xCC690214
	PE_M23_CVI_A_CV_420_INCTRL_T                             cv_420_inctrl;	//0xCC690218
	PE_M23_CVI_A_CV_HDMI_MD_INFO_T                         cv_hdmi_md_info;	//0xCC69021C
	PE_M23_CVI_A_RESERVED001_T                                 reserved001;	//0xCC690220
	PE_M23_CVI_A_CSC_CTRL0_T                                     csc_ctrl0;	//0xCC690224
	PE_M23_CVI_A_CSC_CTRL1_T                                     csc_ctrl1;	//0xCC690228
	PE_M23_CVI_A_CSC_CTRL2_T                                     csc_ctrl2;	//0xCC69022C
	PE_M23_CVI_A_CSC_CTRL3_T                                     csc_ctrl3;	//0xCC690230
	PE_M23_CVI_A_CSC_CTRL4_T                                     csc_ctrl4;	//0xCC690234
	PE_M23_CVI_A_CSC_CTRL5_T                                     csc_ctrl5;	//0xCC690238
	PE_M23_CVI_A_CSC_CTRL6_T                                     csc_ctrl6;	//0xCC69023C
	PE_M23_CVI_A_CSC_CTRL7_T                                     csc_ctrl7;	//0xCC690240
	PE_M23_CVI_A_MISC_CTRL_T                                     misc_ctrl;	//0xCC690244
	PE_M23_CVI_A_OFFSET_READ_T                                 offset_read;	//0xCC690248
	PE_M23_CVI_A_MISC_CTRL1_T                                   misc_ctrl1;	//0xCC69024C
	PE_M23_CVI_A_RESERVED002_T                                 reserved002;	//0xCC690250
	PE_M23_CVI_A_SIZE_STATUS7_T                               size_status7;	//0xCC690254
	PE_M23_CVI_A_SIZE_STATUS1_T                               size_status1;	//0xCC690258
	PE_M23_CVI_A_SIZE_STATUS2_T                               size_status2;	//0xCC69025C
	PE_M23_CVI_A_SIZE_STATUS3_T                               size_status3;	//0xCC690260
	PE_M23_CVI_A_SIZE_STATUS4_T                               size_status4;	//0xCC690264
	PE_M23_CVI_A_PIX_SUM_CTRL0_T                             pix_sum_ctrl0;	//0xCC690268
	PE_M23_CVI_A_PIX_SUM_CTRL1_T                             pix_sum_ctrl1;	//0xCC69026C
	PE_M23_CVI_A_PIX_SUM_CTRL2_T                             pix_sum_ctrl2;	//0xCC690270
	PE_M23_CVI_A_PIX_SUM_STATUS0_T                         pix_sum_status0;	//0xCC690274
	PE_M23_CVI_A_PIX_SUM_STATUS1_T                         pix_sum_status1;	//0xCC690278
	PE_M23_CVI_A_PIX_SUM_STATUS2_T                         pix_sum_status2;	//0xCC69027C
	PE_M23_CVI_A_PIX_SUM_STATUS3_T                         pix_sum_status3;	//0xCC690280
	PE_M23_CVI_A_PIX_SUM_STATUS4_T                         pix_sum_status4;	//0xCC690284
	PE_M23_CVI_A_PIX_SUM_STATUS5_T                         pix_sum_status5;	//0xCC690288
	PE_M23_CVI_A_PIX_SUM_STATUS6_T                         pix_sum_status6;	//0xCC69028C
	PE_M23_CVI_A_PIX_SUM_STATUS7_T                         pix_sum_status7;	//0xCC690290
	PE_M23_CVI_A_PIX_SUM_STATUS8_T                         pix_sum_status8;	//0xCC690294
	PE_M23_CVI_A_PIX_SUM_STATUS9_T                         pix_sum_status9;	//0xCC690298
	PE_M23_CVI_A_PIX_SUM_STATUSA_T                         pix_sum_statusa;	//0xCC69029C
	PE_M23_CVI_A_PIX_SUM_STATUSB_T                         pix_sum_statusb;	//0xCC6902A0
	PE_M23_CVI_A_SYNC_FIL_CTRL_T                             sync_fil_ctrl;	//0xCC6902A4
	PE_M23_CVI_A_SYNC_FIL_STATUS_T                         sync_fil_status;	//0xCC6902A8
	PE_M23_CVI_A_RESERVED00E_T                                 reserved00e;	//0xCC6902AC
	PE_M23_CVI_A_RESERVED00F_T                                 reserved00f;	//0xCC6902B0
	PE_M23_CVI_A_RESERVED010_T                                 reserved010;	//0xCC6902B4
	PE_M23_CVI_A_RESERVED011_T                                 reserved011;	//0xCC6902B8
	PE_M23_CVI_A_RESERVED012_T                                 reserved012;	//0xCC6902BC
	PE_M23_CVI_A_SIZE_DETECT_CTRL_T                       size_detect_ctrl;	//0xCC6902C0
	PE_M23_CVI_A_SIZE_DETECT_READ_T                       size_detect_read;	//0xCC6902C4
	PE_M23_CVI_A_SIZE_STATUS0_T                               size_status0;	//0xCC6902C8
	PE_M23_CVI_A_SIZE_STATUS5_T                               size_status5;	//0xCC6902CC
	PE_M23_CVI_A_SIZE_STATUS6_T                               size_status6;	//0xCC6902D0
	PE_M23_CVI_A_SIZE_DETECT_CTRL1_T                     size_detect_ctrl1;	//0xCC6902D4
	PE_M23_CVI_A_SIZE_DETECT_CTRL2_T                     size_detect_ctrl2;	//0xCC6902D8
	PE_M23_CVI_A_CV_OUT_MUX_T                                   cv_out_mux;	//0xCC6902DC
	PE_M23_CVI_A_PSEUDO_SYNC_CTRL1_T                     pseudo_sync_ctrl1;	//0xCC6902E0
	PE_M23_CVI_A_PSEUDO_SYNC_CTRL2_T                     pseudo_sync_ctrl2;	//0xCC6902E4
	PE_M23_CVI_A_PSEUDO_SYNC_CTRL3_T                     pseudo_sync_ctrl3;	//0xCC6902E8
	PE_M23_CVI_A_PSEUDO_SYNC_CTRL4_T                     pseudo_sync_ctrl4;	//0xCC6902EC
	PE_M23_CVI_A_SIZE_DETECT_CTRL3_T                     size_detect_ctrl3;	//0xCC6902F0
}PE_CVI_REG_M23_T;
#endif
