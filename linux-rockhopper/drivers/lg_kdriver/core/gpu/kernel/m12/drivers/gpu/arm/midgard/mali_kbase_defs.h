...
struct kbase_device {
	...
	/* debugfs entry for webos_mem */
	struct dentry *webos_mem_dentry;

#ifdef CONFIG_MALI_LGE_KMALLOC_DEBUG
	struct dentry *kmalloc_debug_dentry;
#endif
	...
	/* Root directory for webos_mem entry */
	struct dentry *webos_mem_directory;
	 ...
	 */
	bool secure_mode;
	struct kbase_context *secure_kctx;
