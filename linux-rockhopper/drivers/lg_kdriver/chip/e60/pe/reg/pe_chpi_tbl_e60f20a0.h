#ifndef _PE_CHPI_TBL_E60F20A0_H_
#define _PE_CHPI_TBL_E60F20A0_H_

#include "pe_chpi_cco_tbl_e60f20a0.h"
#include "pe_chpi_obc_tbl_e60f20a0.h"
#include "pe_chpi_shp_tbl_e60f20a0.h"
#include "pe_chpi_tnr_tbl_e60f20a0.h"
#include "pe_chpi_dnr_tbl_e60f20a0.h"
...
}PE_CHPI_TBL0_CNT3_E60F20_T;

typedef struct
{
	PE_CHPI_TBL_INFO_E60F20_T              info;
	PE_CHPI_TBL0_CNT0_E60F20_T             cnt0;
	PE_CHPI_TBL0_CNT1_E60F20_T             cnt1;
	PE_CHPI_TBL0_CNT2_E60F20_T             cnt2;
	PE_CHPI_TBL0_CNT3_E60F20_T             cnt3;
	PE_CHPI_TBL_POS_E60F20_T               pos[32];
}PE_CHPI_TBL0_DB_H_E60F20_T;

typedef struct
{
	UINT32                              resvd[1304];
}PE_CHPI_TBL0_RESVD_E60F20_T;
...
{
	UINT32                               head0;
	PE_CHPI_TBL0_DB_H_E60F20_T           head1;
	PE_CHPI_CCO_TBL_E60F20_T               cco;//00
	PE_CHPI_OBO_TBL_E60F20_T               obo;//01
	PE_CHPI_OBF_TBL_E60F20_T               obf;//02
	PE_CHPI_RCO_TBL_E60F20_T               rco;//03
	PE_CHPI_RCF_TBL_E60F20_T               rcf;//04
	PE_CHPI_RES_TBL_E60F20_T               res;//05
	PE_CHPI_CTI_TBL_E60F20_T               cti;//06
	PE_CHPI_TNR_TBL_E60F20_T               tnr;//07
	PE_CHPI_DNR_TBL_E60F20_T               dnr;//08
	PE_CHPI_DNR_PSP_TBL_E60F20_T           psp;//09
	PE_CHPI_DNR_LED_TBL_E60F20_T           led;//10
	...
	PE_CHPI_DRC_CUV_E60F20_T               drc;//21
	PE_CHPI_TBL0_RESVD_E60F20_T          resvd;
	UINT32                                crc0;
	UINT32                                crc1;
}PE_CHPI_TBL0_E60F20_T;
