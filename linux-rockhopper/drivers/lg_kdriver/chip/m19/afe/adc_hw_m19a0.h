...
#ifndef	_ADC_HW_M19A0_H_
#define	_ADC_HW_M19A0_H_
...
void ADC_M19Ax_Vport_ALL_Power_Down(void);
...
int ADC_M19Ax_Power_OnOff(void);
...
int ADC_M19Ax_Read_HSync_Width(UINT32 *pvs_width);
...
int ADC_M19Ax_Set_Blank_Value(S_BLANK_INFORM *blank_t);
