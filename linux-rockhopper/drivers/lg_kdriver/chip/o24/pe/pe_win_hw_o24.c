...
#define PE_WIN_HW_O24_UHD_H_MAX			3840
#define PE_WIN_HW_O24_UHD_V_MAX			2160
#define PE_WIN_HW_O24_FHD_H_MAX			1920
#define PE_WIN_HW_O24_FHD_V_MAX			1080
#define PE_WIN_HW_O24_SHP_WIN			0
#define PE_WIN_HW_O24_CEN_WIN			1
#define PE_WIN_HW_O24_WIN_EN_OFF		0
#define PE_WIN_HW_O24_WIN_EN__ON		1
#define PE_WIN_HW_O24_P1SHP_WIN_OFST	64

#define PE_WIN_HW_O24_WIN_OFFSET_MAX	(4)

/* 20140305, sj.youm, use win0 for lrcr win because of single path */
#define PE_WIN_HW_O24A_USE_WIN_0_ONLY

/*----------------------------------------------------------------------------------------
	Macro Definitions
----------------------------------------------------------------------------------------*/
#define PE_WIN_HW_O24_ERROR	printk

#define PE_WIN_HW_O24_DBG_PRINT(fmt,args...)	\
	if(_g_win_hw_o24_trace) printk("[%x,%x][%s,%d] "fmt,PE_CHIP_VER,g_pe_kdrv_ver_mask,__F__,__L__,##args)
#define PE_WIN_HW_O24_CHECK_CODE(_checker,_action,fmt,args...)	\
	{if(_checker){PE_WIN_HW_O24_ERROR(fmt,##args);_action;}}

#define PE_WIN_HW_O24_DIVIDE(x,y)	(((((x)<<10)/y)+512)>>10)

#define PE_WIN_HW_O24_DBG_PRINT_ALWAYS(fmt,args...)	\
...
----------------------------------------------------------------------------------------*/
static void PE_WIN_HW_O24_SetVerWinReverse(UINT32 *y0,UINT32 *y1,UINT32 v_max);
static void PE_WIN_HW_O24_GetWinParams(PE_TSK_O24_CFG_T *i_pstCfg, LX_PE_WIN_PARAMS_T *o_pstWinPrms);
static void PE_WIN_HW_O24_GetActNWinCrdsForExtFRC(PE_TSK_O24_CFG_T 			*i_pstCfg,
												LX_PE_WIN_PARAMS_T 			*i_pstWinPrms,
												LX_PE_ACT_WIN_COORDINATES_T *o_pstActWinCrds);
static void PE_WIN_HW_O24_GetShpCenWinEnForExtFRC(PE_TSK_O24_CFG_T 		*i_pstCfg,
												BOOLEAN					i_bIsResizeSet,
												LX_PE_SHP_CEN_WIN_EN_T	*o_pstShpCenWinEn);
static void PE_WIN_HW_O24_ValidateWinCoords(LX_PE_WIN_PARAMS_T 			*i_pstWinPrms,
											LX_PE_ACT_WIN_COORDINATES_T *io_pstActWinCrds);
static void PE_WIN_HW_O24_SetCen(PE_TSK_O24_CFG_T 				*i_pstCfg,
								 LX_PE_WIN_PARAMS_T 			*i_pstWinPrms,
								 LX_PE_ACT_WIN_COORDINATES_T 	*i_pstActWinCrds);
static void PE_WIN_HW_O24_SetShp(PE_TSK_O24_CFG_T 				*i_pstCfg,
								 LX_PE_WIN_PARAMS_T 			*i_pstWinPrms,
								 LX_PE_ACT_WIN_COORDINATES_T 		*i_pstActWinCrds);
static void PE_WIN_HW_O24_SetShpWinEn(PE_TSK_O24_CFG_T 				*i_pstCfg,
									 LX_PE_WIN_PARAMS_T 			*i_pstWinPrms,
									 LX_PE_SHP_CEN_WIN_EN_T 		*i_pstShpCenWinEn);
static void PE_WIN_HW_O24_SetCenWinEn(PE_TSK_O24_CFG_T 				*i_pstCfg,
									 LX_PE_WIN_PARAMS_T 			*i_pstWinPrms,
									 LX_PE_SHP_CEN_WIN_EN_T 		*i_pstShpCenWinEn);
static void PE_WIN_HW_O24_SetDCWinEn(PE_TSK_O24_CFG_T 				*i_pstCfg,
									 LX_PE_WIN_PARAMS_T 			*i_pstWinPrms);
static void PE_WIN_HW_O24_SetWinResolution(PE_TSK_O24_CFG_T 			*i_pstCfg,
										   LX_PE_WIN_PARAMS_T 			*i_pstWinPrms);

static void PE_WIN_HW_O24_SetDc(PE_TSK_O24_CFG_T 					*i_pstCfg,
								 LX_PE_WIN_PARAMS_T 				*i_pstWinPrms,
								 LX_PE_ACT_WIN_COORDINATES_T 		*i_pstActWinCrds);
static void PE_WIN_HW_O24_SetPcc(PE_TSK_O24_CFG_T 					*i_pstCfg,
								 LX_PE_WIN_PARAMS_T 				*i_pstWinPrms,
								 LX_PE_ACT_WIN_COORDINATES_T 		*i_pstActWinCrds);
static void PE_WIN_HW_O24_GetWinLeftOfst(UINT16 x_ofst,UINT16 y_ofst, LX_PE_WIN_PARAMS_T *o_pstWinPrms, UINT32 win_id);
static void PE_WIN_HW_O24_GetWinRightOfst(UINT16 x_ofst,UINT16 y_ofst, UINT16 x_size, UINT16 y_size, LX_PE_WIN_PARAMS_T *o_pstWinPrms, UINT32 win_id);
static void PE_WIN_HW_O24_SetWinPriority(PE_TSK_O24_CFG_T 				*i_pstCfg);
/*----------------------------------------------------------------------------------------
	Static Variables
----------------------------------------------------------------------------------------*/
static UINT32 _g_win_hw_o24_trace=0x0;	//default should be off.
static PE_WIN_HW_O24_SETTINGS_T _g_pe_win_hw_o24_info;
 ...
 * @author
 */
int PE_WIN_HW_O24_Init(PE_CFG_CTRL_T *pstParams)
{
	int ret = RET_OK;
	...
	do{
		...
		if(PE_KDRV_VER_O24)
		{
			memset(&_g_pe_win_hw_o24_info,-1,sizeof(PE_WIN_HW_O24_SETTINGS_T));
			PE_WIN_HW_O24_DBG_PRINT("pe1 win ctrl init, inside.\n");
			hw_opt = PE_REG_O24_GetDispOpt();
			_g_pe_win_hw_o24_info.is_external_chip = hw_opt.external_chip;
			/*esf*/
			PE_VSD_SHP_O24_QWr05(shp_esf_win_ctrl_00, 		reg_win_esf_win0_en,0x1, \
                                                        reg_win_esf_win1_en,0x1, \
                                                        reg_win_esf_win01_en,0x1, \
                                                        reg_win_esf_win_en,0x1, \
                                                        reg_win_esf_win_outside,0x0);
			/*dp*/
			PE_VSD_SHP_O24_QWr05(shp_dp_win_ctrl_00, reg_win_dp_win0_en,0x1, \
                                                  	   reg_win_dp_win1_en,0x1, \
                                                  	   reg_win_dp_win01_en,0x1, \
                                                  	   reg_win_dp_win_en,0x1, \
                                                  	   reg_win_dp_win_outside,0x0);
			/*dj*/
			PE_VSD_SHP_O24_QWr05(shp_dj_win_ctrl_00, reg_win_dj_win0_en,0x1, \
                                                  	   reg_win_dj_win1_en,0x1, \
                                                  	   reg_win_dj_win01_en,0x1, \
                                                  	   reg_win_dj_win_en,0x1, \
                                                  	   reg_win_dj_win_outside,0x0);
			/*cco*/
			PE_CC_PE1_O24_QWr05(pe1_win2_ctrl_00,	win0_en,0x1, \
                                                    win1_en,0x1, \
                                                    win01_en,0x1, \
                                                    win_en,0x1, \
                                                    win_outside,0x0);
			PE_CC_PE1_O24_RdFL(pcc_winctrl_20);
			PE_CC_PE1_O24_Wr01(pcc_winctrl_20,	reg_priority_sel0,		0x1);
			PE_CC_PE1_O24_Wr01(pcc_winctrl_20,	reg_priority_sel1,		0x0);
			PE_CC_PE1_O24_Wr01(pcc_winctrl_20,	reg_priority_sel2,		0x2);
			PE_CC_PE1_O24_Wr01(pcc_winctrl_20,	reg_priority_sel3,		0x3);
			PE_CC_PE1_O24_WrFL(pcc_winctrl_20);
		}
		else
		{
			PE_WIN_HW_O24_DBG_PRINT("nothing to do\n");	ret = RET_OK;
		}
	}while(0);
 ...
 * @author
 */
int PE_WIN_HW_O24_SetDebugSettings(LX_PE_DBG_SETTINGS_T *pstParams)
{
	int ret = RET_OK;
	#ifndef PE_HW_O24_BRINGUP
	do{
		...
		PE_WIN_HW_O24_DBG_PRINT("wid:%d,type:0x%x,[0x%x]print:0x%x,bypass:0x%x\n",\
			pstParams->win_id,pstParams->type,(0x1<<PE_ITEM_PKTMODL(WIN)),\
			pstParams->print_lvl,pstParams->bypass);
		/* set print level */
		if(pstParams->type&LX_PE_DBG_LV)
		{
			_g_win_hw_o24_trace = (pstParams->print_lvl & (0x1<<PE_ITEM_PKTMODL(WIN)))? 0x1:0x0;
		}
	}while(0);
	#endif /*PE_HW_O24_BRINGUP*/
	return ret;
 ...
 * @author
 */
int PE_WIN_HW_O24_SetEnhancingWindow(PE_TSK_O24_CFG_T *pCfg)
{
	int ret 						= RET_OK;
	#ifndef PE_HW_O24_BRINGUP
	...
	do {
		...
		if(PE_KDRV_VER_O24) {
			...
			PE_WIN_HW_O24_GetWinParams(pCfg, &stWinPrms);

			PE_WIN_HW_O24_GetActNWinCrdsForExtFRC(pCfg, &stWinPrms, &stActWinCrds);

			/* reverse mode */
			if(disp0_info->mode.is_reverse)	{
				PE_WIN_HW_O24_SetVerWinReverse(&stActWinCrds.act0_y0, &stActWinCrds.act0_y1, stWinPrms.v_max);
				PE_WIN_HW_O24_SetVerWinReverse(&stActWinCrds.act1_y0, &stActWinCrds.act1_y1, stWinPrms.v_max);
				PE_WIN_HW_O24_SetVerWinReverse(&stActWinCrds.win0_y0, &stActWinCrds.win0_y1, stWinPrms.v_max);
				PE_WIN_HW_O24_SetVerWinReverse(&stActWinCrds.win1_y0, &stActWinCrds.win1_y1, stWinPrms.v_max);
			}
			...
			PE_WIN_HW_O24_GetShpCenWinEnForExtFRC(pCfg, is_resize_case, &stShpCenWinEn);

			/* 20130221, sj.youm, check valid window coordinate */
			PE_WIN_HW_O24_ValidateWinCoords(&stWinPrms, &stActWinCrds);

			/* set act(pcc) */
			PE_WIN_HW_O24_SetPcc(pCfg, &stWinPrms, &stActWinCrds);

			/* set act(cen) */
			PE_WIN_HW_O24_SetCen(pCfg, &stWinPrms, &stActWinCrds);

			/* set act(dc) */
			PE_WIN_HW_O24_SetDc(pCfg, &stWinPrms, &stActWinCrds);

			/* set win(shp) */
			PE_WIN_HW_O24_SetShp(pCfg, &stWinPrms, &stActWinCrds);

			/* DC PCC win priority */
			PE_WIN_HW_O24_SetWinPriority(pCfg);

			/* shp win en */
			PE_WIN_HW_O24_SetShpWinEn(pCfg, &stWinPrms, &stShpCenWinEn);

			/* cen win en */
			PE_WIN_HW_O24_SetCenWinEn(pCfg, &stWinPrms, &stShpCenWinEn);

			/* DC win en */
			PE_WIN_HW_O24_SetDCWinEn(pCfg, &stWinPrms);

			/* etc */
			PE_WIN_HW_O24_SetWinResolution(pCfg, &stWinPrms);
...
int PE_WIN_HW_O24_GetCurWinSettings(PE_WIN_HW_O24_SETTINGS_T *pstParams)
{
	int ret = RET_OK;
	#ifndef PE_HW_O24_BRINGUP
	PE_WIN_HW_O24_SETTINGS_T *pInfo = &_g_pe_win_hw_o24_info;
	PE_WIN_HW_O24_CTRL_T *win_info = &_g_pe_win_hw_o24_info.win_inf;
	__attribute__((unused)) PE_WIN_HW_O24_LRCR_CTRL_T *lrcr_info = &_g_pe_win_hw_o24_info.lrcr_inf;
	PE_WIN_HW_O24_TNR_CTRL_T *tnr_info = &_g_pe_win_hw_o24_info.tnr_inf;
	do{
		CHECK_KNULL(pstParams);
		if(PE_KDRV_VER_O24)
		{
			memcpy(pstParams,pInfo,sizeof(PE_WIN_HW_O24_SETTINGS_T));
			PE_WIN_HW_O24_DBG_PRINT("act0:%d,%d,%d,%d, act1:%d,%d,%d,%d\n",\
			...
			PE_WIN_HW_O24_DBG_PRINT("act2:%d,%d,%d,%d, act3:%d,%d,%d,%d\n",\
			...
			PE_WIN_HW_O24_DBG_PRINT("win0:%d,%d,%d,%d, win1:%d,%d,%d,%d\n",\
			...
			PE_WIN_HW_O24_DBG_PRINT("h,v_max:%d,%d, w0,w1,w01_en:[%d,%d],[%d,%d],[%d,%d]\n",\
			...
			PE_WIN_HW_O24_DBG_PRINT("tnr win h,v size0:%d,%d, size1:%d,%d\n",\
 ...
 * Gets window params
 *
 * @param   *i_pstCfg		[in] 	PE_TSK_O24_CFG_T
...
static void PE_WIN_HW_O24_GetWinParams(PE_TSK_O24_CFG_T *i_pstCfg, LX_PE_WIN_PARAMS_T *o_pstWinPrms)
{
	...
	//__attribute__((unused)) PE_INF_O24_CTRL_T *ctrl0_info 	= &i_pstCfg->inf.ctrl_info[LX_PE_WIN_0];
	//__attribute__((unused)) PE_INF_O24_CTRL_T *ctrl1_info 	= &i_pstCfg->inf.ctrl_info[LX_PE_WIN_1];
	...
	{
		PE_OLB_O24_QRd02(olb_osc0_ctrl0,		reg_osc0_x_st, x_ofst[0],\
												reg_osc0_x_ed, x_end_ofst[0]);
		PE_OLB_O24_QRd02(olb_osc0_ctrl1,		reg_osc0_y_st, y_ofst[0],\
												reg_osc0_y_ed, y_end_ofst[0]);
		x_size[0]  = x_ofst[0] > x_end_ofst[0]? 0:(x_end_ofst[0] - x_ofst[0] + 1);
		y_size[0]  = y_ofst[0] > y_end_ofst[0]? 0:(y_end_ofst[0] - y_ofst[0] + 1);

		PE_OLB_O24_QRd02(olb_osc1_ctrl0,		reg_osc1_x_st, x_ofst[1],\
												reg_osc1_x_ed, x_end_ofst[1]);
		PE_OLB_O24_QRd02(olb_osc1_ctrl1,		reg_osc1_y_st, y_ofst[1],\
												reg_osc1_y_ed, y_end_ofst[1]);
		x_size[1] = x_ofst[1] > x_end_ofst[1]? 0:(x_end_ofst[1] - x_ofst[1] + 1);
		y_size[1] = y_ofst[1] > y_end_ofst[1]? 0:(y_end_ofst[1] - y_ofst[1] + 1);

		PE_OLB_O24_QRd02(olb_osc2_ctrl0,		reg_osc2_x_st, x_ofst[2],\
												reg_osc2_x_ed, x_end_ofst[2]);
		PE_OLB_O24_QRd02(olb_osc2_ctrl1,		reg_osc2_y_st, y_ofst[2],\
												reg_osc2_y_ed, y_end_ofst[2]);
		x_size[2]  = x_ofst[2] > x_end_ofst[2]? 0:(x_end_ofst[2] - x_ofst[2] + 1);
		y_size[2]  = y_ofst[2] > y_end_ofst[2]? 0:(y_end_ofst[2] - y_ofst[2] + 1);
		
		PE_OLB_O24_QRd02(olb_osc3_ctrl0,		reg_osc3_x_st, x_ofst[3],\
												reg_osc3_x_ed, x_end_ofst[3]);
		PE_OLB_O24_QRd02(olb_osc3_ctrl1,		reg_osc3_y_st, y_ofst[3],\
												reg_osc3_y_ed, y_end_ofst[3]);
		...
		PE_OLB_O24_QRd04(olb_top_ctrl0,		reg_olb_osc0_enable, win_path_en[0],\
											reg_olb_osc1_enable, win_path_en[1],\
											reg_olb_osc2_enable, win_path_en[2],\
											reg_olb_osc3_enable, win_path_en[3]);
		/* invalid size check */
		o_pstWinPrms->is_invalid_size[LX_PE_WIN_0] = \
			(x_size[0] <= (PE_WIN_HW_O24_WIN_OFFSET_MAX<<1) || \
			x_size[0] > (PE_WIN_HW_O24_UHD_H_MAX+100)		|| \
			y_size[0] <= (PE_WIN_HW_O24_WIN_OFFSET_MAX<<1)	|| \
			!win_path_en[0])? 1:0;
		o_pstWinPrms->is_invalid_size[LX_PE_WIN_1] = \
			(x_size[1] <= (PE_WIN_HW_O24_WIN_OFFSET_MAX<<1) || \
			x_size[1] > (PE_WIN_HW_O24_UHD_H_MAX+100)		|| \
			y_size[1] <= (PE_WIN_HW_O24_WIN_OFFSET_MAX<<1)	|| \
			!win_path_en[1])? 1:0;
		o_pstWinPrms->is_invalid_size[LX_PE_WIN_2] = \
			(x_size[2] <= (PE_WIN_HW_O24_WIN_OFFSET_MAX<<1) || \
			x_size[2] > (PE_WIN_HW_O24_UHD_H_MAX+100)		|| \
			y_size[2] <= (PE_WIN_HW_O24_WIN_OFFSET_MAX<<1)	|| \
			!win_path_en[2])? 1:0;
		o_pstWinPrms->is_invalid_size[LX_PE_WIN_3] = \
			(x_size[3] <= (PE_WIN_HW_O24_WIN_OFFSET_MAX<<1) || \
			x_size[3] > (PE_WIN_HW_O24_UHD_H_MAX+100)		|| \
			y_size[3] <= (PE_WIN_HW_O24_WIN_OFFSET_MAX<<1)	|| \
			!win_path_en[3])? 1:0;
	}
	else
	{
		PE_VCP_DISP_O24_QRd02(vcp_u0_win_o_pos,		cdc_win_o_pos_x, x_ofst[0],\
												 	cdc_win_o_pos_y, y_ofst[0]);
		
		PE_VCP_DISP_O24_QRd02(vcp_u0_win_o_size,	cdc_win_o_size_x, x_size[0],\
													cdc_win_o_size_y, y_size[0]);

		PE_VCP_DISP_O24_QRd02(vcp_u1_win_o_pos,		cdc_win_o_pos_x,  x_ofst[1],\
												 	cdc_win_o_pos_y,  y_ofst[1]);
		PE_VCP_DISP_O24_QRd02(vcp_u1_win_o_size,	cdc_win_o_size_x, x_size[1],\
		...
		o_pstWinPrms->is_invalid_size[LX_PE_WIN_0] = \
			(x_size[0] <= (PE_WIN_HW_O24_WIN_OFFSET_MAX<<1) || \
			x_size[0] > (PE_WIN_HW_O24_UHD_H_MAX+100)		|| \
			y_size[0] <= (PE_WIN_HW_O24_WIN_OFFSET_MAX<<1))? 1:0;
		o_pstWinPrms->is_invalid_size[LX_PE_WIN_1] = \
			(x_size[1] <= (PE_WIN_HW_O24_WIN_OFFSET_MAX<<1) || \
			x_size[1] > (PE_WIN_HW_O24_UHD_H_MAX+100)		|| \
			y_size[1] <= (PE_WIN_HW_O24_WIN_OFFSET_MAX<<1))? 1:0;
		o_pstWinPrms->is_invalid_size[LX_PE_WIN_2] = \
			(x_size[2] <= (PE_WIN_HW_O24_WIN_OFFSET_MAX<<1) || \
			x_size[2] > (PE_WIN_HW_O24_UHD_H_MAX+100)		|| \
			y_size[2] <= (PE_WIN_HW_O24_WIN_OFFSET_MAX<<1))? 1:0;
		o_pstWinPrms->is_invalid_size[LX_PE_WIN_3] = \
			(x_size[3] <= (PE_WIN_HW_O24_WIN_OFFSET_MAX<<1) || \
			x_size[3] > (PE_WIN_HW_O24_UHD_H_MAX+100)		|| \
			y_size[3] <= (PE_WIN_HW_O24_WIN_OFFSET_MAX<<1))? 1:0;
	...
	{
		o_pstWinPrms->h_max=PE_WIN_HW_O24_FHD_H_MAX;
		o_pstWinPrms->v_max=PE_WIN_HW_O24_FHD_V_MAX;
	}
	else // 4k 3840x2160
	{
		o_pstWinPrms->h_max=PE_WIN_HW_O24_UHD_H_MAX;
		o_pstWinPrms->v_max=PE_WIN_HW_O24_UHD_V_MAX;
	}
	#if 0
	...
	#endif
	/* left ofst*/
	PE_WIN_HW_O24_GetWinLeftOfst(x_ofst[0], y_ofst[0],o_pstWinPrms,LX_PE_WIN_0);
	PE_WIN_HW_O24_GetWinLeftOfst(x_ofst[1], y_ofst[1],o_pstWinPrms,LX_PE_WIN_1);
	PE_WIN_HW_O24_GetWinLeftOfst(x_ofst[2], y_ofst[2],o_pstWinPrms,LX_PE_WIN_2);
	PE_WIN_HW_O24_GetWinLeftOfst(x_ofst[3], y_ofst[3],o_pstWinPrms,LX_PE_WIN_3);
	#if 0
	...
	/* right ofst*/
	PE_WIN_HW_O24_GetWinRightOfst(x_ofst[0], y_ofst[0],x_size[0],y_size[0],o_pstWinPrms,LX_PE_WIN_0);
	PE_WIN_HW_O24_GetWinRightOfst(x_ofst[1], y_ofst[1],x_size[1],y_size[1],o_pstWinPrms,LX_PE_WIN_1);
	PE_WIN_HW_O24_GetWinRightOfst(x_ofst[2], y_ofst[2],x_size[2],y_size[2],o_pstWinPrms,LX_PE_WIN_2);
	PE_WIN_HW_O24_GetWinRightOfst(x_ofst[3], y_ofst[3],x_size[3],y_size[3],o_pstWinPrms,LX_PE_WIN_3);
	#if 0
	...
	#if 0
	printk("o_pstWinPrms->w[0]:%d,%d,%d,%d, o_pstWinPrms->w[1]:%d,%d,%d,%d\n",\
 ...
 * @author
 */
static void PE_WIN_HW_O24_GetActNWinCrdsForExtFRC_PIP(PE_TSK_O24_CFG_T 			*i_pstCfg,
													LX_PE_WIN_PARAMS_T 			*i_pstWinPrms,
													LX_PE_ACT_WIN_COORDINATES_T *o_pstActWinCrds)
{
	__attribute__((unused)) LX_PE_INF_DISPLAY_T *disp0_info = &i_pstCfg->inf.disp_info[LX_PE_WIN_0];
												...
												LX_PE_ACT_WIN_COORDINATES_T *o_pstActWinCrds)
{
	...
	if(_g_pe_win_hw_o24_info.is_external_chip==0x0 &&\
		disp0_info->sub_mode > LX_DE_SUB_MODE_NONE && disp0_info->sub_mode <LX_DE_SUB_MODE_MAXN)
	{
		PE_WIN_HW_O24_GetActNWinCrdsForExtFRC_PIP( i_pstCfg, i_pstWinPrms, o_pstActWinCrds );
	}
	else
	{
		/* window 0 */
												...
												LX_PE_SHP_CEN_WIN_EN_T	*o_pstShpCenWinEn)
{
	...
	{
				o_pstShpCenWinEn->win0_en[PE_WIN_HW_O24_SHP_WIN]=PE_WIN_HW_O24_WIN_EN__ON;
				o_pstShpCenWinEn->win1_en[PE_WIN_HW_O24_SHP_WIN]=PE_WIN_HW_O24_WIN_EN__ON;
				o_pstShpCenWinEn->win01_en[PE_WIN_HW_O24_SHP_WIN]=PE_WIN_HW_O24_WIN_EN__ON;
				o_pstShpCenWinEn->win0_en[PE_WIN_HW_O24_CEN_WIN]=PE_WIN_HW_O24_WIN_EN__ON;
				o_pstShpCenWinEn->win1_en[PE_WIN_HW_O24_CEN_WIN]=PE_WIN_HW_O24_WIN_EN__ON;
				o_pstShpCenWinEn->win01_en[PE_WIN_HW_O24_CEN_WIN]=PE_WIN_HW_O24_WIN_EN__ON;
	}
	else if(disp0_info->sub_mode == LX_DE_SUB_MODE_PBP || disp0_info->sub_mode == LX_DE_SUB_MODE_DUALMON)
	{
		o_pstShpCenWinEn->win0_en[PE_WIN_HW_O24_SHP_WIN]=PE_WIN_HW_O24_WIN_EN__ON;
		#if 0
		o_pstShpCenWinEn->win1_en[PE_WIN_HW_O24_SHP_WIN]=(ctrl0_info->vcp_mute_on)? \
			PE_WIN_HW_O24_WIN_EN_OFF:PE_WIN_HW_O24_WIN_EN__ON;
		o_pstShpCenWinEn->win01_en[PE_WIN_HW_O24_SHP_WIN]=PE_WIN_HW_O24_WIN_EN_OFF;
		#else
		o_pstShpCenWinEn->win1_en[PE_WIN_HW_O24_SHP_WIN]= PE_WIN_HW_O24_WIN_EN__ON;
		o_pstShpCenWinEn->win01_en[PE_WIN_HW_O24_SHP_WIN]=PE_WIN_HW_O24_WIN_EN_OFF;
		#endif
		o_pstShpCenWinEn->win0_en[PE_WIN_HW_O24_CEN_WIN]=PE_WIN_HW_O24_WIN_EN__ON;
		o_pstShpCenWinEn->win1_en[PE_WIN_HW_O24_CEN_WIN]=PE_WIN_HW_O24_WIN_EN__ON;
		o_pstShpCenWinEn->win01_en[PE_WIN_HW_O24_CEN_WIN]=PE_WIN_HW_O24_WIN_EN_OFF;
	}
	...
	{
		o_pstShpCenWinEn->win0_en[PE_WIN_HW_O24_SHP_WIN]=(i_bIsResizeSet)? \
			PE_WIN_HW_O24_WIN_EN_OFF:PE_WIN_HW_O24_WIN_EN__ON;
		o_pstShpCenWinEn->win1_en[PE_WIN_HW_O24_SHP_WIN]=PE_WIN_HW_O24_WIN_EN_OFF;
		o_pstShpCenWinEn->win01_en[PE_WIN_HW_O24_SHP_WIN]=PE_WIN_HW_O24_WIN_EN_OFF;
		o_pstShpCenWinEn->win0_en[PE_WIN_HW_O24_CEN_WIN]=PE_WIN_HW_O24_WIN_EN__ON;
		o_pstShpCenWinEn->win1_en[PE_WIN_HW_O24_CEN_WIN]=PE_WIN_HW_O24_WIN_EN_OFF;
		o_pstShpCenWinEn->win01_en[PE_WIN_HW_O24_CEN_WIN]=PE_WIN_HW_O24_WIN_EN_OFF;
	} 
	return;
}
								 ...
								 LX_PE_ACT_WIN_COORDINATES_T 		*i_pstActWinCrds)
{
	...
	if((win_info->act0_x0 != i_pstActWinCrds->act0_x0)|| (win_info->act0_y0 != i_pstActWinCrds->act0_y0)|| \
		...
		if(_g_win_hw_o24_trace) {

			PE_WIN_HW_O24_DBG_PRINT_ALWAYS("[inf]rev:%d,submode:%d,ofs0,1:%d,%d,%d,%d, %d,%d,%d,%d\n",\
			...
			PE_WIN_HW_O24_DBG_PRINT_ALWAYS("[inf]o_win0:%d,%d,%d,%d,o_win1:%d,%d,%d,%d\n",\
			...
			PE_WIN_HW_O24_DBG_PRINT_ALWAYS("[set]act0 : prev:%d,%d,%d,%d, cur:%d,%d,%d,%d\n",\
			...
			PE_WIN_HW_O24_DBG_PRINT_ALWAYS("[set]act1 : prev:%d,%d,%d,%d, cur:%d,%d,%d,%d\n",\
		...
		if(PE_KDRV_VER_O24)	{
            if (i_pstCfg->opr.pause_task == PE_TSK_O24_RUN_STOP_WIN2)
			{
	            PE_CC_PE1_O24_QWr02(pe1_win2_ctrl_01,	win_w0_x0_0,((i_pstActWinCrds->act0_x0+1)>>1),\
	                                                  	win_w0_y0_0,i_pstActWinCrds->act0_y0);
	            PE_CC_PE1_O24_QWr02(pe1_win2_ctrl_02,	win_w0_x1_0,(i_pstActWinCrds->act0_x1>>1),\
	                                                  	win_w0_y1_0,i_pstActWinCrds->act0_y1);
	            PE_CC_PE1_O24_QWr02(pe1_win2_ctrl_05,	win_w0_x0_1,(i_pstActWinCrds->act0_x0>>1),\
	                                                  	win_w0_y0_1,i_pstActWinCrds->act0_y0);
				if(i_pstActWinCrds->act0_x1 == 0)
				{
		            PE_CC_PE1_O24_QWr02(pe1_win2_ctrl_06,	win_w0_x1_1,0x0,\
		                                                  	win_w0_y1_1,i_pstActWinCrds->act0_y1);
				}
				else
				{
		            PE_CC_PE1_O24_QWr02(pe1_win2_ctrl_06,	win_w0_x1_1,((i_pstActWinCrds->act0_x1-1)>>1),\
		                                                  	win_w0_y1_1,i_pstActWinCrds->act0_y1);
				}
				// added for DC AVTASK-1314
	            PE_CC_PE1_O24_QWr02(pe1_win2_ctrl_17,	win_w0_x0_2,((i_pstActWinCrds->act0_x0+1)>>1),\
	                                                  	win_w0_y0_2,i_pstActWinCrds->act0_y0);
	            PE_CC_PE1_O24_QWr02(pe1_win2_ctrl_18,	win_w0_x1_2,(i_pstActWinCrds->act0_x1>>1),\
	                                                  	win_w0_y1_2,i_pstActWinCrds->act0_y1);
	            PE_CC_PE1_O24_QWr02(pe1_win2_ctrl_21,	win_w0_x0_3,(i_pstActWinCrds->act0_x0>>1),\
	                                                  	win_w0_y0_3,i_pstActWinCrds->act0_y0);
				if(i_pstActWinCrds->act0_x1 == 0)
				{
		            PE_CC_PE1_O24_QWr02(pe1_win2_ctrl_22,	win_w0_x1_3,0x0,\
		                                                  	win_w0_y1_3,i_pstActWinCrds->act0_y1);
				}
				else
				{
		            PE_CC_PE1_O24_QWr02(pe1_win2_ctrl_22,	win_w0_x1_3,((i_pstActWinCrds->act0_x1-1)>>1),\
		                                                  	win_w0_y1_3,i_pstActWinCrds->act0_y1);
				}
			}
			else
			{
				if(_g_win_hw_o24_trace) 
				{
					PE_WIN_HW_O24_DBG_PRINT_ALWAYS("[inf]pause_task:%d, w0 SKIP.\n",i_pstCfg->opr.pause_task);
				}
			}
            PE_CC_PE1_O24_QWr02(pe1_win2_ctrl_03,	win_w1_x0_0,((i_pstActWinCrds->act1_x0+1)>>1),\
                                                  	win_w1_y0_0,i_pstActWinCrds->act1_y0);
            PE_CC_PE1_O24_QWr02(pe1_win2_ctrl_04,	win_w1_x1_0,(i_pstActWinCrds->act1_x1>>1),\
                                                  	win_w1_y1_0,i_pstActWinCrds->act1_y1);
            PE_CC_PE1_O24_QWr02(pe1_win2_ctrl_07,	win_w1_x0_1,(i_pstActWinCrds->act1_x0>>1),\
                                                  	win_w1_y0_1,i_pstActWinCrds->act1_y0);
			if(i_pstActWinCrds->act1_x1==0)
			{
	            PE_CC_PE1_O24_QWr02(pe1_win2_ctrl_08,	win_w1_x1_1,0x0,\
	                                                  	win_w1_y1_1,i_pstActWinCrds->act1_y1);
			}
			else
			{
	            PE_CC_PE1_O24_QWr02(pe1_win2_ctrl_08,	win_w1_x1_1,((i_pstActWinCrds->act1_x1-1)>>1),\
	                                                  	win_w1_y1_1,i_pstActWinCrds->act1_y1);
			}
			// added for DC AVTASK-1314
            PE_CC_PE1_O24_QWr02(pe1_win2_ctrl_19,	win_w1_x0_2,((i_pstActWinCrds->act1_x0+1)>>1),\
                                                  	win_w1_y0_2,i_pstActWinCrds->act1_y0);
            PE_CC_PE1_O24_QWr02(pe1_win2_ctrl_20,	win_w1_x1_2,(i_pstActWinCrds->act1_x1>>1),\
                                                  	win_w1_y1_2,i_pstActWinCrds->act1_y1);
            PE_CC_PE1_O24_QWr02(pe1_win2_ctrl_23,	win_w1_x0_3,(i_pstActWinCrds->act1_x0>>1),\
                                                  	win_w1_y0_3,i_pstActWinCrds->act1_y0);
			if(i_pstActWinCrds->act1_x1==0)
			{
	            PE_CC_PE1_O24_QWr02(pe1_win2_ctrl_24,	win_w1_x1_3,0x0,\
	                                                  	win_w1_y1_3,i_pstActWinCrds->act1_y1);
			}
			else
			{
	            PE_CC_PE1_O24_QWr02(pe1_win2_ctrl_24,	win_w1_x1_3,((i_pstActWinCrds->act1_x1-1)>>1),\
	                                                  	win_w1_y1_3,i_pstActWinCrds->act1_y1);
			}
			#if 0
			PE_CC_PE1_O24_QWr02(pe1_apl_ctrl_00,apl_win_ctrl_x0,(i_pstActWinCrds->act0_x0>>1),\
			 										apl_win_ctrl_y0,i_pstActWinCrds->act0_y0);
			if (disp0_info->out_type==LX_PE_OUT_PIP && ctrl0_info->hv_same)	//double window
			{
				PE_CC_PE1_O24_QWr02(pe1_apl_ctrl_01,apl_win_ctrl_x1,(i_pstActWinCrds->act1_x1>>1),
													apl_win_ctrl_y1,i_pstActWinCrds->act1_y1);
			}
			else
			{
				PE_CC_PE1_O24_QWr02(pe1_apl_ctrl_01,apl_win_ctrl_x1,(i_pstActWinCrds->act0_x1>>1),
													apl_win_ctrl_y1,i_pstActWinCrds->act0_y1);
			}
			#else
			if(_g_pe_win_hw_o24_info.is_external_chip==0 && \
				disp0_info->sub_mode==LX_DE_SUB_MODE_PIP && !i_pstWinPrms->is_invalid_size[LX_PE_WIN_1])//miracast & sub video on
			{
				PE_CC_PE1_O24_QWr02(pe1_apl_ctrl_00,	apl_win_ctrl_x0_0,(i_pstActWinCrds->act1_x0>>1),\
			 											apl_win_ctrl_y0_0,i_pstActWinCrds->act1_y0);
				PE_CC_PE1_O24_QWr02(pe1_apl_ctrl_01,	apl_win_ctrl_x1_0,(i_pstActWinCrds->act1_x1>>1),
														apl_win_ctrl_y1_0,i_pstActWinCrds->act1_y1);
				PE_CC_PE1_O24_QWr02(pe1_apl_ctrl_03,	apl_win_ctrl_x0_1,(i_pstActWinCrds->act1_x0>>1),\
			 											apl_win_ctrl_y0_1,i_pstActWinCrds->act1_y0);
				PE_CC_PE1_O24_QWr02(pe1_apl_ctrl_04,	apl_win_ctrl_x1_1,(i_pstActWinCrds->act1_x1>>1),
														apl_win_ctrl_y1_1,i_pstActWinCrds->act1_y1);
			}
			else if(_g_pe_win_hw_o24_info.is_external_chip==0 && \
			...
			{
				PE_CC_PE1_O24_QWr02(pe1_apl_ctrl_00,	apl_win_ctrl_x0_0,(i_pstActWinCrds->act0_x0>>1),\
		 												apl_win_ctrl_y0_0,i_pstActWinCrds->act0_y0);
				PE_CC_PE1_O24_QWr02(pe1_apl_ctrl_01,	apl_win_ctrl_x1_0,(i_pstActWinCrds->act1_x1>>1),
														apl_win_ctrl_y1_0,i_pstActWinCrds->act1_y1);
				PE_CC_PE1_O24_QWr02(pe1_apl_ctrl_03,	apl_win_ctrl_x0_1,(i_pstActWinCrds->act0_x0>>1),\
			...
			else
			{
				PE_CC_PE1_O24_QWr02(pe1_apl_ctrl_00,	apl_win_ctrl_x0_0,(i_pstActWinCrds->act0_x0>>1),\
			 											apl_win_ctrl_y0_0,i_pstActWinCrds->act0_y0);
				PE_CC_PE1_O24_QWr02(pe1_apl_ctrl_01,	apl_win_ctrl_x1_0,(i_pstActWinCrds->act0_x1>>1),
														apl_win_ctrl_y1_0,i_pstActWinCrds->act0_y1);
				PE_CC_PE1_O24_QWr02(pe1_apl_ctrl_03,	apl_win_ctrl_x0_1,(i_pstActWinCrds->act0_x0>>1),\
			 											apl_win_ctrl_y0_1,i_pstActWinCrds->act0_y0);
				PE_CC_PE1_O24_QWr02(pe1_apl_ctrl_04,	apl_win_ctrl_x1_1,(i_pstActWinCrds->act0_x1>>1),
								 ...
								 LX_PE_ACT_WIN_COORDINATES_T 		*i_pstActWinCrds)
{
	...
	if((win_info->win0_x0 != i_pstActWinCrds->win0_x0)|| (win_info->win0_y0 != i_pstActWinCrds->win0_y0)|| \
		...
		if(_g_win_hw_o24_trace) {
			...
			PE_WIN_HW_O24_DBG_PRINT_ALWAYS("[set]win0 : prev:%d,%d,%d,%d, cur:%d,%d,%d,%d\n",\
			...
			PE_WIN_HW_O24_DBG_PRINT_ALWAYS("[set]win1 : prev:%d,%d,%d,%d, cur:%d,%d,%d,%d\n",\
			...
			PE_WIN_HW_O24_DBG_PRINT_ALWAYS("[inf]hmax, vmax : cur:%d,%d\n",\
		...
		if(PE_KDRV_VER_O24) {
			...
			/* shp_l */
			/* esf */
            PE_VSD_SHP_O24_QWr02(shp_esf_win_ctrl_01,	reg_win_esf_win_w0_x0,	shp_l_w0_x0,\
													reg_win_esf_win_w0_y0,	i_pstActWinCrds->win0_y0);
            PE_VSD_SHP_O24_QWr02(shp_esf_win_ctrl_02,	reg_win_esf_win_w0_x1,	shp_l_w0_x1,\
													reg_win_esf_win_w0_y1,	i_pstActWinCrds->win0_y1);
            PE_VSD_SHP_O24_QWr02(shp_esf_win_ctrl_03,	reg_win_esf_win_w1_x0,	shp_l_w1_x0,\
													reg_win_esf_win_w1_y0,	i_pstActWinCrds->win1_y0);
            PE_VSD_SHP_O24_QWr02(shp_esf_win_ctrl_04,	reg_win_esf_win_w1_x1,	shp_l_w1_x1,\
													reg_win_esf_win_w1_y1,	i_pstActWinCrds->win1_y1);
			/* dp*/
			PE_VSD_SHP_O24_QWr02(shp_dp_win_ctrl_01,	reg_win_dp_win_w0_x0,	shp_l_w0_x0,\
													reg_win_dp_win_w0_y0,	i_pstActWinCrds->win0_y0);
            PE_VSD_SHP_O24_QWr02(shp_dp_win_ctrl_02,	reg_win_dp_win_w0_x1,	shp_l_w0_x1,\
													reg_win_dp_win_w0_y1,	i_pstActWinCrds->win0_y1);
            PE_VSD_SHP_O24_QWr02(shp_dp_win_ctrl_03,	reg_win_dp_win_w1_x0,	shp_l_w1_x0,\
													reg_win_dp_win_w1_y0,	i_pstActWinCrds->win1_y0);
            PE_VSD_SHP_O24_QWr02(shp_dp_win_ctrl_04,	reg_win_dp_win_w1_x1,	shp_l_w1_x1,\
													reg_win_dp_win_w1_y1,	i_pstActWinCrds->win1_y1);
			/* dj*/
			PE_VSD_SHP_O24_QWr02(shp_dj_win_ctrl_01,	reg_win_dj_win_w0_x0,	shp_l_w0_x0,\
													reg_win_dj_win_w0_y0,	i_pstActWinCrds->win0_y0);
            PE_VSD_SHP_O24_QWr02(shp_dj_win_ctrl_02,	reg_win_dj_win_w0_x1,	shp_l_w0_x1,\
													reg_win_dj_win_w0_y1,	i_pstActWinCrds->win0_y1);
            PE_VSD_SHP_O24_QWr02(shp_dj_win_ctrl_03,	reg_win_dj_win_w1_x0,	shp_l_w1_x0,\
													reg_win_dj_win_w1_y0,	i_pstActWinCrds->win1_y0);
            PE_VSD_SHP_O24_QWr02(shp_dj_win_ctrl_04,	reg_win_dj_win_w1_x1,	shp_l_w1_x1,\
									 ...
									 LX_PE_SHP_CEN_WIN_EN_T 		*i_pstShpCenWinEn)
{
	...
	if((win_info->win0_en[PE_WIN_HW_O24_SHP_WIN] != i_pstShpCenWinEn->win0_en[PE_WIN_HW_O24_SHP_WIN]) || \
		(win_info->win1_en[PE_WIN_HW_O24_SHP_WIN] != i_pstShpCenWinEn->win1_en[PE_WIN_HW_O24_SHP_WIN]) || \
		(win_info->win01_en[PE_WIN_HW_O24_SHP_WIN] != i_pstShpCenWinEn->win01_en[PE_WIN_HW_O24_SHP_WIN]))
	{
		if(_g_win_hw_o24_trace) {
			...
			PE_WIN_HW_O24_DBG_PRINT_ALWAYS("[set]shp_win_en(0,1,01):%d,%d,%d \n",\
				win_info->win0_en[PE_WIN_HW_O24_SHP_WIN], win_info->win1_en[PE_WIN_HW_O24_SHP_WIN],\
				win_info->win01_en[PE_WIN_HW_O24_SHP_WIN]);
		}

		if(PE_KDRV_VER_O24) {
			/*esf*/
			PE_VSD_SHP_O24_QWr03(shp_esf_win_ctrl_00, reg_win_esf_win0_en, i_pstShpCenWinEn->win0_en[PE_WIN_HW_O24_SHP_WIN], \
                                                  reg_win_esf_win1_en, i_pstShpCenWinEn->win1_en[PE_WIN_HW_O24_SHP_WIN], \
                                                  reg_win_esf_win01_en,i_pstShpCenWinEn->win01_en[PE_WIN_HW_O24_SHP_WIN]);
			/*dp*/
			PE_VSD_SHP_O24_QWr03(shp_dp_win_ctrl_00, reg_win_dp_win0_en, i_pstShpCenWinEn->win0_en[PE_WIN_HW_O24_SHP_WIN] , \
                                                 reg_win_dp_win1_en, i_pstShpCenWinEn->win1_en[PE_WIN_HW_O24_SHP_WIN] , \
                                                 reg_win_dp_win01_en,i_pstShpCenWinEn->win01_en[PE_WIN_HW_O24_SHP_WIN]);
			/*dj*/
			PE_VSD_SHP_O24_QWr03(shp_dj_win_ctrl_00, reg_win_dj_win0_en, i_pstShpCenWinEn->win0_en[PE_WIN_HW_O24_SHP_WIN] , \
                                                 reg_win_dj_win1_en, i_pstShpCenWinEn->win1_en[PE_WIN_HW_O24_SHP_WIN] , \
                                                 reg_win_dj_win01_en,i_pstShpCenWinEn->win01_en[PE_WIN_HW_O24_SHP_WIN]);
		}

		win_info->win0_en[PE_WIN_HW_O24_SHP_WIN] = i_pstShpCenWinEn->win0_en[PE_WIN_HW_O24_SHP_WIN];
		win_info->win1_en[PE_WIN_HW_O24_SHP_WIN] = i_pstShpCenWinEn->win1_en[PE_WIN_HW_O24_SHP_WIN];
		win_info->win01_en[PE_WIN_HW_O24_SHP_WIN] = i_pstShpCenWinEn->win01_en[PE_WIN_HW_O24_SHP_WIN];
	}
	#endif /*PE_HW_O24_BRINGUP*/
									 ...
									 LX_PE_SHP_CEN_WIN_EN_T 		*i_pstShpCenWinEn)
{
	...
	if((win_info->win0_en[PE_WIN_HW_O24_CEN_WIN] != i_pstShpCenWinEn->win0_en[PE_WIN_HW_O24_CEN_WIN]) || \
	   (win_info->win1_en[PE_WIN_HW_O24_CEN_WIN] != i_pstShpCenWinEn->win1_en[PE_WIN_HW_O24_CEN_WIN]) || \
	   (win_info->win01_en[PE_WIN_HW_O24_CEN_WIN] != i_pstShpCenWinEn->win01_en[PE_WIN_HW_O24_CEN_WIN]))
	{
		if(_g_win_hw_o24_trace) {
			...
			PE_WIN_HW_O24_DBG_PRINT_ALWAYS("[set]cen_win_en(0,1,01):%d,%d,%d \n",\
				win_info->win0_en[PE_WIN_HW_O24_CEN_WIN], win_info->win1_en[PE_WIN_HW_O24_CEN_WIN],\
				win_info->win01_en[PE_WIN_HW_O24_CEN_WIN]);
		}

		if(PE_KDRV_VER_O24) {

			PE_CC_PE1_O24_QWr03(pe1_win2_ctrl_00,win0_en,i_pstShpCenWinEn->win0_en[PE_WIN_HW_O24_CEN_WIN], \
                                                    win1_en,i_pstShpCenWinEn->win1_en[PE_WIN_HW_O24_CEN_WIN], \
                                                    win01_en,i_pstShpCenWinEn->win01_en[PE_WIN_HW_O24_CEN_WIN]);
		}

		win_info->win0_en[PE_WIN_HW_O24_CEN_WIN] = i_pstShpCenWinEn->win0_en[PE_WIN_HW_O24_CEN_WIN];
		win_info->win1_en[PE_WIN_HW_O24_CEN_WIN] = i_pstShpCenWinEn->win1_en[PE_WIN_HW_O24_CEN_WIN];
		win_info->win01_en[PE_WIN_HW_O24_CEN_WIN] = i_pstShpCenWinEn->win01_en[PE_WIN_HW_O24_CEN_WIN];
	}
	#endif /*PE_HW_O24_BRINGUP*/
									 ...
									 LX_PE_WIN_PARAMS_T 			*i_pstWinPrms)
{
	...
	UINT32 cur_win_en[4];
	int i;
	UINT32 dc_win_enable; //PE1_DCE_CTRL_00.window_enable

	dc_win_enable = 0x0;
	for (i =0; i < 4 ; i++)
	{
		if(i_pstWinPrms->is_invalid_size[i] !=0)
		{
			cur_win_en[i]=0;
		}
		else
		...
		dc_win_enable += (cur_win_en[i]<<i);
	}
	
	if(win_info->dc_win_en != dc_win_enable)
	{
		PE_CC_PE1_O24_QWr01(pe1_dce_ctrl_00, window_enable, GET_BITS(dc_win_enable,0,4));
		win_info->dc_win_en = dc_win_enable;
		if(_g_win_hw_o24_trace) {

			PE_WIN_HW_O24_DBG_PRINT_ALWAYS("[inf]rev:%d,submode:%d,cur_dc_win:%d,%d,%d,%d, window_enable:0x%X, is_invalid_size:%d,%d,%d,%d \n",\
				disp0_info->mode.is_reverse,disp0_info->sub_mode,\
				cur_win_en[0],cur_win_en[1],cur_win_en[2],cur_win_en[3],dc_win_enable,\
				i_pstWinPrms->is_invalid_size[0],i_pstWinPrms->is_invalid_size[1],i_pstWinPrms->is_invalid_size[2],i_pstWinPrms->is_invalid_size[3]) ;
		}
	}
	#endif /*PE_HW_O24_BRINGUP*/
	return;
										   ...
										   LX_PE_WIN_PARAMS_T 			*i_pstWinPrms)
{
	...
	if((win_info->h_max != i_pstWinPrms->h_max)|| (win_info->v_max != i_pstWinPrms->v_max))	{
		...
		if(_g_win_hw_o24_trace) {
			...
			PE_WIN_HW_O24_DBG_PRINT_ALWAYS("[inf]rev:%d,sub_mode:%d,ofs0,1:%d,%d,%d,%d, %d,%d,%d,%d\n",\
				disp0_info->mode.is_reverse,disp0_info->sub_mode,\
				i_pstWinPrms->x0_ofst[LX_PE_WIN_0],i_pstWinPrms->y0_ofst[LX_PE_WIN_0],\
				i_pstWinPrms->x1_ofst[LX_PE_WIN_0],i_pstWinPrms->y1_ofst[LX_PE_WIN_0],\
				i_pstWinPrms->x0_ofst[LX_PE_WIN_1],i_pstWinPrms->y0_ofst[LX_PE_WIN_1],\
			...
			PE_WIN_HW_O24_DBG_PRINT_ALWAYS("[set]h,v_max : prev:%d,%d, cur:%d,%d\n",\
		...
		if(PE_KDRV_VER_O24) {
			...
			PE_VSD_SHP_O24_QWr02(shp_core_ctrl_01,reg_top_width,shp_top_w,reg_top_height,i_pstWinPrms->v_max);
			PE_CC_PE1_O24_QWr02(pe1_top_ctrl_01,width,(i_pstWinPrms->h_max>>1),height,i_pstWinPrms->v_max);
            //PE_CC_PE1_O24_QWr02(pe1_apl_ctrl_00,apl_win_ctrl_x0,0,apl_win_ctrl_y0,0);
            //PE_CC_PE1_O24_QWr02(pe1_apl_ctrl_01,apl_win_ctrl_x1,(i_pstWinPrms->h_max>>1),apl_win_ctrl_y1,i_pstWinPrms->v_max);
		}
								 ...
								 LX_PE_ACT_WIN_COORDINATES_T 		*i_pstActWinCrds)
{
	#ifndef PE_HW_O24_BRINGUP
	__attribute__((unused)) LX_PE_INF_DISPLAY_T *disp0_info = &i_pstCfg->inf.disp_info[LX_PE_WIN_0];
	__attribute__((unused)) PE_INF_O24_CTRL_T *ctrl2_info 	= &i_pstCfg->inf.ctrl_info[LX_PE_WIN_2];
	__attribute__((unused)) PE_INF_O24_CTRL_T *ctrl3_info 	= &i_pstCfg->inf.ctrl_info[LX_PE_WIN_3];
	PE_WIN_HW_O24_CTRL_T *win_info	= &_g_pe_win_hw_o24_info.win_inf;

	//win0, win1 setting @PE_WIN_HW_O24_SetCen with PE1_WIN2_CTRL_01~09
	// set only win2, win3 
	if(	(win_info->act2_x0 != i_pstActWinCrds->act2_x0)|| (win_info->act2_y0 != i_pstActWinCrds->act2_y0)|| \
		...
		if(PE_KDRV_VER_O24)	{
			//win2 ch 0,1,2,3
            PE_CC_PE1_O24_QWr02(pe1_win2_ctrl_09,	win_w2_x0_0,((i_pstActWinCrds->act2_x0+1)>>1),\
                                                    win_w2_y0_0,i_pstActWinCrds->act2_y0);
            PE_CC_PE1_O24_QWr02(pe1_win2_ctrl_10,	win_w2_x1_0,(i_pstActWinCrds->act2_x1>>1),\
                                                    win_w2_y1_0,i_pstActWinCrds->act2_y1);
            PE_CC_PE1_O24_QWr02(pe1_win2_ctrl_13,	win_w2_x0_1,(i_pstActWinCrds->act2_x0>>1),\
                                                    win_w2_y0_1,i_pstActWinCrds->act2_y0);
			if(i_pstActWinCrds->act2_x1==0)
			{
	            PE_CC_PE1_O24_QWr02(pe1_win2_ctrl_14,	win_w2_x1_1,0x0,\
	                                                    win_w2_y1_1,i_pstActWinCrds->act2_y1);
			}
			else
			{
	            PE_CC_PE1_O24_QWr02(pe1_win2_ctrl_14,	win_w2_x1_1,((i_pstActWinCrds->act2_x1-1)>>1),\
	                                                    win_w2_y1_1,i_pstActWinCrds->act2_y1);
			}
            PE_CC_PE1_O24_QWr02(pe1_win2_ctrl_25,	win_w2_x0_2,((i_pstActWinCrds->act2_x0+1)>>1),\
                                                    win_w2_y0_2,i_pstActWinCrds->act2_y0);
            PE_CC_PE1_O24_QWr02(pe1_win2_ctrl_26,	win_w2_x1_2,(i_pstActWinCrds->act2_x1>>1),\
                                                    win_w2_y1_2,i_pstActWinCrds->act2_y1);
            PE_CC_PE1_O24_QWr02(pe1_win2_ctrl_29,	win_w2_x0_3,(i_pstActWinCrds->act2_x0>>1),\
                                                    win_w2_y0_3,i_pstActWinCrds->act2_y0);
			if(i_pstActWinCrds->act2_x1==0)
            {
	            PE_CC_PE1_O24_QWr02(pe1_win2_ctrl_30,	win_w2_x1_3,0x0,\
	                                                    win_w2_y1_3,i_pstActWinCrds->act2_y1);
			}
			else
			{
	            PE_CC_PE1_O24_QWr02(pe1_win2_ctrl_30,	win_w2_x1_3,((i_pstActWinCrds->act2_x1-1)>>1),\
	                                                    win_w2_y1_3,i_pstActWinCrds->act2_y1);
			}
			//win3 ch 0,1,2,3
            PE_CC_PE1_O24_QWr02(pe1_win2_ctrl_11,	win_w3_x0_0,((i_pstActWinCrds->act3_x0+1)>>1),\
                                                    win_w3_y0_0,i_pstActWinCrds->act3_y0);
            PE_CC_PE1_O24_QWr02(pe1_win2_ctrl_12,	win_w3_x1_0,(i_pstActWinCrds->act3_x1>>1),\
                                                    win_w3_y1_0,i_pstActWinCrds->act3_y1);
            PE_CC_PE1_O24_QWr02(pe1_win2_ctrl_15,	win_w3_x0_1,(i_pstActWinCrds->act3_x0>>1),\
                                                    win_w3_y0_1,i_pstActWinCrds->act3_y0);
			if(i_pstActWinCrds->act3_x1==0)
			{
	            PE_CC_PE1_O24_QWr02(pe1_win2_ctrl_16,	win_w3_x1_1,0x0,\
	                                                    win_w3_y1_1,i_pstActWinCrds->act3_y1);
			}
			else
			{
	            PE_CC_PE1_O24_QWr02(pe1_win2_ctrl_16,	win_w3_x1_1,((i_pstActWinCrds->act3_x1-1)>>1),\
	                                                    win_w3_y1_1,i_pstActWinCrds->act3_y1);
			}
            PE_CC_PE1_O24_QWr02(pe1_win2_ctrl_27,	win_w3_x0_2,((i_pstActWinCrds->act3_x0+1)>>1),\
                                                    win_w3_y0_2,i_pstActWinCrds->act3_y0);
            PE_CC_PE1_O24_QWr02(pe1_win2_ctrl_28,	win_w3_x1_2,(i_pstActWinCrds->act3_x1>>1),\
                                                    win_w3_y1_2,i_pstActWinCrds->act3_y1);
            PE_CC_PE1_O24_QWr02(pe1_win2_ctrl_31,	win_w3_x0_3,(i_pstActWinCrds->act3_x0>>1),\
                                                    win_w3_y0_3,i_pstActWinCrds->act3_y0);
			if(i_pstActWinCrds->act3_x1==0)
			{
	            PE_CC_PE1_O24_QWr02(pe1_win2_ctrl_32,	win_w3_x1_3,0x0,\
	                                                    win_w3_y1_3,i_pstActWinCrds->act3_y1);
			}
			else
			{
	            PE_CC_PE1_O24_QWr02(pe1_win2_ctrl_32,	win_w3_x1_3,((i_pstActWinCrds->act3_x1-1)>>1),\
	                                                    win_w3_y1_3,i_pstActWinCrds->act3_y1);
			}
		}
								 ...
								 LX_PE_ACT_WIN_COORDINATES_T 		*i_pstActWinCrds)
{
	...
	if(	(win_info->act0_x0 != i_pstActWinCrds->act0_x0)|| (win_info->act0_y0 != i_pstActWinCrds->act0_y0)|| \
		...
		if(PE_KDRV_VER_O24)	{
			//win0 ch0,1
            PE_CC_PE1_O24_QWr02(pcc_winctrl_04,	win0_w0_x0,(i_pstActWinCrds->act0_x0>>1),\
                                                win0_w0_y0,i_pstActWinCrds->act0_y0);
            PE_CC_PE1_O24_QWr02(pcc_winctrl_05,	win0_w0_x1,(i_pstActWinCrds->act0_x1>>1),\
                                                win0_w0_y1,i_pstActWinCrds->act0_y1);
            PE_CC_PE1_O24_QWr02(pcc_winctrl_12,	win0_w0_x0,(i_pstActWinCrds->act0_x0>>1),\
                                                win0_w0_y0,i_pstActWinCrds->act0_y0);
            PE_CC_PE1_O24_QWr02(pcc_winctrl_13,	win0_w0_x1,(i_pstActWinCrds->act0_x1>>1),\
                                                win0_w0_y1,i_pstActWinCrds->act0_y1);
			//win1 ch0,1
            PE_CC_PE1_O24_QWr02(pcc_winctrl_06,	win1_w0_x0,(i_pstActWinCrds->act1_x0>>1),\
                                                win1_w0_y0,i_pstActWinCrds->act1_y0);
            PE_CC_PE1_O24_QWr02(pcc_winctrl_07,	win1_w0_x1,(i_pstActWinCrds->act1_x1>>1),\
                                                win1_w0_y1,i_pstActWinCrds->act1_y1);
            PE_CC_PE1_O24_QWr02(pcc_winctrl_14,	win1_w0_x0,(i_pstActWinCrds->act1_x0>>1),\
                                                win1_w0_y0,i_pstActWinCrds->act1_y0);
            PE_CC_PE1_O24_QWr02(pcc_winctrl_15,	win1_w0_x1,(i_pstActWinCrds->act1_x1>>1),\
                                                win1_w0_y1,i_pstActWinCrds->act1_y1);
			//win2 ch0,1
            PE_CC_PE1_O24_QWr02(pcc_winctrl_08,	win2_w0_x0,(i_pstActWinCrds->act2_x0>>1),\
                                                win2_w0_y0,i_pstActWinCrds->act2_y0);
            PE_CC_PE1_O24_QWr02(pcc_winctrl_09,	win2_w0_x1,(i_pstActWinCrds->act2_x1>>1),\
                                                win2_w0_y1,i_pstActWinCrds->act2_y1);
            PE_CC_PE1_O24_QWr02(pcc_winctrl_16,	win2_w0_x0,(i_pstActWinCrds->act2_x0>>1),\
                                                win2_w0_y0,i_pstActWinCrds->act2_y0);
            PE_CC_PE1_O24_QWr02(pcc_winctrl_17,	win2_w0_x1,(i_pstActWinCrds->act2_x1>>1),\
                                                win2_w0_y1,i_pstActWinCrds->act2_y1);
			//win3 ch0,1
            PE_CC_PE1_O24_QWr02(pcc_winctrl_10,	win3_w0_x0,(i_pstActWinCrds->act3_x0>>1),\
                                                win3_w0_y0,i_pstActWinCrds->act3_y0);
            PE_CC_PE1_O24_QWr02(pcc_winctrl_11,	win3_w0_x1,(i_pstActWinCrds->act3_x1>>1),\
                                                win3_w0_y1,i_pstActWinCrds->act3_y1);
            PE_CC_PE1_O24_QWr02(pcc_winctrl_18,	win3_w0_x0,(i_pstActWinCrds->act3_x0>>1),\
                                                win3_w0_y0,i_pstActWinCrds->act3_y0);
            PE_CC_PE1_O24_QWr02(pcc_winctrl_19,	win3_w0_x1,(i_pstActWinCrds->act3_x1>>1),\
                                                win3_w0_y1,i_pstActWinCrds->act3_y1);
		}
	}
	#endif /*PE_HW_O24_BRINGUP*/
...
static void PE_WIN_HW_O24_SetWinPriority(PE_TSK_O24_CFG_T 				*i_pstCfg)
{
	...
	PE_WIN_HW_O24_CTRL_T *win_info	= &_g_pe_win_hw_o24_info.win_inf;
	// int i;
	UINT32 win_priority[2]={1,0};

	if(disp0_info->sub_mode == LX_DE_SUB_MODE_PIP)
	{
		win_priority[disp0_info->zoder[0]] = 0x0;// disp0_info->zoder[0]: win id of top 
		win_priority[disp0_info->zoder[1]] = 0x1;// disp0_info->zoder[1]: win id of bottom 
	}
	
	if((win_info->win_pri[0] != win_priority[0]) || (win_info->win_pri[1] != win_priority[1]))
	{
		PE_CC_PE1_O24_RdFL(pcc_winctrl_20);
		PE_CC_PE1_O24_Wr01(pcc_winctrl_20,	reg_priority_sel0,		win_priority[0]);
		PE_CC_PE1_O24_Wr01(pcc_winctrl_20,	reg_priority_sel1,		win_priority[1]);
		PE_CC_PE1_O24_WrFL(pcc_winctrl_20);
		
		PE_CC_PE1_O24_RdFL(pe1_dce_ctrl_00);
		PE_CC_PE1_O24_Wr01(pe1_dce_ctrl_00,	window_priority0_sel,		win_priority[0]);					//
		PE_CC_PE1_O24_Wr01(pe1_dce_ctrl_00,	window_priority1_sel,		win_priority[1]);					//
		PE_CC_PE1_O24_WrFL(pe1_dce_ctrl_00);
		if(_g_win_hw_o24_trace) {

			PE_WIN_HW_O24_DBG_PRINT_ALWAYS("[inf]priority change (win0,win1) pre:(%d,%d) -> cur:(%d,%d) \n",\
				win_info->win_pri[0], win_info->win_pri[1], win_priority[0], win_priority[1]) ;
		}
		win_info->win_pri[0] = win_priority[0];
		win_info->win_pri[1] = win_priority[1];
	}
	#endif /*PE_HW_O24_BRINGUP*/
	return;
}
