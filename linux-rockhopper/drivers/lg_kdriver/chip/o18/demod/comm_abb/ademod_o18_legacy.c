...
/*****************************************************************************
**
**  Name: ademod_o18_legacy.c
**
**  Description:    ABB O18 Legacy Demodulation block.
**
**  Functions
**  Implemented:   LX_ADEMOD_Result DEMOD_O18_Analog_LegacyDemod_Factory_Set
**                    	LX_ADEMOD_Result DEMOD_O18_Analog_LegacyDemod_Standard_Set
**                  	LX_ADEMOD_Result DEMOD_O18_Analog_LegacyDemod_Gain_Set
**				LX_ADEMOD_Result DEMOD_O18_Analog_LegacyDemod_Gain_Get
**                  	LX_ADEMOD_Result DEMOD_O18_Analog_LegacyDemod_RC_Gain_Set
**                  	LX_ADEMOD_Result DEMOD_O18_Analog_LegacyDemod_RC_Gain_Get
**                  	LX_ADEMOD_Result DEMOD_O18_Analog_LegacyDemod_Offset_Set
**                  	LX_ADEMOD_Result DEMOD_O18_Analog_LegacyDemod_Offset_Get
**                  	LX_ADEMOD_Result DEMOD_O18_Analog_LegacyDemod_RC_Offset_Set
**                  	LX_ADEMOD_Result DEMOD_O18_Analog_LegacyDemod_RC_Offset_Get
**				LX_ADEMOD_Result DEMOD_O18_Analog_LegacyDemod_GroupDelay_Set
**				LX_ADEMOD_Result DEMOD_O18_Analog_LegacyDemod_GroupDelay_Get
**                  	LX_ADEMOD_Result DEMOD_O18_Analog_LegacyDemod_Init
**                 		LX_ADEMOD_Result DEMOD_O18_Analog_LegacyDemod_Start
**
**  References:
**
**  Exports:        	LX_ADEMOD_Result DEMOD_O18_Analog_LegacyDemod_Factory_Set
** 				LX_ADEMOD_Result DEMOD_O18_Analog_LegacyDemod_Standard_Set
**                  	LX_ADEMOD_Result DEMOD_O18_Analog_LegacyDemod_Gain_Set
**				LX_ADEMOD_Result DEMOD_O18_Analog_LegacyDemod_Gain_Get
**                  	LX_ADEMOD_Result DEMOD_O18_Analog_LegacyDemod_RC_Gain_Set
...
static LX_ADEMOD_Result DEMOD_O18_Analog_LegacyDemod_Reset(pLX_ADEMOD_LegacyDemod pContext, BOOL on_off, Handle_t hUser);

static LX_ADEMOD_Result DEMOD_O18_Analog_GroupDelay_Set(pLX_ADEMOD_LegacyDemod pContext, UINT16 *pLUT, Handle_t hUser);

static LX_ADEMOD_Result DEMOD_O18_Analog_LegacyDemod_System_M_N_Set(pLX_ADEMOD_LegacyDemod pContext, Handle_t hUser);

static LX_ADEMOD_Result DEMOD_O18_Analog_LegacyDemod_System_B_G_Set(pLX_ADEMOD_LegacyDemod pContext, Handle_t hUser);

static LX_ADEMOD_Result DEMOD_O18_Analog_LegacyDemod_System_D_K_Set(pLX_ADEMOD_LegacyDemod pContext, Handle_t hUser);

static LX_ADEMOD_Result DEMOD_O18_Analog_LegacyDemod_System_H_Set(pLX_ADEMOD_LegacyDemod pContext, Handle_t hUser);

static LX_ADEMOD_Result DEMOD_O18_Analog_LegacyDemod_System_L_Set(pLX_ADEMOD_LegacyDemod pContext, Handle_t hUser);

static LX_ADEMOD_Result DEMOD_O18_Analog_LegacyDemod_System_L1_Set(pLX_ADEMOD_LegacyDemod pContext, Handle_t hUser);

static LX_ADEMOD_Result DEMOD_O18_Analog_LegacyDemod_System_I_Set(pLX_ADEMOD_LegacyDemod pContext, Handle_t hUser);

static LX_ADEMOD_Result DEMOD_O18_Analog_LegacyDemod_KickVSyncSlicer(pLX_ADEMOD_LegacyDemod pContext, Handle_t hUser);

static LX_ADEMOD_Result DEMOD_O18_Analog_LegacyDemod_DAC_Start(pLX_ADEMOD_LegacyDemod pContext, Handle_t hUser);

static LX_ADEMOD_Result DEMOD_O18_Analog_LegacyDemod_SyncDecoder_Start(pLX_ADEMOD_LegacyDemod pContext, UINT32 *pVideo_freq, UINT32 flags, Handle_t hUser);

static LX_ADEMOD_Result DEMOD_O18_Analog_GroupDelayLUT_Default(pLX_ADEMOD_LegacyDemod pContext, UINT16 *pLUT);
...
/******************************************************************************
**
**  Name: DEMOD_O18_Analog_LegacyDemod_Factory_Set
**
...
**
******************************************************************************/
LX_ADEMOD_Result DEMOD_O18_Analog_LegacyDemod_Factory_Set(pLX_ADEMOD_LegacyDemod pContext)
{
...
/******************************************************************************
**
**  Name: DEMOD_O18_Analog_LegacyDemod_Standard_Set
**
...
**
******************************************************************************/
LX_ADEMOD_Result DEMOD_O18_Analog_LegacyDemod_Standard_Set(pLX_ADEMOD_LegacyDemod pContext, UINT32 VideoStandard, UINT32 AudioStandard)
{
    LX_ADEMOD_Result status = retOK; /*  Status to be returned.  */
...
/******************************************************************************
**
**  Name: DEMOD_O18_Analog_LegacyDemod_SyncOptions_Set
**
...
**
******************************************************************************/
LX_ADEMOD_Result DEMOD_O18_Analog_LegacyDemod_SyncOptions_Set(pLX_ADEMOD_LegacyDemod pContext, UINT32 *pValue, Handle_t hUser, BOOL Update)
{
    LX_ADEMOD_Result status = retOK; /*  Status to be returned.  */
	if (!pContext) {
		return retErrBadContext;
...
/******************************************************************************
**
**  Name: DEMOD_O18_Analog_LegacyDemod_SyncOptions_Get
**
...
**
******************************************************************************/
LX_ADEMOD_Result DEMOD_O18_Analog_LegacyDemod_SyncOptions_Get(pLX_ADEMOD_LegacyDemod pContext, UINT32 *pValue, Handle_t hUser)
{
    LX_ADEMOD_Result status = retOK; /*  Status to be returned.  */
...
/******************************************************************************
**
**  Name: DEMOD_O18_Analog_LegacyDemod_Flags_Set
**
...
**
******************************************************************************/
LX_ADEMOD_Result DEMOD_O18_Analog_LegacyDemod_Flags_Set(pLX_ADEMOD_LegacyDemod pContext, UINT32 Flags, Handle_t hUser, BOOL Update)
{
    LX_ADEMOD_Result status = retOK; /*  Status to be returned.  */
	UINT32 mask = 0;
...
/******************************************************************************
**
**  Name: DEMOD_O18_Analog_LegacyDemod_MixedMode_Set
**
...
**
******************************************************************************/
LX_ADEMOD_Result DEMOD_O18_Analog_LegacyDemod_MixedMode_Set(pLX_ADEMOD_LegacyDemod pContext, UINT32 Mode, Handle_t hUser, BOOL Update)
{
    LX_ADEMOD_Result status = retOK; /*  Status to be returned.  */
...
/******************************************************************************
**
**  Name: DEMOD_O18_Analog_LegacyDemod_Flags_Get
**
...
**
******************************************************************************/
LX_ADEMOD_Result DEMOD_O18_Analog_LegacyDemod_Flags_Get(pLX_ADEMOD_LegacyDemod pContext, UINT32* pFlags)
{
    LX_ADEMOD_Result status = retOK; /*  Status to be returned.  */
...
/******************************************************************************
**
**  Name: DEMOD_O18_Analog_LegacyDemod_Gain_Set
**
...
**
******************************************************************************/
LX_ADEMOD_Result DEMOD_O18_Analog_LegacyDemod_Gain_Set(pLX_ADEMOD_LegacyDemod pContext, UINT32 *pValue, Handle_t hUser, BOOL Update)
{
    LX_ADEMOD_Result status = retOK; /*  Status to be returned.  */
...
/******************************************************************************
**
**  Name: DEMOD_O18_Analog_LegacyDemod_Gain_Get
**
...
**
******************************************************************************/
LX_ADEMOD_Result DEMOD_O18_Analog_LegacyDemod_Gain_Get(pLX_ADEMOD_LegacyDemod pContext, UINT32 *pValue, Handle_t hUser)
{
    LX_ADEMOD_Result status = retOK; /*  Status to be returned.  */
...
/******************************************************************************
**
**  Name: DEMOD_O18_Analog_LegacyDemod_RC_Gain_Set
**
**  Description:    Sets video gain.
**
**  Parameters:     pContext     - Pointer to the Legacy demodulator context,
...
**
******************************************************************************/
LX_ADEMOD_Result DEMOD_O18_Analog_LegacyDemod_RC_Gain_Set(pLX_ADEMOD_LegacyDemod pContext, UINT32 *pValue, Handle_t hUser, BOOL Update)
{
    LX_ADEMOD_Result status = retOK; /*  Status to be returned.  */
...
/******************************************************************************
**
**  Name: DEMOD_O18_Analog_LegacyDemod_RC_Gain_Get
**
**  Description:    Returns actual video gain.
**
**  Parameters:     pContext     - Pointer to the legacy demodulator context,
...
**
******************************************************************************/
LX_ADEMOD_Result DEMOD_O18_Analog_LegacyDemod_RC_Gain_Get(pLX_ADEMOD_LegacyDemod pContext, UINT32 *pValue, Handle_t hUser)
{
    LX_ADEMOD_Result status = retOK; /*  Status to be returned.  */
...
/******************************************************************************
**
**  Name: DEMOD_O18_Analog_LegacyDemod_Offset_Set
**
...
**
******************************************************************************/
LX_ADEMOD_Result DEMOD_O18_Analog_LegacyDemod_Offset_Set(pLX_ADEMOD_LegacyDemod pContext, UINT32 *pValue, Handle_t hUser, BOOL Update)
{
    LX_ADEMOD_Result status = retOK; /*  Status to be returned.  */
...
/******************************************************************************
**
**  Name: DEMOD_O18_Analog_LegacyDemod_Offset_Get
**
...
**
******************************************************************************/
LX_ADEMOD_Result DEMOD_O18_Analog_LegacyDemod_Offset_Get(pLX_ADEMOD_LegacyDemod pContext, UINT32 *pValue, Handle_t hUser)
{
    LX_ADEMOD_Result status = retOK; /*  Status to be returned.  */
...
/******************************************************************************
**
**  Name: DEMOD_O18_Analog_LegacyDemod_RC_Offset_Set
**
**  Description:    Sets video Offset.
**
**  Parameters:     pContext     - Pointer to the Legacy demodulator context,
...
**
******************************************************************************/
LX_ADEMOD_Result DEMOD_O18_Analog_LegacyDemod_RC_Offset_Set(pLX_ADEMOD_LegacyDemod pContext, UINT32 *pValue, Handle_t hUser, BOOL Update)
{
    LX_ADEMOD_Result status = retOK; /*  Status to be returned.  */
...
/******************************************************************************
**
**  Name: DEMOD_O18_Analog_LegacyDemod_RC_Offset_Get
**
**  Description:    Returns actual video Offset.
**
**  Parameters:     pContext     - Pointer to the legacy demodulator context,
...
**
******************************************************************************/
LX_ADEMOD_Result DEMOD_O18_Analog_LegacyDemod_RC_Offset_Get(pLX_ADEMOD_LegacyDemod pContext, UINT32 *pValue, Handle_t hUser)
{
    LX_ADEMOD_Result status = retOK; /*  Status to be returned.  */
...
/******************************************************************************
**
**  Name: DEMOD_O18_Analog_LegacyDemod_Clip_Set
**
...
**
******************************************************************************/
LX_ADEMOD_Result DEMOD_O18_Analog_LegacyDemod_Clip_Set(pLX_ADEMOD_LegacyDemod pContext, UINT32 *pValue, Handle_t hUser, BOOL Update)
{
    LX_ADEMOD_Result status = retOK; /*  Status to be returned.  */
...
/******************************************************************************
**
**  Name: DEMOD_O18_Analog_LegacyDemod_Clip_Get
**
**  Description:    Sets video clipper.
**
**  Parameters:     pContext     - Pointer to the Legacy demodulator context,
...
**
******************************************************************************/
LX_ADEMOD_Result DEMOD_O18_Analog_LegacyDemod_Clip_Get(pLX_ADEMOD_LegacyDemod pContext, UINT32 *pValue, Handle_t hUser)
{
    LX_ADEMOD_Result status = retOK; /*  Status to be returned.  */
...
/******************************************************************************
**
**  Name: DEMOD_O18_Analog_LegacyDemod_RC_Clip_Set
**
**  Description:    Sets video clipper.
**
**  Parameters:     pContext     - Pointer to the Legacy demodulator context,
...
**
******************************************************************************/
LX_ADEMOD_Result DEMOD_O18_Analog_LegacyDemod_RC_Clip_Set(pLX_ADEMOD_LegacyDemod pContext, UINT32 *pValue, Handle_t hUser, BOOL Update)
{
    LX_ADEMOD_Result status = retOK; /*  Status to be returned.  */
...
/******************************************************************************
**
**  Name: DEMOD_O18_Analog_LegacyDemod_RC_Clip_Get
**
**  Description:    Sets video clipper.
**
**  Parameters:     pContext     - Pointer to the Legacy demodulator context,
...
**
******************************************************************************/
LX_ADEMOD_Result DEMOD_O18_Analog_LegacyDemod_RC_Clip_Get(pLX_ADEMOD_LegacyDemod pContext, UINT32 *pValue, Handle_t hUser)
{
    LX_ADEMOD_Result status = retOK; /*  Status to be returned.  */
...
/******************************************************************************
**
**  Name: DEMOD_O18_Analog_LegacyDemod_GroupDelay_Set
**
...
**
******************************************************************************/
LX_ADEMOD_Result DEMOD_O18_Analog_LegacyDemod_GroupDelay_Set(pLX_ADEMOD_LegacyDemod pContext, UINT16 *pLUT, Handle_t hUser, BOOL Update)
{
    LX_ADEMOD_Result status = retOK; /*  Status to be returned.  */
	...
	if (pLUT) {
		...
		status = DEMOD_O18_Analog_GroupDelayLUT_Default(pContext, (UINT16 *)LX_ADEMOD_GROUP_DELAY_BYPASS_LUT);
	}

	if (Update)
	{
		status = DEMOD_O18_Analog_GroupDelay_Set(pContext, (UINT16 *)pContext->GroupDelayLUT, hUser);
	}
...
/******************************************************************************
**
**  Name: DEMOD_O18_Analog_LegacyDemod_GroupDelay_Get
**
...
**
******************************************************************************/
LX_ADEMOD_Result DEMOD_O18_Analog_LegacyDemod_GroupDelay_Get(pLX_ADEMOD_LegacyDemod pContext, UINT16 *pLUT, Handle_t hUser)
{
    LX_ADEMOD_Result status = retOK; /*  Status to be returned.  */
...
/******************************************************************************
**
**  Name: DEMOD_O18_Analog_LegacyDemod_Init
**
...
**
******************************************************************************/
LX_ADEMOD_Result DEMOD_O18_Analog_LegacyDemod_Init(pLX_ADEMOD_LegacyDemod pContext, Handle_t hUser)
{
    LX_ADEMOD_Result status = retOK; /*  Status to be returned.  */
...
/******************************************************************************
**
**  Name: DEMOD_O18_Analog_LegacyDemod_Start
**
...
**                  variables.
******************************************************************************/
LX_ADEMOD_Result DEMOD_O18_Analog_LegacyDemod_Start(pLX_ADEMOD_LegacyDemod pContext, UINT32 *pVideo_freq, UINT32 flags, Handle_t hUser)
{
    LX_ADEMOD_Result status = retOK; /*  Status to be returned.  */
	...
	DEMOD_O18_Analog_LegacyDemod_Reset(pContext, TRUE, hUser);
	switch (pContext->video_std) {
		case LX_ADEMOD_VIDEO_STANDARD_NTSC_M:
		case LX_ADEMOD_VIDEO_STANDARD_NTSC_M_J:
			status = DEMOD_O18_Analog_LegacyDemod_System_M_N_Set(pContext, hUser);
			break;

		case LX_ADEMOD_VIDEO_STANDARD_PAL_B:
		case LX_ADEMOD_VIDEO_STANDARD_PAL_G:
			status = DEMOD_O18_Analog_LegacyDemod_System_B_G_Set(pContext, hUser);
			break;

		case LX_ADEMOD_VIDEO_STANDARD_PAL_D:
		case LX_ADEMOD_VIDEO_STANDARD_PAL_K:
		case LX_ADEMOD_VIDEO_STANDARD_PAL_DK_NICAM:
			status = DEMOD_O18_Analog_LegacyDemod_System_D_K_Set(pContext, hUser);
			break;

		case LX_ADEMOD_VIDEO_STANDARD_PAL_I:
			status = DEMOD_O18_Analog_LegacyDemod_System_I_Set(pContext, hUser);
			break;

		case LX_ADEMOD_VIDEO_STANDARD_SECAM_L:
			status = DEMOD_O18_Analog_LegacyDemod_System_L_Set(pContext, hUser);
			break;

		case LX_ADEMOD_VIDEO_STANDARD_SECAM_L1:
			status = DEMOD_O18_Analog_LegacyDemod_System_L1_Set(pContext, hUser);
			break;

		case LX_ADEMOD_VIDEO_STANDARD_NTSC_433:
		case LX_ADEMOD_VIDEO_STANDARD_NTSC_50:
		case LX_ADEMOD_VIDEO_STANDARD_PAL_H:
			status = DEMOD_O18_Analog_LegacyDemod_System_H_Set(pContext, hUser);
			break;
	...
	DEMOD_O18_Analog_GroupDelay_Set(pContext, (UINT16 *)pContext->GroupDelayLUT, hUser);

	//  Video DAC
	DEMOD_O18_Analog_LegacyDemod_DAC_Start(pContext, hUser);

	// SYNC Decoder
	DEMOD_O18_Analog_LegacyDemod_SyncDecoder_Start(pContext, pVideo_freq, flags, hUser);

	// Kick VSync Slicer
	DEMOD_O18_Analog_LegacyDemod_KickVSyncSlicer(pContext, hUser);

	DEMOD_O18_Analog_LegacyDemod_Reset(pContext, FALSE, hUser);
...
/******************************************************************************
**
**  Name: DEMOD_O18_Analog_LegacyDemod_Reset
**
...
/******************************************************************************
**
**  Name: DEMOD_O18_Analog_GroupDelay_Set
**
**  Description:    Sets group delay LUT.
**
**  Parameters:     pContext     - Pointer to the legacy demodulator context.
...
/******************************************************************************
**
**  Name: DEMOD_O18_Analog_LegacyDemod_System_M_N_Set
**
...
static LX_ADEMOD_Result DEMOD_O18_Analog_LegacyDemod_System_M_N_Set(pLX_ADEMOD_LegacyDemod pContext, Handle_t hUser)
{
	...
	if (!(pContext->update & LX_ADEMOD_UFLAG_GRP_DELAY_USR))
	{
		status = DEMOD_O18_Analog_GroupDelayLUT_Default(pContext, (UINT16 *)LX_ADEMOD_GROUP_DELAY_SYSTEM_M_N_LUT);
	}
...
/******************************************************************************
**
**  Name: DEMOD_O18_Analog_LegacyDemod_System_B_G_Set
**
**  Description:    Sets video standard.
**
...
static LX_ADEMOD_Result DEMOD_O18_Analog_LegacyDemod_System_B_G_Set(pLX_ADEMOD_LegacyDemod pContext, Handle_t hUser)
{
	...
	if (!(pContext->update & LX_ADEMOD_UFLAG_GRP_DELAY_USR))
	{
		status = DEMOD_O18_Analog_GroupDelayLUT_Default(pContext, (UINT16 *)LX_ADEMOD_GROUP_DELAY_SYSTEM_B_G_LUT);
	}
...
/******************************************************************************
**
**  Name: DEMOD_O18_Analog_LegacyDemod_System_D_K_Set
**
**  Description:    Sets video standard.
**
...
static LX_ADEMOD_Result DEMOD_O18_Analog_LegacyDemod_System_D_K_Set(pLX_ADEMOD_LegacyDemod pContext, Handle_t hUser)
{
	...
	if (!(pContext->update & LX_ADEMOD_UFLAG_GRP_DELAY_USR))
	{
		if (pContext->flags & LX_ADEMOD_FFLAG_DK_CHINA_EN) {
			status = DEMOD_O18_Analog_GroupDelayLUT_Default(pContext, (UINT16 *)LX_ADEMOD_GROUP_DELAY_SYSTEM_D_K_CHINA_LUT);
		}
		else {
			status = DEMOD_O18_Analog_GroupDelayLUT_Default(pContext, (UINT16 *)LX_ADEMOD_GROUP_DELAY_SYSTEM_D_K_LUT);
		}
	}
...
/******************************************************************************
**
**  Name: DEMOD_O18_Analog_LegacyDemod_System_H_Set
**
**  Description:    Sets video standard.
**
**  Parameters:     pContext     - Sets legacy demodulator registers for PAL_D_K standard.
...
/******************************************************************************
**
**  Name: DEMOD_O18_Analog_LegacyDemod_System_I_Set
**
**  Description:    Sets video standard.
**
...
DEMOD_PRINT("pContext->update = %d  \n",pContext->update);
	if (!(pContext->update & LX_ADEMOD_UFLAG_GRP_DELAY_USR))
	{
		status = DEMOD_O18_Analog_GroupDelayLUT_Default(pContext, (UINT16 *)LX_ADEMOD_GROUP_DELAY_SYSTEM_I_LUT);
	}
...
/******************************************************************************
**
**  Name: DEMOD_O18_Analog_LegacyDemod_System_L_Set
**
**  Description:    Sets video standard.
**
...
static LX_ADEMOD_Result DEMOD_O18_Analog_LegacyDemod_System_L_Set(pLX_ADEMOD_LegacyDemod pContext, Handle_t hUser)
{
	...
	if (!(pContext->update & LX_ADEMOD_UFLAG_GRP_DELAY_USR))
	{
		status = DEMOD_O18_Analog_GroupDelayLUT_Default(pContext, (UINT16 *)LX_ADEMOD_GROUP_DELAY_SYSTEM_L_LUT);
	}
...
/******************************************************************************
**
**  Name: DEMOD_O18_Analog_LegacyDemod_System_L1_Set
**
**  Description:    Sets video standard.
**
**  Parameters:     pContext     - Sets legacy demodulator registers for SECAM_L standard.
...
static LX_ADEMOD_Result DEMOD_O18_Analog_LegacyDemod_System_L1_Set(pLX_ADEMOD_LegacyDemod pContext, Handle_t hUser)
{
	...
	if (!(pContext->update & LX_ADEMOD_UFLAG_GRP_DELAY_USR))
	{
		status = DEMOD_O18_Analog_GroupDelayLUT_Default(pContext, (UINT16 *)LX_ADEMOD_GROUP_DELAY_SYSTEM_L1_LUT);
	}
...
/******************************************************************************
**
**  Name: DEMOD_O18_Analog_LegacyDemod_DAC_Start
**
...
/******************************************************************************
**
**  Name: DEMOD_O18_Analog_LegacyDemod_KickVSyncSlicer
**
...
/******************************************************************************
**
**  Name: DEMOD_O18_Analog_LegacyDemod_SyncDecoder_Start
**
**  Description:    Starts legacy demodulator's DAC block.
**
**  Parameters:     pContext     - Pointer to the legacy demodulator context.
...
/******************************************************************************
**
**  Name: DEMOD_O18_Analog_GroupDelayLUT_Default
**
