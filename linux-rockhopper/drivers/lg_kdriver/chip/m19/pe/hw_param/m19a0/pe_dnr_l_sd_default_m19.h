...
const PE_REG_PARAM_T dnr_l_sd_default_m19[] =
{	
    {0x3594, 0x00F80221},        // DNR_MAX_CTRL
    ...
    {0x35D8, 0x0F128000},        // AC_BNR_CTRL_1
    {0x35DC, 0x00051040},        // AC_BNR_CTRL_2
    {0x35E4, 0x00C0E0FF},        // AC_BNR_CTRL_3
    {0x35E8, 0x12805000},        // AC_BNR_CTRL_4
    ...
    {0x37E4, 0x20100703},        // REG_DECON_CTRL_19
    {0x37E8, 0x002080C0},        // REG_DECON_CTRL_20
    {0x37EC, 0x01006820},        // REG_DECON_CTRL_21
    {0x37F0, 0x04040080},        // REG_DECON_CTRL_22
    {0x37F4, 0x02000080},        // REG_DECON_CTRL_23
    {0x37F8, 0x10060200},        // REG_DECON_CTRL_24
    {0x37FC, 0x280C0380},        // REG_DECON_CTRL_25
    {0x3800, 0x3FF02200},        // REG_DECON_CTRL_26
    {0x3804, 0x20080200},        // REG_DECON_CTRL_27
    {0x3808, 0x20080200},        // REG_DECON_CTRL_28
    {0x380C, 0x00000000},        // REG_DECON_CTRL_29
    {0x3810, 0xC4060000},        // REG_DECON_CTRL_30
    ...
    {0x385C, 0xFF200201},        // REG_DECON_CTRL_49
