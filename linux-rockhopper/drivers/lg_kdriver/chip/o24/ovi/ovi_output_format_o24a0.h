...
/** @file
 *
 *  Header file of defining possible of output modes of O24 Ax
 *
 ...
 *   External Variables
 *---------------------------------------------------------------------------------------*/
__attribute__((unused)) static LX_OVI_REG_T ovi_o24a0_disp_4k60_vx1_8lane[] = // Blended OSD
{ // Blended OSD
	//4byte
	// OIF
	...
	{0xcc9190ac, 0x00000010}, //vx1_apl_ctrl
...
static LX_OVI_REG_T ovi_o24a0_disp_4k60_vx1_8lane_intellifit[] = // Blended OSD
{ // Blended OSD
	//4byte
	// OIF
	{0xcc910004, 0x00000020},
	{0xcc91000c, 0x0000000E},
	{0xcc910010, 0x00000001},
	{0xcc91001C, 0x000004d4}, //path 설정 변경
	{0xcc910090, 0x00000094}, //tcon_sgen_hbp
	{0xcc910094, 0x0000002c}, //tcon_sgen_hs
	...
	{0xcc9100d4, 0x00000000}, //tcon_pgen_ctl
	{0xcc910300, 0x00101082},
	{0xcc910304, 0x0002001a},
	{0xcc910308, 0x00000f00},

	{0xcc919008, 0x00000082}, //수정됨
	{0xcc919098, 0x07060504}, //vx1_lane_sel0
	{0xcc91909c, 0x03020100}, //vx1_lane_sel1
...
__attribute__((unused)) static LX_OVI_REG_T ovi_o24a0_disp_4k120_vx1_16lane[] = // Blended OSD
{ // Blended OSD
	//4byte
	// OIF
	{0xcc910004, 0x00000020},
	...
	{0xcc9190d8, 0x00001010}, //vx1_info_ctrl0
	{0xcc9190dc, 0x00001019}, //vx1_info_ctrl1
	{0xcc9101dc, 0x00000003}, //init test
...
__attribute__((unused)) static LX_OVI_REG_T ovi_o24a0_disp_4k120_vx1_24lane_5byte[] = // 16lane video + 8lane separated OSD
{ 
	//OIF
	{0xcc910004, 0x00000020},
	{0xcc910010, 0x00000001},
...
__attribute__((unused)) static LX_OVI_REG_T ovi_o24a0_disp_4k120_vx1_16lane_5byte[] = // Blended OSD
{ // Blended OSD
	//5byte
	// OIF
	{0xcc910004, 0x00000020},
...
__attribute__((unused)) static LX_OVI_REG_T ovi_o24a0_disp_4k120_vx1_16lane_5byte_G4_97inch[] = { // Blended OSD
	//5byte
	// OIF
	{0xcc910004, 0x00000020},
	{0xcc910010, 0x00000001},
...
__attribute__((unused)) static LX_OVI_REG_T ovi_o24a0_disp_4k120_vx1_16lane_5byte_G4_97inch_wirelessAV[] = { // Blended OSD
	//5byte
	// OIF
	{0xcc910004, 0x00000020},
	{0xcc910010, 0x00000001},
...
__attribute__((unused)) static LX_OVI_REG_T ovi_o24a0_disp_4k144_vx1_16lane_5byte[] = // Blended OSD
{ // Blended OSD
	// OIF
	{0xcc910004, 0x00000020},
	{0xcc910010, 0x00000001},
	{0xcc91001C, 0x030000d4},
	{0xcc910090, 0x00000150}, //tcon_sgen_hbp
	{0xcc910094, 0x00000050}, //tcon_sgen_hs
	{0xcc910098, 0x000000a0}, //tcon_sgen_hfp
	{0xcc91009c, 0x00000048}, //tcon_sgen_vbp
	{0xcc9100a0, 0x0000000a}, //tcon_sgen_vs
	{0xcc9100a4, 0x00000008}, //tcon_sgen_vfp
	{0xcc9100a8, 0x00000780}, //tcon_sgen_dewidth
	...
	{0xcc9100d4, 0x00000000}, //tcon_pgen_ctl
	{0xcc910300, 0x00101102},
	{0xcc910304, 0x00020006},
	{0xcc910308, 0x00000f00},

	{0xcc919008, 0x000000c2}, //4byte 11bit
	{0xcc919098, 0x00010203}, //vx1_lane_sel0
	{0xcc91909c, 0x04050607}, //vx1_lane_sel1
	{0xcc9190a0, 0x08090a0b}, //vx1_lane_sel2
	{0xcc9190a4, 0x0c0d0e0f}, //vx1_lane_sel3
							  //vx1_lane_sel4
	{0xcc9190ac, 0x00000020}, //vx1_lane_sel5
	{0xcc9190d8, 0x00001010}, //vx1_apl_ctrl
	{0xcc9190dc, 0x00001019}, //vx1_info_ctrl0
	{0xcc9101dc, 0x00000003}, //vx1_info_ctrl1
	...
	{0xCC933024, 0x01fffff0}, //pdb_ch0~23=1
	{0x00000001, 0x00000064}, //100us delay
	{0xCC933000, 0x00000001}, //vtx_link_rstn=1
};

__attribute__((unused)) static LX_OVI_REG_T ovi_o24a0_disp_4k144_vx1_16lane_5byte_wirelessAV[] = // Blended OSD
{ // Blended OSD
	// OIF
	{0xcc910004, 0x00000020},
	{0xcc910010, 0x00000001},
...
__attribute__((unused)) static LX_OVI_REG_T ovi_o24a0_disp_4k165_vx1_16lane_4byte[] = // Blended OSD
{ // Blended OSD
	// OIF
	{0xcc910004, 0x00000020}, //
	{0xcc910010, 0x00000001}, //
	...
	{0xcc9190a0, 0x08090a0b}, //	vx1_lane_sel2
	{0xcc9190a4, 0x0c0d0e0f}, //	vx1_lane_sel3
	{0xcc9190AC, 0x00000020}, //	vx1_apl_ctrl
	{0xcc9190d8, 0x00001010}, //	vx1_info_ctrl0
	{0xcc9190dc, 0x00001019}, //	vx1_info_ctrl1
	{0xcc9101dc, 0x00000003}, //	init test
...
__attribute__((unused)) static LX_OVI_REG_T ovi_o24a0_disp_4k165_vx1_16lane_4byte_7_1_vrr[] = // Blended OSD
{ // Blended OSD
	// OIF
	{0xcc910004, 0x00000020},
	{0xcc910010, 0x00000001}, //
	{0xcc91001C, 0x030000d4}, //
	{0xcc910090, 0x00000010}, //	tcon_sgen_hbp
	{0xcc910094, 0x00000008}, //	tcon_sgen_hs
	{0xcc910098, 0x00000010}, //	tcon_sgen_hfp
	{0xcc91009c, 0x00000048}, //	tcon_sgen_vbp
	{0xcc9100a0, 0x0000000a}, //	tcon_sgen_vs
	{0xcc9100a4, 0x00000018}, //	tcon_sgen_vfp
	{0xcc9100a8, 0x00000780}, //	tcon_sgen_dewidth
	{0xcc9100b0, 0x00000870}, //	tcon_sgen_denum
	{0xcc9100b8, 0x00000060}, //	tcon_vblank_width
	{0xcc9100bc, 0x00000004}, //	tcon_vsync_width
	{0xcc9100d4, 0x00000000}, //	tcon_pgen_ctl
	{0xcc910300, 0x00101102}, //	line delay 없음
	{0xcc910304, 0x00020008}, //	hb_width
	{0xcc910308, 0x00000f00}, //

//	{0xcca20028, 0x001c0006},
	...
	// CTOP : CLK   CRG
	{0xcc920010, 0x00000001},
	{0xcc920014, 0x00001000},
...
__attribute__((unused)) static LX_OVI_REG_T ovi_o24a0_disp_2k60_lvds_2link[] = // Blended OSD
{
#if 0
	// OIF
...
__attribute__((unused)) static LX_OVI_REG_T ovi_o24a0_disp_2k120_lvds_4link[] = // Blended OSD
{
#if 0 
	// OIF
	{0xc9070004, 0x00000000}, //tcon_control
...
__attribute__((unused)) static LX_OVI_REG_T ovi_o24a0_disp_preEmp_swiLvl[] =
{
	{0x00000002, 0x00000001}, // OVI_HW_O24_REG_READ_START
	...
	{0x00000002, 0x00000000} // OVI_HW_O24_REG_CHECK_END
};
