...
/*****************************************************************************
**
**  Name: ademod_m16_bsp.c
**
**  Description:    ABB M16P Board Support Package (BSP) module.
**
**  Functions
**  Implemented:    LX_ADEMOD_Result DEMOD_M16P_Analog_Bsp_Factory_Set
**                  LX_ADEMOD_Result DEMOD_M16P_Analog_Bsp_Init
**                  LX_ADEMOD_Result DEMOD_M16P_Analog_Bsp_PowerUp
**                  LX_ADEMOD_Result DEMOD_M16P_Analog_Bsp_Sleep_Set
**                  LX_ADEMOD_Result DEMOD_M16P_Analog_Bsp_Mode_Set
**                  LX_ADEMOD_Result DEMOD_M16P_Analog_Bsp_Clock_Set
**                  LX_ADEMOD_Result DEMOD_M16P_Analog_Bsp_Flags_Set
**                  LX_ADEMOD_Result DEMOD_M16P_Analog_Bsp_Flags_Get
**
**  References:
**
**  Exports:        LX_ADEMOD_Result DEMOD_M16P_Analog_Bsp_Factory_Set
**                  LX_ADEMOD_Result DEMOD_M16P_Analog_Bsp_Init
**                  LX_ADEMOD_Result DEMOD_M16P_Analog_Bsp_PowerUp
**                  LX_ADEMOD_Result DEMOD_M16P_Analog_Bsp_Sleep_Set
**                  LX_ADEMOD_Result DEMOD_M16P_Analog_Bsp_Mode_Set
...
static LX_ADEMOD_Result DEMOD_M16P_Analog_Bsp_TunerQuite_Init(pLX_ADEMOD_Bsp pContext, Handle_t hUser);

static LX_ADEMOD_Result DEMOD_M16P_Analog_Bsp_SoftwareVersion_Init(pLX_ADEMOD_Bsp pContext, Handle_t hUser);

static LX_ADEMOD_Result DEMOD_M16P_Analog_Bsp_PadOut_Enable(pLX_ADEMOD_Bsp pContext, Handle_t hUser);

static LX_ADEMOD_Result DEMOD_M16P_Analog_Bsp_PadWand_Enable(pLX_ADEMOD_Bsp pContext, Handle_t hUser);
...
/******************************************************************************
**
**  Name: DEMOD_M16P_Analog_Bsp_Factory_Set
**
...
**
******************************************************************************/
LX_ADEMOD_Result DEMOD_M16P_Analog_Bsp_Factory_Set(pLX_ADEMOD_Bsp pContext)
{
...
/******************************************************************************
**
**  Name: DEMOD_M16P_Analog_Bsp_Flags_Set
**
...
**
******************************************************************************/
LX_ADEMOD_Result DEMOD_M16P_Analog_Bsp_Flags_Set(pLX_ADEMOD_Bsp pContext, UINT32 Flags, Handle_t hUser, BOOL Update)
{
    LX_ADEMOD_Result status = retOK; /*  Status to be returned.  */
	UINT32 mask = 0;
...
/******************************************************************************
**
**  Name: DEMOD_M16P_Analog_Bsp_Flags_Get
**
...
**
******************************************************************************/
LX_ADEMOD_Result DEMOD_M16P_Analog_Bsp_Flags_Get(pLX_ADEMOD_Bsp pContext, UINT32* pFlags)
{
    LX_ADEMOD_Result status = retOK; /*  Status to be returned.  */
...
/******************************************************************************
**
**  Name: DEMOD_M16P_Analog_Bsp_FastAGC_Set
**
...
**
******************************************************************************/
LX_ADEMOD_Result DEMOD_M16P_Analog_Bsp_FastAGC_Set(pLX_ADEMOD_Bsp pContext, UINT32 *pValue, Handle_t hUser, BOOL Update)
{
    LX_ADEMOD_Result status = retOK; /*  Status to be returned.  */
	...
	if (Update) {
		status = DEMOD_M16P_Analog_Bsp_PadOut_Enable(pContext, hUser);
	}
...
/******************************************************************************
**
**  Name: DEMOD_M16P_Analog_Bsp_FastAGC_Get
**
...
**
******************************************************************************/
LX_ADEMOD_Result DEMOD_M16P_Analog_Bsp_FastAGC_Get(pLX_ADEMOD_Bsp pContext, UINT32* pMode, Handle_t hUser)
{
    LX_ADEMOD_Result status = retOK; /*  Status to be returned.  */
...
/******************************************************************************
**
**  Name: DEMOD_M16P_Analog_Bsp_OutAGC_Set
**
...
**
******************************************************************************/
LX_ADEMOD_Result DEMOD_M16P_Analog_Bsp_OutAGC_Set(pLX_ADEMOD_Bsp pContext, UINT32 *pValue, Handle_t hUser, BOOL Update)
{
    LX_ADEMOD_Result status = retOK; /*  Status to be returned.  */
	...
	if (Update) {
		...
		status = DEMOD_M16P_Analog_Bsp_PadWand_Enable(pContext, hUser);
	}
...
/******************************************************************************
**
**  Name: DEMOD_M16P_Analog_Bsp_OutAGC_Get
**
...
**
******************************************************************************/
LX_ADEMOD_Result DEMOD_M16P_Analog_Bsp_OutAGC_Get(pLX_ADEMOD_Bsp pContext, UINT32* pMode, Handle_t hUser)
{
    LX_ADEMOD_Result status = retOK; /*  Status to be returned.  */
...
/******************************************************************************
**
**  Name: DEMOD_M16P_Analog_Bsp_WandAGC_Set
**
...
**
******************************************************************************/
LX_ADEMOD_Result DEMOD_M16P_Analog_Bsp_WandAGC_Set(pLX_ADEMOD_Bsp pContext, UINT32 *pValue, Handle_t hUser, BOOL Update)
{
    LX_ADEMOD_Result status = retOK; /*  Status to be returned.  */
...
/******************************************************************************
**
**  Name: DEMOD_M16P_Analog_Bsp_WandAGC_Get
**
...
**
******************************************************************************/
LX_ADEMOD_Result DEMOD_M16P_Analog_Bsp_WandAGC_Get(pLX_ADEMOD_Bsp pContext, UINT32* pMode, Handle_t hUser)
{
    LX_ADEMOD_Result status = retOK; /*  Status to be returned.  */
...
/******************************************************************************
**
**  Name: DEMOD_M16P_Analog_Bsp_Init
**
...
**
******************************************************************************/
LX_ADEMOD_Result DEMOD_M16P_Analog_Bsp_Init(pLX_ADEMOD_Bsp pContext, Handle_t hUser)
{
    LX_ADEMOD_Result status = retOK; /*  Status to be returned.  */
	...
	// power up sequence
	status = DEMOD_M16P_Analog_Bsp_PowerUp(pContext, hUser);

	// Disable watchdog
	//lreg[DOGCNTR/4] = 0x00;


	status = DEMOD_M16P_Analog_Bsp_SoftwareVersion_Init(pContext, hUser);

	status = DEMOD_M16P_Analog_Bsp_TunerQuite_Init(pContext, hUser);
...
/******************************************************************************
**
**  Name: DEMOD_M16P_Analog_Bsp_Mode_Set
**
...
**
******************************************************************************/
LX_ADEMOD_Result DEMOD_M16P_Analog_Bsp_Mode_Set(pLX_ADEMOD_Bsp pContext, UINT32 VideoMode, UINT32 AudioMode, UINT32 Divider, Handle_t hUser)
{
    LX_ADEMOD_Result status = retOK; /*  Status to be returned.  */
...
//	UINT32 sif_dac_out = 0;
	...
	switch (VideoMode)
	{
		case LX_ADEMOD_INPUTMODE_LEGACY:
			...
			status = DEMOD_M16P_Analog_Bsp_Clock_Set(pContext, pContext->clocks, hUser);
...
/******************************************************************************
**
**  Name: DEMOD_M16P_Analog_Bsp_Standard_Set
**
...
**
******************************************************************************/
LX_ADEMOD_Result DEMOD_M16P_Analog_Bsp_Standard_Set(pLX_ADEMOD_Bsp pContext, UINT32 VideoStandard, Handle_t hUser)
{
    LX_ADEMOD_Result status = retOK; /*  Status to be returned.  */
...
/******************************************************************************
**
**  Name: DEMOD_M16P_Analog_Bsp_PowerUp
**
...
**
******************************************************************************/
LX_ADEMOD_Result DEMOD_M16P_Analog_Bsp_PowerUp(pLX_ADEMOD_Bsp pContext, Handle_t hUser)
{
    LX_ADEMOD_Result status = retOK; /*  Status to be returned.  */
...
/******************************************************************************
**
**  Name: DEMOD_M16P_Analog_Bsp_Sleep_Set
**
...
**
******************************************************************************/
LX_ADEMOD_Result DEMOD_M16P_Analog_Bsp_Sleep_Set(pLX_ADEMOD_Bsp pContext, UINT32 Mode, Handle_t hUser)
{
    LX_ADEMOD_Result status = retOK; /*  Status to be returned.  */
	...
	switch (Mode) {
		...
		case LX_ADEMOD_SLEEP_MODE_LEVEL_1:
			...
			status |= DEMOD_M16P_Analog_Bsp_Clock_Set(pContext, LX_ADEMOD_ALL_CLK_POWER_DOWN, hUser);
			break;
		default:
			status = retErrBadMode;
			break;
...
/******************************************************************************
**
**  Name: DEMOD_M16P_Analog_Bsp_Start
**
...
**
******************************************************************************/
LX_ADEMOD_Result DEMOD_M16P_Analog_Bsp_Start(pLX_ADEMOD_Bsp pContext, Handle_t hUser)
{
    LX_ADEMOD_Result status = retOK; /*  Status to be returned.  */
...
/******************************************************************************
**
**  Name: DEMOD_M16P_Analog_Bsp_SoftwareVersion_Init
**
...
/******************************************************************************
**
**  Name: DEMOD_M16P_Analog_Bsp_TunerQuite_Init
**
...
/******************************************************************************
**
**  Name: DEMOD_M16P_Analog_Bsp_PadWand_Enable
**
...
/******************************************************************************
**
**  Name: DEMOD_M16P_Analog_Bsp_PadOut_Enable
**
...
/******************************************************************************
**
**  Name: DEMOD_M16P_Analog_Bsp_Clock_Set
**
...
**
******************************************************************************/
LX_ADEMOD_Result DEMOD_M16P_Analog_Bsp_Clock_Set(pLX_ADEMOD_Bsp pContext, UINT32 Mask, Handle_t hUser)
{
    LX_ADEMOD_Result status = retOK; /*  Status to be returned.  */
	UINT8 ClkPower = 0;
