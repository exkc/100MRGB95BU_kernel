#ifndef _SCRG_CTRL_DDR1SB_REG_H_
#define _SCRG_CTRL_DDR1SB_REG_H_
...
/*-----------------------------------------------------------------------------------------
    0xC451_0000    crg_ddr1sb000 ''
-----------------------------------------------------------------------------------------*/
typedef struct {
    UINT32
    test_reserved             : 32;    //  31: 0
}SCRG_CTRL_DDR1SB_CRG_DDR1SB000_O26A0_T;

/*-----------------------------------------------------------------------------------------
    0xC451_0004    crg_ddr1sb001 ''
-----------------------------------------------------------------------------------------*/
typedef struct {
    UINT32
    test_reserved_ro          : 32;    //  31: 0
}SCRG_CTRL_DDR1SB_CRG_DDR1SB001_O26A0_T;

/*-----------------------------------------------------------------------------------------
    0xC451_0008    crg_ddr1sb002 ''
-----------------------------------------------------------------------------------------*/
typedef struct {
    UINT32
    ...
    reg_bus_884_clk_gate_en   :  1,    //      3
                              : 28;    //   31:4 reserved
}SCRG_CTRL_DDR1SB_CRG_DDR1SB002_O26A0_T;

/*-----------------------------------------------------------------------------------------
    0xC451_000C    crg_ddr1sb003 ''
-----------------------------------------------------------------------------------------*/
typedef struct {
    UINT32
    ...
    reg_soft_rst_x_ddr_0_axi_n:  1,    //      6
                              : 25;    //   31:7 reserved
}SCRG_CTRL_DDR1SB_CRG_DDR1SB003_O26A0_T;

/*-----------------------------------------------------------------------------------------
    scrg_ctrl_ddr1sb Register LIst
-----------------------------------------------------------------------------------------*/
typedef struct {
    SCRG_CTRL_DDR1SB_CRG_DDR1SB000_O26A0_T    crg_ddr1sb000;    // 0xC451_0000
    SCRG_CTRL_DDR1SB_CRG_DDR1SB001_O26A0_T    crg_ddr1sb001;    // 0xC451_0004
    SCRG_CTRL_DDR1SB_CRG_DDR1SB002_O26A0_T    crg_ddr1sb002;    // 0xC451_0008
    SCRG_CTRL_DDR1SB_CRG_DDR1SB003_O26A0_T    crg_ddr1sb003;    // 0xC451_000C
}SCRG_CTRL_DDR1SB_REG_O26A0_T;
/* 4 regs */
...
#define SCRG_CTRL_DDR1SB_CRG_DDR1SB000_O26A0_T_OFF          (BASEADDRESS+0x0000)
#define SCRG_CTRL_DDR1SB_CRG_DDR1SB001_O26A0_T_OFF          (BASEADDRESS+0x0004)
#define SCRG_CTRL_DDR1SB_CRG_DDR1SB002_O26A0_T_OFF          (BASEADDRESS+0x0008)
#define SCRG_CTRL_DDR1SB_CRG_DDR1SB003_O26A0_T_OFF          (BASEADDRESS+0x000C)
