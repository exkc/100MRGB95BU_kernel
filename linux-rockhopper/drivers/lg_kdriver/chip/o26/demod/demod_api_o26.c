...
int DEMOD_O26_API_Suspend (void) {
	LX_DEMOD_L2_Context * frontend = NULL;

	frontend = DEMOD_Get_LGDBB_Context();
...
int DEMOD_O26_API_Status(char * pDbglog, int * pDbgidx) {
...
int DEMOD_O26_API_Dump(char * pDbglog, int * pDbgidx) {
