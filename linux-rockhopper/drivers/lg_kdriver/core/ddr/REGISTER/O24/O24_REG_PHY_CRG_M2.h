#ifndef _REG_PHY_CRG_M2_h
#define _REG_PHY_CRG_M2_h
//Header File for PHY_CRG_M2 in \O24\O24_DRAM_M2_Register_Manual.xls

#define REG_PHY_CRG_M2_PHY_CLK_EN                                        (APB_PHY_CRG_M2_BASE+0x7000)
#define REG_PHY_CRG_M2_PHY_RST_EN                                        (APB_PHY_CRG_M2_BASE+0x7004)
#define REG_PHY_CRG_M2_PAD_CAL_CLK_DIV                                   (APB_PHY_CRG_M2_BASE+0x7008)
#define REG_PHY_CRG_M2_PHY_CLK_SRC_SEL                                   (APB_PHY_CRG_M2_BASE+0x700C)
#define REG_PHY_CRG_M2_PLL_PDB_CTRL                                      (APB_PHY_CRG_M2_BASE+0x7010)
#define REG_PHY_CRG_M2_DMODE_CTRL                                        (APB_PHY_CRG_M2_BASE+0x7014)
#define REG_PHY_CRG_M2_IBIAS_BGRBUF                                      (APB_PHY_CRG_M2_BASE+0x7018)
#define REG_PHY_CRG_M2_RX_PDB                                            (APB_PHY_CRG_M2_BASE+0x701C)
#define REG_PHY_CRG_M2_APHY_CTRL_PWRUP_RSTB_0                            (APB_PHY_CRG_M2_BASE+0x7050)
#define REG_PHY_CRG_M2_APHY_CTRL_PWRUP_RSTB_1                            (APB_PHY_CRG_M2_BASE+0x7054)
#define REG_PHY_CRG_M2_APHY_CTRL_PWRUP_RSTB_2                            (APB_PHY_CRG_M2_BASE+0x7058)
#define REG_PHY_CRG_M2_APHY_CTRL_PWRUP_RSTB_3                            (APB_PHY_CRG_M2_BASE+0x705C)
#define REG_PHY_CRG_M2_APHY_CTRL_PWRUP_RSTB_4                            (APB_PHY_CRG_M2_BASE+0x7060)
#define REG_PHY_CRG_M2_APHY_CTRL_PWRUP_RSTB_5                            (APB_PHY_CRG_M2_BASE+0x7064)
#define REG_PHY_CRG_M2_APHY_CTRL_PWRUP_RSTB_6                            (APB_PHY_CRG_M2_BASE+0x7068)
#define REG_PHY_CRG_M2_APHY_CTRL_PWRUP_RSTB_7                            (APB_PHY_CRG_M2_BASE+0x706C)
#define REG_PHY_CRG_M2_APHY_CTRL_PWRUP_RSTB_8                            (APB_PHY_CRG_M2_BASE+0x7070)
#define REG_PHY_CRG_M2_APHY_CTRL_PWRUP_RSTB_9                            (APB_PHY_CRG_M2_BASE+0x7074)
#define REG_PHY_CRG_M2_APHY_CTRL_SW_RSTB_DQS                             (APB_PHY_CRG_M2_BASE+0x7078)
#define REG_PHY_CRG_M2_APHY_CTRL_SW_RSTB_CK                              (APB_PHY_CRG_M2_BASE+0x707C)
#define REG_PHY_CRG_M2_APHY_PAD_CKE_DDR4                                 (APB_PHY_CRG_M2_BASE+0x7080)
#define REG_PHY_CRG_M2_APHY_PAD_ODT_DDR4                                 (APB_PHY_CRG_M2_BASE+0x7084)
#define REG_PHY_CRG_M2_APHY_PAD_CKE_ODT_LPD4                             (APB_PHY_CRG_M2_BASE+0x7088)
#define REG_PHY_CRG_M2_PLL_CTRL_STATUS                                   (APB_PHY_CRG_M2_BASE+0x7100)
#define REG_PHY_CRG_M2_DFS_CTRL_STATUS                                   (APB_PHY_CRG_M2_BASE+0x7104)
#define REG_PHY_CRG_M2_LP_CTRL_STATUS                                    (APB_PHY_CRG_M2_BASE+0x7108)
#define REG_PHY_CRG_M2_RTE_STATUS                                        (APB_PHY_CRG_M2_BASE+0x710C)
#define REG_PHY_CRG_M2_CAL_STATUS                                        (APB_PHY_CRG_M2_BASE+0x7110)
#define REG_PHY_CRG_M2_RTE_CAL_STATUS                                    (APB_PHY_CRG_M2_BASE+0x7114)
#define REG_PHY_CRG_M2_SPARE                                             (APB_PHY_CRG_M2_BASE+0x7118)

typedef union {
	UINT32 udata32;
	struct {						//0xC450F000 RW
	UINT32 phy_reg_clk_ena                  :1;	//0 //PHY register clock enable
	UINT32 resvd0                           :3;  
	UINT32 phy_clk_ena                      :1;	//4 //PHY core clock enable
	UINT32 resvd1                           :27; 
	};
}REG_PHY_CRG_M2_PHY_CLK_EN_T;

typedef union {
	UINT32 udata32;
	struct {						//0xC450F004 RW
	UINT32 phy_reg_sw_resetn                :1;	//0 //PHY register software reset
	UINT32 resvd0                           :3;  
	UINT32 phy_sw_resetn                    :1;	//4 //PHY core software reset
	UINT32 resvd1                           :27; 
	};
}REG_PHY_CRG_M2_PHY_RST_EN_T;
...
}REG_PHY_CRG_M2_PAD_CAL_CLK_DIV_T;

typedef union {
	UINT32 udata32;
	struct {						//0xC450F00C RW
...
}REG_PHY_CRG_M2_PHY_CLK_SRC_SEL_T;

typedef union {
	UINT32 udata32;
	struct {						//0xC450F010 RW
...
}REG_PHY_CRG_M2_PLL_PDB_CTRL_T;

typedef union {
	UINT32 udata32;
	struct {						//0xC450F014 RW
...
}REG_PHY_CRG_M2_DMODE_CTRL_T;

typedef union {
	UINT32 udata32;
	struct {						//0xC450F018 RW
...
}REG_PHY_CRG_M2_IBIAS_BGRBUF_T;

typedef union {
	UINT32 udata32;
	struct {						//0xC450F01C RW
...
}REG_PHY_CRG_M2_RX_PDB_T;

typedef union {
	UINT32 udata32;
	struct {						//0xC450F050 RW
...
}REG_PHY_CRG_M2_APHY_CTRL_PWRUP_RSTB_0_T;

typedef union {
	UINT32 udata32;
	struct {						//0xC450F054 RW
...
}REG_PHY_CRG_M2_APHY_CTRL_PWRUP_RSTB_1_T;

typedef union {
	UINT32 udata32;
	struct {						//0xC450F058 RW
...
}REG_PHY_CRG_M2_APHY_CTRL_PWRUP_RSTB_2_T;

typedef union {
	UINT32 udata32;
	struct {						//0xC450F05C RW
...
}REG_PHY_CRG_M2_APHY_CTRL_PWRUP_RSTB_3_T;

typedef union {
	UINT32 udata32;
	struct {						//0xC450F060 RW
...
}REG_PHY_CRG_M2_APHY_CTRL_PWRUP_RSTB_4_T;

typedef union {
	UINT32 udata32;
	struct {						//0xC450F064 RW
...
}REG_PHY_CRG_M2_APHY_CTRL_PWRUP_RSTB_5_T;

typedef union {
	UINT32 udata32;
	struct {						//0xC450F068 RW
...
}REG_PHY_CRG_M2_APHY_CTRL_PWRUP_RSTB_6_T;

typedef union {
	UINT32 udata32;
	struct {						//0xC450F06C RW
...
}REG_PHY_CRG_M2_APHY_CTRL_PWRUP_RSTB_7_T;

typedef union {
	UINT32 udata32;
	struct {						//0xC450F070 RW
...
}REG_PHY_CRG_M2_APHY_CTRL_PWRUP_RSTB_8_T;

typedef union {
	UINT32 udata32;
	struct {						//0xC450F074 RW
...
}REG_PHY_CRG_M2_APHY_CTRL_PWRUP_RSTB_9_T;

typedef union {
	UINT32 udata32;
	struct {						//0xC450F078 RW
...
}REG_PHY_CRG_M2_APHY_CTRL_SW_RSTB_DQS_T;

typedef union {
	UINT32 udata32;
	struct {						//0xC450F07C RW
...
}REG_PHY_CRG_M2_APHY_CTRL_SW_RSTB_CK_T;

typedef union {
	UINT32 udata32;
	struct {						//0xC450F080 RW
...
}REG_PHY_CRG_M2_APHY_PAD_CKE_DDR4_T;

typedef union {
	UINT32 udata32;
	struct {						//0xC450F084 RW
...
}REG_PHY_CRG_M2_APHY_PAD_ODT_DDR4_T;

typedef union {
	UINT32 udata32;
	struct {						//0xC450F088 RW
...
}REG_PHY_CRG_M2_APHY_PAD_CKE_ODT_LPD4_T;

typedef union {
	UINT32 udata32;
	struct {						//0xC450F100 RO
...
}REG_PHY_CRG_M2_PLL_CTRL_STATUS_T;

typedef union {
	UINT32 udata32;
	struct {						//0xC450F104 RO
...
}REG_PHY_CRG_M2_DFS_CTRL_STATUS_T;

typedef union {
	UINT32 udata32;
	struct {						//0xC450F108 RO
...
}REG_PHY_CRG_M2_LP_CTRL_STATUS_T;

typedef union {
	UINT32 udata32;
	struct {						//0xC450F10C RO
...
}REG_PHY_CRG_M2_RTE_STATUS_T;

typedef union {
	UINT32 udata32;
	struct {						//0xC450F110 RO
...
}REG_PHY_CRG_M2_CAL_STATUS_T;

typedef union {
	UINT32 udata32;
	struct {						//0xC450F114 RO
...
}REG_PHY_CRG_M2_RTE_CAL_STATUS_T;
...
}REG_PHY_CRG_M2_SPARE_T;

typedef struct {
	REG_PHY_CRG_M2_PHY_CLK_EN_T                              phy_clk_en;	//0xC450F000
	REG_PHY_CRG_M2_PHY_RST_EN_T                              phy_rst_en;	//0xC450F004
	REG_PHY_CRG_M2_PAD_CAL_CLK_DIV_T                    pad_cal_clk_div;	//0xC450F008
	REG_PHY_CRG_M2_PHY_CLK_SRC_SEL_T                    phy_clk_src_sel;	//0xC450F00C
	REG_PHY_CRG_M2_PLL_PDB_CTRL_T                          pll_pdb_ctrl;	//0xC450F010
	REG_PHY_CRG_M2_DMODE_CTRL_T                              dmode_ctrl;	//0xC450F014
	REG_PHY_CRG_M2_IBIAS_BGRBUF_T                          ibias_bgrbuf;	//0xC450F018
	REG_PHY_CRG_M2_RX_PDB_T                                      rx_pdb;	//0xC450F01C
	UINT32                                                    reserved0;	//0xC450F020
	UINT32                                                    reserved1;	//0xC450F024
	UINT32                                                    reserved2;	//0xC450F028
	UINT32                                                    reserved3;	//0xC450F02C
	UINT32                                                    reserved4;	//0xC450F030
	UINT32                                                    reserved5;	//0xC450F034
	UINT32                                                    reserved6;	//0xC450F038
	UINT32                                                    reserved7;	//0xC450F03C
	UINT32                                                    reserved8;	//0xC450F040
	UINT32                                                    reserved9;	//0xC450F044
	UINT32                                                   reserved10;	//0xC450F048
	UINT32                                                   reserved11;	//0xC450F04C
	REG_PHY_CRG_M2_APHY_CTRL_PWRUP_RSTB_0_T      aphy_ctrl_pwrup_rstb_0;	//0xC450F050
	REG_PHY_CRG_M2_APHY_CTRL_PWRUP_RSTB_1_T      aphy_ctrl_pwrup_rstb_1;	//0xC450F054
	REG_PHY_CRG_M2_APHY_CTRL_PWRUP_RSTB_2_T      aphy_ctrl_pwrup_rstb_2;	//0xC450F058
	REG_PHY_CRG_M2_APHY_CTRL_PWRUP_RSTB_3_T      aphy_ctrl_pwrup_rstb_3;	//0xC450F05C
	REG_PHY_CRG_M2_APHY_CTRL_PWRUP_RSTB_4_T      aphy_ctrl_pwrup_rstb_4;	//0xC450F060
	REG_PHY_CRG_M2_APHY_CTRL_PWRUP_RSTB_5_T      aphy_ctrl_pwrup_rstb_5;	//0xC450F064
	REG_PHY_CRG_M2_APHY_CTRL_PWRUP_RSTB_6_T      aphy_ctrl_pwrup_rstb_6;	//0xC450F068
	REG_PHY_CRG_M2_APHY_CTRL_PWRUP_RSTB_7_T      aphy_ctrl_pwrup_rstb_7;	//0xC450F06C
	REG_PHY_CRG_M2_APHY_CTRL_PWRUP_RSTB_8_T      aphy_ctrl_pwrup_rstb_8;	//0xC450F070
	REG_PHY_CRG_M2_APHY_CTRL_PWRUP_RSTB_9_T      aphy_ctrl_pwrup_rstb_9;	//0xC450F074
	REG_PHY_CRG_M2_APHY_CTRL_SW_RSTB_DQS_T        aphy_ctrl_sw_rstb_dqs;	//0xC450F078
	REG_PHY_CRG_M2_APHY_CTRL_SW_RSTB_CK_T          aphy_ctrl_sw_rstb_ck;	//0xC450F07C
	REG_PHY_CRG_M2_APHY_PAD_CKE_DDR4_T                aphy_pad_cke_ddr4;	//0xC450F080
	REG_PHY_CRG_M2_APHY_PAD_ODT_DDR4_T                aphy_pad_odt_ddr4;	//0xC450F084
	REG_PHY_CRG_M2_APHY_PAD_CKE_ODT_LPD4_T        aphy_pad_cke_odt_lpd4;	//0xC450F088
	UINT32                                                   reserved12;	//0xC450F08C
	UINT32                                                   reserved13;	//0xC450F090
	UINT32                                                   reserved14;	//0xC450F094
	UINT32                                                   reserved15;	//0xC450F098
	UINT32                                                   reserved16;	//0xC450F09C
	UINT32                                                   reserved17;	//0xC450F0A0
	UINT32                                                   reserved18;	//0xC450F0A4
	UINT32                                                   reserved19;	//0xC450F0A8
	UINT32                                                   reserved20;	//0xC450F0AC
	UINT32                                                   reserved21;	//0xC450F0B0
	UINT32                                                   reserved22;	//0xC450F0B4
	UINT32                                                   reserved23;	//0xC450F0B8
	UINT32                                                   reserved24;	//0xC450F0BC
	UINT32                                                   reserved25;	//0xC450F0C0
	UINT32                                                   reserved26;	//0xC450F0C4
	UINT32                                                   reserved27;	//0xC450F0C8
	UINT32                                                   reserved28;	//0xC450F0CC
	UINT32                                                   reserved29;	//0xC450F0D0
	UINT32                                                   reserved30;	//0xC450F0D4
	UINT32                                                   reserved31;	//0xC450F0D8
	UINT32                                                   reserved32;	//0xC450F0DC
	UINT32                                                   reserved33;	//0xC450F0E0
	UINT32                                                   reserved34;	//0xC450F0E4
	UINT32                                                   reserved35;	//0xC450F0E8
	UINT32                                                   reserved36;	//0xC450F0EC
	UINT32                                                   reserved37;	//0xC450F0F0
	UINT32                                                   reserved38;	//0xC450F0F4
	UINT32                                                   reserved39;	//0xC450F0F8
	UINT32                                                   reserved40;	//0xC450F0FC
	REG_PHY_CRG_M2_PLL_CTRL_STATUS_T                    pll_ctrl_status;	//0xC450F100
	REG_PHY_CRG_M2_DFS_CTRL_STATUS_T                    dfs_ctrl_status;	//0xC450F104
	REG_PHY_CRG_M2_LP_CTRL_STATUS_T                      lp_ctrl_status;	//0xC450F108
	REG_PHY_CRG_M2_RTE_STATUS_T                              rte_status;	//0xC450F10C
	REG_PHY_CRG_M2_CAL_STATUS_T                              cal_status;	//0xC450F110
	REG_PHY_CRG_M2_RTE_CAL_STATUS_T                      rte_cal_status;	//0xC450F114
	REG_PHY_CRG_M2_SPARE_T                                        spare;	//0xC450F118
}REG_PHY_CRG_M2_T;
