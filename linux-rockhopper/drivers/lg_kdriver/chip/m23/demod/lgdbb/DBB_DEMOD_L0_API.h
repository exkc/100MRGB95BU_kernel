...
#if (DEMOD_PLATFORM == DEMOD_PLATFORM_XTENSA)
#define DEMOD_L0_Lock_CommDevice
#define DEMOD_L0_Unlock_CommDevice
#else
...
#define DEMOD_L0_LockDevice(chip)	DEMOD_L0_MUTEX_LOCK(&chip->mutex_lock, __FILE__, __LINE__)
#define DEMOD_L0_UnlockDevice(chip)	DEMOD_L0_MUTEX_UNLOCK(&chip->mutex_lock, __FILE__, __LINE__)


#if (DEMOD_COMM == DEMOD_COMM_FPGA)
extern MUTEX_LOCK_T _mutex_comm;
#define DEMOD_L0_Lock_CommDevice(chip)		DEMOD_L0_MUTEX_LOCK(&_mutex_comm, __FILE__, __LINE__)
#define DEMOD_L0_Unlock_CommkDevice(chip)	DEMOD_L0_MUTEX_UNLOCK(&_mutex_comm, __FILE__, __LINE__)
#else
#define DEMOD_L0_Lock_CommDevice(chip)
#define DEMOD_L0_Unlock_CommDevice(chip)
#endif
...
int DEMOD_L0_SetAddress (LX_DEMOD_L0_Context* chip, UINT32 addr, UINT8 addSize) ;
