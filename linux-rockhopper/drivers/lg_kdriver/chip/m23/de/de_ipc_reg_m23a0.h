...
#ifndef _IPC_REG_M23A0_H_
#define _IPC_REG_M23A0_H_
...
}M23A0_SPP_MCU_VERSION_T;

typedef union {
	UINT32 udata32;
	struct {						//0xCC080060 RO 0x0000_0000
	UINT32 intr_cvi_mcu_mcu                 :1;	//(0,RO,0x00) //
	UINT32 intr_imx_mcu_mcu                 :1;	//(1,RO,0x00) //
	UINT32 intr_gav_mcu_mcu                 :1;	//(2,RO,0x00) //
	UINT32 intr_hdr_mcu_mcu                 :1;	//(3,RO,0x00) //
	UINT32 intr_vdo_mcu_mcu                 :1;	//(4,RO,0x00) //
	UINT32 intr_nd0_mcu_mcu                 :1;	//(5,RO,0x00) //
	UINT32 intr_sre_mcu_mcu                 :1;	//(6,RO,0x00) //
	UINT32 intr_gsc_mcu_mcu                 :1;	//(7,RO,0x00) //
	UINT32 intr_vsd_mcu_mcu                 :1;	//(8,RO,0x00) //
	UINT32 intr_cco_mcu_mcu                 :1;	//(9,RO,0x00) //
	UINT32 intr_led_mcu_mcu                 :1;	//(10,RO,0x00) //
	UINT32 intr_ldm_mcu_mcu                 :1;	//(11,RO,0x00) //
	UINT32 intr_vdec_mcu_mcu                :1;	//(12,RO,0x00) //
	UINT32 intr_fmc_mcu_mcu                 :1;	//(13,RO,0x00) //
	UINT32 intr_fms_mcu_mcu                 :1;	//(14,RO,0x00) //
	UINT32 intr_me0_mcu_mcu                 :1;	//(15,RO,0x00) //
	UINT32 intr_dne_mcu_mcu                 :1;	//(16,RO,0x00) //
	UINT32 reserved                         :15;	//(31:17,Rsvd,0x0) //
	};
}M23A0_INTR_MCU_FLAG_T;

typedef union {
	UINT32 udata32;
	struct {						//0xCC080064 RW 0x0000_0000
	UINT32 intr_cvi_mcu_mcu_en              :1;	//(0,RW,0x00) //
	UINT32 intr_imx_mcu_mcu_en              :1;	//(1,RW,0x00) //
	UINT32 intr_gav_mcu_mcu_en              :1;	//(2,RW,0x00) //
	UINT32 intr_hdr_mcu_mcu_en              :1;	//(3,RW,0x00) //
	UINT32 intr_vdo_mcu_mcu_en              :1;	//(4,RW,0x00) //
	UINT32 intr_nd0_mcu_mcu_en              :1;	//(5,RW,0x00) //
	UINT32 intr_sre_mcu_mcu_en              :1;	//(6,RW,0x00) //
	UINT32 intr_gsc_mcu_mcu_en              :1;	//(7,RW,0x00) //
	UINT32 intr_vsd_mcu_mcu_en              :1;	//(8,RW,0x00) //
	UINT32 intr_cco_mcu_mcu_en              :1;	//(9,RW,0x00) //
	UINT32 intr_led_mcu_mcu_en              :1;	//(10,RW,0x00) //
	UINT32 intr_ldm_mcu_mcu_en              :1;	//(11,RW,0x00) //
	UINT32 intr_vdec_mcu_mcu_en             :1;	//(12,RW,0x00) //
	UINT32 intr_fmc_mcu_mcu_en              :1;	//(13,RW,0x00) //
	UINT32 intr_fms_mcu_mcu_en              :1;	//(14,RW,0x00) //
	UINT32 intr_me0_mcu_mcu_en              :1;	//(15,RW,0x00) //
	UINT32 intr_dne_mcu_mcu_en              :1;	//(16,RW,0x00) //
	UINT32 reserved                         :15;	//(31:17,Rsvd,0x0) //
	};
}M23A0_INTR_MCU_FLAG_EN_T;

typedef union {
	UINT32 udata32;
	struct {						//0xCC080068 RO 0x0000_0000
	UINT32 intr_cvi_mcu_cpu                 :1;	//(0,RO,0x00) //
	UINT32 intr_imx_mcu_cpu                 :1;	//(1,RO,0x00) //
	UINT32 intr_gav_mcu_cpu                 :1;	//(2,RO,0x00) //
	UINT32 intr_hdr_mcu_cpu                 :1;	//(3,RO,0x00) //
	UINT32 intr_vdo_mcu_cpu                 :1;	//(4,RO,0x00) //
	UINT32 intr_nd0_mcu_cpu                 :1;	//(5,RO,0x00) //
	UINT32 intr_sre_mcu_cpu                 :1;	//(6,RO,0x00) //
	UINT32 intr_gsc_mcu_cpu                 :1;	//(7,RO,0x00) //
	UINT32 intr_vsd_mcu_cpu                 :1;	//(8,RO,0x00) //
	UINT32 intr_cco_mcu_cpu                 :1;	//(9,RO,0x00) //
	UINT32 intr_led_mcu_cpu                 :1;	//(10,RO,0x00) //
	UINT32 intr_vdec_mcu_mcu                :1;	//(11,RO,0x00) //VDEC to MCU interrupt
	UINT32 intr_vdec_mcu_pqe                :1;	//(12,RO,0x00) //MCU to VDEC interrupt
	UINT32 intr_fmc_mcu_cpu                 :1;	//(13,RO,0x00) //
	UINT32 intr_fms_mcu_cpu                 :1;	//(14,RO,0x00) //
	UINT32 intr_me0_mcu_cpu                 :1;	//(15,RO,0x00) //
	UINT32 intr_dne_mcu_cpu                 :1;	//(16,RO,0x00) //
	UINT32 reserved                         :15;	//(31:17,Rsvd,0x0000_0000) //
	};
}M23A0_INTR_CPU_FLAG_T;

typedef union {
	UINT32 udata32;
	struct {						//0xCC08006C RW 0x0000_0000
	UINT32 intr_cvi_mcu_cpu_en              :1;	//(0,RW,0x00) //
	UINT32 intr_imx_mcu_cpu_en              :1;	//(1,RW,0x00) //
	UINT32 intr_gav_mcu_cpu_en              :1;	//(2,RW,0x00) //
	UINT32 intr_hdr_mcu_cpu_en              :1;	//(3,RW,0x00) //
	UINT32 intr_vdo_mcu_cpu_en              :1;	//(4,RW,0x00) //
	UINT32 intr_nd0_mcu_cpu_en              :1;	//(5,RW,0x00) //
	UINT32 intr_sre_mcu_cpu_en              :1;	//(6,RW,0x00) //
	UINT32 intr_gsc_mcu_cpu_en              :1;	//(7,RW,0x00) //
	UINT32 intr_vsd_mcu_cpu_en              :1;	//(8,RW,0x00) //
	UINT32 intr_cco_mcu_cpu_en              :1;	//(9,RW,0x00) //
	UINT32 intr_led_mcu_cpu_en              :1;	//(10,RW,0x00) //
	UINT32 intr_vdec_mcu_mcu_en             :1;	//(11,RW,0x00) //
	UINT32 intr_vdec_mcu_pqe_en             :1;	//(12,RW,0x00) //
	UINT32 intr_fmc_mcu_cpu_en              :1;	//(13,RW,0x00) //
	UINT32 intr_fms_mcu_cpu_en              :1;	//(14,RW,0x00) //
	UINT32 intr_me0_mcu_cpu_en              :1;	//(15,RW,0x00) //
	UINT32 intr_dne_mcu_cpu_en              :1;	//(16,RW,0x00) //
	UINT32 reserved                         :15;	//(31:17,Rsvd,0x0) //
	};
}M23A0_INTR_CPU_FLAG_EN_T;

typedef union {
	UINT32 udata32;
	struct {						//0xCC080070 RO 0x0000_0000
	UINT32 reserved                         :32;	//(31:0,RO,0x0) //
	};
}M23A0_GLOBAL_STCC0_T;
...
}M23A0_APB_TOUT_CTRL_CH0_PWDATA_T;
...
}M23A0_APB_TOUT_CTRL_CH1_PWDATA_T;
...
}M23A0_APB_TOUT_CTRL_CH2_PWDATA_T;
...
}M23A0_APB_TOUT_CTRL_CH3_PWDATA_T;
...
}M23A0_SROM_BOOT_MAP4_T;

typedef struct {
	M23A0_SET_REG_CTRL0_T                               set_reg_ctrl0;	//0xCC080000
	M23A0_SET_REG_CTRL1_T                               set_reg_ctrl1;	//0xCC080004
	M23A0_EXT_INTR_EVENT_T                             ext_intr_event;	//0xCC080008
	M23A0_EXT_INTR_ENABLE_T                           ext_intr_enable;	//0xCC08000C
	M23A0_EXT_INTR_STATUS_T                           ext_intr_status;	//0xCC080010
	M23A0_EXT_INTR_CLEAR_T                             ext_intr_clear;	//0xCC080014
	M23A0_INT_INTR_EVENT_T                             int_intr_event;	//0xCC080018
	M23A0_INT_INTR_ENABLE_T                           int_intr_enable;	//0xCC08001C
	M23A0_INT_INTR_STATUS_T                           int_intr_status;	//0xCC080020
	M23A0_INT_INTR_CLEAR_T                             int_intr_clear;	//0xCC080024
	M23A0_SROM_BOOT_MAP1_T                             srom_boot_map1;	//0xCC080028
	M23A0_SROM_BOOT_MAP2_T                             srom_boot_map2;	//0xCC08002C
	M23A0_SRAM_PORT_SEL_T                               sram_port_sel;	//0xCC080030
	M23A0_PDEBUG_STATUS_T                               pdebug_status;	//0xCC080034
	M23A0_PDEBUG_DATA_T                                   pdebug_data;	//0xCC080038
	M23A0_PDEBUG_PC_T                                       pdebug_pc;	//0xCC08003C
	M23A0_AXI_USER_ID_T                                   axi_user_id;	//0xCC080040
	M23A0_SRAM0_OFFSET_T                                 sram0_offset;	//0xCC080044
	M23A0_SRAM1_OFFSET_T                                 sram1_offset;	//0xCC080048
	M23A0_SRAM2_OFFSET_T                                 sram2_offset;	//0xCC08004C
	M23A0_SRAM3_OFFSET_T                                 sram3_offset;	//0xCC080050
	M23A0_PDEBUG_DATA1_T                                 pdebug_data1;	//0xCC080054
	M23A0_PDEBUG_PC1_T                                     pdebug_pc1;	//0xCC080058
	M23A0_SPP_MCU_VERSION_T                           spp_mcu_version;	//0xCC08005C
	M23A0_INTR_MCU_FLAG_T                               intr_mcu_flag;	//0xCC080060
	M23A0_INTR_MCU_FLAG_EN_T                         intr_mcu_flag_en;	//0xCC080064
	M23A0_INTR_CPU_FLAG_T                               intr_cpu_flag;	//0xCC080068
	M23A0_INTR_CPU_FLAG_EN_T                         intr_cpu_flag_en;	//0xCC08006C
	M23A0_GLOBAL_STCC0_T                                 global_stcc0;	//0xCC080070
	M23A0_GLOBAL_STCC1_T                                 global_stcc1;	//0xCC080074
	M23A0_GLOBAL_STCC2_T                                 global_stcc2;	//0xCC080078
	M23A0_GLOBAL_STCC3_T                                 global_stcc3;	//0xCC08007C
	M23A0_LIVE_STCC0_T                                     live_stcc0;	//0xCC080080
	M23A0_LIVE_STCC1_T                                     live_stcc1;	//0xCC080084
	M23A0_AD_APB_TOUT_CTRL_T                         ad_apb_tout_ctrl;	//0xCC080088
	M23A0_AD_APB_TOUT_CNT_T                           ad_apb_tout_cnt;	//0xCC08008C
	M23A0_APB_TOUT_CTRL_CH0_ADR_T               apb_tout_ctrl_ch0_adr;	//0xCC080090
	M23A0_APB_TOUT_CTRL_CH0_PW_T                 apb_tout_ctrl_ch0_pw;	//0xCC080094
	M23A0_APB_TOUT_CTRL_CH0_PWDATA_T         apb_tout_ctrl_ch0_pwdata;	//0xCC080098
	M23A0_APB_TOUT_CTRL_CH1_ADR_T               apb_tout_ctrl_ch1_adr;	//0xCC08009C
	M23A0_APB_TOUT_CTRL_CH1_PW_T                 apb_tout_ctrl_ch1_pw;	//0xCC0800A0
	M23A0_APB_TOUT_CTRL_CH1_PWDATA_T         apb_tout_ctrl_ch1_pwdata;	//0xCC0800A4
	M23A0_APB_TOUT_CTRL_CH2_ADR_T               apb_tout_ctrl_ch2_adr;	//0xCC0800A8
	M23A0_APB_TOUT_CTRL_CH2_PW_T                 apb_tout_ctrl_ch2_pw;	//0xCC0800AC
	M23A0_APB_TOUT_CTRL_CH2_PWDATA_T         apb_tout_ctrl_ch2_pwdata;	//0xCC0800B0
	M23A0_APB_TOUT_CTRL_CH3_ADR_T               apb_tout_ctrl_ch3_adr;	//0xCC0800B4
	M23A0_APB_TOUT_CTRL_CH3_PW_T                 apb_tout_ctrl_ch3_pw;	//0xCC0800B8
	M23A0_APB_TOUT_CTRL_CH3_PWDATA_T         apb_tout_ctrl_ch3_pwdata;	//0xCC0800BC
	M23A0_AD_MASK_START_ADDR_T                     ad_mask_start_addr;	//0xCC0800C0
	M23A0_AD_MASK_END_ADDR_T                         ad_mask_end_addr;	//0xCC0800C4
	M23A0_AD_MASK_READ_ADDR_T                       ad_mask_read_addr;	//0xCC0800C8
	M23A0_AD_INTR_PRIORITY_T                         ad_intr_priority;	//0xCC0800CC
	M23A0_AD_UP_COUNTER_T                               ad_up_counter;	//0xCC0800D0
	M23A0_RST_ASYNC_BRIDGE_T                         rst_async_bridge;	//0xCC0800D4
	M23A0_PFAULT_STATUS0_T                             pfault_status0;	//0xCC0800D8
	M23A0_PFAULT_STATUS1_T                             pfault_status1;	//0xCC0800DC
	M23A0_PFAULT_STATUS2_T                             pfault_status2;	//0xCC0800E0
	M23A0_SRAM4_OFFSET_T                                 sram4_offset;	//0xCC0800E4
	M23A0_SRAM5_OFFSET_T                                 sram5_offset;	//0xCC0800E8
	UINT32                                                    reserved0;	//0xCC0800EC
	UINT32                                                    reserved1;	//0xCC0800F0
	M23A0_SROM_BOOT_MAP3_T                             srom_boot_map3;	//0xCC0800F4
	M23A0_SROM_BOOT_MAP4_T                             srom_boot_map4;	//0xCC0800F8
}DE_IPC_REG_M23A0_T;
