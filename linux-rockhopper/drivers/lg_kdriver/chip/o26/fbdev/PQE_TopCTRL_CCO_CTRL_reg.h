#ifndef __PQE_TOP_CCO_CTRL_REG_H__
#define __PQE_TOP_CCO_CTRL_REG_H__
...
#define CCO_CTRL_RdFL(_r)           ((g_cco_ctrl_o26_reg_shadow->_r)=(g_cco_ctrl_o26_reg->_r))
#define CCO_CTRL_WrFL(_r)           ((g_cco_ctrl_o26_reg->_r)=(g_cco_ctrl_o26_reg_shadow->_r))

#define CCO_CTRL_Rd(_r)             *((UINT32*)(&(g_cco_ctrl_o26_reg_shadow->_r)))
#define CCO_CTRL_Wr(_r,_v)          ((CCO_CTRL_Rd(_r))=((UINT32)(_v)))

#define CCO_CTRL_Rd01(_r,_f01,_v01)                                                 \
                                do {                                                    \
                                    (_v01) = (g_cco_ctrl_o26_reg_shadow->_r._f01);  \
                                } while(0)

#define CCO_CTRL_Rd02(_r,_f01,_v01,_f02,_v02)                                       \
                                do {                                                    \
                                    (_v01) = (g_cco_ctrl_o26_reg_shadow->_r._f01);  \
                                    (_v02) = (g_cco_ctrl_o26_reg_shadow->_r._f02);  \
                                } while(0)

#define CCO_CTRL_Wr01(_r,_f01,_v01)                                                 \
                                do {                                                    \
                                    (g_cco_ctrl_o26_reg_shadow->_r._f01) = (_v01);  \
                                } while(0)

#define CCO_CTRL_Wr02(_r,_f01,_v01,_f02,_v02)                                       \
                                do {                                                    \
                                    (g_cco_ctrl_o26_reg_shadow->_r._f01) = (_v01);  \
                                    (g_cco_ctrl_o26_reg_shadow->_r._f02) = (_v02);  \
                                } while(0)

extern volatile CCO_CTRL_O26_REG_T* g_cco_ctrl_o26_reg;
extern CCO_CTRL_O26_REG_T*          g_cco_ctrl_o26_reg_shadow;
...
/* from 'O26-A0_PQE_TopCTRL_reg_man_CCO_CTRL.csv' 20241210 18:02:31 KST by getregs v2.9 */
