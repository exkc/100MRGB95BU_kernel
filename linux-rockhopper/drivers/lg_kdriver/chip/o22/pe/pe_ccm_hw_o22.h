...
#ifndef	_PE_CCM_HW_O22_H_
#define	_PE_CCM_HW_O22_H_
...
----------------------------------------------------------------------------------------*/
#define PE_CCM_HW_O22_LUT_A		0
#define PE_CCM_HW_O22_LUT_B		1
...
typedef enum
{
	PE_CCM_HW_O22_D3D_CHK_NORMAL = 0,		///< normal
	PE_CCM_HW_O22_D3D_CHK_NOT_TB,			///< not tb(not normal)
	PE_CCM_HW_O22_D3D_CHK_NOT_SS,			///< not ss(not normal)
	PE_CCM_HW_O22_D3D_CHK_MAX				///< max num
}
PE_CCM_HW_O22_D3D_CHK;
/**
 *	pe ccm control type
 */
typedef struct
{
	...
	UINT32 lut_type;		///< when HW is reset, table type = B. used in O22 only
}
PE_CCM_HW_O22_CTRL_T;
