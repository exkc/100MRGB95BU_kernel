...
**
*****************************************************************************/
#ifndef _ADEMOD_L18F_AGC_H_
#define _ADEMOD_L18F_AGC_H_
...
{
	int			clipper;
	int			instab_min;  //jeongpil.yun L18F
	int			instab_max;
	int			instab_thresh;
	UINT32		DAC_Dither;
	UINT32		Dither_LFSR;
...
**
******************************************************************************/
LX_ADEMOD_Result DEMOD_L18F_Analog_AGC_Gain_Set(pLX_ADEMOD_Agc pContext, UINT32 *pGain, Handle_t hUser, BOOL Update);
...
**
******************************************************************************/
LX_ADEMOD_Result DEMOD_L18F_Analog_AGC_Gain_Get(pLX_ADEMOD_Agc pContext, UINT32 *pGain, Handle_t hUser);
