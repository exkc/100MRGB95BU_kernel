...
#ifdef CONFIG_KERNEL_MODE_ONLY
extern int register_kernel_mode_init(int (*callback)(void));
extern bool is_kernel_mode_only(void);
extern void kernel_mode_init(void);
#else
static inline int register_kernel_mode_init(int (*callback)(void)) { return 0; }
static inline bool is_kernel_mode_only(void) { return false; }
static inline void kernel_mode_init(void) { ; }
#endif
