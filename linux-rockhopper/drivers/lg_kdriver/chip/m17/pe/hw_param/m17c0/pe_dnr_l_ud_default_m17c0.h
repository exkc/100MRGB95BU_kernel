...
const PE_REG_PARAM_T dnr_l_ud_default_m17c0[] =
{
	/* dnr, 0x7194~0x7198, 0x71A0~0x71DC, 0x71E4~0x71E8, 0x71F0~0x71F8, 0x7200~0x7210, 0x726C~0x728C */	
	{0x4594, 0x00380201},    // DNR_MAX_CTRL   
	{0x45A0, 0x3c00ffa1},    // MNR_CTRL_0
	{0x45A4, 0x0102FFFF},    // MNR_CTRL_1
	{0x45A8, 0x08FF00F0},    // MNR_CTRL_2
	{0x45AC, 0x80030061},    // MNR_CTRL_3
	{0x45B0, 0x0204080A},    // MNR_CTRL_4
	{0x45B4, 0x08060606},    // MNR_CTRL_5
	{0x45BC, 0x10300005},    // DC_BNR_CTRL_0
	{0x45C0, 0x4D710102},    // DC_BNR_CTRL_1
	{0x45C4, 0x15804109},    // DC_BNR_CTRL_2
	{0x45C8, 0x15254080},    // DC_BNR_CTRL_3
	{0x45CC, 0x00FFFF00},    // DC_BNR_CTRL_4
	{0x45D0, 0x004080FF},    // DC_BNR_CTRL_5
	{0x45D4, 0xC01010CF},    // AC_BNR_CTRL_0
	{0x45D8, 0x0F408000},    // AC_BNR_CTRL_1
	{0x45DC, 0x00051040},    // AC_BNR_CTRL_2
	{0x45E4, 0x00C0E0FF},    // AC_BNR_CTRL_3
	{0x45E8, 0x60E05000},    // AC_BNR_CTRL_4
	{0x45F0, 0xFA963201},    // AC_BNR_CTRL_5
	{0x45F4, 0x00FFC0A0},    // AC_BNR_CTRL_6
	{0x45F8, 0x80FFA080},    // AC_BNR_CTRL_7
	{0x4600, 0x40000F20},    // AC_BNR_CTRL_8
	{0x4604, 0x00108003},    // AC_BNR_CTRL_9
	...
	{0x46A8, 0x20202010},    // DC_BNR_CTRL_7
	{0x4730, 0x10203040},    // AC_BNR_15
	{0x4734, 0x10206080},    // AC_BNR_16
	{0x4764, 0x80000003},    // REG_DECON_CTRL_0
	{0x4768, 0x52500001},    // REG_DECON_CTRL_1
	{0x476C, 0x70503018},    // REG_DECON_CTRL_2
	{0x4770, 0x00040810},    // REG_DECON_CTRL_3
	{0x4774, 0x40201008},    // REG_DECON_CTRL_4
	{0x4778, 0x004488FF},    // REG_DECON_CTRL_5
	{0x477C, 0x6432190F},    // REG_DECON_CTRL_6
	{0x4780, 0xFAE1C896},    // REG_DECON_CTRL_7
	{0x4784, 0x40404040},    // REG_DECON_CTRL_8
	{0x4788, 0x80804040},    // REG_DECON_CTRL_9
	{0x478C, 0x00000000},    // REG_DECON_CTRL_10
	{0x4790, 0x40506080},    // REG_DC_BNR_CTRL_8
	{0x4794, 0xFFFFFFFF},    // REG_DC_BNR_CTRL_9
