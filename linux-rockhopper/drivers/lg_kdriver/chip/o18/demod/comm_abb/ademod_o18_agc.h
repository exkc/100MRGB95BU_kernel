...
**
*****************************************************************************/
#ifndef _ADEMOD_O18_AGC_H_
#define _ADEMOD_O18_AGC_H_
...
{
	int			clipper;
	int			instab_min;  //jeongpil.yun O18
	int			instab_max;
	int			instab_thresh;
	UINT32		DAC_Dither;
	UINT32		Dither_LFSR;
...
**
******************************************************************************/
LX_ADEMOD_Result DEMOD_O18_Analog_AGC_Gain_Set(pLX_ADEMOD_Agc pContext, UINT32 *pGain, Handle_t hUser, BOOL Update);
...
**
******************************************************************************/
LX_ADEMOD_Result DEMOD_O18_Analog_AGC_Gain_Get(pLX_ADEMOD_Agc pContext, UINT32 *pGain, Handle_t hUser);
