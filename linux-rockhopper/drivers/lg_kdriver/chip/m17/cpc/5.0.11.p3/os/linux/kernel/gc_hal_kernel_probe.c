...
/* SICDTV-6348
 * GFX irq number : O18 IRQS[65]  -> O20 IRQS[92]
 * GFX control register base : O18 0xC982_1000 -> O20 0xC981_1000
 * ClockFrequency : O18 300MHz -> O20 533MHz
 *
 */
	#ifdef CONFIG_LG_EXT
		#if defined(O22_KDRV_BUILD)
		static int irqLine = 120;        /* LG1213 : fake configuration to avoid compile error */
		#elif defined(E60_KDRV_BUILD)
		static int irqLine = 120;        /* LG1811 (88+32) */
		#elif defined(O20_KDRV_BUILD)
		static int irqLine = 124;        /* LG1212 (92+32) */
		#elif defined(O18_KDRV_BUILD)
		static int irqLine = 97;        /* LG1211 (65+32) */
		#elif defined(M19_KDRV_BUILD)
		static int irqLine = 124;        /* M16P3 (92+32) */
		#else
		static int irqLine = 86;        /* H15/M16/M16P common */
		#endif
	#else
...
module_param(irqLine, int, 0644);
	...
	#ifdef CONFIG_LG_EXT
		#if	  defined H15_KDRV_BUILD	/* H15 */
		static ulong registerMemBase = 0xc8441000;
		#elif defined M16_KDRV_BUILD	/* M16 */
		static ulong registerMemBase = 0xc8811000;
		#elif defined M16P_KDRV_BUILD	/* M16P */
		static ulong registerMemBase = 0xc9811000;
		#elif defined M17_KDRV_BUILD	/* M17 */
		static ulong registerMemBase = 0xc9811000;
		#elif defined O18_KDRV_BUILD	/* O18 */
		static ulong registerMemBase = 0xc9821000;
		#elif defined M19_KDRV_BUILD	/* M16P3 */
		static ulong registerMemBase = 0xc9811000;
		#elif defined O20_KDRV_BUILD	/* O20 */
		static ulong registerMemBase = 0xc9811000;
		#elif defined E60_KDRV_BUILD	/* E60 */
		static ulong registerMemBase = 0xc9311000;
		#elif defined O22_KDRV_BUILD	/* O22 - fake configuration to avoid compile error */
		static ulong registerMemBase = 0xc9311000;
		#else
			#error unknown chip
		#endif
...
module_param(baseAddress, ulong, 0644);
	...
	#ifdef CONFIG_LG_EXT
	static ulong physSize = 0xC0000000;
	#else
...
static int __init gpu_init(void)
{
     ...
     && platform.ops->needAddDevice(&platform))
    {
        ...
        of_dma_configure(&platform.device->dev, platform.device->dev.of_node, true);
#else
        of_dma_configure(&platform.device->dev, platform.device->dev.of_node);
#endif
        /* Add device */
