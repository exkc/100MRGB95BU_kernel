#ifndef _PE_CVI_REG_M17C0_H_
#define _PE_CVI_REG_M17C0_H_
#ifndef UINT32
...
typedef struct
{
	...
	pre3d_sync_mode                    :2 ,	// 2:1
	pre3d_field_mode                   :1 ,	// 3 
	pre3d_frame_lr_mode                :1 ,	// 4 
	pre3d_mid_vsync_bypass             :1 ,	// 5 
	pre3d_field_bypass                 :1 ,	// 6 
	reserved                           :1 ,	// 7 
	reserved01                         :8 ,	// reserved
	pre3d_active_line_num              :13;	// 28:16
}PE_M17C0_PRE3D_CTRL0_T;
/*-----------------------------------------------------------------------------
...
{
	UINT32
	pre3d_active_space1_line_num       :13,	// 12:0
	reserved01                         :3 ,	// reserved
	pre3d_active_space2_line_num       :13;	// 28:16
}PE_M17C0_PRE3D_CTRL1_T;
/*-----------------------------------------------------------------------------
...
{
	UINT32
	pre3d_front_porch_line_num         :13,	// 12:0
	reserved01                         :3 ,	// reserved
	pre3d_sync_line_num                :13;	// 28:16
}PE_M17C0_PRE3D_CTRL2_T;
/*-----------------------------------------------------------------------------
...
typedef struct
{
	...
	diff_hsize                         :14;	// 29:16
}PE_M17C0_SIZE_DETECT_CTRL3_T;

typedef struct
{ 
	PE_M17C0_HDMI_MUX_CTRL_T                          hdmi_mux_ctrl;	//0x0000
	UINT32                                            reserved1[10];	//0x4-0x28
	PE_M17C0_HDMI_RX_CTRL_T                           hdmi_rx_ctrl;	//0x002C
}PE_HDMI_REG_M17C0_T;

typedef struct
{ 
	PE_M17C0_TOP_CTRL_T                               top_ctrl;	//0x0000
	PE_M17C0_OFFSET_CTRL_T                            offset_ctrl;	//0x0004
	PE_M17C0_SIZE_CTRL_T                              size_ctrl;	//0x0008
	PE_M17C0_INT_SYNC_CTRL0_T                         int_sync_ctrl0;	//0x000C
	PE_M17C0_INT_SYNC_CTRL1_T                         int_sync_ctrl1;	//0x0010
	PE_M17C0_CV_MASK_CTRL_T                           cv_mask_ctrl;	//0x0014
	PE_M17C0_CV_420_INCTRL_T                          cv_420_inctrl;	//0x0018
	PE_M17C0_RESERVED002_T                            reserved002;	//0x001C
	PE_M17C0_RESERVED003_T                            reserved003;	//0x0020
	PE_M17C0_CSC_CTRL0_T                              csc_ctrl0;	//0x0024
	PE_M17C0_CSC_CTRL1_T                              csc_ctrl1;	//0x0028
	PE_M17C0_CSC_CTRL2_T                              csc_ctrl2;	//0x002C
	PE_M17C0_CSC_CTRL3_T                              csc_ctrl3;	//0x0030
	PE_M17C0_CSC_CTRL4_T                              csc_ctrl4;	//0x0034
	PE_M17C0_CSC_CTRL5_T                              csc_ctrl5;	//0x0038
	PE_M17C0_CSC_CTRL6_T                              csc_ctrl6;	//0x003C
	PE_M17C0_CSC_CTRL7_T                              csc_ctrl7;	//0x0040
	PE_M17C0_MISC_CTRL_T                              misc_ctrl;	//0x0044
	PE_M17C0_OFFSET_READ_T                            offset_read;	//0x0048
	PE_M17C0_PRE3D_CTRL0_T                            pre3d_ctrl0;	//0x004C
	PE_M17C0_PRE3D_CTRL1_T                            pre3d_ctrl1;	//0x0050
	PE_M17C0_PRE3D_CTRL2_T                            pre3d_ctrl2;	//0x0054
	PE_M17C0_SIZE_STATUS1_T                           size_status1;	//0x0058
	PE_M17C0_SIZE_STATUS2_T                           size_status2;	//0x005C
	PE_M17C0_SIZE_STATUS3_T                           size_status3;	//0x0060
	PE_M17C0_SIZE_STATUS4_T                           size_status4;	//0x0064
	PE_M17C0_PIX_SUM_CTRL0_T                          pix_sum_ctrl0;	//0x0068
	PE_M17C0_PIX_SUM_CTRL1_T                          pix_sum_ctrl1;	//0x006C
	PE_M17C0_PIX_SUM_STATUS0_T                        pix_sum_status0;	//0x0070
	PE_M17C0_PIX_SUM_STATUS1_T                        pix_sum_status1;	//0x0074
	PE_M17C0_PIX_SUM_STATUS2_T                        pix_sum_status2;	//0x0078
	PE_M17C0_SYNC_FIL_CTRL_T                          sync_fil_ctrl;	//0x007C
	PE_M17C0_SYNC_FIL_STATUS_T                        sync_fil_status;	//0x0080
	PE_M17C0_RESERVED004_T                            reserved004;	//0x0084
	PE_M17C0_RESERVED005_T                            reserved005;	//0x0088
	PE_M17C0_RESERVED006_T                            reserved006;	//0x008C
	PE_M17C0_SYNC_REPEAT_CTRL_T                       sync_repeat_ctrl;	//0x0090
	PE_M17C0_SYNC_REPEAT_SIZE0_T                      sync_repeat_size0;	//0x0094
	PE_M17C0_SYNC_REPEAT_SIZE1_T                      sync_repeat_size1;	//0x0098
	PE_M17C0_SYNC_REPEAT_SIZE2_T                      sync_repeat_size2;	//0x009C
	PE_M17C0_SYNC_REPEAT_SIZE3_T                      sync_repeat_size3;	//0x00A0
	PE_M17C0_SYNC_REPEAT_SIZE4_T                      sync_repeat_size4;	//0x00A4
	PE_M17C0_SYNC_REPEAT_SIZE5_T                      sync_repeat_size5;	//0x00A8
	PE_M17C0_RESERVED007_T                            reserved007;	//0x00AC
	PE_M17C0_RESERVED008_T                            reserved008;	//0x00B0
	PE_M17C0_RESERVED009_T                            reserved009;	//0x00B4
	UINT32                                            reserved46[2];	//0xb8-0xbc
	PE_M17C0_SIZE_DETECT_CTRL_T                       size_detect_ctrl;	//0x00C0
	PE_M17C0_SIZE_DETECT_READ_T                       size_detect_read;	//0x00C4
	PE_M17C0_SIZE_STATUS0_T                           size_status0;	//0x00C8
	PE_M17C0_SIZE_STATUS5_T                           size_status5;	//0x00CC
	PE_M17C0_SIZE_STATUS6_T                           size_status6;	//0x00D0
	PE_M17C0_SIZE_DETECT_CTRL1_T                      size_detect_ctrl1;	//0x00D4
	PE_M17C0_SIZE_DETECT_CTRL2_T                      size_detect_ctrl2;	//0x00D8
	PE_M17C0_CV_OUT_MUX_T                             cv_out_mux;	//0x00DC
	PE_M17C0_PSEUDO_SYNC_CTRL1_T                      pseudo_sync_ctrl1;	//0x00E0
	PE_M17C0_PSEUDO_SYNC_CTRL2_T                      pseudo_sync_ctrl2;	//0x00E4
	PE_M17C0_PSEUDO_SYNC_CTRL3_T                      pseudo_sync_ctrl3;	//0x00E8
	PE_M17C0_PSEUDO_SYNC_CTRL4_T                      pseudo_sync_ctrl4;	//0x00EC
	PE_M17C0_SIZE_DETECT_CTRL3_T                      size_detect_ctrl3;	//0x00F0
}PE_CVI_REG_M17C0_T;
#endif