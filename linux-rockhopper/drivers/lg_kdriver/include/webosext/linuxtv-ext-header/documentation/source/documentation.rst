...
.. code::
   ...
   * :c:macro:`V4L2_CID_EXT_HDMI_OVERRIDE_EOTF`
   ...
   .. deprecated:: webOS6.0
      ...
      * :c:macro:`V4L2_CID_EXT_HDMI_PACKET_INFO` //except from socts, deprecated api
      * :c:macro:`V4L2_CID_EXT_HDMI_PACKET_INFO` //except from socts, deprecated api
