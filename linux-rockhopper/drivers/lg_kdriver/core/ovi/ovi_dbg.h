...
#define OVI_DBG_LEVEL_ERROR		0
#define OVI_DBG_LEVEL_WARN		1
#define OVI_DBG_LEVEL_IGNORE 	2
...
#define OVI_TRACE(format, args...)		DBG_PRINT ( g_ovi_debug_fd, LX_LOGM_LEVEL_TRACE, format, ##args )
...
extern int gOVIHalFuncSupportDbgLevel;
