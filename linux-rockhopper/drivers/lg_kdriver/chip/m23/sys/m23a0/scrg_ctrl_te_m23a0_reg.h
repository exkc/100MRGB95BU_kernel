#ifndef _SCRG_CTRL_TE_M23A0_REG_H_
#define _SCRG_CTRL_TE_M23A0_REG_H_
...
/*-----------------------------------------------------------------------------------------
    0xCED4_0000    crg_te00 ''
-----------------------------------------------------------------------------------------*/
typedef struct {
    UINT32
    reg_tpi_int_demod_clk_inv : 1,     //      0
    test_reserved             : 31;    //  31: 1
}SCRG_CTRL_TE_CRG_TE00_M23A0_T;

/*-----------------------------------------------------------------------------------------
    0xCED4_0004    crg_te01 ''
-----------------------------------------------------------------------------------------*/
typedef struct {
    UINT32
    test_reserved_ro          : 32;    //  31: 0
}SCRG_CTRL_TE_CRG_TE01_M23A0_T;

/*-----------------------------------------------------------------------------------------
    0xCED4_0008    crg_te02 ''
-----------------------------------------------------------------------------------------*/
typedef struct {
    UINT32
    ...
    reg_tpi_int_demod_clk_gate_en: 1,    //   12
                              : 19;    //  31:13 reserved
}SCRG_CTRL_TE_CRG_TE02_M23A0_T;

/*-----------------------------------------------------------------------------------------
    0xCED4_000C    crg_te03 ''
-----------------------------------------------------------------------------------------*/
typedef struct {
    UINT32
    ...
    reg_soft_rst_f_teiopw_0_gstcc_if_bnd_n: 1,    //  11
    reg_soft_rst_f_teiopw_1_gstcc_if_bnd_n: 1,    //  12
    reg_soft_rst_f_teiopw_2_gstcc_if_bnd_n: 1,    //  13
    reg_soft_rst_f_teiopw_3_gstcc_if_bnd_n: 1,    //  14
    reg_soft_rst_f_teiopw_4_gstcc_if_bnd_n: 1,    //  15
    reg_soft_rst_f_teiopw_5_gstcc_if_bnd_n: 1,    //  16
    reg_soft_rst_gstcc_if_n   :  1,    //     17
    reg_soft_rst_p_te_0_axi_bnd_n: 1,    //   18
    reg_soft_rst_stpo_n       :  1,    //     19
    reg_soft_rst_te_n         :  1,    //     20
    reg_soft_rst_temcu_n      :  1,    //     21
    reg_soft_rst_x_te_0_axi_bnd_n: 1,    //   22
    reg_soft_rst_x_te_0_axi_n :  1,    //     23
                              :  8;    //  31:24 reserved
}SCRG_CTRL_TE_CRG_TE03_M23A0_T;

/*-----------------------------------------------------------------------------------------
    scrg_ctrl_te Register LIst
-----------------------------------------------------------------------------------------*/
typedef struct {
    SCRG_CTRL_TE_CRG_TE00_M23A0_T      crg_te00   ;             // 0xCED4_0000
    SCRG_CTRL_TE_CRG_TE01_M23A0_T      crg_te01   ;             // 0xCED4_0004
    SCRG_CTRL_TE_CRG_TE02_M23A0_T      crg_te02   ;             // 0xCED4_0008
    SCRG_CTRL_TE_CRG_TE03_M23A0_T      crg_te03   ;             // 0xCED4_000C
}SCRG_CTRL_TE_REG_M23A0_T;
/* 4 regs */
...
#define SCRG_CTRL_TE_CRG_TE00_M23A0_T_OFF                   (BASEADDRESS+0x0000)
#define SCRG_CTRL_TE_CRG_TE01_M23A0_T_OFF                   (BASEADDRESS+0x0004)
#define SCRG_CTRL_TE_CRG_TE02_M23A0_T_OFF                   (BASEADDRESS+0x0008)
#define SCRG_CTRL_TE_CRG_TE03_M23A0_T_OFF                   (BASEADDRESS+0x000C)
...
typedef union {
    ...
    UINT32 reg_soft_rst_f_teiopw_0_gstcc_if_bnd_n: 1;    //  11
    UINT32 reg_soft_rst_f_teiopw_1_gstcc_if_bnd_n: 1;    //  12
    UINT32 reg_soft_rst_f_teiopw_2_gstcc_if_bnd_n: 1;    //  13
    UINT32 reg_soft_rst_f_teiopw_3_gstcc_if_bnd_n: 1;    //  14
    UINT32 reg_soft_rst_f_teiopw_4_gstcc_if_bnd_n: 1;    //  15
    UINT32 reg_soft_rst_f_teiopw_5_gstcc_if_bnd_n: 1;    //  16
    UINT32 reg_soft_rst_gstcc_if_n: 1;    //  17
    UINT32 reg_soft_rst_p_te_0_axi_bnd_n: 1;    //  18
    UINT32 reg_soft_rst_stpo_n:  1;    //     19
    UINT32 reg_soft_rst_te_n  :  1;    //     20
    UINT32 reg_soft_rst_temcu_n: 1;    //     21
    UINT32 reg_soft_rst_x_te_0_axi_bnd_n: 1;    //  22
    UINT32 reg_soft_rst_x_te_0_axi_n: 1;    //  23
