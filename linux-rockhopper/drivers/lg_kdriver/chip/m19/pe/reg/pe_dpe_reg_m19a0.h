...
#ifndef _PE_DPE_REG_M19A0_H_
#define _PE_DPE_REG_M19A0_H_
...
}PE_M19_REG_LED_DECON_TOP_CTRL_T;
/*-----------------------------------------------------------------------------
...
}PE_M19_REG_LED_DECON_CTRL_10_T;
/*-----------------------------------------------------------------------------
...
}PE_M19_REG_LED_DECON_CTRL_11_T;
/*-----------------------------------------------------------------------------
...
}PE_M19_REG_LED_DECON_CTRL_12_T;
/*-----------------------------------------------------------------------------
...
}PE_M19_REG_LED_DECON_CTRL_13_T;
/*-----------------------------------------------------------------------------
...
}PE_M19_REG_LED_DECON_CTRL_14_T;
/*-----------------------------------------------------------------------------
...
}PE_M19_REG_LED_DECON_CTRL_15_T;
/*-----------------------------------------------------------------------------
...
}PE_M19_REG_LED_DECON_CTRL_16_T;
/*-----------------------------------------------------------------------------
...
}PE_M19_REG_LED_DECON_CTRL_17_T;
/*-----------------------------------------------------------------------------
...
}PE_M19_REG_LED_DECON_CTRL_18_T;
/*-----------------------------------------------------------------------------
...
}PE_M19_REG_LED_DECON_CTRL_19_T;
/*-----------------------------------------------------------------------------
...
}PE_M19_REG_LED_DECON_CTRL_20_T;
/*-----------------------------------------------------------------------------
...
}PE_M19_REG_LED_DECON_CTRL_21_T;
/*-----------------------------------------------------------------------------
...
}PE_M19_REG_LED_DECON_CTRL_22_T;
/*-----------------------------------------------------------------------------
...
}PE_M19_REG_LED_DECON_CTRL_23_T;
/*-----------------------------------------------------------------------------
...
typedef struct
{
	...
	vsync                              :16,	// 15:0
	vfp                                :16;	// 31:16
}PE_M19_REG_DEC_SYNC_2DLY_CTRL0_T;
/*-----------------------------------------------------------------------------
...
typedef struct
{
	...
	va                                 :16,	// 15:0
	vbp                                :16;	// 31:16
}PE_M19_REG_DEC_SYNC_2DLY_CTRL1_T;
/*-----------------------------------------------------------------------------
...
typedef struct
{
	...
	hsync                              :16,	// 15:0
	hfp                                :16;	// 31:16
}PE_M19_REG_DEC_SYNC_2DLY_CTRL2_T;
/*-----------------------------------------------------------------------------
...
typedef struct
{
	...
	ha                                 :16,	// 15:0
	hbp                                :16;	// 31:16
}PE_M19_REG_DEC_SYNC_2DLY_CTRL3_T;
/*-----------------------------------------------------------------------------
...
typedef struct
{
	...
	force_out_vs                       :1 ,	// 30
	update_force                       :1 ;	// 31
}PE_M19_REG_DEC_SYNC_2DLY_CTRL4_T;
/*-----------------------------------------------------------------------------
...
typedef struct
{
	...
	sync_h_dly                         :16,	// 15:0
	sync_v_dly                         :16;	// 31:16
}PE_M19_REG_DEC_SYNC_2DLY_CTRL5_T;
/*-----------------------------------------------------------------------------
...
}PE_M19_REG_DEC_SYNC_2DLY_CTRL6_T;
/*-----------------------------------------------------------------------------
...
}PE_M19_REG_DEC_SYNC_2DLY_CTRL7_T;
/*-----------------------------------------------------------------------------
...
}PE_M19_REG_DEC_SYNC_2DLY_CTRL8_T;
/*-----------------------------------------------------------------------------
...
}PE_M19_REG_DEC_SYNC_2DLY_CTRL9_T;
/*-----------------------------------------------------------------------------
...
}PE_M19_REG_DEC_SYNC_2DLY_CTRLA_T;
/*-----------------------------------------------------------------------------
...
typedef struct
{
	...
	vsync                              :16,	// 15:0
	vfp                                :16;	// 31:16
}PE_M19_REG_DEC_SYNC_3DLY_CTRL0_T;
/*-----------------------------------------------------------------------------
...
typedef struct
{
	...
	va                                 :16,	// 15:0
	vbp                                :16;	// 31:16
}PE_M19_REG_DEC_SYNC_3DLY_CTRL1_T;
/*-----------------------------------------------------------------------------
...
typedef struct
{
	...
	hsync                              :16,	// 15:0
	hfp                                :16;	// 31:16
}PE_M19_REG_DEC_SYNC_3DLY_CTRL2_T;
/*-----------------------------------------------------------------------------
...
typedef struct
{
	...
	ha                                 :16,	// 15:0
	hbp                                :16;	// 31:16
}PE_M19_REG_DEC_SYNC_3DLY_CTRL3_T;
/*-----------------------------------------------------------------------------
...
typedef struct
{
	...
	force_out_vs                       :1 ,	// 30
	update_force                       :1 ;	// 31
}PE_M19_REG_DEC_SYNC_3DLY_CTRL4_T;
/*-----------------------------------------------------------------------------
...
typedef struct
{
	...
	sync_h_dly                         :16,	// 15:0
	sync_v_dly                         :16;	// 31:16
}PE_M19_REG_DEC_SYNC_3DLY_CTRL5_T;
/*-----------------------------------------------------------------------------
...
typedef struct
{
	...
	manual_cnt_h_value                 :16,	// 15:0
	manual_cnt_v_value                 :16;	// 31:16
}PE_M19_REG_DEC_SYNC_3DLY_CTRL6_T;
/*-----------------------------------------------------------------------------
...
typedef struct
{
	UINT32
	reg_ctrl_sync_actv_dly_7;	// 31:0
}PE_M19_REG_DEC_SYNC_3DLY_CTRL7_T;
/*-----------------------------------------------------------------------------
...
typedef struct
{
	UINT32
	reg_ctrl_sync_actv_dly_8;	// 31:0
}PE_M19_REG_DEC_SYNC_3DLY_CTRL8_T;
/*-----------------------------------------------------------------------------
...
typedef struct
{
	UINT32
	reg_normal_number                  :16;	// 15:0
}PE_M19_REG_DEC_SYNC_3DLY_CTRL9_T;
/*-----------------------------------------------------------------------------
...
typedef struct
{
	...
	rst_pos_cnt_h                      :16,	// 15:0
	rst_pos_cnt_v                      :16;	// 31:16
}PE_M19_REG_DEC_SYNC_3DLY_CTRLA_T;
/*-----------------------------------------------------------------------------
...
}PE_M19_REG_LED_DECON_CTRL_24_T;
/*-----------------------------------------------------------------------------
...
}PE_M19_REG_LED_DECON_CTRL_25_T;
/*-----------------------------------------------------------------------------
...
}PE_M19_REG_LED_DECON_CTRL_26_T;
/*-----------------------------------------------------------------------------
...
typedef struct
{
	...
	reserved01                         :1 ,	// reserved
	reg_err_out_rd_simple_clip         :1 ;	// 31
}PE_M19_REG_LED_DECON_CTRL_27_T;
/*-----------------------------------------------------------------------------
...
}PE_M19_REG_LED_DECON_CTRL_28_T;
/*-----------------------------------------------------------------------------
...
}PE_M19_REG_LED_DECON_CTRL_29_T;
/*-----------------------------------------------------------------------------
...
}PE_M19_REG_LED_DECON_CTRL_30_T;
/*-----------------------------------------------------------------------------
...
}PE_M19_REG_LED_DECON_CTRL_31_T;
/*-----------------------------------------------------------------------------
...
}PE_M19_REG_LED_DECON_CTRL_32_T;
/*-----------------------------------------------------------------------------
...
}PE_M19_REG_LED_DECON_CTRL_33_T;
/*-----------------------------------------------------------------------------
...
}PE_M19_REG_LED_DECON_CTRL_34_T;
/*-----------------------------------------------------------------------------
...
}PE_M19_REG_LED_DECON_CTRL_35_T;
/*-----------------------------------------------------------------------------
...
}PE_M19_REG_LED_DECON_CTRL_36_T;
/*-----------------------------------------------------------------------------
...
}PE_M19_REG_LED_DECON_CTRL_37_T;
/*-----------------------------------------------------------------------------
...
}PE_M19_REG_LED_DECON_CTRL_38_T;
/*-----------------------------------------------------------------------------
...
}PE_M19_REG_LED_DECON_CTRL_39_T;
/*-----------------------------------------------------------------------------
...
}PE_M19_REG_LED_DECON_CTRL_40_T;
/*-----------------------------------------------------------------------------
...
typedef struct
{
	UINT32
	reg_rd_init_yy;	// 31:0
}PE_M19_REG_LED_DECON_CTRL_41_T;
/*-----------------------------------------------------------------------------
...
typedef struct
{
	UINT32
	reg_rd_init_cb;	// 31:0
}PE_M19_REG_LED_DECON_CTRL_42_T;
/*-----------------------------------------------------------------------------
...
typedef struct
{
	UINT32
	reg_rd_init_cr;	// 31:0
}PE_M19_REG_LED_DECON_CTRL_43_T;
/*-----------------------------------------------------------------------------
...
}PE_M19_REG_LED_DECON_CTRL_44_T;
/*-----------------------------------------------------------------------------
...
}PE_M19_REG_LED_DECON_CTRL_45_T;
/*-----------------------------------------------------------------------------
...
}PE_M19_REG_LED_DECON_CTRL_46_T;
/*-----------------------------------------------------------------------------
...
}PE_M19_REG_LED_DECON_CTRL_47_T;
/*-----------------------------------------------------------------------------
...
}PE_M19_REG_LED_DECON_CTRL_48_T;
/*-----------------------------------------------------------------------------
...
}PE_M19_REG_LED_DECON_CTRL_49_T;
/*-----------------------------------------------------------------------------
...
}PE_M19_REG_LED_DECON_CTRL_50_T;
/*-----------------------------------------------------------------------------
...
}PE_M19_REG_LED_DECON_CTRL_51_T;
/*-----------------------------------------------------------------------------
...
}PE_M19_REG_LED_DECON_CTRL_52_T;
/*-----------------------------------------------------------------------------
...
}PE_M19_REG_LED_DECON_CTRL_53_T;
/*-----------------------------------------------------------------------------
...
}PE_M19_REG_LED_DECON_CTRL_54_T;
/*-----------------------------------------------------------------------------
...
}PE_M19_REG_LED_DECON_CTRL_55_T;
/*-----------------------------------------------------------------------------
...
}PE_M19_REG_LED_DECON_CTRL_56_T;
/*-----------------------------------------------------------------------------
...
}PE_M19_REG_LED_DECON_CTRL_57_T;
/*-----------------------------------------------------------------------------
...
}PE_M19_REG_LED_DECON_CTRL_58_T;
/*-----------------------------------------------------------------------------
...
typedef struct
{
	...
	reserved01                         :1 ,	// reserved
	reg_444_mode                       :1 ;	// 31
}PE_M19_REG_LED_DECON_CTRL_59_T;
/*-----------------------------------------------------------------------------
...
}PE_M19_REG_LED_DECON_CTRL_60_T;
/*-----------------------------------------------------------------------------
...
}PE_M19_REG_LED_DECON_CTRL_61_T;
/*-----------------------------------------------------------------------------
...
}PE_M19_REG_LED_DECON_CTRL_62_T;
/*-----------------------------------------------------------------------------
...
}PE_M19_REG_LED_DECON_CTRL_63_T;
/*-----------------------------------------------------------------------------
...
}PE_M19_REG_LED_DECON_CTRL_64_T;
/*-----------------------------------------------------------------------------
...
}PE_M19_REG_LED_DECON_CTRL_65_T;
/*-----------------------------------------------------------------------------
...
}PE_M19_REG_LED_DECON_CTRL_66_T;
/*-----------------------------------------------------------------------------
...
}PE_M19_REG_LED_DECON_CTRL_67_T;
/*-----------------------------------------------------------------------------
...
}PE_M19_REG_LED_DECON_CTRL_68_T;
/*-----------------------------------------------------------------------------
...
}PE_M19_REG_LED_DECON_CTRL_69_T;
/*-----------------------------------------------------------------------------
...
}PE_M19_REG_LED_DECON_CTRL_70_T;
/*-----------------------------------------------------------------------------
...
}PE_M19_REG_LED_DECON_CTRL_71_T;
/*-----------------------------------------------------------------------------
...
}PE_M19_REG_LED_DECON_CTRL_72_T;
#endif
typedef struct {
	PE_LED_M19_AD_RP_HV_POS_T            	ad_rp_hv_pos;                 //0xc8020540L
	PE_LED_M19_AD_RP_MAKE_EN_T           	ad_rp_make_en;                //0xc8020544L
	PE_LED_M19_AD_RP_R_VALUE_T           	ad_rp_r_value;                //0xc8020548L
	PE_LED_M19_AD_RP_G_VALUE_T           	ad_rp_g_value;                //0xc802054cL
	PE_LED_M19_AD_RP_B_VALUE_T           	ad_rp_b_value;                //0xc8020550L
}PE_LED_RP_REG_M19_T;
#if 0
typedef struct
{ 
	PE_M19_REG_LED_DECON_TOP_CTRL_T                       reg_decon_top_ctrl;	//0x0000
	...
	PE_M19_REG_DEC_SYNC_2DLY_CTRL0_T                  reg_dec_sync_2dly_ctrl0;	//0x0064
	PE_M19_REG_DEC_SYNC_2DLY_CTRL1_T                  reg_dec_sync_2dly_ctrl1;	//0x0068
	PE_M19_REG_DEC_SYNC_2DLY_CTRL2_T                  reg_dec_sync_2dly_ctrl2;	//0x006C
	PE_M19_REG_DEC_SYNC_2DLY_CTRL3_T                  reg_dec_sync_2dly_ctrl3;	//0x0070
	PE_M19_REG_DEC_SYNC_2DLY_CTRL4_T                  reg_dec_sync_2dly_ctrl4;	//0x0074
	PE_M19_REG_DEC_SYNC_2DLY_CTRL5_T                  reg_dec_sync_2dly_ctrl5;	//0x0078
	PE_M19_REG_DEC_SYNC_2DLY_CTRL6_T                  reg_dec_sync_2dly_ctrl6;	//0x007C
	PE_M19_REG_DEC_SYNC_2DLY_CTRL7_T                  reg_dec_sync_2dly_ctrl7;	//0x0080
	PE_M19_REG_DEC_SYNC_2DLY_CTRL8_T                  reg_dec_sync_2dly_ctrl8;	//0x0084
	PE_M19_REG_DEC_SYNC_2DLY_CTRL9_T                  reg_dec_sync_2dly_ctrl9;	//0x0088
	PE_M19_REG_DEC_SYNC_2DLY_CTRLA_T                  reg_dec_sync_2dly_ctrla;	//0x008C
	PE_M19_REG_DEC_SYNC_3DLY_CTRL0_T                  reg_dec_sync_3dly_ctrl0;	//0x0090
	PE_M19_REG_DEC_SYNC_3DLY_CTRL1_T                  reg_dec_sync_3dly_ctrl1;	//0x0094
	PE_M19_REG_DEC_SYNC_3DLY_CTRL2_T                  reg_dec_sync_3dly_ctrl2;	//0x0098
	PE_M19_REG_DEC_SYNC_3DLY_CTRL3_T                  reg_dec_sync_3dly_ctrl3;	//0x009C
	PE_M19_REG_DEC_SYNC_3DLY_CTRL4_T                  reg_dec_sync_3dly_ctrl4;	//0x00A0
	PE_M19_REG_DEC_SYNC_3DLY_CTRL5_T                  reg_dec_sync_3dly_ctrl5;	//0x00A4
	PE_M19_REG_DEC_SYNC_3DLY_CTRL6_T                  reg_dec_sync_3dly_ctrl6;	//0x00A8
	PE_M19_REG_DEC_SYNC_3DLY_CTRL7_T                  reg_dec_sync_3dly_ctrl7;	//0x00AC
	PE_M19_REG_DEC_SYNC_3DLY_CTRL8_T                  reg_dec_sync_3dly_ctrl8;	//0x00B0
	PE_M19_REG_DEC_SYNC_3DLY_CTRL9_T                  reg_dec_sync_3dly_ctrl9;	//0x00B4
	PE_M19_REG_DEC_SYNC_3DLY_CTRLA_T                  reg_dec_sync_3dly_ctrla;	//0x00B8
