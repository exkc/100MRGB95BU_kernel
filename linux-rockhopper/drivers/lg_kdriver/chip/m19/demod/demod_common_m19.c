...
UINT8 gM19GBB_PowerOnInit = 1;
LX_DEMOD_L2_Context gM19_LGDBB_Frontend;
...
void __DEMOD_M19_reset(void)
{
	...
	CTOP_CTRL_M19Ax_RdFL(CTOP_BMC, dmdmip_03);
	CTOP_CTRL_M19Ax_Wr01(CTOP_BMC, dmdmip_03, reg_dmd_tadc_pdb, 0);
	CTOP_CTRL_M19Ax_WrFL(CTOP_BMC, dmdmip_03);

//	printk("######[__DEMOD_M19_reset] reg_dmd_tadc_pdb to 0 ##### !!!!!!!!!!!!!!!!!!!!!!!\n");

	DEMOD_L2_Set_SoftRst(pFrontend, 1, 0, 0, 0, 0, 0, 0);

	usleep_range(10000,11000);	/* 1ms ~ 2ms */	
//	printk("######[__DEMOD_M19_reset] DEMOD_L2_Set_SoftRst Done ##### !!!!!!!!!!!!!!!!!!!!!!!\n");

	DEMOD_APB_REG_WR(0xC910A404, 0x00000001);	// MCU stall	
	usleep_range(1000,2000);	/* 1ms ~ 2ms */	
	
//	printk("######[__DEMOD_M19_reset] MCU stall Done ##### !!!!!!!!!!!!!!!!!!!!!!!\n");
	DEMOD_APB_REG_WR(0xC930E4a0, 0x00010000); // MCU reset
	usleep_range(1000,2000);	/* 1ms ~ 2ms */	
	
//	printk("######[__DEMOD_M19_reset] MCU reset Done ##### !!!!!!!!!!!!!!!!!!!!!!!\n");
	DEMOD_APB_REG_WR(0xC930E4a0, 0x00110000); // MCU release
	usleep_range(1000,2000);	/* 1ms ~ 2ms */	
	
//	printk("######[__DEMOD_M19_reset] MCU release Done ##### !!!!!!!!!!!!!!!!!!!!!!!\n");
//	DEMOD_APB_REG_WR(0xC9105000, 0x7c355555); // SW reset
//	usleep_range(1000,2000);	/* 1ms ~ 2ms */	
	DEMOD_APB_REG_WR(0xC930E4a0, 0x00111000); // Reg Init
	usleep_range(1000,2000);	/* 1ms ~ 2ms */	
	
//	printk("######[__DEMOD_M19_reset] Reg Init Done ##### !!!!!!!!!!!!!!!!!!!!!!!\n");
	DEMOD_APB_REG_WR(0xC930E4a0, 0x00110000); // Reg Init release
	
//	printk("######[__DEMOD_M19_reset] Reg Init release ##### !!!!!!!!!!!!!!!!!!!!!!!\n");
}

/***********************************************************************************
************************************************************************************/
/**
 * _DEMOD_M19_Get_Lock_FEC
...
*/
int _DEMOD_M19_Get_Lock_FEC( LX_DEMOD_OPER_MODE_T operMode, UINT8 *lockStatus)
{
	*lockStatus = 0;
 ...
 * @author 	Jeongpil.yun (jeongpil.yun@lge.com)
*/
int _DEMOD_M19_Get_Lock_TR( LX_DEMOD_OPER_MODE_T operMode, UINT8 *lockStatus)
{
	*lockStatus = 0;
 ...
 * @author 	Jeongpil.yun (jeongpil.yun@lge.com)
*/
int _DEMOD_M19_Get_Lock_CARR( LX_DEMOD_OPER_MODE_T operMode, UINT8 *lockStatus)
{
	*lockStatus = 0;
 ...
 * @author 	Jeongpil.yun (jeongpil.yun@lge.com)
*/
int _DEMOD_M19_Get_Lock_PSYNC( LX_DEMOD_OPER_MODE_T operMode, UINT8 *lockStatus)
{
	*lockStatus = 0;
 ...
 * @author 	Jeongpil.yun (jeongpil.yun@lge.com)
*/
int _DEMOD_M19_Get_Lock_TPS( LX_DEMOD_OPER_MODE_T operMode, UINT8 *lockStatus)
{
	*lockStatus = 0;
 ...
 * @author 	Jeongpil.yun (jeongpil.yun@lge.com)
*/
int _DEMOD_M19_Get_Lock_AGC( LX_DEMOD_OPER_MODE_T operMode, UINT8 *lockStatus)
{
	*lockStatus = 0;
 ...
 * @author 	Jeongpil.yun (jeongpil.yun@lge.com)
*/
int _DEMOD_M19_Get_Lock_Mode_Det( LX_DEMOD_OPER_MODE_T operMode, UINT8 *lockStatus)
{
	*lockStatus = 0;
...
int DEMOD_M19_ResetHW(void)
{
	UINT32	swrst_f24m;
//	UINT8	reg_dmd_adc_refsel = 0x04;
	...
	CTOP_CTRL_M19Ax_WrFL(CTOP_BMC, dmdmip_03);
#if 0
	CTOP_CTRL_M19Ax_RdFL(CTOP_BMC, dbb_00);
	CTOP_CTRL_M19Ax_Wr01(CTOP_BMC, dbb_00, reg_dbb_reset, 1);
	CTOP_CTRL_M19Ax_WrFL(CTOP_BMC, dbb_00);

//	ACE_REG_M19A0_RdFL(dbb_00);
//	ACE_REG_M19A0_Wr01(dbb_00, dbb_reset, 1);
//	ACE_REG_M19A0_WrFL(dbb_00);

	usleep_range(1000,10000);	/* 1ms ~ 10ms */

	CTOP_CTRL_M19Ax_RdFL(CTOP_BMC, dbb_00);
	CTOP_CTRL_M19Ax_Wr01(CTOP_BMC, dbb_00, reg_dbb_reset, 0);
	CTOP_CTRL_M19Ax_WrFL(CTOP_BMC, dbb_00);

//	ACE_REG_M19A0_RdFL(dbb_00);
//	ACE_REG_M19A0_Wr01(dbb_00, dbb_reset, 0);
//	ACE_REG_M19A0_WrFL(dbb_00);
...
//	ACE_REG_M19A0_WrFL(dbb_00);
	...
	DEMOD_APB_REG_WR(0xC930E4a0, 0x00110000); // HW release
	usleep_range(1000,2000);	/* 1ms ~ 2ms */ 
	DEMOD_PRINT_ALWAYS("##### DEMOD_M19_ResetHW() HW reset release #####\n");

	DEMOD_APB_REG_WR(0xC9105000, 0x7E355555); // SYNC1 Reset to 0
	usleep_range(2000,3000);	/* 1ms ~ 2ms */ 
	DEMOD_PRINT_ALWAYS("##### DEMOD_M19_ResetHW() SYNC1 Reset to 0 Done #####\n");
		
	DEMOD_APB_REG_WR(0xC930E4a0, 0x00100000); // HW reset
	usleep_range(2000,3000);	/* 1ms ~ 2ms */ 
	DEMOD_PRINT_ALWAYS("##### DEMOD_M19_ResetHW() HW reset Done #####\n");

	DEMOD_APB_REG_WR(0xC930E4a0, 0x00110000); // HW release
	usleep_range(1000,2000);	/* 1ms ~ 2ms */ 
	DEMOD_PRINT_ALWAYS("##### DEMOD_M19_ResetHW() HW reset release #####\n");

	DEMOD_APB_REG_WR(0xC9105010, 0x2f40082d); // Internal CLK Gating ON
	usleep_range(1000,2000);	/* 1ms ~ 2ms */ 

	DEMOD_PRINT_ALWAYS("##### DEMOD_M19_ResetHW() Internal CLK Gating ON #####\n");

	DEMOD_APB_REG_WR(0xC9105000, 0xFE355555); // SYNC1 Reset to 1
	usleep_range(1000,2000);	/* 1ms ~ 2ms */ 

	DEMOD_PRINT_ALWAYS("##### DEMOD_M19_ResetHW() SYNC1 Reset to 1 #####\n");

	DEMOD_APB_REG_WR(0xC9105010, 0x2f40882d); // Internal CLK Gating OFF
	usleep_range(1000,2000);	/* 1ms ~ 2ms */ 

	DEMOD_PRINT_ALWAYS("##### DEMOD_M19_ResetHW() Internal CLK Gating OFF #####\n");
#endif

#if 1
//#ifdef INCLUDE_M19_CHIP_KDRV // For debugging
/////////////////////////////////////////////////////
	CTOP_CTRL_M19Ax_RdFL(BMC_SYN, bmc_ctr01);
	CTOP_CTRL_M19Ax_Rd01(BMC_SYN, bmc_ctr01, swrst_f24m, swrst_f24m);
...
int DEMOD_M19_OperModeReset(LX_DEMOD_OPER_MODE_T operMode)
{
#if 0
//	UINT32		swrst_f24m;
 ...
 * @author 	Jeongpil.yun (jeongpil.yun@lge.com)
*/
int DEMOD_M19_SetI2C(void)
{

#if 0
	DEMOD_PRINT("[KDRV_DEMOD] DEMOD_M19_SetI2C Start !! \n");

	ACE_REG_M19A0_RdFL(dbb_00);

	ACE_REG_M19A0_Wr01(dbb_00, dbb_i2csel, 0);

	ACE_REG_M19A0_WrFL(dbb_00);

	DEMOD_PRINT("[KDRV_DEMOD] DEMOD_M19_SetI2C end !! \n");
...
int DEMOD_M19_SetInclk(LX_DEMOD_INCLK_SEL_T *inclk)
{
#ifdef INCLUDE_M19_CHIP_KDRV
	DEMOD_PRINT("[KDRV_DEMOD] DEMOD_M19_SetInclk Start !! \n");

	CTOP_CTRL_M19Ax_RdFL(CTOP_BMC, dmdmip_01);

	switch(*inclk)
	{
		case LX_DEMOD_ARM_SETTING:
		{
			CTOP_CTRL_M19Ax_Wr01(CTOP_BMC, dmdmip_01, reg_dmd_pll_finsel, 0);
		}
		break;

		case LX_DEMOD_EXTERN_PIN:
		{
			CTOP_CTRL_M19Ax_Wr01(CTOP_BMC, dmdmip_01, reg_dmd_pll_finsel, 1);
		}
		break;
	...
	CTOP_CTRL_M19Ax_WrFL(CTOP_BMC, dmdmip_01);

	DEMOD_PRINT("[KDRV_DEMOD] DEMOD_M19_SetInclk End !! \n");
 ...
 * @author 	Jeongpil.yun (jeongpil.yun@lge.com)
*/
int DEMOD_M19_AdcInit(void)
{
#ifdef INCLUDE_M19_CHIP_KDRV
	DEMOD_PRINT("[KDRV_DEMOD] DEMOD_M19_AdcInit Start !! \n");

	CTOP_CTRL_M19Ax_RdFL(CTOP_BMC, dmdmip_00);
	CTOP_CTRL_M19Ax_Wr01(CTOP_BMC, dmdmip_00, reg_dmd_pll_pdb, 1);
	CTOP_CTRL_M19Ax_WrFL(CTOP_BMC, dmdmip_00);

	#if 1
	// ADC reference voltage selection
	// (000: 0.6Vpp, 001: 0.8Vpp, 010: 1.0Vpp, 011: 1.2Vpp, 100: 1.4Vpp, 101: 1.6Vpp, 110: 1.8Vpp, 111: 2.0Vpp)
	//	default: T2(100), S2(000)
	CTOP_CTRL_M19Ax_RdFL(CTOP_BMC, dmdmip_02);
	CTOP_CTRL_M19Ax_Wr01(CTOP_BMC, dmdmip_02, reg_dmd_adc_refsel, 4);
	CTOP_CTRL_M19Ax_WrFL(CTOP_BMC, dmdmip_02);
	#endif

	DEMOD_PRINT("[KDRV_DEMOD] DEMOD_M19_AdcInit end !! \n");
 ...
 * @author 	Jeongpil.yun (jeongpil.yun@lge.com)
*/
int DEMOD_M19_RepeaterEnable(BOOLEAN bEnable)
{
	UINT16 	address;
	UINT8 	rdBuffer;
	UINT8 	wrBuffer;

	DEMOD_PRINT("before[DEMOD M19]   DEMOD_M19_RepeaterEnable  ###### chungiii \n");
	...
	{
		DEMOD_PRINT("[M19 DBB I2C] FAIL (%s:%d) DEMOD_I2C_Read  !!!\n", __F__, __L__);
		return RET_ERROR;
	}
	else
	{
 ...
 * @author 	Jeongpil.yun (jeongpil.yun@lge.com)
*/
int DEMOD_M19_SoftwareReset(void)
{
	LX_DEMOD_L2_Context *pFrontend;
	pFrontend = &gM19_LGDBB_Frontend;
	...
	{
		DEMOD_PRINT("[DEMOD M19] FAIL (%s:%d) DEMOD_L1_SET_DD_Restart() !!!\n", __F__, __L__);
		return RET_ERROR;
	}
	DEMOD_PRINT("[M19 LGDBB] (%s:%d) DEMOD_L1_SET_DD_Restart OK!!!! \n", __F__, __L__);
 ...
 * @author 	Jeongpil.yun (jeongpil.yun@lge.com)
*/
int DEMOD_M19_Serial_Control(BOOLEAN bEnable)
{
	return	RET_OK;
}
...
int DEMOD_M19_Power_Save(BOOLEAN bEnable)
{
	LX_DEMOD_L2_Context *pFrontend;
	pFrontend = &gM19_LGDBB_Frontend;
	
//	DEMOD_PRINT_ALWAYS("DEMOD_M19_Power_Save Start \n");

	if(bEnable == TRUE)
	{	
		CTOP_CTRL_M19Ax_RdFL(CTOP_BMC, dmdmip_02);
		CTOP_CTRL_M19Ax_Wr01(CTOP_BMC, dmdmip_02, reg_dmd_bias_pdb, 0);
		CTOP_CTRL_M19Ax_WrFL(CTOP_BMC, dmdmip_02);
...
//		usleep_range(1000,2000);	/* 1ms ~ 2ms */	
		...
		{
			DEMOD_PRINT("[M19 LGDBB] (%s:%d) DEMOD_L2_Standby  Fail!! \n", __F__, __L__);
	...
	else
	{
		...
		{
			DEMOD_PRINT("[M19 LGDBB] (%s:%d) DEMOD_L2_WakeUp  Fail!! \n", __F__, __L__);
			DEMOD_RETURN_FAIL(__F__);
		}
...
//		usleep_range(1000,2000);	/* 1ms ~ 2ms */	
		...
		CTOP_CTRL_M19Ax_RdFL(CTOP_BMC, dmdmip_02);
		CTOP_CTRL_M19Ax_Wr01(CTOP_BMC, dmdmip_02, reg_dmd_bias_pdb, 1);
		CTOP_CTRL_M19Ax_WrFL(CTOP_BMC, dmdmip_02);
	}

//	DEMOD_PRINT_ALWAYS("DEMOD_M19_Power_Save End \n");
 ...
 * @author 	Jeongpil.yun (jeongpil.yun@lge.com)
*/
int DEMOD_M19_StdOperModeContrl( LX_DEMOD_OPER_MODE_T operMode, LX_DEMOD_BWMODE_T bandWd, LX_DEMOD_SYMRDET_MODE_T symbr)
{
	...
	if(operMode == LX_DEMOD_DVBT ||operMode == LX_DEMOD_DVBT2 ||operMode == LX_DEMOD_DVBS || operMode == LX_DEMOD_DVBS2)
	{
		...
		{
		  DEMOD_PRINT("[DEMOD] FAIL (%s:%d) FAIL, DEMOD_DVB_Set_MemSconfig() !!!\n", __F__, __L__);
		  DEMOD_RETURN_FAIL(__F__);
		}
	}
	...
	switch(operMode)
	{
		...
		case LX_DEMOD_DVBS2:
			 ...
			 //124MHz 496MHz
			 reg_dmd_pll_mc 	= 0x3E; //96/384 = 30
			 reg_dmd_pll_d_odiv = 0x2;
			 reg_dmd_pll_ort	= 0x1;
			 reg_dmd_pll_d_oen	= 0x3;

			 reg_dmd_adc_refsel = 0x0;
		...
		default :
			DEMOD_PRINT_ALWAYS("[DEMOD M19](%s,%d) Invaild Opermode parameter !!!\n",__F__, __L__);
			return RET_ERROR;
	}
...
#if 1
	CTOP_CTRL_M19Ax_RdFL(CTOP_BMC, dmdmip_02);
	CTOP_CTRL_M19Ax_Wr01(CTOP_BMC, dmdmip_02, reg_dmd_adc_refsel, reg_dmd_adc_refsel);
	CTOP_CTRL_M19Ax_WrFL(CTOP_BMC, dmdmip_02);

	CTOP_CTRL_M19Ax_RdFL(CTOP_BMC, dmdmip_00);
	CTOP_CTRL_M19Ax_Wr01(CTOP_BMC, dmdmip_00, reg_dmd_pll_mc, reg_dmd_pll_mc);
	CTOP_CTRL_M19Ax_Wr01(CTOP_BMC, dmdmip_00, reg_dmd_pll_d_odiv, reg_dmd_pll_d_odiv);
	CTOP_CTRL_M19Ax_Wr01(CTOP_BMC, dmdmip_00, reg_dmd_pll_ort, reg_dmd_pll_ort);
	CTOP_CTRL_M19Ax_Wr01(CTOP_BMC, dmdmip_00, reg_dmd_pll_d_oen, reg_dmd_pll_d_oen);
	CTOP_CTRL_M19Ax_WrFL(CTOP_BMC, dmdmip_00);

	CTOP_CTRL_M19Ax_RdFL(CTOP_BMC, dmdmip_03);
	CTOP_CTRL_M19Ax_Wr03(CTOP_BMC, dmdmip_03, reg_dmd_sadc_q_pdb, reg_dmd_sadc_q_pdb, reg_dmd_sadc_i_pdb, reg_dmd_sadc_i_pdb, reg_dmd_tadc_pdb, reg_dmd_tadc_pdb);
	CTOP_CTRL_M19Ax_WrFL(CTOP_BMC, dmdmip_03);
#endif
/*
	if(RET_OK != DEMOD_L2_Switch_to_standard(pFrontend,new_standard))
	{
		DEMOD_PRINT("[M19 LGDBB] FAIL (%s:%d) DEMOD_L2_Switch_to_standard !!!\n", __F__, __L__);
		return RET_ERROR;
	}
*/
//	usleep_range(20000,30000);	/* 1ms ~ 10ms */
 ...
 * @author 	Jeongpil.yun(jeongpil.yun@lge.com)
*/
int DEMOD_M19_NeverlockScan(DEMOD_CTX_T *pDemodInfo, LX_DEMOD_FLAG_T ResetOn, LX_DEMOD_FLAG_T *pScanProcessing, LX_DEMOD_LOCK_STATE_T *pScanLock)
{
...
//				_maxTimeOut = LX_DEMOD_LOCK_DEALY_600;
	...
	if (RET_OK != DEMOD_M19_Get_NeverLockStatus(scanMode, &neverLockStatus))
	{
		DEMOD_PRINT("^r^[M19_DVB DTV] FAIL (%s:%d) KADP_DEMOD_VQI_ChanScan_GetStatus() !!!\n", __F__, __L__);
		*pScanLock	= LX_DEMOD_UNLOCKED;
		return RET_ERROR;
	}
		...
		case LX_DEMOD_DETECTION_PROCESSING:
			{
				...
				if(elapsedTime > _maxTimeOut)
				{
					*pScanProcessing	= LX_DEMOD_FLAG_FINISH;
					...
					DEMOD_PRINT( "[DEMOD M19] NEVERSCAN : LX_DEMOD_NEVERLOCK DETECTION is on processing \n");
				}
			}
			break;
		...
		case LX_DEMOD_DETECTION_FAIL:
			{
				*pScanProcessing	= LX_DEMOD_FLAG_FINISH;
				_demodScanLock		= LX_DEMOD_UNLOCKED;
				DEMOD_PRINT( "[DEMOD M19] NEVERSCAN :  LX_DEMOD_NEVERLOCK DETECTION FAIL  \n");
			}
			break;
		...
		case LX_DEMOD_DETECTED:
			{
				*pScanProcessing	= LX_DEMOD_FLAG_FINISH;
				...
				DEMOD_PRINT( "[DEMOD M19] NEVERSCAN :  LX_DEMOD_NEVERLOCK DETECTED	!! \n");

			}
			break;
		default:
			_demodScanLock	= LX_DEMOD_UNLOCKED;
			DEMOD_PRINT( "[DEMOD M19] NEVERSCAN :  LX_DEMOD_UNLOCKED(%d)	!! \n",neverLockStatus);
			break;
	}
 ...
 * @author 	Jeongpil.yun (jeongpil.yun@lge.com)
*/
int DEMOD_M19_TPOutEnable(BOOLEAN bEnable)
{
	...
	{
		DEMOD_PRINT("[M19 LGDBB] (%s:%d) DEMOD_L2_Set_Property  Fail!! \n", __F__, __L__);
		DEMOD_RETURN_FAIL(__F__);
	}
 ...
 * @author 	Jeongpil.yun (jeongpil.yun@lge.com)
*/
int DEMOD_M19_Set_IF_Frq(UINT32 ifFrq)
{
#if 1
	LX_DEMOD_L2_Context *pFrontend;
	pFrontend = &gM19_LGDBB_Frontend;
 ...
 * @author 	Jeongpil.yun (jeongpil.yun@lge.com)
*/
int DEMOD_M19_Set_AGCPolarity(LX_DEMOD_AGC_POLAR_T agcPola)
{
	LX_DEMOD_L2_Context *pFrontend;
	pFrontend = &gM19_LGDBB_Frontend;
	...
	if(agcPola == LX_DEMOD_AGC_ACTIVE_HIGH)
	{
		...
		DEMOD_PRINT("[M19 LGDBB] (%s:%d) LX_DEMOD_AGC_ACTIVE_HIGH \n", __F__, __L__);
	}
	else
	{
		pFrontend->demod->prop->dd_agc.agc_pol  = DEMOD_DD_AGC_PROP_POLARITY_INVERSION;;
		DEMOD_PRINT("[M19 LGDBB] (%s:%d) DEMOD_DD_AGC_PROP_POLARITY_INVERSION \n", __F__, __L__);
	}

	if (DEMOD_L2_Set_Property(pFrontend, DEMOD_DD_AGC_PROP_CODE ) != NO_DEMOD_ERROR)
	{
		DEMOD_PRINT_ALWAYS("[M19 LGDBB] (%s:%d) DEMOD_DD_AGC_PROP_CODE  Fail!! \n", __F__, __L__);
		DEMOD_RETURN_FAIL(__F__);
 ...
 * @author 	Jeongpil.yun (jeongpil.yun@lge.com)
*/
int DEMOD_M19_Set_SpectrumCtrl(BOOLEAN bAutoEnable, BOOLEAN bSpecInvEnable)
{
	return RET_OK;
}
/***********************************************************************************
 ...
 * @author 	Jeongpil.yun (jeongpil.yun@lge.com)
*/
int DEMOD_M19_Get_Id(UINT8 *pCellIDLength, UINT16 *pId)
{
	LX_DEMOD_L2_Context 		*pFrontend;
...
************************************************************************************/
/**
 * DEMOD_M19_Get_SpectrumInvStatus
 ...
 * @author 	Jeongpil.yun (jeongpil.yun@lge.com)
*/
int DEMOD_M19_Get_SpectrumStatus(LX_DEMOD_LOCK_STATE_T *pSpectrumAuto, LX_DEMOD_LOCK_STATE_T *pSpectrumInv)
{
	LX_DEMOD_L2_Context 		*pFrontend;
	LX_DEMOD_L2_SIG_STATUS		signalStatus;
 ...
 * @author 	Jeongpil.yun (jeongpil.yun@lge.com)
*/
int DEMOD_M19_Get_IFAGC(UINT16 *pIfAgc)
{
	LX_DEMOD_L2_Context 		*pFrontend;
	LX_DEMOD_L2_SIG_STATUS		signalStatus;
 ...
 * @author 	Jeongpil.yun (jeongpil.yun@lge.com)
*/
int DEMOD_M19_Get_OperMode(LX_DEMOD_OPER_MODE_T *pOperMode)
{
	LX_DEMOD_L2_Context 		*pFrontend;
	...
	//printk("#################################   before  check DEMOD_M19_Get_OperMode reply opmode [%d]\n", reply_opmode);
...
/*
	switch (pFrontend->demod->rsp->dd_status.reply_operMod)
	{
		...
		default :
			DEMOD_PRINT_ALWAYS("[DEMOD M19](%s,%d) LX_DEMOD_UNKNOWN_OPMODE!!!value : %02x\n",__F__, __L__, pFrontend->demod->rsp->dd_status.reply_operMod);
			return RET_ERROR;

	}
*/
	DEMOD_PRINT("[DEMOD M19](%s,%d) OPmode !!!value : %02x\n",__F__, __L__, reply_opmode);

	*pOperMode = reply_opmode;
	//printk("######check DEMOD_M19_Get_OperMode reply opmode [%d]\n", reply_opmode);
 ...
 * @author 	Jeongpil.yun (jeongpil.yun@lge.com)
*/
int DEMOD_M19_Get_NeverLockStatus(LX_DEMOD_OPER_MODE_T scanMode, LX_DEMOD_LOCK_STATE_T *pNeverLockStatus)
{
	LX_DEMOD_L2_Context 	*pFrontend;
	UINT8 					neverlock;
...
************************************************************************************/
/**
 * DEMOD_M19_Get_CarrierFreqOffset
 ...
 * @author 	Jeongpil.yun (jeongpil.yun@lge.com)
*/
int DEMOD_M19_Get_CarrierFreqOffset(SINT32 *pFreqOff)
{
	LX_DEMOD_L2_SIG_STATUS 	signalStatus;
	LX_DEMOD_L2_Context 		*pFrontend;
	SINT32						freqOffset;
...
//	DEMOD_PRINT("[M19 LGDBB] (freqOffset: %d) \n", freqOffset);
	...
	*pFreqOff = carrierOffset;
	...
	DEMOD_PRINT("[DEMOD M19] Carrier Offset freq = %d [KHz] !!!\n",*pFreqOff);
 ...
 * @author 	Jeongpil.yun (jeongpil.yun@lge.com)
*/
int DEMOD_M19_Get_TPIFStatus(BOOLEAN *pbEnable)
{
	*pbEnable = TRUE;
 ...
 * @author 	Jeongpil.yun (jeongpil.yun@lge.com)
*/
int DEMOD_M19_Get_VABER(UINT32 *pVber)
{
	LX_DEMOD_L2_SIG_STATUS 	signalStatus;
	LX_DEMOD_L2_Context 	*pFrontend;
	pFrontend = &gM19_LGDBB_Frontend;
 ...
 * @author 	Jeongpil.yun (jeongpil.yun@lge.com)
*/
int DEMOD_M19_Get_Packet_Error(UINT32 *pError)
{
	LX_DEMOD_L2_Context 		*pFrontend;
	LX_DEMOD_L2_SIG_STATUS		signalStatus;
	...
	//printk("#################################   before  check DEMOD_M19_Get_Packet_Error\n");
	...
	*pError = signalStatus.packetError;
	...
	DEMOD_PRINT(" [M19 LGDBB] DEMOD_M19_Get_Packet_Error *pError = %d  \n",*pError);
 ...
 * @author 	Jeongpil.yun (jeongpil.yun@lge.com)
*/
int DEMOD_M19_Get_BandWidthMode( LX_DEMOD_BWMODE_T *ChannelBW )
{
	LX_DEMOD_L2_Context 		*pFrontend;
	LX_DEMOD_L2_SIG_STATUS		signalStatus;
 ...
 * @author 	Jeongpil.yun (jeongpil.yun@lge.com)
*/
int DEMOD_M19_Get_QAMMode( LX_DEMOD_RF_MODE_T *pQamMode )
{
	LX_DEMOD_L2_Context 		*pFrontend;
	LX_DEMOD_L2_SIG_STATUS		signalStatus;
	...
	pFrontend = &gM19_LGDBB_Frontend;
/*
	if(RET_OK != DEMOD_M19_Get_OperMode(&mode))
	{
...
*/
	...
	switch (pFrontend->demod->rsp->dd_status.reply_operMod)
	{
		...
		default :
			DEMOD_PRINT_ALWAYS("[DEMOD M19](%s,%d) LX_DEMOD_UNKOWN_OPMODE!!!\n",__F__, __L__);
			return RET_ERROR;
	}
	...
	switch(mode)
	{
		...
		default :
			DEMOD_PRINT("[DEMOD M19] FAIL,(%s:%d) UNKNOWN RF MODE !!!\n", __F__, __L__);
			return RET_ERROR;
 ...
 * @author 	Jeongpil.yun (jeongpil.yun@lge.com)
*/
int DEMOD_M19_Get_MseInfo( LX_DEMOD_MSE_T *pSigMse)
{
 ...
 * @author 	Jeongpil.yun (jeongpil.yun@lge.com)
*/
int DEMOD_M19_Get_Lock(LX_DEMOD_LOCK_STATUS_T whatLock, LX_DEMOD_LOCK_STATE_T *lockState)
{
	...
	if ( demodLock == 1)
	{
//		DEMOD_PRINT("[M19 LGDBB] (%s) demod locked !!!\n",  __F__);
 		*lockState = LX_DEMOD_LOCKED;
	}
	else
	{
//		DEMOD_PRINT("[M19 LGDBB] (%s) demod unlocked !!!\n",  __F__);
		*lockState = LX_DEMOD_UNLOCKED;
	}
...
int DEMOD_M19_VSB_Get_SysLockTime(UINT16 *pSyslocktime)
{
	return RET_OK;
}

int DEMOD_M19_VSB_Get_FecLockTime(UINT16 *pFeclocktime)
{
	return RET_OK;
}
 ...
 * @author 	Jeongpil.yun (jeongpil.yun@lge.com)
*/
int DEMOD_M19_FecReset(BOOLEAN bReset)
{
	return RET_OK;
}
...
int DEMOD_M19_CountryGrpSetting(BOOLEAN bEnable)
{
	LX_DEMOD_L2_Context *pFrontend;
	pFrontend = &gM19_LGDBB_Frontend;
...
int DEMOD_M19_ANALOG_ResetHW(void)
{
#if 0 
	...
	ACE_REG_M19A0_RdFL(abb_00);
	ACE_REG_M19A0_Wr01(abb_00, abb_reset, 1);
	ACE_REG_M19A0_WrFL(abb_00);

	usleep_range(1000,10000);	/* 1ms ~ 10ms */


	ACE_REG_M19A0_Wr01(abb_00, abb_reset, 0);
	ACE_REG_M19A0_WrFL(abb_00);
	...
	ACE_REG_M19A0_RdFL(soft_reset_00);
	ACE_REG_M19A0_Rd01(soft_reset_00, swrst_f24m_bb, swrst_f24m_bb);
 ...
 * @author 	Jeongpil.yun (jeongpil.yun@lge.com)
*/
int DEMOD_M19_ANALOG_SetI2C(void)
{

#if 0
	DEMOD_PRINT("[KDRV_DEMOD] DEMOD_SetI2C Start !! \n");

	ACE_REG_M19A0_RdFL(abb_01);

	ACE_REG_M19A0_Wr01(abb_01, abb_i2csel, 0);

	ACE_REG_M19A0_WrFL(abb_01);
...
int DEMOD_M19_ANALOG_Set_AbbMode(BOOLEAN bIsAbbMode)
{
#if 0
	DEMOD_PRINT("[KDRV_DEMOD] DEMOD_M19_ANALOG_Set_AbbMode Start !! \n");


	if(TRUE == bIsAbbMode)
	{
		ACE_REG_M19A0_RdFL(bbdemod_control_00);
		ACE_REG_M19A0_Wr01(bbdemod_control_00, bbdemod_control, 0);  // 0: ABB, 1 : DBB
		ACE_REG_M19A0_WrFL(bbdemod_control_00);

		ACE_REG_M19A0_RdFL(abb_02);
		ACE_REG_M19A0_Wr01(abb_02, ifagc_sel, 0);  // 0: ABB, 1 : DBB
		ACE_REG_M19A0_WrFL(abb_02);
	}
	else
	{
		ACE_REG_M19A0_RdFL(bbdemod_control_00);
		ACE_REG_M19A0_Wr01(bbdemod_control_00, bbdemod_control, 1);  // 0: ABB, 1 : DBB
		ACE_REG_M19A0_WrFL(bbdemod_control_00);


		ACE_REG_M19A0_RdFL(abb_02);
		ACE_REG_M19A0_Wr01(abb_02, ifagc_sel, 1);  // 0: ABB, 1 : DBB
		ACE_REG_M19A0_WrFL(abb_02);
	}

	DEMOD_PRINT("[KDRV_DEMOD] DEMOD_M19_ANALOG_Set_AbbMode End !! \n");
#endif
...
int DEMOD_M19_Get_I2C_Handle(UINT8 portI2C, UINT16 deviceID)
{
	UINT32	handle;
	...
	gM19_LGDBB_Frontend.demodObj.i2cObj.handle = handle;

	return RET_OK;

}
#if 0
int DEMOD_M19_FW_Initialize(void)
{
	...
	#if 0
	data = M19_DEMOD_FW_0_1_0[0].firmware_table;
	size = sizeof(M19_DEMOD_FW_0_1_0[0].firmware_table);
	#endif

	data = M19_TER_DEMOD_FW_a_0_1[0].firmware_table;
	size = sizeof(M19_TER_DEMOD_FW_a_0_1[0].firmware_table);
	...
	{
		DEMOD_PRINT("[DEMOD M19 DBB] FAIL (%s:%d) DEMOD_L2_Set_MemAddr !!!\n", __F__, __L__);
		DEMOD_RETURN_FAIL(__F__);
	}
	...
	DEMOD_PRINT_ALWAYS("##########check START chungiii DEMOD_M19_FW_Initialize\n");
	for(tryCount = 0; tryCount < 5; tryCount++)
	{
		...
		if(lx_chip_rev() >= LX_CHIP_REV(M19, B0))
		{
			...
			{
				DEMOD_PRINT_ALWAYS("[M19 LGDBB] (%s) LGDBB Fail!! => Count(%d)\n", __F__, tryCount);
				OS_MsecSleep(20);
				continue;
			}
			else
			{
				DEMOD_PRINT_ALWAYS("##########check END chungiii DEMOD_M19_FW_Initialize\n");
				DEMOD_PRINT_ALWAYS("[M19 LGDBB] (%s) LGDBB Success!! => Count(%d)\n", __F__, tryCount);
				break;
			}
		}
		else
		{
			...
			{
				DEMOD_PRINT("[M19 LGDBB] (%s) LGDBB Fail!! => Count(%d)\n", __F__, tryCount);
				OS_MsecSleep(20);
				continue;
			}
			else
			{
				DEMOD_PRINT("[M19 LGDBB] (%s) LGDBB Success!! => Count(%d)\n", __F__, tryCount);
				break;
			}
	...
	if(tryCount == 5)
	{
		DEMOD_PRINT("[M19 LGDBB] (%s:%d) LGDBB Fail!! => Count(%d)\n", __F__, __L__, tryCount);
		DEMOD_RETURN_FAIL(__F__);
	}

	DEMOD_PRINT("##########check chungiii DEMOD_M19_FW_Initialize\n");
	//DEMOD_M19_Get_FW_PartInfo();    // should be check when bringup
...
int DEMOD_M19_FW_Initialize(void)
{
	...
	DEMOD_PRINT_ALWAYS("##### DEMOD_M19_FW_Initialize() start #####\n");

	DEMOD_APB_REG_WR(0xC910A404, 0x00000001); //MCU stall

	DEMOD_APB_REG_WR(0xC930E4a0, 0x00110000); // MCU+HW release
	
//	DEMOD_APB_REG_WR(0xC9105000, 0x7F355555);	// SW reset		
	
	data 	= M19_TER_DEMOD_FW_A_0_1[0].firmware_table;
	size 	= sizeof(M19_TER_DEMOD_FW_A_0_1[0].firmware_table);

//	data 	= M19_SAT_DEMOD_FW_A_0_1[0].firmware_table;
//	size 	= sizeof(M19_SAT_DEMOD_FW_A_0_1[0].firmware_table);

	
	DEMOD_PRINT_ALWAYS("##### M19 A0 FW uploaded in DEMOD_M19_FW_Initialize()#####\n");

	if(data != NULL)
	{	
		DEMOD_PRINT_ALWAYS("##### [DEMOD] 1 #####\n");
		if(size > gMemCfgDEMOD_FW.memory_size)
		{
			DEMOD_PRINT_ALWAYS("f/w size(%d) over mem size(%d)\n", size, gMemCfgDEMOD_FW.memory_size);
			return RET_ERROR;
		...
		DEMOD_PRINT_ALWAYS("##### [DEMOD] 2 #####\n");
		if(!fw_addr)
		{
			DEMOD_PRINT_ALWAYS("vmap_phys fail!!!\n");
			return RET_ERROR;
		}		
		DEMOD_PRINT_ALWAYS("##### [DEMOD] 3 #####\n");
		memcpy(fw_addr, data, size);
		wmb(); // use wmb before mcu is awoken
		DEMOD_PRINT_ALWAYS("##### [DEMOD] 4 #####\n");

		mem_base_addr = gMemCfgDEMOD_FW.memory_base;
		vunmap_phys(fw_addr);		
		DEMOD_PRINT_ALWAYS("##### [DEMOD] 5 #####\n");
	}
	else
	{
		return RET_ERROR;
	...
	if(RET_OK != DEMOD_L2_Set_MemAddr(pFrontend, mem_base_addr))
	{		
		DEMOD_PRINT_ALWAYS("##### [DEMOD] 6 #####\n");
		DEMOD_PRINT("[DEMOD M19 DBB] FAIL (%s:%d) DEMOD_L2_Set_MemAddr !!!\n", __F__, __L__);
		DEMOD_RETURN_FAIL(__F__);
	}
	DEMOD_PRINT_ALWAYS("[DEMOD M19 DBB] mem_base_addr = 0x%x !!!\n", mem_base_addr);

		// need to be check !!!!!
	DEMOD_L2_Set_ChipInfo(pFrontend, 0x19a0);
	DEMOD_PRINT_ALWAYS("##########check START chungiii DEMOD_M19_FW_Initialize\n");
	...
	do 
	{
		pRdata = (volatile UINT32 *)ioremap(0xC910a400, sizeof(UINT32));
		...
		sys_val = (*pRdata);
		printk("##########check chungiii reading M19 FW ver through APB[0x%x]\n", sys_val);
	} while(0);
	iounmap((void *)pRdata);
	////////////////////check APB buffer
	#if 0
...
int DEMOD_M19_SAT_FW_Initialize(void)
{
	LX_DEMOD_L2_Context *pFrontend;
	volatile UINT32 *pRdata = NULL;
	...
	DEMOD_PRINT_ALWAYS("##### DEMOD_M19_SAT_FW_Initialize() start #####\n");
	...
	data 	= M19_SAT_DEMOD_FW_A_0_1[0].firmware_table;
	size 	= sizeof(M19_SAT_DEMOD_FW_A_0_1[0].firmware_table);
	DEMOD_PRINT_ALWAYS("##### M19 A0 SAT FW uploaded in DEMOD_M19_SAT_FW_Initialize()#####\n");
...
*/		
			if(ret == NO_DEMOD_ERROR)
			{
				DEMOD_PRINT_ALWAYS("##########check END chungiii DEMOD_M19_SAT_FW_Initialize\n");
				DEMOD_PRINT_ALWAYS("[M19 LGDBB] (%s) LGDBB Success!! => Count(%d)\n", __F__, tryCount);
				break;
			}
			else
	...
	DEMOD_PRINT("##########check chungiii DEMOD_M19_SAT_FW_Initialize\n");
	//DEMOD_O18_Get_FW_PartInfo();    // should be check when bringup

	//DEMOD_PRINT_ALWAYS("##########check chungiii skip~!!! DEMOD_O18_FW_Initialize\n");


	// need to check M19 FW ver address ~!!!!!
	do 
	{
		pRdata = (volatile UINT32 *)ioremap(0xC910a400, sizeof(UINT32));
...
int DEMOD_M19_ALL_FW_Initialize(void)
{
	LX_DEMOD_L2_Context *pFrontend;
	volatile UINT32 *pRdata = NULL;
	UINT32 sys_val;
	...
	DEMOD_PRINT_ALWAYS("##### DEMOD_M19_ALL_FW_Initialize() start #####\n");

//	DEMOD_APB_REG_WR(0xC930E4a0, 0x00110000); // MCU+HW reset

//	DEMOD_APB_REG_WR(0xC910A404, 0x00000001);
	__DEMOD_M19_reset();
	...
	data 	= M19_TER_DEMOD_FW_A_0_1[0].firmware_table;
	size 	= sizeof(M19_TER_DEMOD_FW_A_0_1[0].firmware_table);
	DEMOD_PRINT_ALWAYS("##### M19 A0 FW uploaded in DEMOD_M19_ALL_FW_Initialize()#####\n");
	...
	DEMOD_PRINT_ALWAYS("[DEMOD M19 DBB] mem_base_addr = 0x%x !!!\n", mem_base_addr);
		...
		// need to be check !!!!!
	DEMOD_L2_Set_ChipInfo(pFrontend, 0x19a0);
	DEMOD_PRINT_ALWAYS("##########check START chungiii DEMOD_M19_ALL_FW_Initialize\n");
...
*/
			if(ret == NO_DEMOD_ERROR)
			{
				DEMOD_PRINT_ALWAYS("##########check END chungiii DEMOD_M19_ALL_FW_Initialize\n");
				DEMOD_PRINT_ALWAYS("[M19 LGDBB] (%s) LGDBB Success!! => Count(%d)\n", __F__, tryCount);
				break;
			}
			else
	...
	DEMOD_PRINT("##########check chungiii DEMOD_M19_ALL_FW_Initialize\n");
	//DEMOD_O18_Get_FW_PartInfo();    // should be check when bringup
...
int DEMOD_M19_FW_Configuration_Initialize(LX_DEMOD_OPER_MODE_T operMode)
{
	UINT32 return_code;
	LX_DEMOD_L2_Context *pFrontend;
	pFrontend = &gM19_LGDBB_Frontend;

	DBB_PRINT ("DEMOD_M19_FW_Configuration_Initialize OPmode is %x \n", operMode );
...
int DEMOD_M19_Opermode(DEMOD_CTX_T *pDemodInfo)
{
	UINT8  new_opermode;
...
int DEMOD_M19_Get_BW(DEMOD_CTX_T *pDemodInfo, UINT16 *pter_bandwidth_KHz)
{
...
int DEMOD_M19_Get_FW_PartInfo(UINT32 *pFW_Info)
{
...
int DEMOD_M19_Debug_ATSC_ReadREGvalue(UINT16 address, UINT32 *pData)
{
//	UINT8 	vqData;
	UINT8 	pvalue[4];
...
int DEMOD_M19_Debug_ATSC_WriteREGvalue(UINT16 address, UINT32 *pData)
{
	LX_DEMOD_L2_Context 	*pFrontend;
...
int DEMOD_M19_Get_Dump(void)
{

	LX_DEMOD_L2_Context *pFrontend;
	pFrontend = &gM19_LGDBB_Frontend;

	printk("########chungii call M19 dump\n");
...
int DEMOD_M19_ADC_Enable (void)
{

	DEMOD_PRINT_ALWAYS("[DEMOD] (%s:%d) DEMOD_M19_ADC_Enable !!!\n", __F__, __L__);
...
************************************************************************************/
/**
 * DEMOD_M19_Get_Signal_Information
 * Get BER before RS on DVB
 *
 * @param *pVber 	[OUT] UINT32.
 * @return if Succeeded - RET_OK else-RET_ERROR
 ...
 * @author 	Jeongpil.yun (jeongpil.yun@lge.com)
*/
int DEMOD_M19_Get_Signal_Information(LX_DEMOD_SIGNAL_TOTAL_T *pSignalStatus)
{
	LX_DEMOD_L2_SIG_STATUS 	signalStatus;
	LX_DEMOD_L2_Context 		*pFrontend;
 ...
 * @author 	Jeongpil.yun (jeongpil.yun@lge.com)
*/
int DEMOD_M19_Get_CFG_Information(LX_DEMOD_SIGNAL_TUNE_CFG_T *pSignalStatus)
{
	LX_DEMOD_L2_SIG_STATUS 	signalStatus;
	LX_DEMOD_L2_Context 		*pFrontend;
...
int DEMOD_M19_DVB_Set_MemSconfig(void)
{
	...
	risic_st_mem			= gMemCfgDEMOD_DVB_RISIC.memory_base;

	if(tdi_st_mem == 0 || djb_st_mem == 0 || risic_st_mem == 0)
	{
		printk("######[DEMOD_M19_DVB_Set_MemSconfig] Error M19 DEMOD DVB Wrong Memory Base Address ##### !!!!!!!!!!!!!!!!!!!!!!!\n");
	}
	else
	{
		printk("######[DEMOD_M19_DVB_Set_MemSconfig] first call DEMOD_M19_DVB_Set_MemSconfig TDI_addr[0x%x] , DJB_addr[0x%x] , RISIC_addr[0x%x]##### !!!!!!\n", tdi_st_mem, djb_st_mem, risic_st_mem );
		if(RET_OK != DEMOD_L2_DVB_Set_BaseAddr_AXI(pFrontend, tdi_st_mem, djb_st_mem , risic_st_mem ))
		{
			DEMOD_PRINT("[DEMOD_M19_DVB_Set_MemSconfig] FAIL (%s:%d) DEMOD_L2_DVB_Set_BaseAddr_AXI() !!!\n", __F__, __L__);
			return RET_ERROR;
		}
	}
	return RET_OK;
...
int DEMOD_M19_DVBC_reset(void)
{
	LX_DEMOD_L2_Context *pFrontend;
			
	pFrontend = &gM19_LGDBB_Frontend;
//	DEMOD_APB_REG_WR(0xC9105068, 0x7f01c648);	// MCU stall
	printk("######[DEMOD_M19_DVBC_reset] start ##### !!!!!!!!!!!!!!!!!!!!!!!\n");

//	DEMOD_APB_REG_WR(0xC910A404, 0x00000000);	// MCU release	
//	usleep_range(1000,2000);	/* 1ms ~ 2ms */	

//	DEMOD_M19_Power_Save(FALSE);


	printk("######[DEMOD_M19_DVBC_reset] MCU release ##### !!!!!!!!!!!!!!!!!!!!!!!\n");
...
/*
	if(RET_OK != DEMOD_L2_Switch_to_standard(pFrontend,DEMOD_DD_MODE_PROP_MODULATION_DVBC))
	{
		DEMOD_PRINT("[M19 LGDBB] FAIL (%s:%d) DEMOD_L2_Switch_to_standard !!!\n", __F__, __L__);
		return RET_ERROR;
	}
...
//	DEMOD_APB_REG_WR(0xC9105004, 0x40280000);
//	usleep_range(1000,2000);	/* 1ms ~ 2ms */	
...
//	CTOP_CTRL_M19Ax_WrFL(CTOP_BMC, dmdmip_02);
	...
	printk("######[DEMOD_M19_DVBC_reset] end ##### !!!!!!!!!!!!!!!!!!!!!!!\n");
