...
#ifndef __OSD_AFBC_REG_M19_H__
#define __OSD_AFBC_REG_M19_H__
...
/* from 'M16P3-A0_PQE_OSD_AFBC_reg_man.csv' 20180327 20:22:33 KST by getregs v2.9 */


/*
 * @{
 * Naming for register pointer.
 * g_osd_afbc_m19_reg : real register of AFBC0_CTRL.
 * g_osd_afbc_m19_reg_shadow     : shadow register.
 *
 ...
 * */
#define AFBC0_CTRL_RdFL(_r)			((g_osd_afbc_m19_reg_shadow->_r)=(g_osd_afbc_m19_reg->_r))
#define AFBC0_CTRL_WrFL(_r)			((g_osd_afbc_m19_reg->_r)=(g_osd_afbc_m19_reg_shadow->_r))

#define AFBC0_CTRL_Rd(_r)			*((UINT32*)(&(g_osd_afbc_m19_reg_shadow->_r)))
#define AFBC0_CTRL_Wr(_r,_v)			((AFBC0_CTRL_Rd(_r))=((UINT32)(_v)))

#define AFBC0_CTRL_Rd01(_r,_f01,_v01)													\
								do { 											\
									(_v01) = (g_osd_afbc_m19_reg_shadow->_r._f01);				\
								} while(0)

#define AFBC0_CTRL_Rd02(_r,_f01,_v01,_f02,_v02)										\
								do { 											\
									(_v01) = (g_osd_afbc_m19_reg_shadow->_r._f01);				\
									(_v02) = (g_osd_afbc_m19_reg_shadow->_r._f02);				\
								} while(0)
...
#define AFBC0_CTRL_Rd03(_r,_f01,_v01,_f02,_v02,_f03,_v03)								\
								do { 											\
									(_v01) = (g_osd_afbc_m19_reg_shadow->_r._f01);				\
									(_v02) = (g_osd_afbc_m19_reg_shadow->_r._f02);				\
									(_v03) = (g_osd_afbc_m19_reg_shadow->_r._f03);				\
								} while(0)
...
#define AFBC0_CTRL_Rd04(_r,_f01,_v01,_f02,_v02,_f03,_v03,_f04,_v04)					\
								do { 											\
									...
									(_v02) = (g_osd_afbc_m19_reg_shadow->_r._f02);				\
									(_v03) = (g_osd_afbc_m19_reg_shadow->_r._f03);				\
									(_v04) = (g_osd_afbc_m19_reg_shadow->_r._f04);				\
								} while(0)
...
#define AFBC0_CTRL_Rd05(_r,_f01,_v01,_f02,_v02,_f03,_v03,_f04,_v04,					\
					_f05,_v05)													\
								do { 											\
									...
									(_v03) = (g_osd_afbc_m19_reg_shadow->_r._f03);				\
									(_v04) = (g_osd_afbc_m19_reg_shadow->_r._f04);				\
									(_v05) = (g_osd_afbc_m19_reg_shadow->_r._f05);				\
								} while(0)
...
#define AFBC0_CTRL_Rd06(_r,_f01,_v01,_f02,_v02,_f03,_v03,_f04,_v04,					\
					_f05,_v05,_f06,_v06)										\
								do { 											\
									...
									(_v04) = (g_osd_afbc_m19_reg_shadow->_r._f04);				\
									(_v05) = (g_osd_afbc_m19_reg_shadow->_r._f05);				\
									(_v06) = (g_osd_afbc_m19_reg_shadow->_r._f06);				\
								} while(0)
...
#define AFBC0_CTRL_Rd07(_r,_f01,_v01,_f02,_v02,_f03,_v03,_f04,_v04,					\
					_f05,_v05,_f06,_v06,_f07,_v07)								\
								do { 											\
									...
									(_v05) = (g_osd_afbc_m19_reg_shadow->_r._f05);				\
									(_v06) = (g_osd_afbc_m19_reg_shadow->_r._f06);				\
									(_v07) = (g_osd_afbc_m19_reg_shadow->_r._f07);				\
								} while(0)
...
#define AFBC0_CTRL_Rd08(_r,_f01,_v01,_f02,_v02,_f03,_v03,_f04,_v04,					\
					_f05,_v05,_f06,_v06,_f07,_v07,_f08,_v08)					\
								do { 											\
									...
									(_v06) = (g_osd_afbc_m19_reg_shadow->_r._f06);				\
									(_v07) = (g_osd_afbc_m19_reg_shadow->_r._f07);				\
									(_v08) = (g_osd_afbc_m19_reg_shadow->_r._f08);				\
								} while(0)
...
#define AFBC0_CTRL_Rd09(_r,_f01,_v01,_f02,_v02,_f03,_v03,_f04,_v04,					\
					...
					_f09,_v09)													\
								do { 											\
									...
									(_v07) = (g_osd_afbc_m19_reg_shadow->_r._f07);				\
									(_v08) = (g_osd_afbc_m19_reg_shadow->_r._f08);				\
									(_v09) = (g_osd_afbc_m19_reg_shadow->_r._f09);				\
								} while(0)
...
#define AFBC0_CTRL_Rd10(_r,_f01,_v01,_f02,_v02,_f03,_v03,_f04,_v04,					\
					...
					_f09,_v09,_f10,_v10)										\
								do { 											\
									...
									(_v08) = (g_osd_afbc_m19_reg_shadow->_r._f08);				\
									(_v09) = (g_osd_afbc_m19_reg_shadow->_r._f09);				\
									(_v10) = (g_osd_afbc_m19_reg_shadow->_r._f10);				\
								} while(0)
...
#define AFBC0_CTRL_Rd11(_r,_f01,_v01,_f02,_v02,_f03,_v03,_f04,_v04,					\
					...
					_f09,_v09,_f10,_v10,_f11,_v11)								\
								do { 											\
									...
									(_v09) = (g_osd_afbc_m19_reg_shadow->_r._f09);				\
									(_v10) = (g_osd_afbc_m19_reg_shadow->_r._f10);				\
									(_v11) = (g_osd_afbc_m19_reg_shadow->_r._f11);				\
								} while(0)
...
#define AFBC0_CTRL_Rd12(_r,_f01,_v01,_f02,_v02,_f03,_v03,_f04,_v04,					\
					...
					_f09,_v09,_f10,_v10,_f11,_v11,_f12,_v12)					\
								do { 											\
									...
									(_v10) = (g_osd_afbc_m19_reg_shadow->_r._f10);				\
									(_v11) = (g_osd_afbc_m19_reg_shadow->_r._f11);				\
									(_v12) = (g_osd_afbc_m19_reg_shadow->_r._f12);				\
								} while(0)
...
#define AFBC0_CTRL_Rd13(_r,_f01,_v01,_f02,_v02,_f03,_v03,_f04,_v04,					\
					...
					_f13,_v13)													\
								do { 											\
									...
									(_v11) = (g_osd_afbc_m19_reg_shadow->_r._f11);				\
									(_v12) = (g_osd_afbc_m19_reg_shadow->_r._f12);				\
									(_v13) = (g_osd_afbc_m19_reg_shadow->_r._f13);				\
								} while(0)
...
#define AFBC0_CTRL_Rd14(_r,_f01,_v01,_f02,_v02,_f03,_v03,_f04,_v04,					\
					...
					_f13,_v13,_f14,_v14)										\
								do { 											\
									...
									(_v12) = (g_osd_afbc_m19_reg_shadow->_r._f12);				\
									(_v13) = (g_osd_afbc_m19_reg_shadow->_r._f13);				\
									(_v14) = (g_osd_afbc_m19_reg_shadow->_r._f14);				\
								} while(0)
...
#define AFBC0_CTRL_Rd15(_r,_f01,_v01,_f02,_v02,_f03,_v03,_f04,_v04,					\
					...
					_f13,_v13,_f14,_v14,_f15,_v15)								\
								do { 											\
									...
									(_v13) = (g_osd_afbc_m19_reg_shadow->_r._f13);				\
									(_v14) = (g_osd_afbc_m19_reg_shadow->_r._f14);				\
									(_v15) = (g_osd_afbc_m19_reg_shadow->_r._f15);				\
								} while(0)
...
#define AFBC0_CTRL_Rd16(_r,_f01,_v01,_f02,_v02,_f03,_v03,_f04,_v04,					\
					...
					_f13,_v13,_f14,_v14,_f15,_v15,_f16,_v16)					\
								do { 											\
									...
									(_v14) = (g_osd_afbc_m19_reg_shadow->_r._f14);				\
									(_v15) = (g_osd_afbc_m19_reg_shadow->_r._f15);				\
									(_v16) = (g_osd_afbc_m19_reg_shadow->_r._f16);				\
								} while(0)


#define AFBC0_CTRL_Wr01(_r,_f01,_v01)													\
								do { 											\
									(g_osd_afbc_m19_reg_shadow->_r._f01) = (_v01);				\
								} while(0)

#define AFBC0_CTRL_Wr02(_r,_f01,_v01,_f02,_v02)										\
								do { 											\
									(g_osd_afbc_m19_reg_shadow->_r._f01) = (_v01);				\
									(g_osd_afbc_m19_reg_shadow->_r._f02) = (_v02);				\
								} while(0)
...
#define AFBC0_CTRL_Wr03(_r,_f01,_v01,_f02,_v02,_f03,_v03)								\
								do { 											\
									(g_osd_afbc_m19_reg_shadow->_r._f01) = (_v01);				\
									(g_osd_afbc_m19_reg_shadow->_r._f02) = (_v02);				\
									(g_osd_afbc_m19_reg_shadow->_r._f03) = (_v03);				\
								} while(0)
...
#define AFBC0_CTRL_Wr04(_r,_f01,_v01,_f02,_v02,_f03,_v03,_f04,_v04)					\
								do { 											\
									...
									(g_osd_afbc_m19_reg_shadow->_r._f02) = (_v02);				\
									(g_osd_afbc_m19_reg_shadow->_r._f03) = (_v03);				\
									(g_osd_afbc_m19_reg_shadow->_r._f04) = (_v04);				\
								} while(0)
...
#define AFBC0_CTRL_Wr05(_r,_f01,_v01,_f02,_v02,_f03,_v03,_f04,_v04,					\
					_f05,_v05)													\
								do { 											\
									...
									(g_osd_afbc_m19_reg_shadow->_r._f03) = (_v03);				\
									(g_osd_afbc_m19_reg_shadow->_r._f04) = (_v04);				\
									(g_osd_afbc_m19_reg_shadow->_r._f05) = (_v05);				\
								} while(0)
...
#define AFBC0_CTRL_Wr06(_r,_f01,_v01,_f02,_v02,_f03,_v03,_f04,_v04,					\
					_f05,_v05,_f06,_v06)										\
								do { 											\
									...
									(g_osd_afbc_m19_reg_shadow->_r._f04) = (_v04);				\
									(g_osd_afbc_m19_reg_shadow->_r._f05) = (_v05);				\
									(g_osd_afbc_m19_reg_shadow->_r._f06) = (_v06);				\
								} while(0)
...
#define AFBC0_CTRL_Wr07(_r,_f01,_v01,_f02,_v02,_f03,_v03,_f04,_v04,					\
					_f05,_v05,_f06,_v06,_f07,_v07)								\
								do { 											\
									...
									(g_osd_afbc_m19_reg_shadow->_r._f05) = (_v05);				\
									(g_osd_afbc_m19_reg_shadow->_r._f06) = (_v06);				\
									(g_osd_afbc_m19_reg_shadow->_r._f07) = (_v07);				\
								} while(0)
...
#define AFBC0_CTRL_Wr08(_r,_f01,_v01,_f02,_v02,_f03,_v03,_f04,_v04,					\
					_f05,_v05,_f06,_v06,_f07,_v07,_f08,_v08)					\
								do { 											\
									...
									(g_osd_afbc_m19_reg_shadow->_r._f06) = (_v06);				\
									(g_osd_afbc_m19_reg_shadow->_r._f07) = (_v07);				\
									(g_osd_afbc_m19_reg_shadow->_r._f08) = (_v08);				\
								} while(0)
...
#define AFBC0_CTRL_Wr09(_r,_f01,_v01,_f02,_v02,_f03,_v03,_f04,_v04,					\
					...
					_f09,_v09)													\
								do { 											\
									...
									(g_osd_afbc_m19_reg_shadow->_r._f07) = (_v07);				\
									(g_osd_afbc_m19_reg_shadow->_r._f08) = (_v08);				\
									(g_osd_afbc_m19_reg_shadow->_r._f09) = (_v09);				\
								} while(0)
...
#define AFBC0_CTRL_Wr10(_r,_f01,_v01,_f02,_v02,_f03,_v03,_f04,_v04,					\
					...
					_f09,_v09,_f10,_v10)										\
								do { 											\
									...
									(g_osd_afbc_m19_reg_shadow->_r._f08) = (_v08);				\
									(g_osd_afbc_m19_reg_shadow->_r._f09) = (_v09);				\
									(g_osd_afbc_m19_reg_shadow->_r._f10) = (_v10);				\
								} while(0)
...
#define AFBC0_CTRL_Wr11(_r,_f01,_v01,_f02,_v02,_f03,_v03,_f04,_v04,					\
					...
					_f09,_v09,_f10,_v10,_f11,_v11)								\
								do { 											\
									...
									(g_osd_afbc_m19_reg_shadow->_r._f09) = (_v09);				\
									(g_osd_afbc_m19_reg_shadow->_r._f10) = (_v10);				\
									(g_osd_afbc_m19_reg_shadow->_r._f11) = (_v11);				\
								} while(0)
...
#define AFBC0_CTRL_Wr12(_r,_f01,_v01,_f02,_v02,_f03,_v03,_f04,_v04,					\
					...
					_f09,_v09,_f10,_v10,_f11,_v11,_f12,_v12)					\
								do { 											\
									...
									(g_osd_afbc_m19_reg_shadow->_r._f10) = (_v10);				\
									(g_osd_afbc_m19_reg_shadow->_r._f11) = (_v11);				\
									(g_osd_afbc_m19_reg_shadow->_r._f12) = (_v12);				\
								} while(0)
...
#define AFBC0_CTRL_Wr13(_r,_f01,_v01,_f02,_v02,_f03,_v03,_f04,_v04,					\
					...
					_f13,_v13)													\
								do { 											\
									...
									(g_osd_afbc_m19_reg_shadow->_r._f11) = (_v11);				\
									(g_osd_afbc_m19_reg_shadow->_r._f12) = (_v12);				\
									(g_osd_afbc_m19_reg_shadow->_r._f13) = (_v13);				\
								} while(0)
...
#define AFBC0_CTRL_Wr14(_r,_f01,_v01,_f02,_v02,_f03,_v03,_f04,_v04,					\
					...
					_f13,_v13,_f14,_v14)										\
								do { 											\
									...
									(g_osd_afbc_m19_reg_shadow->_r._f12) = (_v12);				\
									(g_osd_afbc_m19_reg_shadow->_r._f13) = (_v13);				\
									(g_osd_afbc_m19_reg_shadow->_r._f14) = (_v14);				\
								} while(0)
...
#define AFBC0_CTRL_Wr15(_r,_f01,_v01,_f02,_v02,_f03,_v03,_f04,_v04,					\
					...
					_f13,_v13,_f14,_v14,_f15,_v15)								\
								do { 											\
									...
									(g_osd_afbc_m19_reg_shadow->_r._f13) = (_v13);				\
									(g_osd_afbc_m19_reg_shadow->_r._f14) = (_v14);				\
									(g_osd_afbc_m19_reg_shadow->_r._f15) = (_v15);				\
								} while(0)
...
#define AFBC0_CTRL_Wr16(_r,_f01,_v01,_f02,_v02,_f03,_v03,_f04,_v04,					\
					...
					_f13,_v13,_f14,_v14,_f15,_v15,_f16,_v16)					\
								do { 											\
									...
									(g_osd_afbc_m19_reg_shadow->_r._f14) = (_v14);				\
									(g_osd_afbc_m19_reg_shadow->_r._f15) = (_v15);				\
									(g_osd_afbc_m19_reg_shadow->_r._f16) = (_v16);				\
								} while(0)

/** @} *//* end of macro documentation */

extern volatile OSD_AFBC_M19_REG_T*	g_osd_afbc_m19_reg;
extern OSD_AFBC_M19_REG_T*    			g_osd_afbc_m19_reg_shadow;

#ifdef __cplusplus
}
#endif

#endif	/* __OSD_AFBC_REG_M19_H__ */
