...
extern int ntfs_read_compressed_block(struct folio *folio);
#else
...
extern void ntfs_file_upcase_value(FILE_NAME_ATTR *file_name_attr,
		const ntfschar *upcase, const u32 upcase_len);
extern int ntfs_file_compare_values(const FILE_NAME_ATTR *file_name_attr1,
...
s64 ntfs_compressed_attr_pread(ntfs_inode *ni, s64 pos, s64 count, void *b);
