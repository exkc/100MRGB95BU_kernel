...
#define DEMOD_DD_AGC_PROP_POLARITY_INVERSION     		1
#define DEMOD_DD_AGC_PROP_POLARITY_NORMAL	     		0
#define DEMOD_DD_AGC_PROP_POL_MASK						0x01

#define DEMOD_DD_AGC_PROP_OUTEN_LSB						5
#define DEMOD_DD_AGC_PROP_OUTEN_ENABLE         			1
#define DEMOD_DD_AGC_PROP_OUTEN_DISABLE     			0
#define DEMOD_DD_AGC_PROP_OUTEN_MASK					0x01

#define DEMOD_DD_AGC_PROP_OUTEN_S_LSB					4
#define DEMOD_DD_AGC_PROP_OUTEN_S_ENABLE       			1
#define DEMOD_DD_AGC_PROP_OUTEN_S_DISABLE     			0
...
#define DEMOD_DD_CONSTELATION_PROP_DQPSK				1
#define DEMOD_DD_CONSTELATION_PROP_VSB					2
#define DEMOD_DD_CONSTELATION_PROP_16QAM				3
#define DEMOD_DD_CONSTELATION_PROP_32QAM				4
#define DEMOD_DD_CONSTELATION_PROP_64QAM				5
#define DEMOD_DD_CONSTELATION_PROP_128QAM				6
#define DEMOD_DD_CONSTELATION_PROP_256QAM				7
#define DEMOD_DD_CONSTELATION_PROP_1024QAM				8
#define DEMOD_DD_CONSTELATION_PROP_4096QAM				9
#define DEMOD_DD_CONSTELATION_PROP_PSK					10

#define DEMOD_DD_CONSTELATION_PROP_16APSK				11
#define DEMOD_DD_CONSTELATION_PROP_32APSK				12
#define DEMOD_DD_CONSTELATION_PROP_AUTO					15
