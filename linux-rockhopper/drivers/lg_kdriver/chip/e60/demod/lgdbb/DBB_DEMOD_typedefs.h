...
#define DEMOD_CHIP_DEFAULT		0
#define DEMOD_CHIP_O20			1
#define DEMOD_CHIP_E60			2
#define DEMOD_CHIP_O22			3

#if !defined(DEMOD_CHIP)
#define DEMOD_CHIP				DEMOD_CHIP_DEFAULT
#endif
...
#pragma message ("demod platform kdrv + cpbox")
#define DEMOD_COMM		DEMOD_COMM_I2C
#else
//#pragma message ("demod platform kdrv")
#define DEMOD_COMM		DEMOD_COMM_APB
#endif
#else
...
#pragma message ("demod platform gui (fpga)")

#define DEMOD_PLATFORM	DEMOD_PLATFORM_GUI
#define DEMOD_COMM		DEMOD_COMM_FPGA
#elif defined(EVAL_GUI)
#pragma message ("demod platform gui")

#define DEMOD_PLATFORM	DEMOD_PLATFORM_GUI
#define DEMOD_COMM		DEMOD_COMM_I2C
#else
#pragma message ("demod platform ext (win32)")
#define DEMOD_PLATFORM	DEMOD_PLATFORM_EXT
#define DEMOD_COMM		DEMOD_COMM_I2C
#endif
#endif
