#ifndef _SCRG_CTRL_M0_REG_O24A0_H_
#define _SCRG_CTRL_M0_REG_O24A0_H_
...
typedef struct {
    ...
    reg_soft_rst_x_lbus_3_axi_n: 1,    //     10
                              : 21;    //  31:11 reserved
}SCRG_CTRL_M0_CRG_M03_O24A0_T;

/*-----------------------------------------------------------------------------------------
    scrg_ctrl_m0 Register LIst
-----------------------------------------------------------------------------------------*/
typedef struct {
    SCRG_CTRL_M0_CRG_M00_O24A0_T       crg_m00    ;             // 0xC4D2_0000
    SCRG_CTRL_M0_CRG_M01_O24A0_T       crg_m01    ;             // 0xC4D2_0004
    SCRG_CTRL_M0_CRG_M02_O24A0_T       crg_m02    ;             // 0xC4D2_0008
    SCRG_CTRL_M0_CRG_M03_O24A0_T       crg_m03    ;             // 0xC4D2_000C
}SCRG_CTRL_M0_REG_O24A0_T;
/* 4 regs */
...
#define SCRG_CTRL_M0_CRG_M00_O24A0_T_OFF                    (BASEADDRESS+0x0000)
#define SCRG_CTRL_M0_CRG_M01_O24A0_T_OFF                    (BASEADDRESS+0x0004)
#define SCRG_CTRL_M0_CRG_M02_O24A0_T_OFF                    (BASEADDRESS+0x0008)
#define SCRG_CTRL_M0_CRG_M03_O24A0_T_OFF                    (BASEADDRESS+0x000C)
