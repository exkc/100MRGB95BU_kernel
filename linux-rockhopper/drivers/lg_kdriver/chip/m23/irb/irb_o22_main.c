...
/*----------------------------------------------------------------------------------------
	global Functions
---------------------------------------------------------------------------------------*/
static int o22_irbs_enable = 1;
static int o22_irb_inited = 0;

module_param(o22_irbs_enable, int, S_IRUGO);
MODULE_PARM_DESC(o22_irbs_enable, "o22 irbs disable");


static irbs_o22_func_t* irb_o22_func = NULL;
 ...
 */
int o22_irb_ioctl_main (unsigned int cmd, unsigned long arg)
{
...
static int o22_irb_ioctl (unsigned int cmd, unsigned long arg)
{
	int ret = 0;
	...
	ret = o22_irb_ioctl_main(cmd, arg);

    return ret;
}

static int o22_irb_suspend(void)
{

	return 0;
}

static int o22_irb_resume(void)
{
	irb_o22_func = get_o22_irb_func();
	irb_o22_func->reinit();
...
static irbs_driver_t o22_irbs_driver =
{
	.init = o22_irb_init,
	.ioctl = o22_irb_ioctl,
	.suspend = o22_irb_suspend,
	.resume = o22_irb_resume,
};

irbs_driver_t* get_o22_irb_driver(void)
{
	return &o22_irbs_driver;
}
