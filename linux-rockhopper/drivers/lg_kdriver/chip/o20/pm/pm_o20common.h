...
/* o20_gov_status.governor status  */
...
#define O20_AVS_SET_DELAY 	30	/* sec */

#define GOV_START_DELAY 	60

#define AVS_NOT_INITED 0

/* o20_load_dump related*/
...
#define CPU_DFTFREQ	660 //Mhz
#define CPU_NORMALFREQ	1700 //Mhz
...
#define O20_CPU_AVS_INVALID_MAX   5  /* invalid max */
...
typedef struct
{
	...
	void  			(*run)(pms_o20_work_t o20work);
	void  			(*run_regul)(pms_o20_work_t o20work);
	void  			(*run_cpuregul)(pms_o20_work_t o20work);
	void  			(*reset)(void);
...
typedef struct
{
	...
	void  			(*reinit)(void);
	int 			(*set_avs)(void);
	int 			(*get_cpu_avs_type)(pms_o20_avsinto_t *);
	int 			(*get_core_avs_type)(pms_o20_avsinto_t *);
