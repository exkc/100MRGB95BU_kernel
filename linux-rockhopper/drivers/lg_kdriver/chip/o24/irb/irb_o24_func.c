...
void o24_irb_funcInit(void);
int o24_irb_tx(LX_IRB_PARAM_T * param);
void o24_irb_funcReInit(void);
void o24_irb_exit(void);

void o24_irb_funcInit(void)
{

    KDRV_IRB_DEBUG("o24_irb init\n");
...
int o24_irb_tx(LX_IRB_PARAM_T * param)
{
    ...
    /*  busy status is same in o24  checked by micom engineer 210428*/
    ...
    /*  no done clear  in o24  checked by micom engineer 210428*/

    KDRV_IRB_DEBUG("o24_irb tx makenum[%x] pbuf[%x]\n",
	    midx,pbuf[0]);
    if(mbuf)
	kfree(mbuf);
    return 0;
...
void o24_irb_funcReInit(void)
{
    ...
    KDRV_IRB_NOTI("o24_irb reinit\n");
}
void o24_irb_exit(void)
{
    KDRV_IRB_DEBUG("o24_irb end\n");
}


static irbs_o24_func_t o24_irb_func =
{
    .init = o24_irb_funcInit,
    .reinit = o24_irb_funcReInit,
    .tx = o24_irb_tx,
    .exit = o24_irb_exit,
};

irbs_o24_func_t* get_o24_irb_func(void)
{
    return &o24_irb_func;
}
