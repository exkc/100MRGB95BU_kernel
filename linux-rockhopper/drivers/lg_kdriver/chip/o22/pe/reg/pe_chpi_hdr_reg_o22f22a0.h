#ifndef _PE_CHPI_HDR_REG_O22F22A0_H_
#define _PE_CHPI_HDR_REG_O22F22A0_H_
#ifndef UINT32
...
}PE_O22F22_HDR_LLUT0_IA_CTRL_T;

typedef struct {
	UINT32 uaddr32;
	union {
	UINT32 udata32;
	struct {						//0xF1000A24 RW
...
}PE_O22F22_HDR_LLUT0_IA_DATA_T;

typedef struct {
	UINT32 uaddr32;
	union {
	UINT32 udata32;
	struct {						//0xF1000A44 RW
	UINT32 hif_llut1_wdata_x_33rd           :32;	//31:0	//X coordinate of 33rd control point
	};
	};
}PE_O22F22_HDR_LLUT1_CTRL_05_T;

typedef struct {
	UINT32 uaddr32;
	union {
	UINT32 udata32;
	struct {						//0xF1000A48 RW
	UINT32 hif_llut1_wdata_y_33rd           :16;	//15:0	//Y coordinate of 33rd control point
	UINT32 resvd                            :16;
	};
	};
}PE_O22F22_HDR_LLUT1_CTRL_06_T;

typedef struct {
	UINT32 uaddr32;
	union {
	UINT32 udata32;
	struct {						//0xF1000A50 RW
...
}PE_O22F22_HDR_LLUT1_IA_CTRL_T;

typedef struct {
	UINT32 uaddr32;
	union {
	UINT32 udata32;
	struct {						//0xF1000A54 RW
...
}PE_O22F22_HDR_LLUT1_IA_DATA_T;

typedef struct {
	UINT32 uaddr32;
	union {
	UINT32 udata32;
	struct {						//0xF1000A74 RW
	UINT32 resvd                            :16;
	UINT32 hif_llut2_wdata_x_33rd           :16;	//31:16	//X coordinate of 33rd control point
	};
	};
}PE_O22F22_HDR_LLUT2_CTRL_05_T;

typedef struct {
	UINT32 uaddr32;
	union {
	UINT32 udata32;
	struct {						//0xF1000A78 RW
	UINT32 hif_llut2_wdata_y_33rd           :16;	//15:0	//Y coordinate of 33rd control point
	UINT32 resvd                            :16;
	};
	};
}PE_O22F22_HDR_LLUT2_CTRL_06_T;

typedef struct {
	UINT32 uaddr32;
	union {
	UINT32 udata32;
	struct {						//0xF1000A80 RW
...
}PE_O22F22_HDR_LLUT2_IA_CTRL_T;

typedef struct {
	UINT32 uaddr32;
	union {
	UINT32 udata32;
	struct {						//0xF1000A84 RW
...
}PE_O22F22_HDR_LLUT2_IA_DATA_T;

typedef struct {
	UINT32 uaddr32;
	union {
	UINT32 udata32;
	struct {						//0xF1000B34 RW
...
}PE_O22F22_HDR_YGAIN_LUT_CTRL_05_T;

typedef struct {
	UINT32 uaddr32;
	union {
	UINT32 udata32;
	struct {						//0xF1000B38 RW
...
}PE_O22F22_HDR_YGAIN_LUT_IA_CTRL_T;

typedef struct {
	UINT32 uaddr32;
	union {
	UINT32 udata32;
	struct {						//0xF1000B3C RW
...
}PE_O22F22_HDR_YGAIN_LUT_IA_DATA_T;

typedef struct {
	UINT32 uaddr32;
	union {
	UINT32 udata32;
	struct {						//0xF10008D0 RW
...
}PE_O22F22_HDR_PCC_CTRL_01_T;

typedef struct {
	UINT32 uaddr32;
	union {
	UINT32 udata32;
	struct {						//0xF10008A8 RW
...
}PE_O22F22_HDR_PCC_CTRL_02_T;

typedef struct {
	UINT32 uaddr32;
	union {
	UINT32 udata32;
	struct {						//0xF10008AC RW
...
}PE_O22F22_HDR_PCC_CTRL_03_T;

typedef struct {
	UINT32 uaddr32;
	union {
	UINT32 udata32;
	struct {						//0xF10008B0 RW
...
}PE_O22F22_HDR_PCC_CTRL_04_T;

typedef struct {
	UINT32 uaddr32;
	union {
	UINT32 udata32;
	struct {						//0xF10008B4 RW
	UINT32 resvd0                           :16;
	UINT32 r_pcc_coef8                      :15;	//30:16	//PCC32 Coefficient 8 (Default : 6801)
	UINT32 resvd1                           :1;
	};
	};
}PE_O22F22_HDR_PCC_CTRL_05_T;

typedef struct
{
	PE_O22F22_HDR_LLUT0_IA_CTRL_T                 hdr_llut0_ia_ctrl_x;	//0xF1000A20
	PE_O22F22_HDR_LLUT1_IA_CTRL_T                 hdr_llut1_ia_ctrl_x;	//0xF1000A50
	PE_O22F22_HDR_LLUT2_IA_CTRL_T                 hdr_llut2_ia_ctrl_x;	//0xF1000A80
	PE_O22F22_HDR_LLUT0_IA_DATA_T                 hdr_llut0_ia_data_x[32];	//0xF1000A24
	PE_O22F22_HDR_LLUT1_IA_DATA_T                 hdr_llut1_ia_data_x[32];	//0xF1000A54
	PE_O22F22_HDR_LLUT2_IA_DATA_T                 hdr_llut2_ia_data_x[32];	//0xF1000A84
	PE_O22F22_HDR_LLUT0_CTRL_05_T                 hdr_llut0_ctrl_05;	//0xF1000A14
	PE_O22F22_HDR_LLUT1_CTRL_05_T                 hdr_llut1_ctrl_05;	//0xF1000A44
	PE_O22F22_HDR_LLUT2_CTRL_05_T                 hdr_llut2_ctrl_05;	//0xF1000A74
	PE_O22F22_HDR_LLUT0_IA_CTRL_T                 hdr_llut0_ia_ctrl_y;	//0xF1000A20
	PE_O22F22_HDR_LLUT1_IA_CTRL_T                 hdr_llut1_ia_ctrl_y;	//0xF1000A50
	PE_O22F22_HDR_LLUT2_IA_CTRL_T                 hdr_llut2_ia_ctrl_y;	//0xF1000A80
	PE_O22F22_HDR_LLUT0_IA_DATA_T                 hdr_llut0_ia_data_y[32];	//0xF1000A24
	PE_O22F22_HDR_LLUT1_IA_DATA_T                 hdr_llut1_ia_data_y[32];	//0xF1000A54
	PE_O22F22_HDR_LLUT2_IA_DATA_T                 hdr_llut2_ia_data_y[32];	//0xF1000A84
	PE_O22F22_HDR_LLUT0_CTRL_06_T                 hdr_llut0_ctrl_06;	//0xF1000A18
	PE_O22F22_HDR_LLUT1_CTRL_06_T                 hdr_llut1_ctrl_06;	//0xF1000A48
	PE_O22F22_HDR_LLUT2_CTRL_06_T                 hdr_llut2_ctrl_06;	//0xF1000A78
	PE_O22F22_HDR_LLUT0_IA_CTRL_T                 hdr_llut0_ia_ctrl_e;	//0xF1000A20
	PE_O22F22_HDR_LLUT1_IA_CTRL_T                 hdr_llut1_ia_ctrl_e;	//0xF1000A50
	PE_O22F22_HDR_LLUT2_IA_CTRL_T                 hdr_llut2_ia_ctrl_e;	//0xF1000A80
}PE_CHPI_HDR_TM_O22F22_T;

typedef struct
{
	PE_O22F22_HDR_YGAIN_LUT_IA_CTRL_T             hdr_ygain_lut_ia_ctrl_s;	//0xF1000B38
	PE_O22F22_HDR_YGAIN_LUT_IA_DATA_T             hdr_ygain_lut_ia_data[32];	//0xF1000B3C
	PE_O22F22_HDR_YGAIN_LUT_IA_CTRL_T             hdr_ygain_lut_ia_ctrl_e;	//0xF1000B38
	PE_O22F22_HDR_YGAIN_LUT_CTRL_05_T             hdr_ygain_lut_ctrl_05;	//0xF1000B34
}PE_CHPI_HDR_YG_O22F22_T;

typedef struct
{
	PE_O22F22_HDR_HUE_SAT_CTRL_T                  hdr_hue_sat_ctrl;	//0xF10008D0
	PE_O22F22_HDR_LGAIN_LUT_CTRL_00_T             hdr_lgain_lut_ctrl_00;	//0xF1000B60
	PE_O22F22_HDR_LGAIN_LUT_CTRL_01_T             hdr_lgain_lut_ctrl_01;	//0xF1000B64
	PE_O22F22_HDR_LGAIN_LUT_CTRL_02_T             hdr_lgain_lut_ctrl_02;	//0xF1000B68
	PE_O22F22_HDR_LGAIN_LUT_CTRL_03_T             hdr_lgain_lut_ctrl_03;	//0xF1000B6C
	PE_O22F22_HDR_LGAIN_LUT_CTRL_04_T             hdr_lgain_lut_ctrl_04;	//0xF1000B70
	PE_O22F22_HDR_LGAIN_LUT_CTRL_05_T             hdr_lgain_lut_ctrl_05;	//0xF1000B74
	PE_O22F22_HDR_LGAIN_LUT_CTRL_06_T             hdr_lgain_lut_ctrl_06;	//0xF1000B78
	PE_O22F22_HDR_LGAIN_LUT_CTRL_07_T             hdr_lgain_lut_ctrl_07;	//0xF1000B7C
	PE_O22F22_HDR_SGAIN_LUT_CTRL_00_T             hdr_sgain_lut_ctrl_00;	//0xF1000B80
	PE_O22F22_HDR_SGAIN_LUT_CTRL_01_T             hdr_sgain_lut_ctrl_01;	//0xF1000B84
	PE_O22F22_HDR_SGAIN_LUT_CTRL_02_T             hdr_sgain_lut_ctrl_02;	//0xF1000B88
	PE_O22F22_HDR_SGAIN_LUT_CTRL_03_T             hdr_sgain_lut_ctrl_03;	//0xF1000B8C
	PE_O22F22_HDR_SGAIN_LUT_CTRL_04_T             hdr_sgain_lut_ctrl_04;	//0xF1000B90
	PE_O22F22_HDR_SGAIN_LUT_CTRL_05_T             hdr_sgain_lut_ctrl_05;	//0xF1000B94
	PE_O22F22_HDR_SGAIN_LUT_CTRL_06_T             hdr_sgain_lut_ctrl_06;	//0xF1000B98
	PE_O22F22_HDR_SGAIN_LUT_CTRL_07_T             hdr_sgain_lut_ctrl_07;	//0xF1000B9C
}PE_CHPI_HDR_HS_O22F22_T;

typedef struct
{
	PE_O22F22_HDR_PCC_CTRL_01_T                   hdr_pcc_ctrl_01;	//0xF10008A4
	PE_O22F22_HDR_PCC_CTRL_02_T                   hdr_pcc_ctrl_02;	//0xF10008A8
	PE_O22F22_HDR_PCC_CTRL_03_T                   hdr_pcc_ctrl_03;	//0xF10008AC
	PE_O22F22_HDR_PCC_CTRL_04_T                   hdr_pcc_ctrl_04;	//0xF10008B0
	PE_O22F22_HDR_PCC_CTRL_05_T                   hdr_pcc_ctrl_05;	//0xF10008B4
}PE_CHPI_HDR_PCC_O22F22_T;
