...
#ifndef __TOP_CTRL_OSD_REG_O22_H__
#define __TOP_CTRL_OSD_REG_O22_H__
...
#define OSD_TOP_O22_RdFL(_r)			((g_osd_top_o22_reg_shadow->_r)=(g_osd_top_o22_reg->_r))
#define OSD_TOP_O22_WrFL(_r)			((g_osd_top_o22_reg->_r)=(g_osd_top_o22_reg_shadow->_r))

#define OSD_TOP_O22_Rd(_r)				*((UINT32*)(&(g_osd_top_o22_reg_shadow->_r)))
#define OSD_TOP_O22_Wr(_r,_v)			((OSD_TOP_O22_Rd(_r))=((UINT32)(_v)))

#define OSD_TOP_O22_Rd01(_r,_f01,_v01)													\
								do { 											\
									(_v01) = (g_osd_top_o22_reg_shadow->_r._f01);				\
								} while(0)

#define OSD_TOP_O22_Rd02(_r,_f01,_v01,_f02,_v02)										\
								do { 											\
									(_v01) = (g_osd_top_o22_reg_shadow->_r._f01);				\
									(_v02) = (g_osd_top_o22_reg_shadow->_r._f02);				\
								} while(0)

#define OSD_TOP_O22_Wr01(_r,_f01,_v01)													\
								do { 											\
									(g_osd_top_o22_reg_shadow->_r._f01) = (_v01);				\
								} while(0)

#define OSD_TOP_O22_Wr02(_r,_f01,_v01,_f02,_v02)										\
								do { 											\
									(g_osd_top_o22_reg_shadow->_r._f01) = (_v01);				\
									(g_osd_top_o22_reg_shadow->_r._f02) = (_v02);				\
								} while(0)

extern volatile OSD_TOP_O22_REG_T*	g_osd_top_o22_reg;
extern OSD_TOP_O22_REG_T*			g_osd_top_o22_reg_shadow;
