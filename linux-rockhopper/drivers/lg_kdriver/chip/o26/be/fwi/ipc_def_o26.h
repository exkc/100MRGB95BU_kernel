...
#ifndef  _IPC_DEF_O26_H_
#define  _IPC_DEF_O26_H_

/*----------------------------------------------------------------------------------------
 *   Control Constants
 *---------------------------------------------------------------------------------------*/
#define BE_IPC_FROM_CPU_O26A0_BASE
#define BE_IPC_FROM_MCU_O26A0_BASE
 ...
 *---------------------------------------------------------------------------------------*/
typedef enum {
	BE_TOP_INIT                     = 0x60000000,  /* 0x6000 0000 */
	BE_TOP_SET_3D_OUT_FORMAT,                      /* 0x6000 0001 */
	BE_TOP_SET_BLOCK_BYPASS,                       /* 0x6000 0002 */
	BE_TOP_SET_DEBUG_DISPLAY,                      /* 0x6000 0003 */
	BE_TOP_GET_SYSTEM_INFO,                        /* 0x6000 0004 */
	BE_TOP_TOGGLE_3D_LR,                           /* 0x6000 0005 */
	BE_TOP_SET_3D_CONVERGENCE,                     /* 0x6000 0006 */
	BE_TOP_SET_BLACK_BAR,                          /* 0x6000 0007 */
	BE_TOP_SET_REAL_CINEMA,                        /* 0x6000 0008 */
	BE_TOP_SET_LSR,                                /* 0x6000 0009 */
	BE_TOP_SET_ORBIT,                              /* 0x6000 000A */
	BE_TOP_SET_CPC,                                /* 0x6000 000B */
	BE_TOP_SET_GSR,                                /* 0x6000 000C */
	BE_TOP_SET_DISP_MODE,                          /* 0x6000 000D */
	BE_TOP_SET_GSR2,                               /* 0x6000 000E */
	BE_TOP_SET_IRR,                                /* 0x6000 000F */
	BE_TOP_SET_PCCE,                               /* 0x6000 0010 */
	BE_TOP_IPC_TPC_T				= 0x60000020,
...
typedef struct
{
	...
	UINT32	uFrate165; // 0 : Normal ( 120Hz ), 1: 165Hz (SICREQ-847)
	UINT32 	rsvd;
} BE_IPC_DISP_MODE_T;
#endif
// http://jira.lge.com/issue/browse/SICDTV-16180
typedef struct
{
	UINT32
	uDispResolutionWidth  : 16,
	uDispResolutionHeight : 16;
	UINT32
	uHighSpeedClock		  : 8, // 0:144Hz, 1:165Hz
	uBoostMode			  : 8, // 0, 60Hz, 1:120Hz 2:30Hz, 3:VRR(120Hz)
	rsvd0				  : 16;
	UINT32 uFrameRate;
	UINT32 rsvd1;
} BE_IPC_DISP_MODE_T;
...
typedef struct{
	UINT32 uParamBaseAddr;
	UINT32 uParamDbtype;
	UINT32 uStatusBaseAddr;
	UINT32 rsvd[2];
} BE_IPC_TPC_T;
