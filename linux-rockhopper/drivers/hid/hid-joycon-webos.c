...
#define USB_DEVICE_ID_JOYCON_LEFT       0x2006
#define USB_DEVICE_ID_JOYCON_RIGHT      0x2007
...
#define jc_type_is_joycon(ctlr) \
	(ctlr->hdev->product == USB_DEVICE_ID_JOYCON_LEFT || \
	 ctlr->hdev->product == USB_DEVICE_ID_JOYCON_RIGHT)
...
static int joycon_input_create(struct joycon_ctlr *ctlr)
{
	...
	if (jc_type_has_left(ctlr)) {
		...
		/* configure d-pad for joy-con controller */
...
static const struct hid_device_id joycon_hid_devices[] = {
	{ HID_BLUETOOTH_DEVICE(USB_VENDOR_ID_NINTENDO,
			 USB_DEVICE_ID_JOYCON_LEFT) },
	{ HID_BLUETOOTH_DEVICE(USB_VENDOR_ID_NINTENDO,
			 USB_DEVICE_ID_JOYCON_RIGHT) },
	{ }
};
...
MODULE_DESCRIPTION("Driver for Nintendo Joycon LR controller");